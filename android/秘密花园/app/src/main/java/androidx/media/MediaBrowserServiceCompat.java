    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder o = a.o("detach() called when detach() had already been called for: ");
                ...
                StringBuilder o3 = a.o("detach() called when sendError() had already been called for: ");
        ...
        AnonymousClass1 r7 = new Result<List<MediaBrowserCompat.MediaItem>>(str) { // from class: androidx.media.MediaBrowserServiceCompat.1
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                ...
                if (connectionRecord2 == connectionRecord3) {
                    ...
                    String str3 = connectionRecord3.pkg;
                }
            }
        };
        this.mCurConnection = connectionRecord;
