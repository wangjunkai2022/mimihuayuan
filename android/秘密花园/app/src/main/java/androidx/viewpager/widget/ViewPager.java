...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder o = a.o("FragmentPager.SavedState{");
            o.append(Integer.toHexString(System.identityHashCode(this)));
            o.append(" position=");
            return a.k(o, this.position, "}");
        }
    ...
    private boolean pageScrolled(int i2) {
        if (this.mItems.size() != 0) {
            ...
            float f3 = ((((float) i2) / f2) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (((float) i3) / f2));
