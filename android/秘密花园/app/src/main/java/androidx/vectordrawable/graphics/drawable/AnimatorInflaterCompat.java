...
public class AnimatorInflaterCompat {
    ...
    public static void dumpKeyframes(Object[] objArr, String str) {
        if (!(objArr == null || objArr.length == 0)) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                StringBuilder p = a.p("Keyframe ", i2, ": fraction ");
                Object obj = "null";
                p.append(keyframe.getFraction() < 0.0f ? obj : Float.valueOf(keyframe.getFraction()));
                p.append(", , value : ");
    ...
    public static PropertyValuesHolder getPVH(TypedArray typedArray, int i2, int i3, int i4, String str) {
        ...
        if (i2 == 4) {
            i2 = ((!z || !isColorType(i8)) && (!z2 || !isColorType(i9))) ? 0 : 3;
        }
        boolean z3 = i2 == 0;
        ...
        if (i2 == 2) {
            ...
            ArgbEvaluator instance = i2 == 3 ? ArgbEvaluator.getInstance() : null;
            if (z3) {
                if (z) {
                    if (i8 == 5) {
