...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public boolean isPointInsideVerticalThumb(float f2, float f3) {
        if (!isLayoutRTL() ? f2 >= ((float) (this.mRecyclerViewWidth - this.mVerticalThumbWidth)) : f2 <= ((float) (this.mVerticalThumbWidth / 2))) {
            ...
            if (f3 >= ((float) (i2 - (i3 / 2))) && f3 <= ((float) ((i3 / 2) + i2))) {
                return true;
            }
        }
        return false;
    ...
    public void updateScrollPosition(int i2, int i3) {
        ...
        if (this.mNeedVerticalScrollbar || z) {
            if (this.mNeedVerticalScrollbar) {
                float f2 = (float) i4;
                this.mVerticalThumbCenterY = (int) ((((f2 / 2.0f) + ((float) i3)) * f2) / ((float) computeVerticalScrollRange));
                this.mVerticalThumbHeight = Math.min(i4, (i4 * i4) / computeVerticalScrollRange);
            }
            if (this.mNeedHorizontalScrollbar) {
                float f3 = (float) i5;
                this.mHorizontalThumbCenterX = (int) ((((f3 / 2.0f) + ((float) i2)) * f3) / ((float) computeHorizontalScrollRange));
