...
public class DefaultItemAnimator extends SimpleItemAnimator {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z4) {
                ...
                if (z || z2 || z3) {
                    ...
                    ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, r5, Math.max(moveDuration, j2) + removeDuration);
                    return;
                }
                r5.run();
            }
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder o = a.o("ChangeInfo{oldHolder=");
            o.append(this.oldHolder);
            o.append(", newHolder=");
            o.append(this.newHolder);
            o.append(", fromX=");
            o.append(this.fromX);
            o.append(", fromY=");
            o.append(this.fromY);
