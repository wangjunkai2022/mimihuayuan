...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i2, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    StringBuilder o = a.o("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    o.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(a.H(this.mRecyclerView, o));
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(a.H(this.mRecyclerView, a.o("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public boolean shouldMeasureChild(View view, int i2, int i3, LayoutParams layoutParams) {
            return view.isLayoutRequested() || !this.mMeasurementCacheEnabled || !isMeasurementUpToDate(view.getWidth(), i2, ((ViewGroup.MarginLayoutParams) layoutParams).width) || !isMeasurementUpToDate(view.getHeight(), i3, ((ViewGroup.MarginLayoutParams) layoutParams).height);
        }
        ...
        public boolean shouldReMeasureChild(View view, int i2, int i3, LayoutParams layoutParams) {
            return !this.mMeasurementCacheEnabled || !isMeasurementUpToDate(view.getMeasuredWidth(), i2, ((ViewGroup.MarginLayoutParams) layoutParams).width) || !isMeasurementUpToDate(view.getMeasuredHeight(), i3, ((ViewGroup.MarginLayoutParams) layoutParams).height);
        }
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i2, @Nullable Bundle bundle) {
            ...
            if (i2 == 4096) {
                ...
                if (this.mRecyclerView.canScrollHorizontally(1)) {
                    i6 = (getWidth() - getPaddingLeft()) - getPaddingRight();
                    i3 = i5;
                    i4 = i6;
                }
                i3 = i5;
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i2) {
            ...
            throw new IllegalArgumentException(a.H(RecyclerView.this, a.o("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
        }
        ...
        public int convertPreLayoutPositionToPostLayout(int i2) {
            if (i2 < 0 || i2 >= RecyclerView.this.mState.getItemCount()) {
                StringBuilder p = a.p("invalid position ", i2, ". State item count is ");
                p.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(a.H(RecyclerView.this, p));
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder o = a.o("Scrapped or attached views may not be recycled. isScrap:");
                o.append(viewHolder.isScrap());
                o.append(" isAttached:");
                if (viewHolder.itemView.getParent() != null) {
                    z = true;
                }
                o.append(z);
                throw new IllegalArgumentException(a.H(RecyclerView.this, o));
                ...
                throw new IllegalArgumentException(a.H(RecyclerView.this, a.o("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(a.H(RecyclerView.this, a.o("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:104:0x020c A[ADDED_TO_REGION] */
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i2) {
            if ((this.mLayoutStep & i2) == 0) {
                StringBuilder o = a.o("Layout state should be one of ");
                o.append(Integer.toBinaryString(i2));
                o.append(" but it is ");
                o.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder o = a.o("State{mTargetPosition=");
            o.append(this.mTargetPosition);
            o.append(", mData=");
            o.append(this.mData);
            o.append(", mItemCount=");
            o.append(this.mItemCount);
            o.append(", mIsMeasuring=");
            o.append(this.mIsMeasuring);
            o.append(", mPreviousLayoutItemCount=");
            o.append(this.mPreviousLayoutItemCount);
            ...
            o.append(this.mStructureChanged);
            o.append(", mInPreLayout=");
            o.append(this.mInPreLayout);
            o.append(", mRunSimpleAnimations=");
            o.append(this.mRunSimpleAnimations);
            o.append(", mRunPredictiveAnimations=");
            o.append(this.mRunPredictiveAnimations);
            o.append('}');
            return o.toString();
        }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i2, int i3, int i4, int i5) {
            ...
            float f3 = (float) i7;
            float distanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (((float) sqrt2) * 1.0f) / f2)) * f3) + f3;
            if (sqrt > 0) {
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder r = a.r(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            ...
            if (!isRecyclable()) {
                StringBuilder o = a.o(" not recyclable(");
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(a.H(this, a.o("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(a.H(this, a.o(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(a.H(this, a.o("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(a.H(this, a.o("")));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        o.append(", adapter:");
        o.append(this.mAdapter);
        o.append(", layout:");
        o.append(this.mLayout);
        o.append(", context:");
        o.append(getContext());
        return o.toString();
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(a.H(this, a.o("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(a.H(this, a.o("Trying to set fast scroller without both required drawables.")));
        }
