...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            StringBuilder o = a.o("AnchorInfo{mPosition=");
            o.append(this.mPosition);
            o.append(", mCoordinate=");
            o.append(this.mCoordinate);
            o.append(", mLayoutFromEnd=");
            o.append(this.mLayoutFromEnd);
            o.append(", mValid=");
            o.append(this.mValid);
            o.append('}');
            return o.toString();
        }
    }
            ...
            if (i2 < 0 || i2 >= state.getItemCount()) {
                ...
                if (savedState != null && savedState.hasValidAnchor()) {
                    ...
                    if (findViewByPosition == null) {
                        ...
                        if (anchorInfo.mLayoutFromEnd) {
                            i3 = this.mOrientationHelper.getTotalSpaceChange() + this.mOrientationHelper.getDecoratedEnd(findViewByPosition);
                        } else {
    ...
    private void updateLayoutState(int i2, int i3, boolean z, RecyclerView.State state) {
        ...
        if (z2) {
            ...
            layoutState7.mItemDirection = i5;
        ...
        layoutState10.mAvailable = i3;
        if (z) {
            layoutState10.mAvailable = i3 - i4;
        }
        ...
        if (getChildCount() >= 1) {
            ...
            if (this.mShouldReverseLayout) {
                for (int i2 = 1; i2 < getChildCount(); i2++) {
                    ...
                    if (position2 < position) {
                        logChildren();
                        StringBuilder o = a.o("detected invalid position. loc invalid? ");
            ...
            for (int i3 = 1; i3 < getChildCount(); i3++) {
                ...
                if (position3 < position) {
                    logChildren();
                    StringBuilder o2 = a.o("detected invalid position. loc invalid? ");
