...
public class ConstraintLayout extends ViewGroup {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (!layoutParams.isGuideline && !layoutParams.isHelper) {
                    ...
                    if (z3 || layoutParams.verticalDimensionFixed || (!z3 && layoutParams.matchConstraintDefaultWidth == 1) || ((ViewGroup.MarginLayoutParams) layoutParams).width == -1 || (!layoutParams.verticalDimensionFixed && (layoutParams.matchConstraintDefaultHeight == 1 || ((ViewGroup.MarginLayoutParams) layoutParams).height == -1))) {
                        ...
                        if (i8 == 0) {
                            i5 = ViewGroup.getChildMeasureSpec(i3, paddingBottom, -2);
                            z = true;
                        } else if (i8 == -1) {
                            ...
                            z = i8 == -2;
                            i5 = ViewGroup.getChildMeasureSpec(i3, paddingBottom, i8);
                        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:119:0x0249  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:134:0x027d  */
    /* JADX WARNING: Removed duplicated region for block: B:137:0x0283  */
    /* JADX WARNING: Removed duplicated region for block: B:138:0x0285  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:146:0x02ab  */
    /* JADX WARNING: Removed duplicated region for block: B:148:0x02b4  */
    /* JADX WARNING: Removed duplicated region for block: B:149:0x02bc  */
    /* JADX WARNING: Removed duplicated region for block: B:152:0x02c9  */
    /* JADX WARNING: Removed duplicated region for block: B:155:0x02d4 A[ADDED_TO_REGION] */
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.isGuideline) {
                    ...
                    int i25 = layoutParams.circleConstraint;
                    if (i25 != -1) {
                        ...
                        if (i19 != -1) {
                            ...
                            if (targetWidget6 != null) {
                                ...
                                i3 = i24;
                                i2 = i22;
                                viewWidget2.immediateConnect(type, targetWidget6, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i23);
                            } else {
                                f2 = f4;
                                i3 = i24;
                                i2 = i22;
                            ...
                            if (!(i20 == -1 || (targetWidget4 = getTargetWidget(i20)) == null)) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget4, ConstraintAnchor.Type.RIGHT, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i23);
                            }
                        }
                        if (i21 != -1) {
                            ...
                            viewWidget2.immediateConnect(type2, targetWidget3, type2, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i3);
                        }
                        ...
                        if (i26 != -1) {
                            ...
                            if (!(i27 == -1 || (targetWidget2 = getTargetWidget(i27)) == null)) {
                        ...
                        if (i28 != -1) {
                            ...
                            if (!(i29 == -1 || (targetWidget = getTargetWidget(i29)) == null)) {
                        ...
                        if (f5 >= 0.0f && f5 != 0.5f) {
                            viewWidget2.setVerticalBiasPercent(f5);
                        }
                    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:177:0x03a2  */
