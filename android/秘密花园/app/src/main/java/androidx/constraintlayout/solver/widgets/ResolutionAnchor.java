...
public class ResolutionAnchor extends ResolutionNode {
    ...
    public String toString() {
        if (this.state != 1) {
            ...
            o3.append(", RESOLVED: ");
            o3.append(this.resolvedTarget);
            o3.append(":");
            o3.append(this.resolvedOffset);
            o3.append("] type: ");
        ...
        if (this.state != 1 && this.type != 4) {
            ...
            if (this.type == 1 && ((resolutionAnchor7 = this.target) == null || resolutionAnchor7.state == 1)) {
                ...
                if (z) {
                    ...
                    resolutionAnchor10.resolvedOffset = (f9 * f4) + resolutionAnchor10.target.resolvedOffset + f8;
                    this.resolvedOffset = (this.target.resolvedOffset - f7) - ((1.0f - f4) * f9);
                } else {
                    this.resolvedOffset = (f9 * f4) + this.target.resolvedOffset + f7;
                    ResolutionAnchor resolutionAnchor11 = this.opposite;
                    resolutionAnchor11.resolvedOffset = (resolutionAnchor11.target.resolvedOffset - f8) - ((1.0f - f4) * f9);
                }
                didResolve();
