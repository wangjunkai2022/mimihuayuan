...
public final class TimeUtils {
    ...
    public static int formatDurationLocked(long j2, int i2) {
        ...
        if (i2 != 0) {
            ...
            int accumField2 = accumField(i4, 1, accumField > 0, 2) + accumField;
            int accumField3 = accumField(i6, 1, accumField2 > 0, 2) + accumField2;
            int accumField4 = accumField(i5, 1, accumField3 > 0, 2) + accumField3;
            i7 = 0;
            for (int accumField5 = accumField(i10, 2, true, accumField4 > 0 ? 3 : 0) + 1 + accumField4; accumField5 < i2; accumField5++) {
                cArr[i7] = ' ';
                i7++;
            }
        } else {
