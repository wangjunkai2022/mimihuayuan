...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Builder(int i2, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z, int i3, boolean z2) {
    ...
    public static class Builder {
        ...
        public static CharSequence limitCharSequenceLength(CharSequence charSequence) {
            ...
            return charSequence.length() > 5120 ? charSequence.subSequence(0, MAX_CHARSEQUENCE_LENGTH) : charSequence;
        }
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            if (!z || (arrayList = this.mBuilder.mActions) == null || (min = Math.min(arrayList.size(), 3)) <= 0) {
                ...
                for (int i3 = 0; i3 < min; i3++) {
                    applyStandardTemplate.addView(R.id.actions, generateActionButton(this.mBuilder.mActions.get(i3)));
                }
            }
            if (!z2) {
                i2 = 8;
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i3 = 0; i3 < remoteInputs.length; i3++) {
                ...
                remoteInputArr2[i3] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras(), null);
            }
        ...
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, z, i2, z2);
    }
