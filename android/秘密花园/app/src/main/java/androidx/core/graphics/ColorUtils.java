...
public final class ColorUtils {
    ...
    public static int HSLToColor(@NonNull float[] fArr) {
        ...
        switch (((int) f2) / 60) {
            case 0:
                i4 = Math.round((abs + f5) * 255.0f);
                i3 = Math.round((abs2 + f5) * 255.0f);
                i2 = Math.round(f5 * 255.0f);
                break;
            case 1:
                i4 = Math.round((abs2 + f5) * 255.0f);
                i3 = Math.round((abs + f5) * 255.0f);
                i2 = Math.round(f5 * 255.0f);
                break;
            case 2:
                i4 = Math.round(f5 * 255.0f);
                i3 = Math.round((abs + f5) * 255.0f);
    ...
    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, @IntRange(from = 0, to = 255) int i4, @NonNull double[] dArr) {
        ...
        if (dArr.length == 3) {
            ...
            dArr[1] = ((0.0722d * d4) + (0.7152d * d3) + (0.2126d * d2)) * 100.0d;
            double d8 = d4 * 0.9505d;
            dArr[2] = (d8 + (d3 * 0.1192d) + (d2 * 0.0193d)) * 100.0d;
            return;
        }
