...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f4 = (this.mRawShadowSize / 2.0f) + f2 + ((float) this.mInsetShadow);
        float f5 = f4 * 2.0f;
    ...
    public float getMinHeight() {
        ...
        return (((this.mRawMaxShadowSize * 1.5f) + ((float) this.mInsetShadow)) * 2.0f) + (Math.max(f2, f3 + this.mCornerRadius + ((float) this.mInsetShadow)) * 2.0f);
    }

    public float getMinWidth() {
        float f2 = this.mRawMaxShadowSize;
        float f3 = f2 / 2.0f;
        return ((this.mRawMaxShadowSize + ((float) this.mInsetShadow)) * 2.0f) + (Math.max(f2, f3 + this.mCornerRadius + ((float) this.mInsetShadow)) * 2.0f);
    }
