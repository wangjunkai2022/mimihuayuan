...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i6 = 0; i6 < virtualChildCount; i6++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i6))) {
                LayoutParams layoutParams = (LayoutParams) virtualChildAt.getLayoutParams();
                if (isLayoutRtl) {
                    i5 = virtualChildAt.getRight() + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
                } else {
                    i5 = (virtualChildAt.getLeft() - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) - this.mDividerWidth;
                }
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 != null) {
                ...
                if (isLayoutRtl) {
                    i4 = virtualChildAt2.getLeft() - ((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin;
                    i3 = this.mDividerWidth;
                    i2 = i4 - i3;
                    drawVerticalDivider(canvas, i2);
                }
                i2 = virtualChildAt2.getRight() + ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin;
                drawVerticalDivider(canvas, i2);
            } else if (isLayoutRtl) {
                i2 = getPaddingLeft();
                drawVerticalDivider(canvas, i2);
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 == null) {
                ...
                i2 = virtualChildAt2.getBottom() + ((ViewGroup.MarginLayoutParams) ((LayoutParams) virtualChildAt2.getLayoutParams())).bottomMargin;
            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:188:0x0450  */
