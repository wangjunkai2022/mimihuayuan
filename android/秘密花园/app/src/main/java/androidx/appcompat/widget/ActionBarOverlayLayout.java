...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private boolean applyInsets(View view, Rect rect, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (!z || ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin == (i5 = rect.left)) {
            z5 = false;
        } else {
            ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin = i5;
            z5 = true;
        }
        if (z2 && ((ViewGroup.MarginLayoutParams) layoutParams).topMargin != (i4 = rect.top)) {
            ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = i4;
            z5 = true;
        }
        if (z4 && ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin != (i3 = rect.right)) {
            ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin = i3;
            z5 = true;
        }
        if (!z3 || ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin == (i2 = rect.bottom)) {
            return z5;
        }
