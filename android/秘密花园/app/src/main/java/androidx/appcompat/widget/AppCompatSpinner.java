...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void computeContentWidth() {
            ...
            if (ViewUtils.isLayoutRtl(AppCompatSpinner.this)) {
                i2 = (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) + i3;
            } else {
                i2 = getHorizontalOriginalOffset() + paddingLeft + i3;
            }
    ...
    public AppCompatSpinner(android.content.Context r6, android.util.AttributeSet r7, int r8, int r9, android.content.res.Resources.Theme r10) {
        ...
        L_0x0034:
            ...
            int[] r10 = androidx.appcompat.widget.AppCompatSpinner.ATTRS_ANDROID_SPINNERMODE     // Catch: Exception -> 0x0056, all -> 0x004f
