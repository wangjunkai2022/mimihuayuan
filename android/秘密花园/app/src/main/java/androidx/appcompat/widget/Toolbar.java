...
public class Toolbar extends ViewGroup {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (shouldLayout(this.mMenuView)) {
            measureChildConstrained(this.mMenuView, i2, max2, i3, 0, this.mMaxButtonHeight);
        ...
        int max3 = Math.max(currentContentInsetEnd, i7) + max2;
        iArr[c2] = Math.max(0, currentContentInsetEnd - i7);
        if (shouldLayout(this.mExpandedActionView)) {
            max3 += measureChildCollapseMargins(this.mExpandedActionView, i2, max3, i3, 0, iArr);
        ...
        if (shouldLayout(this.mLogoView)) {
            max3 += measureChildCollapseMargins(this.mLogoView, i2, max3, i3, 0, iArr);
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                max3 += measureChildCollapseMargins(childAt, i2, max3, i3, 0, iArr);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i2, max3 + i14, i3, i13, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i9 = Math.max(i9, measureChildCollapseMargins(this.mSubtitleTextView, i2, max3 + i14, i3, i8 + i13, iArr));
