...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            ...
            r.append("; weight:");
            r.append(new BigDecimal((double) this.weight));
            r.append("]");
            return r.toString();
        }
    ...
    public final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r14) {
            /*
                ...
                r5 = 0
                androidx.appcompat.widget.ActivityChooserModel r6 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch: FileNotFoundException -> 0x00a3
                android.content.Context r6 = r6.mContext     // Catch: FileNotFoundException -> 0x00a3
                java.io.FileOutputStream r14 = r6.openFileOutput(r14, r2)     // Catch: FileNotFoundException -> 0x00a3
                org.xmlpull.v1.XmlSerializer r6 = android.util.Xml.newSerializer()
                r6.setOutput(r14, r5)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r7 = "UTF-8"
                java.lang.Boolean r8 = java.lang.Boolean.TRUE     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.startDocument(r7, r8)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.startTag(r5, r1)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                int r7 = r3.size()     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r8 = 0
            L_0x002d:
                if (r8 >= r7) goto L_0x005f
                java.lang.Object r9 = r3.remove(r2)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r9 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r9     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.startTag(r5, r0)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r10 = "activity"
                android.content.ComponentName r11 = r9.activity     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r11 = r11.flattenToString()     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.attribute(r5, r10, r11)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r10 = "time"
                long r11 = r9.time     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r11 = java.lang.String.valueOf(r11)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.attribute(r5, r10, r11)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r10 = "weight"
                float r9 = r9.weight     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.attribute(r5, r10, r9)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.endTag(r5, r0)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                int r8 = r8 + 1
                goto L_0x002d
            L_0x005f:
                r6.endTag(r5, r1)     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
                r6.endDocument()     // Catch: IllegalArgumentException -> 0x008b, IllegalStateException -> 0x007e, IOException -> 0x0071, all -> 0x006f
            ...
            L_0x006b:
                r14.close()     // Catch: IOException -> 0x0098
                goto L_0x0098
            L_0x006f:
                r0 = move-exception
                goto L_0x0099
            L_0x0071:
                java.lang.String r0 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch: all -> 0x006f
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch: all -> 0x006f
                java.lang.String r0 = r0.mHistoryFileName     // Catch: all -> 0x006f
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r4
                if (r14 == 0) goto L_0x0098
                goto L_0x006b
            ...
            L_0x0099:
                ...
                r14.close()     // Catch: IOException -> 0x00a2
            L_0x00a2:
                throw r0
            L_0x00a3:
