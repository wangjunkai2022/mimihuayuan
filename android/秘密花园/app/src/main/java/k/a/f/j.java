...
public class j {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x0048 A[EDGE_INSN: B:39:0x0048->B:32:0x0048 ?: BREAK  , SYNTHETIC] */
    ...
    public String b(String str) {
        ...
        if (indexOf != -1) {
            str2 = this.a.substring(this.b, indexOf);
