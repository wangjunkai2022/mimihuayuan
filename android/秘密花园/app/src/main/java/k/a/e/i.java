...
public class i {
    ...
    public static void a(b bVar, String str, int i2) {
        int i3;
        bVar.a = new String[i2];
        bVar.b = new int[i2];
        bVar.f7028c = new int[i2];
        bVar.f7029d = new String[i2];
        k.a.f.a aVar = new k.a.f.a(new StringReader(str), str.length());
        boolean z = false;
        int i4 = 0;
        while (!aVar.l()) {
            String g2 = aVar.g('=');
            ...
            bVar.a[i4] = g2;
            bVar.b[i4] = parseInt;
            bVar.f7028c[parseInt2] = parseInt;
            bVar.f7029d[parseInt2] = g2;
            if (i3 != -1) {
                b.put(g2, new String(new int[]{parseInt, i3}, 0, 2));
            }
            i4++;
        }
        if (i4 == i2) {
    ...
    public static void b(Appendable appendable, b bVar, int i2) throws IOException {
        CharSequence charSequence;
        int binarySearch = Arrays.binarySearch(bVar.f7028c, i2);
        if (binarySearch >= 0) {
            CharSequence[] charSequenceArr = bVar.f7029d;
            if (binarySearch < charSequenceArr.length - 1) {
                int i3 = binarySearch + 1;
                if (bVar.f7028c[i3] == i2) {
                    charSequence = charSequenceArr[i3];
                }
            }
            charSequence = bVar.f7029d[binarySearch];
        } else {
            charSequence = "";
        }
    ...
    public static void c(Appendable appendable, String str, f.a aVar, boolean z, boolean z2, boolean z3) throws IOException {
        b bVar = aVar.a;
        CharsetEncoder charsetEncoder = aVar.f7007c.get();
