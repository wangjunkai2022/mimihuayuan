...
public class b0 implements Cloneable, f.a {
    ...
    public static final class a {
        ...
        public s f6387l = s.a;
        public c o = c.a;
        public List<m> s = b0.D;
        public List<? extends c0> t = b0.C;
        public HostnameVerifier u = d.a;
        public h v = h.f6443c;
        public int y = 10000;
        public int z = 10000;
        public int A = 10000;
        ...
        public a() {
            ...
            g.b(socketFactory, "SocketFactory.getDefault()");
    ...
    /* JADX DEBUG: Type inference failed for r1v0. Raw type applied. Possible types: java.util.List<? extends i.c0>, java.util.List<i.c0> */
    ...
    public a b() {
        ...
        aVar.a = this.a;
        aVar.b = this.b;
        h.d(aVar.f6378c, this.f6367c);
        h.d(aVar.f6379d, this.f6368d);
