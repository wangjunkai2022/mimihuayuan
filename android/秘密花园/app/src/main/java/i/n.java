...
public final class n {
    ...
    public static final long c(String str, int i2, int i3) {
        ...
        while (a < i3) {
            ...
            if (i5 == -1 && matcher.usePattern(f6751m).matches()) {
                ...
                g.b(pattern, "MONTH_PATTERN.pattern()");
                i7 = d.j(pattern, lowerCase, 0, false, 6) / 4;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof n) {
            n nVar = (n) obj;
            if (g.a(nVar.a, this.a) && g.a(nVar.b, this.b) && nVar.f6752c == this.f6752c && g.a(nVar.f6753d, this.f6753d) && g.a(nVar.f6754e, this.f6754e) && nVar.f6755f == this.f6755f && nVar.f6756g == this.f6756g && nVar.f6757h == this.f6757h && nVar.f6758i == this.f6758i) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        return ((((((((this.f6754e.hashCode() + ((hashCode2 + ((((hashCode + ((this.a.hashCode() + 527) * 31)) * 31) + b.a(this.f6752c)) * 31)) * 31)) * 31) + a.a(this.f6755f)) * 31) + a.a(this.f6756g)) * 31) + a.a(this.f6757h)) * 31) + a.a(this.f6758i);
    }
    ...
    public String toString() {
        ...
        if (this.f6757h) {
            if (this.f6752c == Long.MIN_VALUE) {
                ...
                sb.append("; expires=");
                sb.append(c.b(new Date(this.f6752c)));
            }
        }
        if (!this.f6758i) {
            sb.append("; domain=");
