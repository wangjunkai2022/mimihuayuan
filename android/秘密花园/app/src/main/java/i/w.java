...
public final class w implements Iterable<c<? extends String, ? extends String>>, h.o.c.o.a {
    ...
    public static final class a {
        ...
        public final String e(String str) {
            if (str != null) {
                ...
                int i4 = b.f6334c;
                if (i4 < 0 ? i2 >= i3 : i2 <= i3) {
                    while (!d.d(str, this.a.get(i2), true)) {
                        if (i2 != i3) {
                            i2 += i4;
                        }
                    }
    ...
    /* Return type fixed from 'java.util.Iterator<h.c<java.lang.String, java.lang.String>>' to match base method */
    @Override // java.lang.Iterable
    public Iterator<c<? extends String, ? extends String>> iterator() {
        int size = size();
        c[] cVarArr = new c[size];
        for (int i2 = 0; i2 < size; i2++) {
            cVarArr[i2] = new c(c(i2), f(i2));
        }
