...
public final class b extends f {
    ...
    /* loaded from: classes.dex */
    public static final class C0106b implements ConscryptHostnameVerifier {
    ...
    public void f(X509TrustManager x509TrustManager) {
        if (Conscrypt.isConscrypt(x509TrustManager)) {
            Conscrypt.setHostnameVerifier(x509TrustManager, C0106b.a);
        }
    }
    ...
    @Override // i.m0.i.f
    public SSLContext m() {
        SSLContext instance = SSLContext.getInstance("TLS", this.f6729d);
        g.b(instance, "SSLContext.getInstance(\"TLS\", provider)");
        return instance;
    }
