...
public final class k implements d {
    ...
    public static final List<String> f6683g = b.o("connection", "host", "keep-alive", "proxy-connection", "te", "transfer-encoding", "encoding", "upgrade", ":method", ":path", ":scheme", ":authority");

    /* renamed from: h  reason: collision with root package name */
    public static final List<String> f6684h = b.o("connection", "host", "keep-alive", "proxy-connection", "te", "transfer-encoding", "encoding", "upgrade");
    public volatile m a;
    public final c0 b;
    ...
    public k(b0 b0Var, h hVar, y.a aVar, f fVar) {
        c0 c0Var = c0.H2_PRIOR_KNOWLEDGE;
        this.f6686d = hVar;
        this.f6687e = aVar;
        this.f6688f = fVar;
        this.b = !b0Var.t.contains(c0Var) ? c0.HTTP_2 : c0Var;
    }
            ...
            if (xVar != null) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (c2 != null) {
                        ...
                        if (!f6683g.contains(lowerCase) || (g.a(lowerCase, "te") && g.a(wVar.f(i3), "trailers"))) {
                ...
                synchronized (fVar.s) {
                    synchronized (fVar) {
                        ...
                        if (!fVar.f6650g) {
                            ...
                            if (!z2 || fVar.p >= fVar.q || mVar.f6697c >= mVar.f6698d) {
                                z = true;
                            }
                            if (mVar.i()) {
                ...
                if (this.f6685c) {
                    ...
                    m mVar3 = this.a;
                    if (mVar3 != null) {
                        mVar3.f6703i.g((long) this.f6687e.b(), TimeUnit.MILLISECONDS);
                        m mVar4 = this.a;
                        if (mVar4 != null) {
                            mVar4.f6704j.g((long) this.f6687e.c(), TimeUnit.MILLISECONDS);
                        } else {
                            g.e();
                            throw null;
                        }
        ...
        if (mVar != null) {
            synchronized (mVar) {
                ...
                if (!mVar.f6699e.isEmpty()) {
                    ...
                    g.b(removeFirst, "headersQueue.removeFirst()");
                    wVar = removeFirst;
                } else {
