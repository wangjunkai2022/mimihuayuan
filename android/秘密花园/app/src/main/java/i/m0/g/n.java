...
public final class n implements Closeable {
    ...
    public final synchronized void E(boolean z, int i2, List<c> list) throws IOException {
        if (list == null) {
            ...
            this.f6717d.e(list);
            long j2 = this.a.b;
            long min = Math.min((long) this.b, j2);
    ...
    public final synchronized void e(boolean z, int i2, g gVar, int i3) throws IOException {
        if (!this.f6716c) {
            f(i2, i3, 0, z ? 1 : 0);
            if (i3 > 0) {
                i iVar = this.f6718e;
    ...
    public final void f(int i2, int i3, int i4, int i5) throws IOException {
        ...
        StringBuilder o = a.o("FRAME_SIZE_ERROR length > ");
        o.append(this.b);
        o.append(": ");
        o.append(i3);
