...
public final class a implements i.m0.e.d {
    ...
    /* loaded from: classes.dex */
    public abstract class AbstractC0102a implements a0 {
        public final n a;
        public boolean b;
    ...
    public final class c extends AbstractC0102a {
        ...
        @Override // i.m0.f.a.AbstractC0102a, j.a0
        public long c(g gVar, long j2) {
            if (gVar != null) {
                boolean z = true;
                if (!(j2 >= 0)) {
    ...
    /* compiled from: Http1ExchangeCodec.kt */
    /* loaded from: classes.dex */
    public final class f extends AbstractC0102a {
