            ...
            if (obj == null) {
                ...
                if (!g.a(name, "unsupported") || !g.a(Void.TYPE, returnType)) {
                    ...
                    if ((g.a(name, "selectProtocol") || g.a(name, "select")) && g.a(String.class, returnType) && objArr.length == 1 && (objArr[0] instanceof List)) {
                        ...
                        throw new f("null cannot be cast to non-null type kotlin.collections.List<*>");
    ...
    public String h(SSLSocket sSLSocket) {
        try {
            ...
            if (invocationHandler != null) {
                ...
                throw new f("null cannot be cast to non-null type okhttp3.internal.platform.Jdk8WithJettyBootPlatform.AlpnProvider");
            }
        } catch (IllegalAccessException e2) {
