...
public final class e {
    ...
    public static final k a = k.f6979e.b("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    static {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            ...
            g.b(binaryString, "Integer.toBinaryString(it)");
            String replace = b.l("%8s", binaryString).replace(' ', '0');
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            for (int i7 = 0; i7 < 1; i7++) {
                ...
                sb.append(f6643c[i8]);
                sb.append("|");
                f6643c[i9 | 8] = a.l(sb, f6643c[i6], "|PADDED");
            }
        }
    ...
    public final String a(boolean z, int i2, int i3, int i4, int i5) {
        ...
        String str2;
        String[] strArr = b;
        String l2 = i4 < strArr.length ? strArr[i4] : b.l("0x%02x", Integer.valueOf(i4));
        if (i5 == 0) {
            str = "";
        } else {
            if (!(i4 == 2 || i4 == 3)) {
                if (i4 == 4 || i4 == 6) {
                    ...
                    str = (i4 != 5 || (i5 & 4) == 0) ? (i4 != 0 || (i5 & 32) == 0) ? str2 : d.q(str2, "PRIORITY", "COMPRESSED", false, 4) : d.q(str2, "HEADERS", "PUSH_PROMISE", false, 4);
                }
            }
            str = f6644d[i5];
        }
        return b.l("%s 0x%08x %5d %-13s %s", z ? "<<" : ">>", Integer.valueOf(i2), Integer.valueOf(i3), l2, str);
    }
}
