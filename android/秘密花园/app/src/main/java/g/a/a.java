...
public abstract class a implements Closeable {
    ...
    public static final d f6189i = new d();
    public final long a;
    public final b0 b;
    ...
    /* loaded from: classes.dex */
    public class C0091a implements OsSharedRealm.SchemaChangedCallback {
        public C0091a() {
        }
    ...
    public static final class c {
        ...
        public void b(a aVar, p pVar, g.a.f1.c cVar, boolean z, List<String> list) {
            this.a = aVar;
            this.b = pVar;
            this.f6194c = cVar;
            this.f6195d = z;
    ...
    public void f() {
        ...
        } else if (this.a != Thread.currentThread().getId()) {
            throw new IllegalStateException("Realm access from incorrect thread. Realm objects can only be accessed on the thread they were created.");
        }
    }
    ...
    public a(z zVar, OsSchemaInfo osSchemaInfo) {
        ...
        b bVar = null;
        this.f6190c = null;
        c cVar = (osSchemaInfo == null || (d0Var = b0Var.f6201g) == null) ? null : new c(d0Var);
        x.a aVar = b0Var.f6206l;
        bVar = aVar != null ? new b(this, aVar) : bVar;
        ...
        this.f6191d = instance;
        this.f6192e = true;
        instance.registerSchemaChangedCallback(this.f6193f);
        this.f6190c = zVar;
    }
}
