...
public class c0<E> extends AbstractList<E> implements OrderedRealmCollection<E> {
    ...
    public boolean contains(Object obj) {
        ...
        this.f6219d.f();
        if (!(obj instanceof n) || ((n) obj).realmGet$proxyState().f6305c != g.INSTANCE) {
            return super.contains(obj);
        }
        return false;
    }

    public final o<E> g(a aVar, OsList osList, Class<E> cls, String str) {
        if (cls == null || h(cls)) {
    ...
    public E remove(int i2) {
        ...
        if (i()) {
            this.f6219d.f();
            e2 = get(i2);
            OsList.nativeRemove(this.f6218c.b.a, (long) i2);
        } else {
            e2 = this.f6220e.remove(i2);
        }
        ((AbstractList) this).modCount++;
        return e2;
    }
    ...
    public String toString() {
        ...
        if (!i()) {
            ...
            if (!(oVar != null && OsList.nativeIsValid(oVar.b.a))) {
                ...
                while (i2 < size()) {
                    sb.append(((n) get(i2)).realmGet$proxyState().f6305c.l());
                    sb.append(",");
                    i2++;
                }
                if (size() > 0) {
    ...
    public c0(Class<E> cls, OsList osList, a aVar) {
        this.a = cls;
        this.f6218c = g(aVar, osList, cls, null);
        this.f6219d = aVar;
    }

    public c0(String str, OsList osList, a aVar) {
        this.f6219d = aVar;
        this.b = str;
