...
public final class f0<T> extends o<T> {
    ...
    public void a(Object obj) {
        ...
        OsList.nativeAddRow(osList.a, ((n) h((e0) obj)).realmGet$proxyState().f6305c.l());
    }
    ...
    public T c(int i2) {
        ...
        OsList osList = this.b;
        return (T) aVar.F(cls, str, osList.f6920c.m(OsList.nativeGetRow(osList.a, (long) i2)));
    }
    ...
    public void e(int i2, Object obj) {
        ...
        OsList.nativeInsertRow(this.b.a, (long) i2, ((n) h((e0) obj)).realmGet$proxyState().f6305c.l());
    }
    ...
    public void g(int i2, Object obj) {
        OsList osList = this.b;
        OsList.nativeSetRow(osList.a, (long) i2, ((n) h((e0) obj)).realmGet$proxyState().f6305c.l());
    }

    /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: g.a.f1.o */
    /* JADX DEBUG: Multi-variable search result rejected for r4v4, resolved type: g.a.f1.o */
    ...
    public final <E extends e0> E h(E e2) {
        ...
        if (OsObjectSchemaInfo.nativeGetPrimaryKeyProperty(a.a) == 0) {
            property = null;
        } else {
            property = new Property(OsObjectSchemaInfo.nativeGetPrimaryKeyProperty(a.a));
        }
        if (property != null) {
            return (E) xVar.K(e2, true, new HashMap(), Util.b(mVarArr));
        }
        StringBuilder o = a.o("A RealmObject with no @PrimaryKey cannot be updated: ");
