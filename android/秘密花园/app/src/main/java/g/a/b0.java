...
public class b0 {
    ...
    public final o f6204j;

    /* renamed from: k  reason: collision with root package name */
    public final b f6205k;
    ...
    static {
        ...
        p = Q;
        if (Q != null) {
            o b = b(Q.getClass().getCanonicalName());
            if (b.j()) {
                q = b;
                return;
            }
    ...
    public b0(File file, String str, String str2, String str3, byte[] bArr, long j2, d0 d0Var, boolean z, OsRealmConfig.c cVar, o oVar, b bVar, x.a aVar, boolean z2, CompactOnLaunchCallback compactOnLaunchCallback, boolean z3) {
        this.a = file;
        this.b = str;
        this.f6197c = str2;
        this.f6199e = bArr;
    ...
    public int hashCode() {
        ...
        long j2 = this.f6200f;
        int i3 = (((hashCode4 + ((hashCode2 + hashCode3) * 31)) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31;
        d0 d0Var = this.f6201g;
        int hashCode5 = (this.f6204j.hashCode() + ((this.f6203i.hashCode() + ((((i3 + (d0Var != null ? d0Var.hashCode() : 0)) * 31) + (this.f6202h ? 1 : 0)) * 31)) * 31)) * 31;
        b bVar = this.f6205k;
        int hashCode6 = (hashCode5 + (bVar != null ? bVar.hashCode() : 0)) * 31;
        x.a aVar = this.f6206l;
        int hashCode7 = (((hashCode6 + (aVar != null ? aVar.hashCode() : 0)) * 31) + (this.f6207m ? 1 : 0)) * 31;
        CompactOnLaunchCallback compactOnLaunchCallback = this.n;
        if (compactOnLaunchCallback != null) {
            i2 = compactOnLaunchCallback.hashCode();
        }
        return ((hashCode7 + i2) * 31) + (this.o ? 1 : 0);
    }
    ...
    public String toString() {
        ...
        f.b.a.a.a.C(o, this.f6197c, g.a, "key: ", "[length: ");
