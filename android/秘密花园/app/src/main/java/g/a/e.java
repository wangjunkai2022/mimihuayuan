...
public final class e extends o<Boolean> {
    ...
    public Boolean c(int i2) {
        return (Boolean) this.b.a((long) i2);
    }

    @Override // g.a.o
    public void e(int i2, Object obj) {
        OsList osList = this.b;
        OsList.nativeInsertBoolean(osList.a, (long) i2, ((Boolean) obj).booleanValue());
    }

    @Override // g.a.o
    public void g(int i2, Object obj) {
        OsList osList = this.b;
        OsList.nativeSetBoolean(osList.a, (long) i2, ((Boolean) obj).booleanValue());
    }
}
