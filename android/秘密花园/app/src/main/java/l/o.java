...
public abstract class o<ResponseT, ReturnT> extends i0<ReturnT> {
    ...
    public final l<i0, ResponseT> f7208c;
    ...
    public static final class a<ResponseT, ReturnT> extends o<ResponseT, ReturnT> {
        ...
        public a(f0 f0Var, f.a aVar, l<i0, ResponseT> lVar, e<ResponseT, ReturnT> eVar) {
    ...
    public static final class b<ResponseT> extends o<ResponseT, Object> {
        ...
        public b(f0 f0Var, f.a aVar, l<i0, ResponseT> lVar, e<ResponseT, d<ResponseT>> eVar, boolean z) {
            super(f0Var, aVar, lVar);
            this.f7210d = eVar;
            this.f7211e = z;
        }
    ...
    public static final class c<ResponseT> extends o<ResponseT, Object> {
        ...
        public c(f0 f0Var, f.a aVar, l<i0, ResponseT> lVar, e<ResponseT, d<ResponseT>> eVar) {
            super(f0Var, aVar, lVar);
            this.f7212d = eVar;
        }
    ...
    public o(f0 f0Var, f.a aVar, l<i0, ResponseT> lVar) {
        this.a = f0Var;
        this.b = aVar;
        this.f7208c = lVar;
    }
