...
public interface c {
    @e
    @m("/api/comic-lists")
    m.e<ComicList> a(@d HashMap<String, String> hashMap);

    @e
    @m("/api/guess-like")
    m.e<ComicList> b(@d HashMap<String, String> hashMap);

    @m("/cms/api/article/search/list")
    m.e<SpecialBean> c(@a g0 g0Var);

    @e
    @m("/api/special-lists")
    m.e<ComicList> d(@d HashMap<String, String> hashMap);
    ...
    @e
    @m("/api/view-module")
    m.e<ViewModel> g(@d HashMap<String, String> hashMap);
    ...
    @e
    @m("/api/comic-image")
    m.e<AnimeRead> m(@d HashMap<String, String> hashMap);
}
