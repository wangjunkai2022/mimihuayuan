...
public class b {
    ...
    public static String f3842c = e.a("dicw");

    /* renamed from: d  reason: collision with root package name */
    public static String f3843d = SignHelper.getMM2(App.b);

    public static String a(String str) {
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(f3843d.getBytes(e.a("QhYFSVM=")), f3842c);
            IvParameterSpec ivParameterSpec = new IvParameterSpec(a.getBytes(e.a("QhYFSVM=")));
            Cipher instance = Cipher.getInstance(b);
            instance.init(1, secretKeySpec, ivParameterSpec);
            byte[] doFinal = instance.doFinal(str.getBytes(Charset.forName(e.a("QhYFSVM="))));
    ...
    public static String b(String str) {
        try {
            ...
            return new String(instance.doFinal(bArr), e.a("QhYFSVM="));
        } catch (Exception e2) {
            e2.printStackTrace();
            return "";
        }
