...
public class e implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        if (S != null) {
            ...
            w.a d2 = S.f6433d.d();
            String str2 = "";
            String replace = new URL(aVar.S().b.f6779j).getPath().replaceFirst(f.e.a.e.a("GA=="), str2).replace(f.e.a.e.a("GA=="), f.e.a.e.a("Gw=="));
            ...
            if (valueOf != null) {
                ...
                d2.a(a2, str2);
                if (xVar != null) {
                    return aVar.d(new e0(xVar, str, d2.d(), g0Var, b.E(linkedHashMap)));
                }
