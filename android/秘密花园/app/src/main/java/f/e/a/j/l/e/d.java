...
public class d implements y {
    static {
        e.a("UhspVQhBb0orVFgMMQAMWHoIIhwmGVIHPTVDDhotJRFTJRsSMUFVRjoMWx82ADpYejYuUCYJbEQVNxpfHg9UDVUDUVxcRF0DQVFQVkhSAlgAUFtWW0JdC0IDVUlBCVQKAAdWB1hBAANEUQ1eGQtWXwYBUl1dQgFSRlMMARpdVl8BWlIHWUAAVkZVV1RKDwEIVQdXVw==");
    }
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        String replace = str.replace(e.a("GBIPBRJdVAAGXgs="), e.a("GBIPBRJM"));
        e0 S = aVar.S();
        if (S != null) {
