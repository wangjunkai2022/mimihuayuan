...
public class c implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        if (S != null) {
            ...
            String str4 = aVar.S().b.f6779j;
            f.a();
            String str5 = "";
            String replace = str4.replace(b.c().b(), str5);
            if (!replace.contains(e.a("CA==")) || replace.contains(e.a("GAUUSxkWSh4RCVYIVwgMREFTTAUbGhZSAxZrFR0ZDB5FAQYX")) || replace.contains(e.a("GAUUSxkWSh4RCVYIVwgMREFQTAUbGhZBEghfOBoFAhlTEUwTDhZS")) || replace.contains(e.a("GAUUSxkWSh4RCVYIVwgMREFQTAUbGhZBEghfOBoFAhlTEUwJBB1NWw=="))) {
                ...
                String str6 = split[0];
                String str7 = split[1];
                str = (new String(Base64.encode(str6.getBytes(), 2)) + e.a("aA==") + new String(Base64.encode(str7.getBytes(), 2))).replace(e.a("Cg=="), str5);
            }
            g0 g0Var = aVar.S().f6434e;
            if (g0Var != null) {
                g gVar = new g();
                g0Var.e(gVar);
                str2 = gVar.I();
            ...
            try {
                ...
                String a2 = e.a("VhcXDAQBUEkSEl0IFg==");
                b c2 = b.c();
                if (!TextUtils.isEmpty(c2.f3825c)) {
                    str5 = e.a("dQcCFg4BGQ==") + c2.f3825c;
                }
                aVar2.a(a2, str5);
                ...
                if (e.a("VQMQAV1H").equals(e2)) {
                    ...
                    try {
                        ...
                        H = new String(instance.doFinal(Base64.decode(H, 2)));
                    } catch (Exception e4) {
                        e4.printStackTrace();
                    }
                    str3 = H;
                }
                i0 F = i0.F(str3, d2.f6452h.E());
                e0 e0Var = d2.b;
                c0 c0Var = d2.f6447c;
                int i3 = d2.f6449e;
                String str8 = d2.f6448d;
                v vVar = d2.f6450f;
                w.a d3 = d2.f6451g.d();
                h0 h0Var = d2.f6453i;
                h0 h0Var2 = d2.f6454j;
                ...
                if (!(i3 >= 0)) {
                    ...
                    return new h0(e0Var, c0Var, str8, i3, vVar, d3.d(), F, h0Var, h0Var2, h0Var3, j2, j3, cVar);
                } else {
