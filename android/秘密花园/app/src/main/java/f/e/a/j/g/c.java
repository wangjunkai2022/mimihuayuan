...
public class c extends j<VideoList> {
    ...
    public final /* synthetic */ MovieDetailActivity f3863e;

    public c(MovieDetailActivity movieDetailActivity) {
        this.f3863e = movieDetailActivity;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v1, resolved type: f.e.a.k.g */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // m.j
    public void f(VideoList videoList) {
        Video video = videoList.getData().get(0);
        this.f3863e.ivCollect.setTag(video.newRealm());
        this.f3863e.tvTitle.setText(video.getMovName());
        this.f3863e.tvIntro.setText(video.getMovDesc());
        this.f3863e.tvDetail.setText(video.getDetail());
        MovieDetailActivity movieDetailActivity = this.f3863e;
        RealmVideo realmVideo = (RealmVideo) movieDetailActivity.ivCollect.getTag();
        if (g.d(realmVideo.getRealm()).b(realmVideo.getClass(), e.a("XgY="), String.valueOf(realmVideo.getId()))) {
        ...
        MovieDetailActivity movieDetailActivity2 = this.f3863e;
