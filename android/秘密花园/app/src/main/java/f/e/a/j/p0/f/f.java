...
public class f implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        if (S != null) {
            ...
            String a = e.a("QwsOARgHWF4D");
            String valueOf = String.valueOf(currentTimeMillis);
            if (valueOf != null) {
                d2.a(a, valueOf);
                String a2 = e.a("RAsECg==");
                try {
                    str = new String(b(MessageDigest.getInstance(e.a("eiZW")).digest((currentTimeMillis + e.a("VAECUQkSXwQSBAZXHl1XXgdSOi0+O3BmOwpZCxMACQcFUlAFUkBdBEFQBFZAWVVdBlM=")).getBytes(e.a("YjYlSVM=")))));
                } catch (UnsupportedEncodingException | NoSuchAlgorithmException unused) {
                    str = "";
                }
                d2.a(a2, str);
                if (xVar != null) {
                    h0 d3 = aVar.d(new e0(xVar, str2, d2.d(), g0Var, b.E(linkedHashMap)));
                    String H = d3.f6452h.H();
                    try {
                        String string = new JSONObject(H).getString(e.a("UwMXBQ=="));
                        String a3 = a.a(string);
                        H = H.replace(e.a("FQ==") + string + e.a("FQ=="), a3);
                    } catch (Exception e2) {
                        e2.printStackTrace();
                    }
