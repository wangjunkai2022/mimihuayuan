...
public class f extends j<ComicDetailBean> {
    ...
    public final /* synthetic */ ComicReadActivity f3888e;

    public f(ComicReadActivity comicReadActivity) {
        this.f3888e = comicReadActivity;
    }
    ...
    public void e(Throwable th) {
        h.n1(e.a("0MnDjOHx3YzSgLXIkOTUjrj0hsDam42W"));
    }
    ...
    public void f(ComicDetailBean comicDetailBean) {
        ...
        this.f3888e.f580f = comicDetailBean2;
        if (!comicDetailBean2.isSucc()) {
            h.n1(comicDetailBean2.getMsg());
        }
        ComicReadActivity comicReadActivity = this.f3888e;
