...
public final class l implements d0, n.a, j.b {
    ...
    public l(i iVar, j jVar, h hVar, @Nullable i0 i0Var, b0 b0Var, f0.a aVar, e eVar, v vVar, boolean z, boolean z2) {
        this.a = iVar;
        this.b = jVar;
        this.f5047c = hVar;
        this.f5048d = i0Var;
    ...
    public static f.i.a.a.b0 p(f.i.a.a.b0 b0Var, f.i.a.a.b0 b0Var2, boolean z) {
        ...
        return f.i.a.a.b0.g(b0Var.a, str3, b0Var.f4012h, r.c(str2), str2, z ? b0Var.f4009e : -1, i4, -1, null, i3, i2, str);
    }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:136:0x008b */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:105:0x02c0  */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x038a A[LOOP:9: B:125:0x0384->B:127:0x038a, LOOP_END] */
    ...
    public List<c0> n(List<f.i.a.a.j1.j> list) {
        ...
        int i3;
        l lVar = this;
        f.i.a.a.h1.u0.t.e eVar = ((c) lVar.b).f5089l;
        h.t(eVar);
