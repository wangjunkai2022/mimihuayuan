...
public final class a {
    ...
    /* loaded from: classes.dex */
    public static final class C0086a implements GenericArrayType, Serializable {
        public final Type a;

        public C0086a(Type type) {
            this.a = a.a(type);
        }
    ...
    public static final class b implements ParameterizedType, Serializable {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f6008c = typeArr2;
            int length = typeArr2.length;
            for (int i2 = 0; i2 < length; i2++) {
                h.u(this.f6008c[i2]);
                a.b(this.f6008c[i2]);
                Type[] typeArr3 = this.f6008c;
        ...
        @Override // java.lang.Object
        public int hashCode() {
            int hashCode = Arrays.hashCode(this.f6008c) ^ this.b.hashCode();
            Type type = this.a;
        ...
        public String toString() {
            ...
            sb.append("<");
            sb.append(a.i(this.f6008c[0]));
            for (int i2 = 1; i2 < length; i2++) {
                sb.append(", ");
                sb.append(a.i(this.f6008c[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            boolean z = true;
            h.p(typeArr2.length <= 1);
            h.p(typeArr.length == 1);
            if (typeArr2.length == 1) {
                h.u(typeArr2[0]);
                a.b(typeArr2[0]);
                h.p(typeArr[0] != Object.class ? false : z);
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            return cls.isArray() ? new C0086a(a(cls.getComponentType())) : cls;
        } else if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
            return new C0086a(((GenericArrayType) type).getGenericComponentType());
        } else {
    ...
    public static void b(Type type) {
        h.p(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:89:0x004b */
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (type2 instanceof Class) {
                    ...
                    if (cls3.isArray()) {
                        ...
                        return componentType == h2 ? cls3 : new C0086a(h2);
                    }
                }
                if (type2 instanceof GenericArrayType) {
                    ...
                    return genericComponentType == h3 ? genericArrayType : new C0086a(h3);
