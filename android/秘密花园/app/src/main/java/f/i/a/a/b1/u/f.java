...
import f.i.a.a.d1.i.h;
import f.i.a.a.d1.i.i;
import f.i.a.a.d1.i.l;
...
public final class f {
    ...
    public static b0 a(int i2, b0 b0Var, @Nullable a aVar, @Nullable a aVar2, j jVar) {
        if (i2 == 1) {
            if (jVar.a()) {
            ...
            while (true) {
                ...
                if (bVar instanceof e) {
                    ...
                    if ("com.android.capture.fps".equals(eVar.a) && eVar.f4187d == 23) {
                        try {
                            b0Var = b0Var.b(ByteBuffer.wrap(eVar.b).asFloatBuffer().get()).e(new a(eVar));
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0033 A[Catch: all -> 0x01d7, TRY_LEAVE, TryCatch #0 {all -> 0x01d7, blocks: (B:6:0x001c, B:8:0x0020, B:10:0x0026, B:12:0x002b, B:15:0x0033, B:19:0x003d, B:21:0x0041, B:24:0x004b, B:26:0x004f, B:29:0x0059, B:31:0x005f, B:34:0x0069, B:36:0x006d, B:39:0x0077, B:41:0x007b, B:44:0x0083, B:46:0x0087, B:49:0x0091, B:51:0x0095, B:54:0x009f, B:56:0x00a3, B:59:0x00ad, B:61:0x00b1, B:64:0x00bb, B:66:0x00bf, B:69:0x00c9, B:71:0x00cd, B:74:0x00d7, B:76:0x00db, B:79:0x00e5, B:81:0x00e9, B:84:0x00f3, B:86:0x00f7, B:89:0x0101, B:91:0x0105, B:94:0x010f, B:96:0x0113, B:100:0x011f, B:102:0x0123, B:104:0x012f, B:105:0x0142, B:108:0x0149, B:110:0x014d, B:113:0x0153, B:115:0x0157, B:118:0x015c, B:120:0x0160, B:123:0x016a, B:125:0x016e, B:128:0x0178, B:130:0x017c, B:133:0x0186, B:135:0x018a, B:138:0x0194, B:140:0x0198, B:143:0x01a2, B:145:0x01a6, B:148:0x01ae, B:150:0x01b2, B:153:0x01bc, B:156:0x01c3, B:159:0x01cd), top: B:165:0x0014 }] */
    ...
    @Nullable
    public static l d(int i2, String str, u uVar) {
        int d2 = uVar.d();
    ...
    @Nullable
    public static h e(u uVar, int i2) {
        String str = null;
        String str2 = null;
        int i3 = -1;
        int i4 = -1;
        ...
        uVar.A(i3);
        uVar.B(16);
        return new i(str, str2, uVar.l(i4 - 16));
    }
    ...
    @Nullable
    public static l g(int i2, String str, u uVar) {
        int d2 = uVar.d();
        if (uVar.d() == a.T0) {
            uVar.B(8);
            return new l(str, null, uVar.l(d2 - 16));
        }
        a.a(i2);
        return null;
    }
    ...
    @Nullable
    public static h h(int i2, String str, u uVar, boolean z2, boolean z3) {
        int i3 = i(uVar);
        if (z3) {
            i3 = Math.min(1, i3);
        }
        if (i3 < 0) {
            ...
            return new l(str, null, Integer.toString(i3));
        } else {
            return new e("und", str, Integer.toString(i3));
        }
    }
