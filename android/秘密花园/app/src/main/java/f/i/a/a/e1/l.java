...
public class l implements x {
    ...
    public static final Constructor<? extends v> f4633c;
    @Nullable

    /* renamed from: d  reason: collision with root package name */
    public static final Constructor<? extends v> f4634d;
    public final w a;
    ...
    public v a(u uVar) {
        ...
        if (c2 == 0) {
            return new a0(uVar.f4688c, uVar.f4690e, this.a);
        }
        if (c2 == 1) {
            return b(uVar, b);
        }
        if (c2 == 2) {
            return b(uVar, f4633c);
        }
        if (c2 == 3) {
            return b(uVar, f4634d);
        }
        StringBuilder o = a.o("Unsupported type: ");
        o.append(uVar.b);
    ...
    public final v b(u uVar, @Nullable Constructor<? extends v> constructor) {
        if (constructor != null) {
            try {
                return (v) constructor.newInstance(uVar.f4688c, uVar.f4689d, this.a);
            } catch (Exception e2) {
                StringBuilder o = a.o("Failed to instantiate downloader for: ");
                o.append(uVar.b);
                throw new RuntimeException(o.toString(), e2);
            }
        } else {
            StringBuilder o2 = a.o("Module missing for: ");
            o2.append(uVar.b);
