...
public final class k implements d0 {
    ...
    public static final String f4629e = f(3, 4);

    /* renamed from: f  reason: collision with root package name */
    public static final String[] f4630f = {"id", NotificationCompatJellybean.KEY_TITLE, "uri", "stream_keys", "custom_cache_key", "data", "state", "start_time_ms", "update_time_ms", "content_length", "stop_reason", "failure_reason", "percent_downloaded", "bytes_downloaded"};
    public final String a = "";
    public final String b = "ExoPlayerDownloads";

    /* renamed from: c  reason: collision with root package name */
    public final f.i.a.a.x0.b f4631c;
    ...
    public final void a() throws f.i.a.a.x0.a {
        if (!this.f4632d) {
            try {
                if (h.a0(((SQLiteOpenHelper) this.f4631c).getReadableDatabase(), 0, this.a) != 2) {
                    SQLiteDatabase writableDatabase = ((SQLiteOpenHelper) this.f4631c).getWritableDatabase();
                    writableDatabase.beginTransaction();
                    h.l1(writableDatabase, 0, this.a, 2);
    ...
    public final Cursor b(String str, @Nullable String[] strArr) throws f.i.a.a.x0.a {
        try {
            return ((SQLiteOpenHelper) this.f4631c).getReadableDatabase().query(this.b, f4630f, str, strArr, null, null, "start_time_ms ASC");
    ...
    public void g(m mVar) throws f.i.a.a.x0.a {
        ...
        contentValues.put("uri", mVar.a.f4688c.toString());
        List<c0> list = mVar.a.f4689d;
        ...
        contentValues.put("custom_cache_key", mVar.a.f4690e);
        contentValues.put("data", mVar.a.f4691f);
        contentValues.put("state", Integer.valueOf(mVar.b));
        contentValues.put("start_time_ms", Long.valueOf(mVar.f4635c));
        contentValues.put("update_time_ms", Long.valueOf(mVar.f4636d));
        contentValues.put("content_length", Long.valueOf(mVar.f4637e));
        contentValues.put("stop_reason", Integer.valueOf(mVar.f4638f));
        contentValues.put("failure_reason", Integer.valueOf(mVar.f4639g));
        contentValues.put("percent_downloaded", Float.valueOf(mVar.f4640h.b));
        contentValues.put("bytes_downloaded", Long.valueOf(mVar.f4640h.a));
        try {
            ((SQLiteOpenHelper) this.f4631c).getWritableDatabase().replaceOrThrow(this.b, null, contentValues);
        } catch (SQLiteException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
    ...
    public void h() throws f.i.a.a.x0.a {
        ...
        try {
            ...
            ((SQLiteOpenHelper) this.f4631c).getWritableDatabase().update(this.b, contentValues, "state = 2", null);
        } catch (SQLException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
    ...
    public void i(int i2) throws f.i.a.a.x0.a {
        ...
        try {
            ...
            ((SQLiteOpenHelper) this.f4631c).getWritableDatabase().update(this.b, contentValues, f4629e, null);
        } catch (SQLException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
    ...
    public void j(String str, int i2) throws f.i.a.a.x0.a {
        ...
        try {
            ...
            SQLiteDatabase writableDatabase = ((SQLiteOpenHelper) this.f4631c).getWritableDatabase();
            String str2 = this.b;
            writableDatabase.update(str2, contentValues, f4629e + " AND id = ?", new String[]{str});
        } catch (SQLException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
