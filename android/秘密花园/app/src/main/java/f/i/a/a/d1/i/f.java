...
public final class f extends h {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        f fVar = (f) obj;
        if (!h0.b(this.b, fVar.b) || !h0.b(this.f4568c, fVar.f4568c) || !h0.b(this.f4569d, fVar.f4569d) || !Arrays.equals(this.f4570e, fVar.f4570e)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return Arrays.hashCode(this.f4570e) + ((hashCode2 + i2) * 31);
    }
