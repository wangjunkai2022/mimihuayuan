...
public final class w extends k {
    ...
    public static final Pattern f5596g = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)\\.v1\\.exo$", 32);

    /* renamed from: h  reason: collision with root package name */
    public static final Pattern f5597h = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)\\.v2\\.exo$", 32);

    /* renamed from: i  reason: collision with root package name */
    public static final Pattern f5598i = Pattern.compile("^(\\d+)\\.(\\d+)\\.(\\d+)\\.v3\\.exo$", 32);
    ...
    public static f.i.a.a.l1.k0.w b(java.io.File r16, long r17, long r19, f.i.a.a.l1.k0.n r21) {
        /*
            ...
            java.lang.String r1 = r16.getName()
            java.util.regex.Pattern r2 = f.i.a.a.l1.k0.w.f5597h
            ...
            goto L_0x0039
        L_0x002d:
            java.util.regex.Pattern r2 = f.i.a.a.l1.k0.w.f5596g
            java.util.regex.Matcher r2 = r2.matcher(r1)
        ...
        L_0x0070:
            ...
            r15 = r2
        L_0x0073:
            java.util.regex.Pattern r2 = f.i.a.a.l1.k0.w.f5598i
