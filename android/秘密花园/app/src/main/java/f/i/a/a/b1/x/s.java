...
public final class s extends f.i.a.a.b1.a {
    ...
    public static final class b implements a.g {
        ...
        public a.f a(d dVar, long j2, a.c cVar) throws IOException, InterruptedException {
            int f2;
            long j3 = dVar.f4042d;
            int min = (int) Math.min(20000L, dVar.f4041c - j3);
            this.b.w(min);
                        ...
                        if (uVar.a() >= p) {
                            ...
                            if (uVar.a() >= 4) {
                                ...
                                while (true) {
                                    ...
                                    uVar.A(Math.min(uVar.f5701c, uVar.b + uVar.u()));
                                }
                            } else {
                                uVar.A(i4);
                            }
            ...
            if (j4 != -9223372036854775807L) {
                return new a.f(-2, j4, j3 + ((long) i2));
            }
            return a.f.f4031d;
        }
    ...
    public s(e0 e0Var, long j2, long j3) {
        super(new a.b(), new b(e0Var, null), j2, 0, j2 + 1, 0, j3, 188, 1000);
    }
