...
public abstract class b extends p {
    ...
    public final c f4527j;
    public boolean j0;
    @Nullable

    /* renamed from: k  reason: collision with root package name */
    public final g<j> f4528k;
    public boolean k0;
    ...
    public final int F(b0 b0Var) throws w {
        try {
            return k0(this.f4527j, this.f4528k, b0Var);
        } catch (d.c e2) {
    ...
    public abstract int I(MediaCodec mediaCodec, a aVar, b0 b0Var, b0 b0Var2);

    public abstract void J(a aVar, MediaCodec mediaCodec, b0 b0Var, MediaCrypto mediaCrypto, float f2);
    ...
    public final List<a> O(boolean z) throws d.c {
        List<a> R = R(this.f4527j, this.u, z);
        if (R.isEmpty() && z) {
            R = R(this.f4527j, this.u, false);
            if (!R.isEmpty()) {
                StringBuilder o = f.b.a.a.a.o("Drm session requires secure decoder for ");
                o.append(this.u.f4013i);
    ...
    public abstract List<a> R(c cVar, b0 b0Var, boolean z) throws d.c;
    ...
    public final void S(a aVar, MediaCrypto mediaCrypto) throws Exception {
        ...
        if (h0.a < 23) {
            ...
            f2 = Q(this.B, this.u, this.f5762f);
        }
        float f3 = f2 <= this.n ? -1.0f : f2;
        try {
        ...
        try {
            h.N();
            h.g("configureCodec");
            J(aVar, mediaCodec, this.u, mediaCrypto, f3);
            h.N();
            h.g("startCodec");
            mediaCodec.start();
            h.N();
            ...
            this.E = f3;
            this.D = this.u;
            if (h0.a > 25 || !"OMX.Exynos.avc.dec.secure".equals(str) || (!h0.f5663d.startsWith("SM-T585") && !h0.f5663d.startsWith("SM-A510") && !h0.f5663d.startsWith("SM-A520") && !h0.f5663d.startsWith("SM-J700"))) {
            ...
            this.I = i2;
            this.J = h0.f5663d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(str);
            this.K = h0.a < 21 && this.D.f4015k.isEmpty() && "OMX.MTK.VIDEO.DECODER.AVC".equals(str);
            int i3 = h0.a;
            this.L = i3 < 18 || (i3 == 18 && ("OMX.SEC.avc.dec".equals(str) || "OMX.SEC.avc.dec.secure".equals(str))) || (h0.a == 19 && h0.f5663d.startsWith("SM-G800") && ("OMX.Exynos.avc.dec".equals(str) || "OMX.Exynos.avc.dec.secure".equals(str)));
            ...
            String str2 = aVar.a;
            this.R = ((h0.a <= 25 && "OMX.rk.video_decoder.avc".equals(str2)) || ((h0.a <= 17 && "OMX.allwinner.video.decoder.avc".equals(str2)) || ("Amazon".equals(h0.f5662c) && "AFTS".equals(h0.f5663d) && aVar.f4524f))) || P();
            f0();
            g0();
            this.U = this.f5760d == 2 ? SystemClock.elapsedRealtime() + 1000 : -9223372036854775807L;
            this.a0 = false;
            this.b0 = 0;
            this.f0 = false;
            this.e0 = false;
    ...
    public final void T() throws w {
        if (this.C == null && this.u != null) {
            ...
            if (fVar != null) {
                ...
                if (this.y == null) {
                    ...
                    if (a2 != null) {
                        try {
                            ...
                            this.y = mediaCrypto;
                            this.z = !a2.f6002c && mediaCrypto.requiresSecureDecoderComponent(str);
                ...
                if ("Amazon".equals(h0.f5662c) && ("AFTM".equals(h0.f5663d) || "AFTB".equals(h0.f5663d))) {
                    z = true;
                }
                if (z) {
                    int c2 = this.w.c();
                    if (c2 == 1) {
                        throw w.a(this.w.b(), this.f5759c);
                    } else if (c2 != 4) {
                        return;
                    }
                }
            ...
            while (this.C == null) {
                ...
                if (j0(peekFirst)) {
                    try {
                        ...
                        a aVar = new a("Decoder init failed: " + str2 + ", " + b0Var, e3, b0Var.f4013i, z, str2, (h0.a < 21 || !(e3 instanceof MediaCodec.CodecException)) ? null : ((MediaCodec.CodecException) e3).getDiagnosticInfo(), null);
                        a aVar2 = this.G;
                        if (aVar2 == null) {
                            this.G = aVar;
                        } else {
                            this.G = new a(aVar2.getMessage(), aVar2.getCause(), aVar2.a, aVar2.b, aVar2.f4531c, aVar2.f4532d, aVar);
                        }
                        if (this.F.isEmpty()) {
                            throw this.G;
                        }
    ...
    public boolean d() {
        ...
        if (!(g() ? this.f5765i : this.f5761e.d())) {
    ...
    public final void h0(@Nullable f<j> fVar) {
        ...
        if (fVar2 != null && fVar2 != this.x && fVar2 != fVar) {
            ((f.i.a.a.z0.d) this.f4528k).b(fVar2);
        }
    }

    /* JADX WARNING: Removed duplicated region for block: B:108:0x01be A[LOOP:0: B:14:0x0027->B:108:0x01be, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:193:0x0345  */
    /* JADX WARNING: Removed duplicated region for block: B:226:0x03ff  */
    /* JADX WARNING: Removed duplicated region for block: B:237:0x043a A[DONT_GENERATE] */
    /* JADX WARNING: Removed duplicated region for block: B:254:0x041e A[EDGE_INSN: B:254:0x041e->B:233:0x041e ?: BREAK  , SYNTHETIC] */
    @Override // f.i.a.a.p0
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public final void l(float f2) throws w {
        this.B = f2;
        if (this.C != null && this.d0 != 3 && this.f5760d != 0) {
            l0();
        }
    }
    ...
    public final void l0() throws w {
        if (h0.a >= 23) {
            float Q = Q(this.B, this.D, this.f5762f);
            float f2 = this.E;
            if (f2 != Q) {
                if (Q == -1.0f) {
                    K();
    ...
    public final b0 n0(long j2) {
        ...
        synchronized (d0Var) {
            b0Var = null;
            while (d0Var.f5660d > 0 && j2 - d0Var.a[d0Var.f5659c] >= 0) {
                b0[] b0VarArr = d0Var.b;
                int i2 = d0Var.f5659c;
                b0 b0Var2 = b0VarArr[i2];
                b0VarArr[i2] = null;
                d0Var.f5659c = (i2 + 1) % b0VarArr.length;
                d0Var.f5660d--;
                b0Var = b0Var2;
            }
        }
    ...
    public static class a extends Exception {
        ...
        public a(f.i.a.a.b0 r11, java.lang.Throwable r12, boolean r13, int r14) {
            /*
                ...
                java.lang.String r5 = r11.f4013i
