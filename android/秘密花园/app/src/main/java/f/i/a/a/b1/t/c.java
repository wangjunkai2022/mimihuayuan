...
public final class c implements d.a {
    ...
    public c(long[] jArr, long[] jArr2) {
        this.a = jArr;
        this.b = jArr2;
        this.f4125c = q.a(jArr2[jArr2.length - 1]);
    }
    ...
    public static Pair<Long, Long> a(long j2, long[] jArr, long[] jArr2) {
        ...
        long j5 = jArr[i2];
        return Pair.create(Long.valueOf(j2), Long.valueOf(((long) ((j5 == j3 ? 0.0d : (((double) j2) - ((double) j3)) / ((double) (j5 - j3))) * ((double) (jArr2[i2] - j4)))) + j4));
    }
    ...
    public n.a h(long j2) {
        Pair<Long, Long> a = a(q.b(h0.p(j2, 0, this.f4125c)), this.b, this.a);
