...
public final class i {
    ...
    public static final int[] f5672c = {0, 1, 2, 3, 4, 5, 6, 8, -1, -1, -1, 7, 8, -1, 8, -1};
    ...
    public static Pair<Integer, Integer> d(t tVar, boolean z) throws h0 {
        int f2 = tVar.f(5);
        if (f2 == 31) {
            f2 = tVar.f(6) + 32;
        }
            ...
            if (!(f2 == 1 || f2 == 2 || f2 == 3 || f2 == 4 || f2 == 6 || f2 == 7 || f2 == 17)) {
                switch (f2) {
                    ...
                    case 23:
                        break;
                    default:
                        throw new h0(a.J("Unsupported audio object type: ", f2));
                }
            }
            tVar.l(1);
            if (tVar.e()) {
            ...
            if (f3 != 0) {
                ...
                switch (f2) {
                    ...
                    case 23:
                        int f5 = tVar.f(2);
                        if (f5 == 2 || f5 == 3) {
                            throw new h0(a.J("Unsupported epConfig: ", f5));
                        }
                }
            } else {
    ...
    public static Pair<Integer, Integer> e(byte[] bArr) throws h0 {
