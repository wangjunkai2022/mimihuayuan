...
public final class a extends h {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        a aVar = (a) obj;
        if (this.f4555d != aVar.f4555d || !h0.b(this.b, aVar.b) || !h0.b(this.f4554c, aVar.f4554c) || !Arrays.equals(this.f4556e, aVar.f4556e)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return Arrays.hashCode(this.f4556e) + ((hashCode + i3) * 31);
    }
