...
public final class v implements b {
    ...
    public final HashMap<String, ArrayList<b.AbstractC0081b>> f5590e;
    ...
    public static void l(v vVar) {
        ...
        if (vVar.a.exists() || vVar.a.mkdirs()) {
            ...
            if (listFiles == null) {
                StringBuilder o = a.o("Failed to list cache directory files: ");
                o.append(vVar.a);
            ...
            if (j2 == -1) {
                try {
                    ...
                    StringBuilder o2 = a.o("Failed to create cache UID: ");
                    o2.append(vVar.a);
                    vVar.f5595j = new b.a(o2.toString(), e2);
                    return;
                }
            }
            try {
                ...
                StringBuilder o3 = a.o("Failed to initialize cache indices: ");
                o3.append(vVar.a);
                vVar.f5595j = new b.a(o3.toString(), e3);
            }
        } else {
            StringBuilder o4 = a.o("Failed to create cache directory: ");
            o4.append(vVar.a);
            vVar.f5595j = new b.a(o4.toString());
        }
    }
    ...
    public static long o(File file) throws IOException {
        ...
        File file2 = new File(file, a.f(Long.toString(j2, 16), ".uid"));
    ...
    public final void m(w wVar) {
        ...
        ArrayList<b.AbstractC0081b> arrayList = this.f5590e.get(wVar.a);
        if (arrayList != null) {
    ...
    public final void q(k kVar) {
        ...
        if (c2 != null) {
            ...
            if (z) {
                ...
                this.f5588c.f(c2.b);
                ArrayList<b.AbstractC0081b> arrayList = this.f5590e.get(kVar.a);
                if (arrayList != null) {
                    int size = arrayList.size();
                    while (true) {
                        size--;
    ...
    public synchronized w i(String str, long j2) throws b.a {
        ...
        m mVar = this.f5588c.a.get(str);
        if (mVar == null) {
            wVar = new w(str, j2, -1, -9223372036854775807L, null);
        } else {
            while (true) {
                b = mVar.b(j2);
