...
public final class g implements f.i.a.a.d1.b {
    ...
    public static a d(u uVar, int i2, int i3) throws UnsupportedEncodingException {
        String str;
        int i4;
        int p = uVar.p();
        String s = s(p);
        ...
        int i6 = i4 + 2;
        int u = u(bArr, i6, p);
        return new a(str, new String(bArr, i6, u - i6, s), bArr[i4 + 1] & 255, b(bArr, r(p) + u, i5));
    }

    public static b e(u uVar, int i2, String str) {
    ...
    public static c f(u uVar, int i2, int i3, boolean z, int i4, @Nullable a aVar) throws UnsupportedEncodingException {
        ...
        int d3 = uVar.d();
        long q = uVar.q();
        long j2 = q == 4294967295L ? -1 : q;
        long q2 = uVar.q();
        long j3 = q2 == 4294967295L ? -1 : q2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:131:0x017f, code lost:
        if (r13 == 67) goto L_0x0181;
     */
    ...
    public static boolean x(f.i.a.a.m1.u r18, int r19, int r20, boolean r21) {
        ...
        L_0x0006:
            ...
            int r7 = r18.d()     // Catch: all -> 0x00ab
            long r8 = r18.q()     // Catch: all -> 0x00ab
            int r10 = r18.u()     // Catch: all -> 0x00ab
            goto L_0x002a
        L_0x0020:
            int r7 = r18.r()     // Catch: all -> 0x00ab
            int r8 = r18.r()     // Catch: all -> 0x00ab
            long r8 = (long) r8
            r10 = 0
        L_0x002a:
            r11 = 0
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x003b, code lost:
        if (((r7 & 64) != 0) != false) goto L_0x0083;
     */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x0086 A[RETURN] */
