...
public class g<T extends h> implements k0, l0, c0.b<d>, c0.f {
    ...
    public final ArrayList<a> f4893k;

    /* renamed from: l  reason: collision with root package name */
    public final List<a> f4894l;
    ...
    public final class a implements k0 {
        ...
        @Override // f.i.a.a.h1.k0
        public int i(f.i.a.a.c0 c0Var, e eVar, boolean z) {
            if (g.this.y()) {
                return -3;
            }
            b();
    ...
    public long e() {
        ...
        if (!w.d()) {
            if (this.f4893k.size() > 1) {
                ArrayList<a> arrayList = this.f4893k;
