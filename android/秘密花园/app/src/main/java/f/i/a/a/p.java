...
public abstract class p implements p0 {
    ...
    public static boolean G(@Nullable g<?> gVar, @Nullable e eVar) {
        if (eVar == null) {
            return true;
        }
        if (gVar == null) {
        ...
        if (!((ArrayList) d.a(eVar, null, true)).isEmpty() || (eVar.f5997d == 1 && eVar.a[0].b(q.b))) {
            String str = eVar.f5996c;
            if (str == null || "cenc".equals(str)) {
                return true;
            }
            if ((!"cbc1".equals(str) && !"cbcs".equals(str) && !"cens".equals(str)) || h0.a >= 25) {
                return true;
            }
        }
        return false;
    ...
    @Override // f.i.a.a.p0
    public final void h(q0 q0Var, b0[] b0VarArr, k0 k0Var, long j2, boolean z, long j3) throws w {
        h.v(this.f5760d == 0);
        this.b = q0Var;
        this.f5760d = 1;
        y(z);
    ...
    @Override // f.i.a.a.p0
    public final void w(b0[] b0VarArr, k0 k0Var, long j2) throws w {
        h.v(!this.f5765i);
        this.f5761e = k0Var;
        this.f5764h = j2;
        this.f5762f = b0VarArr;
