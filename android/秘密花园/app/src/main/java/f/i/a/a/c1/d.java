...
public final class d {
    ...
    public static final HashMap<b, List<a>> b = new HashMap<>();
    ...
    public static final class b {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            b bVar = (b) obj;
            if (TextUtils.equals(this.a, bVar.a) && this.b == bVar.b && this.f4540c == bVar.f4540c) {
                return true;
            }
            return false;
        }
    ...
    /* loaded from: classes.dex */
    public interface AbstractC0059d {
    ...
    /* compiled from: MediaCodecUtil.java */
    /* loaded from: classes.dex */
    public static final class e implements AbstractC0059d {
        public e(a aVar) {
        }

        @Override // f.i.a.a.c1.d.AbstractC0059d
    ...
    @TargetApi(21)
    /* loaded from: classes.dex */
    public static final class f implements AbstractC0059d {
        public final int a;
    ...
    public static final class g implements Comparator<a> {
        ...
        public int compare(a aVar, a aVar2) {
            a aVar3 = aVar2;
            int i2 = 0;
            int i3 = aVar.a.startsWith("OMX.google") ? -1 : 0;
            if (aVar3.a.startsWith("OMX.google")) {
                i2 = -1;
            }
            return i3 - i2;
        }
    ...
    public static Pair<Integer, Integer> c(@Nullable String str) {
        ...
        switch (c2) {
            ...
            case 3:
                ...
                Integer num3 = f4535e.get(split[3]);
                if (num3 == null) {
                    return null;
                }
                return new Pair<>(Integer.valueOf(i7), num3);
            case 4:
            case 5:
                if (split.length < 3) {
                    return null;
                ...
                if (!matcher2.matches() || (num = f4536f.get(matcher2.group(1))) == null || (num2 = f4537g.get(split[2])) == null) {
                    return null;
                }
            ...
            case 6:
                if (split.length == 3) {
                    try {
                        if (!"audio/mp4a-latm".equals(r.d(Integer.parseInt(split[1], 16))) || (i6 = f4538h.get(Integer.parseInt(split[2]), -1)) == -1) {
                            return null;
                        }
    ...
    @Nullable
    public static a d(String str, boolean z, boolean z2) throws c {
    ...
    public static synchronized List<a> e(String str, boolean z, boolean z2) throws c {
        synchronized (d.class) {
            b bVar = new b(str, z, z2);
            List<a> list = b.get(bVar);
            if (list != null) {
                return list;
            }
            ArrayList<a> f2 = f(bVar, h0.a >= 21 ? new f(z, z2) : new e(null));
    ...
    public static ArrayList<a> f(b bVar, AbstractC0059d dVar) throws c {
        try {
            ...
            for (int i2 = 0; i2 < c2; i2++) {
                ...
                if (b2 != null) {
                    try {
                        ...
                        boolean d2 = dVar.d("tunneled-playback", b2, capabilitiesForType);
                        boolean b3 = dVar.b("tunneled-playback", b2, capabilitiesForType);
                        if ((bVar.f4540c || !b3) && (!bVar.f4540c || d2)) {
                            boolean d3 = dVar.d("secure-playback", b2, capabilitiesForType);
                            boolean b4 = dVar.b("secure-playback", b2, capabilitiesForType);
                            if ((bVar.b || !b4) && (!bVar.b || d3)) {
                                ...
                                if ((e2 && bVar.b == d3) || !(e2 || bVar.b)) {
                                    arrayList.add(a.f(name, str, b2, capabilitiesForType, z, false));
                                } else if (!e2 && d3) {
                                    arrayList.add(a.f(name + ".secure", str, b2, capabilitiesForType, z, true));
                                    return arrayList;
                                }
                            }
                        }
