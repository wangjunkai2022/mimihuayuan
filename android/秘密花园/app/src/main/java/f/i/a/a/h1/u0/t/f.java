...
public final class f extends g {
    ...
    public static final class a implements Comparable<Long> {
        ...
        public a(String str, @Nullable a aVar, String str2, long j2, int i2, long j3, @Nullable e eVar, @Nullable String str3, @Nullable String str4, long j4, long j5, boolean z) {
            this.a = str;
            this.b = aVar;
            this.f5124c = j2;
            this.f5125d = i2;
    ...
    public f(int i2, String str, List<String> list, long j2, long j3, boolean z, int i3, long j4, int i4, long j5, boolean z2, boolean z3, boolean z4, @Nullable e eVar, List<a> list2) {
        super(str, list, z2);
        long j6;
        this.f5114d = i2;
        this.f5116f = j3;
