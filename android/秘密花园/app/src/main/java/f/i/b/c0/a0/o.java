...
public final class o {
    ...
    public static final f.i.b.z<BitSet> f6030c;

    /* renamed from: d  reason: collision with root package name */
    public static final f.i.b.a0 f6031d;
    ...
    public static final f.i.b.z<Boolean> f6032e = new x();

    /* renamed from: f  reason: collision with root package name */
    public static final f.i.b.z<Boolean> f6033f = new y();

    /* renamed from: g  reason: collision with root package name */
    public static final f.i.b.a0 f6034g = new q(Boolean.TYPE, Boolean.class, f6032e);

    /* renamed from: h  reason: collision with root package name */
    public static final f.i.b.z<Number> f6035h = new z();

    /* renamed from: i  reason: collision with root package name */
    public static final f.i.b.a0 f6036i = new q(Byte.TYPE, Byte.class, f6035h);

    /* renamed from: j  reason: collision with root package name */
    public static final f.i.b.z<Number> f6037j = new a0();

    /* renamed from: k  reason: collision with root package name */
    public static final f.i.b.a0 f6038k = new q(Short.TYPE, Short.class, f6037j);

    /* renamed from: l  reason: collision with root package name */
    public static final f.i.b.z<Number> f6039l = new b0();

    /* renamed from: m  reason: collision with root package name */
    public static final f.i.b.a0 f6040m = new q(Integer.TYPE, Integer.class, f6039l);
    public static final f.i.b.z<Number> t = new b();
    public static final f.i.b.z<Number> u = new c();
    public static final f.i.b.z<Number> v = new d();
    public static final f.i.b.z<Character> y = new f();
    public static final f.i.b.a0 z = new q(Character.TYPE, Character.class, y);
    public static final f.i.b.z<String> A = new g();
    public static final f.i.b.z<BigDecimal> B = new h();
    public static final f.i.b.z<BigInteger> C = new i();
    public static final f.i.b.a0 D = new p(String.class, A);
    public static final f.i.b.a0 S = new r();
    public static final f.i.b.a0 Z = new w();
    ...
    public static class a extends f.i.b.z<AtomicIntegerArray> {
        ...
        public void b(f.i.b.e0.c cVar, AtomicIntegerArray atomicIntegerArray) throws IOException {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                cVar.N((long) atomicIntegerArray2.get(i2));
            }
            cVar.E();
        }
    }
    ...
    /* loaded from: classes.dex */
    public static class C0088o extends f.i.b.z<InetAddress> {
        /* Return type fixed from 'java.lang.Object' to match base method */
        @Override // f.i.b.z
    ...
    public static class s extends f.i.b.z<Calendar> {
        ...
        public void b(f.i.b.e0.c cVar, Calendar calendar) throws IOException {
            ...
            cVar.f();
            cVar.G("year");
            cVar.N((long) calendar2.get(1));
            cVar.G("month");
            cVar.N((long) calendar2.get(2));
            cVar.G("dayOfMonth");
            cVar.N((long) calendar2.get(5));
            cVar.G("hourOfDay");
            cVar.N((long) calendar2.get(11));
            cVar.G("minute");
            cVar.N((long) calendar2.get(12));
            cVar.G("second");
            cVar.N((long) calendar2.get(13));
            cVar.F();
        }
    }
    ...
    public static class u extends f.i.b.z<f.i.b.o> {
        ...
        public void b(f.i.b.e0.c cVar, f.i.b.o oVar) throws IOException {
            if (oVar == null || (oVar instanceof f.i.b.q)) {
                cVar.I();
            } else if (oVar instanceof f.i.b.t) {
                f.i.b.t b = oVar.b();
                Object obj = b.a;
    ...
    static {
        ...
        a = yVar;
        b = new p(Class.class, yVar);
        f.i.b.y yVar2 = new f.i.b.y(new v());
        f6030c = yVar2;
        f6031d = new p(BitSet.class, yVar2);
        f.i.b.y yVar3 = new f.i.b.y(new c0());
        n = yVar3;
        o = new p(AtomicInteger.class, yVar3);
        f.i.b.y yVar4 = new f.i.b.y(new d0());
        p = yVar4;
        q = new p(AtomicBoolean.class, yVar4);
        f.i.b.y yVar5 = new f.i.b.y(new a());
        r = yVar5;
        s = new p(AtomicIntegerArray.class, yVar5);
        e eVar = new e();
        w = eVar;
