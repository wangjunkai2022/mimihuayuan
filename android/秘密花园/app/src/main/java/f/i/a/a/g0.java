...
public final class g0 {
    ...
    public final f0 c(e0 e0Var, long j2) {
        ...
        if (f0Var.f4698f) {
            ...
            return e(n(obj, j4, j5), j8, j4);
        }
        e0.a aVar = f0Var.a;
        this.f4710d.h(aVar.a, this.a);
        if (aVar.b()) {
            int i3 = aVar.b;
            a.C0068a[] aVarArr = this.a.f5798f.f4853c;
            int i4 = aVarArr[i3].a;
            if (i4 == -1) {
                return null;
            }
            int a = aVarArr[i3].a(aVar.f4741c);
            if (a >= i4) {
    ...
    public final f0 f(Object obj, int i2, int i3, long j2, long j3) {
        ...
        return new f0(aVar, i3 == this.a.f5798f.f4853c[i2].a(-1) ? this.a.f5798f.f4854d : 0, j2, -9223372036854775807L, this.f4710d.h(aVar.a, this.a).a(aVar.b, aVar.f4741c), false, false);
    }
    ...
    public final f0 g(Object obj, long j2, long j3) {
        ...
        if (d2 == -9223372036854775807L || d2 == Long.MIN_VALUE) {
            j4 = this.a.f5796d;
        } else {
            j4 = d2;
        }
        return new f0(aVar, j2, -9223372036854775807L, d2, j4, z, j5);
    }
    ...
    public final boolean j(e0.a aVar, boolean z) {
        ...
        if (!(this.f4710d.d(b, this.a, this.b, this.f4711e, this.f4712f) == -1) || !z) {
            return false;
        }
        return true;
    }
