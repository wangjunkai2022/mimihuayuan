...
public class j0 implements p {
    ...
    public final u f4805e = new u(32);
    ...
    public void c(long j2, int i2, int i3, int i4, @Nullable p.a aVar) {
        ...
        long j4 = (this.f4813m - ((long) i3)) - ((long) i4);
    ...
    public final int r(int i2) {
        ...
        if (!aVar.f4814c) {
            ...
            synchronized (qVar) {
                qVar.f5612f++;
                if (qVar.f5613g > 0) {
                    d[] dVarArr = qVar.f5614h;
                    int i3 = qVar.f5613g - 1;
                    qVar.f5613g = i3;
                    dVar = dVarArr[i3];
                    qVar.f5614h[i3] = null;
                } else {
                    dVar = new d(new byte[qVar.b], 0);
                }
            }
    ...
    public int s(c0 c0Var, f.i.a.a.y0.e eVar, boolean z, boolean z2, long j2) {
        int i2;
        int i3;
        char c2;
        i0 i0Var = this.f4803c;
        b0 b0Var = this.f4809i;
            ...
            if (!eVar.h()) {
                ...
                if (!(eVar.f5955c == null && eVar.f5957e == 0)) {
                    if (eVar.f(1073741824)) {
                        ...
                        cryptoInfo.mode = i6;
                        if (h0.a >= 24) {
                            b.C0083b bVar3 = bVar2.f5947e;
                            bVar3.b.set(i7, i8);
                            bVar3.a.setPattern(bVar3.b);
                        }
                        long j6 = aVar2.b;
                        int i9 = (int) (j5 - j6);
                        aVar2.b = j6 + ((long) i9);
