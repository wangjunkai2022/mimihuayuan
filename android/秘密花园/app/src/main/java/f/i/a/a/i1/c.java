...
public abstract class c extends g<i, j, g> implements f {
    public c(String str) {
        ...
        h.v(this.f5962g == this.f5960e.length);
        for (e eVar : this.f5960e) {
            eVar.k(1024);
        }
    }
    ...
    /* JADX DEBUG: Method arguments types fixed to match base method, original types: [f.i.a.a.y0.e, f.i.a.a.y0.f, boolean] */
