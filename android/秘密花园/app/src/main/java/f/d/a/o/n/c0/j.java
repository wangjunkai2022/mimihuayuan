...
public final class j {
    ...
    public j(a aVar) {
        ...
        int round2 = Math.round(aVar.f3533e * f4);
        int round3 = Math.round(f4 * aVar.f3532d);
        ...
        if (round3 + round2 <= i3) {
            ...
            float f5 = (float) i3;
            float f6 = aVar.f3533e;
            float f7 = aVar.f3532d;
            float f8 = f5 / (f6 + f7);
            this.b = Math.round(f7 * f8);
            this.a = Math.round(f8 * aVar.f3533e);
        }
    ...
    public final String a(int i2) {
        return Formatter.formatFileSize(this.f3528c, (long) i2);
    }
}
