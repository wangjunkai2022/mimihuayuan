...
public class o implements f {
    ...
    public final f f3614g;

    /* renamed from: h  reason: collision with root package name */
    public final Map<Class<?>, l<?>> f3615h;
    ...
    public boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        if (!this.b.equals(oVar.b) || !this.f3614g.equals(oVar.f3614g) || this.f3611d != oVar.f3611d || this.f3610c != oVar.f3610c || !this.f3615h.equals(oVar.f3615h) || !this.f3612e.equals(oVar.f3612e) || !this.f3613f.equals(oVar.f3613f) || !this.f3616i.equals(oVar.f3616i)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        StringBuilder o = a.o("EngineKey{model=");
        o.append(this.b);
        o.append(", width=");
