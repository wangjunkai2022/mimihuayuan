...
public abstract class i<T extends View, Z> extends a<Z> {
    ...
    public static int f3779c = g.glide_custom_view_target_tag;
    public final T a;
    public final a b;
    ...
    public static final class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public ViewTreeObserver$OnPreDrawListenerC0045a f3781c;

        /* compiled from: ViewTarget.java */
        /* renamed from: f.d.a.s.h.i$a$a  reason: collision with other inner class name */
        /* loaded from: classes.dex */
        public static final class ViewTreeObserver$OnPreDrawListenerC0045a implements ViewTreeObserver.OnPreDrawListener {
            public final WeakReference<a> a;

            public ViewTreeObserver$OnPreDrawListenerC0045a(@NonNull a aVar) {
        ...
        public final int b(int i2, int i3, int i4) {
            ...
            if (f3780d == null) {
                ...
                h.s(windowManager, "Argument must not be null");
    ...
    public void h(@NonNull g gVar) {
        ...
        if (aVar.f3781c == null) {
            ...
            a.ViewTreeObserver$OnPreDrawListenerC0045a aVar2 = new a.ViewTreeObserver$OnPreDrawListenerC0045a(aVar);
            aVar.f3781c = aVar2;
