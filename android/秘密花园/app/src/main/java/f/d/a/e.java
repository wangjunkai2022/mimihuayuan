...
public class e extends ContextWrapper {
    ...
    public final List<d<Object>> f3378e;
    ...
    public e(@NonNull Context context, @NonNull b bVar, @NonNull h hVar, @NonNull f fVar, @NonNull c.a aVar, @NonNull Map<Class<?>, k<?, ?>> map, @NonNull List<d<Object>> list, @NonNull l lVar, boolean z, int i2) {
