...
public class a0 implements g, d.a<Object>, g.a {
    ...
    @Override // f.d.a.o.n.g.a
    public void b(f fVar, Exception exc, d<?> dVar, a aVar) {
        ...
        if (obj != null) {
            ...
            try {
                ...
                if (Log.isLoggable("SourceGenerator", 2)) {
                    String str = "Finished encoding source to cache, key: " + this.f3501g + ", data: " + obj + ", encoder: " + e2 + ", duration: " + e.a(b);
                }
    ...
    @Override // f.d.a.o.n.g.a
    public void f(f fVar, Object obj, d<?> dVar, a aVar, f fVar2) {
