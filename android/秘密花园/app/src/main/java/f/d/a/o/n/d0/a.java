...
public final class a implements ExecutorService {
    ...
    public static volatile int f3544c;
    ...
    public static final class ThreadFactoryC0031a implements ThreadFactory {
        ...
        public class C0032a extends Thread {
            public C0032a(Runnable runnable, String str) {
                super(runnable, str);
            }
            ...
            public void run() {
                ...
                if (ThreadFactoryC0031a.this.f3545c) {
                    StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy.Builder().detectNetwork().penaltyDeath().build());
                }
                try {
                    super.run();
                } catch (Throwable th) {
                    ThreadFactoryC0031a.this.b.a(th);
                }
            }
        }

        public ThreadFactoryC0031a(String str, b bVar, boolean z) {
            this.a = str;
            this.b = bVar;
            this.f3545c = z;
        }
        ...
        public synchronized Thread newThread(@NonNull Runnable runnable) {
            C0032a aVar;
            aVar = new C0032a(runnable, "glide-" + this.a + "-thread-" + this.f3546d);
            this.f3546d = this.f3546d + 1;
            return aVar;
        }
    }
    ...
    /* loaded from: classes.dex */
    public interface b {
        public static final b a = new C0033a();
    ...
    public static int a() {
        if (f3544c == 0) {
            f3544c = Math.min(4, Runtime.getRuntime().availableProcessors());
        }
        return f3544c;
    }
