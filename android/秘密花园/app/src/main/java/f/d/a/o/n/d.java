...
public class d implements g, d.a<Object> {
    ...
    public void c(@NonNull Exception exc) {
        this.f3537c.b(this.f3539e, exc, this.f3542h.f3660c, a.DATA_DISK_CACHE);
    }
    ...
    public void d(Object obj) {
        this.f3537c.f(this.f3539e, obj, this.f3542h.f3660c, a.DATA_DISK_CACHE, this.f3539e);
    }

    @Override // f.d.a.o.n.g
    public boolean e() {
        while (true) {
            List<n<File, ?>> list = this.f3540f;
            if (list != null) {
