...
public abstract class a<T extends a<T>> implements Cloneable {
    ...
    /* JADX DEBUG: Type inference failed for r0v0. Raw type applied. Possible types: f.d.a.o.g<f.d.a.o.p.c.m>, f.d.a.o.g<Y> */
    @NonNull
    @CheckResult
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: f.d.a.o.g<f.d.a.o.b>, f.d.a.o.g<Y> */
    @NonNull
    @CheckResult
    ...
    @NonNull
    @CheckResult
    public <Y> T t(@NonNull g<Y> gVar, @NonNull Y y) {
        if (this.v) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: f.d.a.o.l<android.graphics.Bitmap> */
    ...
    public T x(@NonNull l<Bitmap> lVar, boolean z) {
        ...
        z(GifDrawable.class, new e(lVar), z);
        s();
        return this;
    }
