...
public class b0<T> implements j<T, Bitmap> {
    ...
    public static final g<Long> f3676d = new g<>("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", -1L, new a());

    /* renamed from: e  reason: collision with root package name */
    public static final g<Integer> f3677e = new g<>("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", 2, new b());

    /* renamed from: f  reason: collision with root package name */
    public static final d f3678f = new d();
    public final e<T> a;
    ...
    public static android.graphics.Bitmap c(android.media.MediaMetadataRetriever r9, long r10, int r12, int r13, int r14, f.d.a.o.p.c.m r15) {
        /*
            ...
            f.d.a.o.p.c.m r0 = f.d.a.o.p.c.m.f3682d
    ...
    @Override // f.d.a.o.j
    public w<Bitmap> a(@NonNull T t, int i2, int i3, @NonNull h hVar) throws IOException {
        long longValue = ((Long) hVar.c(f3676d)).longValue();
        if (longValue >= 0 || longValue == -1) {
            Integer num = (Integer) hVar.c(f3677e);
            if (num == null) {
                num = 2;
            }
            m mVar = (m) hVar.c(m.f3684f);
            if (mVar == null) {
                mVar = m.f3683e;
            }
            if (this.f3679c != null) {
                ...
                try {
                    try {
                        ...
                        Bitmap c2 = c(mediaMetadataRetriever, longValue, num.intValue(), i2, i3, mVar);
                        mediaMetadataRetriever.release();
                        return e.c(c2, this.b);
    ...
    @Override // f.d.a.o.j
    public boolean b(@NonNull T t, @NonNull h hVar) {
        return true;
    }
}
