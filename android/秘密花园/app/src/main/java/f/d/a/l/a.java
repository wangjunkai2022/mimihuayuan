...
public final class a implements Closeable {
    ...
    public final Callable<Void> n = new CallableC0025a();
    ...
    public final class c {
        ...
        public c(d dVar, CallableC0025a aVar) {
            boolean[] zArr;
            this.a = dVar;
            if (dVar.f3420e) {
                zArr = null;
            } else {
                zArr = new boolean[a.this.f3409g];
            }
            this.b = zArr;
        }
    ...
    public final class d {
        ...
        public d(String str, CallableC0025a aVar) {
            this.a = str;
    ...
    public final class e {
        ...
        public e(String str, long j2, File[] fileArr, long[] jArr, CallableC0025a aVar) {
            this.a = fileArr;
        }
    }
    ...
    public final void K() throws IOException {
        b bVar = new b(new FileInputStream(this.b), c.a);
        try {
            String e2 = bVar.e();
            String e3 = bVar.e();
            String e4 = bVar.e();
            ...
            while (true) {
                try {
                    ...
                    if (z) {
                        ...
                        this.f3411i = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.b, true), c.a));
                    }
                    try {
                        bVar.close();
                        return;
        ...
        if (indexOf != -1) {
            ...
            if (indexOf2 == -1) {
                ...
                if (indexOf == 6 && str.startsWith(i.m0.c.e.x)) {
                    this.f3412j.remove(str2);
                    return;
                }
            } else {
                str2 = str.substring(i2, indexOf2);
            }
            d dVar = this.f3412j.get(str2);
            if (dVar == null) {
                dVar = new d(str2, null);
                this.f3412j.put(str2, dVar);
            }
    ...
    public final synchronized void M() throws IOException {
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.f3405c), c.a));
