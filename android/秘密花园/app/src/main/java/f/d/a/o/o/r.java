...
public class r {
    ...
    public static final c f3666e = new c();

    /* renamed from: f  reason: collision with root package name */
    public static final n<Object, Object> f3667f = new a();
    public final c b;

    /* renamed from: d  reason: collision with root package name */
    public final Pools.Pool<List<Throwable>> f3669d;
    public final List<b<?, ?>> a = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    public final Set<b<?, ?>> f3668c = new HashSet();
    ...
    public static class a implements n<Object, Object> {
        ...
        @Nullable
        public n.a<Object> a(@NonNull Object obj, int i2, int i3, @NonNull h hVar) {
            return null;
        }
    ...
    public static class b<Model, Data> {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final o<? extends Model, ? extends Data> f3670c;
    ...
    public final <Model, Data> n<Model, Data> b(@NonNull b<?, ?> bVar) {
        n<Model, Data> nVar = (n<Model, Data>) bVar.f3670c.b(this);
    ...
    public synchronized <Model, Data> n<Model, Data> c(@NonNull Class<Model> cls, @NonNull Class<Data> cls2) {
        try {
            ...
            boolean z = false;
            for (b<?, ?> bVar : this.a) {
                if (this.f3668c.contains(bVar)) {
                    z = true;
                } else if (bVar.a(cls, cls2)) {
                    this.f3668c.add(bVar);
                    arrayList.add(b(bVar));
                    this.f3668c.remove(bVar);
                }
            }
            if (arrayList.size() > 1) {
                c cVar = this.b;
                Pools.Pool<List<Throwable>> pool = this.f3669d;
                if (cVar != null) {
    ...
    public synchronized <Model> List<n<Model, ?>> d(@NonNull Class<Model> cls) {
        ...
        try {
            ...
            for (b<?, ?> bVar : this.a) {
                if (!this.f3668c.contains(bVar) && bVar.a.isAssignableFrom(cls)) {
                    this.f3668c.add(bVar);
                    n<? extends Object, ? extends Object> b2 = bVar.f3670c.b(this);
