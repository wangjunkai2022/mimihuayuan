...
public class ExoVideoAnim extends View {
    ...
    private void drawCircle01(Canvas canvas) {
        ...
        this.oval.left = (float) (width - (circleWrapper.dynamicDiameter / 2));
        this.oval.top = (float) ((getHeight() / 2) - (circleWrapper.dynamicDiameter / 2));
        RectF rectF = this.oval;
        rectF.right = rectF.left + ((float) circleWrapper.dynamicDiameter);
        RectF rectF2 = this.oval;
        rectF2.bottom = rectF2.top + ((float) circleWrapper.dynamicDiameter);
    ...
    public ExoVideoAnim(@NonNull Context context, AttributeSet attributeSet) {
        ...
        this.circleRadius = (int) obtainStyledAttributes.getDimension(R.styleable.exoVideoAnim_circleRadius, (float) paramsCreator.getDefaultCircleRadius());
        this.circleSpacing = (int) obtainStyledAttributes.getDimension(R.styleable.exoVideoAnim_circleSpacing, (float) paramsCreator.getDefaultCircleSpacing());
        int i2 = (int) ((((double) this.circleRadius) * 2.0d) / ((double) ((int) (((((double) (obtainStyledAttributes.getInt(R.styleable.exoVideoAnim_cycle, 2000) / 2)) * 1.0d) / 1000.0d) * 83.0d))));
        this.increment = i2;
