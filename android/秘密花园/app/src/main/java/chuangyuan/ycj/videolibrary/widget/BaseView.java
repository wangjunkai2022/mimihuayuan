    ...
    public BaseView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                i5 = obtainStyledAttributes.getResourceId(R.styleable.VideoPlayerView_user_watermark, 0);
                ...
                i3 = obtainStyledAttributes.getResourceId(R.styleable.VideoPlayerView_player_preview_layout_id, 0);
                ...
                if (i3 == 0 && (resourceId == R.layout.simple_exo_playback_list_view || resourceId == R.layout.simple_exo_playback_top_view)) {
                    i3 = R.layout.exo_default_preview_layout;
                }
            } finally {
        ...
        if (i3 != 0) {
            this.exoPlayPreviewLayout = FrameLayout.inflate(context, i3, null);
        }
        intiView();
        initWatermark(i5, i4);
    }
