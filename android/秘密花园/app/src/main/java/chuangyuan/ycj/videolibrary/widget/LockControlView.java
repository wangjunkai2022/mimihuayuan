...
public class LockControlView extends FrameLayout implements View.OnClickListener, AnimUtils.AnimatorListener, AnimUtils.UpdateProgressListener {
    ...
    public final Runnable hideAction = new Runnable() { // from class: chuangyuan.ycj.videolibrary.widget.LockControlView.1
    ...
    public void onClick(View view) {
        ...
        if (this.lockCheckBox.isChecked()) {
            ...
            if (!this.mBaseView.playerView.g()) {
                postDelayed(this.hideAction, (long) this.mBaseView.playerView.getControllerShowTimeoutMs());
                return;
            }
            return;
        }
    ...
    public void showLockState(int i2) {
        if (this.exoPlayLockLayout != null) {
            ...
            if (this.isProgress) {
                ExoDefaultTimeBar exoDefaultTimeBar = this.exoPlayerLockProgress;
                if (i2 == 8) {
                    i3 = 0;
                }
                exoDefaultTimeBar.setVisibility(i3);
                return;
            }
