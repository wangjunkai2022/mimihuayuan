...
public class TbsShareManager {
    ...
    public static void a(Context context) {
        ...
        try {
            ...
            StringBuilder o = a.o("shareTbsCore tbsShareDir error is ");
    ...
    public static int findCoreForThirdPartyApp(Context context) {
        ...
        } else if (f2480e != l.a().a(f2478c)) {
            f2480e = 0;
            f2479d = null;
            f2481f = null;
            StringBuilder o = a.o("check AppDefined core is error src is ");
            o.append(f2480e);
            o.append(" dest is ");
            ...
            if (f2478c == null || (a2 = l.a().a(f2478c)) <= 0) {
                ...
                for (String str2 : coreProviderAppList) {
                    ...
                    if (sharedTbsCoreVersion >= h2 && sharedTbsCoreVersion >= i2 && sharedTbsCoreVersion > 0) {
                        ...
                        if (QbSdk.canLoadX5FirstTimeThirdApp(context)) {
                            writeProperties(context, Integer.toString(f2480e), f2481f, f2479d, Integer.toString(b.b(context)));
                            return;
                        }
                        f2480e = 0;
                        f2479d = null;
        ...
        for (String str : coreProviderAppList) {
            if (str.equalsIgnoreCase(TbsConfig.APP_WX)) {
                ...
                if (str.equalsIgnoreCase(TbsConfig.APP_QZONE)) {
                    j3 += (long) getSharedTbsCoreVersion(context, str);
                }
            }
    ...
    public static boolean i(Context context) {
        try {
            ...
            instance.a(context, TbsListener.ErrorCode.INFO_CORE_EXIST_NOT_LOAD, new Throwable("mAvailableCoreVersion=" + f2480e + "; mSrcPackageName=" + f2481f + "; getSharedTbsCoreVersion(ctx, mSrcPackageName) is " + getSharedTbsCoreVersion(context, f2481f) + "; getHostCoreVersions is " + getHostCoreVersions(context)));
            f2479d = null;
            f2480e = 0;
    ...
    public static boolean k(Context context) {
        ...
        if (f2480e == getSharedTbsCoreVersion(context, str) || f2480e == getCoreShareDecoupleCoreVersion(context, f2481f)) {
            return true;
        }
        return false;
    }
                    ...
                    if (i2 == l.a().a(f2478c)) {
                        ...
                        for (String str : d2) {
                            if (i2 == getSharedTbsCoreVersion(context, str)) {
                                ...
                                b.b(context);
                                if (l.a().f(packageContext)) {
                                    f.a(new File(absolutePath), new File(f2478c), new FileFilter() { // from class: com.tencent.smtt.sdk.TbsShareManager.1
    ...
    public static void a(Context context, TbsLinuxToolsJni tbsLinuxToolsJni, File file) {
        ...
        if (file != null && file.exists() && file.isDirectory()) {
            StringBuilder o = a.o("shareAllDirsAndFiles dir is ");
    ...
    public static void a(Context context, int i2) {
        if (!TbsPVConfig.getInstance(a).isDisableHostBackupCore() && l.a().t(context)) {
            ...
            StringBuilder o = a.o("find host backup core to unzip #1");
            ...
            while (true) {
                ...
                if (i2 == getBackupCoreVersion(context, str)) {
                    if (l.a().f(getPackageContext(context, str, false))) {
                        ...
                        if (com.tencent.smtt.utils.a.a(context, backupCoreFile, 0, i2)) {
                    ...
                    if (i2 == getBackupDecoupleCoreVersion(context, str) && l.a().f(getPackageContext(context, str, false))) {
                        ...
                        if (com.tencent.smtt.utils.a.a(context, backupDecoupleCoreFile, 0, i2)) {
