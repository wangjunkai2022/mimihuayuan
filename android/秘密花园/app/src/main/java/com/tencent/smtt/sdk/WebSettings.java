...
public class WebSettings {
    ...
    public static String getDefaultUserAgent(Context context) {
        ...
        Object a = k.a((Class<?>) android.webkit.WebSettings.class, "getDefaultUserAgent", (Class<?>[]) new Class[]{Context.class}, context);
        if (a == null) {
            return null;
        }
        return (String) a;
    ...
    public boolean enableSmoothTransition() {
        ...
        if (this.f2499c || (webSettings = this.b) == null || (a = k.a(webSettings, "enableSmoothTransition")) == null) {
            return false;
        }
    ...
    public boolean getAllowContentAccess() {
        ...
        if (this.f2499c || (webSettings = this.b) == null || (a = k.a(webSettings, "getAllowContentAccess")) == null) {
            return false;
        }
        return ((Boolean) a).booleanValue();
    }
    ...
    public boolean getDisplayZoomControls() {
        ...
        if (this.f2499c || (webSettings = this.b) == null || (a = k.a(webSettings, "getDisplayZoomControls")) == null) {
            return false;
        }
        return ((Boolean) a).booleanValue();
    }
    ...
    public boolean getMediaPlaybackRequiresUserGesture() {
        ...
        if (this.f2499c || (webSettings = this.b) == null || (a = k.a(webSettings, "getMediaPlaybackRequiresUserGesture")) == null) {
            return false;
        }
        return ((Boolean) a).booleanValue();
    }
    ...
    public synchronized int getMixedContentMode() {
        int i2 = -1;
        if (!this.f2499c || this.a == null) {
            Object a = k.a(this.b, "getMixedContentMode", new Class[0], new Object[0]);
            if (a != null) {
    ...
    public boolean getNavDump() {
        ...
        if (this.f2499c || (webSettings = this.b) == null || (a = k.a(webSettings, "getNavDump")) == null) {
            return false;
        }
        return ((Boolean) a).booleanValue();
    }
    ...
    public synchronized PluginState getPluginState() {
        if (this.f2499c && this.a != null) {
            ...
            Object a = k.a(this.b, "getPluginState");
            if (a == null) {
                return null;
            }
    ...
    public synchronized int getTextZoom() {
        if (this.f2499c && this.a != null) {
            ...
            try {
                ...
                Object a = k.a(this.b, "getTextZoom");
                if (a == null) {
                    return 0;
                }
    ...
    public boolean getUseWebViewBackgroundForOverscrollBackground() {
        ...
        if (this.f2499c || (webSettings = this.b) == null || (a = k.a(webSettings, "getUseWebViewBackgroundForOverscrollBackground")) == null) {
            return false;
        }
        return ((Boolean) a).booleanValue();
    }
    ...
    public void setAllowContentAccess(boolean z) {
        ...
        if (this.f2499c && (iX5WebSettings = this.a) != null) {
            ...
            k.a(webSettings, "setAllowContentAccess", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setDisplayZoomControls(boolean z) {
        ...
        if (this.f2499c && (iX5WebSettings = this.a) != null) {
            ...
            k.a(webSettings, "setDisplayZoomControls", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setEnableSmoothTransition(boolean z) {
        ...
        if (this.f2499c && (iX5WebSettings = this.a) != null) {
            ...
            k.a(webSettings, "setEnableSmoothTransition", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMediaPlaybackRequiresUserGesture(boolean z) {
        ...
        if (this.f2499c && (iX5WebSettings = this.a) != null) {
            ...
            k.a(webSettings, "setMediaPlaybackRequiresUserGesture", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMixedContentMode(int i2) {
        ...
        if ((!this.f2499c || this.a == null) && !this.f2499c && (webSettings = this.b) != null) {
            k.a(webSettings, "setMixedContentMode", new Class[]{Integer.TYPE}, Integer.valueOf(i2));
        }
    }
    ...
    public synchronized void setPluginsPath(String str) {
        if (this.f2499c && this.a != null) {
            ...
            k.a(this.b, "setPluginsPath", new Class[]{String.class}, str);
        }
    }
    ...
    public synchronized void setTextZoom(int i2) {
        if (this.f2499c && this.a != null) {
            ...
            try {
                ...
                k.a(this.b, "setTextZoom", new Class[]{Integer.TYPE}, Integer.valueOf(i2));
            }
        }
    }
