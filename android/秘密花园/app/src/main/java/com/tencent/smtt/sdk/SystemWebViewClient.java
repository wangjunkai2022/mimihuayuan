...
public class SystemWebViewClient extends WebViewClient {
    ...
    public static class f implements WebResourceRequest {
        ...
        public boolean isRedirect() {
            if (Build.VERSION.SDK_INT >= 24) {
                Object a = k.a(this.a, "isRedirect");
    ...
    public void onReceivedError(WebView webView, android.webkit.WebResourceRequest webResourceRequest, final WebResourceError webResourceError) {
        ...
        if (webResourceError != null) {
            r2 = new com.tencent.smtt.export.external.interfaces.WebResourceError() { // from class: com.tencent.smtt.sdk.SystemWebViewClient.2
    ...
    /* JADX WARNING: Removed duplicated region for block: B:13:0x0047 A[RETURN] */
