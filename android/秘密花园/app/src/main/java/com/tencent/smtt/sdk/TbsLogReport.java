...
public class TbsLogReport {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:29:0x0104 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:50:0x012d */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:54:0x0141 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:68:0x014c A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:73:0x0128 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:75:0x0145 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:79:0x0121 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    public void b() {
        ...
        if (map == null || !map.containsKey(QbSdk.KEY_SET_SENDREQUEST_AND_UPLOAD) || !QbSdk.n.get(QbSdk.KEY_SET_SENDREQUEST_AND_UPLOAD).equals("false")) {
            ...
            try {
                String a3 = g.a(n.a(this.f2452c).c(), a2.toString().getBytes("utf-8"), new g.a() { // from class: com.tencent.smtt.sdk.TbsLogReport.3
    ...
    public void a(int i2, TbsLogInfo tbsLogInfo) {
        ...
        sb.append(a(i2));
        sb.append(a(b.c(this.f2452c)));
        sb.append(a(l.a(this.f2452c)));
        ...
        if (TbsConfig.APP_WX.equals(packageName)) {
            sb.append(a(b.a(this.f2452c, TbsDownloader.TBS_METADATA)));
        } else {
            sb.append(a(b.b(this.f2452c)));
        }
    ...
    public static class a {
        ...
        /* JADX WARNING: Can't wrap try/catch for region: R(10:110|4|5|(3:83|6|(2:108|7))|(10:112|8|100|9|(2:10|(1:12)(1:116))|13|92|14|88|17)|39|90|40|43|118) */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:42:0x008e, code lost:
            r0.printStackTrace();
         */
        /* JADX WARNING: Removed duplicated region for block: B:104:0x0079 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /* JADX WARNING: Removed duplicated region for block: B:86:0x006f A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void a() {
            /*
        ...
        public static void a(File file) throws IOException {
            ...
            try {
                ...
                try {
                    ...
                    if ((read & parseInt) > 0) {
                        randomAccessFile2.seek(7);
                        randomAccessFile2.write((~parseInt) & 255 & read);
                    }
