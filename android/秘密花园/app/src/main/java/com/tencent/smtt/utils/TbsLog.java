...
public class TbsLog {
    ...
    public static TbsLogClient f2608c;
    ...
    public static void app_extra(String str, Context context) {
        try {
            ...
            StringBuilder o = a.o("app_extra exception:");
    ...
    public static void d(String str, String str2) {
        TbsLogClient tbsLogClient = f2608c;
    ...
    public static void setLogView(TextView textView) {
        ...
        if (textView != null && (tbsLogClient = f2608c) != null) {
