...
public final class JsContext {
    ...
    public ExceptionHandler f2404c;
    ...
    public void evaluateScriptAsync(String str, final ValueCallback<JsValue> valueCallback, URL url) {
        this.b.evaluateScriptAsync(str, valueCallback == null ? null : new ValueCallback<IX5JsValue>() { // from class: com.tencent.smtt.sdk.JsContext.1
            /* renamed from: a */
    ...
    public void setExceptionHandler(ExceptionHandler exceptionHandler) {
        this.f2404c = exceptionHandler;
        if (exceptionHandler == null) {
            this.b.setExceptionHandler(null);
        } else {
            this.b.setExceptionHandler(new ValueCallback<IX5JsError>() { // from class: com.tencent.smtt.sdk.JsContext.2
                /* renamed from: a */
                public void onReceiveValue(IX5JsError iX5JsError) {
                    JsContext.this.f2404c.handleException(JsContext.this, new JsError(iX5JsError));
                }
            });
        }
    }
