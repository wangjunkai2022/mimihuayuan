...
public class e implements Closeable {
    ...
    public static class b extends a {
        ...
        public long a() {
            return (long) this.f2645m;
        }

        @Override // com.tencent.smtt.utils.e.a
        public long b() {
            return (long) this.f2644l;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static class C0010e extends l {
        public int a;
        public int b;
    }
    ...
    public e(File file) throws IOException, UnknownFormatConversionException {
        ...
        if (a()) {
            ...
            for (int i2 = 0; i2 < aVar.f2641i; i2++) {
                cVar.a(aVar.a() + ((long) (aVar.f2640h * i2)));
                if (d2) {
                    h hVar = new h();
                    hVar.f2667g = cVar.b();
                    hVar.f2668h = cVar.b();
    ...
    private void f() throws IOException {
        ...
        for (int i3 = 0; i3 < aVar.f2639g; i3++) {
            cVar.a(aVar.b() + ((long) (aVar.f2638f * i3)));
            if (d2) {
                g gVar = new g();
                gVar.f2665g = cVar.b();
                gVar.f2666h = cVar.b();
