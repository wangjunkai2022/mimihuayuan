...
public class l {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:16:0x000e */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r5v0, types: [android.content.Context] */
    /* JADX WARN: Type inference failed for: r5v1, types: [android.content.Context] */
    /* JADX WARN: Type inference failed for: r5v2, types: [com.tencent.smtt.sdk.TbsLogReport] */
    private void g(Context context, boolean z) {
        ...
        try {
            ...
            while (true) {
                context = TbsLogReport.getInstance(context);
                StringBuilder o2 = a.o("setTmpFolderCoreToRead Exception message is ");
                o2.append(e2.getMessage());
                o2.append(" Exception cause is ");
                o2.append(e2.getCause());
                context.setInstallErrorCode(225, o2.toString());
                return;
            }
        }
    }
    ...
    private void x(Context context) {
        ...
        try {
            ...
            StringBuilder o2 = a.o("exception when renameing from unzip:");
            o2.append(th.toString());
            instance.setInstallErrorCode(TbsListener.ErrorCode.RENAME_EXCEPTION, o2.toString());
    ...
    private void y(Context context) {
        ...
        try {
            ...
            e2.printStackTrace();
            TbsLogReport instance = TbsLogReport.getInstance(context);
            StringBuilder o2 = a.o("exception when renameing from tpatch:");
            o2.append(e2.toString());
            instance.setInstallErrorCode(TbsListener.ErrorCode.TPATCH_ENABLE_EXCEPTION, o2.toString());
        }
        g(context);
    }
    ...
    private void z(Context context) {
        ...
        try {
            ...
            e2.printStackTrace();
            TbsLogReport instance = TbsLogReport.getInstance(context);
            StringBuilder o2 = a.o("exception when renameing from copy:");
            o2.append(e2.toString());
            instance.setInstallErrorCode(TbsListener.ErrorCode.RENAME_EXCEPTION, o2.toString());
        }
        g(context);
    ...
    public boolean n(Context context) {
        ...
        try {
            f.a(p2, true);
            f.a(q, p2, new FileFilter() { // from class: com.tencent.smtt.sdk.l.5
                @Override // java.io.FileFilter
                public boolean accept(File file) {
                    return !file.getName().endsWith(MultiDexExtractor.DEX_SUFFIX) && !file.getName().endsWith(".jar_is_first_load_dex_flag_file");
                }
            });
            TbsShareManager.b(context);
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: SSATransform
        jadx.core.utils.exceptions.JadxRuntimeException: Not initialized variable reg: 3, insn: 0x00a9: MOVE  (r4 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:31:0x00a9
    ...
    public int i(
/*
[196] Method generation error in method: com.tencent.smtt.sdk.l.i(android.content.Context):int, file: classes.dex
...
*/
    ...
    public boolean g(Context context, int i2) {
        ...
        try {
            ...
            StringBuilder o2 = a.o("ISTBSCORELEGAL exception getMessage is ");
    ...
    public void a(Context context, boolean z) {
        ...
        StringBuilder o2 = a.o("TbsInstaller-continueInstallTbsCore currentProcessName=");
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: AttachTryCatchVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Null type added to not empty exception handler: IOException -> 0x0048
    ...
    public void d(android.content.Context r6) {
        /*
            r5 = this;
            r5.q(r6)     // Catch: IOException -> 0x0048
            r6 = move-result     // Catch: IOException -> 0x0048
            java.io.File r0 = new java.io.File     // Catch: IOException -> 0x0048
            java.lang.String r1 = "tbs.conf"     // Catch: IOException -> 0x0048
            r0.<init>(r6, r1)     // Catch: IOException -> 0x0048
            java.util.Properties r6 = new java.util.Properties     // Catch: IOException -> 0x0048
            ...
            java.lang.String r2 = "tbs_local_installation"     // Catch: all -> 0x0039
            java.lang.String r4 = "false"     // Catch: all -> 0x0039
            r6.setProperty(r2, r4)     // Catch: all -> 0x0039
            r6.store(r0, r1)     // Catch: all -> 0x0039
            r0.close()     // Catch: IOException -> 0x0035, IOException -> 0x0048
        L_0x0035:
            r3.close()
            goto L_0x0048
        L_0x0039:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:252:0x047f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    public Context d(Context context, int i2) {
        ...
        for (int i3 = 0; i3 < coreProviderAppList.length; i3++) {
            if (!context.getPackageName().equalsIgnoreCase(coreProviderAppList[i3]) && e(context, coreProviderAppList[i3]) && (b2 = b(context, coreProviderAppList[i3])) != null) {
                if (!f(b2)) {
                    StringBuilder o2 = a.o("TbsInstaller--getTbsCoreHostContext ");
                    ...
                    if (i4 != 0 && i4 == i2) {
                        StringBuilder o3 = a.o("TbsInstaller-getTbsCoreHostContext targetApp=");
        ...
        try {
            ...
            if (i2 == 0) {
                ...
                if (i3 != a3) {
                    ...
                    TbsLogReport instance = TbsLogReport.getInstance(context);
                    instance.setInstallErrorCode(TbsListener.ErrorCode.TPATCH_VERSION_FAILED, "version=" + i3 + ",patchVersion=" + a3);
                    return 1;
                }
            ...
            StringBuilder o2 = a.o("patch exception");
            o2.append(Log.getStackTraceString(e2));
            instance4.setInstallErrorCode(TbsListener.ErrorCode.DECOUPLE_TPATCH_FAIL, o2.toString());
            return 1;
        }
    }
    ...
    private boolean c(Context context, File file) {
        try {
            ...
            File[] listFiles = file.listFiles(new FileFilter() { // from class: com.tencent.smtt.sdk.l.7
                @Override // java.io.FileFilter
    ...
    /* access modifiers changed from: private */
    /* JADX WARNING: Removed duplicated region for block: B:113:0x02d9 A[Catch: Exception -> 0x04ac, all -> 0x04dc, TryCatch #0 {Exception -> 0x04ac, blocks: (B:72:0x020b, B:74:0x0234, B:75:0x0237, B:77:0x0253, B:79:0x025c, B:94:0x02b2, B:97:0x02b8, B:107:0x02cd, B:110:0x02d3, B:113:0x02d9, B:114:0x02e7, B:116:0x02ea, B:118:0x02f6, B:120:0x0302, B:122:0x030e, B:124:0x0314, B:127:0x0321, B:130:0x0337, B:132:0x033d, B:133:0x0359, B:135:0x0388, B:137:0x038f, B:140:0x03a7, B:143:0x03d2, B:145:0x03e1, B:147:0x03e7, B:151:0x03f4, B:152:0x03fa, B:154:0x0406, B:155:0x0412, B:156:0x041d, B:160:0x0459, B:161:0x0471, B:165:0x047b, B:168:0x0481, B:169:0x0484, B:170:0x0485, B:174:0x04b1, B:176:0x04c7), top: B:192:0x0207 }] */
    /* JADX WARNING: Removed duplicated region for block: B:139:0x03a5 A[ADDED_TO_REGION] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:162:0x0449  */
    /* JADX WARNING: Removed duplicated region for block: B:164:0x044e  */
    /* JADX WARNING: Removed duplicated region for block: B:178:0x04a7  */
    /* JADX WARNING: Removed duplicated region for block: B:180:0x04ab  */
    /* JADX WARNING: Removed duplicated region for block: B:66:0x01c8 A[Catch: Exception -> 0x0403, all -> 0x03fb, TryCatch #13 {Exception -> 0x0403, all -> 0x03fb, blocks: (B:20:0x00c7, B:49:0x019a, B:51:0x01a0, B:64:0x01bd, B:66:0x01c8, B:68:0x01e5, B:69:0x01ed, B:71:0x01f3, B:72:0x01fb, B:74:0x0201, B:75:0x0209, B:82:0x023e, B:84:0x024d, B:86:0x025a), top: B:217:0x00c7 }] */
    /* JADX WARNING: Removed duplicated region for block: B:82:0x023e A[Catch: Exception -> 0x0403, all -> 0x03fb, TRY_ENTER, TryCatch #13 {Exception -> 0x0403, all -> 0x03fb, blocks: (B:20:0x00c7, B:49:0x019a, B:51:0x01a0, B:64:0x01bd, B:66:0x01c8, B:68:0x01e5, B:69:0x01ed, B:71:0x01f3, B:72:0x01fb, B:74:0x0201, B:75:0x0209, B:82:0x023e, B:84:0x024d, B:86:0x025a), top: B:217:0x00c7 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private boolean a(Context context, File file, boolean z) {
        ...
        try {
            ...
            StringBuilder o2 = a.o("TbsInstaller-unzipTbs -- delete unzip folder if exists exception");
        ...
        try {
            ...
            if (z2) {
                try {
                    ...
                    StringBuilder o3 = a.o("copyFileIfChanged -- delete tmpTbsCoreUnzipDir#2! exception:");
            ...
            if (z2) {
                try {
                    ...
                    StringBuilder o4 = a.o("copyFileIfChanged -- delete tmpTbsCoreUnzipDir#2! exception:");
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: SSATransform
        jadx.core.utils.exceptions.JadxRuntimeException: Not initialized variable reg: 4, insn: 0x012a: MOVE  (r14 I:??[OBJECT, ARRAY]) = (r4 I:??[OBJECT, ARRAY]), block:B:57:0x012a
        	at jadx.core.dex.visitors.ssa.SSATransform.renameVarsInBlock(SSATransform.java:171)
        	at jadx.core.dex.visitors.ssa.SSATransform.renameVariables(SSATransform.java:143)
        	at jadx.core.dex.visitors.ssa.SSATransform.process(SSATransform.java:60)
        	at jadx.core.dex.visitors.ssa.SSATransform.visit(SSATransform.java:41)
    ...
    private boolean a(
/*
[310] Method generation error in method: com.tencent.smtt.sdk.l.a(java.io.File, android.content.Context):boolean, file: classes.dex
            ...
            public void run() {
                ...
                try {
                    if (context2 == null) {
                        ...
                        file = l.this.q(context2);
                    } else if (TbsShareManager.c(context) == null || !TbsShareManager.c(context).contains("decouple")) {
                        file = l.this.q(context2);
                    } else {
                        file = l.this.p(context2);
                    }
                    f.a(file, l.this.q(context), new FileFilter() { // from class: com.tencent.smtt.sdk.l.4.2
                        @Override // java.io.FileFilter
