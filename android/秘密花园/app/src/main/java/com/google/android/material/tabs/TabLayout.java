...
public class TabLayout extends HorizontalScrollView {
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        public final Paint selectedIndicatorPaint = new Paint();
        public final GradientDrawable defaultSelectionIndicator = new GradientDrawable();
            ...
            if (i4 != left || i5 != right) {
                ...
                valueAnimator2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.tabs.TabLayout.SlidingTabIndicator.1
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        ...
                        SlidingTabIndicator.this.setIndicatorPosition(AnimationUtils.lerp(i4, left, animatedFraction), AnimationUtils.lerp(i5, right, animatedFraction));
                    }
                });
        ...
        public void onMeasure(int i2, int i3) {
            ...
            if (this.textView != null) {
                ...
                if (i5 != 0 || (maxLines >= 0 && i4 != maxLines)) {
                    if (TabLayout.this.mode == 1 && i5 > 0 && lineCount == 1 && ((layout = this.textView.getLayout()) == null || approximateLineWidth(layout, 0, f2) > ((float) ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight())))) {
                        z = false;
                    }
                    if (z) {
