...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public int state = 4;
    public final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.2
        ...
        public boolean tryCaptureView(@NonNull View view, int i2) {
            ...
            if ((i3 != 3 || bottomSheetBehavior.activePointerId != i2 || (view2 = bottomSheetBehavior.nestedScrollingChildRef.get()) == null || !view2.canScrollVertically(-1)) && (weakReference = BottomSheetBehavior.this.viewRef) != null && weakReference.get() == view) {
                return true;
            }
            return false;
        }
    ...
    public void dispatchOnSlide(int i2) {
        ...
        if (v != null && (bottomSheetCallback = this.callback) != null) {
            ...
            if (i2 > i3) {
                bottomSheetCallback.onSlide(v, ((float) (i3 - i2)) / ((float) (this.parentHeight - i3)));
            } else {
                bottomSheetCallback.onSlide(v, ((float) (i3 - i2)) / ((float) (i3 - getExpandedOffset())));
            }
        }
    }
    ...
    public boolean shouldHide(View view, float f2) {
        ...
        if (Math.abs(((f2 * 0.1f) + ((float) view.getTop())) - ((float) this.collapsedOffset)) / ((float) this.peekHeight) > 0.5f) {
            return true;
        }
        return false;
    }
