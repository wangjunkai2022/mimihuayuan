...
public class MaterialButtonHelper {
    ...
    public void drawStroke(@Nullable Canvas canvas) {
        if (canvas != null && this.strokeColor != null && this.strokeWidth > 0) {
            ...
            rectF.set((((float) i2) / 2.0f) + ((float) rect.left) + ((float) this.insetLeft), (((float) i2) / 2.0f) + ((float) rect.top) + ((float) this.insetTop), (((float) rect.right) - (((float) i2) / 2.0f)) - ((float) this.insetRight), (((float) rect.bottom) - (((float) i2) / 2.0f)) - ((float) this.insetBottom));
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        ...
        if (colorStateList != null) {
            i2 = colorStateList.getColorForState(this.materialButton.getDrawableState(), 0);
        }
        paint.setColor(i2);
    ...
    public void setStrokeWidth(int i2) {
        if (this.strokeWidth != i2) {
            this.strokeWidth = i2;
            this.buttonStrokePaint.setStrokeWidth((float) i2);
            updateStroke();
        }
    }
