...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createCradleTranslationAnimation(int i2, List<Animator> list) {
        if (this.fabAttached) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.topEdgeTreatment.getHorizontalOffset(), (float) getFabTranslationX(i2));
    ...
    private void createFabTranslationXAnimation(int i2, List<Animator> list) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(findDependentFab(), "translationX", (float) getFabTranslationX(i2));
        ofFloat.setDuration(300L);
        list.add(ofFloat);
    }
