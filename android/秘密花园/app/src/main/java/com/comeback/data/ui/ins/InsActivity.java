...
public class InsActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1071c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.r.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1071c);
    }
