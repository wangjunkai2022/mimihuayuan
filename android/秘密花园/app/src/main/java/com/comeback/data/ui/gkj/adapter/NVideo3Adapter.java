...
public class NVideo3Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<NavBean.DataEntity.ArticleVOSEntity> f949c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public TextView f951d;

        public b(NVideo3Adapter nVideo3Adapter, View view) {
            super(view);
            this.a = (ImageView) view.findViewById(R.id.iv_cover);
            this.b = (TextView) view.findViewById(R.id.tv_title);
            this.f950c = (TextView) view.findViewById(R.id.tv_intro);
            this.f951d = (TextView) view.findViewById(R.id.tv_duration);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        NavBean.DataEntity.ArticleVOSEntity articleVOSEntity = this.f949c.get(i2);
        h.u0(articleVOSEntity.getCover(), bVar.a);
        bVar.f950c.setText(articleVOSEntity.getInfo());
        bVar.f950c.setVisibility(8);
        try {
            bVar.f951d.setText(h.f1(Integer.valueOf(articleVOSEntity.getVideoTime()).intValue()));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
