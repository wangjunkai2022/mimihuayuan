...
public class TomatoActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f2083c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.m0.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f2083c);
    }

    public /* synthetic */ boolean l(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.navigation_av /* 2131296604 */:
