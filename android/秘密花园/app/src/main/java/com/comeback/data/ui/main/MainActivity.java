...
public class MainActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener {
    ...
    public MainAdapter.a f1485d = new MainAdapter.a() { // from class: f.e.a.j.b0.d
    ...
    public final void r() {
        ...
        mainAdapter.f1504d = this.f1485d;
        ...
        arrayList.add(new HomeBean(e.a("AlOKx+WVjLI="), R.mipmap.launcher_fl, 50, e.a("0ufLjejb35bPg7PDkOv5jqfq")));
        ...
        int i2 = 0;
        while (arrayList.size() > i2 && arrayList2.size() > i2) {
