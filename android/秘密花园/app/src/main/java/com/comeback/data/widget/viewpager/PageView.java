...
public class PageView extends FrameLayout {
    ...
    public final Runnable f2281c = new b();
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            if (pageView.f2282d) {
                ...
                pageView2.b.postDelayed(pageView2.f2281c, 6000);
            }
        }
    }
    ...
    public void a(List<f.e.a.g.a> list, AdPagerAdapter.a aVar) {
        if (!(list == null || list.size() == 0)) {
            ...
            adPagerAdapter.f2276e = aVar;
            adPagerAdapter.f2279c.clear();
            if (list.size() > 0) {
                adPagerAdapter.f2279c.addAll(list);
            }
            adPagerAdapter.notifyDataSetChanged();
            this.mViewPager.setCurrentItem((this.a.getCount() / 2) + new Random().nextInt(list.size()));
        }
        this.f2282d = true;
        this.b.postDelayed(this.f2281c, 6000);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (this.f2282d) {
            ...
            if (action == 1 || action == 3 || action == 4) {
                this.b.removeCallbacks(this.f2281c);
                this.b.postDelayed(this.f2281c, 6000);
            } else if (action == 0) {
                this.b.removeCallbacks(this.f2281c);
            }
