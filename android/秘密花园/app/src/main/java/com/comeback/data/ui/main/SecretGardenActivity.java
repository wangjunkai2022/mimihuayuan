...
public class SecretGardenActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener {
    @BindView
    ...
    public MainAdapter.a f1490d = new MainAdapter.a() { // from class: f.e.a.j.b0.f
        @Override // com.comeback.data.ui.main.adapter.MainAdapter.a
        public final void a(HomeBean homeBean) {
            SecretGardenActivity.this.p(homeBean);
        }
    };
    ...
    public class a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i2) {
            ...
            SecretGardenActivity.this.o(this.a.getUrl());
            SecretGardenActivity.this.f1489c = true;
        }
    }

    /* loaded from: classes.dex */
    public class b implements DialogInterface.OnClickListener {
        public b(SecretGardenActivity secretGardenActivity) {
        }
    ...
    public class d implements DialogInterface.OnClickListener {
        public d(SecretGardenActivity secretGardenActivity) {
        }
    ...
    public static void l(SecretGardenActivity secretGardenActivity, String str) {
        if (secretGardenActivity != null) {
            f.a();
            AppActivity.p(secretGardenActivity, str, true);
            return;
        }
        throw null;
    }
    ...
    public static void v(Context context) {
        f.b.a.a.a.u(context, SecretGardenActivity.class);
    }

    @Override // com.comeback.data.base.BaseActivity
    public int d() {
        return R.layout.activity_main_secret_garden;
    }

    /* JADX WARNING: Removed duplicated region for block: B:25:0x0194  */
    /* JADX WARNING: Removed duplicated region for block: B:26:0x0197  */
    /* JADX WARNING: Removed duplicated region for block: B:29:0x019d  */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x01a0  */
    /* JADX WARNING: Removed duplicated region for block: B:33:0x01c8  */
    ...
    public void e() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.comeback.data.ui.main.SecretGardenActivity.e():void");
    }
    ...
    public /* synthetic */ void p(HomeBean homeBean) {
        ...
        } else if (homeBean.getTask().getLockType() == -1) {
            t(homeBean.getTask());
        } else {
            u(homeBean.getTask());
        }
    ...
    public final void r() {
        ...
        arrayList2.add(new HomeBean(e.a("3sT6jP760ZT1j5b2"), R.mipmap.launcher_xj, 5, e.a("x/3u6IzvptrV/w==")));
        arrayList2.add(new HomeBean(e.a("0ej1jfPH3LzDgb3v"), R.mipmap.launcher_dytb, 8, e.a("09rwgtjb3IHog6/anc7EjL7l")));
        arrayList2.add(new HomeBean(e.a("3tjYjNr1bWU="), R.mipmap.launcher_mdtv, 45, ""));
        arrayList2.add(new HomeBean(e.a("DlM3Mg=="), R.mipmap.launcher_91tv, 48, ""));
        arrayList2.add(new HomeBean(e.a("excXEQkW"), R.mipmap.launcher_lutube, 9, e.a("3+Lig+L/3q/4gb3gl9bvjIzthuHTlouolv2JgtzNhOKw")));
        arrayList2.add(new HomeBean(e.a("cRcPBQRB"), R.mipmap.launcher_fl2, 12, e.a("0vLPjMTH3q/4g5D9nNDljov9htj0mqWzm8C1gOzCheK8hOrS")));
        arrayList2.add(new HomeBean(e.a("fiwwg8/N3L/J"), R.mipmap.launcher_ins, 47, ""));
        arrayList2.add(new HomeBean(e.a("cIvY+oPVr9rT3Q=="), R.mipmap.launcher_gdian, 49, ""));
        arrayList2.add(new HomeBean(e.a("3+jOgNLj0ZT1j5b2"), R.mipmap.launcher_bale, 27, e.a("0NzHgeT437nmgZzYkMzijYbghdPQlrOTlPywBgga")));
        arrayList2.add(new HomeBean(e.a("3+/qjOXg0ZT1j5b2"), R.mipmap.launcher_cm, 33, e.a("0NzHgeT437nmgZzYkMzijYbghdPQlrOTlPywBgga")));
        arrayList2.add(new HomeBean(e.a("0O7IgfnZ"), R.mipmap.launcher_mm, 4, e.a("0szmg//E3pX8g7zOn87djrvYjNjnm7mylO+4geTqhMOEh83+CgNJ")));
        arrayList2.add(new HomeBean(e.a("0t3Ig+fY"), R.mipmap.ic_km, 3, e.a("0t3Ig+fYWEMDiYjrkMTTjor3h9nLlKO3lNi6gt3XhvCph9zi")));
        arrayList2.add(new HomeBean(e.a("0fTTg+L73IzYgbjM"), R.mipmap.ic_km, 21, e.a("0t3Ig+fYWEMDiYjrkMTTjor3h9nLlKO3lNi6gt3XhvCph9zi")));
        arrayList2.add(new HomeBean(e.a("fQMVICk="), R.mipmap.launcher_jav, 38, e.a("0MXugcbj3qbZg7vQnvr/jIPA")));
        arrayList2.add(new HomeBean(e.a("3+P5gfv73qjHgKbK"), R.mipmap.icon_secret_garden, 1, e.a("0PnXgvne0bLpg6Tvl9bvj4rChePplKO3")));
        arrayList2.add(new HomeBean(e.a("39fngtHj3pjq"), R.mipmap.launcher_lnkl, 43, e.a("39Tmg9HU3YvDg5vrn/DnjorTi8Ptm4y3ldykiMX0")));
        s(this.rvVideo, arrayList2);
        ArrayList arrayList3 = new ArrayList();
        arrayList3.add(new HomeBean(e.a("393Ugc3K34/YgaDc"), R.mipmap.launcher_mimei, 30, e.a("0NzHgeT437nmgZzYkMzijYbghdPQlrOTlPywgcTBhP+MAxMU")));
        arrayList3.add(new HomeBean(e.a("3v3KgtfY3IP8jpvT"), R.mipmap.launcher_slf, 44, e.a("0NzHgeT437nmgZzYkMzijYbghdPQlrOTlPywgcTBhP+MAxMU")));
        arrayList3.add(new HomeBean(e.a("0f7qge7n3IP8jpvT"), R.mipmap.launcher_youtu, 37, e.a("39Tmg9HU3YvDg5vrn/Dnjofti8vfm4y3ldykiMX0")));
        arrayList3.add(new HomeBean(e.a("3vHVgvb8GXU+"), R.mipmap.launcher_yx, 29, e.a("0tzrgsjh3qn3gKjuncnTjofti8vfm4y3ldyk")));
        s(this.rvNovel, arrayList3);
        ArrayList arrayList4 = new ArrayList();
        arrayList4.add(new HomeBean(e.a("3+P5gfv735bPg7PD"), R.mipmap.icon_secret_garden, 40, e.a("0ufLjejb35bPg7PDkOv5jqfq")));
        arrayList4.add(new HomeBean(e.a("AlOKx+WVjLI="), R.mipmap.launcher_fl, 50, e.a("0ufLjejb35bPg7PDkOv5jqfq")));
        arrayList4.add(new HomeBean(e.a("0tzNgvb835bPg7PD"), R.mipmap.launcher_wx, 7, e.a("0s3hgcTt3IPCgKnCkNX6grDuhe3Vlp+Klsuk")));
        s(this.rvLoufeng, arrayList4);
        ArrayList arrayList5 = new ArrayList();
        if (!TextUtils.isEmpty(f.e.a.k.b.d0)) {
            arrayList5.add(new HomeBean(e.a("VhIIgfv70Kj1"), R.mipmap.icon_secret_garden, 42, e.a("0fbVjPz83o7ig6nnntrbg4j+h9zml4Wpm9mDj8/F"), f.e.a.k.b.d0));
        }
        arrayList5.add(new HomeBean(e.a("0sz7gv3K3J3RgKjqn9TH"), R.mipmap.launcher_telegram, 100, e.a("0fbVjPz83o7ig6nnntrbg4j+h9zml4Wpm9mDj8/F"), e.a("XxYXFBhJFhwHSFkCVwcODU4FBQ==")));
        arrayList5.add(new HomeBean(e.a("0urlgNHY"), R.drawable.ic_set_share, 18, e.a("0sfegNPv0ZbMgLTpnNPrjrjNh9/Ol4Gzl96eg8LQhMy2ivTr")));
        arrayList5.add(new HomeBean(e.a("0eryg/H336fFjqPo"), R.drawable.ic_set_collet, PointerIconCompat.TYPE_CONTEXT_MENU, e.a("0sfegNPv0ZbMgLTpnNPrjrjNh9/Ol4Gzl96eg8LQhMy2ivTr")));
        arrayList5.add(new HomeBean(e.a("0N7wgcbr3Yveg4vk"), R.drawable.ic_set_download, PointerIconCompat.TYPE_HAND, e.a("0sfegNPv0ZbMgLTpnNPrjrjNh9/Ol4Gzl96eg8LQhMy2ivTr")));
        arrayList5.add(new HomeBean(e.a("0trbjMzy0KTdj5b/"), R.drawable.ic_set_question, PointerIconCompat.TYPE_HELP, e.a("0sfegNPv0ZbMgLTpnNPrjrjNh9/Ol4Gzl96eg8LQhMy2ivTr")));
    ...
    public final void s(RecyclerView recyclerView, List<HomeBean> list) {
        ...
        ConfigBean configBean = App.f104e;
        if (!(configBean == null || (task = configBean.getTask()) == null || h.r(task.getPackageName()))) {
        ...
        mainAdapter.f1504d = this.f1490d;
    }
