...
public class VideoListAdapter extends BaseAbstractAdapter<LVideosBean> {
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/lutube/bean/LVideosBean;>; */
    @NonNull
