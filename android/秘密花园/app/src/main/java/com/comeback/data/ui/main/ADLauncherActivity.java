...
public class ADLauncherActivity extends BaseActivity {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (i2 > 3) {
                ...
                aDLauncherActivity2.tvCount.postDelayed(aDLauncherActivity2.f1453d, 1000);
                return;
            }
            ...
            if (i3 >= 0) {
                ...
                aDLauncherActivity3.tvCount.postDelayed(aDLauncherActivity3.f1453d, 1000);
    ...
    public void e() {
        ...
        this.tvCount.postDelayed(this.f1453d, 150);
    }
