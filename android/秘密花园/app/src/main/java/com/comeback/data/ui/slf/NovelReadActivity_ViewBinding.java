...
public class NovelReadActivity_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ NovelReadActivity f1954c;

        public a(NovelReadActivity_ViewBinding novelReadActivity_ViewBinding, NovelReadActivity novelReadActivity) {
            this.f1954c = novelReadActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            NovelReadActivity novelReadActivity = this.f1954c;
            if (novelReadActivity.b) {
                novelReadActivity.m();
                return;
            }
            novelReadActivity.b = true;
            ObjectAnimator.ofFloat(novelReadActivity.llFolder, e.a("QxACChgfWEcaCVo/"), (float) novelReadActivity.llFolder.getWidth(), 0.0f).setDuration(300L).start();
        }
    }
