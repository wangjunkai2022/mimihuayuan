...
public class RealTimeAdapter extends BaseAbstractAdapter<DsItemBean> {

    /* loaded from: classes.dex */
    public static class Holder extends BaseViewHolder<DsItemBean> {
        public RealTimeAdapter a;
        public DsItemBean b;
        @BindView
        ...
        public Holder(View view, RealTimeAdapter realTimeAdapter) {
            super(view);
        ...
        public void a(DsItemBean dsItemBean) {
            ...
            textView.setText(dsItemBean2.getTitle() + e.a("F08=") + dsItemBean2.getMhstatusString());
            TextView textView2 = this.tvAuthor;
            textView2.setText(e.a("09//jOv21o/p") + dsItemBean2.getAuther());
            this.tvRank.setText(dsItemBean2.getPingfen());
            this.tvIntro.setText(dsItemBean2.getDesc());
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        /* compiled from: RealTimeAdapter$Holder_ViewBinding.java */
        /* loaded from: classes.dex */
        public class a extends b {

            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f626c;
    ...
    public BaseViewHolder f(@NonNull ViewGroup viewGroup) {
        return new Holder(this.f107c.inflate(R.layout.item_ds_real_time, viewGroup, false), this);
    }
