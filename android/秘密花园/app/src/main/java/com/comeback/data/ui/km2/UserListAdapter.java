...
public class UserListAdapter extends BaseAbstractAdapter<Km2User> {
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/km2/bean/Km2User;>; */
    @NonNull
