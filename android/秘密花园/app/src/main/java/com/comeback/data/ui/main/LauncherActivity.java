...
public class LauncherActivity extends BaseActivity {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (i2 > 0) {
                launcherActivity.tvName.postDelayed(launcherActivity.f1475f, 250);
            } else if (i2 == 0) {
                launcherActivity.tvName.postDelayed(launcherActivity.f1475f, 500);
            } else {
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            if (i2 > 2) {
                ...
                launcherActivity2.tvCount.postDelayed(launcherActivity2.f1475f, 1200);
                return;
            }
            ...
            if (i3 > 0) {
                ...
                launcherActivity3.tvCount.postDelayed(launcherActivity3.f1475f, 1200);
                return;
            }
            launcherActivity.o();
        }
    ...
    public static void l(LauncherActivity launcherActivity) {
        if (launcherActivity.f1473d) {
            if (!launcherActivity.f1472c) {
                ...
                launcherActivity.tvCount.postDelayed(launcherActivity.f1477h, 150);
            }
        }
    }
    ...
    public final void n() {
        ...
        if (b2.a.getLong(e.a("UQsRFx8sTVoeAw=="), -1) == -1) {
        ...
        this.tvName.postDelayed(this.f1475f, 250);
    }
