...
public class FengliuActivity extends BaseRefreshActivity {
    ...
    public HashMap<String, HashMap<String, String>> f1238d;

    /* renamed from: e  reason: collision with root package name */
    public List<List<b>> f1239e;

    /* renamed from: f  reason: collision with root package name */
    public ArrayList<b> f1240f;
    @BindView
    public FloatingActionButton floatingActionButton;

    /* renamed from: g  reason: collision with root package name */
    public String f1241g = e.a("Vg4P");
    ...
    public static void t(FengliuActivity fengliuActivity, boolean z, String str) {
        if (fengliuActivity != null) {
            ...
            if (z) {
                ...
                SearchResultActivity.u(fengliuActivity, str, fengliuActivity.f1243i, fengliuActivity.f1242h);
            }
        } else {
            throw null;
        }
    ...
    public void c(Intent intent) {
        this.f1242h = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1243i = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void e() {
        ...
        try {
            ...
            j jVar = new j();
            Type type = new f.e.a.j.v.b(this).b;
        ...
        HashMap<String, String> hashMap2 = this.f1238d.get(e.a("D1Q="));
        TextView textView = this.tvArea;
        textView.setText(this.f1242h + e.a("GofmzI7ohA=="));
        this.f1240f.add(new b(this, e.a("0ufLjejb"), e.a("Vg4P")));
        for (String str : hashMap2.keySet()) {
            this.f1240f.add(new b(this, hashMap2.get(str), str));
        }
        Iterator<b> it = this.f1240f.iterator();
        while (it.hasNext()) {
            b next = it.next();
            ArrayList arrayList = new ArrayList();
            this.f1239e.add(arrayList);
            arrayList.add(new b(this, e.a("0ufLjejb"), next.b));
            HashMap<String, String> hashMap3 = this.f1238d.get(next.b);
    ...
    public void onViewClicked(View view) {
        if (view.getId() == R.id.ll_area) {
            f.e.a.j.v.a aVar = new d() { // from class: f.e.a.j.v.a
                @Override // f.c.a.h.d
            ...
            eVar.f(this.f1240f, this.f1239e, null);
            eVar.e();
        }
    }
    ...
    public void p(int i2) {
        k(c.a().b(i2, this.f1241g, this.f1243i), new a(i2));
    }

    public void u(int i2, int i3, int i4, View view) {
        b bVar = this.f1239e.get(i2).get(i3);
        this.f1241g = bVar.b;
        TextView textView = this.tvArea;
        StringBuilder sb = new StringBuilder();
        f.b.a.a.a.B(sb, this.f1242h, "Gg==");
        f.b.a.a.a.B(sb, this.f1240f.get(i2).a, "Gg==");
        sb.append(bVar.a);
