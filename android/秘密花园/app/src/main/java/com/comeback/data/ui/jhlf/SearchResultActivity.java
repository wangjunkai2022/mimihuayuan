...
public class SearchResultActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1254d = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1255e = intent.getStringExtra(e.a("XgY="));
        this.f1256f = intent.getStringExtra(e.a("XAca"));
    }
    ...
    public void e() {
        ...
        sb.append(TextUtils.isEmpty(this.f1254d) ? e.a("0ufLg8Dq") : this.f1254d);
        sb.append(e.a("Gg=="));
    ...
    public void p(int i2) {
        m.e<ArrayList<MMList.DataEntity>> eVar;
        if (TextUtils.isEmpty(this.f1255e)) {
            eVar = c.a().d(i2, this.f1256f);
        } else {
            eVar = c.a().a(i2, this.f1255e, this.f1256f);
        }
        k(eVar, new a(i2));
    }
}
