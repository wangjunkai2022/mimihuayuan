...
public class ComicVAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f1990c;

    /* renamed from: d  reason: collision with root package name */
    public boolean f1991d;

    /* renamed from: e  reason: collision with root package name */
    public int f1992e = new Random().nextInt(1000);
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(ComicVAdapter comicVAdapter, View view) {
            ...
            this.f1993c = (TextView) view.findViewById(R.id.tv_intro);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        SLFItemBean sLFItemBean = this.f1990c.get(i2);
        h.N0(sLFItemBean.getImg(), bVar.a, 0);
        bVar.b.setText(sLFItemBean.getName());
        h.k1(bVar.f1993c, sLFItemBean.getDescription());
