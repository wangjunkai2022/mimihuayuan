...
public class UserCenterActivity extends BaseRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<ImageList> {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ int f1079f;
    ...
    public void c(Intent intent) {
        this.f1076e = intent.getStringExtra(e.a("XgY="));
        this.f1075d = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1077f = intent.getStringExtra(e.a("QhAP"));
        this.f1078g = intent.getBooleanExtra(e.a("XhEqCQoUXA=="), true);
    }
    ...
    public void e() {
        ...
        this.tvName.setText(this.f1075d);
        h.z0(this.f1077f, this.ivHead);
        this.ivImg.setColorFilter(this.f1078g ? this.basic_primary_text : this.basic_third_text);
        this.ivVideo.setColorFilter(this.f1078g ? this.basic_third_text : this.basic_primary_text);
    }
    ...
    public void p(int i2) {
        ...
        if (this.f1078g) {
            m.e<ImageList> g2 = f.e.a.j.r.e.b.a().g(this.f1076e, hashMap, f.e.a.k.b.u0);
            a aVar = new a(i2);
            g2.d(m.r.a.a()).b(m.l.b.a.a()).c(aVar);
            this.a.b(aVar);
            return;
        }
        m.e<VideoList> b2 = f.e.a.j.r.e.b.a().b(this.f1076e, hashMap, f.e.a.k.b.u0);
        b bVar = new b(i2);
