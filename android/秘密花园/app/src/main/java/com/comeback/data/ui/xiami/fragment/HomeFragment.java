...
public class HomeFragment extends BaseViewPagerFragment {
    ...
    public ArrayList<BaseFragment> h() {
        ...
        for (Category.DataBean dataBean : MainActivity.f2136d.getData()) {
            arrayList.add(HomeTypeFragment.j(dataBean));
        }
        return arrayList;
    }
    ...
    @Override // com.comeback.data.base.BaseViewPagerFragment
    public String[] i() {
        List<Category.DataBean> data = MainActivity.f2136d.getData();
