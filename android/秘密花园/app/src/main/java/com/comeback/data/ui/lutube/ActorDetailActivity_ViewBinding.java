...
public class ActorDetailActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public ActorDetailActivity f1394c;
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ ActorDetailActivity f1396c;

        public a(ActorDetailActivity_ViewBinding actorDetailActivity_ViewBinding, ActorDetailActivity actorDetailActivity) {
            this.f1396c = actorDetailActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            ActorDetailActivity actorDetailActivity = this.f1396c;
            g.d(actorDetailActivity.f1391d.getRealm()).a(actorDetailActivity.f1391d);
    ...
    public ActorDetailActivity_ViewBinding(ActorDetailActivity actorDetailActivity, View view) {
        ...
        this.f1394c = actorDetailActivity;
    ...
    public void a() {
        ActorDetailActivity actorDetailActivity = this.f1394c;
