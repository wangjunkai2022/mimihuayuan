...
public class VTitle1Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public Channel.DataBean.RowsBean f2250c;
    ...
    public /* synthetic */ void d(View view) {
        SpecialDetailActivity.w(this.a, this.f2250c);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        aVar.a.setText(this.f2250c.getSpname());
        aVar.b.setText(this.f2250c.getItemcount());
        aVar.b.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.r0.d.n
