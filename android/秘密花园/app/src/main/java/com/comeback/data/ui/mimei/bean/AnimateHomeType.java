...
public class AnimateHomeType extends j {
    ...
    public static class SuccessBean {
        ...
        public List<MimeiAnimateItem> series;
        ...
        public static class RankingBean {
            public List<MimeiAnimateItem> data;
            public int lastPage;
            public int total;

            public List<MimeiAnimateItem> getData() {
                return this.data;
            }
            ...
            public void setData(List<MimeiAnimateItem> list) {
                this.data = list;
            }
