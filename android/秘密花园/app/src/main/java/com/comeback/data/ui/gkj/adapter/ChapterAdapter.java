...
public class ChapterAdapter extends BaseAbstractAdapter<ComicDetail.DataEntity.ChaptersEntity> {
    ...
    public static class Holder extends BaseViewHolder<ComicDetail.DataEntity.ChaptersEntity> {
        ...
        public void a(ComicDetail.DataEntity.ChaptersEntity chaptersEntity) {
            ...
            this.tvTitle.setTextColor(this.a.f908e == getAdapterPosition() ? this.kmColorAccent : this.white);
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f910c;
            ...
            public void a(View view) {
                Holder holder = this.f910c;
                a aVar = holder.a.f907d;
                if (aVar != null) {
                    aVar.a(holder.getAdapterPosition());
                    holder.a.f908e = holder.getAdapterPosition();
                }
            }
        }
