...
public class MdActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1637c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.d0.b
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1637c);
    }
