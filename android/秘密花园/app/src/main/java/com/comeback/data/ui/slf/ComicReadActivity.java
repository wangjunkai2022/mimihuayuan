...
public class ComicReadActivity extends BaseActivity implements View.OnClickListener {
    ...
    public class b extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(@NonNull RecyclerView recyclerView, int i2, int i3) {
            ...
            textView.setText(e.a("0M7P") + (comicReadActivity.f1937g + 1) + e.a("383+REs=") + (findFirstVisibleItemPosition + 1) + e.a("GA==") + comicReadActivity.f1936f.getItemCount());
        }
    }
    ...
    public void c(Intent intent) {
        ...
        this.f1933c = intent.getStringExtra(e.a("XgY="));
        this.b = (List) new j().e(stringExtra, new a(this).b);
        this.f1937g = intent.getIntExtra(e.a("XgwHARM="), 0);
    }
    ...
    public void e() {
        ...
        r rVar = new r();
        rVar.e(e.a("XgY="), this.f1933c);
        k(f.e.a.j.k0.h.b.a().m(d.a(rVar.toString())), new f(this));
    }
    ...
    public final void n() {
        ...
        chapterAdapter.f1976e = this.f1937g;
        chapterAdapter.f1975d = new ChapterAdapter.a() { // from class: f.e.a.j.k0.a
        ...
        linearLayoutManager.scrollToPosition(this.f1937g);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_folder /* 2131296953 */:
                m();
                this.f1935e = true;
                ObjectAnimator.ofFloat(this.llFolder, e.a("QxACChgfWEcaCVo/"), (float) this.llFolder.getWidth(), 0.0f).setDuration(300L).start();
                return;
            case R.id.tv_next /* 2131296994 */:
                if (this.f1937g < this.b.size() - 1) {
                    this.f1937g++;
                    p();
                    return;
                }
    ...
    public final void p() {
        if (this.f1936f == null) {
            ...
            this.f1936f = picAdapter;
            picAdapter.f2011d = this;
            this.rvList.setLayoutManager(new LinearLayoutManager(this));
            this.rvList.setAdapter(this.f1936f);
        }
        this.f1936f.c();
        this.f1936f.a(this.b.get(this.f1937g).getImages());
        if (this.f1936f.getItemCount() == 0) {
