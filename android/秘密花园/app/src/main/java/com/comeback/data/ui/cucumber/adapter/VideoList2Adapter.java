...
public class VideoList2Adapter extends BaseAbstractAdapter<Video> {
    ...
    public static class Holder extends BaseViewHolder<Video> {
        ...
        public void a(Video video) {
            ...
            String str = "";
            try {
                str = new JSONObject(video2.getCover().replace(b.O, str)).getString(e.a("QQcREAIQWF8sFVkGFAY="));
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/cucumber/bean/Video;>; */
    @NonNull
