    ...
    public static class DataEntity {
        ...
        public static class ArticleVOSEntity implements Parcelable {
            ...
            public boolean isVip() {
                if (TextUtils.isEmpty(this.resources) && this.vip != 1) {
                    return false;
                }
                return true;
            }
            ...
            public void writeToParcel(Parcel parcel, int i2) {
                ...
                parcel.writeByte(this.haveNew ? (byte) 1 : 0);
                parcel.writeByte(this.likeIs ? (byte) 1 : 0);
            ...
            public ArticleVOSEntity(Parcel parcel) {
                ...
                this.likeIs = parcel.readByte() == 0 ? false : z;
