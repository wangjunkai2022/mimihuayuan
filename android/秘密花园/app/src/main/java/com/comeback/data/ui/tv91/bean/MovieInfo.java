...
public class MovieInfo extends j {
    ...
    public class MessageEntity {
        ...
        private String createId() {
            ...
            if (img.contains(e.a("GBIKB0Q="))) {
                str = img.split(e.a("GBIKB0Q="))[1].replace(e.a("GQgTAw=="), "");
            } else {
                str = "";
            }
            if (img.contains(e.a("GDIqJ0Q="))) {
                str = img.split(e.a("GDIqJ0Q="))[1].replace(e.a("GQgTAw=="), "");
            }
            if (img.contains(e.a("GBIKB1lc"))) {
                str = img.split(e.a("GBIKB1lc"))[1].replace(e.a("GQgTAw=="), "");
            }
            if (img.contains(e.a("GDIqJ1lc"))) {
                str = img.split(e.a("GDIqJ1lc"))[1].replace(e.a("GQgTAw=="), "");
            }
            if (!TextUtils.isEmpty(str) && str.startsWith(e.a("GA=="))) {
                str = str.substring(1);
            }
            return (TextUtils.isEmpty(str) || !str.contains(e.a("GQ8TUA=="))) ? str : str.replace(e.a("GQ8TUA=="), "");
        }
