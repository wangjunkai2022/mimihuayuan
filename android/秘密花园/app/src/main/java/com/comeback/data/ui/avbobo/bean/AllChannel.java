...
public class AllChannel extends j {
    public int code;
    ...
    public static class DataBean implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeByte(this.editable ? (byte) 1 : 0);
            parcel.writeByte(this.searchable ? (byte) 1 : 0);
            parcel.writeByte(this.recommendable ? (byte) 1 : 0);
        ...
        public DataBean(Parcel parcel) {
            ...
            this.recommendable = parcel.readByte() == 0 ? false : z;
