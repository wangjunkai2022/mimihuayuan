...
public class GDianActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f799c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.l.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f799c);
    }
    ...
    public /* synthetic */ boolean l(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.navigation_image /* 2131296619 */:
                ...
                return true;
            case R.id.navigation_live /* 2131296620 */:
