...
public class SearchMovieItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<HomeData.DataBean.VideosBean> f1599c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(SearchMovieItemAdapter searchMovieItemAdapter, View view) {
            ...
            this.f1600c = (TextView) view.findViewById(R.id.tv_title);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        HomeData.DataBean.VideosBean videosBean = this.f1599c.get(i2);
        bVar.f1600c.setText(videosBean.getName());
