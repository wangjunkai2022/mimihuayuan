...
public class VideoListFragment extends BaseRefreshFragment {
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            ...
            try {
                ...
                if (VideoListFragment.this.f1236j) {
                    VideoListFragment.this.f117h.a(f.e.a.j.u.e.a.d(H).getList());
                    return;
                }
                VideoListFragment.this.f117h.a(f.e.a.j.u.e.a.a(H));
    ...
    public void a() {
        this.f1235i = getArguments().getString(e.a("QhAP"));
        this.f1236j = getArguments().getBoolean(e.a("XhE1DQ8WVg=="));
    }
    ...
    public RecyclerView.LayoutManager i() {
        return new GridLayoutManager(getContext(), this.f1236j ? 2 : 3);
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public void l(int i2) {
        d<i0> b = c.a().b(this.f1235i + e.a("ERICAw5O") + i2, b.h0, b.f3970c);
        this.f1237k = b;
        b.X(new a(i2));
    }
