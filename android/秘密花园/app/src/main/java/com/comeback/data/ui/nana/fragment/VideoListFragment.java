...
public class VideoListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1806m = getArguments().getInt(e.a("WgcNETQaXQ=="), 0);
        this.f1802i = getArguments().getString(e.a("QQsHAQQsTUoDAw=="), "");
        this.f1803j = getArguments().getString(e.a("WBAHARk="), "");
        this.f1804k = getArguments().getString(e.a("Qw0T"), "");
        this.f1805l = getArguments().getString(e.a("VAMXAQwcS0o="), "");
    }
    ...
    public RecyclerView.LayoutManager i() {
        if (this.f1802i.equals(e.a("Ww0NAw=="))) {
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("QQsHAQQsTUoDAw=="), this.f1802i);
        hashMap.put(e.a("WBAHARk="), this.f1803j);
        hashMap.put(e.a("Qw0T"), this.f1804k);
        hashMap.put(e.a("VAMXAQwcS0o="), this.f1805l);
        g(f.e.a.j.g0.m.e.a().d(this.f1806m, hashMap), new a(i2));
    }
}
