...
public class Km2Activity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1320c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.x.c
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1320c);
    }
