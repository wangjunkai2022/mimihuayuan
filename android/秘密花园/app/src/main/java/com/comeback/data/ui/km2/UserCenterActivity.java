...
public class UserCenterActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1348e = intent.getStringExtra(e.a("XgY="));
        this.f1347d = intent.getStringExtra(e.a("WQMOAQ=="));
    }
    ...
    public void e() {
        ...
        this.tvName.setText(this.f1347d);
        if (g.d(x.P()).f(Km2User.class, e.a("Whc8DQ8="), this.f1348e).size() != 0) {
            t(this.tvFollow);
        }
    }
    ...
    public void p(int i2) {
        ...
        try {
            jSONObject.put(e.a("VRs8DQ8="), this.f1348e);
            jSONObject.put(e.a("RwMEAQ=="), i2);
            jSONObject.put(e.a("QxsTAQ=="), 5);
        } catch (Exception unused) {
        }
        k(d.a().b(f.e.a.j.x.j.a.c(jSONObject)), new a(i2));
    }
