...
public class LoufengListFragment extends BaseRefreshFragment {
    ...
    public static void m(LoufengListFragment loufengListFragment, LouFengList louFengList) {
        if (loufengListFragment.f116g == 1) {
            h.n1(e.a("0ufSgvTW3LvD") + louFengList.getTotal_num_rows() + e.a("0f/CgNTS37Lc"));
    ...
    public void a() {
        this.f1862i = getArguments().getInt(e.a("RxAMEg=="));
        this.f1863j = getArguments().getInt(e.a("VAsXHQ=="));
    }
    ...
    public void l(int i2) {
        g(b.a().a(d.b(i2, this.f1862i, this.f1863j), System.currentTimeMillis()), new a());
    }
}
