...
public class XXItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<XXList.DataBean.VodrowsBean> f1753c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(XXItemAdapter xXItemAdapter, View view) {
            ...
            this.f1755d = (TextView) view.findViewById(R.id.tv_title);
            this.f1754c = (TextView) view.findViewById(R.id.tv_area);
            this.f1756e = (TextView) view.findViewById(R.id.tv_detail);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        XXList.DataBean.VodrowsBean vodrowsBean = this.f1753c.get(i2);
        bVar.f1755d.setText(vodrowsBean.getTitle());
        h.u0(vodrowsBean.getCoverpic(), bVar.a);
        bVar.b.setText(vodrowsBean.getScorenum());
        bVar.f1754c.setText(vodrowsBean.getAreaname());
        bVar.f1756e.setText(vodrowsBean.getIntro());
