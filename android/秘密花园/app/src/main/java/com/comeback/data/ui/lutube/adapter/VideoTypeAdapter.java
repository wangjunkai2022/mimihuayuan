...
public class VideoTypeAdapter extends BaseAbstractAdapter<VideoType.ResponseBean.CategoriesBean> {
    ...
    public class HomeListHolder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ HomeListHolder f1420c;

            public a(HomeListHolder_ViewBinding homeListHolder_ViewBinding, HomeListHolder homeListHolder) {
                this.f1420c = homeListHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                HomeListHolder homeListHolder = this.f1420c;
                VideoListActivity.n(homeListHolder.a.a, homeListHolder.b.getCategory_id(), homeListHolder.a.f1418d, homeListHolder.b.getCategory_name());
            }
        }
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/lutube/bean/VideoType$ResponseBean$CategoriesBean;>; */
    @NonNull
