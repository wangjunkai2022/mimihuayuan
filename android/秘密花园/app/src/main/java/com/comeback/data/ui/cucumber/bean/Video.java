...
public class Video extends j implements Parcelable {
    ...
    public Video(Parcel parcel) {
        ...
        this.hasFavor = parcel.readByte() == 0 ? false : z;
        this.id = parcel.readInt();
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        parcel.writeByte(this.hasDown ? (byte) 1 : 0);
        parcel.writeByte(this.hasFavor ? (byte) 1 : 0);
        parcel.writeInt(this.id);
