    ...
    public class a extends j<ComicDetail> {
        ...
        public void f(ComicDetail comicDetail) {
            ...
            if (comicDetailActivity != null) {
                ...
                int i2 = 0;
                int i3 = 0;
                while (i3 < chapters.size() && i3 < 5) {
                    comicDetailActivity.f851h.add(chapters.get(i3));
                    i3++;
                }
                while (i2 < chapters.size() && i2 < 5) {
                    comicDetailActivity.f850g.add(chapters.get((chapters.size() - i2) - 1));
                    i2++;
                }
