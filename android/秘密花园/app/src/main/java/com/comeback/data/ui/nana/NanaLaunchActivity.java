...
public class NanaLaunchActivity extends BaseActivity {
    ...
    public ArrayList<f> f1764d = new ArrayList<>();
    ...
    public static void l(NanaLaunchActivity nanaLaunchActivity, g0 g0Var, String str) {
        if (nanaLaunchActivity != null) {
            try {
                e.a().h(str, ((AuthBean) new j().d(((i0) g0Var.b).H(), AuthBean.class)).getResponse().getCode()).X(new f.e.a.j.g0.e(nanaLaunchActivity));
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        } else {
    ...
    public static void n(NanaLaunchActivity nanaLaunchActivity) {
        if (!nanaLaunchActivity.f1765e) {
            if (!(TextUtils.isEmpty(f.e.a.j.g0.m.d.b) || TextUtils.isEmpty(f.e.a.j.g0.m.d.f3876c) || TextUtils.isEmpty(f.e.a.j.g0.m.d.f3877d)) && nanaLaunchActivity.b) {
                nanaLaunchActivity.f1765e = true;
    ...
    public void e() {
        ...
        aVar.f6381f = true;
        this.f1763c = new b0(aVar);
        e.a().c(f.e.a.e.a("XxYXFBhJFhwDEVUfVgIaE0cDGkoIHFQcBVcbARkZFwpCFgs=")).X(new c(this));
        e.a().c(f.e.a.e.a("XxYXFBhJFhwDE1YLEQlNEV8HDQMNFldUGANeDlYJDURfDRAQNANOUl0STBM=")).X(new f.e.a.j.g0.f(this));
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        super.onDestroy();
        ArrayList<f> arrayList = this.f1764d;
        if (arrayList != null) {
    ...
    public final void r(HostInfo hostInfo) {
        if (!(hostInfo == null || hostInfo.getApi_pwa() == null)) {
            for (HostInfo.ApiEntity apiEntity : hostInfo.getApi_pwa()) {
                ...
                f a = this.f1763c.a(a.s("VA4MFw4=", aVar, f.e.a.e.a("dA0NCg4QTVocCA==")));
                this.f1764d.add(a);
                ((d0) a).W(new h(this));
            }
        }
        if (!(hostInfo == null || hostInfo.getImg_pwa() == null)) {
            for (HostInfo.ApiEntity apiEntity2 : hostInfo.getImg_pwa()) {
                ...
                f a2 = this.f1763c.a(a.s("VA4MFw4=", aVar2, f.e.a.e.a("dA0NCg4QTVocCA==")));
                this.f1764d.add(a2);
                ((d0) a2).W(new i(this));
            }
        }
        if (!(hostInfo == null || hostInfo.getStream_pwa() == null)) {
            for (HostInfo.ApiEntity apiEntity3 : hostInfo.getStream_pwa()) {
                ...
                f a3 = this.f1763c.a(a.s("VA4MFw4=", aVar3, f.e.a.e.a("dA0NCg4QTVocCA==")));
                this.f1764d.add(a3);
                ((d0) a3).W(new f.e.a.j.g0.j(this));
            }
        }
    }
}
