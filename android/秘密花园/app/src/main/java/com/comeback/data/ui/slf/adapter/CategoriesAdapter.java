...
public class CategoriesAdapter extends BaseAbstractAdapter<CategoriesBean> {
    ...
    public static class Holder extends BaseViewHolder<CategoriesBean> {
        ...
        public void a(CategoriesBean categoriesBean) {
            ...
            h.N0(categoriesBean2.getImg(), this.ivHead, 0);
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1974c;
            ...
            public void a(View view) {
                ...
                if (holder != null) {
                    ...
                    if (e.a("RQMNDw==").equals(key)) {
                        ...
                        RankActivity.n(categoriesAdapter.a, categoriesAdapter.f1972d);
                    } else if (e.a("RBIGBwISVQ==").equals(key)) {
                        CategoriesAdapter categoriesAdapter2 = holder.b;
                        SpecialActivity.t(categoriesAdapter2.a, categoriesAdapter2.f1972d);
                    } else {
                        CatIdActivity.v(holder.b.a, str, holder.a.getName(), holder.b.f1972d);
                    }
                } else {
                    throw null;
                }
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/slf/bean/CategoriesBean;>; */
    @NonNull
