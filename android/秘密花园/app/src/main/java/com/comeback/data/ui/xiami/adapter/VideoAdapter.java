...
public class VideoAdapter extends BaseAbstractAdapter<VideoInfo> {
    ...
    public static class Holder extends BaseViewHolder<VideoInfo> {
        ...
        public void a(VideoInfo videoInfo) {
            ...
            this.b = videoInfo2;
            this.tvTitle.setText(videoInfo2.getVideoTitle());
            this.tvIntro.setText(videoInfo2.getVideoTime());
            h.u0(videoInfo2.getVideoImage(), this.ivCover);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f2163c;
    ...
    public Holder f(@NonNull ViewGroup viewGroup) {
        return new Holder(this.f107c.inflate(R.layout.item_xm_video_h, viewGroup, false), this);
    }
