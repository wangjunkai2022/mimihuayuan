...
public class Tag3Adapter extends BaseAbstractAdapter<ScreenBean.StateBean> {
    ...
    public static class Holder extends BaseViewHolder<ScreenBean.StateBean> {
        ...
        public void a(ScreenBean.StateBean stateBean) {
            ...
            textView.setBackground(adapterPosition == tag3Adapter.f964d ? tag3Adapter.a.getDrawable(R.drawable.bg_radius_red_stroke) : null);
            this.tvTag.setTextColor(getAdapterPosition() == this.a.f964d ? Color.parseColor(e.a("FAQFUF9HDQ==")) : this.thirdText);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f967c;
    ...
    public String f() {
        return ((ScreenBean.StateBean) this.b.get(this.f964d)).getKey();
    }
