...
public class PPTAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public ViewModel.DataBean f952c;
    ...
    public class a implements OnBannerListener {
        ...
        public void OnBannerClick(int i2) {
            ...
            pPTAdapter.f952c.getM_banner_data().get(i2);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        Iterator<ViewModel.DataBean.MBannerDataBean> it = this.f952c.getM_banner_data().iterator();
        ...
        bVar.a.setImages(this.f952c.getM_banner_data());
