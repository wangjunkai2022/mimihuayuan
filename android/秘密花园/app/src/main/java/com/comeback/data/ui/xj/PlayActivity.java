...
public class PlayActivity extends BaseActivity {
    ...
    public void e() {
        ...
        if (this.f2188c) {
            eVar = b.a().g(z ? f.e.a.k.b.f3977j : f.e.a.k.b.f3978k, this.b);
        } else {
            f.e.a.j.r0.f.a a2 = b.a();
            Random random = new Random();
            eVar = a2.h(random.nextInt(255) + e.a("GQ==") + random.nextInt(255) + e.a("GQ==") + random.nextInt(255) + e.a("GQ==") + random.nextInt(255), this.b);
        }
        k(eVar, new a());
    }
