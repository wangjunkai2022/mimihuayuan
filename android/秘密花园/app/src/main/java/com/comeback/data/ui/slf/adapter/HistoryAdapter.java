...
public class HistoryAdapter extends BaseAbstractAdapter<SLFItemBean> {
    ...
    public static class Holder extends BaseViewHolder<SLFItemBean> {
        ...
        public Holder(View view, HistoryAdapter historyAdapter) {
            super(view);
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        /* compiled from: HistoryAdapter$Holder_ViewBinding.java */
        /* loaded from: classes.dex */
        public class a extends b {

            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f2003c;
    ...
    public Holder f(@NonNull ViewGroup viewGroup) {
        return new Holder(this.f107c.inflate(R.layout.item_gkj_history, viewGroup, false), this);
    }
