...
public class AMJItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        AMJList.DataBean dataBean = this.f1742c.get(i2);
        ...
        aVar.itemView.setOnClickListener(new View.OnClickListener(dataBean) { // from class: f.e.a.j.f0.g.a
            public final /* synthetic */ AMJList.DataBean b;
            ...
            public final void onClick(View view) {
                AMJItemAdapter.this.d(this.b, view);
            }
        });
    }
