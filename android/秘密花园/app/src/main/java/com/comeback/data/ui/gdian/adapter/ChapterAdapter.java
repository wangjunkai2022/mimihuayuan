...
public class ChapterAdapter extends BaseAbstractAdapter<ChapterList.DataEntity.ListEntity> {
    ...
    public class HomeListHolder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ HomeListHolder f813c;

            public a(HomeListHolder_ViewBinding homeListHolder_ViewBinding, HomeListHolder homeListHolder) {
                this.f813c = homeListHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                HomeListHolder homeListHolder = this.f813c;
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/gdian/bean/ChapterList$DataEntity$ListEntity;>; */
    @NonNull
