...
public class MmLaunchActivity extends BaseActivity {
    ...
    public static String[] f1532g = {e.a("BlBXSlpGDx1CVw1JSl9R"), e.a("BldTSlpDAB1CVwJJTVk=")};
    public b0 b;
    ...
    public ArrayList<f> f1534d = new ArrayList<>();

    /* renamed from: f  reason: collision with root package name */
    public g f1536f = new a();
    ...
    public class a implements g {
        ...
        public void c(f fVar, h0 h0Var) {
            if (h0Var.f6449e <= 300) {
                Iterator<f> it = MmLaunchActivity.this.f1534d.iterator();
                while (it.hasNext()) {
                    it.next().cancel();
                }
                MmLaunchActivity mmLaunchActivity = MmLaunchActivity.this;
                if (!mmLaunchActivity.f1535e) {
                    mmLaunchActivity.f1535e = true;
                    String replace = fVar.S().b.f6779j.replace(e.a("GAMTDUQHVlwfFRsDFwcCAlk="), "");
                    b.f3975h = replace;
            ...
            } else if (MmLaunchActivity.this.f1534d.size() == 1) {
        ...
        public void d(f fVar, IOException iOException) {
            if (MmLaunchActivity.this.f1534d.size() == 1) {
                MmLaunchActivity.this.m();
            }
        }
    }
    ...
    public static void l(MmLaunchActivity mmLaunchActivity) {
        if (mmLaunchActivity != null) {
            int length = f1532g.length;
            String[] strArr = new String[length];
            for (int i2 = 0; i2 < length; i2++) {
                String str = f1532g[i2];
    ...
    public void onDestroy() {
        ...
        ArrayList<f> arrayList = this.f1534d;
        if (arrayList != null) {
