...
public class HomeTypeFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1643i = getArguments().getString(f.e.a.e.a("VAoCCgUWVQ=="));
    }
    ...
    public void l(int i2) {
        ...
        if (!TextUtils.isEmpty(this.f1643i)) {
            treeMap.put(f.e.a.e.a("VAoCCgUWVQ=="), this.f1643i);
        }
        treeMap.put(f.e.a.e.a("WwsQEDQBVkQ="), f.e.a.e.a("BVI="));
        treeMap.put(f.e.a.e.a("QxsTAQ=="), f.e.a.e.a("BQ=="));
        b b = f.e.a.j.d0.d.e.b();
        d.a(treeMap);
        e<MdApiBean> d2 = b.d(treeMap);
        a aVar = new a(i2);
        d2.d(m.r.a.a()).b(m.r.a.a()).a(f.e.a.j.d0.c.a.a).b(m.l.b.a.a()).c(aVar);
        this.a.b(aVar);
    }
}
