...
public class HGDDBrowseActivity extends BaseActivity {
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            if (hGDDBrowseActivity.b != contains) {
                ...
                if (contains) {
                    ...
                    Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(hGDDBrowseActivity.flShow, width, height, 0.0f, (float) Math.hypot((double) width, (double) height));
                    ...
                    Animator createCircularReveal2 = ViewAnimationUtils.createCircularReveal(hGDDBrowseActivity.flShow, width2, height2, (float) Math.hypot((double) width2, (double) height2), 0.0f);
                    createCircularReveal2.addListener(new f.e.a.j.o.a(hGDDBrowseActivity));
    ...
    public class b extends WebChromeClient {
        ...
        public IX5WebChromeClient.CustomViewCallback f1012c;
        ...
        public void onHideCustomView() {
            IX5WebChromeClient.CustomViewCallback customViewCallback = this.f1012c;
        ...
        public void onShowCustomView(View view, IX5WebChromeClient.CustomViewCallback customViewCallback) {
            ...
            this.a = view;
            this.b = webView;
            this.f1012c = customViewCallback;
        }
    }
