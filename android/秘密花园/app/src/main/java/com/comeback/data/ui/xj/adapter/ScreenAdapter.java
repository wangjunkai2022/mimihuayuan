...
public class ScreenAdapter extends BaseAbstractAdapter {
    ...
    public static class HomeListHolder extends BaseViewHolder<VideoBean> {
        ...
        public void a(VideoBean videoBean) {
            ...
            boolean z = true;
            if (videoBean2.getExclusive() != 1) {
                z = false;
            }
            ImageView imageView = this.ivExclusive;
            if (z) {
                i2 = 0;
            }
            ...
            this.itemView.setOnClickListener(new a(this, videoBean2));
        }
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/xj/bean/VideoBean;>; */
    @NonNull
