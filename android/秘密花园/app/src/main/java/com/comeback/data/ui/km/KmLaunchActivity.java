...
public class KmLaunchActivity extends BaseActivity {
    ...
    public static String[] f1277g = {e.a("BlJXSllACh1CUgJJSV5S"), e.a("BlJXSllACh1CUgJJSVlS"), e.a("BlJXSllACh1CUgBJQFM=")};
    public b0 b;
    ...
    public ArrayList<f> f1279d = new ArrayList<>();

    /* renamed from: f  reason: collision with root package name */
    public g f1281f = new a();
    ...
    public class a implements g {
        ...
        public void c(f fVar, h0 h0Var) {
            if (h0Var.f6449e <= 300) {
                Iterator<f> it = KmLaunchActivity.this.f1279d.iterator();
                while (it.hasNext()) {
                    it.next().cancel();
                }
                KmLaunchActivity kmLaunchActivity = KmLaunchActivity.this;
                if (!kmLaunchActivity.f1280e) {
                    kmLaunchActivity.f1280e = true;
                    b.f3973f = fVar.S().b.f6779j.replace(e.a("GAMTDUQRVlwHSVYIFx42Gw=="), "");
            ...
            } else if (KmLaunchActivity.this.f1279d.size() == 1) {
        ...
        public void d(f fVar, IOException iOException) {
            if (KmLaunchActivity.this.f1279d.size() == 1) {
                KmLaunchActivity.this.m();
            }
        }
    }
    ...
    public static void l(KmLaunchActivity kmLaunchActivity) {
        if (kmLaunchActivity != null) {
            int length = f1277g.length;
            String[] strArr = new String[length];
            for (int i2 = 0; i2 < length; i2++) {
                String str = f1277g[i2];
                strArr[i2] = e.a("XxYXFFFcFg==") + str + e.a("DVpTXVI=");
            }
            kmLaunchActivity.f1279d.clear();
            for (int i3 = 0; i3 < length; i3++) {
                ...
                kmLaunchActivity.f1279d.add(a2);
                ((d0) a2).W(kmLaunchActivity.f1281f);
            }
            return;
        }
        throw null;
    ...
    public void onDestroy() {
        ...
        ArrayList<f> arrayList = this.f1279d;
        if (arrayList != null) {
