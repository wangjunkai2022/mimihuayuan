...
public class SearchActivity extends BaseActivity {
    ...
    public void e() {
        ...
        this.etSearch.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: f.e.a.j.g0.b
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                return SearchActivity.this.m(textView, i2, keyEvent);
            }
        });
        m.e<VideoListBean> a2 = f.e.a.j.g0.m.e.a().a(e.a("Ww0NAw=="), d.a);
        m.e<VideoListBean> a3 = f.e.a.j.g0.m.e.a().a(e.a("RAoMFh8="), d.a);
        a aVar = new a();
        b bVar = new b();
        k(a2, aVar);
        k(a3, bVar);
