...
public class LVideosBean extends g0 implements a1 {
    public String actor;
    public String cover;
    ...
    public String getTime() {
        if (realmGet$upload_date() != 0) {
            return h.O0(getUpload_date() * 1000);
        }
    ...
    public void setUpload_date(long j2) {
        realmSet$upload_date(j2);
    }
