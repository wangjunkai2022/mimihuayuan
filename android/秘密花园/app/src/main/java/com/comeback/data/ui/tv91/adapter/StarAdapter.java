...
public class StarAdapter extends BaseAbstractAdapter<StarBean.MessageBean.DataBean> {

    /* loaded from: classes.dex */
    public static class HomeListHolder extends BaseViewHolder<StarBean.MessageBean.DataBean> {
        public StarAdapter a;
        public StarBean.MessageBean.DataBean b;
        @BindView
        ...
        public void a(StarBean.MessageBean.DataBean dataBean) {
            StarBean.MessageBean.DataBean dataBean2 = dataBean;
            this.b = dataBean2;
            h.A0(dataBean2.getPic(), this.ivCover);
    ...
    public class HomeListHolder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ HomeListHolder f2112c;

            public a(HomeListHolder_ViewBinding homeListHolder_ViewBinding, HomeListHolder homeListHolder) {
                this.f2112c = homeListHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                HomeListHolder homeListHolder = this.f2112c;
                VideoBrowseActivity.t(homeListHolder.a.a, homeListHolder.b.getName(), homeListHolder.b.getID());
            }
        }
    ...
    /* JADX WARN: Incorrect args count in method signature: (Landroid/view/ViewGroup;I)Lcom/comeback/data/base/BaseViewHolder<Lcom/comeback/data/ui/tv91/bean/StarBean$MessageBean$DataBean;>; */
    @NonNull
    public BaseViewHolder f(@NonNull ViewGroup viewGroup) {
        return new HomeListHolder(this.f107c.inflate(R.layout.item_tv91_star, viewGroup, false), this);
    }
