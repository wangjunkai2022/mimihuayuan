...
public class HGMovieDetailActivity extends BasePlayByIdActivity {
    ...
    public static void n(Context context, f.e.a.j.n.c.a aVar) {
    ...
    public void c(Intent intent) {
        this.f1008d = (f.e.a.j.n.c.a) intent.getSerializableExtra(e.a("RwMRBQY="));
    }
    ...
    public void e() {
        ...
        this.f1009e = new b0();
        e0.a aVar = new e0.a();
        aVar.i(this.f1008d.a);
        Map<String, String> map = this.f1008d.b;
        for (String str : map.keySet()) {
            aVar.c(str, map.get(str));
        }
        ((d0) this.f1009e.a(aVar.b())).W(new f.e.a.j.n.b(this));
        if (!TextUtils.isEmpty(this.f1008d.f3932c)) {
            f.e.a.j.n.d.a.b = new a();
        }
    }
