...
public class SpecialDetailActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1176d = intent.getStringExtra(e.a("XgY="));
        this.f1177e = intent.getStringExtra(e.a("QhAP"));
    }
    ...
    public void p(int i2) {
        b a2 = f.e.a.j.t.e.e.a();
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(f.b.a.a.a.i("BlQ=", hashMap, f.b.a.a.a.G(i2, hashMap, e.a("RwMEAQ=="), "WwsODR8="), "RBIGBwISVWwaAg=="), this.f1176d);
        k(a2.c(hashMap), new a(i2));
    }
}
