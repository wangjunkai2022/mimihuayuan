...
public class TestExoActivity extends AppCompatActivity {
    ...
    public static String[] f2077e = {e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sNj5gIiokIidoMTcrOTJ+dg=="), e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")};

    /* renamed from: f  reason: collision with root package name */
    public static String f2078f = e.a("YwcQEA==");
    public ExoUserPlayer a;
    public Runnable b = new a();

    /* renamed from: c  reason: collision with root package name */
    public SeekBar f2079c;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (exoUserPlayer != null && testExoActivity.f2079c != null && exoUserPlayer.isPlaying()) {
                long currentPosition = TestExoActivity.this.a.getCurrentPosition();
                TestExoActivity testExoActivity2 = TestExoActivity.this;
                testExoActivity2.f2079c.setProgress((int) ((currentPosition * 1000) / testExoActivity2.a.getDuration()));
                if (TestExoActivity.this.a.isPlaying()) {
                    TestExoActivity testExoActivity3 = TestExoActivity.this;
                    testExoActivity3.f2079c.postDelayed(testExoActivity3.b, 300);
                }
            }
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (TestExoActivity.this.a.isPlaying()) {
                TestExoActivity.this.f2080d.setImageDrawable(null);
            } else {
                TestExoActivity.this.f2080d.setImageResource(R.mipmap.player_icon_start_play);
            }
        }
    }
    ...
    public class c implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            TestExoActivity.this.a.seekTo((TestExoActivity.this.a.getDuration() / 1000) * ((long) seekBar.getProgress()));
        }
    }
    ...
    public class d implements VideoInfoListener {
        ...
        public void onPlayStart(long j2) {
            TestExoActivity testExoActivity = TestExoActivity.this;
            testExoActivity.f2079c.postDelayed(testExoActivity.b, 300);
            TestExoActivity.this.f2080d.setClickable(true);
        }

        @Override // chuangyuan.ycj.videolibrary.listener.VideoInfoListener
        public void onPlayerError(@Nullable w wVar) {
            TestExoActivity.this.f2080d.setClickable(false);
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        try {
            if (ContextCompat.checkSelfPermission(this, e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")) != 0) {
                ActivityCompat.requestPermissions(this, f2077e, 1);
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
