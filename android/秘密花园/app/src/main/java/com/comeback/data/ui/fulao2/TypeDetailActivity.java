...
public class TypeDetailActivity extends BaseViewPagerActivity {
    ...
    public void c(Intent intent) {
        ...
        this.f723c = intent.getIntExtra(e.a("VAMXAQwcS0osD1A="), 0);
    }
    ...
    public ArrayList<BaseFragment> l() {
        ...
        arrayList.add(TypeListFragment.o(e.a("QgwACx0WSw=="), this.f723c));
        arrayList.add(TypeListFragment.o(e.a("VA0VARk="), this.f723c));
        return arrayList;
    }
