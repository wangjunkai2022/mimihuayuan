...
public class UMFrUtils {
                ...
                Arrays.sort(listFiles, new Comparator<File>() { // from class: com.umeng.commonsdk.framework.UMFrUtils.2
                    ...
                    public int compare(File file2, File file3) {
                        ...
                        if (!TextUtils.isEmpty(createTimeFromFileName) && !TextUtils.isEmpty(createTimeFromFileName2)) {
                            try {
                                int i2 = ((Long.valueOf(createTimeFromFileName).longValue() - Long.valueOf(createTimeFromFileName2).longValue()) > 0 ? 1 : ((Long.valueOf(createTimeFromFileName).longValue() - Long.valueOf(createTimeFromFileName2).longValue()) == 0 ? 0 : -1));
                                if (i2 > 0) {
                                    return 1;
                                }
                                return i2 == 0 ? 0 : -1;
    ...
    public static long getLastInstantBuildTime(Context context) {
        ...
        synchronized (mEnvelopeBuildTimeLock) {
            j2 = PreferenceWrapper.getDefault(context).getLong(KEY_LAST_INSTANT_SUCC_BUILD_TIME, 0);
        }
        return j2;
    }
    ...
    public static long getLastSuccessfulBuildTime(Context context) {
        long j2;
        synchronized (mEnvelopeBuildTimeLock) {
            j2 = PreferenceWrapper.getDefault(context).getLong(KEY_LAST_SUCC_BUILD_TIME, 0);
        }
        return j2;
    }
            ...
            if (listFiles != null && listFiles.length > i2) {
                Arrays.sort(listFiles, new Comparator<File>() { // from class: com.umeng.commonsdk.framework.UMFrUtils.1
                    ...
                    public int compare(File file2, File file3) {
                        ...
                        if (!TextUtils.isEmpty(createTimeFromFileName) && !TextUtils.isEmpty(createTimeFromFileName2)) {
                            try {
                                int i3 = ((Long.valueOf(createTimeFromFileName).longValue() - Long.valueOf(createTimeFromFileName2).longValue()) > 0 ? 1 : ((Long.valueOf(createTimeFromFileName).longValue() - Long.valueOf(createTimeFromFileName2).longValue()) == 0 ? 0 : -1));
                                if (i3 > 0) {
                                    return 1;
                                }
                                return i3 == 0 ? 0 : -1;
