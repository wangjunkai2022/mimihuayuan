...
public class d {
    ...
    public static void c(Context context) {
        if (context != null) {
            try {
                ...
                f.a(context, context.getFilesDir() + "/" + com.umeng.commonsdk.stateless.a.f3118e + "/" + Base64.encodeToString(a.a.getBytes(), 0), 10);
    ...
    public static JSONObject d(Context context) {
        ...
        if (context != null) {
            try {
                ...
                try {
                    String k2 = a.k(applicationContext);
                ...
                try {
                    String l2 = a.l(applicationContext);
    ...
    public static JSONObject e(Context context) {
        ...
        if (context != null) {
            ...
            try {
                JSONObject o = a.o(applicationContext);
        ...
        if (!(context == null || (b = a.b((applicationContext = context.getApplicationContext()))) == null || b.size() <= 0)) {
            for (ScanResult scanResult : b) {
                try {
                    ...
                    jSONObject.put(com.umeng.commonsdk.internal.utils.f.f2963i, scanResult.frequency);
                    jSONObject.put("ts", System.currentTimeMillis());
                    ...
                    jSONObject.put(com.umeng.commonsdk.internal.utils.f.f2960f, scanResult.describeContents());
    ...
    public static JSONArray k(Context context) {
        ...
        JSONArray jSONArray = new JSONArray();
        if (!(context == null || (m2 = a.m((applicationContext = context.getApplicationContext()))) == null)) {
    ...
    public static JSONArray m(Context context) {
        ...
        List<a.C0015a> p;
        JSONArray jSONArray = new JSONArray();
        if (!(context == null || (p = a.p((applicationContext = context.getApplicationContext()))) == null || p.isEmpty())) {
            for (a.C0015a aVar : p) {
                if (aVar != null) {
                    try {
                        JSONObject jSONObject = new JSONObject();
    ...
    public static JSONObject n(Context context) {
        ...
        JSONObject jSONObject = new JSONObject();
        if (!(context == null || (q = a.q((applicationContext = context.getApplicationContext()))) == null)) {
            try {
            ...
            for (int i2 = 0; i2 < runningServices.size(); i2++) {
                if (!(runningServices.get(i2) == null || runningServices.get(i2).service == null || runningServices.get(i2).service.getClassName() == null || runningServices.get(i2).service.getPackageName() == null)) {
                    try {
                        ...
                        jSONObject.put(b.ad, runningServices.get(i2).service.getPackageName().toString());
                        if (jSONArray == null) {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:43:0x002f */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:49:0x0048 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:27:0x006a */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:45:0x005b */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:47:0x0085 */
    public static JSONArray s(Context context) {
        ...
        if (context != null) {
            ...
            if (!TextUtils.isEmpty(f2)) {
                ...
                jSONObject5.put(e.W, new JSONObject(f2));
                jSONObject6 = jSONObject5;
            }
            if (jSONObject6 != null) {
        ...
        if (context != null) {
            ...
            if (!TextUtils.isEmpty(a)) {
                try {
                    ...
                    if (jSONObject2.has(l.f2986d)) {
                        jSONObject.put(l.f2986d, jSONObject2.opt(l.f2986d));
                    }
                    if (jSONObject2.has(l.f2985c)) {
                        jSONObject.put(l.f2985c, jSONObject2.opt(l.f2985c));
                    }
    ...
    public static JSONObject d() {
        try {
            ...
            try {
                ...
                jSONObject.put("cpus", a.f2946c);
                jSONObject.put("fea", a.f2947d);
                jSONObject.put("imp", a.f2948e);
                jSONObject.put("arc", a.f2949f);
                jSONObject.put("var", a.f2950g);
                jSONObject.put("par", a.f2951h);
                jSONObject.put("rev", a.f2952i);
                jSONObject.put("har", a.f2953j);
                jSONObject.put("rev", a.f2954k);
                jSONObject.put("ser", a.f2955l);
