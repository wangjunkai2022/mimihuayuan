...
public class d implements j<d, e>, Serializable, Cloneable {
    ...
    /* loaded from: classes.dex */
    public static class C0022d implements ar {
        public C0022d() {
        }
    ...
    static {
        ...
        f3280j.put(at.class, new C0022d());
        EnumMap enumMap = new EnumMap(e.class);
        enumMap.put((EnumMap) e.PROPERTY, (e) new v("property", (byte) 1, new y(ap.f3039k, new w((byte) 11), new aa((byte) 12, e.class))));
    ...
    public void l() throws p {
        if (this.a == null) {
            StringBuilder o = f.b.a.a.a.o("Required field 'property' was not present! Struct: ");
            o.append(toString());
            throw new aj(o.toString());
