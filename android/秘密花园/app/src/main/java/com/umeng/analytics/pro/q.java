...
public class q implements u.a {
    ...
    public void c(Context context, Object obj) {
        try {
            ...
            if (sharedPreferences != null) {
                if (sharedPreferences.getLong(f2859e, 0) == 0) {
        ...
        try {
            ...
            if (sharedPreferences != null && (edit = sharedPreferences.edit()) != null) {
                ...
                if (TextUtils.isEmpty(string)) {
                    ...
                    if (longValue - sharedPreferences.getLong(f2860f, 0) < u.a().b()) {
                        edit.putLong(f2860f, 0);
                    }
                    edit.commit();
                    if (f2863i) {
                        f2863i = false;
    ...
    public boolean b(Context context, long j2) {
        ...
        long j3 = sharedPreferences.getLong(f2859e, 0);
        long j4 = sharedPreferences.getLong(f2860f, 0);
        if (j3 > 0 && j4 == 0) {
            z = true;
