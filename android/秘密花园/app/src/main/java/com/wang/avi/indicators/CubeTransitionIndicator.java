...
public class CubeTransitionIndicator extends Indicator {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        for (final int i2 = 0; i2 < 2; i2++) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(width, ((float) getWidth()) - width, ((float) getWidth()) - width, width, width);
            if (i2 == 1) {
                ofFloat = ValueAnimator.ofFloat(((float) getWidth()) - width, width, width, ((float) getWidth()) - width, ((float) getWidth()) - width);
            }
            ...
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(height, height, ((float) getHeight()) - height, ((float) getHeight()) - height, height);
            if (i2 == 1) {
                ofFloat2 = ValueAnimator.ofFloat(((float) getHeight()) - height, ((float) getHeight()) - height, height, height, ((float) getHeight()) - height);
            }
