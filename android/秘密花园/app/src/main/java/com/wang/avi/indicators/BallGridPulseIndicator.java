...
public class BallGridPulseIndicator extends Indicator {
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        float f2 = 2.0f * width;
        float f3 = f2 + 4.0f;
        float width2 = ((float) (getWidth() / 2)) - f3;
        float width3 = ((float) (getWidth() / 2)) - f3;
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        for (final int i2 = 0; i2 < 9; i2++) {
            ...
            ofFloat.setDuration((long) iArr[i2]);
            ofFloat.setRepeatCount(-1);
            ofFloat.setStartDelay((long) iArr2[i2]);
            ...
            ofInt.setDuration((long) iArr[i2]);
            ofInt.setRepeatCount(-1);
            ofInt.setStartDelay((long) iArr2[i2]);
