...
public class BallZigZagDeflectIndicator extends BallZigZagIndicator {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        for (final int i2 = 0; i2 < 2; i2++) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(width, ((float) getWidth()) - width, width, ((float) getWidth()) - width, width);
            if (i2 == 1) {
                ofFloat = ValueAnimator.ofFloat(((float) getWidth()) - width, width, ((float) getWidth()) - width, width, ((float) getWidth()) - width);
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(width2, width2, ((float) getHeight()) - width2, ((float) getHeight()) - width2, width2);
            if (i2 == 1) {
                ofFloat2 = ValueAnimator.ofFloat(((float) getHeight()) - width2, ((float) getHeight()) - width2, width2, width2, ((float) getHeight()) - width2);
            }
