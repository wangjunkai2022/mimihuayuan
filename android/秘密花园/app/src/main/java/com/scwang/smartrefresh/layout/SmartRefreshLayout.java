...
public class SmartRefreshLayout extends ViewGroup implements f.j.a.a.f.i, NestedScrollingParent {
    ...
    public int f2369e = 300;

    /* renamed from: m  reason: collision with root package name */
    public char f2377m = 'n';
    public boolean S = false;
    public boolean T = false;
    public int[] f0 = new int[2];
    public NestedScrollingChildHelper g0 = new NestedScrollingChildHelper(this);
    public NestedScrollingParentHelper h0 = new NestedScrollingParentHelper(this);
    public f.j.a.a.f.h x0 = new k();
    public long A0 = 0;
    public int B0 = 0;
    public int C0 = 0;
    public boolean G0 = false;
    public boolean H0 = false;
    public MotionEvent I0 = null;
    public Handler w0 = new Handler();
    public VelocityTracker x = VelocityTracker.obtain();
    public Interpolator y = new f.j.a.a.m.b(0);
    ...
    public class b extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (gVar != null) {
                ...
                gVar.b(smartRefreshLayout2, i2, (int) (smartRefreshLayout2.o0 * ((float) i2)));
            }
            ...
            if (cVar != null && (smartRefreshLayout3.s0 instanceof f.j.a.a.f.f)) {
                ...
                smartRefreshLayout4.c0.l((f.j.a.a.f.f) smartRefreshLayout4.s0, i3, (int) (smartRefreshLayout4.o0 * ((float) i3)));
            }
        }
    }
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (smartRefreshLayout.b != 0 || (bVar = smartRefreshLayout.y0) == (bVar2 = f.j.a.a.g.b.None) || bVar.f6129e || bVar.f6128d) {
                SmartRefreshLayout smartRefreshLayout2 = SmartRefreshLayout.this;
            ...
            if (this.a == 0) {
                ...
                if (smartRefreshLayout.y0 == f.j.a.a.g.b.None && smartRefreshLayout.z0 == f.j.a.a.g.b.Refreshing) {
                    ...
                    if (smartRefreshLayout2.K0 != null) {
                        ...
                        if (bVar.a && (bVar.f6128d || bVar == f.j.a.a.g.b.RefreshReleased)) {
                            SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
                    ...
                    if (!(smartRefreshLayout4.y0 != f.j.a.a.g.b.Refreshing || smartRefreshLayout4.s0 == null || smartRefreshLayout4.u0 == null)) {
                        this.a++;
                        smartRefreshLayout4.w0.postDelayed(this, (long) this.b);
                        SmartRefreshLayout.this.r(f.j.a.a.g.b.RefreshFinish);
                        if (this.f2378c == Boolean.FALSE) {
                            SmartRefreshLayout.this.u(false);
                        }
                    }
                }
                if (this.f2378c == Boolean.TRUE) {
            ...
            if (i2 < Integer.MAX_VALUE) {
                ...
                if (smartRefreshLayout7.n || smartRefreshLayout7.e0) {
                    ...
                    if (smartRefreshLayout8.n) {
                        float f2 = smartRefreshLayout8.f2375k;
                        smartRefreshLayout8.f2373i = f2;
                        smartRefreshLayout8.f2368d = 0;
                        smartRefreshLayout8.n = false;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, smartRefreshLayout8.f2374j, (f2 + ((float) smartRefreshLayout8.b)) - ((float) (smartRefreshLayout8.a * 2)), 0));
                        SmartRefreshLayout smartRefreshLayout9 = SmartRefreshLayout.this;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 2, smartRefreshLayout9.f2374j, smartRefreshLayout9.f2375k + ((float) smartRefreshLayout9.b), 0));
                    }
                    SmartRefreshLayout smartRefreshLayout10 = SmartRefreshLayout.this;
                    if (smartRefreshLayout10.e0) {
                        smartRefreshLayout10.d0 = 0;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 1, smartRefreshLayout10.f2374j, smartRefreshLayout10.f2375k, 0));
                        SmartRefreshLayout smartRefreshLayout11 = SmartRefreshLayout.this;
                        smartRefreshLayout11.e0 = false;
                        smartRefreshLayout11.f2368d = 0;
                    }
                }
                SmartRefreshLayout smartRefreshLayout12 = SmartRefreshLayout.this;
                int i3 = smartRefreshLayout12.b;
                if (i3 > 0) {
                    ValueAnimator g2 = smartRefreshLayout12.g(0, i2, smartRefreshLayout12.y, smartRefreshLayout12.f2370f);
                    ...
                    smartRefreshLayout12.g(0, i2, smartRefreshLayout12.y, smartRefreshLayout12.f2370f);
                } else {
    ...
    public class g implements Runnable {
            ...
            public void run() {
                ...
                if (i2 > 0) {
                    ...
                    if (animatorUpdateListener != null || i2 == 0) {
                        ...
                        ((k) SmartRefreshLayout.this.x0).d(f.j.a.a.g.b.None);
                    } else if (!gVar.f2381c || !smartRefreshLayout2.G) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:43:0x00ad, code lost:
            if (((f.j.a.a.j.a) r2.u0).a() != false) goto L_0x00b1;
         */
        @Override // java.lang.Runnable
    ...
    public class h implements Runnable {
        ...
        /* renamed from: e  reason: collision with root package name */
        public float f2386e = 0.0f;

        /* renamed from: d  reason: collision with root package name */
        public long f2385d = AnimationUtils.currentAnimationTimeMillis();

        public h(float f2, int i2) {
            this.f2387f = f2;
            this.f2384c = i2;
            SmartRefreshLayout.this.w0.postDelayed(this, (long) this.b);
            if (f2 > 0.0f) {
        ...
        public void run() {
            SmartRefreshLayout smartRefreshLayout = SmartRefreshLayout.this;
            if (smartRefreshLayout.J0 == this && !smartRefreshLayout.y0.f6130f) {
                if (Math.abs(smartRefreshLayout.b) < Math.abs(this.f2384c)) {
                    int i2 = this.a + 1;
                    this.a = i2;
                    this.f2387f = (float) (Math.pow(0.949999988079071d, (double) (i2 * 2)) * ((double) this.f2387f));
                } else if (this.f2384c != 0) {
                    int i3 = this.a + 1;
                    this.a = i3;
                    this.f2387f = (float) (Math.pow(0.44999998807907104d, (double) (i3 * 2)) * ((double) this.f2387f));
                } else {
                    int i4 = this.a + 1;
                    this.a = i4;
                    this.f2387f = (float) (Math.pow(0.8500000238418579d, (double) (i4 * 2)) * ((double) this.f2387f));
                }
                long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
                float f2 = this.f2387f * ((((float) (currentAnimationTimeMillis - this.f2385d)) * 1.0f) / 1000.0f);
                if (Math.abs(f2) >= 1.0f) {
                    this.f2385d = currentAnimationTimeMillis;
                    float f3 = this.f2386e + f2;
                    this.f2386e = f3;
                ...
                if (!bVar.f6128d || !bVar.a) {
                    SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
                    f.j.a.a.g.b bVar2 = smartRefreshLayout3.z0;
                    if (bVar2.f6128d && bVar2.b) {
                ...
                if (Math.abs(smartRefreshLayout4.b) >= Math.abs(this.f2384c)) {
                    SmartRefreshLayout smartRefreshLayout5 = SmartRefreshLayout.this;
                    smartRefreshLayout5.g(this.f2384c, 0, smartRefreshLayout5.y, Math.min(Math.max((int) (((float) Math.abs(SmartRefreshLayout.this.b - this.f2384c)) / f.j.a.a.m.b.f6184d), 30), 100) * 10);
                }
            }
        }
    }
    ...
    public class i implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public float f2390d = 0.98f;

        /* renamed from: e  reason: collision with root package name */
        public long f2391e = 0;

        /* renamed from: f  reason: collision with root package name */
        public long f2392f = AnimationUtils.currentAnimationTimeMillis();
        ...
        public void run() {
            ...
            if (smartRefreshLayout.J0 == this && !smartRefreshLayout.y0.f6130f) {
                long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
                float pow = (float) (Math.pow((double) this.f2390d, (double) (((float) (currentAnimationTimeMillis - this.f2391e)) / (1000.0f / ((float) this.b)))) * ((double) this.f2389c));
                this.f2389c = pow;
                float f2 = ((((float) (currentAnimationTimeMillis - this.f2392f)) * 1.0f) / 1000.0f) * pow;
                if (Math.abs(f2) > 1.0f) {
                    this.f2392f = currentAnimationTimeMillis;
                    int i2 = (int) (((float) this.a) + f2);
                    this.a = i2;
                    SmartRefreshLayout smartRefreshLayout2 = SmartRefreshLayout.this;
                    ...
                    f.j.a.a.m.b.e(((f.j.a.a.j.a) SmartRefreshLayout.this.u0).f6158c, (int) (-this.f2389c));
                    SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
    ...
    public class k implements f.j.a.a.f.h {
        ...
        public ValueAnimator a(int i2) {
            SmartRefreshLayout smartRefreshLayout = SmartRefreshLayout.this;
            return smartRefreshLayout.g(i2, 0, smartRefreshLayout.y, smartRefreshLayout.f2370f);
        }
        ...
        public f.j.a.a.f.h d(@NonNull f.j.a.a.g.b bVar) {
            switch (bVar.ordinal()) {
                ...
                case 1:
                    SmartRefreshLayout smartRefreshLayout2 = SmartRefreshLayout.this;
                    if (smartRefreshLayout2.y0.f6129e || !smartRefreshLayout2.o(smartRefreshLayout2.A)) {
                ...
                case 2:
                    ...
                    if (smartRefreshLayout3.o(smartRefreshLayout3.B)) {
                        ...
                        if (!bVar4.f6129e && !bVar4.f6130f && (!smartRefreshLayout4.S || !smartRefreshLayout4.G || !smartRefreshLayout4.T)) {
                ...
                case 3:
                    SmartRefreshLayout smartRefreshLayout5 = SmartRefreshLayout.this;
                    if (smartRefreshLayout5.y0.f6129e || !smartRefreshLayout5.o(smartRefreshLayout5.A)) {
                ...
                case 4:
                    ...
                    if (smartRefreshLayout6.o(smartRefreshLayout6.B)) {
                        SmartRefreshLayout smartRefreshLayout7 = SmartRefreshLayout.this;
                        if (!smartRefreshLayout7.y0.f6129e && (!smartRefreshLayout7.S || !smartRefreshLayout7.G || !smartRefreshLayout7.T)) {
                ...
                case 5:
                    SmartRefreshLayout smartRefreshLayout8 = SmartRefreshLayout.this;
                    if (smartRefreshLayout8.y0.f6129e || !smartRefreshLayout8.o(smartRefreshLayout8.A)) {
                ...
                case 6:
                    ...
                    if (smartRefreshLayout9.o(smartRefreshLayout9.B)) {
                        ...
                        if (!bVar5.f6129e && !bVar5.f6130f && (!smartRefreshLayout10.S || !smartRefreshLayout10.G || !smartRefreshLayout10.T)) {
                ...
                case 7:
                    SmartRefreshLayout smartRefreshLayout11 = SmartRefreshLayout.this;
                    if (smartRefreshLayout11.y0.f6129e || !smartRefreshLayout11.o(smartRefreshLayout11.A)) {
                ...
                case 9:
                    SmartRefreshLayout smartRefreshLayout12 = SmartRefreshLayout.this;
                    if (smartRefreshLayout12.y0.f6129e || !smartRefreshLayout12.o(smartRefreshLayout12.A)) {
                ...
                case 10:
                    SmartRefreshLayout smartRefreshLayout13 = SmartRefreshLayout.this;
                    if (smartRefreshLayout13.y0.f6129e || !smartRefreshLayout13.o(smartRefreshLayout13.B)) {
    ...
    public SmartRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.V = false;
        this.W = false;
        f.j.a.a.g.a aVar = f.j.a.a.g.a.f6110c;
        this.j0 = aVar;
        this.l0 = aVar;
        this.o0 = 2.5f;
        this.p0 = 2.5f;
        ...
        this.f2371g = context.getResources().getDisplayMetrics().heightPixels;
        ...
        this.f2376l = obtainStyledAttributes.getFloat(f.j.a.a.d.SmartRefreshLayout_srlDragRate, this.f2376l);
        ...
        this.f2370f = obtainStyledAttributes.getInt(f.j.a.a.d.SmartRefreshLayout_srlReboundDuration, this.f2370f);
        ...
        this.j0 = obtainStyledAttributes.hasValue(f.j.a.a.d.SmartRefreshLayout_srlHeaderHeight) ? f.j.a.a.g.a.f6116i : this.j0;
        this.l0 = obtainStyledAttributes.hasValue(f.j.a.a.d.SmartRefreshLayout_srlFooterHeight) ? f.j.a.a.g.a.f6116i : this.l0;
        ...
        if (gVar != null && gVar.getView() == view) {
            ...
            if (view2 != null) {
                ...
                if (!(i2 == 0 || (paint2 = this.v0) == null)) {
                    paint2.setColor(i2);
                    if (this.s0.getSpinnerStyle().f6138c) {
                        max = view.getBottom();
                    } else if (this.s0.getSpinnerStyle() == f.j.a.a.g.c.f6132d) {
                        max = view.getBottom() + this.b;
                    }
                    canvas.drawRect(0.0f, (float) view.getTop(), (float) getWidth(), (float) max, this.v0);
                }
                if (this.C && this.s0.getSpinnerStyle() == f.j.a.a.g.c.f6134f) {
                    canvas.save();
        ...
        if (gVar2 != null && gVar2.getView() == view) {
            ...
            if (view2 != null) {
                ...
                if (!(i3 == 0 || (paint = this.v0) == null)) {
                    paint.setColor(i3);
                    if (this.t0.getSpinnerStyle().f6138c) {
                        min = view.getTop();
                    } else if (this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6132d) {
                        min = view.getTop() + this.b;
                    }
                    canvas.drawRect(0.0f, (float) min, (float) getWidth(), (float) view.getBottom(), this.v0);
                }
                if (this.D && this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6134f) {
                    canvas.save();
    ...
    public boolean h() {
        ...
        int i3 = this.f2370f;
        int i4 = this.i0;
        float f2 = ((this.o0 / 2.0f) + 0.5f) * ((float) i4) * 1.0f;
        if (i4 == 0) {
            i4 = 1;
        }
        ...
        if (i2 > 0) {
            this.w0.postDelayed(eVar, (long) i2);
        } else {
            eVar.run();
        }
        return true;
    ...
    public f.j.a.a.f.i i(int i2, boolean z, boolean z2) {
        ...
        if (i4 > 0) {
            this.w0.postDelayed(gVar, (long) i4);
        } else {
            gVar.run();
        }
        return this;
    ...
    public f.j.a.a.f.i l(int i2, boolean z, Boolean bool) {
        ...
        if (i4 > 0) {
            this.w0.postDelayed(fVar, (long) i4);
        } else {
            fVar.run();
        }
        return this;
    ...
    public boolean n(int i2) {
        if (i2 == 0) {
            if (this.K0 != null) {
                ...
                if (bVar.f6130f || bVar == f.j.a.a.g.b.TwoLevelReleased) {
                    return true;
                }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:139:0x0111 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:69:0x0147 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:141:0x0111 */
    @Override // android.view.ViewGroup, android.view.View
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            if (aVar3 != null) {
                aVar3.f6164i.b = null;
                ((f.j.a.a.j.a) dVar).f6164i.f6165c = this.O;
                ...
                if (viewGroup2 != null) {
                    aVar4.f6158c = viewGroup2;
                }
                if (!(findViewById == null && findViewById2 == null)) {
                    aVar4.f6159d = findViewById;
                    aVar4.f6160e = findViewById2;
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (!(childAt.getVisibility() == 8 || childAt.getTag(f.j.a.a.c.srl_component_falsify) == childAt)) {
                ...
                if (gVar != null && gVar.getView() == childAt) {
                    ...
                    if (!z4 && this.s0.getSpinnerStyle() == f.j.a.a.g.c.f6132d) {
                        int i13 = this.i0;
                        i12 -= i13;
                        measuredHeight2 -= i13;
                    }
                ...
                if (gVar2 != null && gVar2.getView() == childAt) {
                    if (!isInEditMode() || !this.H || !o(this.B)) {
                        z2 = false;
                    }
                    ...
                    if (this.S && this.T && this.G && this.u0 != null && this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6132d && o(this.B)) {
                        View view4 = ((f.j.a.a.j.a) this.u0).a;
                        ViewGroup.LayoutParams layoutParams4 = view4.getLayoutParams();
                        measuredHeight3 = view4.getMeasuredHeight() + paddingTop + paddingTop + (layoutParams4 instanceof ViewGroup.MarginLayoutParams ? ((ViewGroup.MarginLayoutParams) layoutParams4).topMargin : 0);
                    }
                    if (spinnerStyle == f.j.a.a.g.c.f6136h) {
                        measuredHeight3 = marginLayoutParams3.topMargin - this.n0;
                    } else {
                        if (z2 || spinnerStyle == f.j.a.a.g.c.f6135g || spinnerStyle == f.j.a.a.g.c.f6134f) {
                            i6 = this.k0;
                        } else if (spinnerStyle.f6138c && this.b < 0) {
    ...
    public void onNestedScroll(@NonNull View view, int i2, int i3, int i4, int i5) {
        ...
        if ((i6 < 0 && (this.A || this.J)) || (i6 > 0 && (this.B || this.J))) {
            ...
            if (bVar == f.j.a.a.g.b.None || bVar.f6129e) {
    ...
    public boolean p(boolean z, f.j.a.a.f.g gVar) {
        return z || this.L || gVar == null || gVar.getSpinnerStyle() == f.j.a.a.g.c.f6134f;
    }

    public void q(float f2) {
        f.j.a.a.g.b bVar;
        float f3 = (!this.e0 || this.O || f2 >= 0.0f || ((f.j.a.a.j.a) this.u0).a()) ? f2 : 0.0f;
        if (f3 > ((float) (this.f2371g * 5)) && getTag() == null) {
        ...
        if (this.y0 == f.j.a.a.g.b.TwoLevel && f3 > 0.0f) {
            ...
            if (f3 < ((float) i2)) {
                ...
                double d2 = (double) ((this.o0 - 1.0f) * ((float) i2));
                int max = Math.max((this.f2371g * 4) / 3, getHeight());
                int i3 = this.i0;
                double d3 = (double) (max - i3);
                double max2 = (double) Math.max(0.0f, (f3 - ((float) i3)) * this.f2376l);
                double d4 = -max2;
                if (d3 == 0.0d) {
                    d3 = 1.0d;
                }
            ...
            if (f3 > ((float) (-i4))) {
                ...
                double d5 = (double) ((this.p0 - 1.0f) * ((float) i4));
                int max3 = Math.max((this.f2371g * 4) / 3, getHeight());
                int i5 = this.k0;
                double d6 = (double) (max3 - i5);
                double d7 = (double) (-Math.min(0.0f, (((float) i5) + f3) * this.f2376l));
                double d8 = -d7;
                if (d6 == 0.0d) {
                    d6 = 1.0d;
                }
            ...
            double d9 = (double) (this.o0 * ((float) this.i0));
            double max4 = (double) Math.max(this.f2371g / 2, getHeight());
            double max5 = (double) Math.max(0.0f, this.f2376l * f3);
            double d10 = -max5;
            if (max4 == 0.0d) {
                max4 = 1.0d;
            }
            ...
            double d11 = (double) (this.p0 * ((float) this.k0));
            double max6 = (double) Math.max(this.f2371g / 2, getHeight());
            double d12 = (double) (-Math.min(0.0f, this.f2376l * f3));
            double d13 = -d12;
            if (max6 == 0.0d) {
                max6 = 1.0d;
            }
        ...
        if (this.K && !this.S && o(this.B) && f3 < 0.0f && (bVar = this.y0) != f.j.a.a.g.b.Refreshing && bVar != f.j.a.a.g.b.Loading && bVar != f.j.a.a.g.b.LoadFinish) {
            ...
            this.w0.postDelayed(new e(), (long) this.f2370f);
        }
    }
    ...
    public void s() {
        ...
        if (bVar == f.j.a.a.g.b.TwoLevel) {
            if (this.v > -1000 && this.b > getMeasuredHeight() / 2) {
                ...
                if (a2 != null) {
                    a2.setDuration((long) this.f2369e);
                }
            } else if (this.n) {
                k kVar = (k) this.x0;
                SmartRefreshLayout smartRefreshLayout = SmartRefreshLayout.this;
                if (smartRefreshLayout.y0 == f.j.a.a.g.b.TwoLevel) {
                    ...
                    kVar.a(0).setDuration((long) SmartRefreshLayout.this.f2369e);
                }
            }
    ...
    public void setStateDirectLoading(boolean z) {
        if (this.y0 != f.j.a.a.g.b.Loading) {
            ...
            if (gVar != null) {
                int i2 = this.k0;
                gVar.b(this, i2, (int) (this.p0 * ((float) i2)));
            }
        }
    }
    ...
    public void setStateLoading(boolean z) {
        ...
        if (gVar != null) {
            int i2 = this.k0;
            gVar.k(this, i2, (int) (this.p0 * ((float) i2)));
        }
        if (a2 == null) {
            aVar.onAnimationEnd(null);
        }
    ...
    public void setStateRefreshing(boolean z) {
        ...
        if (gVar != null) {
            int i2 = this.i0;
            gVar.k(this, i2, (int) (this.o0 * ((float) i2)));
        }
        if (a2 == null) {
    ...
    public void setViceState(f.j.a.a.g.b bVar) {
        f.j.a.a.g.b bVar2 = this.y0;
        if (bVar2.f6128d && bVar2.a != bVar.a) {
            r(f.j.a.a.g.b.None);
        }
        if (this.z0 != bVar) {
            this.z0 = bVar;
        ...
        if (this.y0 == f.j.a.a.g.b.Refreshing && z) {
            ...
            if (gVar instanceof f.j.a.a.f.e) {
                if (((f.j.a.a.f.e) gVar).d(z)) {
                    this.T = true;
                    if (this.S && this.G && this.b > 0 && this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6132d && o(this.B) && p(this.A, this.s0)) {
                        this.t0.getView().setTranslationY((float) this.b);
                    }
                } else {
                    this.T = false;
    ...
    public static class j extends ViewGroup.MarginLayoutParams {
        ...
        public j(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(f.j.a.a.d.SmartRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                this.b = f.j.a.a.g.c.f6137i[obtainStyledAttributes.getInt(f.j.a.a.d.SmartRefreshLayout_Layout_layout_srlSpinnerStyle, f.j.a.a.g.c.f6132d.a)];
            }
            obtainStyledAttributes.recycle();
        }
