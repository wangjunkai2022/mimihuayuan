...
public class DelegateAdapter extends VirtualLayoutAdapter<RecyclerView.ViewHolder> {
    ...
    public SparseArray<Adapter> f43e = new SparseArray<>();
    @NonNull

    /* renamed from: f  reason: collision with root package name */
    public final List<Pair<AdapterDataObserver, Adapter>> f44f = new ArrayList();

    /* renamed from: g  reason: collision with root package name */
    public int f45g = 0;

    /* renamed from: h  reason: collision with root package name */
    public final SparseArray<Pair<AdapterDataObserver, Adapter>> f46h = new SparseArray<>();

    /* renamed from: i  reason: collision with root package name */
    public long[] f47i = new long[2];

    /* loaded from: classes.dex */
    public static abstract class Adapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
        /* JADX WARN: Incorrect args count in method signature: (TVH;II)V */
        public void a() {
        }

        /* JADX WARN: Incorrect args count in method signature: (TVH;IILjava/util/List<Ljava/lang/Object;>;)V */
    ...
    public long getItemId(int i2) {
        ...
        long j2 = ((long) ((AdapterDataObserver) e2.first).b) + itemId;
        return (((1 + j2) * j2) / 2) + itemId;
    }

    /* JADX DEBUG: Multi-variable search result rejected for r1v5, resolved type: android.util.SparseArray<com.alibaba.android.vlayout.DelegateAdapter$Adapter> */
    ...
    public int getItemViewType(int i2) {
        ...
        long j2 = (long) ((AdapterDataObserver) e2.first).b;
        long j3 = ((long) itemViewType) + j2;
    ...
    public void h(@Nullable List<Adapter> list) {
        ...
        for (Adapter adapter : list) {
            ...
            AdapterDataObserver adapterDataObserver = new AdapterDataObserver(i3, i2);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
        ...
        int floor = (int) (Math.floor(Math.sqrt((double) ((8 * j2) + 1)) - 1.0d) / 2.0d);
        int i3 = (int) (j2 - ((long) (((floor * floor) + floor) / 2)));
        jArr[0] = (long) (floor - i3);
        jArr[1] = (long) i3;
