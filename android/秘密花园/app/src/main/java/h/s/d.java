...
public class d {
    ...
    public static final int g(CharSequence charSequence, CharSequence charSequence2, int i2, int i3, boolean z, boolean z2) {
        ...
        if (!(charSequence instanceof String) || !(charSequence2 instanceof String)) {
            ...
            while (!p(charSequence2, 0, charSequence, i4, charSequence2.length(), z)) {
                if (i4 == i5) {
                    return -1;
                }
                i4 += i6;
        ...
        while (!o((String) charSequence2, 0, (String) charSequence, i7, charSequence2.length(), z)) {
            if (i7 == i8) {
                return -1;
            }
            i7 += i9;
    ...
    public static List r(CharSequence charSequence, char[] cArr, boolean z, int i2, int i3) {
        ...
        if (charSequence != null) {
            ...
            while (it.hasNext()) {
                arrayList2.add(x(charSequence, (c) it.next()));
            }
            return arrayList2;
        }
        g.f("$this$split");
