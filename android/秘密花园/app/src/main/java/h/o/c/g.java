...
public class g {
    ...
    public static void b(Object obj, String str) {
        if (obj == null) {
            IllegalStateException illegalStateException = new IllegalStateException(a.f(str, " must not be null"));
    ...
    public static void g(String str) {
        h hVar = new h(a.g("lateinit property ", str, " has not been initialized"));
        c(hVar);
        throw hVar;
    }
}
