...
public class OsCollectionChangeSet implements s, i {
    ...
    public static long f6916e = nativeGetFinalizerPtr();
    public final long a;
    public final boolean b;

    /* renamed from: c  reason: collision with root package name */
    public final OsSubscription f6917c;
    ...
    public boolean g() {
        ...
        OsSubscription osSubscription = this.f6917c;
        if (osSubscription != null && osSubscription.a() == OsSubscription.d.COMPLETE) {
            return true;
        }
        return false;
    }
