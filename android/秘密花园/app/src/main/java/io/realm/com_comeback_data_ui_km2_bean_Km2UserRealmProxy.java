...
public class com_comeback_data_ui_km2_bean_Km2UserRealmProxy extends Km2User implements n, v0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6846f = a("mu_name", "mu_name", a);
            this.f6847g = a("mu_id", "mu_id", a);
            this.f6845e = a.a();
        }
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6846f = aVar.f6846f;
            aVar2.f6847g = aVar.f6847g;
            aVar2.f6845e = aVar.f6845e;
        }
    }
    ...
    public static Km2User copy(x xVar, a aVar, Km2User km2User, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6317j.e(Km2User.class);
        long j2 = aVar.f6845e;
    ...
    public static com.comeback.data.ui.km2.bean.Km2User copyOrUpdate(g.a.x r9, io.realm.com_comeback_data_ui_km2_bean_Km2UserRealmProxy.a r10, com.comeback.data.ui.km2.bean.Km2User r11, boolean r12, java.util.Map<g.a.e0, g.a.f1.n> r13, java.util.Set<g.a.m> r14) {
        ...
        L_0x006b:
            ...
            io.realm.com_comeback_data_ui_km2_bean_Km2UserRealmProxy r1 = new io.realm.com_comeback_data_ui_km2_bean_Km2UserRealmProxy     // Catch: all -> 0x0089
    ...
    public static com.comeback.data.ui.km2.bean.Km2User createOrUpdateUsingJsonObject(g.a.x r9, org.json.JSONObject r10, boolean r11) throws org.json.JSONException {
        ...
        L_0x0033:
            ...
            io.realm.com_comeback_data_ui_km2_bean_Km2UserRealmProxy r11 = new io.realm.com_comeback_data_ui_km2_bean_Km2UserRealmProxy     // Catch: all -> 0x0068
    ...
    public static long insert(x xVar, Km2User km2User, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6286f.a(Km2User.class);
        long j4 = aVar.f6847g;
        String realmGet$mu_id = km2User.realmGet$mu_id();
        if (realmGet$mu_id == null) {
            j2 = Table.nativeFindFirstNull(j3, j4);
        } else {
            j2 = Table.nativeFindFirstString(j3, j4, realmGet$mu_id);
        }
        if (j2 == -1) {
            long createRowWithPrimaryKey = OsObject.createRowWithPrimaryKey(e2, j4, realmGet$mu_id);
            map.put(km2User, Long.valueOf(createRowWithPrimaryKey));
            String realmGet$mu_name = km2User.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j3, aVar.f6846f, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
    ...
    public static long insertOrUpdate(x xVar, Km2User km2User, Map<e0, Long> map) {
        ...
        if (j2 == -1) {
            j2 = OsObject.createRowWithPrimaryKey(e2, j4, realmGet$mu_id);
        }
        map.put(km2User, Long.valueOf(j2));
        String realmGet$mu_name = km2User.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j3, aVar.f6846f, j2, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j3, aVar.f6846f, j2, false);
        }
        return j2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_km2_bean_km2userrealmproxy.proxyState.f6307e.b.f6197c;
        if (str == null ? str2 != null : !str.equals(str2)) {
            return false;
        }
        String j2 = this.proxyState.f6305c.d().j();
        String j3 = com_comeback_data_ui_km2_bean_km2userrealmproxy.proxyState.f6305c.d().j();
        if (j2 == null ? j3 == null : j2.equals(j3)) {
            return this.proxyState.f6305c.l() == com_comeback_data_ui_km2_bean_km2userrealmproxy.proxyState.f6305c.l();
        }
        return false;
    }
    ...
    public String realmGet$mu_id() {
        ...
        return this.proxyState.f6305c.q(this.columnInfo.f6847g);
    }

    @Override // com.comeback.data.ui.km2.bean.Km2User, g.a.v0
    public String realmGet$mu_name() {
        this.proxyState.f6307e.f();
        return this.proxyState.f6305c.q(this.columnInfo.f6846f);
    }
    ...
    public void realmSet$mu_name(String str) {
        ...
        if (!vVar.b) {
            vVar.f6307e.f();
            if (str == null) {
                this.proxyState.f6305c.f(this.columnInfo.f6846f);
            } else {
                this.proxyState.f6305c.a(this.columnInfo.f6846f, str);
            }
        } else if (vVar.f6308f) {
            p pVar = vVar.f6305c;
            if (str == null) {
                pVar.d().q(this.columnInfo.f6846f, pVar.l(), true);
            } else {
                pVar.d().r(this.columnInfo.f6846f, pVar.l(), str, true);
            }
        }
    }
    ...
    public String toString() {
        ...
        String str = "null";
        f.b.a.a.a.C(q, realmGet$mu_name() != null ? realmGet$mu_name() : str, "}", ",", "{mu_id:");
        if (realmGet$mu_id() != null) {
            str = realmGet$mu_id();
        }
        q.append(str);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2User)) {
                if (km2User instanceof n) {
                    n nVar = (n) km2User;
                    if (nVar.realmGet$proxyState().f6307e != null && nVar.realmGet$proxyState().f6307e.b.f6197c.equals(xVar.b.f6197c)) {
                        map.put(km2User, Long.valueOf(nVar.realmGet$proxyState().f6305c.l()));
                    }
                }
                String realmGet$mu_id = km2User.realmGet$mu_id();
                if (realmGet$mu_id == null) {
    ...
    public static void insertOrUpdate(x xVar, Iterator<? extends e0> it, Map<e0, Long> map) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2User)) {
                ...
                long createRowWithPrimaryKey = j2 == -1 ? OsObject.createRowWithPrimaryKey(e2, j4, realmGet$mu_id) : j2;
                map.put(km2User, Long.valueOf(createRowWithPrimaryKey));
                String realmGet$mu_name = km2User.realmGet$mu_name();
                if (realmGet$mu_name != null) {
                    Table.nativeSetString(j3, aVar.f6846f, createRowWithPrimaryKey, realmGet$mu_name, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6846f, createRowWithPrimaryKey, false);
                }
            }
        }
    }
