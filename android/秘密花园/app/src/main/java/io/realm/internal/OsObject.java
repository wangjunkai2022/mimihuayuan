...
public class OsObject implements i {
    ...
    public OsObject(OsSharedRealm osSharedRealm, UncheckedRow uncheckedRow) {
        this.nativePtr = nativeCreate(osSharedRealm.getNativePtr(), uncheckedRow.f6957c);
    ...
    public static long createRow(Table table) {
        return nativeCreateRow(table.f6953c.getNativePtr(), table.a);
    }
    ...
    public static long createRowWithPrimaryKey(Table table, long j2, Object obj) {
        ...
        if (fromNativeValue == RealmFieldType.STRING) {
            ...
            return nativeCreateRowWithLongPrimaryKey(osSharedRealm.getNativePtr(), table.a, j2, j3, obj == null);
        } else {
    ...
    public static UncheckedRow createWithPrimaryKey(Table table, Object obj) {
        ...
        if (h2 == RealmFieldType.STRING) {
            ...
            return new UncheckedRow(osSharedRealm.context, table, nativeCreateNewObjectWithLongPrimaryKey(osSharedRealm.getNativePtr(), table.a, andVerifyPrimaryKeyColumnIndex, j2, obj == null));
        } else {
    ...
    public static long getAndVerifyPrimaryKeyColumnIndex(Table table) {
        String a2 = OsObjectStore.a(table.f6953c, table.d());
        if (a2 != null) {
            return table.f(a2);
        }
