...
public class o {
    ...
    public static final b f7334g = new a();
    ...
    public final AtomicReference<a> f7336d = new AtomicReference<>();
    ...
    public static java.lang.Object d(java.lang.Class<?> r9, java.util.Properties r10) {
        /*
            ...
            java.util.Set r5 = r10.entrySet()     // Catch: SecurityException -> 0x00a9
            java.util.Iterator r5 = r5.iterator()     // Catch: SecurityException -> 0x00a9
        L_0x0032:
            boolean r6 = r5.hasNext()     // Catch: SecurityException -> 0x00a9
            if (r6 == 0) goto L_0x00ad
            java.lang.Object r6 = r5.next()     // Catch: SecurityException -> 0x00a9
            java.util.Map$Entry r6 = (java.util.Map.Entry) r6     // Catch: SecurityException -> 0x00a9
            java.lang.Object r7 = r6.getKey()     // Catch: SecurityException -> 0x00a9
            java.lang.String r7 = r7.toString()     // Catch: SecurityException -> 0x00a9
            boolean r8 = r7.startsWith(r2)     // Catch: SecurityException -> 0x00a9
            if (r8 == 0) goto L_0x0032
            boolean r8 = r7.endsWith(r3)     // Catch: SecurityException -> 0x00a9
            if (r8 == 0) goto L_0x0032
            java.lang.Object r6 = r6.getValue()     // Catch: SecurityException -> 0x00a9
            java.lang.String r6 = r6.toString()     // Catch: SecurityException -> 0x00a9
            boolean r6 = r0.equals(r6)     // Catch: SecurityException -> 0x00a9
            if (r6 == 0) goto L_0x0032
            r3 = 0
            int r5 = r7.length()     // Catch: SecurityException -> 0x00a9
            int r5 = r5 + -6
            java.lang.String r3 = r7.substring(r3, r5)     // Catch: SecurityException -> 0x00a9
            r5 = 14
            java.lang.String r3 = r3.substring(r5)     // Catch: SecurityException -> 0x00a9
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch: SecurityException -> 0x00a9
            r5.<init>()     // Catch: SecurityException -> 0x00a9
            r5.append(r2)     // Catch: SecurityException -> 0x00a9
            r5.append(r3)     // Catch: SecurityException -> 0x00a9
            r5.append(r4)     // Catch: SecurityException -> 0x00a9
            java.lang.String r2 = r5.toString()     // Catch: SecurityException -> 0x00a9
            java.lang.String r1 = r10.getProperty(r2)     // Catch: SecurityException -> 0x00a9
            if (r1 == 0) goto L_0x008a
            goto L_0x00ad
        L_0x008a:
            java.lang.IllegalStateException r10 = new java.lang.IllegalStateException     // Catch: SecurityException -> 0x00a9
            ...
            r10.<init>(r2)     // Catch: SecurityException -> 0x00a9
            throw r10     // Catch: SecurityException -> 0x00a9
        L_0x00a9:
            r10 = move-exception
            r10.printStackTrace()
        L_0x00ad:
            if (r1 == 0) goto L_0x0106
            java.lang.Class r10 = java.lang.Class.forName(r1)     // Catch: ClassCastException -> 0x00e3, ClassNotFoundException -> 0x00d6, InstantiationException -> 0x00c9, IllegalAccessException -> 0x00bc
            java.lang.Class r9 = r10.asSubclass(r9)     // Catch: ClassCastException -> 0x00e3, ClassNotFoundException -> 0x00d6, InstantiationException -> 0x00c9, IllegalAccessException -> 0x00bc
            java.lang.Object r9 = r9.newInstance()     // Catch: ClassCastException -> 0x00e3, ClassNotFoundException -> 0x00d6, InstantiationException -> 0x00c9, IllegalAccessException -> 0x00bc
            return r9
        L_0x00bc:
            r9 = move-exception
    ...
    public a a() {
        if (this.f7336d.get() == null) {
            Object d2 = d(a.class, g());
            if (d2 == null) {
                this.f7336d.compareAndSet(null, new b(this));
            } else {
                this.f7336d.compareAndSet(null, (a) d2);
            }
        }
    ...
    public b b() {
        if (this.a.get() == null) {
            Object d2 = d(b.class, g());
            if (d2 == null) {
                this.a.compareAndSet(null, f7334g);
            } else {
                this.a.compareAndSet(null, (b) d2);
            }
        }
        return this.a.get();
    }
