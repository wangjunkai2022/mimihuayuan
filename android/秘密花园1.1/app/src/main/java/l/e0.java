...
public final class e0 {
    ...
    public void a(String str, String str2, boolean z) {
        if (z) {
            ...
            if (str != null) {
                aVar.a.add(x.b.a(i.x.f6771l, str, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", true, false, true, false, aVar.f6765c, 83));
                aVar.b.add(x.b.a(i.x.f6771l, str2, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", true, false, true, false, aVar.f6765c, 83));
                return;
            }
            h.o.c.g.f("name");
            throw null;
    ...
    public void d(String str, String str2, boolean z) {
        ...
        if (z) {
            ...
            if (str != null) {
                ...
                if (list != null) {
                    list.add(x.b.a(i.x.f6771l, str, 0, 0, " \"'<>#&=", true, false, true, false, null, TbsListener.ErrorCode.EXCEED_COPY_RETRY_NUM));
                    List<String> list2 = aVar.f6785g;
                    if (list2 != null) {
                        list2.add(str2 != null ? x.b.a(i.x.f6771l, str2, 0, 0, " \"'<>#&=", true, false, true, false, null, TbsListener.ErrorCode.EXCEED_COPY_RETRY_NUM) : null);
                        return;
                    } else {
                        h.o.c.g.e();
                        throw null;
