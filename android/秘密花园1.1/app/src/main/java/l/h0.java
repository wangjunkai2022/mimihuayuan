...
public final class h0 {
    ...
    public static final class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final List<l.a> f7193d;

        /* renamed from: e  reason: collision with root package name */
        public final List<e.a> f7194e;
        ...
        public h0 b() {
            ...
            if (this.f7192c != null) {
                ...
                return new h0(aVar2, this.f7192c, Collections.unmodifiableList(arrayList2), Collections.unmodifiableList(arrayList), a, false);
            }
    ...
    public <T> l<T, i.g0> d(Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        for (int i2 = indexOf; i2 < size; i2++) {
            l<T, i.g0> lVar = (l<T, i.g0>) this.f7187d.get(i2).a(type, annotationArr, annotationArr2, this);
            if (lVar != null) {
                return lVar;
            }
        }
    ...
    public <T> l<i.i0, T> e(Type type, Annotation[] annotationArr) {
        ...
        int size = this.f7187d.size();
        for (int i2 = indexOf; i2 < size; i2++) {
            l<i.i0, T> lVar = (l<i.i0, T>) this.f7187d.get(i2).b(type, annotationArr, this);
            if (lVar != null) {
                return lVar;
            }
        }
