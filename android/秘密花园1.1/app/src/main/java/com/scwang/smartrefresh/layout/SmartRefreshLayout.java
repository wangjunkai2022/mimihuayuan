...
public class SmartRefreshLayout extends ViewGroup implements f.j.a.a.f.i, NestedScrollingParent {
            ...
            if (i2 < Integer.MAX_VALUE) {
                ...
                if (smartRefreshLayout7.n || smartRefreshLayout7.e0) {
                    ...
                    if (smartRefreshLayout8.n) {
                        ...
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, smartRefreshLayout8.f2374j, (f2 + smartRefreshLayout8.b) - (smartRefreshLayout8.a * 2), 0));
                        SmartRefreshLayout smartRefreshLayout9 = SmartRefreshLayout.this;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 2, smartRefreshLayout9.f2374j, smartRefreshLayout9.f2375k + smartRefreshLayout9.b, 0));
                    }
            ...
            public void run() {
                ...
                if (i2 > 0) {
                    ...
                    if (animatorUpdateListener == null && i2 != 0) {
                        if (gVar.f2381c && smartRefreshLayout2.G) {
        ...
        public void run() {
            ...
            if (Math.abs(smartRefreshLayout.b) >= Math.abs(this.f2384c)) {
                if (this.f2384c != 0) {
                    int i2 = this.a + 1;
                    this.a = i2;
                    this.f2387f = (float) (Math.pow(0.44999998807907104d, i2 * 2) * this.f2387f);
                } else {
                    int i3 = this.a + 1;
                    this.a = i3;
                    this.f2387f = (float) (Math.pow(0.8500000238418579d, i3 * 2) * this.f2387f);
                }
            } else {
                int i4 = this.a + 1;
                this.a = i4;
                this.f2387f = (float) (Math.pow(0.949999988079071d, i4 * 2) * this.f2387f);
            }
            ...
            if (Math.abs(smartRefreshLayout4.b) >= Math.abs(this.f2384c)) {
                SmartRefreshLayout smartRefreshLayout5 = SmartRefreshLayout.this;
                smartRefreshLayout5.g(this.f2384c, 0, smartRefreshLayout5.y, Math.min(Math.max((int) (Math.abs(SmartRefreshLayout.this.b - this.f2384c) / f.j.a.a.m.b.f6184d), 30), 100) * 10);
            }
        }
    }
    ...
    public class i implements Runnable {
        ...
        public void run() {
            ...
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            float pow = (float) (Math.pow(this.f2390d, ((float) (currentAnimationTimeMillis - this.f2391e)) / (1000.0f / this.b)) * this.f2389c);
            this.f2389c = pow;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x00c6, code lost:
        if (r4.f6130f == false) goto L64;
     */
    /* JADX WARN: Code restructure failed: missing block: B:67:0x00cc, code lost:
        if (r21.y0.a == false) goto L64;
     */
    /* JADX WARN: Code restructure failed: missing block: B:73:0x00da, code lost:
        if (r4.f6130f == false) goto L72;
     */
                ...
                if (gVar2 != null && gVar2.getView() == childAt) {
                    ...
                    if (spinnerStyle == f.j.a.a.g.c.f6136h) {
                        ...
                        if (!z2 && spinnerStyle != f.j.a.a.g.c.f6135g && spinnerStyle != f.j.a.a.g.c.f6134f) {
                            if (spinnerStyle.f6138c && this.b < 0) {
    ...
    */
    ...
    public void q(float f2) {
        ...
        if (f3 > this.f2371g * 5 && getTag() == null) {
        ...
        if (this.y0 == f.j.a.a.g.b.TwoLevel && f3 > 0.0f) {
            ...
            if (f3 < i2) {
                ...
                int i3 = this.i0;
                double d3 = max - i3;
                double max2 = Math.max(0.0f, (f3 - i3) * this.f2376l);
                double d4 = -max2;
                if (d3 == 0.0d) {
                    d3 = 1.0d;
                }
            ...
            if (f3 > (-i4)) {
                ...
                int i5 = this.k0;
                double d6 = max3 - i5;
                double d7 = -Math.min(0.0f, (i5 + f3) * this.f2376l);
                double d8 = -d7;
                if (d6 == 0.0d) {
                    d6 = 1.0d;
                }
            ...
            double max4 = Math.max(this.f2371g / 2, getHeight());
            double max5 = Math.max(0.0f, this.f2376l * f3);
            double d10 = -max5;
            if (max4 == 0.0d) {
                max4 = 1.0d;
            }
            ...
            double max6 = Math.max(this.f2371g / 2, getHeight());
            double d12 = -Math.min(0.0f, this.f2376l * f3);
            double d13 = -d12;
            if (max6 == 0.0d) {
                max6 = 1.0d;
            }
        ...
        this.w0.postDelayed(new e(), this.f2370f);
    }
        ...
        if (bVar == f.j.a.a.g.b.TwoLevel) {
            if (this.v > -1000 && this.b > getMeasuredHeight() / 2) {
                ...
                if (smartRefreshLayout.y0 == f.j.a.a.g.b.TwoLevel) {
                    ...
                    kVar.a(0).setDuration(SmartRefreshLayout.this.f2369e);
                }
            }
