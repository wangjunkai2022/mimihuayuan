...
public class VVideoAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        final VideoListBean.ResponseEntity.VideosEntity videosEntity = this.f1783c.get(i2);
        ...
        aVar.itemView.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.g0.k.a
