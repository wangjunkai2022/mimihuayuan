...
public class AppActivity extends BaseActivity {
    ...
    public static void m(AppActivity appActivity, String str) {
        if (appActivity != null) {
            ...
            while (it.hasNext()) {
                ...
                appInfo.setUrl(appActivity.f1462d + e.a("GBYT") + hVar.b(e.a("XxAGAg==")));
                appInfo.setName(hVar.L());
                appInfo.setImage(appActivity.f1462d + hVar.J(e.a("Xg8E")).get(0).b(e.a("RBAA")));
    ...
    public void c(Intent intent) {
        ...
        this.f1461c = intent.getBooleanExtra(e.a("RAoMEyEGVEMxFFsQCw8R"), false);
    }
    ...
    public void e() {
        ...
        String str = this.b;
        this.f1462d = str.substring(0, str.lastIndexOf(e.a("GA==")));
        webView.getSettings().setJavaScriptEnabled(true);
        webView.addJavascriptInterface(new a(), e.a("XQMVBTQcW1k="));
        webView.setWebViewClient(new f.e.a.j.b0.h(this));
        webView.loadUrl(str);
        this.tvJump.setVisibility(this.f1461c ? 0 : 8);
    }
