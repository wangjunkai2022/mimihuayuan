...
public class ActorDetailActivity extends BaseRefreshActivity {
    ...
    public ActorBean.ResponseEntity.ActorsEntity f1757d;
    @BindView
    ...
    public void c(Intent intent) {
        this.f1757d = (ActorBean.ResponseEntity.ActorsEntity) intent.getSerializableExtra(e.a("UwMXBQ=="));
    }
    ...
    public void e() {
        super.e();
        j(-16777216);
        h.K0(this.f1757d.getActor_url(), this.ivHead);
        this.tvName.setText(this.f1757d.getActor_name());
    }
    ...
    public void p(int i2) {
        b a2 = f.e.a.j.g0.m.e.a();
        int actor_id = this.f1757d.getActor_id();
