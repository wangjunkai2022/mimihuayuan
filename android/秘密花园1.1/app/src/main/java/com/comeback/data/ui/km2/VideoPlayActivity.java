...
public class VideoPlayActivity extends BaseActivity {
    ...
    public static boolean f1362f = false;
    public Km2Video b;

    /* renamed from: c  reason: collision with root package name */
    public ExoUserPlayer f1363c;
    ...
    public void c(Intent intent) {
        this.f1364d = intent.getStringExtra(e.a("XgY="));
        this.f1365e = intent.getBooleanExtra(e.a("WwMNABgQWEMW"), false);
    }
    ...
    @Override // com.comeback.data.base.BaseActivity
    public void e() {
        this.f1363c = h.h(this, this.videoView);
        ...
        this.f1363c.setPlayUri(e.a("XxYXFFFcFkQEERoFGQMHHhkBDAk="));
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(e.a("QQsHAQQsUFc="), this.f1364d);
        ...
        if (g.d(x.P()).b(Km2Video.class, e.a("XgY="), this.f1364d)) {
        ...
        this.videoDetailLikeImg.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.x.f
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1363c.onConfigurationChanged(configuration);
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        this.f1363c.onDestroy();
        super.onDestroy();
    }
