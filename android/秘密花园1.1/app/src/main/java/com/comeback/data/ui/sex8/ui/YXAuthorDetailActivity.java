...
public class YXAuthorDetailActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1880d = (YXHostBean) intent.getParcelableExtra(e.a("Xw0QECkWWF0="));
    }
    ...
    public void e() {
        j(-1);
        super.e();
        this.tvTitle.setText(this.f1880d.getName());
        this.tvSpecial.setText(this.f1880d.getWorks_count());
        this.tvHot.setText(this.f1880d.getHits_count());
        h.u0(this.f1880d.getImg(), this.ivHeader);
    }
    ...
    public void p(int i2) {
        ...
        yXParams.setHostid(this.f1880d.getHost_id());
        yXParams.setPage(i2);
