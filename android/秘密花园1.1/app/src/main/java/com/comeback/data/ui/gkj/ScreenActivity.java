...
public class ScreenActivity extends BaseRefreshActivity {
    ...
    public class a extends j<ScreenBean> {
        ...
        public void f(ScreenBean screenBean) {
            ...
            TagAdapter tagAdapter = new TagAdapter(screenActivity, new TagAdapter.a() { // from class: f.e.a.j.m.f
            ...
            Tag3Adapter tag3Adapter = new Tag3Adapter(screenActivity, new Tag3Adapter.a() { // from class: f.e.a.j.m.c
            ...
            Tag3Adapter tag3Adapter2 = new Tag3Adapter(screenActivity, new Tag3Adapter.a() { // from class: f.e.a.j.m.h
                @Override // com.comeback.data.ui.gkj.adapter.Tag3Adapter.a
                public final void a(int i2) {
            ...
            Tag3Adapter tag3Adapter3 = new Tag3Adapter(screenActivity, new Tag3Adapter.a() { // from class: f.e.a.j.m.d
                @Override // com.comeback.data.ui.gkj.adapter.Tag3Adapter.a
                public final void a(int i2) {
    ...
    public void e() {
        j(-1);
        this.refreshLayout.a0 = new d() { // from class: f.e.a.j.m.e
