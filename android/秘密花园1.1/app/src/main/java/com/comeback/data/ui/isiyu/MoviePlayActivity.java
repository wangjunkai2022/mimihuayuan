...
public class MoviePlayActivity extends BaseActivity {
    ...
    public class a extends j<Video> {
        ...
        public void f(Video video) {
            ...
            MoviePlayActivity.this.f1167c.setPlayUri(video2.getPlay_url_m3u8());
            MoviePlayActivity.this.f1167c.startPlayer();
            h.h1(MoviePlayActivity.this.f1167c.getVideoPlayerView(), video2.getPlay_url_m3u8());
        }
    }
    ...
    public void e() {
        ...
        k(f.e.a.j.t.e.e.a().f(hashMap), new a());
        hashMap.put(e.a("VA0KChg="), e.a("Bw=="));
        k(f.e.a.j.t.e.e.a().b(hashMap), new b());
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void onBackPressed() {
        if (this.f1167c.onBackPressed()) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1167c.onConfigurationChanged(configuration);
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        this.f1167c.onDestroy();
        super.onDestroy();
    }
