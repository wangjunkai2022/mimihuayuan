...
public class ScreenActivity extends BaseRefreshActivity {
    ...
    public String[] f2191d = {e.a("Bw=="), e.a("Bw=="), e.a("Bw=="), e.a("Bw=="), e.a("Bw=="), e.a("Bw=="), e.a("Bw=="), e.a("Bw==")};

    /* renamed from: e  reason: collision with root package name */
    public boolean f2192e = false;

    /* renamed from: f  reason: collision with root package name */
    public TabLayout.OnTabSelectedListener f2193f = new a();
    @BindView
        ...
        public void onTabSelected(TabLayout.Tab tab) {
            ...
            if (tag != null) {
                if (tag instanceof ScreenVideo.DataBean.CategoriesBean) {
                    ScreenActivity.this.f2191d[0] = ((ScreenVideo.DataBean.CategoriesBean) tag).getCateid();
                } else if (tag instanceof ScreenVideo.DataBean.AreasBean) {
                    ScreenActivity.this.f2191d[1] = ((ScreenVideo.DataBean.AreasBean) tag).getAreaid();
                } else if (tag instanceof ScreenVideo.DataBean.YearsBean) {
                    ScreenActivity.this.f2191d[2] = ((ScreenVideo.DataBean.YearsBean) tag).getYearid();
                } else if (tag instanceof ScreenVideo.DataBean.DefinitionsBean) {
                    ScreenActivity.this.f2191d[3] = ((ScreenVideo.DataBean.DefinitionsBean) tag).getKeyid();
                } else if (tag instanceof ScreenVideo.DataBean.DurationsBean) {
                    ScreenActivity.this.f2191d[4] = ((ScreenVideo.DataBean.DurationsBean) tag).getKeyid();
                } else if (tag instanceof ScreenVideo.DataBean.MosaicsBean) {
                    ScreenActivity.this.f2191d[5] = ((ScreenVideo.DataBean.MosaicsBean) tag).getKeyid();
                } else if (tag instanceof ScreenVideo.DataBean.LangvoicesBean) {
                    ScreenActivity.this.f2191d[6] = ((ScreenVideo.DataBean.LangvoicesBean) tag).getKeyid();
                } else if (!(tag instanceof ScreenVideo.DataBean.OrdersBean)) {
                    return;
                } else {
                    ScreenActivity.this.f2191d[7] = ((ScreenVideo.DataBean.OrdersBean) tag).getKeyid();
                }
    ...
    public class b extends BaseRefreshActivity.a<ScreenVideo> {
        ...
        public void f(Object obj) {
            ...
            if (this.f2194f == 1) {
                ...
                if (!screenActivity.f2192e) {
                    screenActivity.f2192e = true;
                    ...
                    screenActivity.mTab1.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.CategoriesBean categoriesBean2 : screenVideo.getData().getCategories()) {
                        ...
                        if (categoriesBean2.getCateid().equals(screenActivity.f2191d[0])) {
                            text2.select();
                        }
                    }
                    ...
                    screenActivity.mTab2.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.AreasBean areasBean2 : screenVideo.getData().getAreas()) {
                        ...
                        if (areasBean2.getAreaid().equals(screenActivity.f2191d[1])) {
                            text4.select();
                        }
                    }
                    ...
                    screenActivity.mTab3.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.YearsBean yearsBean2 : screenVideo.getData().getYears()) {
                        ...
                        if (yearsBean2.getYearid().equals(screenActivity.f2191d[2])) {
                            text6.select();
                        }
                    }
                    ...
                    screenActivity.mTab4.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.DefinitionsBean definitionsBean2 : screenVideo.getData().getDefinitions()) {
                        ...
                        if (definitionsBean2.getKeyid().equals(screenActivity.f2191d[3])) {
                            text8.select();
                        }
                    }
                    ...
                    screenActivity.mTab5.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.DurationsBean durationsBean2 : screenVideo.getData().getDurations()) {
                        ...
                        if (durationsBean2.getKeyid().equals(screenActivity.f2191d[4])) {
                            text10.select();
                        }
                    }
                    ...
                    screenActivity.mTab6.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.MosaicsBean mosaicsBean2 : screenVideo.getData().getMosaics()) {
                        ...
                        if (mosaicsBean2.getKeyid().equals(screenActivity.f2191d[5])) {
                            text12.select();
                        }
                    }
                    ...
                    screenActivity.mTab7.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.LangvoicesBean langvoicesBean2 : screenVideo.getData().getLangvoices()) {
                        ...
                        if (langvoicesBean2.getKeyid().equals(screenActivity.f2191d[6])) {
                            text14.select();
                        }
                    }
                    ...
                    screenActivity.mTab8.addOnTabSelectedListener(screenActivity.f2193f);
                    for (ScreenVideo.DataBean.OrdersBean ordersBean2 : screenVideo.getData().getOrders()) {
                        ...
                        if (ordersBean2.getKeyid().equals(screenActivity.f2191d[7])) {
                            text16.select();
                        }
                    }
                }
    ...
    public void p(int i2) {
        ...
        f.e.a.j.r0.f.a a2 = f.e.a.j.r0.f.b.a();
        StringBuilder sb = new StringBuilder();
        sb.append(e.a("WwsQEAIdXh4="));
        f.b.a.a.a.B(sb, this.f2191d[0], "Gg==");
        f.b.a.a.a.B(sb, this.f2191d[1], "Gg==");
        f.b.a.a.a.B(sb, this.f2191d[2], "Gg==");
        f.b.a.a.a.B(sb, this.f2191d[3], "Gg==");
        f.b.a.a.a.B(sb, this.f2191d[4], "GlJO");
        f.b.a.a.a.B(sb, this.f2191d[5], "Gg==");
        f.b.a.a.a.B(sb, this.f2191d[6], "Gg==");
        sb.append(this.f2191d[7]);
        sb.append(e.a("Gg=="));
        sb.append(i2);
