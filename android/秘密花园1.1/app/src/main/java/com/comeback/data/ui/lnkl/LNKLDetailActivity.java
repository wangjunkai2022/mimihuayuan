...
public class LNKLDetailActivity extends BaseActivity {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            if (g0Var.a.f6449e < 300) {
                try {
                    ...
                    LNKLDetailActivity.this.f1383d = W0.getTorrentUrl();
                    TextView textView = LNKLDetailActivity.this.tvLink;
                    textView.setText(e.a("0MXugcbj0KDNgLrCl9b5") + LNKLDetailActivity.this.f1383d);
    ...
    public void c(Intent intent) {
        ...
        this.f1382c = intent.getStringExtra(e.a("QhAP"));
        d<i0> c2 = c.a().c(this.f1382c);
        this.f1384e = c2;
        c2.X(new a());
    }
    ...
    public void onViewClicked(View view) {
        ...
        int id = view.getId();
        if (id == R.id.tv_copy) {
            ((ClipboardManager) getSystemService(e.a("VA4KFAkcWEEX"))).setPrimaryClip(ClipData.newPlainText(e.a("ewMBAQc="), this.f1383d));
            h.n1(e.a("0sbugePF37vjg774"));
        } else if (id != R.id.tv_down) {
        } else {
            try {
                Intent intent = new Intent(e.a("VgwHFgQaXR0aCEACFh5NClQWCgsFXW96NjE="), Uri.parse(this.f1383d));
