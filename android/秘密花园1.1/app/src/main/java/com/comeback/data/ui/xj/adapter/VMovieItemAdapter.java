...
public class VMovieItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        final VideoBean videoBean = this.f2239c.get(i2);
        ...
        aVar.f2240c.setVisibility(videoBean.getExclusive() == 1 ? 0 : 8);
        ...
        aVar.itemView.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.r0.d.l
