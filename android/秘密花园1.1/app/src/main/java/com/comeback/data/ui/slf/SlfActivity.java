...
public class SlfActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1963c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.k0.e
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1963c);
    }

    public /* synthetic */ boolean l(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.navigation_cartoon /* 2131296605 */:
                this.viewPager.setCurrentItem(0, false);
                return true;
            case R.id.navigation_image /* 2131296619 */:
            ...
            case R.id.navigation_novel /* 2131296625 */:
                ...
                return true;
            case R.id.navigation_video /* 2131296635 */:
