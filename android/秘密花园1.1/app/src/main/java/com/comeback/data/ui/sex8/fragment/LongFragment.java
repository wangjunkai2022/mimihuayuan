...
public class LongFragment extends BaseRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<YXNovelList> {
        ...
        public void f(Object obj) {
            ...
            if (this.f1860f == 1) {
                LongFragment.this.f117h.c();
            }
            LongFragment.this.f117h.a(yXNovelList.getData());
        }
    }
    ...
    public void l(int i2) {
        ...
        yXParams.setCategory(e.a("UhAMEAIQZl8cCFM="));
