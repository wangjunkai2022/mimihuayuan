...
public class ActorDetailActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f693d = (ActorsBean) intent.getParcelableExtra(e.a("VQcCCg=="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.z0(this.f693d.getActor_url(), this.ivHead);
        this.tvName.setText(this.f693d.getActor_name());
        if (g.d(this.f693d.getRealm()).b(this.f693d.getClass(), e.a("VgEXCxksUFc="), this.f693d.getActor_id())) {
            t();
        }
    }
    ...
    public void p(int i2) {
        b b = f.b();
        String actor_id = this.f693d.getActor_id();
