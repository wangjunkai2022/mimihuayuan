...
public class FengliuActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public class a extends d.c.b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ FengliuActivity f1249c;

        public a(FengliuActivity_ViewBinding fengliuActivity_ViewBinding, FengliuActivity fengliuActivity) {
            this.f1249c = fengliuActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            FengliuActivity fengliuActivity = this.f1249c;
    ...
    public void a() {
        FengliuActivity fengliuActivity = this.f1246c;
