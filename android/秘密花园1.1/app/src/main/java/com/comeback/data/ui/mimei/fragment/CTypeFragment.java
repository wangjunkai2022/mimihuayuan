...
public class CTypeFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1707i = getArguments().getInt(e.a("QxsTAQ=="));
        this.f1708j = getArguments().getString(e.a("XAca"));
    }
    ...
    public void l(int i2) {
        ...
        if (this.f1708j.equals(e.a("RQMNDwIdXg=="))) {
            hashMap.put(e.a("RQMNAw4="), e.a("BA=="));
        }
        hashMap.put(f.b.a.a.a.G(i2, hashMap, f.b.a.a.a.i("Blc=", hashMap, f.b.a.a.a.G(this.f1707i, hashMap, e.a("QxsTAQ=="), "VA0WCh8A"), "RwMEARg="), "VAoCDQU="), d.b);
        hashMap.put(e.a("Xw0QEA=="), d.f3852c);
        g(f.a().h(this.f1708j, hashMap), new a(i2));
    }
}
