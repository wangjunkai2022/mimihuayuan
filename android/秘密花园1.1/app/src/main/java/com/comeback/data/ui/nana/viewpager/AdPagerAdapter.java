...
public class AdPagerAdapter extends BaseCardPagerAdapter<f.e.a.g.a> {
    ...
    public class SpikePagerItemViewHolder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ SpikePagerItemViewHolder f1811c;
            ...
            public a(SpikePagerItemViewHolder_ViewBinding spikePagerItemViewHolder_ViewBinding, SpikePagerItemViewHolder spikePagerItemViewHolder) {
                this.f1811c = spikePagerItemViewHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                SpikePagerItemViewHolder spikePagerItemViewHolder = this.f1811c;
                a aVar = spikePagerItemViewHolder.a.f1809e;
                if (aVar != null) {
                    MovieDetailActivity.o(((f.e.a.j.g0.l.b) aVar).a.getContext(), spikePagerItemViewHolder.b.getId());
                    return;
                }
