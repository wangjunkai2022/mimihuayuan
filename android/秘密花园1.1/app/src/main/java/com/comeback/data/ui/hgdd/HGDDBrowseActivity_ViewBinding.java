...
public class HGDDBrowseActivity_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ HGDDBrowseActivity f1015c;

        public a(HGDDBrowseActivity_ViewBinding hGDDBrowseActivity_ViewBinding, HGDDBrowseActivity hGDDBrowseActivity) {
            this.f1015c = hGDDBrowseActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            f.e.a.j.o.d.a aVar;
            HGDDBrowseActivity hGDDBrowseActivity = this.f1015c;
            ...
            if (url.contains(e.a("URI8DQ8="))) {
                ...
                hGDDBrowseActivity.k(aVar.a(str), new f.e.a.j.o.b(hGDDBrowseActivity));
                return;
            }
