...
public class MovieItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeData.DataBean f1595c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (MovieItemAdapter.this.f1595c.isComic()) {
                h.n1(e.a("0d7Ig//I"));
            } else {
    ...
    public int getItemCount() {
        return this.f1595c.getVideos().size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        HomeData.DataBean.VideosBean videosBean = this.f1595c.getVideos().get(i2);
        bVar.f1596c.setText(videosBean.getName());
