...
public class YXDetailActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public YXDetailActivity f1887c;
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ YXDetailActivity f1889c;

        public a(YXDetailActivity_ViewBinding yXDetailActivity_ViewBinding, YXDetailActivity yXDetailActivity) {
            this.f1889c = yXDetailActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            YXDetailActivity yXDetailActivity = this.f1889c;
            YXNovelDetail.DataBean dataBean = yXDetailActivity.f1885d;
            if (dataBean != null) {
    ...
    public void a() {
        YXDetailActivity yXDetailActivity = this.f1887c;
