...
public class VideoLoadingProgressbar extends View {
    ...
    public VideoLoadingProgressbar(Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f2270c = 100;
        this.f2271d = 100;
        this.f2272e = Color.parseColor(e.a("FAYGAA4XXA=="));
        this.f2275h = 20;
        ...
        this.f2274g = new a(this);
        if (getVisibility() == 0) {
            this.f2274g.sendEmptyMessageDelayed(1, this.f2275h);
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int i4 = this.a;
        int i5 = this.f2270c;
        canvas.drawLine((i4 / 2.0f) - (i5 / 2.0f), 0.0f, (i5 / 2.0f) + (i4 / 2.0f), this.b, this.f2273f);
    }
