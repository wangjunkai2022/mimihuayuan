...
public class VideoFragment extends BaseVRefreshFragment {
    ...
    public void l(int i2) {
        ...
        l lVar = new l();
        lVar.p(0, 0, 0, 0);
        PPTAdapter pPTAdapter = new PPTAdapter(getContext(), lVar, this.f1625j);
        this.f120i.b(pPTAdapter);
        pPTAdapter.f393c = new PPTAdapter.b() { // from class: f.e.a.j.c0.l.a
    ...
    public /* synthetic */ void r(int i2) {
        SpecialList.DataBean dataBean = this.f1625j.getData().get(i2);
