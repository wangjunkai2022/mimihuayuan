...
public class Title2Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public NavBean.DataEntity f972c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            SpecialActivity.v(title2Adapter.a, title2Adapter.f972c.getId(), Title2Adapter.this.f972c.getSpecialName(), Title2Adapter.this.f972c.getType(), Title2Adapter.this.f972c.getStyle());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        bVar.a.setText(this.f972c.getSpecialName());
        bVar.b.setText(this.f972c.getTotalText());
