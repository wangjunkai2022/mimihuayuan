...
public class NovelActivity extends BaseRefreshActivity {
    ...
    public NovelList.NovelEntity f802d;
    @BindView
    ...
    public void c(Intent intent) {
        this.f802d = (NovelList.NovelEntity) intent.getParcelableExtra(e.a("XgwFCw=="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.u0(this.f802d.getFiction_cover(), this.ivImg);
        this.tvTitle.setText(this.f802d.getFiction_name());
        TextView textView = this.tvAuthor;
        textView.setText(e.a("09//jOv21o/p") + this.f802d.getFiction_author());
        TextView textView2 = this.tvUpdate;
        textView2.setText(e.a("0fnXgv3D36TFj6PTl9b5") + h.g0(this.f802d.getPush_time()));
        this.tvDesc.setText(this.f802d.getIntroduction());
    }
    ...
    public void p(int i2) {
        b a2 = f.e.a.j.l.e.e.a();
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(e.a("UQsAEAIcV2waAg=="), String.valueOf(this.f802d.getFiction_id()));
