...
public class SearchActivity extends BaseRefreshActivity {
    ...
    public void e() {
        j(-1);
        this.refreshLayout.a0 = new f.j.a.a.l.d() { // from class: f.e.a.j.q.c
            @Override // f.j.a.a.l.d
            public final void b(i iVar) {
                SearchActivity.this.v(iVar);
            }
        };
        this.refreshLayout.v(new b() { // from class: f.e.a.j.q.b
        ...
        this.etSearch.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: f.e.a.j.q.d
    ...
    public void p(int i2) {
        d<i0> c2 = c.a().c(f.e.a.j.q.f.a.b(i2, f.e.a.j.q.f.a.c(), "", this.f1050d));
        this.f1051e = c2;
        c2.X(new a(i2));
    }
