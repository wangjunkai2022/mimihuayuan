...
public class UserCenterActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public UserCenterActivity f1351c;
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ UserCenterActivity f1353c;

        public a(UserCenterActivity_ViewBinding userCenterActivity_ViewBinding, UserCenterActivity userCenterActivity) {
            this.f1353c = userCenterActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            UserCenterActivity userCenterActivity = this.f1353c;
            userCenterActivity.t(userCenterActivity.tvFollow);
            Km2User km2User = new Km2User();
            km2User.setMu_id(userCenterActivity.f1348e);
            km2User.setMu_name(userCenterActivity.f1347d);
    ...
    public UserCenterActivity_ViewBinding(UserCenterActivity userCenterActivity, View view) {
        ...
        this.f1351c = userCenterActivity;
    ...
    public void a() {
        UserCenterActivity userCenterActivity = this.f1351c;
