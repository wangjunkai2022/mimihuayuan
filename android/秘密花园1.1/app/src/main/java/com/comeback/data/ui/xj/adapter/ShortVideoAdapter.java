...
public class ShortVideoAdapter extends BaseAbstractAdapter<VideoBean> {
    ...
    public static class TiktopHolder extends BaseViewHolder<VideoBean> {
        ...
        public void a(VideoBean videoBean) {
            ...
            this.mIvPlay.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.r0.d.b
        ...
        public final void c() {
            if (this.a.getCurrentPosition() <= 500) {
                if (TextUtils.isEmpty(this.f2226d.getPlay())) {
                    e.a("aD08Ow==");
                    getAdapterPosition();
                    e.a("3+zUgeTl36HegKDZnfbTjqri");
                    m.e<PlayUrl> e2 = b.a().e(this.f2226d.getVodid());
