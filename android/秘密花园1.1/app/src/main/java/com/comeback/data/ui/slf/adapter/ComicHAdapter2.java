...
public class ComicHAdapter2 extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f1986c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(ComicHAdapter2 comicHAdapter2, View view) {
            ...
            this.f1987c = (TextView) view.findViewById(R.id.tv_state);
            this.f1988d = (TextView) view.findViewById(R.id.tv_watch);
            this.f1989e = (TextView) view.findViewById(R.id.tv_collect);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        SLFItemBean sLFItemBean = this.f1986c.get(i2);
        h.N0(sLFItemBean.getImg(), bVar.a, 0);
        bVar.b.setText(sLFItemBean.getName());
        bVar.f1987c.setText(sLFItemBean.getTagStr());
        bVar.f1988d.setText(sLFItemBean.getClick());
        bVar.f1989e.setText(sLFItemBean.getFavorite());
