...
public class FuLao2Activity extends BaseActivity {
    ...
    public static Host f699d;
    public ArrayList<BaseFragment> b;

    /* renamed from: c  reason: collision with root package name */
    public BottomNavigationView.OnNavigationItemSelectedListener f700c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.k.a
