...
public class UserCenterActivity extends BaseActivity {
    ...
    public void c(Intent intent) {
        ...
        this.f1136c = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1137d = intent.getStringExtra(e.a("XwcCACIeWFQW"));
    }
    ...
    public void e() {
        ...
        h.E0(this.f1137d, this.ivHeader);
        this.tvName.setText(this.f1136c);
