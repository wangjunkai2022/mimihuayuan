...
public class YXDetailActivity extends BaseRefreshActivity {
    ...
    public YXNovelDetail.DataBean f1885d;
    @BindView
    ...
    public static void r(YXDetailActivity yXDetailActivity, YXNovelDetail yXNovelDetail) {
        if (yXDetailActivity != null) {
            ...
            yXDetailActivity.f1885d = data;
            yXDetailActivity.tvName.setText(data.getName());
            yXDetailActivity.tvTitle.setText(yXDetailActivity.f1885d.getName());
            h.u0(yXDetailActivity.f1885d.getCover_img(), yXDetailActivity.ivPic);
            TextView textView = yXDetailActivity.tvDetail;
            textView.setText(yXDetailActivity.f1885d.getRadio_count() + "    " + yXDetailActivity.f1885d.getRadio_count() + e.a("3vnl"));
            YXHostBean host = yXDetailActivity.f1885d.getHost();
            ...
            yXDetailActivity.f114c.a(yXDetailActivity.f1885d.getRadio_list());
            return;
        }
        throw null;
    }
    ...
    public void c(Intent intent) {
        f1884e = intent.getStringExtra(e.a("Vg4BEQYsUFc="));
    }
