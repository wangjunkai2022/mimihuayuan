...
public class ComicDetailAdapter extends BaseAbstractAdapter<ChapterBean> {
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1981c;
            ...
            public void a(View view) {
                Holder holder = this.f1981c;
                if (holder != null) {
                    a aVar = holder.a.f1979d;
                    if (aVar != null) {
                        ComicDetailActivity comicDetailActivity = (ComicDetailActivity) aVar;
                        ComicReadActivity.q(comicDetailActivity, (ArrayList) comicDetailActivity.f1919e.b, holder.getAdapterPosition(), comicDetailActivity.b.getId());
