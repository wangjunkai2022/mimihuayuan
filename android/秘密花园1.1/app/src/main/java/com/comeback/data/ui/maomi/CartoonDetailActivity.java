...
public class CartoonDetailActivity extends BaseRefreshActivity {
    ...
    public Cartoon.DataBeanX.DataBean f1521d;
    @BindView
    ...
    public void c(Intent intent) {
        this.f1521d = (Cartoon.DataBeanX.DataBean) intent.getParcelableExtra(e.a("UwMXBQ=="));
    }
    ...
    public void e() {
        ...
        this.mTvTitle.setText(this.f1521d.getTitle());
        this.mTvDetail.setText(this.f1521d.getDescriptions());
        this.mTvDetail.setVisibility(TextUtils.isEmpty(this.f1521d.getDescriptions()) ? 8 : 0);
        h.u0(this.f1521d.getThumb(), this.mIvBg);
    }
    ...
    public void p(int i2) {
        ...
        try {
            ...
            jSONObject.put(e.a("XgY="), this.f1521d.getId());
