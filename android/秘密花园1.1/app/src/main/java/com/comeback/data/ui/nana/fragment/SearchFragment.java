...
public class SearchFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1796i = getArguments().getString(e.a("QQsHAQQsTUoDAw=="), "");
        this.f1797j = getArguments().getString(e.a("XAca"), "");
    }
    ...
    public RecyclerView.LayoutManager i() {
        if (this.f1796i.equals(e.a("Ww0NAw=="))) {
    ...
    public void l(int i2) {
        g(f.e.a.j.g0.m.e.a().l(this.f1796i, this.f1797j, d.a), new a(i2));
    }
}
