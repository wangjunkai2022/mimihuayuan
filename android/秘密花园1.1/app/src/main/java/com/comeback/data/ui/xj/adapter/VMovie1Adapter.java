...
public class VMovie1Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        final VideoBean videoBean = this.f2235c.get(i2);
        ...
        aVar.f2236c.setVisibility(videoBean.getExclusive() == 1 ? 0 : 8);
        aVar.itemView.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.r0.d.k
