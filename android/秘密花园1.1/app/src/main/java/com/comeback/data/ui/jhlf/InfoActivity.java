...
public class InfoActivity extends BaseActivity {
    ...
    public static void l(InfoActivity infoActivity) {
        if (infoActivity != null) {
            ...
            StringBuffer stringBuffer = infoActivity.f1251c;
            ...
            title.setMessage(sb.toString()).setNeutralButton(e.a("09nGgfv93LX+gaDP"), new f(infoActivity)).setNegativeButton(e.a("0MnogebA3J36jpfi"), new f.e.a.j.v.e(infoActivity)).create().show();
            return;
        }
        throw null;
    }
