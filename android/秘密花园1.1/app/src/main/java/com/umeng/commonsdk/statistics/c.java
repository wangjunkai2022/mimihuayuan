...
public class c {
    ...
    public c(Context context) {
        ...
        this.f3179l = sharedPreferences.getLong("thtstart", 0L);
        ...
        imprintService.a(new d() { // from class: com.umeng.commonsdk.statistics.c.1
            ...
            public void onImprintChanged(ImprintHandler.a aVar) {
                c.this.f3178k.onImprintChanged(aVar);
                c cVar = c.this;
                cVar.a = UMEnvelopeBuild.imprintProperty(cVar.r, "track_list", null);
                try {
                    String a = com.umeng.commonsdk.framework.a.a(c.this.r, com.umeng.commonsdk.proguard.e.f3058e, (String) null);
    ...
    public boolean a(File file) {
        ...
        try {
            ...
            byte[] a = this.f3173f.a(byteArray, com.umeng.commonsdk.statistics.internal.a.a(this.r).a(file.getName()));
            int a2 = a == null ? 1 : a(a);
            if (a2 == 2) {
                this.f3175h.d();
