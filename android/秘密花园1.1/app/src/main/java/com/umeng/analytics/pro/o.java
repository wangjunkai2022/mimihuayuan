        ...
        try {
            if (a(str) && b(str2)) {
                ...
                if (UMGlobalContext.getInstance().isMainProcess(f2852g)) {
                    a2 = u.a().d(UMGlobalContext.getAppContext(f2852g));
                } else {
                    a2 = u.a().a(UMGlobalContext.getAppContext(f2852g), currentTimeMillis);
                }
            ...
            if (!a(str)) {
                ...
                if (map.size() > 10) {
                    ...
                    if (UMGlobalContext.getInstance().isMainProcess(f2852g)) {
                        ...
                        a2 = u.a().a(UMGlobalContext.getAppContext(f2852g), jSONObject.getLong("ts"));
                    }
                    if (TextUtils.isEmpty(a2)) {
                        a2 = "-1";
                    }
