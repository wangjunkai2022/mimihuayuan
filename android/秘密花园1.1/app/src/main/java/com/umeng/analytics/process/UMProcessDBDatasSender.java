...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f2884d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() {
        ...
        if (a != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f2888h, null, null);
        }
        return a;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(com.umeng.analytics.pro.b.f2736i, AnalyticsConfig.getVerticalType(this.mContext));
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(com.umeng.analytics.pro.b.f2739l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(com.umeng.analytics.pro.b.f2740m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(com.umeng.analytics.pro.b.ae, "1.0.0");
            if (TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(com.umeng.analytics.pro.b.f2739l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(com.umeng.analytics.pro.b.f2740m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
