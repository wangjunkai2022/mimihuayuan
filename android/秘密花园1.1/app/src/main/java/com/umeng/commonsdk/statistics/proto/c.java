...
public class c implements j<c, e>, Serializable, Cloneable {
    ...
    static {
        ...
        enumMap.put((EnumMap) e.SNAPSHOTS, (e) new v("snapshots", (byte) 1, new y(ap.f3039k, new w((byte) 11), new aa((byte) 12, com.umeng.commonsdk.statistics.proto.b.class))));
        enumMap.put((EnumMap) e.JOURNALS, (e) new v("journals", (byte) 2, new x(ap.f3041m, new aa((byte) 12, com.umeng.commonsdk.statistics.proto.a.class))));
