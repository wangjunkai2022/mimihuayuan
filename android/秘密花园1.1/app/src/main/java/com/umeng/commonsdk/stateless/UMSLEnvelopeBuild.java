...
public class UMSLEnvelopeBuild {
    ...
    public synchronized JSONObject buildSLBaseHeader(Context context) {
        ...
        if (!TextUtils.isEmpty(cacheSystemheader)) {
            ...
            jSONObject.put(com.umeng.commonsdk.proguard.e.f3056c, SdkVersion.SDK_TYPE);
            if (!TextUtils.isEmpty(module)) {
                jSONObject.put(com.umeng.commonsdk.proguard.e.f3057d, module);
            }
        ...
        try {
            if (SdkVersion.SDK_TYPE != 1) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    jSONObject.put(com.umeng.commonsdk.proguard.e.f3058e, str);
                }
            }
        } catch (Exception unused3) {
        }
        try {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(applicationContext, com.umeng.commonsdk.proguard.e.f3059f, null);
            if (!TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(com.umeng.commonsdk.proguard.e.f3059f, imprintProperty);
            }
        } catch (Exception unused4) {
        }
        try {
            if (SdkVersion.SDK_TYPE != 1 && com.umeng.commonsdk.proguard.a.b(applicationContext) != null) {
                jSONObject.put(com.umeng.commonsdk.proguard.e.f3060g, com.umeng.commonsdk.proguard.a.b(applicationContext));
            }
    ...
    public synchronized JSONObject buildSLEnvelope(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str) {
        ...
        if (context != null && str != null) {
            ...
            if (f.a(jSONObject.toString().getBytes().length, a.f3116c)) {
            ...
            } else if (constructEnvelope != null && f.a(constructEnvelope.b().length, a.f3117d)) {
