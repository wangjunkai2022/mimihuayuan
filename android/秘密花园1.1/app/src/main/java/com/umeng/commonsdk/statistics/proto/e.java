...
public class e implements j<e, EnumC0030e>, Serializable, Cloneable {
    ...
    public static final Map<EnumC0030e, v> f3289d;
    ...
    public e() {
        this.f3298l = (byte) 0;
        this.f3299m = new EnumC0030e[]{EnumC0030e.VALUE};
    }
    ...
    public enum EnumC0030e implements q {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final Map<String, EnumC0030e> f3301d = new HashMap();
        ...
        static {
            ...
            while (it.hasNext()) {
                ...
                f3301d.put(enumC0030e.b(), enumC0030e);
            }
        }
