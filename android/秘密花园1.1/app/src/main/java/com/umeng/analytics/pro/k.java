...
public class k {
    ...
    private JSONObject m() {
        ...
        try {
            ...
            jSONObject.put(com.umeng.analytics.pro.b.f2736i, AnalyticsConfig.getVerticalType(a));
            ...
            if (t()) {
                ...
                if (sharedPreferences != null) {
                    sharedPreferences.edit().putLong(f2821m, 0L).commit();
                }
            }
            jSONObject.put(com.umeng.analytics.pro.b.f2739l, n());
            jSONObject.put(com.umeng.analytics.pro.b.f2740m, o());
            if (sharedPreferences != null) {
                ...
                if (!TextUtils.isEmpty(string)) {
                    ...
                    if (TextUtils.isEmpty(imprintProperty)) {
                        ...
                        jSONObject.put(com.umeng.analytics.pro.b.f2740m, sharedPreferences.getString("vers_date", format));
                    }
    ...
    private boolean t() {
        ...
        try {
            ...
            return sharedPreferences.getLong(f2821m, -1L) != 0;
        } catch (Throwable unused) {
            return false;
        }
    }
    ...
    public k() {
        ...
        try {
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(a);
            this.f2830k = sharedPreferences.getLong("thtstart", 0L);
