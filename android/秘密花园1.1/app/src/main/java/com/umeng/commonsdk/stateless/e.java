    ...
    public boolean a(byte[] bArr, String str) {
        ...
        if (bArr != null && str != null) {
            ...
            try {
                try {
                    if (c()) {
                        httpsURLConnection = (HttpsURLConnection) new URL(a.f3120g + "/" + str).openConnection(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(this.a, this.b)));
                    } else {
                        httpsURLConnection = (HttpsURLConnection) new URL(a.f3120g + "/" + str).openConnection();
                    }
                    try {
                        ...
                        if (httpsURLConnection.getResponseCode() == 200) {
                            UMRTLog.i(UMRTLog.RTLOG_TAG, "--->>> send stateless message success : " + a.f3120g + "/" + str);
                            z = true;
                        }
                        try {
                            outputStream.close();
    ...
    */
    public boolean b(byte[] r9, java.lang.String r10) {
        ...
        L7:
            ...
            java.lang.String r6 = com.umeng.commonsdk.stateless.a.f3120g     // Catch: java.lang.Throwable -> La9
        ...
        L40:
            ...
            java.lang.String r5 = com.umeng.commonsdk.stateless.a.f3120g     // Catch: java.lang.Throwable -> La9
        ...
        La9:
            ...
            r10 = r1
        Lab:
            android.content.Context r2 = r8.f3162c     // Catch: java.lang.Throwable -> Lbb
