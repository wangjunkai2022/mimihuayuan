...
public class UMConfigure {
    ...
    public static void setLatencyWindow(long j2) {
        com.umeng.commonsdk.statistics.a.f3164c = ((int) j2) * 1000;
    }
    ...
    public static void init(Context context, String str, String str2, int i2, String str3) {
        ...
        try {
            try {
                ...
                aVar.f3111f = b.a;
                aVar.f3112g = false;
                aVar.f3113h = UMFrUtils.getCurrentProcessName(applicationContext);
                aVar.f3114i = UMUtils.getAppVersionName(applicationContext);
                aVar.f3115j = UMUtils.isMainProgress(applicationContext);
