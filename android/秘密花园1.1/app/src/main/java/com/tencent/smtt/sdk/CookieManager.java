        ...
        if (this.a != null && this.a.size() != 0) {
            ...
            if (a2 != null && a2.b()) {
                ...
                while (it.hasNext()) {
                    ...
                    int i2 = next.a;
                    if (i2 == 1) {
                        setCookie(next.b, next.f2400c, next.f2401d);
                    } else if (i2 == 2) {
                        setCookie(next.b, next.f2400c);
                    }
                }
            } else {
                ...
                while (it2.hasNext()) {
                    ...
                    int i3 = next2.a;
                    if (i3 == 1) {
                        com.tencent.smtt.utils.k.a(android.webkit.CookieManager.getInstance(), "setCookie", new Class[]{String.class, String.class, android.webkit.ValueCallback.class}, next2.b, next2.f2400c, next2.f2401d);
                    } else if (i3 == 2) {
                        android.webkit.CookieManager.getInstance().setCookie(next2.b, next2.f2400c);
                    }
                }
            }
            this.a.clear();
