...
public class d {
    ...
    public static Drawable a(String str) {
        ...
        if ("x5_tbs_activity_picker_check".equals(str)) {
            return new BitmapDrawable(d(f2554c));
        }
        return null;
    }
    ...
    public static String c(String str) {
        ...
        String f2 = f.b.a.a.a.f(".", substring);
        int i2 = 0;
        while (true) {
            String[][] strArr = a;
            if (i2 >= strArr.length) {
                str2 = "*/*";
                break;
            } else if (f2.equalsIgnoreCase(strArr[i2][0])) {
                str2 = a[i2][1];
                break;
            } else {
                i2++;
