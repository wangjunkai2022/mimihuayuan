...
public class i {
    ...
    public String f2684e = String.valueOf(new Random().nextInt(89999999) + 10000000);

    /* renamed from: c  reason: collision with root package name */
    public String f2682c = this.f2684e + String.valueOf(new Random().nextInt(89999999) + 10000000);
    ...
    public String c() throws Exception {
        if (this.f2683d == null) {
            byte[] bytes = this.f2682c.getBytes();
            Cipher cipher = null;
            try {
                try {
            ...
            this.f2683d = b(cipher.doFinal(bytes));
        }
        return this.f2683d;
    }
    ...
    public byte[] a(byte[] bArr) throws Exception {
        return com.tencent.smtt.sdk.a.a.a(this.f2684e.getBytes(), bArr, 1);
    }
}
