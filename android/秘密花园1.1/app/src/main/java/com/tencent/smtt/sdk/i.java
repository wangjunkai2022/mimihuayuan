...
public class i {
    ...
    private boolean b(int i2) {
        try {
            ...
            if (a != null) {
                ...
                if (com.tencent.smtt.utils.a.a(this.f2573g, file, 0L, i2)) {
                    return true;
                }
    ...
    private void c(boolean z) {
        com.tencent.smtt.utils.q.a(this.f2573g);
        TbsDownloadConfig tbsDownloadConfig = TbsDownloadConfig.getInstance(this.f2573g);
        ...
        if (i2 == 5) {
            ...
            l.a().a(this.f2573g, new File(this.f2577k, "x5.tbs").getAbsolutePath(), tbsDownloadConfig.mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0));
    ...
    private boolean g() {
        File file = new File(com.tencent.smtt.utils.f.a(this.f2573g, 4), TbsDownloader.getOverSea(this.f2573g) ? "x5.oversea.tbs.org" : "x5.tbs.org");
        ...
        return com.tencent.smtt.utils.a.a(this.f2573g, file, 0L, i2);
    }
    ...
    public boolean m() {
        ...
        boolean z = false;
        boolean z2 = Apn.getApnType(this.f2573g) == 3;
    ...
    */
    ...
    public boolean a() {
        ...
        try {
            File file = new File(com.tencent.smtt.utils.f.a(this.f2573g, 4), "x5.tbs.decouple");
            if (file.exists()) {
            ...
            if (com.tencent.smtt.utils.a.a(this.f2573g, file, 0L, TbsDownloadConfig.getInstance(this.f2573g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_DECOUPLECOREVERSION, -1))) {
    ...
    public Bundle a(int i2, boolean z) {
        ...
        if (z) {
            f2 = l.a().f(this.f2573g, 6);
        } else {
            f2 = l.a().f(this.f2573g, 5);
        }
        ...
        String a = com.tencent.smtt.utils.f.a(this.f2573g, 7);
