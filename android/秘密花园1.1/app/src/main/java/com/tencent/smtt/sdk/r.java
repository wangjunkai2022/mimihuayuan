...
public class r {
    ...
    private int b(Context context) {
        ...
        if (this.b == null && TbsShareManager.getHostCorePathAppDefined() != null) {
            ...
            invokeStaticMethod = dexLoader2.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class, String.class, Integer.TYPE, String.class}, context, this.b, dexLoader2, this.f2598c, this.f2601f, TbsConfig.TBS_SDK_VERSIONNAME, 43697, QbSdk.a());
        }
        if (invokeStaticMethod == null) {
            c();
            d();
            DexLoader dexLoader3 = this.f2600e;
            invokeStaticMethod = dexLoader3.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class}, context, this.b, dexLoader3, this.f2598c, this.f2601f);
        }
        if (invokeStaticMethod == null) {
            i2 = -3;
        ...
        if (i2 < 0) {
            Object invokeStaticMethod2 = this.f2600e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "getLoadFailureDetails", new Class[0], new Object[0]);
            ...
            if (invokeStaticMethod2 instanceof String) {
                this.f2602g = (String) invokeStaticMethod2;
            }
        } else {
            this.f2602g = null;
        }
