...
public final class SsMediaSource extends o implements c0.b<e0<f.i.a.a.h1.v0.e.a>> {
    ...
    public f.i.a.a.h1.d0 c(e0.a aVar, e eVar, long j2) {
        d dVar = new d(this.v, this.f2339i, this.t, this.f2340j, this.f2341k, this.b.D(0, aVar, 0L), this.s, eVar);
        this.o.add(dVar);
        return dVar;
    }
    ...
    public final void o() {
        ...
        if (j3 == RecyclerView.FOREVER_NS) {
            n0Var = new n0(this.v.f5164d ? -9223372036854775807L : 0L, 0L, 0L, 0L, true, this.v.f5164d, this.p);
        } else {
    ...
    public c0.c p(f.i.a.a.l1.e0<f.i.a.a.h1.v0.e.a> e0Var, long j2, long j3, IOException iOException, int i2) {
        c0.c c2;
        f.i.a.a.l1.e0<f.i.a.a.h1.v0.e.a> e0Var2 = e0Var;
        long c3 = ((w) this.f2341k).c(4, j3, iOException, i2);
        ...
        p pVar = e0Var2.a;
        g0 g0Var = e0Var2.f5499c;
        aVar.u(pVar, g0Var.f5513c, g0Var.f5514d, e0Var2.b, j2, j3, g0Var.b, iOException, !c2.a());
        return c2;
    }
