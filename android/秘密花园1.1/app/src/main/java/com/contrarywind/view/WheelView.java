...
public class WheelView extends View {
    ...
    public ScheduledExecutorService f2288h;
    ...
    public WheelView(Context context, AttributeSet attributeSet) {
        ...
        this.f2286f = false;
        this.f2287g = true;
        this.f2288h = Executors.newSingleThreadScheduledExecutor();
        ...
        this.f2290j.setTextSize(this.o);
        ...
        this.f2291k.setTextSize(this.o);
    ...
    public final void f(float f2, float f3) {
        int i2 = this.r;
        this.f2290j.setTextSkewX((i2 > 0 ? 1 : i2 < 0 ? -1 : 0) * (f3 <= 0.0f ? 1 : -1) * 0.5f * f2);
    ...
    public void g(a aVar) {
        ...
        this.f2289i = this.f2288h.scheduleWithFixedDelay(new c(this, this.L), 0L, 10L, TimeUnit.MILLISECONDS);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (bVar == b.WRAP) {
            ...
            float f8 = this.A;
            float f9 = f6;
            canvas.drawLine(f9, f8, f7, f8, this.f2292l);
            float f10 = this.B;
            canvas.drawLine(f9, f10, f7, f10, this.f2292l);
        } else if (bVar == b.CIRCLE) {
            this.f2292l.setStyle(Paint.Style.STROKE);
            this.f2292l.setStrokeWidth(this.x);
            if (TextUtils.isEmpty(this.n)) {
            ...
            canvas.drawCircle(this.J / 2.0f, this.I / 2.0f, Math.max((this.J - f12) - f12, this.s) / 1.8f, this.f2292l);
        } else {
            float f13 = this.A;
            canvas.drawLine(0.0f, f13, this.J, f13, this.f2292l);
            float f14 = this.B;
            canvas.drawLine(0.0f, f14, this.J, f14, this.f2292l);
        }
        if (!TextUtils.isEmpty(this.n) && this.f2287g) {
            ...
            canvas.drawText(this.n, (i6 - i3) - this.S, this.C, this.f2291k);
        }
        int i8 = 0;
        while (true) {
            int i9 = this.H;
            ...
            if (this.z) {
                a2 = ((f.c.a.f.a) this.f2293m).a(c(i10));
            } else {
                a2 = (i10 >= 0 && i10 <= ((f.c.a.f.a) this.f2293m).b() + (-1)) ? ((f.c.a.f.a) this.f2293m).a(i10) : "";
            }
            canvas.save();
            double d2 = ((this.s * i8) - f4) / this.K;
            float f15 = (float) (90.0d - ((d2 / 3.141592653589793d) * 180.0d));
            if (f15 <= 90.0f && f15 >= -90.0f) {
                String b2 = (!this.f2287g && !TextUtils.isEmpty(this.n) && !TextUtils.isEmpty(b(a2))) ? b(a2) + this.n : b(a2);
                float pow = (float) Math.pow(Math.abs(f15) / 90.0f, 2.2d);
                Rect rect = new Rect();
                this.f2291k.getTextBounds(b2, i5, b2.length(), rect);
                int i11 = this.o;
                for (int width = rect.width(); width > this.J; width = rect.width()) {
                    i11--;
                    this.f2291k.setTextSize(i11);
                    this.f2291k.getTextBounds(b2, i5, b2.length(), rect);
                }
                this.f2290j.setTextSize(i11);
                Rect rect2 = new Rect();
                this.f2291k.getTextBounds(b2, i5, b2.length(), rect2);
                int i12 = this.P;
                if (i12 != 3) {
                    if (i12 == 5) {
                ...
                Rect rect3 = new Rect();
                this.f2290j.getTextBounds(b2, i2, b2.length(), rect3);
                int i13 = this.P;
                if (i13 == 3) {
                    this.R = 0;
                } else if (i13 == 5) {
                    ...
                    if (!this.f2286f && (str = this.n) != null && !str.equals("") && this.f2287g) {
                ...
                if (cos <= f16 && this.q + cos >= f16) {
                    ...
                    f(pow, f15);
                    canvas.drawText(b2, this.R, this.q, this.f2290j);
                    canvas.restore();
                    canvas.save();
                    canvas.clipRect(0.0f, this.A - cos, this.J, (int) this.s);
                    canvas.scale(1.0f, ((float) Math.sin(d2)) * 1.0f);
                    canvas.drawText(b2, this.Q, this.q - this.S, this.f2291k);
                    canvas.restore();
                } else {
                    float f17 = this.B;
                    if (cos <= f17 && this.q + cos >= f17) {
                        ...
                        if (cos >= this.A) {
                            int i14 = this.q;
                            if (i14 + cos <= this.B) {
                                canvas.drawText(b2, this.Q, i14 - this.S, this.f2291k);
                        ...
                        canvas.scale(1.0f, ((float) Math.sin(d2)) * 0.8f);
                        f(pow, f15);
                        canvas.drawText(b2, (this.r * pow) + this.R, this.q, this.f2290j);
                        canvas.restore();
                    }
                }
                canvas.restore();
