...
public class w implements Runnable {
    ...
    public final /* synthetic */ x.a.InterfaceC0101a f6313f;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            if (w.this.f6314g.H()) {
                ...
                w.this.f6314g.f6191d.realmNotifier.addTransactionCallback(new RunnableC0100a());
            } else {
                w.this.f6311d.a();
            }
        }
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            x.a.InterfaceC0101a interfaceC0101a = w.this.f6313f;
        ...
        if (b0Var != null) {
            ...
            try {
                ...
                if (!this.f6310c) {
                    ...
                    return;
                } else if (aVar != null && this.f6311d != null) {
