...
public class x extends g.a.a {
    ...
    public x(OsSharedRealm osSharedRealm) {
        super(osSharedRealm);
        this.f6317j = new l(this, new g.a.f1.b(this.b.f6204j, osSharedRealm.getSchemaInfo()));
    }
    ...
    */
    ...
    public g.a.f1.t.b O(a aVar, a.b bVar) {
        ...
        return new g.a.f1.t.b(g.a.a.f6188h.a(new w(this, this.b, aVar, a2, bVar, this.f6191d.realmNotifier, null)), g.a.a.f6188h);
    }

    public x(z zVar) {
        super(zVar, new OsSchemaInfo(zVar.f6322c.f6204j.d().values()));
        this.f6317j = new l(this, new g.a.f1.b(this.b.f6204j, this.f6191d.getSchemaInfo()));
        b0 b0Var = this.b;
        if (b0Var.f6207m) {
            g.a.f1.o oVar = b0Var.f6204j;
