...
public abstract class g0 implements e0 {
    ...
    public static <E extends e0> Observable<Object<E>> asChangesetObservable(E e2) {
        if (e2 instanceof g.a.f1.n) {
            a aVar = ((g.a.f1.n) e2).realmGet$proxyState().f6307e;
    ...
    public static <E extends e0> void deleteFromRealm(E e2) {
        if (e2 instanceof g.a.f1.n) {
            ...
            if (nVar.realmGet$proxyState().f6305c != null) {
                if (nVar.realmGet$proxyState().f6307e != null) {
                    nVar.realmGet$proxyState().f6307e.f();
                    g.a.f1.p pVar = nVar.realmGet$proxyState().f6305c;
                    Table d2 = pVar.d();
                    long l2 = pVar.l();
                    d2.a();
                    d2.nativeMoveLastOver(d2.a, l2);
                    nVar.realmGet$proxyState().f6305c = g.a.f1.g.INSTANCE;
                    return;
                }
        ...
        if (e0Var != null) {
            if (!(e0Var instanceof DynamicRealmObject)) {
                if (e0Var instanceof g.a.f1.n) {
                    a aVar = ((g.a.f1.n) e0Var).realmGet$proxyState().f6307e;
                    aVar.f();
                    if (isValid(e0Var)) {
                        return (x) aVar;
                    }
    ...
    public static <E extends e0> boolean isLoaded(E e2) {
        if (e2 instanceof g.a.f1.n) {
            g.a.f1.n nVar = (g.a.f1.n) e2;
            nVar.realmGet$proxyState().f6307e.f();
            return !(nVar.realmGet$proxyState().f6305c instanceof g.a.f1.l);
        }
        return true;
    }
    ...
    public static <E extends e0> boolean isValid(E e2) {
        ...
        g.a.f1.p pVar = ((g.a.f1.n) e2).realmGet$proxyState().f6305c;
    ...
    public static <E extends e0> void removeAllChangeListeners(E e2) {
        if (e2 instanceof g.a.f1.n) {
            ...
            g.a.f1.k<OsObject.b> kVar = realmGet$proxyState.f6309g;
            kVar.b = true;
            kVar.a.clear();
            return;
        }
    ...
    public static <E extends e0> void addChangeListener(E e2, h0<E> h0Var) {
        ...
        if (h0Var != null) {
            if (e2 instanceof g.a.f1.n) {
                ...
                v realmGet$proxyState = nVar.realmGet$proxyState();
                g.a.f1.p pVar = realmGet$proxyState.f6305c;
                if (pVar instanceof g.a.f1.l) {
