...
public class b extends m {
    ...
    public boolean C(k.a.e.h hVar) {
        return k.a.d.a.d(hVar.f7018c.b, D);
    }
    ...
    public k.a.e.h F(String str) {
        for (int size = this.f7121e.size() - 1; size >= 0; size--) {
            k.a.e.h hVar = this.f7121e.get(size);
    ...
    */
            ...
            if ("select".equals(str)) {
                ...
                if ("tr".equals(str)) {
                    ...
                    if ("caption".equals(str)) {
                        this.f7040k = c.f7051k;
                        return;
                    } else if ("colgroup".equals(str)) {
                        this.f7040k = c.f7052l;
                        return;
                    } else if ("table".equals(str)) {
                        this.f7040k = c.f7049i;
                        return;
                    } else if ("head".equals(str)) {
                        this.f7040k = c.f7047g;
                        return;
    ...
    public final void h(String... strArr) {
        ...
        while (true) {
            ...
            k.a.e.h hVar = this.f7121e.get(size);
            if (k.a.d.a.c(hVar.f7018c.b, strArr) || hVar.f7018c.b.equals("html")) {
                return;
            }
            this.f7121e.remove(size);
        }
    ...
    public void l(String str) {
        while (str != null && !a().f7018c.b.equals(str) && k.a.d.a.d(a().f7018c.b, C)) {
            E();
        }
    }
