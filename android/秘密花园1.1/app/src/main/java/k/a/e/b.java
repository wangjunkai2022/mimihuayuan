...
public class b implements Iterable<k.a.e.a>, Cloneable {
    ...
    public static final String[] f7002d = new String[0];
    public int a = 0;
    public String[] b;
    ...
    public class a implements Iterator<k.a.e.a> {
        ...
        public k.a.e.a next() {
            ...
            int i2 = this.a;
            k.a.e.a aVar = new k.a.e.a(strArr[i2], bVar.f7003c[i2], bVar);
            this.a++;
            return aVar;
        }
    ...
    public b clone() {
        try {
            ...
            this.f7003c = f(this.f7003c, this.a);
            return bVar;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.a == bVar.a && Arrays.equals(this.b, bVar.b)) {
            return Arrays.equals(this.f7003c, bVar.f7003c);
        }
        return false;
    }
    ...
    public String g(String str) {
        String str2;
        int k2 = k(str);
        return (k2 == -1 || (str2 = this.f7003c[k2]) == null) ? "" : str2;
    }

    public String h(String str) {
        String str2;
        int l2 = l(str);
        return (l2 == -1 || (str2 = this.f7003c[l2]) == null) ? "" : str2;
    }

    public int hashCode() {
        return (((this.a * 31) + Arrays.hashCode(this.b)) * 31) + Arrays.hashCode(this.f7003c);
    }
