        ...
        public boolean boundsMatch() {
            ...
            if ((i2 & 7) == 0 || (i2 & (compare(this.mChildStart, this.mRvStart) << 0)) != 0) {
                ...
                if ((i3 & 112) == 0 || (i3 & (compare(this.mChildStart, this.mRvEnd) << 4)) != 0) {
                    ...
                    if ((i4 & BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE) == 0 || (i4 & (compare(this.mChildEnd, this.mRvStart) << 8)) != 0) {
                        int i5 = this.mBoundFlags;
                        return (i5 & UMModuleRegister.SHARE_EVENT_VALUE_HIGH) == 0 || (i5 & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0;
                    }
                    return false;
                }
                return false;
