    ...
    public String toString() {
        if (this.state == 1) {
            if (this.resolvedTarget == this) {
                StringBuilder o = a.o("[");
                o.append(this.myAnchor);
                o.append(", RESOLVED: ");
                o.append(this.resolvedOffset);
                o.append("]  type: ");
                o.append(sType(this.type));
                return o.toString();
            }
            StringBuilder o2 = a.o("[");
            o2.append(this.myAnchor);
            o2.append(", RESOLVED: ");
            o2.append(this.resolvedTarget);
            o2.append(":");
            o2.append(this.resolvedOffset);
            o2.append("] type: ");
            o2.append(sType(this.type));
            return o2.toString();
        }
        StringBuilder o3 = a.o("{ ");
        o3.append(this.myAnchor);
        o3.append(" UNRESOLVED} type: ");
        o3.append(sType(this.type));
        return o3.toString();
    }
    ...
    public void resolve() {
        ...
        if (this.type == 1 && ((resolutionAnchor7 = this.target) == null || resolutionAnchor7.state == 1)) {
            ...
            if (z) {
                ...
                resolutionAnchor10.resolvedOffset = (f8 * f4) + resolutionAnchor10.target.resolvedOffset + f7;
                this.resolvedOffset = (this.target.resolvedOffset - f6) - ((1.0f - f4) * f8);
            } else {
                this.resolvedOffset = (f8 * f4) + this.target.resolvedOffset + f6;
                ResolutionAnchor resolutionAnchor11 = this.opposite;
                resolutionAnchor11.resolvedOffset = (resolutionAnchor11.target.resolvedOffset - f7) - ((1.0f - f4) * f8);
            }
            didResolve();
