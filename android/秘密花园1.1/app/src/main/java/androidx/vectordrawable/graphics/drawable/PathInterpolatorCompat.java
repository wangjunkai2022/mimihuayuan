...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            ...
            StringBuilder o = a.o("The Path must start at (0,0) and end at (1,1) start: ");
            o.append(this.mX[0]);
            o.append(",");
            o.append(this.mY[0]);
            o.append(" end:");
    ...
    private void parseInterpolatorFromTypeArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
            ...
            throw new InflateException(a.f("The path is null, which is created from ", namedString));
    ...
    public float getInterpolation(float f2) {
        ...
        float[] fArr2 = this.mY;
        float f4 = fArr2[i2];
        return a.a(fArr2[length], f4, (f2 - fArr[i2]) / f3, f4);
    }
