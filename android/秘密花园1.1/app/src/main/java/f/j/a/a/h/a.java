...
public class a extends f.j.a.a.k.b implements e {
    ...
    public TimeInterpolator f6147l;
    ...
    public a(Context context) {
        ...
        this.f6145j = 0L;
        this.f6146k = false;
        this.f6147l = new AccelerateDecelerateInterpolator();
        ...
        this.f6144i = f.j.a.a.m.b.d(4.0f);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        while (i2 < 3) {
            int i3 = i2 + 1;
            long j2 = (currentTimeMillis - this.f6145j) - (i3 * 120);
