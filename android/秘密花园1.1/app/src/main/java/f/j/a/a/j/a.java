...
public class a implements f.j.a.a.f.d, f.j.a.a.l.a, ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    public ValueAnimator.AnimatorUpdateListener e(int i2) {
        ...
        if ((i2 >= 0 || !f.j.a.a.m.b.c(view, 1)) && (i2 <= 0 || !f.j.a.a.m.b.c(this.f6158c, -1))) {
            return null;
        }
        this.f6161f = i2;
        return this;
    ...
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        try {
            float scaleY = (intValue - this.f6161f) * this.f6158c.getScaleY();
            if (this.f6158c instanceof AbsListView) {
                f.j.a.a.m.b.j((AbsListView) this.f6158c, (int) scaleY);
            } else {
