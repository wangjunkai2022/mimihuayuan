...
public class d extends WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        webResourceRequest.getRequestHeaders().put(f.e.a.e.a("T08FCxkEWEEXA1BKHgUR"), this.b.f701c);
        String uri = webResourceRequest.getUrl().toString();
        if (uri.contains(f.e.a.e.a("GBAGAwIATVYBSUAIEw8N"))) {
            f.e.a.e.a("RQcEDRgHXEEmFFg=");
            f.e.a.k.f.b();
            this.b.f703e = uri.split(f.e.a.e.a("XwMQDFY="))[1];
            if (this.b.f703e.contains(f.e.a.e.a("EQ=="))) {
                FuLao2Launch2Activity fuLao2Launch2Activity = this.b;
                fuLao2Launch2Activity.f703e = fuLao2Launch2Activity.f703e.split(f.e.a.e.a("EQ=="))[0];
            }
            this.b.f704f = uri.split(f.e.a.e.a("a10="))[1];
