...
public class c implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        u uVar;
        int h2;
        if (aVar.S().b.f6779j.contains(f.e.a.e.a("GQgQCwU="))) {
        ...
        String str = new String(f.e.a.k.c.c(j2.getBytes(), d.a.getBytes(), d.f3844c, f.b.a.a.a.l(new StringBuilder(), d.b, substring).getBytes()));
