...
public class d implements l.f<i0> {
    ...
    public d(NanaLaunchActivity nanaLaunchActivity) {
        this.a = nanaLaunchActivity;
    }

    @Override // l.f
    public void a(l.d<i0> dVar, g0<i0> g0Var) {
        NanaLaunchActivity.l(this.a, g0Var, f.e.a.e.a("XxYXFBhJFhwDEVUJVhoTD14MBEoFFk0cBVcbARkZFwdYBQoK"));
    }

    @Override // l.f
    public void b(l.d<i0> dVar, Throwable th) {
        c.a.a.b.g.h.n1(f.e.a.e.a("3+zUgeTl3737gKnknc7Sg4PHjNjnm5aEmuG5j9f/"));
    }
}
