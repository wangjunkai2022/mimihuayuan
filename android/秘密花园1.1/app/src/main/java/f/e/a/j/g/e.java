...
public class e extends j<StarWork> {
    ...
    public final /* synthetic */ MovieDetailActivity f3865e;

    public e(MovieDetailActivity movieDetailActivity) {
        this.f3865e = movieDetailActivity;
    }
    ...
    public void f(StarWork starWork) {
        ...
        if (starWork2.getData().size() != 0) {
            MovieDetailActivity movieDetailActivity = this.f3865e;
        ...
        this.f3865e.rlStar.setVisibility(8);
    }
}
