...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3846g = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    ...
    public d.a<? super InputStream> f3849e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3850f;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3848d = h0Var.f6452h;
        if (h0Var.g()) {
            i0 i0Var = this.f3848d;
            h.s(i0Var, "Argument must not be null");
            f.d.a.u.b bVar = new f.d.a.u.b(this.f3848d.d(), i0Var.g());
            this.f3847c = bVar;
            this.f3849e.d(f.e.a.j.d0.d.d.b(bVar));
            return;
        }
        this.f3849e.c(new f.d.a.o.e(h0Var.f6448d, h0Var.f6449e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3846g, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3849e.c(iOException);
    }
