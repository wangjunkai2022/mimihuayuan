...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3878h = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    ...
    public volatile f f3882f;

    /* renamed from: g  reason: collision with root package name */
    public ByteArrayOutputStream f3883g = null;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3880d = h0Var.f6452h;
        if (h0Var.g()) {
            i0 i0Var = this.f3880d;
            h.s(i0Var, "Argument must not be null");
            InputStream bVar = new f.d.a.u.b(this.f3880d.d(), i0Var.g());
            this.f3879c = bVar;
            d.a<? super InputStream> aVar = this.f3881e;
            try {
        ...
        this.f3881e.c(new f.d.a.o.e(h0Var.f6448d, h0Var.f6449e));
    }
