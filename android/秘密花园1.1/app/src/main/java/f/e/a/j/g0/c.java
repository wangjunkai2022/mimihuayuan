...
public class c implements l.f<i0> {
    ...
    public c(NanaLaunchActivity nanaLaunchActivity) {
        this.a = nanaLaunchActivity;
    }

    @Override // l.f
    public void a(l.d<i0> dVar, g0<i0> g0Var) {
        NanaLaunchActivity.l(this.a, g0Var, f.e.a.e.a("XxYXFBhJFhwDEVUfVgIaE0cDGkoIHFQcBVcbARkZFwdYBQoK"));
    }

    @Override // l.f
    public void b(l.d<i0> dVar, Throwable th) {
        NanaLaunchActivity.m(this.a);
    }
}
