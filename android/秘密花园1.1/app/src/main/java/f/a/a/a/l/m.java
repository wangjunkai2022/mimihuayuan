    ...
    public void v(RecyclerView.Recycler recycler, RecyclerView.State state, VirtualLayoutManager.f fVar, h hVar, f.a.a.a.c cVar) {
        ...
        if (cVar.getOrientation() == 1) {
            if (virtualLayoutManager.isLayoutRTL()) {
                d2 = (virtualLayoutManager.j() - cVar.getPaddingRight()) - this.f3322h;
                paddingLeft = d2 - iVar.d(view2);
            } else {
                paddingLeft = this.f3321g + cVar.getPaddingLeft();
            ...
            if (cVar4.f67h == -1) {
                ...
                g2 = ((iVar.g() - this.f3324j) - this.s) - this.p.f3313d;
                i8 = g2 - hVar.a;
            }
            if (!cVar.getReverseLayout() && this.r) {
                if ((i9 < this.s + this.p.b && fVar.a.f66g == -1) || i8 < this.f3323i + this.s + this.p.b) {
                    this.u = false;
                    this.t = view2;
                    int i12 = iVar.i() + this.f3323i + this.s + this.p.b;
                    i7 = i12;
                    i4 = d2;
                    i6 = paddingLeft;
                    i5 = hVar.a + i12;
                ...
                if ((i9 < this.s + this.p.f3313d && fVar.a.f66g == 1) || g2 > this.f3324j + this.s + this.p.f3313d) {
                    this.u = false;
                    this.t = view2;
                    int g3 = ((iVar.g() - this.f3324j) - this.s) - this.p.f3313d;
                    i7 = g3 - hVar.a;
                    i4 = d2;
                    i6 = paddingLeft;
                    i5 = g3;
            ...
            int d3 = iVar.d(view2) + paddingTop + this.f3323i;
            ...
            if (!cVar.getReverseLayout() && this.r) {
                ...
                if (i9 < this.s + this.p.f3312c) {
                    this.u = false;
                    this.t = view2;
                    int g4 = (iVar.g() - this.s) - this.p.f3312c;
                    i4 = g4;
                    i5 = d3;
                    i6 = g4 - hVar.a;
                    i7 = paddingTop;
