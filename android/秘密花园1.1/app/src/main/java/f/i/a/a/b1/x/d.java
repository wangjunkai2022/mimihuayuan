    ...
    public void c(f.i.a.a.m1.u uVar) {
        ...
        while (uVar.a() > 0) {
            ...
            if (i2 == 0) {
                ...
                uVar.b += min;
                int i3 = this.f4336g + min;
                this.f4336g = i3;
                if (i3 == 16) {
                    this.a.j(0);
                    h.b b = f.i.a.a.w0.h.b(this.a);
                    f.i.a.a.b0 b0Var = this.f4340k;
                    if (b0Var == null || b.b != b0Var.v || b.a != b0Var.w || !"audio/ac4".equals(b0Var.f4013i)) {
                        f.i.a.a.b0 j2 = f.i.a.a.b0.j(this.f4333d, "audio/ac4", null, -1, -1, b.b, b.a, null, null, 0, this.f4332c);
                        this.f4340k = j2;
                        this.f4334e.d(j2);
                    }
                    this.f4341l = b.f5863c;
                    this.f4339j = (b.f5864d * 1000000) / this.f4340k.w;
                    this.b.A(0);
                ...
                int i4 = this.f4336g + min2;
                this.f4336g = i4;
                int i5 = this.f4341l;
                if (i4 == i5) {
                    this.f4334e.c(this.f4342m, 1, i5, 0, null);
