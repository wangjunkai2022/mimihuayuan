        ...
        while (true) {
            ...
            if (i3 < i4) {
                ...
                if (iArr[i3] == 1) {
                    ...
                    sb.append(String.format(Locale.US, this.f5000c[i3], Long.valueOf(j2)));
                } else if (iArr[i3] == 3) {
                    sb.append(String.format(Locale.US, this.f5000c[i3], Integer.valueOf(i2)));
                } else if (iArr[i3] == 4) {
                    sb.append(String.format(Locale.US, this.f5000c[i3], Long.valueOf(j3)));
                }
                i3++;
            } else {
                sb.append(this.a[i4]);
