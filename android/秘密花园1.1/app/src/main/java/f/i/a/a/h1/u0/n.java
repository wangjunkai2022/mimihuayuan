...
public final class n implements c0.b<f.i.a.a.h1.s0.d>, c0.f, l0, f.i.a.a.b1.h, j0.b {
    ...
    public final f.i.a.a.l1.e f5060d;
    ...
    public final Runnable f5068l;

    /* renamed from: m  reason: collision with root package name */
    public final Runnable f5069m;
    ...
    public n(int i2, a aVar, g gVar, Map<String, f.i.a.a.z0.e> map, f.i.a.a.l1.e eVar, long j2, b0 b0Var, f.i.a.a.l1.b0 b0Var2, f0.a aVar2) {
        ...
        this.f5068l = new Runnable() { // from class: f.i.a.a.h1.u0.c
            @Override // java.lang.Runnable
            public final void run() {
                n.this.A();
            }
        };
        this.f5069m = new Runnable() { // from class: f.i.a.a.h1.u0.b
            @Override // java.lang.Runnable
            public final void run() {
                n.this.C();
            }
    ...
    public static b0 v(b0 b0Var, b0 b0Var2, boolean z) {
        ...
        String y = h0.y(b0Var.f4010f, f.i.a.a.m1.r.f(b0Var2.f4013i));
        ...
        return new b0(str2, str3, i7, b0Var2.f4008d, i2, y, aVar, b0Var2.f4012h, str, b0Var2.f4014j, b0Var2.f4015k, b0Var2.f4016l, b0Var2.f4017m, i5, i6, b0Var2.p, b0Var2.q, b0Var2.r, b0Var2.t, b0Var2.s, b0Var2.u, i4, b0Var2.w, b0Var2.x, b0Var2.y, b0Var2.z, str4, b0Var2.B);
    }
        ...
        if (!this.D && this.G == null && this.y) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                ...
                if (i11 == i7) {
                    ...
                    o0VarArr[i11] = new o0(v((i6 == 2 && f.i.a.a.m1.r.h(n2.f4013i)) ? this.f5061e : null, n2, false));
                }
            }
    ...
    public void B() throws IOException {
        ...
        if (iOException == null) {
            ...
            ((f.i.a.a.h1.u0.t.c) gVar.f5032g).f(uri);
            return;
        }
        throw iOException;
    }
    ...
    public long e() {
        ...
        k w = w();
        if (!w.G) {
            w = this.f5066j.size() > 1 ? this.f5066j.get(arrayList.size() - 2) : null;
        }
        if (w != null) {
    ...
    public boolean f(long j2) {
        ...
        if (z()) {
            ...
            if (w.G) {
                ...
                max = Math.max(this.L, w.f4870f);
            }
        }
        List<k> list2 = list;
        long j5 = max;
        g gVar = this.f5059c;
        g.c cVar2 = this.f5065i;
        if (gVar != null) {
            k kVar = list2.isEmpty() ? null : list2.get(list2.size() - 1);
            int a2 = kVar == null ? -1 : gVar.f5033h.a(kVar.f4867c);
            long j6 = j5 - j2;
            ...
            if (kVar == null || gVar.o) {
                ...
                cVar = cVar2;
                long j8 = kVar.f4871g - kVar.f4870f;
            ...
            int i4 = gVar.p.i();
            boolean z = i3 != i4;
            Uri uri2 = gVar.f5030e[i4];
            if (!((f.i.a.a.h1.u0.t.c) gVar.f5032g).e(uri2)) {
                cVar.f5040c = uri2;
                ...
                g.c cVar3 = cVar;
                f.i.a.a.h1.u0.t.f d2 = ((f.i.a.a.h1.u0.t.c) gVar.f5032g).d(uri2, true);
                gVar.o = d2.f5133c;
                gVar.q = d2.f5122l ? j3 : (d2.f5116f + d2.p) - ((f.i.a.a.h1.u0.t.c) gVar.f5032g).p;
                long j9 = d2.f5116f - ((f.i.a.a.h1.u0.t.c) gVar.f5032g).p;
                r8 = 0;
                r8 = 0;
                r8 = 0;
                r8 = 0;
                ...
                if (b2 >= d2.f5119i || kVar2 == null || !z) {
                    j4 = j9;
                    uri = uri2;
                    i2 = i4;
                } else {
                    Uri uri3 = gVar.f5030e[i3];
                    d2 = ((f.i.a.a.h1.u0.t.c) gVar.f5032g).d(uri3, true);
                    long j10 = d2.f5116f - ((f.i.a.a.h1.u0.t.c) gVar.f5032g).p;
                    b2 = kVar2.c();
                    uri = uri3;
                    i2 = i3;
                    j4 = j10;
                ...
                if (b2 < j11) {
                    ...
                    if (i5 >= d2.o.size()) {
                        ...
                        f.a aVar2 = aVar.b;
                        Uri e1 = (aVar2 == null || (str = aVar2.f5128g) == null) ? null : c.a.a.b.g.h.e1(d2.a, str);
                        ...
                        if (c2 == null) {
                            ...
                            cVar3.a = c3;
                            if (c3 == null) {
                                cVar3.a = k.e(gVar.a, gVar.b, gVar.f5031f[i2], j4, d2, i5, uri, gVar.f5034i, gVar.p.l(), gVar.p.p(), gVar.f5036k, gVar.f5029d, kVar2, gVar.f5035j.get(e12), gVar.f5035j.get(e1));
                            }
                        }
                    }
                }
            }
            g.c cVar4 = this.f5065i;
            boolean z2 = cVar4.b;
            f.i.a.a.h1.s0.d dVar = cVar4.a;
            Uri uri4 = cVar4.f5040c;
            cVar4.a = r8;
            cVar4.b = false;
            cVar4.f5040c = r8;
            if (z2) {
                ...
                if (uri4 != null) {
                    ((f.i.a.a.h1.u0.t.c) ((l) this.b).b).f5081d.get(uri4).b();
                    return false;
                }
                return false;
            } else {
                if (dVar instanceof k) {
                    ...
                    k kVar3 = (k) dVar;
                    kVar3.C = this;
                    this.f5066j.add(kVar3);
                    this.B = kVar3.f4867c;
                }
                this.f5064h.w(dVar.a, dVar.b, this.a, dVar.f4867c, dVar.f4868d, dVar.f4869e, dVar.f4870f, dVar.f4871g, this.f5063g.g(dVar, this, ((w) this.f5062f).b(dVar.b)));
                return true;
            }
        }
        throw null;
    ...
    public c0.c p(f.i.a.a.h1.s0.d dVar, long j2, long j3, IOException iOException, int i2) {
        ...
        if (z) {
            ...
            long c3 = ((w) this.f5062f).c(dVar2.b, j3, iOException, i2);
            c2 = c3 != -9223372036854775807L ? c0.c(false, c3) : c0.f5489e;
        }
        f0.a aVar = this.f5064h;
        f.i.a.a.l1.p pVar = dVar2.a;
        g0 g0Var = dVar2.f4872h;
        aVar.t(pVar, g0Var.f5513c, g0Var.f5514d, dVar2.b, this.a, dVar2.f4867c, dVar2.f4868d, dVar2.f4869e, dVar2.f4870f, dVar2.f4871g, j2, j3, j4, iOException, !c2.a());
        if (z) {
            if (!this.z) {
                f(this.L);
            } else {
