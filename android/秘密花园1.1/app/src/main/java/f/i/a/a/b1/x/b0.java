...
public final class b0 implements f.i.a.a.b1.g {
    ...
    public final f.i.a.a.m1.u f4310c;
    ...
    public b0(int i2, e0 e0Var, c0.c cVar) {
        ...
        this.f4310c = new f.i.a.a.m1.u(new byte[9400], 0);
    ...
    public int c(f.i.a.a.b1.d dVar, f.i.a.a.b1.m mVar) throws IOException, InterruptedException {
        ...
        if (this.f4320m) {
            if ((j4 == -1 || this.a == 2) ? false : true) {
                ...
                if (!a0Var.f4294c) {
                    ...
                    if (!a0Var.f4296e) {
                    ...
                    } else if (a0Var.f4298g == -9223372036854775807L) {
                        a0Var.a(dVar);
                        return 0;
                    } else if (!a0Var.f4295d) {
                        int min2 = (int) Math.min(112800L, dVar.f4041c);
                        long j7 = 0;
                        if (dVar.f4042d != j7) {
                            mVar.a = j7;
                        } else {
                        ...
                        long j8 = a0Var.f4297f;
                        if (j8 == -9223372036854775807L) {
                            a0Var.a(dVar);
                            return 0;
                        }
                        a0Var.f4299h = a0Var.a.b(a0Var.f4298g) - a0Var.a.b(j8);
                        a0Var.a(dVar);
                        return 0;
                    }
                    return 1;
            ...
            if (this.n) {
                ...
                this.n = true;
                a0 a0Var2 = this.f4316i;
                long j9 = a0Var2.f4299h;
                if (j9 != -9223372036854775807L) {
                    z2 = false;
                    z zVar = new z(a0Var2.a, j9, j4, this.r);
                    this.f4317j = zVar;
                    this.f4318k.a(zVar.a);
                } else {
                    z2 = false;
                    this.f4318k.a(new n.b(j9, 0L));
                }
            }
            if (this.o) {
                this.o = z2;
            ...
            z zVar2 = this.f4317j;
            if (zVar2 != null) {
                if (zVar2.f4018c != null) {
                    return this.f4317j.a(dVar, mVar, null);
                }
            }
            c0Var = null;
            r12 = z2;
        ...
        f.i.a.a.m1.u uVar3 = this.f4310c;
        byte[] bArr = uVar3.a;
        if (9400 - uVar3.b < 188) {
            int a2 = uVar3.a();
            if (a2 > 0) {
                System.arraycopy(bArr, this.f4310c.b, bArr, r12, a2);
            }
            this.f4310c.y(bArr, a2);
        }
        while (true) {
            if (this.f4310c.a() >= 188) {
                i2 = -1;
                z = true;
                break;
            }
            int i9 = this.f4310c.f5701c;
        ...
        if (z) {
            f.i.a.a.m1.u uVar4 = this.f4310c;
            int i10 = uVar4.b;
            int i11 = uVar4.f5701c;
            byte[] bArr2 = uVar4.a;
            int i12 = i10;
            ...
            f.i.a.a.m1.u uVar5 = this.f4310c;
            int i15 = uVar5.f5701c;
            if (i13 > i15) {
                return r12;
            }
            int d2 = uVar5.d();
            ...
            if (this.a != i3) {
                int i18 = d2 & 15;
                int i19 = this.f4311d.get(i17, i18 - 1);
                this.f4311d.put(i17, i18);
                if (i19 == i18) {
                    this.f4310c.A(i13);
                    return r12;
            ...
            if (z3) {
                int p = this.f4310c.p();
                i16 |= (this.f4310c.p() & 64) != 0 ? 2 : 0;
                this.f4310c.B(p - 1);
            }
            boolean z4 = this.f4320m;
            if (this.a == i3 || z4 || !this.f4315h.get(i17, r12)) {
                this.f4310c.z(i13);
                c0Var.c(this.f4310c, i16);
                this.f4310c.z(i15);
            }
            if (this.a != i3 && !z4 && this.f4320m && j4 != -1) {
                this.o = true;
            }
            this.f4310c.A(i13);
            return r12;
