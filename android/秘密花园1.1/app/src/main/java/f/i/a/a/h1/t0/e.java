...
public final class e implements d0, l0.a<f.i.a.a.h1.s0.g<c>>, g.b<c> {
    ...
    public final IdentityHashMap<f.i.a.a.h1.s0.g<c>, j.c> f4915l = new IdentityHashMap<>();
    ...
    public e(int i2, f.i.a.a.h1.t0.k.b bVar, int i3, c.a aVar, @Nullable i0 i0Var, b0 b0Var, f0.a aVar2, long j2, f.i.a.a.l1.d0 d0Var, f.i.a.a.l1.e eVar, v vVar, j.b bVar2) {
        ...
        if (vVar != null) {
            ...
            f.i.a.a.h1.t0.k.f fVar = bVar.f4965l.get(i3);
            ...
            for (int i9 = 0; i9 < size; i9++) {
                if (!zArr[i9]) {
                    zArr[i9] = true;
                    List<f.i.a.a.h1.t0.k.d> list4 = list3.get(i9).f4955e;
                    int i10 = 0;
                    while (true) {
                        if (i10 >= list4.size()) {
                            dVar = null;
            ...
            for (int i14 = 0; i14 < length2; i14++) {
                ...
                while (true) {
                    ...
                    List<f.i.a.a.h1.t0.k.i> list5 = list3.get(iArr4[i15]).f4953c;
                ...
                while (true) {
                    ...
                    List<f.i.a.a.h1.t0.k.d> list6 = list3.get(i18).f4954d;
                    int i19 = 0;
            ...
            while (i23 < length2) {
                ...
                int i24 = 0;
                while (i24 < length5) {
                    arrayList.addAll(list3.get(iArr7[i24]).f4953c);
                    i24++;
                    length2 = length2;
                }
                int i25 = length2;
        ...
        while (i9 < jVarArr2.length) {
            ...
            if (jVar == null) {
                ...
                if (i10 == 0) {
                    ...
                    i3 = i9;
                    iArr2 = iArr3;
                    f.i.a.a.h1.s0.g<c> gVar = new f.i.a.a.h1.s0.g<>(aVar.b, iArr4, b0VarArr, this.b.a(this.f4909f, this.r, this.s, aVar.a, jVar, aVar.b, this.f4908e, z2, arrayList, cVar2, this.f4906c), this, this.f4910g, j2, this.f4907d, this.f4916m);
                    synchronized (this) {
                        this.f4915l.put(gVar, cVar2);
                    }
                    k0VarArr[i3] = gVar;
                } else {
                    i3 = i9;
                ...
                if (k0VarArr[i3] instanceof f.i.a.a.h1.s0.g) {
                    ((c) ((f.i.a.a.h1.s0.g) k0VarArr[i3]).f4887e).c(jVar);
                }
            }
            i9 = i3 + 1;
            jVarArr2 = jVarArr;
                ...
                if (aVar2.f4917c == 1) {
                    ...
                    if (d3 == -1) {
                        ...
                        for (int i14 = 0; i14 < gVar2.n.length; i14++) {
                            if (gVar2.b[i14] == i13) {
                                c.a.a.b.g.h.v(!gVar2.f4886d[i14]);
