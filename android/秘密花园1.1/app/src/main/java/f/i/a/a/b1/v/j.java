...
public final class j extends h {
    ...
    public void c(long j2) {
        ...
        this.p = j2 != 0;
        m mVar = this.q;
        this.o = mVar != null ? mVar.f4281d : 0;
    }
    ...
    public boolean e(u uVar, long j2, h.b bVar) throws IOException, InterruptedException {
        ...
        if (this.q == null) {
            ...
            int f4 = uVar.f();
            int p2 = uVar.p();
            this.q = new m(g2, p, g3, f2, f3, f4, (int) Math.pow(2.0d, p2 & 15), (int) Math.pow(2.0d, (p2 & TbsListener.ErrorCode.TPATCH_VERSION_FAILED) >> 4), (uVar.p() & 1) > 0, Arrays.copyOf(uVar.a, uVar.f5701c));
        } else if (this.r == null) {
