    ...
    public static void a(String str, a aVar, SpannableStringBuilder spannableStringBuilder, List<d> list, List<b> list2) {
        ...
        while (i6 < size2) {
            ...
            if (dVar.a.isEmpty() && dVar.b.isEmpty() && dVar.f5358c.isEmpty() && dVar.f5359d.isEmpty()) {
                ...
                int b2 = d.b(d.b(d.b(i5, dVar.a, str, 1073741824), dVar.b, str3, 2), dVar.f5359d, str4, 4);
                size = (b2 == -1 || !Arrays.asList(strArr).containsAll(dVar.f5358c)) ? 0 : b2 + (dVar.f5358c.size() * 4);
            }
            if (size > 0) {
        ...
        for (int i7 = 0; i7 < size3; i7++) {
            ...
            if (dVar2 != null) {
                ...
                if (dVar2.f5362g) {
                    if (dVar2.f5362g) {
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(dVar2.f5361f), i4, length, i2);
                    } else {
                ...
                if (dVar2.f5364i) {
                    if (dVar2.f5364i) {
                        spannableStringBuilder.setSpan(new BackgroundColorSpan(dVar2.f5363h), i4, length, 33);
                    } else {
                ...
                if (dVar2.f5360e != null) {
                    i3 = 33;
                    spannableStringBuilder.setSpan(new TypefaceSpan(dVar2.f5360e), i4, length, 33);
                } else {
                    i3 = 33;
                }
                if (dVar2.o != null) {
