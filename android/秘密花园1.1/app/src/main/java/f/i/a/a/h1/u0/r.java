...
public final class r implements f.i.a.a.b1.g {
    ...
    public final f.i.a.a.b1.p b(long j2) {
        f.i.a.a.b1.p q = this.f5077d.q(0, 3);
    ...
    public int c(f.i.a.a.b1.d dVar, f.i.a.a.b1.m mVar) throws IOException, InterruptedException {
        Matcher matcher;
        String e2;
        int i2 = (int) dVar.f4041c;
        int i3 = this.f5079f;
        byte[] bArr = this.f5078e;
        if (i3 == bArr.length) {
            this.f5078e = Arrays.copyOf(bArr, ((i2 != -1 ? i2 : bArr.length) * 3) / 2);
        }
        byte[] bArr2 = this.f5078e;
        int i4 = this.f5079f;
        int e3 = dVar.e(bArr2, i4, bArr2.length - i4);
        if (e3 != -1) {
            int i5 = this.f5079f + e3;
            this.f5079f = i5;
            if (i2 == -1 || i5 != i2) {
                return 0;
            }
        }
        u uVar = new u(this.f5078e);
        ...
        while (true) {
            ...
            if (TextUtils.isEmpty(e4)) {
                ...
                if (matcher == null) {
                    ...
                    this.f5076c.y(this.f5078e, this.f5079f);
                    b2.a(this.f5076c, this.f5079f);
                    b2.c(b, 1, this.f5079f, 0, null);
                }
                return -1;
            } else if (e4.startsWith("X-TIMESTAMP-MAP")) {
                Matcher matcher2 = f5074g.matcher(e4);
                if (matcher2.find()) {
                    Matcher matcher3 = f5075h.matcher(e4);
                    if (matcher3.find()) {
