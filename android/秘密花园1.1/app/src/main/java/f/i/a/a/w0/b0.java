...
public final class b0 extends t {
            ...
            if (i2 == 0) {
                ...
                if (n < limit3 && position2 < i5) {
                    ...
                    if (i6 == bArr2.length) {
                        if (this.o) {
                            o(bArr2, this.n);
                            this.p += (this.f5826m - (this.n * 2)) / this.f5821h;
                        } else {
                            this.p += (i6 - this.n) / this.f5821h;
                        }
                ...
                int n2 = n(byteBuffer);
                byteBuffer.limit(n2);
                this.p += byteBuffer.remaining() / this.f5821h;
    ...
    public void i() {
        if (isActive()) {
            int i2 = ((int) ((this.b * 150000) / 1000000)) * this.f5821h;
            if (this.f5823j.length != i2) {
                this.f5823j = new byte[i2];
            }
            int i3 = ((int) ((this.b * 20000) / 1000000)) * this.f5821h;
            this.n = i3;
