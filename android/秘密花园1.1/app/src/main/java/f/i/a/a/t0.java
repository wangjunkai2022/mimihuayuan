...
public class t0 extends o implements l0, l0.d, l0.c {
    ...
    public final CopyOnWriteArraySet<f.i.a.a.n1.q> f5785f;

    /* renamed from: g  reason: collision with root package name */
    public final CopyOnWriteArraySet<f.i.a.a.w0.l> f5786g;

    /* renamed from: h  reason: collision with root package name */
    public final CopyOnWriteArraySet<f.i.a.a.i1.k> f5787h;

    /* renamed from: i  reason: collision with root package name */
    public final CopyOnWriteArraySet<f.i.a.a.d1.e> f5788i;

    /* renamed from: j  reason: collision with root package name */
    public final CopyOnWriteArraySet<f.i.a.a.n1.s> f5789j;

    /* renamed from: k  reason: collision with root package name */
    public final CopyOnWriteArraySet<f.i.a.a.w0.o> f5790k;

    /* renamed from: l  reason: collision with root package name */
    public final f.i.a.a.l1.g f5791l;
    ...
    public final class b implements f.i.a.a.n1.s, f.i.a.a.w0.o, f.i.a.a.i1.k, f.i.a.a.d1.e, SurfaceHolder.Callback, TextureView.SurfaceTextureListener, k.c, l0.b {
        ...
        public void a(int i2, int i3, int i4, float f2) {
            Iterator<f.i.a.a.n1.q> it = t0.this.f5785f.iterator();
            while (it.hasNext()) {
            ...
            Iterator<f.i.a.a.n1.s> it2 = t0.this.f5789j.iterator();
            while (it2.hasNext()) {
        ...
        public void c(int i2) {
            ...
            t0Var.y = i2;
            Iterator<f.i.a.a.w0.l> it = t0Var.f5786g.iterator();
            while (it.hasNext()) {
            ...
            Iterator<f.i.a.a.w0.o> it2 = t0.this.f5790k.iterator();
            while (it2.hasNext()) {
                it2.next().c(i2);
            }
        }
        ...
        public void d(f.i.a.a.y0.d dVar) {
            Iterator<f.i.a.a.w0.o> it = t0.this.f5790k.iterator();
            while (it.hasNext()) {
                it.next().d(dVar);
            }
            t0 t0Var = t0.this;
        ...
        public void g(f.i.a.a.y0.d dVar) {
            t0 t0Var = t0.this;
            t0Var.x = dVar;
            Iterator<f.i.a.a.w0.o> it = t0Var.f5790k.iterator();
            while (it.hasNext()) {
                it.next().g(dVar);
            }
        }
        ...
        public void h(String str, long j2, long j3) {
            Iterator<f.i.a.a.n1.s> it = t0.this.f5789j.iterator();
            while (it.hasNext()) {
                it.next().h(str, j2, j3);
            }
        }
        ...
        public void j(b0 b0Var) {
            t0 t0Var = t0.this;
            t0Var.o = b0Var;
            Iterator<f.i.a.a.n1.s> it = t0Var.f5789j.iterator();
            while (it.hasNext()) {
                it.next().j(b0Var);
            }
        }
        ...
        public void r(Surface surface) {
            t0 t0Var = t0.this;
            if (t0Var.q == surface) {
                Iterator<f.i.a.a.n1.q> it = t0Var.f5785f.iterator();
                while (it.hasNext()) {
                    it.next().b();
                }
            }
        ...
        public void v(f.i.a.a.d1.a aVar) {
            Iterator<f.i.a.a.d1.e> it = t0.this.f5788i.iterator();
            while (it.hasNext()) {
                it.next().v(aVar);
            }
        }
    ...
    public t0(Context context, r0 r0Var, f.i.a.a.j1.m mVar, t tVar, @Nullable f.i.a.a.z0.g<f.i.a.a.z0.j> gVar, f.i.a.a.l1.g gVar2, a.C0089a c0089a, Looper looper) {
        ...
        this.f5791l = gVar2;
        this.f5784e = new b(null);
        this.f5785f = new CopyOnWriteArraySet<>();
        this.f5786g = new CopyOnWriteArraySet<>();
        this.f5787h = new CopyOnWriteArraySet<>();
        this.f5788i = new CopyOnWriteArraySet<>();
        this.f5789j = new CopyOnWriteArraySet<>();
        this.f5790k = new CopyOnWriteArraySet<>();
        ...
        if (c0089a != null) {
            ...
            this.n = new f.i.a.a.w0.k(context, this.f5784e);
            return;
        }
        throw null;
    }
    ...
    public final void E(int i2, int i3) {
        ...
        this.u = i2;
        this.v = i3;
        Iterator<f.i.a.a.n1.q> it = this.f5785f.iterator();
        while (it.hasNext()) {
            it.next().u(i2, i3);
        }
    }
