...
public class b implements e0.a<f.i.a.a.h1.v0.e.a> {
    ...
    public static class e extends a {
        ...
        public a.C0077a f5195m;

        public e(a aVar, String str) {
            super(null, str, "SmoothStreamingMedia");
            this.f5193k = -1;
            this.f5195m = null;
            this.f5187e = new LinkedList();
        }
        ...
        public Object b() {
            ...
            return new f.i.a.a.h1.v0.e.a(this.f5188f, this.f5189g, this.f5190h, this.f5191i, this.f5192j, this.f5193k, this.f5194l, this.f5195m, bVarArr);
        }
        ...
        public void k(XmlPullParser xmlPullParser) throws h0 {
            ...
            this.f5190h = h(xmlPullParser, "TimeScale", 10000000L);
            String attributeValue = xmlPullParser.getAttributeValue(null, "Duration");
            if (attributeValue != null) {
                try {
                    this.f5191i = Long.parseLong(attributeValue);
                    this.f5192j = h(xmlPullParser, "DVRWindowLength", 0L);
                    this.f5193k = g(xmlPullParser, "LookaheadCount", -1);
                    String attributeValue2 = xmlPullParser.getAttributeValue(null, "IsLive");
                    this.f5194l = attributeValue2 != null ? Boolean.parseBoolean(attributeValue2) : false;
