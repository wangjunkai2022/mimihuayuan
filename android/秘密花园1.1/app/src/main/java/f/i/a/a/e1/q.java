...
public final class q {
    ...
    public static final class e implements e0.b, d0.a, Handler.Callback {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final ArrayList<f.i.a.a.h1.d0> f4653d = new ArrayList<>();

        /* renamed from: e  reason: collision with root package name */
        public final Handler f4654e = h0.s(new Handler.Callback() { // from class: f.i.a.a.e1.h
        ...
        public final boolean a(Message message) {
            ...
            c.a.a.b.g.h.t(qVar2.f4649k);
            c.a.a.b.g.h.t(qVar2.f4649k.f4659j);
            c.a.a.b.g.h.t(qVar2.f4649k.f4658i);
            int length = qVar2.f4649k.f4659j.length;
            int length2 = qVar2.f4644f.length;
            ...
            qVar2.f4650l = new p0[length];
            qVar2.f4651m = new f.a[length];
            for (int i5 = 0; i5 < length; i5++) {
                qVar2.f4650l[i5] = qVar2.f4649k.f4659j[i5].o();
                f.i.a.a.j1.n g2 = qVar2.g(i5);
                f.i.a.a.j1.d dVar = qVar2.f4643e;
                Object obj2 = g2.f5453d;
                if (dVar != null) {
                    f.a aVar = (f.a) obj2;
                    dVar.f5440c = aVar;
                    f.a[] aVarArr = qVar2.f4651m;
                    c.a.a.b.g.h.t(aVar);
                    aVarArr[i5] = aVar;
                } else {
                    throw null;
        ...
        public void f(e0 e0Var, u0 u0Var, @Nullable Object obj) {
            ...
            this.f4658i = u0Var;
            this.f4657h = obj;
            this.f4659j = new f.i.a.a.h1.d0[u0Var.i()];
            int i2 = 0;
            while (true) {
                ...
                f.i.a.a.h1.d0 c2 = this.a.c(new e0.a(u0Var.m(i2)), this.f4652c, 0L);
                this.f4659j[i2] = c2;
                this.f4653d.add(c2);
                i2++;
            }
        ...
        public boolean handleMessage(Message message) {
            ...
            if (i2 == 1) {
                try {
                    ...
                    this.f4656g.sendEmptyMessageDelayed(1, 100L);
                ...
                f.i.a.a.h1.d0[] d0VarArr = this.f4659j;
                if (d0VarArr != null) {
    ...
    public final f.i.a.a.j1.n g(int i2) {
        boolean z;
        try {
            f.i.a.a.j1.n a2 = this.f4643e.a(this.f4644f, this.f4650l[i2], new e0.a(this.f4649k.f4658i.m(i2)), this.f4649k.f4658i);
            for (int i3 = 0; i3 < a2.a; i3++) {
                f.i.a.a.j1.j jVar = a2.f5452c.b[i3];
                if (jVar != null) {
