...
public final class p {
    ...
    public p d(long j2, long j3) {
        return (j2 == 0 && this.f5606f == j3) ? this : new p(this.a, this.b, this.f5603c, this.f5604d + j2, this.f5605e + j2, j3, this.f5607g, this.f5608h);
    }
    ...
    public String toString() {
        ...
        o.append(", ");
        return f.b.a.a.a.k(o, this.f5608h, "]");
    }
    ...
    public p(Uri uri, int i2, @Nullable byte[] bArr, long j2, long j3, long j4, @Nullable String str, int i3) {
        ...
        this.a = uri;
        this.b = i2;
        this.f5603c = (bArr2 == null || bArr2.length == 0) ? null : null;
        this.f5604d = j2;
        this.f5605e = j3;
        this.f5606f = j4;
        this.f5607g = str;
