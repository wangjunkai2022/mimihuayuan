...
public final class f implements d.a {
    ...
    public long b(long j2) {
        ...
        h.t(jArr);
        double d2 = (j3 * 256.0d) / this.f4140d;
    ...
    public n.a h(long j2) {
        ...
        long p = h0.p(j2, 0L, this.f4139c);
        double d2 = (p * 100.0d) / this.f4139c;
        double d3 = 0.0d;
        if (d2 > 0.0d) {
            if (d2 >= 100.0d) {
                d3 = 256.0d;
                ...
                int i2 = (int) d2;
                long[] jArr2 = this.f4142f;
                h.t(jArr2);
                double d4 = jArr2[i2];
                d3 = d4 + (((i2 == 99 ? 256.0d : jArr[i2 + 1]) - d4) * (d2 - i2));
            }
        }
        return new n.a(new o(p, this.a + h0.p(Math.round((d3 / 256.0d) * this.f4140d), this.b, this.f4140d - 1)));
    }
