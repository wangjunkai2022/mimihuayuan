    ...
    public b a(List list) {
        ...
        while (true) {
            ...
            if (((c0) linkedList.peek()).a != i2) {
                ...
                arrayList.add(new f(b.a, b.b - j2, arrayList2, b.f4977d));
            }
            i2++;
        }
        long j3 = this.b;
        return new b(this.a, j3 != -9223372036854775807L ? j3 - j2 : -9223372036854775807L, this.f4956c, this.f4957d, this.f4958e, this.f4959f, this.f4960g, this.f4961h, this.f4964k, this.f4962i, this.f4963j, arrayList);
    }
