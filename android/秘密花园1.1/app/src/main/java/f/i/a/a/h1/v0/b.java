...
public class b implements c {
    ...
    public b(d0 d0Var, f.i.a.a.h1.v0.e.a aVar, int i2, j jVar, m mVar) {
        ...
        for (int i3 = 0; i3 < this.f5146c.length; i3++) {
            ...
            this.f5146c[i3] = new e(new f.i.a.a.b1.u.d(3, null, new f.i.a.a.b1.u.j(e2, bVar.a, bVar.f5170c, -9223372036854775807L, aVar.f5167g, b0Var, 0, b0Var.f4016l != null ? aVar.f5165e.f5169c : null, bVar.a == 2 ? 4 : 0, null, null), null, Collections.emptyList(), null), bVar.a, b0Var);
        }
    }
    ...
    public final void h(long j2, long j3, List<? extends l> list, f fVar) {
        ...
        if (list.isEmpty()) {
            ...
            c2 = (int) (list.get(list.size() - 1).c() - this.f5150g);
            if (c2 < 0) {
                this.f5151h = new p();
                return;
            }
        ...
        for (int i4 = 0; i4 < length; i4++) {
            mVarArr[i4] = new C0076b(bVar, this.f5148e.e(i4), i2);
        }
        this.f5148e.h(j2, j4, c3, list, mVarArr);
        long j5 = bVar.o[i2];
        long c4 = bVar.c(i2) + j5;
        long j6 = list.isEmpty() ? j3 : -9223372036854775807L;
        int m2 = this.f5148e.m();
        fVar.a = new i(this.f5147d, new f.i.a.a.l1.p(bVar.a(this.f5148e.e(m2), i2), 0L, -1L, null), this.f5148e.k(), this.f5148e.l(), this.f5148e.p(), j5, c4, j6, -9223372036854775807L, this.f5150g + i2, 1, j5, this.f5146c[m2]);
    }
