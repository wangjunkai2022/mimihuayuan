            ...
            if (lVar != null) {
                ...
                if (eglGetDisplay != null) {
                    ...
                    if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                        ...
                        int[] iArr2 = new int[1];
                        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, f.i.a.a.m1.l.f5675h, 0, eGLConfigArr, 0, 1, iArr2, 0);
                        if (eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null) {
                            EGLConfig eGLConfig = eGLConfigArr[0];
                            EGLContext eglCreateContext = EGL14.eglCreateContext(lVar.f5677d, eGLConfig, EGL14.EGL_NO_CONTEXT, i2 == 0 ? new int[]{12440, 2, 12344} : new int[]{12440, 2, 12992, 1, 12344}, 0);
                            if (eglCreateContext != null) {
                                ...
                                if (EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext)) {
                                    lVar.f5679f = eglCreatePbufferSurface;
                                    ...
                                    this.f5739e = new k(this, surfaceTexture2, i2 != 0, null);
                                    return;
                                }
