...
public final class f extends f.i.a.a.d1.j.b {
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            parcel.writeByte(cVar.f4595c ? (byte) 1 : (byte) 0);
            parcel.writeByte(cVar.f4596d ? (byte) 1 : (byte) 0);
            ...
            parcel.writeByte(cVar.f4599g ? (byte) 1 : (byte) 0);
