...
public final class v implements p {
    ...
    public final e0 f5902e;

    /* renamed from: f  reason: collision with root package name */
    public final m[] f5903f;

    /* renamed from: g  reason: collision with root package name */
    public final m[] f5904g;

    /* renamed from: h  reason: collision with root package name */
    public final ConditionVariable f5905h;

    /* renamed from: i  reason: collision with root package name */
    public final r f5906i;

    /* renamed from: j  reason: collision with root package name */
    public final ArrayDeque<e> f5907j;
    @Nullable
        ...
        public c(boolean z, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z2, boolean z3, m[] mVarArr) {
            ...
            if (i8 == 0) {
                if (z) {
                    ...
                    i10 = (int) (((this.f5915g == 5 ? i9 * 2 : i9) * 250000) / 1000000);
                }
                i8 = i10;
            }
            this.f5916h = i8;
    ...
    public static class d implements b {
        ...
        public long c(long j2) {
            ...
            if (j3 >= 1024) {
                ...
                return h0.h0(j2, d0Var.f5848m * i2, j3 * i3);
            }
            return (long) (d0Var.f5839d * j2);
        }
    ...
    public v(@Nullable j jVar, m[] mVarArr) {
        ...
        this.b = dVar;
        this.f5900c = false;
        this.f5905h = new ConditionVariable(true);
        this.f5906i = new r(new f(null));
        this.f5901d = new u();
        this.f5902e = new e0();
    ...
    */
    ...
    public final long f() {
        c cVar = this.n;
        return cVar.a ? this.y / cVar.f5912d : this.z;
    }
