...
public final class e implements f.i.a.a.b1.h {
    ...
    public final SparseArray<a> f4874d = new SparseArray<>();
    ...
    public static final class a implements p {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final f.i.a.a.b1.f f4881d = new f.i.a.a.b1.f();
        ...
        public void c(long j2, int i2, int i3, int i4, p.a aVar) {
            ...
            this.f4883f.c(j2, i2, i3, i4, aVar);
        }

        @Override // f.i.a.a.b1.p
        public void d(b0 b0Var) {
            b0 b0Var2 = this.f4880c;
            if (b0Var2 != null) {
    ...
    public void b(@Nullable b bVar, long j2, long j3) {
        ...
        gVar.f(0L, j2);
        for (int i2 = 0; i2 < this.f4874d.size(); i2++) {
            this.f4874d.valueAt(i2).e(bVar, j3);
        }
    }

    @Override // f.i.a.a.b1.h
    public void d() {
        b0[] b0VarArr = new b0[this.f4874d.size()];
        for (int i2 = 0; i2 < this.f4874d.size(); i2++) {
            b0VarArr[i2] = this.f4874d.valueAt(i2).f4882e;
        }
        this.f4879i = b0VarArr;
    }

    @Override // f.i.a.a.b1.h
    public p q(int i2, int i3) {
        a aVar = this.f4874d.get(i2);
        if (aVar == null) {
            c.a.a.b.g.h.v(this.f4879i == null);
            aVar = new a(i2, i3, i3 == this.b ? this.f4873c : null);
            aVar.e(this.f4876f, this.f4877g);
            this.f4874d.put(i2, aVar);
        }
        return aVar;
    }
}
