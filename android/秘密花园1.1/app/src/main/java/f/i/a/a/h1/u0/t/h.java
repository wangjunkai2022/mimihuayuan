    ...
    public static e f(a aVar, String str) throws IOException {
        ...
        while (true) {
            ...
            if (hashSet2.add(bVar3.a)) {
                ...
                hashMap = hashMap2;
                hashSet = hashSet2;
                arrayList17.add(new e.b(bVar3.a, bVar3.b.e(new f.i.a.a.d1.a(new o(null, null, (List) hashMap2.get(bVar3.a)))), bVar3.f5110c, bVar3.f5111d, bVar3.f5112e, bVar3.f5113f));
            } else {
                hashMap = hashMap2;
                hashSet = hashSet2;
            }
        ...
        while (i9 < arrayList9.size()) {
            ...
            if (c2 == 0) {
                ...
                if (bVar != null) {
                    b0 b0Var3 = bVar.b;
                    String y2 = f.i.a.a.m1.h0.y(b0Var3.f4010f, 2);
                    int i12 = b0Var3.n;
                    int i13 = b0Var3.o;
                    f2 = b0Var3.p;
                    str2 = y2;
                        ...
                        if (b2.startsWith("#EXT-X-TARGETDURATION")) {
                            ...
                            if (b2.startsWith("#EXT-X-MEDIA-SEQUENCE")) {
                                ...
                                if (b2.startsWith("#EXT-X-DEFINE")) {
                                    ...
                                    if (j22 != null) {
                                        String str10 = eVar3.f5107j.get(j22);
                                        if (str10 != null) {
