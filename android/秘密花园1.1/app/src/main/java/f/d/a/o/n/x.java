...
public class x implements g, d.a<Object> {
    ...
    public f.d.a.o.f f3633e;

    /* renamed from: f  reason: collision with root package name */
    public List<f.d.a.o.o.n<File, ?>> f3634f;
    ...
    public void c(@NonNull Exception exc) {
        this.a.b(this.f3638j, exc, this.f3636h.f3660c, f.d.a.o.a.RESOURCE_DISK_CACHE);
    }
    ...
    public void d(Object obj) {
        this.a.f(this.f3633e, obj, this.f3636h.f3660c, f.d.a.o.a.RESOURCE_DISK_CACHE, this.f3638j);
    }
    ...
    public boolean e() {
        ...
        if (arrayList.isEmpty()) {
            if (File.class.equals(this.b.f3557k)) {
                return false;
            }
        ...
        while (true) {
            List<f.d.a.o.o.n<File, ?>> list2 = this.f3634f;
            if (list2 != null) {
                if (this.f3635g < list2.size()) {
                    ...
                    while (!z) {
                        ...
                        List<f.d.a.o.o.n<File, ?>> list3 = this.f3634f;
                        int i2 = this.f3635g;
                        this.f3635g = i2 + 1;
            ...
            f.d.a.o.f fVar = a.get(this.f3631c);
