...
public class j<DataType, ResourceType, Transcode> {
    ...
    public final f.d.a.o.p.h.e<ResourceType, Transcode> f3580c;
        ...
        try {
            ...
            if (iVar != null) {
                ...
                if (iVar.a.f3549c.b.f3388d.a(wVar.b()) != null) {
                    f.d.a.o.k a2 = iVar.a.f3549c.b.f3388d.a(wVar.b());
                    if (a2 != null) {
                        cVar = a2.b(iVar.o);
                        kVar = a2;
                    } else {
                ...
                if (iVar.n.d(!z, aVar2, cVar)) {
                    if (kVar != null) {
                        ...
                        if (ordinal == 0) {
                            eVar2 = new e(iVar.x, iVar.f3566i);
                        } else if (ordinal == 1) {
                            eVar2 = new y(iVar.a.f3549c.a, iVar.x, iVar.f3566i, iVar.f3569l, iVar.f3570m, lVar, cls, iVar.o);
                        } else {
                ...
                return this.f3580c.a(wVar2, hVar);
            }
            throw null;
        } catch (Throwable th) {
            this.f3581d.release(list);
