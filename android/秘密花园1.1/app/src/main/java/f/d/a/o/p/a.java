...
public abstract class a<T> implements j<ImageDecoder.Source, T> {
    ...
    public class C0047a implements ImageDecoder.OnHeaderDecodedListener {
        ...
        public final /* synthetic */ f.d.a.o.b f3672d;
        ...
        public void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
            ...
            if (this.f3672d == f.d.a.o.b.PREFER_RGB_565) {
    ...
    public final w<T> a(@NonNull ImageDecoder.Source source, int i2, int i3, @NonNull h hVar) throws IOException {
        C0047a c0047a = new C0047a(i2, i3, hVar.c(n.f3690i) != null && ((Boolean) hVar.c(n.f3690i)).booleanValue(), (f.d.a.o.b) hVar.c(n.f3687f), (m) hVar.c(m.f3684f), (i) hVar.c(n.f3688g));
        d dVar = (d) this;
