...
public final class h<Transcode> {
    ...
    public Map<Class<?>, f.d.a.o.l<?>> f3556j;
    ...
    public List<n.a<?>> c() {
        if (!this.f3558l) {
            ...
            int size = f2.size();
            for (int i2 = 0; i2 < size; i2++) {
                n.a<?> a = ((f.d.a.o.o.n) f2.get(i2)).a(this.f3550d, this.f3551e, this.f3552f, this.f3555i);
                if (a != null) {
                    this.a.add(a);
                }
            }
    ...
    public <Data> u<Data, ?, Transcode> d(Class<Data> cls) {
        ...
        cVar.b.set(andSet);
        if (hVar.f3393i != null) {
            if (f.d.a.r.c.f3748c.equals(uVar)) {
                return null;
            }
            if (uVar == null) {
                ...
                u<Data, ?, Transcode> uVar2 = arrayList2.isEmpty() ? null : new u<>(cls, cls2, cls3, arrayList2, hVar.f3394j);
                f.d.a.r.c cVar2 = hVar.f3393i;
                synchronized (cVar2.a) {
                    cVar2.a.put(new f.d.a.u.h(cls, cls2, cls3), uVar2 != null ? uVar2 : f.d.a.r.c.f3748c);
                }
                return uVar2;
            }
            return uVar;
