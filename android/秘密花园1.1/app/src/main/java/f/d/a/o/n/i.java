...
public class i<R> implements g.a, Runnable, Comparable<i<?>>, a.d {
    ...
    public final <Data> w<R> e(Data data, f.d.a.o.a aVar) throws r {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Boolean bool = (Boolean) hVar.c(f.d.a.o.p.c.n.f3690i);
            if (bool == null || (bool.booleanValue() && !z)) {
                hVar = new f.d.a.o.h();
                hVar.d(this.o);
                hVar.b.put(f.d.a.o.p.c.n.f3690i, Boolean.valueOf(z));
            }
        }
        ...
        try {
            return d2.a(b2, hVar2, this.f3569l, this.f3570m, new b(aVar));
        } finally {
            b2.b();
        }
    }
        ...
        if (wVar != null) {
            ...
            try {
                if (this.f3563f.f3571c != null) {
                    ...
                    f.d.a.o.h hVar = this.o;
                    if (cVar2 != null) {
                        ((l.c) dVar2).a().a(cVar2.a, new f.d.a.o.n.f(cVar2.b, cVar2.f3571c, hVar));
                        cVar2.f3571c.e();
                    } else {
                        throw null;
                    }
