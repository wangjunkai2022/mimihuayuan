...
public final class j implements h {
    ...
    public volatile Map<String, String> f3655c;
    ...
    public static final class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final Map<String, List<i>> f3656c;
        public Map<String, List<i>> a = f3656c;
        ...
        static {
            ...
            f3656c = Collections.unmodifiableMap(hashMap);
        }
    }
    ...
    public Map<String, String> a() {
        if (this.f3655c == null) {
            synchronized (this) {
                if (this.f3655c == null) {
                    this.f3655c = Collections.unmodifiableMap(b());
                }
            }
        }
        return this.f3655c;
