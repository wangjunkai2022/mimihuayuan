...
public class v extends FilterInputStream {
    ...
    public final f.d.a.o.n.b0.b f3707f;
        ...
        if (i2 != -1) {
            ...
            if (i3 < i4) {
                if (i2 == 0 && i4 > bArr.length && this.b == bArr.length) {
                    ...
                    byte[] bArr2 = (byte[]) this.f3707f.f(i4, byte[].class);
                ...
                int i6 = this.f3706e - this.f3705d;
                this.f3706e = i6;
                this.f3705d = 0;
                this.b = 0;
    ...
    public synchronized int read() throws IOException {
        ...
        if (bArr != null && inputStream != null) {
            if (this.f3706e < this.b || d(inputStream, bArr) != -1) {
    ...
    public synchronized long skip(long j2) throws IOException {
        ...
        if (bArr != null) {
            InputStream inputStream = ((FilterInputStream) this).in;
            if (inputStream != null) {
                if (this.b - this.f3706e >= j2) {
                    this.f3706e = (int) (this.f3706e + j2);
                    return j2;
                }
                long j3 = this.b - this.f3706e;
                this.f3706e = this.b;
                if (this.f3705d != -1 && j2 <= this.f3704c) {
                    if (d(inputStream, bArr) == -1) {
                        return j3;
                    }
                    if (this.b - this.f3706e >= j2 - j3) {
                        this.f3706e = (int) ((this.f3706e + j2) - j3);
                        return j2;
                    }
                    long j4 = (j3 + this.b) - this.f3706e;
                    this.f3706e = this.b;
                    return j4;
                }
