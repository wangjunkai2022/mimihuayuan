...
public final class m {
            ...
            synchronized (m.this) {
                ...
                if (!m.this.f6702h.f6708c) {
                    if (this.a.b > 0) {
                        ...
                        m mVar = m.this;
                        mVar.n.H(mVar.f6707m, true, null, 0L);
                    }
                }
                synchronized (m.this) {
                    this.b = true;
                ...
                synchronized (m.this) {
                    ...
                    if (!this.f6710c) {
                        if (this.b.b > j5) {
                            ...
                            if (th == null && j6 >= m.this.n.f6655l.a() / 2) {
    ...
    public m(int i2, f fVar, boolean z, boolean z2, w wVar) {
        if (fVar != null) {
            this.f6707m = i2;
            this.n = fVar;
            this.f6698d = fVar.f6656m.a();
            this.f6699e = new ArrayDeque<>();
            this.f6701g = new b(this.n.f6655l.a(), z2);
            this.f6702h = new a(z);
            this.f6703i = new c();
            this.f6704j = new c();
            if (wVar != null) {
    ...
    public final boolean h() {
        return this.n.a == ((this.f6707m & 1) == 1);
    }
    ...
    */
    public final void j(i.w r5, boolean r6) {
        ...
        L1a:
            monitor-enter(r4)
            boolean r0 = r4.f6700f     // Catch: java.lang.Throwable -> L47
            if (r0 == 0) goto L28
            if (r6 != 0) goto L22
            goto L28
        L22:
            i.m0.g.m$b r5 = r4.f6701g     // Catch: java.lang.Throwable -> L47
            if (r5 == 0) goto L27
            goto L2f
        L27:
            throw r1     // Catch: java.lang.Throwable -> L47
        L28:
            r4.f6700f = r2     // Catch: java.lang.Throwable -> L47
            java.util.ArrayDeque<i.w> r0 = r4.f6699e     // Catch: java.lang.Throwable -> L47
            r0.add(r5)     // Catch: java.lang.Throwable -> L47
        L2f:
            if (r6 == 0) goto L35
            i.m0.g.m$b r5 = r4.f6701g     // Catch: java.lang.Throwable -> L47
            r5.f6712e = r2     // Catch: java.lang.Throwable -> L47
        L35:
