...
public final class i {
    ...
    public static final ThreadPoolExecutor f6563g = new ThreadPoolExecutor(0, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, 60, TimeUnit.SECONDS, new SynchronousQueue(), i.m0.b.A("OkHttp ConnectionPool", true));
    public final long a;
            ...
            while (true) {
                ...
                if (!z || next.g()) {
                    if (next.n.size() < next.f6562m && !next.f6558i && next.q.a.a(aVar)) {
                        if (!h.o.c.g.a(aVar.a.f6774e, next.q.a.a.f6774e)) {
                            if (next.f6555f != null && list != null) {
                                if (!list.isEmpty()) {
                                    for (k0 k0Var : list) {
                                        if (k0Var.b.type() == Proxy.Type.DIRECT && next.q.b.type() == Proxy.Type.DIRECT && h.o.c.g.a(next.q.f6486c, k0Var.f6486c)) {
                                            z3 = true;
                                            continue;
                                        } else {
                                            z3 = false;
                                ...
                                z2 = false;
                                if (z2 && aVar.f6351g == i.m0.k.d.a && next.l(aVar.a)) {
                                    try {
