...
public final class e implements Closeable, Flushable {
    ...
    public final class a {
        ...
        public a(b bVar) {
            e.this = r1;
            this.f6518c = bVar;
            this.a = bVar.f6521d ? null : new boolean[r1.s];
        }
        ...
        public final y d(int i2) {
            synchronized (e.this) {
                if (!this.b) {
                    ...
                    try {
                        return new f(e.this.p.c(this.f6518c.f6520c.get(i2)), new C0107a(i2));
    ...
    public final class b {
        ...
        public b(String str) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                sb.append(".tmp");
                this.f6520c.add(new File(r8.q, sb.toString()));
                sb.setLength(length);
            }
        }
    ...
    public static final class d implements Runnable {
        ...
        public final void run() {
            synchronized (e.this) {
                if (!e.this.f6514j || e.this.f6515k) {
                    return;
                }
                try {
                    e.this.N();
    ...
    public final void K(String str) throws IOException {
        ...
        if (i2 != -1) {
            ...
            b bVar = this.f6511g.get(substring);
            if (bVar == null) {
                bVar = new b(substring);
                this.f6511g.put(substring, bVar);
            }
        ...
        if (g.a(bVar.f6522e, aVar)) {
            if (z2 && !bVar.f6521d) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    ...
                    if (zArr != null) {
                        if (zArr[i3]) {
                            if (!this.p.f(bVar.f6520c.get(i3))) {
                                aVar.a();
                                return;
                            }
                        } else {
