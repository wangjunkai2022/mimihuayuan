...
public final class d implements Closeable, Flushable {
    ...
    public static final class a extends i0 {
        ...
        public a(e.c cVar, String str, String str2) {
            ...
            this.f6402e = str;
            this.f6403f = str2;
            j.a0 a0Var = cVar.f6526c.get(1);
            this.f6400c = j.b.h(new C0104a(a0Var, a0Var));
        }
                                    ...
                                    try {
                                        ...
                                        if (u2 >= 0 && u2 <= j2) {
                                            if (!(n2.length() > 0)) {
                                                ...
                                                aVar2.f(f6404k);
                                                aVar2.f(f6405l);
                                                this.f6412i = e2 != null ? Long.parseLong(e2) : 0L;
                                                this.f6413j = e3 != null ? Long.parseLong(e3) : 0L;
                                                this.f6410g = aVar2.d();
