...
public final class a extends m.g implements h {
    ...
    public static final long f7272c;
    ...
    public static final C0130a f7275f;
    public final ThreadFactory a;
    public final AtomicReference<C0130a> b = new AtomicReference<>(f7275f);
    ...
    public static final class C0130a {
        ...
        public class b implements Runnable {
            ...
            public void run() {
                ...
                if (c0130a.f7276c.isEmpty()) {
                    return;
                }
                long nanoTime = System.nanoTime();
                Iterator<c> it = c0130a.f7276c.iterator();
                while (it.hasNext()) {
                    c next = it.next();
                    if (next.f7282i > nanoTime) {
                        return;
                    }
                    if (c0130a.f7276c.remove(next)) {
                        c0130a.f7277d.e(next);
                    }
                }
            }
        }
    ...
    public static final class b extends g.a implements m.n.a {
        ...
        public b(C0130a c0130a) {
            ...
            if (c0130a.f7277d.b) {
                ...
                while (true) {
                    if (!c0130a.f7276c.isEmpty()) {
                        cVar = c0130a.f7276c.poll();
                        if (cVar != null) {
                            break;
                        }
                    } else {
                        cVar = new c(c0130a.a);
                        c0130a.f7277d.b(cVar);
                        break;
                    }
                }
                cVar2 = cVar;
        ...
        public k b(m.n.a aVar) {
            ...
            g e2 = this.f7280c.e(new m.o.c.b(this, aVar), 0L, null);
            this.a.b(e2);
        ...
        public void call() {
            ...
            c cVar = this.f7280c;
            if (c0130a != null) {
                cVar.f7282i = System.nanoTime() + c0130a.b;
                c0130a.f7276c.offer(cVar);
                return;
            }
            throw null;
        }
    ...
    static {
        ...
        f7275f = c0130a;
        c0130a.a();
        f7272c = Integer.getInteger("rx.io-scheduler.keepalive", 60).intValue();
    }

    public a(ThreadFactory threadFactory) {
        this.a = threadFactory;
        C0130a c0130a = new C0130a(this.a, f7272c, f7273d);
        if (this.b.compareAndSet(f7275f, c0130a)) {
            return;
        }
        c0130a.a();
    }
