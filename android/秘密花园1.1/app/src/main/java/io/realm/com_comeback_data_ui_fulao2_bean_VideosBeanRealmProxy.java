...
public class com_comeback_data_ui_fulao2_bean_VideosBeanRealmProxy extends VideosBean implements n, t0 {
    ...
    */
    ...
    public static long insert(x xVar, VideosBean videosBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$video_title != null) {
                Table.nativeSetString(j2, aVar.f6830g, createRowWithPrimaryKey, realmGet$video_title, false);
            }
            String realmGet$actor = videosBean.realmGet$actor();
            if (realmGet$actor != null) {
                Table.nativeSetString(j2, aVar.f6831h, createRowWithPrimaryKey, realmGet$actor, false);
            }
            String realmGet$thumb = videosBean.realmGet$thumb();
            if (realmGet$thumb != null) {
                Table.nativeSetString(j2, aVar.f6832i, createRowWithPrimaryKey, realmGet$thumb, false);
            }
            String realmGet$cover = videosBean.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6833j, createRowWithPrimaryKey, realmGet$cover, false);
            }
            Table.nativeSetLong(j2, aVar.f6834k, createRowWithPrimaryKey, videosBean.realmGet$upload_date(), false);
            Table.nativeSetLong(j2, aVar.f6835l, createRowWithPrimaryKey, videosBean.realmGet$release_date(), false);
            Table.nativeSetLong(j2, aVar.f6836m, createRowWithPrimaryKey, videosBean.realmGet$video_duration(), false);
    ...
    public static long insertOrUpdate(x xVar, VideosBean videosBean, Map<e0, Long> map) {
        ...
        String realmGet$video_title = videosBean.realmGet$video_title();
        if (realmGet$video_title != null) {
            Table.nativeSetString(j2, aVar.f6830g, j4, realmGet$video_title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6830g, j4, false);
        }
        String realmGet$actor = videosBean.realmGet$actor();
        if (realmGet$actor != null) {
            Table.nativeSetString(j2, aVar.f6831h, j4, realmGet$actor, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6831h, j4, false);
        }
        String realmGet$thumb = videosBean.realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(j2, aVar.f6832i, j4, realmGet$thumb, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6832i, j4, false);
        }
        String realmGet$cover = videosBean.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6833j, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6833j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6834k, j4, videosBean.realmGet$upload_date(), false);
        Table.nativeSetLong(j2, aVar.f6835l, j4, videosBean.realmGet$release_date(), false);
        Table.nativeSetLong(j2, aVar.f6836m, j4, videosBean.realmGet$video_duration(), false);
    ...
    public void realmSet$video_duration(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6836m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6836m, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videosBean)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6836m, createRowWithPrimaryKey, videosBean.realmGet$video_duration(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videosBean)) {
                ...
                if (realmGet$video_title != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6830g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor = videosBean.realmGet$actor();
                if (realmGet$actor != null) {
                    Table.nativeSetString(j3, aVar.f6831h, createRowWithPrimaryKey, realmGet$actor, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6831h, createRowWithPrimaryKey, false);
                }
                String realmGet$thumb = videosBean.realmGet$thumb();
                if (realmGet$thumb != null) {
                    Table.nativeSetString(j3, aVar.f6832i, createRowWithPrimaryKey, realmGet$thumb, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6832i, createRowWithPrimaryKey, false);
                }
                String realmGet$cover = videosBean.realmGet$cover();
                if (realmGet$cover != null) {
                    Table.nativeSetString(j3, aVar.f6833j, createRowWithPrimaryKey, realmGet$cover, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6833j, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6834k, j5, videosBean.realmGet$upload_date(), false);
                Table.nativeSetLong(j3, aVar.f6835l, j5, videosBean.realmGet$release_date(), false);
                Table.nativeSetLong(j3, aVar.f6836m, j5, videosBean.realmGet$video_duration(), false);
