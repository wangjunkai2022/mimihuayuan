...
public class com_comeback_data_ui_km2_bean_Km2VideoRealmProxy extends Km2Video implements n, w0 {
    ...
    */
    ...
    public static long insert(x xVar, Km2Video km2Video, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$title != null) {
                Table.nativeSetString(j2, aVar.f6850g, createRowWithPrimaryKey, realmGet$title, false);
            }
            Table.nativeSetLong(j2, aVar.f6851h, createRowWithPrimaryKey, km2Video.realmGet$praise_num(), false);
            Table.nativeSetLong(j2, aVar.f6852i, createRowWithPrimaryKey, km2Video.realmGet$width(), false);
            Table.nativeSetLong(j2, aVar.f6853j, createRowWithPrimaryKey, km2Video.realmGet$height(), false);
            String realmGet$cover = km2Video.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6854k, createRowWithPrimaryKey, realmGet$cover, false);
            }
            String realmGet$nickname = km2Video.realmGet$nickname();
            if (realmGet$nickname != null) {
                Table.nativeSetString(j2, aVar.f6855l, createRowWithPrimaryKey, realmGet$nickname, false);
            }
            Table.nativeSetLong(j2, aVar.f6856m, createRowWithPrimaryKey, km2Video.realmGet$type(), false);
    ...
    public static long insertOrUpdate(x xVar, Km2Video km2Video, Map<e0, Long> map) {
        ...
        String realmGet$title = km2Video.realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(j2, aVar.f6850g, j4, realmGet$title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6850g, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6851h, j4, km2Video.realmGet$praise_num(), false);
        Table.nativeSetLong(j2, aVar.f6852i, j4, km2Video.realmGet$width(), false);
        Table.nativeSetLong(j2, aVar.f6853j, j4, km2Video.realmGet$height(), false);
        String realmGet$cover = km2Video.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6854k, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6854k, j4, false);
        }
        String realmGet$nickname = km2Video.realmGet$nickname();
        if (realmGet$nickname != null) {
            Table.nativeSetString(j2, aVar.f6855l, j4, realmGet$nickname, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6855l, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6856m, j4, km2Video.realmGet$type(), false);
        String realmGet$normal_url = km2Video.realmGet$normal_url();
        if (realmGet$normal_url != null) {
    ...
    public void realmSet$height(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6853j, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6853j, i2);
    }
    ...
    public void realmSet$praise_num(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6851h, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6851h, i2);
    }
    ...
    public void realmSet$type(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6856m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6856m, i2);
    }
    ...
    public void realmSet$width(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6852i, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6852i, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2Video)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6851h, createRowWithPrimaryKey, km2Video.realmGet$praise_num(), false);
                    Table.nativeSetLong(j3, aVar.f6852i, createRowWithPrimaryKey, km2Video.realmGet$width(), false);
                    Table.nativeSetLong(j3, aVar.f6853j, createRowWithPrimaryKey, km2Video.realmGet$height(), false);
                    String realmGet$cover = km2Video.realmGet$cover();
                    if (realmGet$cover != null) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6856m, createRowWithPrimaryKey, km2Video.realmGet$type(), false);
                    String realmGet$normal_url = km2Video.realmGet$normal_url();
                    if (realmGet$normal_url != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2Video)) {
                ...
                if (realmGet$title != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6850g, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6851h, j5, km2Video.realmGet$praise_num(), false);
                Table.nativeSetLong(j3, aVar.f6852i, j5, km2Video.realmGet$width(), false);
                Table.nativeSetLong(j3, aVar.f6853j, j5, km2Video.realmGet$height(), false);
                String realmGet$cover = km2Video.realmGet$cover();
                if (realmGet$cover != null) {
                    Table.nativeSetString(j3, aVar.f6854k, createRowWithPrimaryKey, realmGet$cover, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6854k, createRowWithPrimaryKey, false);
                }
                String realmGet$nickname = km2Video.realmGet$nickname();
                if (realmGet$nickname != null) {
                    Table.nativeSetString(j3, aVar.f6855l, createRowWithPrimaryKey, realmGet$nickname, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6855l, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.f6856m, createRowWithPrimaryKey, km2Video.realmGet$type(), false);
                String realmGet$normal_url = km2Video.realmGet$normal_url();
                if (realmGet$normal_url != null) {
