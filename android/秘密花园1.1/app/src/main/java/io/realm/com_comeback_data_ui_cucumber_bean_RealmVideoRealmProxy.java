    ...
    */
    ...
    public static long insert(x xVar, RealmVideo realmVideo, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$cover = realmVideo.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6806f, createRowWithPrimaryKey, realmGet$cover, false);
            }
            String realmGet$mins = realmVideo.realmGet$mins();
            if (realmGet$mins != null) {
                Table.nativeSetString(j2, aVar.f6808h, createRowWithPrimaryKey, realmGet$mins, false);
            }
            String realmGet$name = realmVideo.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6809i, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$strPlayCnt = realmVideo.realmGet$strPlayCnt();
            if (realmGet$strPlayCnt != null) {
                Table.nativeSetString(j2, aVar.f6810j, createRowWithPrimaryKey, realmGet$strPlayCnt, false);
            }
    ...
    public static long insertOrUpdate(x xVar, RealmVideo realmVideo, Map<e0, Long> map) {
        ...
        String realmGet$cover = realmVideo.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6806f, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6806f, j4, false);
        }
        String realmGet$mins = realmVideo.realmGet$mins();
        if (realmGet$mins != null) {
            Table.nativeSetString(j2, aVar.f6808h, j4, realmGet$mins, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6808h, j4, false);
        }
        String realmGet$name = realmVideo.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6809i, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6809i, j4, false);
        }
        String realmGet$strPlayCnt = realmVideo.realmGet$strPlayCnt();
        if (realmGet$strPlayCnt != null) {
            Table.nativeSetString(j2, aVar.f6810j, j4, realmGet$strPlayCnt, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6810j, j4, false);
        }
        return j4;
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(realmVideo2)) {
                ...
                if (realmGet$cover != null) {
                    ...
                    realmVideo = realmVideo2;
                    Table.nativeSetNull(j2, aVar.f6806f, createRowWithPrimaryKey, false);
                }
                String realmGet$mins = realmVideo.realmGet$mins();
                if (realmGet$mins != null) {
                    Table.nativeSetString(j2, aVar.f6808h, createRowWithPrimaryKey, realmGet$mins, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6808h, createRowWithPrimaryKey, false);
                }
                String realmGet$name = realmVideo.realmGet$name();
                if (realmGet$name != null) {
                    Table.nativeSetString(j2, aVar.f6809i, createRowWithPrimaryKey, realmGet$name, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6809i, createRowWithPrimaryKey, false);
                }
                String realmGet$strPlayCnt = realmVideo.realmGet$strPlayCnt();
                if (realmGet$strPlayCnt != null) {
                    Table.nativeSetString(j2, aVar.f6810j, createRowWithPrimaryKey, realmGet$strPlayCnt, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6810j, createRowWithPrimaryKey, false);
                }
            }
        }
    }
