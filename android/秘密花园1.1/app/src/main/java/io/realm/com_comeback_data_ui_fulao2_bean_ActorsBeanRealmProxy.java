    ...
    */
    ...
    public static long insert(x xVar, ActorsBean actorsBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$actor_name = actorsBean.realmGet$actor_name();
            if (realmGet$actor_name != null) {
                Table.nativeSetString(j2, aVar.f6822g, createRowWithPrimaryKey, realmGet$actor_name, false);
            }
            String realmGet$actor_url = actorsBean.realmGet$actor_url();
            if (realmGet$actor_url != null) {
                Table.nativeSetString(j2, aVar.f6823h, createRowWithPrimaryKey, realmGet$actor_url, false);
            }
            Table.nativeSetBoolean(j2, aVar.f6824i, createRowWithPrimaryKey, actorsBean.realmGet$actor_like(), false);
            Table.nativeSetLong(j2, aVar.f6825j, createRowWithPrimaryKey, actorsBean.realmGet$actor_collects(), false);
            Table.nativeSetBoolean(j2, aVar.f6826k, createRowWithPrimaryKey, actorsBean.realmGet$actor_vip(), false);
            String realmGet$video_title = actorsBean.realmGet$video_title();
            if (realmGet$video_title != null) {
                Table.nativeSetString(j2, aVar.f6827l, createRowWithPrimaryKey, realmGet$video_title, false);
            }
    ...
    public static long insertOrUpdate(x xVar, ActorsBean actorsBean, Map<e0, Long> map) {
        ...
        String realmGet$actor_name = actorsBean.realmGet$actor_name();
        if (realmGet$actor_name != null) {
            Table.nativeSetString(j2, aVar.f6822g, j4, realmGet$actor_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6822g, j4, false);
        }
        String realmGet$actor_url = actorsBean.realmGet$actor_url();
        if (realmGet$actor_url != null) {
            Table.nativeSetString(j2, aVar.f6823h, j4, realmGet$actor_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6823h, j4, false);
        }
        Table.nativeSetBoolean(j2, aVar.f6824i, j4, actorsBean.realmGet$actor_like(), false);
        Table.nativeSetLong(j2, aVar.f6825j, j4, actorsBean.realmGet$actor_collects(), false);
        Table.nativeSetBoolean(j2, aVar.f6826k, j4, actorsBean.realmGet$actor_vip(), false);
        String realmGet$video_title = actorsBean.realmGet$video_title();
        if (realmGet$video_title != null) {
            Table.nativeSetString(j2, aVar.f6827l, j4, realmGet$video_title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6827l, j4, false);
        }
        return j4;
    }
    ...
    public void realmSet$actor_collects(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6825j, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6825j, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(actorsBean)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6825j, createRowWithPrimaryKey, actorsBean.realmGet$actor_collects(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(actorsBean)) {
                ...
                if (realmGet$actor_name != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6822g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor_url = actorsBean.realmGet$actor_url();
                if (realmGet$actor_url != null) {
                    Table.nativeSetString(j3, aVar.f6823h, createRowWithPrimaryKey, realmGet$actor_url, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6823h, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetBoolean(j3, aVar.f6824i, j5, actorsBean.realmGet$actor_like(), false);
                Table.nativeSetLong(j3, aVar.f6825j, j5, actorsBean.realmGet$actor_collects(), false);
                Table.nativeSetBoolean(j3, aVar.f6826k, j5, actorsBean.realmGet$actor_vip(), false);
                String realmGet$video_title = actorsBean.realmGet$video_title();
                if (realmGet$video_title != null) {
                    Table.nativeSetString(j3, aVar.f6827l, createRowWithPrimaryKey, realmGet$video_title, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6827l, createRowWithPrimaryKey, false);
                }
                j4 = j2;
            }
        }
