...
public class com_comeback_data_ui_ba_bean_BaComicsBeanRealmProxy extends BaComicsBean implements n, p0 {
    ...
    */
    ...
    public static long insert(x xVar, BaComicsBean baComicsBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$author != null) {
                Table.nativeSetString(j2, aVar.f6797f, createRowWithPrimaryKey, realmGet$author, false);
            }
            String realmGet$describes = baComicsBean.realmGet$describes();
            if (realmGet$describes != null) {
                Table.nativeSetString(j2, aVar.f6798g, createRowWithPrimaryKey, realmGet$describes, false);
            }
            Table.nativeSetDouble(j2, aVar.f6799h, createRowWithPrimaryKey, baComicsBean.realmGet$follow_num(), false);
            Table.nativeSetLong(j2, aVar.f6800i, createRowWithPrimaryKey, baComicsBean.realmGet$heat(), false);
            Table.nativeSetLong(j2, aVar.f6801j, createRowWithPrimaryKey, baComicsBean.realmGet$is_adult(), false);
            Table.nativeSetLong(j2, aVar.f6802k, createRowWithPrimaryKey, baComicsBean.realmGet$is_end(), false);
            String realmGet$small_picture = baComicsBean.realmGet$small_picture();
            if (realmGet$small_picture != null) {
                Table.nativeSetString(j2, aVar.f6804m, createRowWithPrimaryKey, realmGet$small_picture, false);
            }
    ...
    public static long insertOrUpdate(x xVar, BaComicsBean baComicsBean, Map<e0, Long> map) {
        ...
        String realmGet$author = baComicsBean.realmGet$author();
        if (realmGet$author != null) {
            Table.nativeSetString(j2, aVar.f6797f, j4, realmGet$author, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6797f, j4, false);
        }
        String realmGet$describes = baComicsBean.realmGet$describes();
        if (realmGet$describes != null) {
            Table.nativeSetString(j2, aVar.f6798g, j4, realmGet$describes, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6798g, j4, false);
        }
        Table.nativeSetDouble(j2, aVar.f6799h, j4, baComicsBean.realmGet$follow_num(), false);
        Table.nativeSetLong(j2, aVar.f6800i, j4, baComicsBean.realmGet$heat(), false);
        Table.nativeSetLong(j2, aVar.f6801j, j4, baComicsBean.realmGet$is_adult(), false);
        Table.nativeSetLong(j2, aVar.f6802k, j4, baComicsBean.realmGet$is_end(), false);
        String realmGet$small_picture = baComicsBean.realmGet$small_picture();
        if (realmGet$small_picture != null) {
            Table.nativeSetString(j2, aVar.f6804m, j4, realmGet$small_picture, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6804m, j4, false);
        }
        String realmGet$title = baComicsBean.realmGet$title();
        if (realmGet$title != null) {
    ...
    public void realmSet$heat(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6800i, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6800i, i2);
    }
    ...
    public void realmSet$is_adult(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6801j, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6801j, i2);
    }
    ...
    public void realmSet$is_end(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6802k, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6802k, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(baComicsBean)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6800i, createRowWithPrimaryKey, baComicsBean.realmGet$heat(), false);
                    Table.nativeSetLong(j3, aVar.f6801j, createRowWithPrimaryKey, baComicsBean.realmGet$is_adult(), false);
                    Table.nativeSetLong(j3, aVar.f6802k, createRowWithPrimaryKey, baComicsBean.realmGet$is_end(), false);
                    String realmGet$small_picture = baComicsBean.realmGet$small_picture();
                    if (realmGet$small_picture != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(baComicsBean)) {
                ...
                if (realmGet$author != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6797f, createRowWithPrimaryKey, false);
                }
                String realmGet$describes = baComicsBean.realmGet$describes();
                if (realmGet$describes != null) {
                    Table.nativeSetString(j3, aVar.f6798g, createRowWithPrimaryKey, realmGet$describes, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6798g, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetDouble(j3, aVar.f6799h, j5, baComicsBean.realmGet$follow_num(), false);
                Table.nativeSetLong(j3, aVar.f6800i, j5, baComicsBean.realmGet$heat(), false);
                Table.nativeSetLong(j3, aVar.f6801j, j5, baComicsBean.realmGet$is_adult(), false);
                Table.nativeSetLong(j3, aVar.f6802k, j5, baComicsBean.realmGet$is_end(), false);
                String realmGet$small_picture = baComicsBean.realmGet$small_picture();
                if (realmGet$small_picture != null) {
                    Table.nativeSetString(j3, aVar.f6804m, createRowWithPrimaryKey, realmGet$small_picture, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6804m, createRowWithPrimaryKey, false);
                }
                String realmGet$title = baComicsBean.realmGet$title();
                if (realmGet$title != null) {
                    Table.nativeSetString(j3, aVar.n, createRowWithPrimaryKey, realmGet$title, false);
