...
public class com_comeback_data_ui_mimei_bean_MimeiComicItemRealmProxy extends MimeiComicItem implements n, d1 {
    ...
    */
    ...
    public static long insert(x xVar, MimeiComicItem mimeiComicItem, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$series_hash_key != null) {
                Table.nativeSetString(j2, aVar.f6896g, createRowWithPrimaryKey, realmGet$series_hash_key, false);
            }
            String realmGet$name = mimeiComicItem.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6897h, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$series = mimeiComicItem.realmGet$series();
            if (realmGet$series != null) {
                Table.nativeSetString(j2, aVar.f6898i, createRowWithPrimaryKey, realmGet$series, false);
            }
            String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
            if (realmGet$series_stamp != null) {
                Table.nativeSetString(j2, aVar.f6899j, createRowWithPrimaryKey, realmGet$series_stamp, false);
            }
            String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
            if (realmGet$cover_path != null) {
                Table.nativeSetString(j2, aVar.f6900k, createRowWithPrimaryKey, realmGet$cover_path, false);
            }
            String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
            if (realmGet$full_cover_path != null) {
                Table.nativeSetString(j2, aVar.f6901l, createRowWithPrimaryKey, realmGet$full_cover_path, false);
            }
            Table.nativeSetLong(j2, aVar.f6902m, createRowWithPrimaryKey, mimeiComicItem.realmGet$view_count(), false);
    ...
    public static long insertOrUpdate(x xVar, MimeiComicItem mimeiComicItem, Map<e0, Long> map) {
        ...
        String realmGet$series_hash_key = mimeiComicItem.realmGet$series_hash_key();
        if (realmGet$series_hash_key != null) {
            Table.nativeSetString(j2, aVar.f6896g, j4, realmGet$series_hash_key, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6896g, j4, false);
        }
        String realmGet$name = mimeiComicItem.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6897h, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6897h, j4, false);
        }
        String realmGet$series = mimeiComicItem.realmGet$series();
        if (realmGet$series != null) {
            Table.nativeSetString(j2, aVar.f6898i, j4, realmGet$series, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6898i, j4, false);
        }
        String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
        if (realmGet$series_stamp != null) {
            Table.nativeSetString(j2, aVar.f6899j, j4, realmGet$series_stamp, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6899j, j4, false);
        }
        String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
        if (realmGet$cover_path != null) {
            Table.nativeSetString(j2, aVar.f6900k, j4, realmGet$cover_path, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6900k, j4, false);
        }
        String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
        if (realmGet$full_cover_path != null) {
            Table.nativeSetString(j2, aVar.f6901l, j4, realmGet$full_cover_path, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6901l, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6902m, j4, mimeiComicItem.realmGet$view_count(), false);
    ...
    public void realmSet$series_number(int i2) {
        ...
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.t, i2);
    }
    ...
    public void realmSet$view_count(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6902m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6902m, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(mimeiComicItem)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6902m, createRowWithPrimaryKey, mimeiComicItem.realmGet$view_count(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(mimeiComicItem)) {
                ...
                if (realmGet$series_hash_key != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6896g, createRowWithPrimaryKey, false);
                }
                String realmGet$name = mimeiComicItem.realmGet$name();
                if (realmGet$name != null) {
                    Table.nativeSetString(j3, aVar.f6897h, createRowWithPrimaryKey, realmGet$name, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6897h, createRowWithPrimaryKey, false);
                }
                String realmGet$series = mimeiComicItem.realmGet$series();
                if (realmGet$series != null) {
                    Table.nativeSetString(j3, aVar.f6898i, createRowWithPrimaryKey, realmGet$series, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6898i, createRowWithPrimaryKey, false);
                }
                String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
                if (realmGet$series_stamp != null) {
                    Table.nativeSetString(j3, aVar.f6899j, createRowWithPrimaryKey, realmGet$series_stamp, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6899j, createRowWithPrimaryKey, false);
                }
                String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
                if (realmGet$cover_path != null) {
                    Table.nativeSetString(j3, aVar.f6900k, createRowWithPrimaryKey, realmGet$cover_path, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6900k, createRowWithPrimaryKey, false);
                }
                String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
                if (realmGet$full_cover_path != null) {
                    Table.nativeSetString(j3, aVar.f6901l, createRowWithPrimaryKey, realmGet$full_cover_path, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6901l, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6902m, j5, mimeiComicItem.realmGet$view_count(), false);
