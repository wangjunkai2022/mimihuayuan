    ...
    */
    public static com.comeback.data.ui.lutube.bean.LActorsBean createOrUpdateUsingJsonObject(g.a.x r8, org.json.JSONObject r9, boolean r10) throws org.json.JSONException {
        ...
        L35:
            ...
            g.a.k0 r3 = r8.f6317j     // Catch: java.lang.Throwable -> L6c
            java.lang.Class<com.comeback.data.ui.lutube.bean.LActorsBean> r4 = com.comeback.data.ui.lutube.bean.LActorsBean.class
            r3.a()     // Catch: java.lang.Throwable -> L6c
            g.a.f1.b r3 = r3.f6286f     // Catch: java.lang.Throwable -> L6c
            ...
            r5.f6194c = r3     // Catch: java.lang.Throwable -> L6c
            r5.f6195d = r4     // Catch: java.lang.Throwable -> L6c
            r5.f6196e = r6     // Catch: java.lang.Throwable -> L6c
    ...
    public static long insert(x xVar, LActorsBean lActorsBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$actor_name = lActorsBean.realmGet$actor_name();
            if (realmGet$actor_name != null) {
                Table.nativeSetString(j2, aVar.f6871g, createRowWithPrimaryKey, realmGet$actor_name, false);
            }
            String realmGet$actor_url = lActorsBean.realmGet$actor_url();
            if (realmGet$actor_url != null) {
                Table.nativeSetString(j2, aVar.f6872h, createRowWithPrimaryKey, realmGet$actor_url, false);
            }
            Table.nativeSetBoolean(j2, aVar.f6873i, createRowWithPrimaryKey, lActorsBean.realmGet$actor_like(), false);
    ...
    public static long insertOrUpdate(x xVar, LActorsBean lActorsBean, Map<e0, Long> map) {
        ...
        String realmGet$actor_name = lActorsBean.realmGet$actor_name();
        if (realmGet$actor_name != null) {
            Table.nativeSetString(j2, aVar.f6871g, j4, realmGet$actor_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6871g, j4, false);
        }
        String realmGet$actor_url = lActorsBean.realmGet$actor_url();
        if (realmGet$actor_url != null) {
            Table.nativeSetString(j2, aVar.f6872h, j4, realmGet$actor_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6872h, j4, false);
        }
        Table.nativeSetBoolean(j2, aVar.f6873i, j4, lActorsBean.realmGet$actor_like(), false);
        return j4;
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lActorsBean2)) {
                ...
                if (realmGet$actor_name != null) {
                    ...
                    lActorsBean = lActorsBean2;
                    Table.nativeSetNull(j2, aVar.f6871g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor_url = lActorsBean.realmGet$actor_url();
                if (realmGet$actor_url != null) {
                    Table.nativeSetString(j2, aVar.f6872h, createRowWithPrimaryKey, realmGet$actor_url, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6872h, createRowWithPrimaryKey, false);
                }
                Table.nativeSetBoolean(j2, aVar.f6873i, createRowWithPrimaryKey, lActorsBean.realmGet$actor_like(), false);
            }
        }
