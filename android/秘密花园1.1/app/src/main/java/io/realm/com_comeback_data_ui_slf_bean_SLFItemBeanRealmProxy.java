...
public class com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy extends SLFItemBean implements n, e1 {
    ...
    */
    ...
    public static long insert(x xVar, SLFItemBean sLFItemBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6905g, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$click = sLFItemBean.realmGet$click();
            if (realmGet$click != null) {
                Table.nativeSetString(j2, aVar.f6906h, createRowWithPrimaryKey, realmGet$click, false);
            }
            String realmGet$favorite = sLFItemBean.realmGet$favorite();
            if (realmGet$favorite != null) {
                Table.nativeSetString(j2, aVar.f6907i, createRowWithPrimaryKey, realmGet$favorite, false);
            }
            String realmGet$img = sLFItemBean.realmGet$img();
            if (realmGet$img != null) {
                Table.nativeSetString(j2, aVar.f6908j, createRowWithPrimaryKey, realmGet$img, false);
            }
            Table.nativeSetLong(j2, aVar.f6909k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
            String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
            if (realmGet$updateTime != null) {
                Table.nativeSetString(j2, aVar.f6910l, createRowWithPrimaryKey, realmGet$updateTime, false);
            }
            String realmGet$description = sLFItemBean.realmGet$description();
            if (realmGet$description != null) {
                Table.nativeSetString(j2, aVar.f6911m, createRowWithPrimaryKey, realmGet$description, false);
            }
    ...
    public static long insertOrUpdate(x xVar, SLFItemBean sLFItemBean, Map<e0, Long> map) {
        ...
        String realmGet$name = sLFItemBean.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6905g, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6905g, j4, false);
        }
        String realmGet$click = sLFItemBean.realmGet$click();
        if (realmGet$click != null) {
            Table.nativeSetString(j2, aVar.f6906h, j4, realmGet$click, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6906h, j4, false);
        }
        String realmGet$favorite = sLFItemBean.realmGet$favorite();
        if (realmGet$favorite != null) {
            Table.nativeSetString(j2, aVar.f6907i, j4, realmGet$favorite, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6907i, j4, false);
        }
        String realmGet$img = sLFItemBean.realmGet$img();
        if (realmGet$img != null) {
            Table.nativeSetString(j2, aVar.f6908j, j4, realmGet$img, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6908j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6909k, j4, sLFItemBean.realmGet$sale(), false);
        String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
        if (realmGet$updateTime != null) {
            Table.nativeSetString(j2, aVar.f6910l, j4, realmGet$updateTime, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6910l, j4, false);
        }
        String realmGet$description = sLFItemBean.realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(j2, aVar.f6911m, j4, realmGet$description, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6911m, j4, false);
        }
        String realmGet$summary = sLFItemBean.realmGet$summary();
        if (realmGet$summary != null) {
    ...
    public void realmSet$point(int i2) {
        ...
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.o, i2);
    }
    ...
    public void realmSet$sale(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6909k, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6909k, i2);
    }
    ...
    public void realmSet$type(int i2) {
        ...
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.q, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(sLFItemBean)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6909k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
                    String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
                    if (realmGet$updateTime != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(sLFItemBean)) {
                ...
                if (realmGet$updateTime != null) {
                    ...
                    Table.nativeSetNull(j3, aVar.f6910l, createRowWithPrimaryKey, false);
                }
                String realmGet$description = sLFItemBean.realmGet$description();
                if (realmGet$description != null) {
                    Table.nativeSetString(j3, aVar.f6911m, createRowWithPrimaryKey, realmGet$description, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6911m, createRowWithPrimaryKey, false);
                }
                String realmGet$summary = sLFItemBean.realmGet$summary();
                if (realmGet$summary != null) {
                    Table.nativeSetString(j3, aVar.n, createRowWithPrimaryKey, realmGet$summary, false);
