    ...
    */
    ...
    public static long insert(x xVar, Km2User km2User, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$mu_name = km2User.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j2, aVar.f6846f, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
    ...
    public static long insertOrUpdate(x xVar, Km2User km2User, Map<e0, Long> map) {
        ...
        String realmGet$mu_name = km2User.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j2, aVar.f6846f, j4, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6846f, j4, false);
        }
        return j4;
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2User)) {
                ...
                if (realmGet$mu_name != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6846f, createRowWithPrimaryKey, false);
                }
            }
        }
    }
