...
public class com_comeback_data_ui_ds_bean_DsItemBeanRealmProxy extends DsItemBean implements n, r0 {
    ...
    */
    ...
    public static long insert(x xVar, DsItemBean dsItemBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$title != null) {
                Table.nativeSetString(j2, aVar.f6813g, createRowWithPrimaryKey, realmGet$title, false);
            }
            String realmGet$lanmu_id = dsItemBean.realmGet$lanmu_id();
            if (realmGet$lanmu_id != null) {
                Table.nativeSetString(j2, aVar.f6814h, createRowWithPrimaryKey, realmGet$lanmu_id, false);
            }
            String realmGet$create_time = dsItemBean.realmGet$create_time();
            if (realmGet$create_time != null) {
                Table.nativeSetString(j2, aVar.f6815i, createRowWithPrimaryKey, realmGet$create_time, false);
            }
            String realmGet$update_time = dsItemBean.realmGet$update_time();
            if (realmGet$update_time != null) {
                Table.nativeSetString(j2, aVar.f6816j, createRowWithPrimaryKey, realmGet$update_time, false);
            }
            String realmGet$sort = dsItemBean.realmGet$sort();
            if (realmGet$sort != null) {
                Table.nativeSetString(j2, aVar.f6817k, createRowWithPrimaryKey, realmGet$sort, false);
            }
            String realmGet$status = dsItemBean.realmGet$status();
            if (realmGet$status != null) {
                Table.nativeSetString(j2, aVar.f6818l, createRowWithPrimaryKey, realmGet$status, false);
            }
            String realmGet$view = dsItemBean.realmGet$view();
            if (realmGet$view != null) {
                Table.nativeSetString(j2, aVar.f6819m, createRowWithPrimaryKey, realmGet$view, false);
            }
    ...
    public static long insertOrUpdate(x xVar, DsItemBean dsItemBean, Map<e0, Long> map) {
        ...
        String realmGet$title = dsItemBean.realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(j2, aVar.f6813g, j4, realmGet$title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6813g, j4, false);
        }
        String realmGet$lanmu_id = dsItemBean.realmGet$lanmu_id();
        if (realmGet$lanmu_id != null) {
            Table.nativeSetString(j2, aVar.f6814h, j4, realmGet$lanmu_id, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6814h, j4, false);
        }
        String realmGet$create_time = dsItemBean.realmGet$create_time();
        if (realmGet$create_time != null) {
            Table.nativeSetString(j2, aVar.f6815i, j4, realmGet$create_time, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6815i, j4, false);
        }
        String realmGet$update_time = dsItemBean.realmGet$update_time();
        if (realmGet$update_time != null) {
            Table.nativeSetString(j2, aVar.f6816j, j4, realmGet$update_time, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6816j, j4, false);
        }
        String realmGet$sort = dsItemBean.realmGet$sort();
        if (realmGet$sort != null) {
            Table.nativeSetString(j2, aVar.f6817k, j4, realmGet$sort, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6817k, j4, false);
        }
        String realmGet$status = dsItemBean.realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(j2, aVar.f6818l, j4, realmGet$status, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6818l, j4, false);
        }
        String realmGet$view = dsItemBean.realmGet$view();
        if (realmGet$view != null) {
            Table.nativeSetString(j2, aVar.f6819m, j4, realmGet$view, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6819m, j4, false);
        }
        String realmGet$image = dsItemBean.realmGet$image();
        if (realmGet$image != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(dsItemBean2)) {
                ...
                if (realmGet$title != null) {
                    ...
                    dsItemBean = dsItemBean2;
                    Table.nativeSetNull(j2, aVar.f6813g, createRowWithPrimaryKey, false);
                }
                String realmGet$lanmu_id = dsItemBean.realmGet$lanmu_id();
                if (realmGet$lanmu_id != null) {
                    Table.nativeSetString(j2, aVar.f6814h, createRowWithPrimaryKey, realmGet$lanmu_id, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6814h, createRowWithPrimaryKey, false);
                }
                String realmGet$create_time = dsItemBean.realmGet$create_time();
                if (realmGet$create_time != null) {
                    Table.nativeSetString(j2, aVar.f6815i, createRowWithPrimaryKey, realmGet$create_time, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6815i, createRowWithPrimaryKey, false);
                }
                String realmGet$update_time = dsItemBean.realmGet$update_time();
                if (realmGet$update_time != null) {
                    Table.nativeSetString(j2, aVar.f6816j, createRowWithPrimaryKey, realmGet$update_time, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6816j, createRowWithPrimaryKey, false);
                }
                String realmGet$sort = dsItemBean.realmGet$sort();
                if (realmGet$sort != null) {
                    Table.nativeSetString(j2, aVar.f6817k, createRowWithPrimaryKey, realmGet$sort, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6817k, createRowWithPrimaryKey, false);
                }
                String realmGet$status = dsItemBean.realmGet$status();
                if (realmGet$status != null) {
                    Table.nativeSetString(j2, aVar.f6818l, createRowWithPrimaryKey, realmGet$status, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6818l, createRowWithPrimaryKey, false);
                }
                String realmGet$view = dsItemBean.realmGet$view();
                if (realmGet$view != null) {
                    Table.nativeSetString(j2, aVar.f6819m, createRowWithPrimaryKey, realmGet$view, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6819m, createRowWithPrimaryKey, false);
                }
                String realmGet$image = dsItemBean.realmGet$image();
                if (realmGet$image != null) {
                    Table.nativeSetString(j2, aVar.n, createRowWithPrimaryKey, realmGet$image, false);
