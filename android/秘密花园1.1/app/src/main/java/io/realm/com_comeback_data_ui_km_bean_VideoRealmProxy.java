...
public class com_comeback_data_ui_km_bean_VideoRealmProxy extends Video implements n, y0 {
    ...
    */
    ...
    public static long insert(x xVar, Video video, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$mu_avatar != null) {
                Table.nativeSetString(j2, aVar.f6861f, createRowWithPrimaryKey, realmGet$mu_avatar, false);
            }
            String realmGet$mu_id = video.realmGet$mu_id();
            if (realmGet$mu_id != null) {
                Table.nativeSetString(j2, aVar.f6862g, createRowWithPrimaryKey, realmGet$mu_id, false);
            }
            String realmGet$mu_name = video.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j2, aVar.f6863h, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
            String realmGet$mv_comment = video.realmGet$mv_comment();
            if (realmGet$mv_comment != null) {
                Table.nativeSetString(j2, aVar.f6864i, createRowWithPrimaryKey, realmGet$mv_comment, false);
            }
            String realmGet$mv_created = video.realmGet$mv_created();
            if (realmGet$mv_created != null) {
                Table.nativeSetString(j2, aVar.f6865j, createRowWithPrimaryKey, realmGet$mv_created, false);
            }
            String realmGet$mv_img_url = video.realmGet$mv_img_url();
            if (realmGet$mv_img_url != null) {
                Table.nativeSetString(j2, aVar.f6867l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
            }
            String realmGet$mv_like = video.realmGet$mv_like();
            if (realmGet$mv_like != null) {
                Table.nativeSetString(j2, aVar.f6868m, createRowWithPrimaryKey, realmGet$mv_like, false);
            }
    ...
    public static long insertOrUpdate(x xVar, Video video, Map<e0, Long> map) {
        ...
        String realmGet$mu_avatar = video.realmGet$mu_avatar();
        if (realmGet$mu_avatar != null) {
            Table.nativeSetString(j2, aVar.f6861f, j4, realmGet$mu_avatar, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6861f, j4, false);
        }
        String realmGet$mu_id = video.realmGet$mu_id();
        if (realmGet$mu_id != null) {
            Table.nativeSetString(j2, aVar.f6862g, j4, realmGet$mu_id, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6862g, j4, false);
        }
        String realmGet$mu_name = video.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j2, aVar.f6863h, j4, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6863h, j4, false);
        }
        String realmGet$mv_comment = video.realmGet$mv_comment();
        if (realmGet$mv_comment != null) {
            Table.nativeSetString(j2, aVar.f6864i, j4, realmGet$mv_comment, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6864i, j4, false);
        }
        String realmGet$mv_created = video.realmGet$mv_created();
        if (realmGet$mv_created != null) {
            Table.nativeSetString(j2, aVar.f6865j, j4, realmGet$mv_created, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6865j, j4, false);
        }
        String realmGet$mv_img_url = video.realmGet$mv_img_url();
        if (realmGet$mv_img_url != null) {
            Table.nativeSetString(j2, aVar.f6867l, j4, realmGet$mv_img_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6867l, j4, false);
        }
        String realmGet$mv_like = video.realmGet$mv_like();
        if (realmGet$mv_like != null) {
            Table.nativeSetString(j2, aVar.f6868m, j4, realmGet$mv_like, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6868m, j4, false);
        }
    ...
    public void realmSet$is_cat_ads(int i2) {
        ...
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.r, i2);
    }
    ...
    public void realmSet$mv_play_height(int i2) {
        ...
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.n, i2);
    }
    ...
    public void realmSet$mv_play_width(int i2) {
        ...
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.p, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(video)) {
                ...
                if (realmGet$mu_avatar != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6861f, createRowWithPrimaryKey, false);
                }
                String realmGet$mu_id = video.realmGet$mu_id();
                if (realmGet$mu_id != null) {
                    Table.nativeSetString(j3, aVar.f6862g, createRowWithPrimaryKey, realmGet$mu_id, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6862g, createRowWithPrimaryKey, false);
                }
                String realmGet$mu_name = video.realmGet$mu_name();
                if (realmGet$mu_name != null) {
                    Table.nativeSetString(j3, aVar.f6863h, createRowWithPrimaryKey, realmGet$mu_name, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6863h, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_comment = video.realmGet$mv_comment();
                if (realmGet$mv_comment != null) {
                    Table.nativeSetString(j3, aVar.f6864i, createRowWithPrimaryKey, realmGet$mv_comment, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6864i, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_created = video.realmGet$mv_created();
                if (realmGet$mv_created != null) {
                    Table.nativeSetString(j3, aVar.f6865j, createRowWithPrimaryKey, realmGet$mv_created, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6865j, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_img_url = video.realmGet$mv_img_url();
                if (realmGet$mv_img_url != null) {
                    Table.nativeSetString(j3, aVar.f6867l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6867l, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_like = video.realmGet$mv_like();
                if (realmGet$mv_like != null) {
                    Table.nativeSetString(j3, aVar.f6868m, createRowWithPrimaryKey, realmGet$mv_like, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6868m, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.n, createRowWithPrimaryKey, video.realmGet$mv_play_height(), false);
                String realmGet$mv_play_url = video.realmGet$mv_play_url();
                if (realmGet$mv_play_url != null) {
