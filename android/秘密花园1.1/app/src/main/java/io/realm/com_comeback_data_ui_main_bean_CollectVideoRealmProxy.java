    ...
    */
    ...
    public static long insert(x xVar, CollectVideo collectVideo, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$name = collectVideo.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6884f, createRowWithPrimaryKey, realmGet$name, false);
            }
            Table.nativeSetLong(j2, aVar.f6886h, createRowWithPrimaryKey, collectVideo.realmGet$addTime(), false);
    ...
    public static long insertOrUpdate(x xVar, CollectVideo collectVideo, Map<e0, Long> map) {
        ...
        String realmGet$name = collectVideo.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6884f, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6884f, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6886h, j4, collectVideo.realmGet$addTime(), false);
        return j4;
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(collectVideo)) {
                ...
                if (realmGet$name != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6884f, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.f6886h, createRowWithPrimaryKey, collectVideo.realmGet$addTime(), false);
                j4 = j2;
            }
