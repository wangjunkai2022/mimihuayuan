    ...
    */
    ...
    public static long insert(x xVar, VideoCacheBean videoCacheBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$name = videoCacheBean.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6888f, createRowWithPrimaryKey, realmGet$name, false);
            }
            Table.nativeSetBoolean(j2, aVar.f6890h, createRowWithPrimaryKey, videoCacheBean.realmGet$downloadFinish(), false);
            String realmGet$cachePath = videoCacheBean.realmGet$cachePath();
            if (realmGet$cachePath != null) {
                Table.nativeSetString(j2, aVar.f6891i, createRowWithPrimaryKey, realmGet$cachePath, false);
            }
            String realmGet$tempPath = videoCacheBean.realmGet$tempPath();
            if (realmGet$tempPath != null) {
                Table.nativeSetString(j2, aVar.f6892j, createRowWithPrimaryKey, realmGet$tempPath, false);
            }
            String realmGet$md5 = videoCacheBean.realmGet$md5();
            if (realmGet$md5 != null) {
                Table.nativeSetString(j2, aVar.f6893k, createRowWithPrimaryKey, realmGet$md5, false);
            }
    ...
    public static long insertOrUpdate(x xVar, VideoCacheBean videoCacheBean, Map<e0, Long> map) {
        ...
        String realmGet$name = videoCacheBean.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6888f, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6888f, j4, false);
        }
        Table.nativeSetBoolean(j2, aVar.f6890h, j4, videoCacheBean.realmGet$downloadFinish(), false);
        String realmGet$cachePath = videoCacheBean.realmGet$cachePath();
        if (realmGet$cachePath != null) {
            Table.nativeSetString(j2, aVar.f6891i, j4, realmGet$cachePath, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6891i, j4, false);
        }
        String realmGet$tempPath = videoCacheBean.realmGet$tempPath();
        if (realmGet$tempPath != null) {
            Table.nativeSetString(j2, aVar.f6892j, j4, realmGet$tempPath, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6892j, j4, false);
        }
        String realmGet$md5 = videoCacheBean.realmGet$md5();
        if (realmGet$md5 != null) {
            Table.nativeSetString(j2, aVar.f6893k, j4, realmGet$md5, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6893k, j4, false);
        }
        return j4;
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videoCacheBean2)) {
                ...
                if (realmGet$name != null) {
                    ...
                    videoCacheBean = videoCacheBean2;
                    Table.nativeSetNull(j2, aVar.f6888f, createRowWithPrimaryKey, false);
                }
                Table.nativeSetBoolean(j2, aVar.f6890h, createRowWithPrimaryKey, videoCacheBean.realmGet$downloadFinish(), false);
                String realmGet$cachePath = videoCacheBean.realmGet$cachePath();
                if (realmGet$cachePath != null) {
                ...
                if (realmGet$tempPath != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6892j, createRowWithPrimaryKey, false);
                }
                String realmGet$md5 = videoCacheBean.realmGet$md5();
                if (realmGet$md5 != null) {
                    Table.nativeSetString(j2, aVar.f6893k, createRowWithPrimaryKey, realmGet$md5, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6893k, createRowWithPrimaryKey, false);
                }
            }
        }
    }
