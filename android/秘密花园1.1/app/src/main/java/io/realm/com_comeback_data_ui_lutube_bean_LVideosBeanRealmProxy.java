...
public class com_comeback_data_ui_lutube_bean_LVideosBeanRealmProxy extends LVideosBean implements n, a1 {
    ...
    */
    ...
    public static long insert(x xVar, LVideosBean lVideosBean, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$video_title != null) {
                Table.nativeSetString(j2, aVar.f6876g, createRowWithPrimaryKey, realmGet$video_title, false);
            }
            String realmGet$actor = lVideosBean.realmGet$actor();
            if (realmGet$actor != null) {
                Table.nativeSetString(j2, aVar.f6877h, createRowWithPrimaryKey, realmGet$actor, false);
            }
            String realmGet$thumb = lVideosBean.realmGet$thumb();
            if (realmGet$thumb != null) {
                Table.nativeSetString(j2, aVar.f6878i, createRowWithPrimaryKey, realmGet$thumb, false);
            }
            String realmGet$cover = lVideosBean.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6879j, createRowWithPrimaryKey, realmGet$cover, false);
            }
            Table.nativeSetLong(j2, aVar.f6880k, createRowWithPrimaryKey, lVideosBean.realmGet$upload_date(), false);
            Table.nativeSetLong(j2, aVar.f6881l, createRowWithPrimaryKey, lVideosBean.realmGet$release_date(), false);
            Table.nativeSetLong(j2, aVar.f6882m, createRowWithPrimaryKey, lVideosBean.realmGet$video_duration(), false);
    ...
    public static long insertOrUpdate(x xVar, LVideosBean lVideosBean, Map<e0, Long> map) {
        ...
        String realmGet$video_title = lVideosBean.realmGet$video_title();
        if (realmGet$video_title != null) {
            Table.nativeSetString(j2, aVar.f6876g, j4, realmGet$video_title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6876g, j4, false);
        }
        String realmGet$actor = lVideosBean.realmGet$actor();
        if (realmGet$actor != null) {
            Table.nativeSetString(j2, aVar.f6877h, j4, realmGet$actor, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6877h, j4, false);
        }
        String realmGet$thumb = lVideosBean.realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(j2, aVar.f6878i, j4, realmGet$thumb, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6878i, j4, false);
        }
        String realmGet$cover = lVideosBean.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6879j, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6879j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6880k, j4, lVideosBean.realmGet$upload_date(), false);
        Table.nativeSetLong(j2, aVar.f6881l, j4, lVideosBean.realmGet$release_date(), false);
        Table.nativeSetLong(j2, aVar.f6882m, j4, lVideosBean.realmGet$video_duration(), false);
    ...
    public void realmSet$video_duration(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6308f) {
                p pVar = vVar.f6305c;
                pVar.d().p(this.columnInfo.f6882m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6307e.f();
        this.proxyState.f6305c.u(this.columnInfo.f6882m, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lVideosBean)) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    Table.nativeSetLong(j3, aVar.f6882m, createRowWithPrimaryKey, lVideosBean.realmGet$video_duration(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lVideosBean)) {
                ...
                if (realmGet$video_title != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6876g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor = lVideosBean.realmGet$actor();
                if (realmGet$actor != null) {
                    Table.nativeSetString(j3, aVar.f6877h, createRowWithPrimaryKey, realmGet$actor, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6877h, createRowWithPrimaryKey, false);
                }
                String realmGet$thumb = lVideosBean.realmGet$thumb();
                if (realmGet$thumb != null) {
                    Table.nativeSetString(j3, aVar.f6878i, createRowWithPrimaryKey, realmGet$thumb, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6878i, createRowWithPrimaryKey, false);
                }
                String realmGet$cover = lVideosBean.realmGet$cover();
                if (realmGet$cover != null) {
                    Table.nativeSetString(j3, aVar.f6879j, createRowWithPrimaryKey, realmGet$cover, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6879j, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6880k, j5, lVideosBean.realmGet$upload_date(), false);
                Table.nativeSetLong(j3, aVar.f6881l, j5, lVideosBean.realmGet$release_date(), false);
                Table.nativeSetLong(j3, aVar.f6882m, j5, lVideosBean.realmGet$video_duration(), false);
