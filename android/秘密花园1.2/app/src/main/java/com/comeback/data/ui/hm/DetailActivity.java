...
public class DetailActivity extends BaseRefreshActivity {
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            ...
            try {
                ChapterInfo d2 = f.e.a.j.r.f.a.d(g0Var.b.H());
    ...
    public void c(Intent intent) {
        this.f1105e = (ItemInfo) intent.getParcelableExtra(e.a("XgwFCw=="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.u0(this.f1105e.getImage(), this.ivImg);
        this.tvTitle.setText(this.f1105e.getTitle());
        this.tvAuthor.setText(this.f1105e.getAuthor());
        this.tvUpdate.setText(this.f1105e.getUpdate());
        this.tvDesc.setText(this.f1105e.getDesc());
        t(g.d(x.P()).f(ItemInfo.class, e.a("XgY="), this.f1105e.getId()).size() != 0);
    }
    ...
    public void p(int i2) {
        f.e.a.j.i0.a a2 = c.a();
        boolean isHm = this.f1105e.isHm();
        String id = this.f1105e.getId();
        StringBuilder sb = new StringBuilder();
        sb.append(isHm ? f.e.a.j.r.f.a.a : f.e.a.j.r.f.a.b);
