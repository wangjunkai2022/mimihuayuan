...
public class DownloadActivity extends BaseActivity implements DownloadAdapter.a, c {
    ...
    public static String[] f1540f = {e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sNj5gIiokIidoMTcrOTJ+dg=="), e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")};
    ...
    public void c(Intent intent) {
        this.f1541c = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1542d = intent.getStringExtra(e.a("QhAP"));
    }
    ...
    public void e() {
        try {
            if (ContextCompat.checkSelfPermission(this, e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")) != 0) {
                ActivityCompat.requestPermissions(this, f1540f, 1);
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        ...
        if (aVar != null) {
            ...
            textView.setText(e.a("0c/Agffb3Yv4jonal9b5") + aVar.f3867e.getName());
            aVar.a = this;
        }
        if (TextUtils.isEmpty(this.f1542d) && TextUtils.isEmpty(this.f1541c)) {
            return;
        }
        AlertDialog.Builder title = new AlertDialog.Builder(this).setTitle(e.a("0e3zg8/J"));
        title.setMessage(e.a("0MnogebA3Yv4jona") + this.f1541c).setNeutralButton(e.a("0vLF"), b.a).setNegativeButton(e.a("0MnogebA3Yv4jona"), new DialogInterface.OnClickListener() { // from class: f.e.a.j.c0.c
    ...
    public final void l() {
        ...
        realmQuery.a(e.a("QhAP"), this.f1542d);
        if (((VideoCacheBean) realmQuery.c()) != null) {
            h.n1(this.f1541c + e.a("0tXRg9D83K/bgonHn/Dnj4zZhu7KlrGkm8ecg8DH"));
            return;
        }
        VideoCacheBean videoCacheBean = new VideoCacheBean(this.f1541c, this.f1542d);
        TextView textView = this.tvName;
