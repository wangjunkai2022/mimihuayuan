...
public class VSearchHeadAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SearchResult.DataBean.HotwordsBean> f2319c;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        HotWordsAdapter hotWordsAdapter = new HotWordsAdapter(this.a, this.f2320d);
        bVar.a.setAdapter(hotWordsAdapter);
        hotWordsAdapter.a(this.f2319c);
    }
