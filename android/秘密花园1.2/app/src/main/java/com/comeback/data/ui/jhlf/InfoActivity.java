...
public class InfoActivity extends BaseActivity {
    ...
    public static void l(InfoActivity infoActivity) {
        if (infoActivity != null) {
            ...
            sb.append(e.a("0f7Pjcni0LLgj6jnkMzij4/pi9nWlpe6m8WxhPjm"));
            StringBuffer stringBuffer = infoActivity.f1326c;
            sb.append(stringBuffer.deleteCharAt(stringBuffer.length() - 1).toString());
            sb.append(e.a("1OLuguL+0bDOgonYn/7LYdLE4YL1792L+I6J2pzS7o+N5IvL3JuGqJTynIHw3YTVk4ri8IzAgtTdx9P3/o/y8w=="));
            title.setMessage(sb.toString()).setNeutralButton(e.a("09nGgfv93LX+gaDP"), new f(infoActivity)).setNegativeButton(e.a("0MnogebA3J36jpfi"), new f.e.a.j.w.e(infoActivity)).create().show();
            return;
        }
        throw null;
    }
