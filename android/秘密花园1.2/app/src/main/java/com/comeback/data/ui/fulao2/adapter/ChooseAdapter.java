...
public class ChooseAdapter extends BaseAbstractAdapter<Host.StreamBean> {
    ...
    public static class Holder extends BaseViewHolder<Host.StreamBean> {
        ...
        public void a(Host.StreamBean streamBean) {
            ...
            boolean z = getAdapterPosition() == ChooseAdapter.f800e;
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f803c;
            ...
            public void a(View view) {
                Holder holder = this.f803c;
                if (holder.getAdapterPosition() != ChooseAdapter.f800e) {
                    VideoInfo.StreamHost = holder.b.getUrl();
                    holder.a.notifyItemChanged(ChooseAdapter.f800e);
                    ChooseAdapter.f800e = holder.getAdapterPosition();
                    PlayActivity playActivity = (PlayActivity) holder.a.f801d;
