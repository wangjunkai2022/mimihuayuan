...
public class SearchResultFragment extends BaseVRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<SpecialBean> {
        ...
        public void f(Object obj) {
            ...
            if (searchResultFragment.f1070j.equals(e.a("Bg=="))) {
            ...
            } else if (searchResultFragment.f1070j.equals(e.a("AQ=="))) {
    ...
    public void a() {
        this.f1070j = getArguments().getString(e.a("QxsTAQ=="));
        this.f1071k = getArguments().getString(e.a("WQMOAQ=="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public void l(int i2) {
        r rVar = new r();
        rVar.e(e.a("QxsTAQ=="), this.f1070j);
        rVar.d(e.a("RwMEAQ=="), Integer.valueOf(i2 - 1));
        rVar.d(e.a("RwMEATgaQ1Y="), 20);
        rVar.e(e.a("RAcCFggbd1IeAw=="), this.f1071k);
        g(f.e.a.j.n.p.e.b().d(g0.c(rVar.toString(), z.c(e.a("VhITCAIQWEcaCVpIEhkMBQxCAAwKAUpWB1tBEx5HWw==")))), new a(i2));
    }
}
