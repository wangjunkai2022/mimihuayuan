...
public class MMActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ MMActivity f1407c;

        public a(MMActivity_ViewBinding mMActivity_ViewBinding, MMActivity mMActivity) {
            this.f1407c = mMActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            MMActivity mMActivity = this.f1407c;
            if (mMActivity != null) {
    ...
    public void a() {
        MMActivity mMActivity = this.f1405c;
        if (mMActivity != null) {
            this.f1405c = null;
            mMActivity.tvArea = null;
            this.f1406d.setOnClickListener(null);
            this.f1406d = null;
            super.a();
            return;
        }
