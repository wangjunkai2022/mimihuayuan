...
public class ChapterAdapter extends BaseAbstractAdapter<String> {
    ...
    public static class Holder extends BaseViewHolder<String> {
        ...
        public void a(String str) {
            ...
            this.tvTitle.setTextColor(this.a.f1920e == getAdapterPosition() ? this.kmColorAccent : this.white);
            this.tvTitle.setText(this.f1921c);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1924c;
            ...
            public void a(View view) {
                Holder holder = this.f1924c;
                ChapterAdapter chapterAdapter = holder.a;
                if (chapterAdapter.f1919d != null) {
                    int i2 = chapterAdapter.f1920e;
                    chapterAdapter.f1920e = holder.getAdapterPosition();
                    holder.a.notifyItemChanged(i2);
                    ChapterAdapter chapterAdapter2 = holder.a;
                    chapterAdapter2.notifyItemChanged(chapterAdapter2.f1920e);
                    a aVar = holder.a.f1919d;
                    String str = holder.f1922d;
