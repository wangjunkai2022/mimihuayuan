...
public class VSpecialHeadAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public class a extends RecyclerView.ViewHolder {
        ...
        public a(VSpecialHeadAdapter vSpecialHeadAdapter, View view) {
            ...
            this.f2321c = (TextView) view.findViewById(R.id.tv_name);
            this.f2322d = (TextView) view.findViewById(R.id.tv_intro);
            this.b = (ImageView) view.findViewById(R.id.iv_like);
            this.f2323e = (TextView) view.findViewById(R.id.tv_like_num);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        aVar.f2321c.setText(this.b.getSpname());
        aVar.f2322d.setText(this.b.getIntro());
        aVar.f2323e.setText(this.b.getUpnum());
        aVar.b.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.d.m
