...
public class UserCenterActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1151e = intent.getStringExtra(e.a("XgY="));
        this.f1150d = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1152f = intent.getStringExtra(e.a("QhAP"));
        this.f1153g = intent.getBooleanExtra(e.a("XhEqCQoUXA=="), true);
    }
    ...
    public void e() {
        ...
        this.tvName.setText(this.f1150d);
        h.z0(this.f1152f, this.ivHead);
        this.ivImg.setColorFilter(this.f1153g ? this.basic_primary_text : this.basic_third_text);
        this.ivVideo.setColorFilter(this.f1153g ? this.basic_third_text : this.basic_primary_text);
    }
    ...
    public void p(int i2) {
        ...
        if (this.f1153g) {
            m.e<ImageList> g2 = f.e.a.j.s.e.b.a().g(this.f1151e, hashMap, f.e.a.k.b.v0);
            a aVar = new a(i2);
            g2.d(m.r.a.a()).b(m.l.b.a.a()).c(aVar);
            this.a.b(aVar);
            return;
        }
        m.e<VideoList> b2 = f.e.a.j.s.e.b.a().b(this.f1151e, hashMap, f.e.a.k.b.v0);
        b bVar = new b(i2);
