...
public class GDianActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f872c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.m.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f872c);
    }
