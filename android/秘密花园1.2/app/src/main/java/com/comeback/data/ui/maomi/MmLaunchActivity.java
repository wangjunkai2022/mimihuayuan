...
public class MmLaunchActivity extends BaseActivity {
    ...
    public static String[] f1607g = {e.a("BlBXSlpGDx1CVw1JSl9R"), e.a("BldTSlpDAB1CVwJJTVk=")};
    public b0 b;
    ...
    public ArrayList<f> f1609d = new ArrayList<>();

    /* renamed from: f  reason: collision with root package name */
    public g f1611f = new a();
    ...
    public class a implements g {
        ...
        public void c(f fVar, h0 h0Var) {
            if (h0Var.f6524e > 300) {
                if (MmLaunchActivity.this.f1609d.size() == 1) {
                    MmLaunchActivity.this.m();
                    return;
                }
                return;
            }
            Iterator<f> it = MmLaunchActivity.this.f1609d.iterator();
            while (it.hasNext()) {
                it.next().cancel();
            }
            MmLaunchActivity mmLaunchActivity = MmLaunchActivity.this;
            if (mmLaunchActivity.f1610e) {
                return;
            }
            mmLaunchActivity.f1610e = true;
            String replace = fVar.S().b.f6854j.replace(e.a("GAMTDUQHVlwfFRsDFwcCAlk="), "");
            b.f4050h = replace;
    ...
    public static void l(MmLaunchActivity mmLaunchActivity) {
        if (mmLaunchActivity != null) {
            int length = f1607g.length;
            String[] strArr = new String[length];
            for (int i2 = 0; i2 < length; i2++) {
                String str = f1607g[i2];
    ...
    public void onDestroy() {
        ...
        ArrayList<f> arrayList = this.f1609d;
        if (arrayList != null) {
