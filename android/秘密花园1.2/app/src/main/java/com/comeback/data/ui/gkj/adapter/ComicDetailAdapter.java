...
public class ComicDetailAdapter extends BaseAbstractAdapter<ComicDetail.DataEntity.ChaptersEntity> {
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1010c;
            ...
            public void a(View view) {
                Holder holder = this.f1010c;
                a aVar = holder.a.f1008d;
                if (aVar != null) {
                    ComicDetailActivity comicDetailActivity = (ComicDetailActivity) aVar;
                    ComicReadActivity.p(comicDetailActivity, comicDetailActivity.b, (ArrayList) comicDetailActivity.f921e.b, holder.b.getId());
                }
            }
        }
