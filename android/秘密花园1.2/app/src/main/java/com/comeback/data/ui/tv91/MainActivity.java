...
public class MainActivity extends BaseActivity {
    ...
    public NovelFragment f2161c;

    /* renamed from: d  reason: collision with root package name */
    public BottomNavigationView.OnNavigationItemSelectedListener f2162d = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.o0.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f2162d);
        j b = j.b();
        ...
        textView.setOnClickListener(new f.e.a.j.o0.e(this, create));
    ...
    public /* synthetic */ boolean l(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.navigation_novel /* 2131296629 */:
                ...
                return true;
            case R.id.navigation_star /* 2131296636 */:
    ...
    public void onBackPressed() {
        ...
        if (this.viewPager.getCurrentItem() == 3) {
            NovelFragment novelFragment = this.f2161c;
