...
public class VideoListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1881m = getArguments().getInt(e.a("WgcNETQaXQ=="), 0);
        this.f1877i = getArguments().getString(e.a("QQsHAQQsTUoDAw=="), "");
        this.f1878j = getArguments().getString(e.a("WBAHARk="), "");
        this.f1879k = getArguments().getString(e.a("Qw0T"), "");
        this.f1880l = getArguments().getString(e.a("VAMXAQwcS0o="), "");
    }
    ...
    public RecyclerView.LayoutManager i() {
        if (this.f1877i.equals(e.a("Ww0NAw=="))) {
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("QQsHAQQsTUoDAw=="), this.f1877i);
        hashMap.put(e.a("WBAHARk="), this.f1878j);
        hashMap.put(e.a("Qw0T"), this.f1879k);
        hashMap.put(e.a("VAMXAQwcS0o="), this.f1880l);
        g(f.e.a.j.h0.m.e.a().d(this.f1881m, hashMap), new a(i2));
    }
}
