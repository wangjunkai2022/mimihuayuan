...
public class ActorFragment extends BaseRefreshFragment {
    ...
    public String[] f1499i = {"", e.a("dg=="), e.a("dQ=="), e.a("dA=="), e.a("cw=="), e.a("cg=="), e.a("cQ=="), e.a("cA==")};

    /* renamed from: j  reason: collision with root package name */
    public TabLayout.OnTabSelectedListener f1500j = new a();
    @BindView
    ...
    public void f() {
        ...
        this.tab1.addOnTabSelectedListener(this.f1500j);
        this.tab2.addOnTabSelectedListener(this.f1500j);
        super.f();
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(f.b.a.a.a.i(selectedTabPosition == 0 ? "QQsGExg=" : "QQEMEQUH", hashMap, e.a("WBAHARk="), "VBcT"), this.f1499i[selectedTabPosition2]);
