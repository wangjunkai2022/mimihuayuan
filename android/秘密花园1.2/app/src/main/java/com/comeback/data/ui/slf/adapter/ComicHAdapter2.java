...
public class ComicHAdapter2 extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f2061c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(ComicHAdapter2 comicHAdapter2, View view) {
            ...
            this.f2062c = (TextView) view.findViewById(R.id.tv_state);
            this.f2063d = (TextView) view.findViewById(R.id.tv_watch);
            this.f2064e = (TextView) view.findViewById(R.id.tv_collect);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        SLFItemBean sLFItemBean = this.f2061c.get(i2);
        h.N0(sLFItemBean.getImg(), bVar.a, 0);
        bVar.b.setText(sLFItemBean.getName());
        bVar.f2062c.setText(sLFItemBean.getTagStr());
        bVar.f2063d.setText(sLFItemBean.getClick());
        bVar.f2064e.setText(sLFItemBean.getFavorite());
