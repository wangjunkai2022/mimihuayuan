...
public class App extends MultiDexApplication {
    ...
    public static e b(Context context, i iVar) {
        ...
        ImageView imageView = bVar.f6245e;
        ImageView imageView2 = bVar.f6246f;
    ...
    public void c(String str) {
        ...
        try {
            if (TextUtils.isEmpty(str)) {
                L = j.b().d(f.e.a.e.a("VA0NAgIUZlASBVwC"));
            } else {
                L = h.L(str);
                j.b().h(f.e.a.e.a("VA0NAgIUZlASBVwC"), L);
            }
            if (TextUtils.isEmpty(L)) {
                return;
            }
            ConfigBean configBean = (ConfigBean) new f.i.b.j().d(L, ConfigBean.class);
            f104e = configBean;
    ...
    public void onCreate() {
        ...
        j.b();
        x.R(this);
        b0.a aVar = new b0.a(g.a.a.f6262g);
