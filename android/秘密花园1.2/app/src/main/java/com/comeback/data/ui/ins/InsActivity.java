...
public class InsActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1146c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.s.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1146c);
    }
