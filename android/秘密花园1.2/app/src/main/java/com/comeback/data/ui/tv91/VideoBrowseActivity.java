...
public class VideoBrowseActivity extends BaseRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<VideoList> {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ int f2181f;
    ...
    public void c(Intent intent) {
        this.f2180f = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f2178d = intent.getIntExtra(e.a("XgY="), -1);
        this.f2179e = intent.getIntExtra(e.a("RBYCFiIX"), -1);
    }
    ...
    public void e() {
        ...
        super.e();
        this.tvTitle.setText(this.f2180f);
    ...
    public void p(int i2) {
        m.e<VideoList> e2;
        if (this.f2178d != -1) {
            e2 = b.a().c(TiktopParam.buildTagListParams(this.f2178d, i2));
        } else {
            e2 = b.a().e(TiktopParam.buildStarListParams(this.f2179e, i2));
        }
        k(e2, new a(i2));
    }
}
