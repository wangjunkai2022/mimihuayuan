...
public class SpecialDetailActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1251d = intent.getStringExtra(e.a("XgY="));
        this.f1252e = intent.getStringExtra(e.a("QhAP"));
    }
    ...
    public void p(int i2) {
        ...
        hashMap.put(f.b.a.a.a.i("BlQ=", hashMap, f.b.a.a.a.G(i2, hashMap, e.a("RwMEAQ=="), "WwsODR8="), "RBIGBwISVWwaAg=="), this.f1251d);
