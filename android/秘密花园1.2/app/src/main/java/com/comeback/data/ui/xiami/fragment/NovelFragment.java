...
public class NovelFragment extends BaseRefreshFragment {
    ...
    public Category.DataBean.InfoBean f2249i;

    /* loaded from: classes.dex */
    public class a extends BaseRefreshFragment.a<NovelList> {

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ int f2250f;
    ...
    public void a() {
        this.f2249i = (Category.DataBean.InfoBean) getArguments().getParcelable(e.a("UwMXBSkWWF0="));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(f.b.a.a.a.i("QAcBOwQVX1oQD1UL", hashMap, f.b.a.a.a.G(this.f116g, hashMap, e.a("RwMEASUc"), "VAoCCgUWVQ=="), "VAoKCA86XQ=="), String.valueOf(this.f2249i.getChildId()));
