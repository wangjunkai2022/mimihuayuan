...
public class ComicItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<MimeiComicItem> f1765c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(ComicItemAdapter comicItemAdapter, View view) {
            ...
            this.f1766c = (TextView) view.findViewById(R.id.tv_state);
            this.f1767d = (TextView) view.findViewById(R.id.tv_state2);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        MimeiComicItem mimeiComicItem = this.f1765c.get(i2);
        bVar.b.setText(mimeiComicItem.getName());
        h.J0(mimeiComicItem.getFull_cover_path(), bVar.a);
        bVar.f1767d.setVisibility(mimeiComicItem.isEnd() ? 8 : 0);
        bVar.f1766c.setText(mimeiComicItem.getChapterState());
