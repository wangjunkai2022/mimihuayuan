...
public class TypeListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f855i = getArguments().getString(e.a("QxsTAQ=="));
        this.f856j = getArguments().getInt(e.a("VAMXAQwcS0osD1A="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public BaseAbstractAdapter h() {
        return new VideoListAdapter(getContext(), this.f855i.equals(e.a("VA0VARk=")));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(f.b.a.a.a.i("Ww0NAw==", hashMap, f.b.a.a.a.i("QwsOAQ==", hashMap, f.b.a.a.a.G(i2, hashMap, e.a("RwMEAQ=="), "WBAHARk="), "QQsHAQQsTUoDAw=="), "QxsTAQ=="), this.f855i);
        hashMap.put(f.b.a.a.a.G(this.f856j, hashMap, e.a("VAMXAQwcS0o="), "QwsOARgHWF4D"), String.valueOf(System.currentTimeMillis() / 1000));
