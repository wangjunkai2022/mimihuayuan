...
public class IQYMainActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1205c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.t.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1205c);
    }
