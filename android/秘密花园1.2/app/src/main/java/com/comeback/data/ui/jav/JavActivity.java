...
public class JavActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1279c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.v.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1279c);
        j b = j.b();
        ...
        textView.setOnClickListener(new f.e.a.j.v.b(this, create));
