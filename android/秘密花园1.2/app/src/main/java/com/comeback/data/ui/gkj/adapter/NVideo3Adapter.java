...
public class NVideo3Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<NavBean.DataEntity.ArticleVOSEntity> f1022c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(NVideo3Adapter nVideo3Adapter, View view) {
            ...
            this.f1023c = (TextView) view.findViewById(R.id.tv_intro);
            this.f1024d = (TextView) view.findViewById(R.id.tv_duration);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        NavBean.DataEntity.ArticleVOSEntity articleVOSEntity = this.f1022c.get(i2);
        h.u0(articleVOSEntity.getCover(), bVar.a);
        bVar.f1023c.setText(articleVOSEntity.getInfo());
        bVar.f1023c.setVisibility(8);
        try {
            bVar.f1024d.setText(h.f1(Integer.valueOf(articleVOSEntity.getVideoTime()).intValue()));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
