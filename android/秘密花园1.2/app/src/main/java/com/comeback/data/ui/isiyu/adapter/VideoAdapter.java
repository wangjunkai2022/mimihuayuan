...
import com.comeback.data.ui.isiyu.MoviePlayActivity;
...
public class VideoAdapter extends BaseAbstractAdapter<Video> {
    ...
    public static class Holder extends BaseViewHolder<Video> {
        ...
        public void a(Video video) {
            Video video2 = video;
            this.b = video2;
            this.tvTitle.setText(video2.getTitle());
            if (video2.getCoins() > 0) {
                this.tvIntro.setText(e.a("0u3Jgv/c37/yj5bjkM3r"));
            } else {
                this.tvIntro.setText(video2.getTimeAndDuration());
            }
            h.G0(video2.getCover_url(), this.ivCover);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1262c;
            ...
            public void a(View view) {
                Holder holder = this.f1262c;
                MoviePlayActivity.l(holder.a.a, holder.b.getId());
            }
        }
    ...
    public Holder f(@NonNull ViewGroup viewGroup) {
        return new Holder(this.f107c.inflate(R.layout.item_isiyu_video, viewGroup, false), this);
    }
