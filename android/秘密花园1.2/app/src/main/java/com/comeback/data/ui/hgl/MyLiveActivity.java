...
public class MyLiveActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f1093c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.q.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f1093c);
    }

    public /* synthetic */ boolean l(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.navigation_channel1 /* 2131296610 */:
                this.viewPager.setCurrentItem(1);
                return true;
            case R.id.navigation_channel2 /* 2131296611 */:
