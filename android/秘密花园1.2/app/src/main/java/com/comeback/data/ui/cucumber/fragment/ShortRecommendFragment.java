...
public class ShortRecommendFragment extends BaseRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<VideoList> {
        ...
        public void f(Object obj) {
            ...
            if (this.f527f == 1) {
                ShortRecommendFragment.this.f117h.c();
            }
            ShortRecommendFragment.this.f117h.a(videoList.getData());
        }
    }

    /* loaded from: classes.dex */
    public class b extends PagerSnapHelper {
        public b(ShortRecommendFragment shortRecommendFragment) {
        }
