...
public class ActorFragment extends BaseRefreshFragment {
    ...
    public String[] f1863i = {"", e.a("dg=="), e.a("dQ=="), e.a("dA=="), e.a("cw=="), e.a("cg=="), e.a("cQ=="), e.a("cA==")};

    /* renamed from: j  reason: collision with root package name */
    public TabLayout.OnTabSelectedListener f1864j = new a();
    @BindView
    ...
    public void f() {
        ...
        this.tab1.addOnTabSelectedListener(this.f1864j);
        this.tab2.addOnTabSelectedListener(this.f1864j);
        super.f();
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("VBcT"), this.f1863i[selectedTabPosition2]);
