...
public class LoufengListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1937i = getArguments().getInt(e.a("RxAMEg=="));
        this.f1938j = getArguments().getInt(e.a("VAsXHQ=="));
    }
    ...
    public void l(int i2) {
        g(b.a().a(d.b(i2, this.f1937i, this.f1938j), System.currentTimeMillis()), new a());
    }
}
