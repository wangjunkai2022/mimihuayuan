...
public class NTypeFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1789i = getArguments().getInt(e.a("QxsTAQ=="));
        this.f1790j = getArguments().getString(e.a("XAca"));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("QxsTAQ=="), String.valueOf(this.f1789i));
        if (this.f1790j.equals(e.a("RQMNDwIdXg=="))) {
            hashMap.put(e.a("RQMNAw4="), e.a("BA=="));
        }
        hashMap.put(f.b.a.a.a.i("Blc=", hashMap, e.a("VA0WCh8A"), "RwMEARg="), String.valueOf(i2));
        g(f.a().j(this.f1790j, hashMap), new a(i2));
    }
}
