...
public class ActorDetailActivity extends BaseRefreshActivity {
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            ...
            try {
                ActorDetail b = f.e.a.j.v.e.a.b(g0Var.b.H());
                if (this.a == 1) {
    ...
    public void c(Intent intent) {
        this.f1275d = intent.getStringExtra(e.a("QhAP"));
        this.f1276e = intent.getStringExtra(e.a("Xg8E"));
    }
    ...
    public void p(int i2) {
        f.e.a.j.i0.a a2 = c.a();
        d<i0> b = a2.b(f.e.a.j.v.e.a.a + this.f1275d + e.a("CBICAw5O") + i2, b.h0, b.f4045c);
        this.f1277f = b;
        b.X(new a(i2));
    }
}
