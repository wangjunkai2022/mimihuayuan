...
public class ComicTypeFragment extends BaseVRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<ComicHomeType> {
        ...
        public void f(Object obj) {
            ...
            if (comicTypeFragment.f1787j != 0 && comicHomeType.getSuccess().getNewX() != null) {
    ...
    public void a() {
        this.f1787j = getArguments().getInt(e.a("QxsTAQ=="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public void l(int i2) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(f.b.a.a.a.G(this.f1787j, hashMap, e.a("QxsTAQ=="), "VAoCDQU="), d.b);
