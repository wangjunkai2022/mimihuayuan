...
public class XHLBrowseActivity extends BaseActivity {
    ...
    public class a extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            if (!str.contains(e.a("Wg0HWR0aXEQHDkYCGQ4="))) {
                return str.contains(e.a("Xw0OAUUDUUNMC1sDRRkTClQH"));
            }
    ...
    public class b extends WebChromeClient {
        ...
        public IX5WebChromeClient.CustomViewCallback f2207c;
        ...
        public void onHideCustomView() {
            IX5WebChromeClient.CustomViewCallback customViewCallback = this.f2207c;
        ...
        public void onShowCustomView(View view, IX5WebChromeClient.CustomViewCallback customViewCallback) {
            ...
            this.a = view;
            this.b = webView;
            this.f2207c = customViewCallback;
        }
    }
