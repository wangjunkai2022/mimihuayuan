...
public class Tag3Adapter extends BaseAbstractAdapter<ScreenBean.StateBean> {
    ...
    public static class Holder extends BaseViewHolder<ScreenBean.StateBean> {
        ...
        public void a(ScreenBean.StateBean stateBean) {
            ...
            textView.setBackground(adapterPosition == tag3Adapter.f1037d ? tag3Adapter.a.getDrawable(R.drawable.bg_radius_red_stroke) : null);
            this.tvTag.setTextColor(getAdapterPosition() == this.a.f1037d ? Color.parseColor(e.a("FAQFUF9HDQ==")) : this.thirdText);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1040c;
            ...
            public void a(View view) {
                Holder holder = this.f1040c;
                int adapterPosition = holder.getAdapterPosition();
                Tag3Adapter tag3Adapter = holder.a;
                int i2 = tag3Adapter.f1037d;
                tag3Adapter.f1037d = adapterPosition;
                tag3Adapter.notifyItemChanged(i2);
                holder.a.notifyItemChanged(adapterPosition);
                holder.a.f1038e.a(adapterPosition);
            }
        }
    ...
    public String f() {
        return ((ScreenBean.StateBean) this.b.get(this.f1037d)).getKey();
    }
