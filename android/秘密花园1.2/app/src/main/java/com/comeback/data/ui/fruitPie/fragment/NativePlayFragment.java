...
public class NativePlayFragment extends BaseFragment {
    ...
    public static void h(NativePlayFragment nativePlayFragment, FilmInfo filmInfo) {
        if (nativePlayFragment != null) {
            ...
            nativePlayFragment.f759g = TextUtils.isEmpty(dataEntity.getUrl()) ? dataEntity.getDownload_url() : dataEntity.getUrl();
            return;
        }
        throw null;
    }
    ...
    @Override // com.comeback.data.base.BaseFragment
    public void e() {
        if (TextUtils.isEmpty(f758h)) {
            return;
        }
        this.tvError.setVisibility(8);
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(e.a("UQsPCTQaXQ=="), f758h);
