...
public class NovelReadActivity extends BaseActivity {
    ...
    public List<ChapterBean> f2024d;
    ...
    public class a extends j<ComicDetail> {
        ...
        public void f(ComicDetail comicDetail) {
            NovelReadActivity.this.f2024d = comicDetail.getChapter();
            ...
            chapterAdapter.f2051e = 0;
            chapterAdapter.f2050d = new ChapterAdapter.a() { // from class: f.e.a.j.l0.b
            ...
            chapterAdapter.a(novelReadActivity.f2024d);
        }
    }
    ...
    public void c(Intent intent) {
        this.f2025e = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public /* synthetic */ void n(LinearLayoutManager linearLayoutManager, int i2) {
        ...
        m();
        o();
        linearLayoutManager.scrollToPosition(this.f2026f);
    }

    public final void o() {
        ChapterBean chapterBean = this.f2024d.get(this.f2026f);
