...
public class ImageReadActivity extends BaseActivity {
    ...
    public ImageList.DataBean f2209c;
    @BindView
    ...
    public void c(Intent intent) {
        this.f2209c = (ImageList.DataBean) intent.getParcelableExtra(f.e.a.e.a("UwMXBQ=="));
    }
    ...
    public void e() {
        ...
        hashMap.put(f.e.a.e.a("UAMPCA4BQHoX"), this.f2209c.getGalleryId());
        hashMap.put(f.e.a.e.a("VAoCCgUWVQ=="), f.e.a.e.a("QAcBOwQVX1oQD1UL"));
        k(a2.i(hashMap), new a());
        this.tvTitle.setText(this.f2209c.getGalleryTitle());
        TextView textView = this.tvType;
        textView.setText(f.e.a.e.a("0NPYgfX41o/p") + this.f2209c.getCategoryTitle());
        TextView textView2 = this.tvCount;
        textView2.setText(f.e.a.e.a("0ffTjez81o/p") + this.f2209c.getGalleryCounts());
        TextView textView3 = this.tvTime;
        textView3.setText(f.e.a.e.a("0fXVjfzH1o/p") + h.O0(this.f2209c.getAddTime()));
    }
}
