...
public class VideoPlayActivity extends BaseActivity {
    ...
    @Override // com.comeback.data.base.BaseActivity
    public void e() {
        this.f1390c = h.h(this, this.videoView);
        ...
        this.f1390c.setPlayUri(this.b.getMv_play_url());
        this.f1390c.startPlayer();
        h.h1(this.f1390c.getVideoPlayerView(), this.b.getMv_play_url());
        ...
        this.videoDetailLikeImg.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.x.d
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1390c.onConfigurationChanged(configuration);
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        this.f1390c.onDestroy();
        super.onDestroy();
    }
