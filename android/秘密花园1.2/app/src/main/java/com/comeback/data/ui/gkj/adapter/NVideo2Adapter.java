...
public class NVideo2Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(NVideo2Adapter nVideo2Adapter, View view) {
            ...
            this.f1021d = (TextView) view.findViewById(R.id.tv_duration);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        bVar.f1020c.setVisibility(8);
        try {
            bVar.f1021d.setText(h.f1(Integer.valueOf(articleVOSEntity.getVideoTime()).intValue()));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
