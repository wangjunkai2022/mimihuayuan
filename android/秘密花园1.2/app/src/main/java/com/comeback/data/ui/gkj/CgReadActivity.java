...
public class CgReadActivity extends BaseActivity {
    ...
    public class a extends j<ComicRead> {
        ...
        public void f(ComicRead comicRead) {
            ...
            PicAdapter picAdapter = cgReadActivity.f917c;
            if (picAdapter == null) {
                cgReadActivity.f917c = new PicAdapter(cgReadActivity);
                ...
                cgReadActivity3.rvList.setAdapter(cgReadActivity3.f917c);
                return;
            }
            picAdapter.c();
        }
