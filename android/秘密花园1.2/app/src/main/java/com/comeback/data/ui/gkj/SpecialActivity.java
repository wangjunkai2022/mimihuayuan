...
public class SpecialActivity extends BaseVRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<SpecialBean> {
        ...
        public void f(Object obj) {
            ...
            int i2 = specialActivity.f975g;
            if (i2 == 4) {
                g m2 = f.b.a.a.a.m(2, 5, 5);
                m2.s = true;
                int i3 = specialActivity.f974f;
                if (i3 == 3) {
    ...
    public void c(Intent intent) {
        ...
        this.f973e = intent.getIntExtra(e.a("XgY="), 0);
        this.f974f = intent.getIntExtra(e.a("QxsTAQ=="), 0);
        this.f975g = intent.getIntExtra(e.a("RBYaCA4="), 0);
    }
    ...
    public void p(int i2) {
        k(f.e.a.j.n.p.e.b().l(this.f973e, i2 - 1, 20), new a(i2));
    }
}
