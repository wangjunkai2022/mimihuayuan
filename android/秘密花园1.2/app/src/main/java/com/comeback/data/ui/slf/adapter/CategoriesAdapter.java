...
public class CategoriesAdapter extends BaseAbstractAdapter<CategoriesBean> {
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f2049c;
            ...
            public void a(View view) {
                ...
                if (holder != null) {
                    ...
                    if (e.a("RQMNDw==").equals(key)) {
                        ...
                        RankActivity.n(categoriesAdapter.a, categoriesAdapter.f2047d);
                        return;
                    } else if (e.a("RBIGBwISVQ==").equals(key)) {
                        CategoriesAdapter categoriesAdapter2 = holder.b;
                        SpecialActivity.t(categoriesAdapter2.a, categoriesAdapter2.f2047d);
                        return;
                    } else {
                        CatIdActivity.v(holder.b.a, str, holder.a.getName(), holder.b.f2047d);
                        return;
                    }
                }
                throw null;
