...
public class VideoDetailActivity extends BaseActivity {
    ...
    public static void l(VideoDetailActivity videoDetailActivity) {
        if (!TextUtils.isEmpty(videoDetailActivity.f1282d.getError())) {
            h.n1(videoDetailActivity.f1282d.getError());
            return;
        }
        videoDetailActivity.tvTitle.setText(videoDetailActivity.f1282d.getName());
        h.u0(videoDetailActivity.f1282d.getImg(), videoDetailActivity.ivCover);
        if (!TextUtils.isEmpty(videoDetailActivity.f1282d.getPreview_video())) {
            videoDetailActivity.tvPlay.setVisibility(0);
        }
        videoDetailActivity.tvUid.setText(videoDetailActivity.f1282d.getUid());
        videoDetailActivity.tvDate.setText(videoDetailActivity.f1282d.getDate());
        videoDetailActivity.tvDuration.setText(videoDetailActivity.f1282d.getDuration());
        videoDetailActivity.tvShop.setText(videoDetailActivity.f1282d.getShop());
        videoDetailActivity.tvPublisher.setText(videoDetailActivity.f1282d.getPublisher());
        videoDetailActivity.tvScore.setText(videoDetailActivity.f1282d.getScore());
        videoDetailActivity.tvActor.setText(videoDetailActivity.f1282d.getActor());
        videoDetailActivity.tvTag.setText(videoDetailActivity.f1282d.getTag());
        if (videoDetailActivity.f1282d.getPreview_images() != null && videoDetailActivity.f1282d.getPreview_images().size() != 0) {
            videoDetailActivity.rlPreview.setVisibility(0);
            TextView textView = videoDetailActivity.tvMoreImg;
            textView.setText(e.a("0ufLjejb") + videoDetailActivity.f1282d.getPreview_images().size());
            ...
            picAdapter.a(videoDetailActivity.f1282d.getBigPreview_images());
        } else {
            videoDetailActivity.rlPreview.setVisibility(8);
        }
        if (videoDetailActivity.f1282d.getSameVideo() != null && videoDetailActivity.f1282d.getSameVideo().size() != 0) {
            ...
            hVideoAdapter.a(videoDetailActivity.f1282d.getSameVideo());
        } else {
            videoDetailActivity.llSame.setVisibility(8);
        }
        if (videoDetailActivity.f1282d.getGuessLike() != null && videoDetailActivity.f1282d.getGuessLike().size() != 0) {
            ...
            hVideoAdapter2.a(videoDetailActivity.f1282d.getGuessLike());
        } else {
            videoDetailActivity.llGuess.setVisibility(8);
        }
        if (videoDetailActivity.f1282d.getDownloads() != null && videoDetailActivity.f1282d.getDownloads().size() != 0) {
            ...
            downloadAdapter.a(videoDetailActivity.f1282d.getDownloads());
            return;
        }
    ...
    public void e() {
        j(-1);
        d<i0> b = c.a().b(this.b, b.h0, b.f4045c);
        this.f1281c = b;
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.tv_more_img) {
            PicBrowseActivity.l(this, this.f1282d.getBigPreview_images());
        } else if (id == R.id.tv_play) {
            PlayActivity.l(this, this.f1282d.getPreview_video());
