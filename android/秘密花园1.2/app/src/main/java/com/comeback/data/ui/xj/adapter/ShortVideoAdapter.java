...
import d.c.c;
import f.e.a.e;
import f.e.a.j.s0.d.p;
import f.e.a.j.s0.d.q;
import f.e.a.j.s0.d.r;
...
public class ShortVideoAdapter extends BaseAbstractAdapter<VideoBean> {
    ...
    public static class TiktopHolder extends BaseViewHolder<VideoBean> {
        ...
        public ShortVideoAdapter f2300c;

        /* renamed from: d  reason: collision with root package name */
        public VideoBean f2301d;
        @BindView
        ...
        public TiktopHolder(View view, ShortVideoAdapter shortVideoAdapter) {
            super(view);
            this.b = new a();
            this.f2300c = shortVideoAdapter;
        }

        @Override // com.comeback.data.base.BaseViewHolder
        public void a(VideoBean videoBean) {
            VideoBean videoBean2 = videoBean;
            this.f2301d = videoBean2;
            this.tvTitle.setText(videoBean2.getTitle());
            this.tvTime.setText(videoBean2.getCreatetime());
            ExoUserPlayer h2 = h.h((Activity) this.f2300c.a, this.videoView);
            this.a = h2;
            ...
            this.mIvPlay.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.d.b
        ...
        public final void c() {
            if (this.a.getCurrentPosition() <= 500) {
                if (TextUtils.isEmpty(this.f2301d.getPlay())) {
                    e.a("aD08Ow==");
                    getAdapterPosition();
                    e.a("3+zUgeTl36HegKDZnfbTjqri");
                    m.e<PlayUrl> e2 = b.a().e(this.f2301d.getVodid());
