...
public class SearchResultActivity extends BaseRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<ArrayList<MMList.DataEntity>> {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ int f1332f;
    ...
    public void c(Intent intent) {
        this.f1329d = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1330e = intent.getStringExtra(e.a("XgY="));
        this.f1331f = intent.getStringExtra(e.a("XAca"));
    }
    ...
    public void e() {
        ...
        sb.append(TextUtils.isEmpty(this.f1329d) ? e.a("0ufLg8Dq") : this.f1329d);
        sb.append(e.a("Gg=="));
    ...
    public void p(int i2) {
        ...
        if (TextUtils.isEmpty(this.f1330e)) {
            a2 = c.a().d(i2, this.f1331f);
        } else {
            a2 = c.a().a(i2, this.f1330e, this.f1331f);
        }
        k(a2, new a(i2));
    }
}
