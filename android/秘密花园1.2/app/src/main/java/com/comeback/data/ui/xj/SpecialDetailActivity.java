...
public class SpecialDetailActivity extends BaseVRefreshActivity {
    ...
    public static void u(SpecialDetailActivity specialDetailActivity, Special special) {
        if (specialDetailActivity != null) {
            specialDetailActivity.f2285e = special.getData().getRow();
            specialDetailActivity.v();
            specialDetailActivity.f2286f = special;
    ...
    public void c(Intent intent) {
        this.f2285e = (Channel.DataBean.RowsBean) intent.getParcelableExtra(e.a("UwMXBQ=="));
        this.f2287g = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void p(int i2) {
        ...
        if (TextUtils.isEmpty(this.f2287g)) {
            this.f2287g = this.f2285e.getSpid();
        }
        k(b.a().c(this.f2287g), new a());
        v();
    }

    public final void v() {
        if (this.f2285e == null || this.f2288h) {
            return;
        }
        this.f2288h = true;
        this.f119d.b(new VSpecialHeadAdapter(this, new m(), this.f2285e));
    }
}
