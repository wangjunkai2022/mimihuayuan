...
public class GifDrawable extends Drawable implements f.b, Animatable, Animatable2Compat {
    ...
    public void a() {
        ...
        invalidateSelf();
        f.a aVar = this.a.a.f3799j;
        if ((aVar != null ? aVar.f3804e : -1) == this.a.a.a.d() - 1) {
            this.f92f++;
        }
        int i2 = this.f93g;
    ...
    public final void d() {
        ...
        if (this.a.a.a.d() == 1) {
            ...
            f fVar = this.a.a;
            if (!fVar.f3800k) {
                if (!fVar.f3792c.contains(this)) {
                    boolean isEmpty = fVar.f3792c.isEmpty();
                    fVar.f3792c.add(this);
                    if (isEmpty && !fVar.f3795f) {
                        fVar.f3795f = true;
                        fVar.f3800k = false;
                        fVar.a();
                    }
    ...
    public final void e() {
        this.b = false;
        f fVar = this.a.a;
        fVar.f3792c.remove(this);
        if (fVar.f3792c.isEmpty()) {
            fVar.f3795f = false;
        }
    }
