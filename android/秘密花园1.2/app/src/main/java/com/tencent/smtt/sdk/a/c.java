...
public class c {
    ...
    public static class a {
        ...
        public String f2604d = "0";

        /* renamed from: e  reason: collision with root package name */
        public String f2605e = null;
    }
    ...
    public static boolean c(Context context) {
        ...
        boolean z = false;
        try {
            if (Long.valueOf(a2.f2604d).longValue() >= 6001500) {
                z = true;
            }
    ...
    */
    ...
    public static a a(Context context) {
        ...
        try {
            ...
            try {
                ...
                aVar.a = 2;
                aVar.f2605e = TbsConfig.APP_QB;
                aVar.f2603c = "ADRQB_";
                if (packageInfo != null && packageInfo.versionCode > 420000) {
                    aVar.b = packageInfo.versionCode;
                    aVar.f2603c += packageInfo.versionName.replaceAll("\\.", "");
                    aVar.f2604d = packageInfo.versionName.replaceAll("\\.", "");
                    return aVar;
                }
            ...
            try {
                try {
                    ...
                    aVar.a = 1;
                    aVar.f2605e = "com.tencent.qbx5";
                    aVar.f2603c = "ADRQBX5_";
                }
    ...
    public static boolean a(Context context, long j2, long j3) {
        ...
        boolean z = false;
        try {
            if (Long.valueOf(a2.f2604d).longValue() >= j2) {
                z = true;
            }
        } catch (NumberFormatException e2) {
            e2.printStackTrace();
