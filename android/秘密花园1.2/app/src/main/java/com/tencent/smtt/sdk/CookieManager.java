...
public class CookieManager {
    ...
    public static CookieManager f2469d;
    public CopyOnWriteArrayList<b> a;
    public String b;

    /* renamed from: c  reason: collision with root package name */
    public a f2470c = a.MODE_NONE;
    ...
    public class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public ValueCallback<Boolean> f2476d;
        ...
        if (this.a != null && this.a.size() != 0) {
            ...
            if (a2 != null && a2.b()) {
                ...
                while (it.hasNext()) {
                    ...
                    int i2 = next.a;
                    if (i2 == 1) {
                        setCookie(next.b, next.f2475c, next.f2476d);
                    } else if (i2 == 2) {
                        setCookie(next.b, next.f2475c);
                    }
                }
            } else {
                ...
                while (it2.hasNext()) {
                    ...
                    int i3 = next2.a;
                    if (i3 == 1) {
                        com.tencent.smtt.utils.k.a(android.webkit.CookieManager.getInstance(), "setCookie", new Class[]{String.class, String.class, android.webkit.ValueCallback.class}, next2.b, next2.f2475c, next2.f2476d);
                    } else if (i3 == 2) {
                        android.webkit.CookieManager.getInstance().setCookie(next2.b, next2.f2475c);
                    }
                }
            }
            this.a.clear();
    ...
    public boolean setCookieCompatialbeMode(Context context, a aVar, String str, boolean z) {
        ...
        if (this.f2470c == a.MODE_NONE || !z || t.a().d()) {
            return true;
        }
        t.a().a(context);
        return true;
    ...
    public synchronized void a(Context context, boolean z, boolean z2) {
        int i2;
        int d2;
        if (this.f2470c != a.MODE_NONE && context != null && TbsExtensionFunctionManager.getInstance().canUseFunction(context, TbsExtensionFunctionManager.COOKIE_SWITCH_FILE_NAME) && !this.f2471e) {
            ...
            if (!TextUtils.isEmpty(this.b)) {
                ...
                if (!z3 && (d2 <= 0 || i2 <= 0)) {
                    ...
                    h.a(context, this.f2470c, this.b, z3, z2);
