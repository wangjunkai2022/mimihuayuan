...
public final class JsVirtualMachine {
    ...
    public final HashSet<WeakReference<a>> f2481c;
    ...
    public IX5JsContext a() {
        ...
        if (iX5JsVirtualMachine == null) {
            a aVar = new a(this.a);
            this.f2481c.add(new WeakReference<>(aVar));
            return aVar;
        }
    ...
    public void destroy() {
        ...
        Iterator<WeakReference<a>> it = this.f2481c.iterator();
        while (it.hasNext()) {
