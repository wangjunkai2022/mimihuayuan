...
public class l {
    ...
    public static l f2656d;

    /* renamed from: f  reason: collision with root package name */
    public FileLock f2662f;

    /* renamed from: g  reason: collision with root package name */
    public FileOutputStream f2663g;

    /* renamed from: i  reason: collision with root package name */
    public static final ReentrantLock f2657i = new ReentrantLock();

    /* renamed from: j  reason: collision with root package name */
    public static final Lock f2658j = new ReentrantLock();

    /* renamed from: l  reason: collision with root package name */
    public static FileLock f2659l = null;
    ...
    public static Handler f2660m = null;
    ...
    public static final FileFilter f2655c = new FileFilter() { // from class: com.tencent.smtt.sdk.l.2
    ...
    public l() {
        if (f2660m == null) {
            f2660m = new Handler(k.a().getLooper()) { // from class: com.tencent.smtt.sdk.l.3
    ...
    private synchronized boolean c(Context context, boolean z) {
        ...
        boolean z2 = false;
        if (t(context)) {
            boolean tryLock = f2657i.tryLock();
    ...
    private boolean w(Context context) {
        ...
        if (!z) {
            f2659l = t.a().b(context);
        } else {
            f2659l = com.tencent.smtt.utils.f.f(context);
        }
        if (f2659l == null) {
        ...
        if (tryLock) {
            ...
            try {
                try {
                    ...
                    if (!file.exists()) {
                        try {
                            if (f2657i.isHeldByCurrentThread()) {
                                f2657i.unlock();
                            }
                        } catch (Throwable th) {
    ...
    */
    ...
    public synchronized void b() {
        if (this.f2661e <= 0) {
            TbsLog.i("TbsInstaller", "releaseTbsInstallingFileLock currentTbsFileLockStackCount=" + this.f2661e + "call stack:" + Log.getStackTraceString(new Throwable()));
        } else if (this.f2661e > 1) {
            ...
            if (this.f2661e == 1) {
                ...
                com.tencent.smtt.utils.f.a(this.f2662f, this.f2663g);
                this.f2661e = 0;
            }
        }
    }
