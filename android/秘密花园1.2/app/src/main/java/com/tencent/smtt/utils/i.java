...
public class i {
    ...
    public String f2759e = String.valueOf(new Random().nextInt(89999999) + 10000000);

    /* renamed from: c  reason: collision with root package name */
    public String f2757c = this.f2759e + String.valueOf(new Random().nextInt(89999999) + 10000000);
    ...
    public String c() throws Exception {
        if (this.f2758d == null) {
            byte[] bytes = this.f2757c.getBytes();
            Cipher cipher = null;
            try {
                try {
            ...
            this.f2758d = b(cipher.doFinal(bytes));
        }
        return this.f2758d;
    }
    ...
    public byte[] a(byte[] bArr) throws Exception {
        return com.tencent.smtt.sdk.a.a.a(this.f2759e.getBytes(), bArr, 1);
    }
}
