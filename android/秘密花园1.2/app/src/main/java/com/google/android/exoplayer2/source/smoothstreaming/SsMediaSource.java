...
public final class SsMediaSource extends o implements c0.b<e0<f.i.a.a.h1.v0.e.a>> {
    ...
    public final m.a f2413h;

    /* renamed from: i  reason: collision with root package name */
    public final c.a f2414i;

    /* renamed from: j  reason: collision with root package name */
    public final v f2415j;

    /* renamed from: k  reason: collision with root package name */
    public final b0 f2416k;

    /* renamed from: l  reason: collision with root package name */
    public final long f2417l;

    /* renamed from: m  reason: collision with root package name */
    public final f0.a f2418m;
    ...
    public static final class Factory {
        ...
        public e0.a<? extends f.i.a.a.h1.v0.e.a> f2419c;
        @Nullable

        /* renamed from: d  reason: collision with root package name */
        public List<f.i.a.a.e1.c0> f2420d;
        ...
        public SsMediaSource createMediaSource(Uri uri) {
            this.f2424h = true;
            if (this.f2419c == null) {
                this.f2419c = new f.i.a.a.h1.v0.e.b();
            }
            List<f.i.a.a.e1.c0> list = this.f2420d;
            if (list != null) {
                this.f2419c = new z(this.f2419c, list);
            }
            if (uri != null) {
                return new SsMediaSource(null, uri, this.b, this.f2419c, this.a, this.f2421e, this.f2422f, this.f2423g, null, null);
            }
            throw null;
        }
        ...
        public Factory(c.a aVar, @Nullable m.a aVar2) {
            ...
            this.b = aVar2;
            this.f2422f = new w();
            this.f2423g = com.umeng.commonsdk.proguard.c.f3127d;
            this.f2421e = new v();
        }
    }
    ...
    public f.i.a.a.h1.d0 c(e0.a aVar, e eVar, long j2) {
        d dVar = new d(this.v, this.f2414i, this.t, this.f2415j, this.f2416k, this.b.D(0, aVar, 0L), this.s, eVar);
        this.o.add(dVar);
        return dVar;
    }
    ...
    public void k(f.i.a.a.l1.e0<f.i.a.a.h1.v0.e.a> e0Var, long j2, long j3, boolean z) {
        ...
        f0.a aVar = this.f2418m;
        p pVar = e0Var2.a;
        g0 g0Var = e0Var2.f5574c;
        aVar.o(pVar, g0Var.f5588c, g0Var.f5589d, e0Var2.b, j2, j3, g0Var.b);
    }
    ...
    public void l(@Nullable i0 i0Var) {
        ...
        this.q = this.f2413h.createDataSource();
        c0 c0Var = new c0("Loader:Manifest");
        this.r = c0Var;
        this.s = c0Var;
        this.w = new Handler();
        f.i.a.a.l1.e0 e0Var = new f.i.a.a.l1.e0(this.q, this.f2412g, 4, this.n);
        this.f2418m.x(e0Var.a, e0Var.b, this.r.g(e0Var, this, ((w) this.f2416k).b(e0Var.b)));
    }

    @Override // f.i.a.a.h1.o
    public void n() {
        this.v = this.f2411f ? this.v : null;
        this.q = null;
        this.u = 0L;
        c0 c0Var = this.r;
        if (c0Var != null) {
    ...
    public final void o() {
        ...
        if (j3 == RecyclerView.FOREVER_NS) {
            n0Var = new n0(this.v.f5239d ? -9223372036854775807L : 0L, 0L, 0L, 0L, true, this.v.f5239d, this.p);
        } else {
            f.i.a.a.h1.v0.e.a aVar2 = this.v;
            if (aVar2.f5239d) {
                long j4 = aVar2.f5243h;
                if (j4 != -9223372036854775807L && j4 > 0) {
                    j3 = Math.max(j3, j2 - j4);
                }
                long j5 = j3;
                long j6 = j2 - j5;
                long a2 = j6 - q.a(this.f2417l);
                if (a2 < 5000000) {
                    a2 = Math.min(5000000L, j6 / 2);
                }
                n0Var = new n0(-9223372036854775807L, j6, j5, a2, true, true, this.p);
            } else {
                long j7 = aVar2.f5242g;
    ...
    public c0.c p(f.i.a.a.l1.e0<f.i.a.a.h1.v0.e.a> e0Var, long j2, long j3, IOException iOException, int i2) {
        c0.c c2;
        f.i.a.a.l1.e0<f.i.a.a.h1.v0.e.a> e0Var2 = e0Var;
        long c3 = ((w) this.f2416k).c(4, j3, iOException, i2);
