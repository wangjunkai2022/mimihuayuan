...
public class UMConfigure {
    ...
    public static void setLatencyWindow(long j2) {
        com.umeng.commonsdk.statistics.a.f3239c = ((int) j2) * 1000;
    }
    ...
    public static void init(Context context, String str, String str2, int i2, String str3) {
        ...
        try {
            try {
                ...
                aVar.f3186f = b.a;
                aVar.f3187g = false;
                aVar.f3188h = UMFrUtils.getCurrentProcessName(applicationContext);
                aVar.f3189i = UMUtils.getAppVersionName(applicationContext);
                aVar.f3190j = UMUtils.isMainProgress(applicationContext);
