...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            if (str.startsWith(a.f2958c)) {
                str = str.replaceFirst(a.f2958c, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f2959d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() {
        ...
        if (a != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f2963h, null, null);
        }
        return a;
    }
    ...
    private JSONObject generalBody() {
        ...
        try {
            ...
            if (a != null && !TextUtils.isEmpty(a[0]) && !TextUtils.isEmpty(a[1])) {
                ...
                jSONObject2.put(com.umeng.analytics.pro.b.L, a[0]);
                jSONObject2.put(com.umeng.analytics.pro.b.M, a[1]);
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(com.umeng.analytics.pro.b.f2811i, AnalyticsConfig.getVerticalType(this.mContext));
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(com.umeng.analytics.pro.b.f2814l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(com.umeng.analytics.pro.b.f2815m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            ...
            if (TextUtils.isEmpty(imprintProperty)) {
                ...
                jSONObject.put(com.umeng.analytics.pro.b.f2815m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
