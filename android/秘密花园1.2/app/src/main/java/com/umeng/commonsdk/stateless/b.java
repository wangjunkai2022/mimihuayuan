...
public class b implements j<b, e>, Serializable, Cloneable {
    ...
    public static final Map<e, v> f3197k;

    /* renamed from: l  reason: collision with root package name */
    public static final long f3198l = 420342210744516016L;

    /* renamed from: m  reason: collision with root package name */
    public static final an f3199m = new an("UMSLEnvelope");
    ...
    public enum e implements q {
        ...
        /* renamed from: k  reason: collision with root package name */
        public static final Map<String, e> f3216k = new HashMap();

        /* renamed from: l  reason: collision with root package name */
        public final short f3217l;
    ...
    public b(b bVar) {
        ...
        if (bVar.j()) {
            this.f3200c = bVar.f3200c;
        }
        this.f3201d = bVar.f3201d;
        this.f3202e = bVar.f3202e;
        this.f3203f = bVar.f3203f;
        if (bVar.w()) {
            this.f3204g = k.d(bVar.f3204g);
        }
        if (bVar.z()) {
            this.f3205h = bVar.f3205h;
        }
        if (bVar.C()) {
            this.f3206i = bVar.f3206i;
        }
        this.f3207j = bVar.f3207j;
    }
}
