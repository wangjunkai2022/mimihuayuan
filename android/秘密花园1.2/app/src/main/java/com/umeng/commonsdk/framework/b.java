...
public class b implements UMImprintChangeCallback {
    ...
    public static Handler f2972c = null;

    /* renamed from: d  reason: collision with root package name */
    public static final int f2973d = 200;

    /* renamed from: e  reason: collision with root package name */
    public static final int f2974e = 273;

    /* renamed from: f  reason: collision with root package name */
    public static final int f2975f = 274;

    /* renamed from: g  reason: collision with root package name */
    public static final int f2976g = 512;

    /* renamed from: h  reason: collision with root package name */
    public static final int f2977h = 769;

    /* renamed from: i  reason: collision with root package name */
    public static a f2978i = null;

    /* renamed from: j  reason: collision with root package name */
    public static ConnectivityManager f2979j = null;

    /* renamed from: k  reason: collision with root package name */
    public static NetworkInfo f2980k = null;

    /* renamed from: l  reason: collision with root package name */
    public static IntentFilter f2981l = null;

    /* renamed from: m  reason: collision with root package name */
    public static boolean f2982m = false;
    ...
    public static BroadcastReceiver v = new BroadcastReceiver() { // from class: com.umeng.commonsdk.framework.b.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                ...
                ConnectivityManager unused = b.f2979j = (ConnectivityManager) appContext.getSystemService("connectivity");
                try {
                    if (b.f2979j != null) {
                        NetworkInfo unused2 = b.f2980k = b.f2979j.getActiveNetworkInfo();
                        if (b.f2980k != null && b.f2980k.isAvailable()) {
                            ULog.i("--->>> network isAvailable, check if there are any files to send.");
                            boolean unused3 = b.f2982m = true;
                            synchronized (b.o) {
                            ...
                            b.c(273);
                            if (b.f2980k.getType() != 1 || context == null) {
                                return;
                            }
                            try {
                                if (UMWorkDispatch.eventHasExist(com.umeng.commonsdk.internal.a.f2999j)) {
                                    return;
                                }
                                UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f2999j, com.umeng.commonsdk.internal.b.a(context).a(), null);
                                return;
                        ...
                        boolean unused5 = b.f2982m = false;
                    }
                } catch (Throwable th) {
    ...
    public b(Context context, Handler handler) {
        ...
        try {
            if (a == null) {
                ...
                Context appContext = UMModuleRegister.getAppContext();
                if (DeviceConfig.checkPermission(appContext, "android.permission.ACCESS_NETWORK_STATE") && f2981l == null) {
                    IntentFilter intentFilter = new IntentFilter();
                    f2981l = intentFilter;
                    intentFilter.addAction("android.net.conn.CONNECTIVITY_CHANGE");
                    if (v != null) {
                        appContext.registerReceiver(v, f2981l);
                    }
                }
                m();
                if (b == null) {
    ...
    public static void e() {
        a((int) f2975f, (int) PathInterpolatorCompat.MAX_NUM_POINTS);
    }
    ...
    public static void b(int i2) {
        Handler handler;
        if (!f2982m || (handler = b) == null || handler.hasMessages(i2)) {
            return;
        }
