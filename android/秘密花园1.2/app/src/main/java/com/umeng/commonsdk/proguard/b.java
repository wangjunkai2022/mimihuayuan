...
public class b {
    ...
    public static final int f3123c = 10000;
    ...
    public synchronized void a(d dVar) {
        ...
        if (dVar != null && this.f3124d != null) {
            this.f3125e = dVar;
            boolean checkPermission = UMUtils.checkPermission(this.f3124d, "android.permission.ACCESS_COARSE_LOCATION");
            boolean checkPermission2 = UMUtils.checkPermission(this.f3124d, "android.permission.ACCESS_FINE_LOCATION");
            ...
            if (this.b != null) {
                ...
                if (isProviderEnabled || isProviderEnabled2) {
                    ...
                    this.f3125e.a(lastKnownLocation);
                }
