...
public class b {
    ...
    public static final String f3241c = "EnvelopeManager";

    /* renamed from: d  reason: collision with root package name */
    public static String f3242d;

    /* renamed from: f  reason: collision with root package name */
    public static boolean f3243f;
    ...
    public static JSONObject b(Context context) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(f3242d)) {
                try {
                    jSONObject = new JSONObject(f3242d);
                ...
                jSONObject2.put(e.f3131c, SdkVersion.SDK_TYPE);
                if (!TextUtils.isEmpty(a)) {
                    jSONObject2.put(e.f3132d, a);
                }
                f3242d = jSONObject2.toString();
        ...
        try {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(context, e.f3134f, null);
            if (!TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(e.f3134f, imprintProperty);
            }
        } catch (Exception e4) {
        ...
        try {
            if (SdkVersion.SDK_TYPE != 1 && com.umeng.commonsdk.proguard.a.b(context) != null) {
                jSONObject.put(e.f3135g, com.umeng.commonsdk.proguard.a.b(context));
            }
                ...
                if (next != null && (next instanceof String)) {
                    ...
                    if (jSONObject2.opt(str) != null) {
                        try {
                            ...
                            if (str.equals(com.umeng.analytics.pro.b.f2811i) && (jSONObject2.opt(str) instanceof Integer)) {
                                this.f3244e = ((Integer) jSONObject2.opt(str)).intValue();
                            }
                        } catch (Exception unused) {
                        }
                    }
