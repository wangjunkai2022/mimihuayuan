...
public class c {
    ...
    public static boolean f3294e = false;
    ...
    private void b() {
        String imprintProperty = UMEnvelopeBuild.imprintProperty(this.f3295c, "domain_p", "");
        String imprintProperty2 = UMEnvelopeBuild.imprintProperty(this.f3295c, "domain_s", "");
        ...
        String imprintProperty3 = UMEnvelopeBuild.imprintProperty(this.f3295c, "oversea_domain_p", "");
        String imprintProperty4 = UMEnvelopeBuild.imprintProperty(this.f3295c, "oversea_domain_s", "");
    ...
    private boolean c() {
        ...
        String extraInfo;
        if (this.f3295c.getPackageManager().checkPermission("android.permission.ACCESS_NETWORK_STATE", this.f3295c.getPackageName()) != 0) {
            return false;
        }
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) this.f3295c.getSystemService("connectivity");
            if (DeviceConfig.checkPermission(this.f3295c, "android.permission.ACCESS_NETWORK_STATE") && connectivityManager != null && (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) != null && activeNetworkInfo.getType() != 1 && (extraInfo = activeNetworkInfo.getExtraInfo()) != null) {
            ...
            UMCrashManager.reportCrash(this.f3295c, th);
        }
        return false;
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    httpsURLConnection.setRequestProperty("X-Umeng-Sdk", a.a(this.f3295c).b());
                    httpsURLConnection.setRequestProperty("Content-Type", a.a(this.f3295c).a());
            ...
            try {
                ...
                if (responseCode == 200 && z) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            UMCrashManager.reportCrash(this.f3295c, e2);
                        }
                        try {
                ...
                try {
                    ...
                    UMCrashManager.reportCrash(this.f3295c, e3);
                }
                try {
                    httpsURLConnection.getInputStream().close();
                ...
                if (outputStream != null) {
                    try {
                        ...
                        UMCrashManager.reportCrash(this.f3295c, e4);
                    }
                }
                ...
                if (outputStream != null) {
                    try {
                        ...
                        UMCrashManager.reportCrash(this.f3295c, e5);
                    }
                }
                if (httpsURLConnection != null) {
                    try {
                ...
                if (outputStream != null) {
                    try {
                        ...
                        UMCrashManager.reportCrash(this.f3295c, e6);
                    }
                }
                if (httpsURLConnection != null) {
                    try {
            ...
            if (outputStream2 != null) {
                try {
                    ...
                    UMCrashManager.reportCrash(this.f3295c, e7);
                }
            }
    ...
    public byte[] a(byte[] bArr, String str) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("X-Umeng-Sdk", a.a(this.f3295c).b());
            httpURLConnection.setRequestProperty("Msg-Type", "envelope/json");
            httpURLConnection.setRequestProperty("Content-Type", a.a(this.f3295c).a());
