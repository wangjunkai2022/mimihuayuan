...
public class b implements p {
    ...
    public static final String f2791h = "sp_uapp";

    /* renamed from: i  reason: collision with root package name */
    public static final String f2792i = "prepp_uapp";
    ...
    public volatile JSONObject f2799k;

    /* renamed from: l  reason: collision with root package name */
    public volatile JSONObject f2800l;

    /* renamed from: m  reason: collision with root package name */
    public volatile JSONObject f2801m;
    public boolean n;
    ...
    private void i(Context context) {
        try {
            ...
            if (this.f2799k == null) {
                this.f2799k = new JSONObject();
            }
            if (this.f2800l == null) {
                this.f2800l = new JSONObject();
            }
            String string = sharedPreferences.getString(f2792i, null);
            if (!TextUtils.isEmpty(string)) {
                try {
                    this.f2801m = new JSONObject(string);
                } catch (JSONException unused) {
                }
            }
            if (this.f2801m == null) {
                this.f2801m = new JSONObject();
            }
    ...
    public void h() {
        try {
            if (this.a != null) {
                ...
                UMWorkDispatch.sendEvent(this.a, k.a.f2914k, CoreProtocol.getInstance(this.a), Long.valueOf(currentTimeMillis));
                UMWorkDispatch.sendEvent(this.a, k.a.f2910g, CoreProtocol.getInstance(this.a), Long.valueOf(currentTimeMillis));
            }
            if (this.b != null) {
                this.b.a();
            }
    ...
    public synchronized void k() {
        ...
        if (this.f2799k != null && this.a != null) {
            SharedPreferences.Editor edit = PreferenceWrapper.getDefault(this.a).edit();
            edit.putString(f2791h, this.f2799k.toString());
            edit.commit();
        } else {
            this.f2799k = new JSONObject();
        }
    ...
    public void d(Context context) {
        ...
        try {
            ...
            if (this.a != null) {
                if (this.f2796f != null) {
                    this.f2796f.c(this.a, Long.valueOf(System.currentTimeMillis()));
                }
                k.a(this.a).d();
                r.a(this.a);
                j.a(this.a);
    ...
    public synchronized Object e(Context context, String str) {
        ...
        if (!UMGlobalContext.getInstance().isMainProcess(this.a)) {
            ...
            if (this.f2799k != null) {
                if (this.f2799k.has(str)) {
                    return this.f2799k.opt(str);
                }
            } else {
                this.f2799k = new JSONObject();
            }
    ...
    public void j() {
        try {
            ...
            UMWorkDispatch.sendEvent(this.a, k.a.f2909f, CoreProtocol.getInstance(this.a), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
    ...
    public void b(Context context) {
        if (context == null) {
            ...
            try {
                ...
                if (AnalyticsConfig.AUTO_ACTIVITY_PAGE_COLLECTION != MobclickAgent.PageMode.LEGACY_MANUAL) {
                    this.f2795e.a(context.getClass().getName());
                }
                h();
                j(this.a);
                if (UMConfigure.isDebugLog() && (context instanceof Activity)) {
    ...
    public synchronized JSONObject h(Context context) {
        ...
        if (this.f2801m.length() > 0) {
            try {
                jSONObject = new JSONObject(this.f2801m.toString());
            } catch (JSONException unused) {
            }
        }
        return jSONObject;
    ...
    public void i() {
        try {
            if (this.a != null) {
                ...
                UMWorkDispatch.sendEvent(this.a, k.a.f2911h, CoreProtocol.getInstance(this.a), Long.valueOf(System.currentTimeMillis()));
                UMWorkDispatch.sendEvent(this.a, k.a.f2907d, CoreProtocol.getInstance(this.a), null);
                UMWorkDispatch.sendEvent(this.a, 4099, CoreProtocol.getInstance(this.a), null);
                UMWorkDispatch.sendEvent(this.a, k.a.f2912i, CoreProtocol.getInstance(this.a), null);
            }
        } catch (Throwable unused) {
        }
        x xVar = this.b;
    ...
    public synchronized void f(Context context, String str) {
        ...
        if (str != null && str.length() > 0) {
            if (this.f2801m.has(str)) {
                this.f2801m.remove(str);
                UMWorkDispatch.sendEvent(this.a, k.a.u, CoreProtocol.getInstance(this.a), this.f2801m.toString());
    ...
    public synchronized String e(Context context) {
        ...
        if (!UMGlobalContext.getInstance().isMainProcess(this.a)) {
            ...
            return null;
        } else if (this.f2799k != null) {
            return this.f2799k.toString();
        } else {
            this.f2799k = new JSONObject();
            return null;
        }
    ...
    public synchronized void b(Object obj) {
        ...
        if (obj != null) {
            ...
            if (edit != null && !TextUtils.isEmpty(str)) {
                edit.putString(f2792i, str).commit();
            }
        } else if (edit != null) {
            edit.remove(f2792i).commit();
        }
    }
    ...
    public void a(Context context, String str) {
        ...
        if (!UMGlobalContext.getInstance().isMainProcess(this.a)) {
            ...
            try {
                ...
                jSONObject.put("__ii", this.f2796f.c());
                UMWorkDispatch.sendEvent(this.a, k.a.f2913j, CoreProtocol.getInstance(this.a), jSONObject);
            } catch (Throwable th) {
                if (MLog.DEBUG) {
                    MLog.e(th);
                }
        ...
        try {
            ...
            if (this.a != null) {
                ...
                if (th != null) {
                    ...
                    g.a(this.a).a(this.f2796f.c(), jSONObject.toString(), 1);
                }
                k.a(this.a).d();
                r.a(this.a);
                j.a(this.a);
    ...
    public void a(String str, String str2) {
        try {
            ...
            jSONObject.put("ts", currentTimeMillis);
            k.a(this.a).a((Object) null, true);
            UMWorkDispatch.sendEvent(this.a, k.a.f2908e, CoreProtocol.getInstance(this.a), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                ...
                try {
                    ...
                    if (obj.getClass().isArray()) {
                        if (obj instanceof String[]) {
                            ...
                            this.f2799k.put(str, jSONArray2);
                            ...
                            this.f2799k.put(str, jSONArray3);
                            ...
                            this.f2799k.put(str, jSONArray4);
                            ...
                            this.f2799k.put(str, jSONArray5);
                            ...
                            this.f2799k.put(str, jSONArray6);
                        } else {
                        ...
                        this.f2799k.put(str, obj);
                    }
                } catch (Throwable unused) {
                }
                UMWorkDispatch.sendEvent(this.a, k.a.p, CoreProtocol.getInstance(this.a), this.f2799k.toString());
                return;
            }
        }
        UMLog.aq(h.af, 0, "\\|");
    ...
    private void a(String str, Object obj) {
        try {
            ...
            if (obj.getClass().isArray()) {
                ...
                this.f2799k.put(str, jSONArray7);
    ...
    public synchronized void a(Object obj) {
        ...
        if (obj != null && this.a != null) {
            ...
            SharedPreferences.Editor edit = PreferenceWrapper.getDefault(this.a).edit();
            if (edit != null && !TextUtils.isEmpty(str)) {
                edit.putString(f2791h, this.f2799k.toString()).commit();
            }
        }
    }
    ...
    public synchronized void a(Context context, JSONObject jSONObject) {
        ...
        if (jSONObject != null && jSONObject.length() > 0) {
            ...
            try {
                jSONObject2 = new JSONObject(this.f2801m.toString());
            ...
            this.f2801m = jSONObject2;
            if (this.f2801m.length() > 0) {
                UMWorkDispatch.sendEvent(this.a, k.a.t, CoreProtocol.getInstance(this.a), this.f2801m.toString());
            }
            return;
        }
        UMLog.aq(h.al, 0, "\\|");
