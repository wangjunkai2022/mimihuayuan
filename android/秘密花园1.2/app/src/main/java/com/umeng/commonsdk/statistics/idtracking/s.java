...
public class s extends a {
    ...
    public static final String f3289e = "yosuid";

    /* renamed from: f  reason: collision with root package name */
    public static final String f3290f = "23346339";
    public Context b;
    ...
    */
    ...
    public String f() {
        ...
        try {
            ...
            String string = sharedPreferences.getString(f3289e, "");
            if (TextUtils.isEmpty(string)) {
                String b = b(f3290f);
                this.f3292d = b;
                if (!TextUtils.isEmpty(b) && this.b != null && (edit = sharedPreferences.edit()) != null) {
                    edit.putString(f3289e, this.f3292d).commit();
                }
                return this.f3292d;
            }
            return string;
