...
public class ImprintHandler implements FileLockCallback {
    ...
    public static final String f3262c = ".imprint";

    /* renamed from: k  reason: collision with root package name */
    public static Context f3267k = null;

    /* renamed from: l  reason: collision with root package name */
    public static FileLockUtil f3268l = null;

    /* renamed from: m  reason: collision with root package name */
    public static final int f3269m = 0;
    public static final int n = 1;

    /* renamed from: e  reason: collision with root package name */
    public com.umeng.commonsdk.statistics.internal.d f3270e;

    /* renamed from: h  reason: collision with root package name */
    public a f3271h = new a();

    /* renamed from: i  reason: collision with root package name */
    public com.umeng.commonsdk.statistics.proto.d f3272i = null;
    public static Object b = new Object();

    /* renamed from: d  reason: collision with root package name */
    public static final byte[] f3263d = "pbl0".getBytes();

    /* renamed from: f  reason: collision with root package name */
    public static Map<String, ArrayList<UMImprintChangeCallback>> f3264f = new HashMap();

    /* renamed from: g  reason: collision with root package name */
    public static Object f3265g = new Object();

    /* renamed from: j  reason: collision with root package name */
    public static ImprintHandler f3266j = null;
    ...
    public ImprintHandler(Context context) {
        f3267k = context.getApplicationContext();
    }

    public static void a(String str, UMImprintChangeCallback uMImprintChangeCallback) {
        synchronized (f3265g) {
            int i2 = 0;
            if (f3264f.containsKey(str)) {
                ArrayList<UMImprintChangeCallback> arrayList = f3264f.get(str);
    ...
    private com.umeng.commonsdk.statistics.proto.d d(com.umeng.commonsdk.statistics.proto.d dVar) {
        ...
        while (true) {
            ...
            if (!next.getValue().d()) {
                ...
                synchronized (f3265g) {
                    if (!TextUtils.isEmpty(key) && f3264f.containsKey(key) && (arrayList2 = f3264f.get(key)) != null) {
        ...
        while (it2.hasNext()) {
            ...
            synchronized (f3265g) {
                if (!TextUtils.isEmpty(str2) && f3264f.containsKey(str2) && (arrayList = f3264f.get(str2)) != null) {
    ...
    */
    private void e() {
        /*
            ...
            android.content.Context r1 = com.umeng.commonsdk.statistics.idtracking.ImprintHandler.f3267k
        ...
        L18:
            r0 = 0
            android.content.Context r2 = com.umeng.commonsdk.statistics.idtracking.ImprintHandler.f3267k     // Catch: java.lang.Throwable -> L2b java.lang.Exception -> L30
        ...
        L36:
            ...
            r5.f3272i = r2     // Catch: java.lang.Exception -> L4d java.lang.Throwable -> L58
            com.umeng.commonsdk.statistics.idtracking.ImprintHandler$a r0 = r5.f3271h     // Catch: java.lang.Exception -> L4d java.lang.Throwable -> L58
    ...
    public static synchronized ImprintHandler getImprintService(Context context) {
        ...
        synchronized (ImprintHandler.class) {
            if (f3266j == null) {
                f3266j = new ImprintHandler(context);
                FileLockUtil fileLockUtil = new FileLockUtil();
                f3268l = fileLockUtil;
                if (fileLockUtil != null) {
                    f3268l.doFileOperateion(new File(f3267k.getFilesDir(), f3262c), f3266j, 0);
                }
            }
            imprintHandler = f3266j;
        }
    ...
    public void b(com.umeng.commonsdk.statistics.proto.d dVar) {
        ...
        if (dVar == null) {
            ...
            synchronized (this) {
                com.umeng.commonsdk.statistics.proto.d dVar2 = this.f3272i;
                String str = null;
            ...
            com.umeng.commonsdk.statistics.proto.d dVar3 = this.f3272i;
            if (dVar3 != null) {
                boolean z2 = AnalyticsConstants.UM_DEBUG;
                if (z) {
                    this.f3271h.a(dVar3);
                    com.umeng.commonsdk.statistics.internal.d dVar4 = this.f3270e;
                    if (dVar4 != null) {
                        dVar4.onImprintChanged(this.f3271h);
                    }
                }
            }
            if (hashMap.size() > 0) {
                synchronized (f3265g) {
                    for (Map.Entry entry : hashMap.entrySet()) {
                        ...
                        if (!TextUtils.isEmpty(str2) && f3264f.containsKey(str2)) {
                            ULog.i("--->>> target imprint key is: " + str2 + "; value is: " + str3);
                            ArrayList<UMImprintChangeCallback> arrayList = f3264f.get(str2);
                            if (arrayList != null) {
                                for (int i3 = 0; i3 < arrayList.size(); i3++) {
    ...
    public void d() {
        if (this.f3272i == null || f3268l == null) {
            return;
        }
        File file = new File(f3267k.getFilesDir(), f3262c);
        if (!file.exists()) {
            try {
                try {
                    file.createNewFile();
                ...
                UMCrashManager.reportCrash(f3267k, e2);
            }
        }
        f3268l.doFileOperateion(file, f3266j, 1);
    }
    ...
    public byte[] a() {
        try {
            synchronized (this) {
                ...
                return new com.umeng.commonsdk.proguard.s().a(this.f3272i);
            }
        } catch (Throwable th) {
            UMCrashManager.reportCrash(f3267k, th);
            return null;
        }
    }
        ...
        for (Map.Entry<String, com.umeng.commonsdk.statistics.proto.e> entry : dVar2.c().entrySet()) {
            ...
            if (entry.getValue().d()) {
                ...
                if (i2 == 0) {
                    ...
                    synchronized (f3265g) {
                        if (!TextUtils.isEmpty(key) && f3264f.containsKey(key) && f3264f.get(key) != null) {
                            map.put(key, str);
                        }
                    }
                } else {
                ...
                synchronized (f3265g) {
                    if (!TextUtils.isEmpty(key2) && f3264f.containsKey(key2) && (arrayList = f3264f.get(key2)) != null) {
    ...
    private void a(File file) {
        ...
        try {
            synchronized (b) {
                byte[] a2 = new com.umeng.commonsdk.proguard.s().a(this.f3272i);
