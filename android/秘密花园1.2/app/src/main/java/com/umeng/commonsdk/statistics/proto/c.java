...
public class c implements j<c, e>, Serializable, Cloneable {
    ...
    public static final Map<e, v> f3335d;

    /* renamed from: e  reason: collision with root package name */
    public static final long f3336e = -5764118265293965743L;

    /* renamed from: f  reason: collision with root package name */
    public static final an f3337f = new an("IdTracking");

    /* renamed from: g  reason: collision with root package name */
    public static final ad f3338g = new ad("snapshots", ap.f3114k, 1);

    /* renamed from: h  reason: collision with root package name */
    public static final ad f3339h = new ad("journals", ap.f3116m, 2);

    /* renamed from: i  reason: collision with root package name */
    public static final ad f3340i = new ad("checksum", (byte) 11, 3);

    /* renamed from: j  reason: collision with root package name */
    public static final Map<Class<? extends aq>, ar> f3341j;
    ...
    /* loaded from: classes.dex */
    public static class C0028c extends at<c> {
        public C0028c() {
        }
        ...
        public void b(ai aiVar, c cVar) throws p {
            ...
            cVar.a = new HashMap(afVar.f3095c * 2);
            for (int i2 = 0; i2 < afVar.f3095c; i2++) {
                String z = aoVar.z();
                com.umeng.commonsdk.statistics.proto.b bVar = new com.umeng.commonsdk.statistics.proto.b();
                bVar.read(aoVar);
                cVar.a.put(z, bVar);
    ...
    static {
        ...
        f3341j.put(at.class, new d());
        EnumMap enumMap = new EnumMap(e.class);
        enumMap.put((EnumMap) e.SNAPSHOTS, (e) new v("snapshots", (byte) 1, new y(ap.f3114k, new w((byte) 11), new aa((byte) 12, com.umeng.commonsdk.statistics.proto.b.class))));
        enumMap.put((EnumMap) e.JOURNALS, (e) new v("journals", (byte) 2, new x(ap.f3116m, new aa((byte) 12, com.umeng.commonsdk.statistics.proto.a.class))));
        ...
        f3335d = unmodifiableMap;
        v.a(c.class, unmodifiableMap);
    }

    public c() {
        this.f3343k = new e[]{e.JOURNALS, e.CHECKSUM};
    }
    ...
    public void read(ai aiVar) throws p {
        f3341j.get(aiVar.D()).b().b(aiVar, this);
    }
    ...
    public void write(ai aiVar) throws p {
        f3341j.get(aiVar.D()).b().a(aiVar, this);
    }
    ...
    public enum e implements q {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final Map<String, e> f3345d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final short f3347e;
