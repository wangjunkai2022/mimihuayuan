...
public class g {
    ...
    public static final String[] f7207d = {",", ">", "+", "~", " "};

    /* renamed from: e  reason: collision with root package name */
    public static final String[] f7208e = {"=", "!=", "^=", "$=", "*=", "~="};

    /* renamed from: f  reason: collision with root package name */
    public static final Pattern f7209f = Pattern.compile("(([+-])?(\\d+)?)n(\\s*([+-])?\\s*\\d+)?", 2);

    /* renamed from: g  reason: collision with root package name */
    public static final Pattern f7210g = Pattern.compile("([+-])?(\\d+)");
    public j a;
    public String b;

    /* renamed from: c  reason: collision with root package name */
    public List<d> f7211c = new ArrayList();
    ...
    */
    ...
    public final void c(boolean z) {
        ...
        if (z) {
            this.f7211c.add(new d.m(m2));
        } else {
            this.f7211c.add(new d.n(m2));
        }
    }
    ...
    */
    public final void d(boolean r9, boolean r10) {
        /*
            ...
            java.util.regex.Pattern r1 = k.a.g.g.f7209f
            java.util.regex.Matcher r1 = r1.matcher(r0)
            java.util.regex.Pattern r2 = k.a.g.g.f7210g
        ...
        L76:
            if (r10 == 0) goto L90
            if (r9 == 0) goto L85
            java.util.List<k.a.g.d> r9 = r8.f7211c
    ...
    public final void e() {
        if (this.a.h("#")) {
            String e2 = this.a.e();
            j.b.q(e2);
            this.f7211c.add(new d.p(e2));
        } else if (this.a.h(".")) {
            String e3 = this.a.e();
            j.b.q(e3);
            this.f7211c.add(new d.k(e3.trim()));
        } else if (!this.a.k() && !this.a.i("*|")) {
            if (this.a.i("[")) {
                j jVar = new j(this.a.a('[', ']'));
                String[] strArr = f7208e;
                int i2 = jVar.b;
                ...
                if (jVar.g()) {
                    if (substring.startsWith("^")) {
                        this.f7211c.add(new d.C0121d(substring.substring(1)));
                    } else {
                        this.f7211c.add(new d.b(substring));
                    }
                } else if (jVar.h("=")) {
                    this.f7211c.add(new d.e(substring, jVar.l()));
                } else if (jVar.h("!=")) {
                    this.f7211c.add(new d.i(substring, jVar.l()));
                } else if (jVar.h("^=")) {
                    this.f7211c.add(new d.j(substring, jVar.l()));
                } else if (jVar.h("$=")) {
                    this.f7211c.add(new d.g(substring, jVar.l()));
                } else if (jVar.h("*=")) {
                    this.f7211c.add(new d.f(substring, jVar.l()));
                } else if (jVar.h("~=")) {
                    this.f7211c.add(new d.h(substring, Pattern.compile(jVar.l())));
                } else {
                    throw new h("Could not parse attribute query '%s': unexpected token at '%s'", this.b, jVar.l());
                }
            } else if (this.a.h("*")) {
                this.f7211c.add(new d.a());
            } else if (this.a.h(":lt(")) {
                this.f7211c.add(new d.t(b()));
            } else if (this.a.h(":gt(")) {
                this.f7211c.add(new d.s(b()));
            } else if (this.a.h(":eq(")) {
                this.f7211c.add(new d.q(b()));
            } else if (this.a.i(":has(")) {
                this.a.d(":has");
                String a = this.a.a('(', ')');
                j.b.r(a, ":has(el) subselect must not be empty");
                this.f7211c.add(new i.a(h(a)));
                ...
                this.f7211c.add(new d.v());
            } else if (this.a.h(":last-child")) {
                this.f7211c.add(new d.x());
            } else if (this.a.h(":first-of-type")) {
                this.f7211c.add(new d.w());
            } else if (this.a.h(":last-of-type")) {
                this.f7211c.add(new d.y());
            } else if (this.a.h(":only-child")) {
                this.f7211c.add(new d.d0());
            } else if (this.a.h(":only-of-type")) {
                this.f7211c.add(new d.e0());
            } else if (this.a.h(":empty")) {
                this.f7211c.add(new d.u());
            } else if (this.a.h(":root")) {
                this.f7211c.add(new d.f0());
            } else if (this.a.h(":matchText")) {
                this.f7211c.add(new d.g0());
            } else {
            ...
            j.b.q(p);
            if (p.startsWith("*|")) {
                this.f7211c.add(new b.C0120b(new d.j0(p), new d.k0(p.replace("*|", ":"))));
                return;
            }
            if (p.contains("|")) {
                p = p.replace("|", ":");
            }
            this.f7211c.add(new d.j0(p));
        }
    }
    ...
    public final void f(boolean z) {
        ...
        if (z) {
            this.f7211c.add(new d.i0(Pattern.compile(a)));
        } else {
            this.f7211c.add(new d.h0(Pattern.compile(a)));
        }
    }
    ...
    public d g() {
        ...
        if (this.f7211c.size() == 1) {
            return this.f7211c.get(0);
        }
        return new b.a(this.f7211c);
    }
}
