...
public class DownloadTracker {
    ...
    public class DownloadManagerListener implements s.d {
        ...
        public void onDownloadChanged(s sVar, f.i.a.a.e1.m mVar) {
            DownloadTracker.this.downloads.put(mVar.a.f4763c, mVar);
        ...
        public void onDownloadRemoved(s sVar, f.i.a.a.e1.m mVar) {
            DownloadTracker.this.downloads.remove(mVar.a.f4763c);
            Iterator it = DownloadTracker.this.listeners.iterator();
            while (it.hasNext()) {
                ((Listener) it.next()).onDownloadsChanged();
            }
    ...
    public final class StartDownloadDialogHelper implements q.b, DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
        ...
        public StartDownloadDialogHelper(FragmentManager fragmentManager, final q qVar, String str) {
            ...
            this.name = str;
            h.v(qVar.f4723j == null);
            qVar.f4723j = this;
            e0 e0Var = qVar.f4717d;
            if (e0Var != null) {
                qVar.f4724k = new q.e(e0Var, qVar);
            } else {
                qVar.f4721h.post(new Runnable() { // from class: f.i.a.a.e1.c
        ...
        private u buildDownloadRequest() {
            ...
            if (qVar.f4717d == null) {
                return new u(uri, qVar.a, qVar.b, Collections.emptyList(), qVar.f4716c, O);
            }
            h.v(qVar.f4722i);
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                arrayList.addAll(qVar.f4724k.f4734j[i2].n(arrayList2));
            }
            return new u(uri, qVar.a, qVar.b, arrayList, qVar.f4716c, O);
        }
        ...
        public void onClick(DialogInterface dialogInterface, int i2) {
            ...
            while (true) {
                ...
                if (qVar.f4717d == null) {
                    ...
                    h.v(qVar.f4722i);
                    length = qVar.f4725l.length;
                }
                if (i3 < length) {
                    q qVar2 = this.downloadHelper;
                    h.v(qVar2.f4722i);
                    for (int i4 = 0; i4 < qVar2.f4719f.length; i4++) {
                        qVar2.n[i3][i4].clear();
                    }
                    int i5 = 0;
                        ...
                        if (!this.trackSelectionDialog.getIsDisabled(i5)) {
                            ...
                            if (cVar != null) {
                                ...
                                if (overrides.isEmpty()) {
                                    ...
                                    p0 p0Var = qVar3.f4726m[i3].f5516c[i5];
                    ...
                    if (buildDownloadRequest.f4764d.isEmpty()) {
                        return;
                    }
                    startDownload(buildDownloadRequest);
                    return;
    ...
    public DownloadTracker(Context context, m.a aVar, s sVar) {
        ...
        sVar.f4738c.add(new DownloadManagerListener());
        loadDownloads();
    }
    ...
    private void loadDownloads() {
        try {
            ...
            while (e2.moveToNext()) {
                ...
                this.downloads.put(d2.a.f4763c, d2);
            }
            ((k.b) e2).a.close();
