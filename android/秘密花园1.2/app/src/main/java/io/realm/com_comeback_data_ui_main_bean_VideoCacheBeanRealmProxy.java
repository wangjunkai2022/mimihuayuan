...
public class com_comeback_data_ui_main_bean_VideoCacheBeanRealmProxy extends VideoCacheBean implements n, c1 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6963f = a("name", "name", a);
            this.f6964g = a(TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL, TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL, a);
            this.f6965h = a("downloadFinish", "downloadFinish", a);
            this.f6966i = a("cachePath", "cachePath", a);
            this.f6967j = a(TbsReaderView.KEY_TEMP_PATH, TbsReaderView.KEY_TEMP_PATH, a);
            this.f6968k = a("md5", "md5", a);
            this.f6962e = a.a();
        }
    ...
    public static VideoCacheBean copy(x xVar, a aVar, VideoCacheBean videoCacheBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6392j.e(VideoCacheBean.class);
        long j2 = aVar.f6962e;
    ...
    */
    ...
    public static long insert(x xVar, VideoCacheBean videoCacheBean, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(VideoCacheBean.class);
        long j3 = aVar.f6964g;
        String realmGet$url = videoCacheBean.realmGet$url();
        if (realmGet$url == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$name = videoCacheBean.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6963f, createRowWithPrimaryKey, realmGet$name, false);
            }
            Table.nativeSetBoolean(j2, aVar.f6965h, createRowWithPrimaryKey, videoCacheBean.realmGet$downloadFinish(), false);
            String realmGet$cachePath = videoCacheBean.realmGet$cachePath();
            if (realmGet$cachePath != null) {
                Table.nativeSetString(j2, aVar.f6966i, createRowWithPrimaryKey, realmGet$cachePath, false);
            }
            String realmGet$tempPath = videoCacheBean.realmGet$tempPath();
            if (realmGet$tempPath != null) {
                Table.nativeSetString(j2, aVar.f6967j, createRowWithPrimaryKey, realmGet$tempPath, false);
            }
            String realmGet$md5 = videoCacheBean.realmGet$md5();
            if (realmGet$md5 != null) {
                Table.nativeSetString(j2, aVar.f6968k, createRowWithPrimaryKey, realmGet$md5, false);
            }
    ...
    public static long insertOrUpdate(x xVar, VideoCacheBean videoCacheBean, Map<e0, Long> map) {
        ...
        String realmGet$name = videoCacheBean.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6963f, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6963f, j4, false);
        }
        Table.nativeSetBoolean(j2, aVar.f6965h, j4, videoCacheBean.realmGet$downloadFinish(), false);
        String realmGet$cachePath = videoCacheBean.realmGet$cachePath();
        if (realmGet$cachePath != null) {
            Table.nativeSetString(j2, aVar.f6966i, j4, realmGet$cachePath, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6966i, j4, false);
        }
        String realmGet$tempPath = videoCacheBean.realmGet$tempPath();
        if (realmGet$tempPath != null) {
            Table.nativeSetString(j2, aVar.f6967j, j4, realmGet$tempPath, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6967j, j4, false);
        }
        String realmGet$md5 = videoCacheBean.realmGet$md5();
        if (realmGet$md5 != null) {
            Table.nativeSetString(j2, aVar.f6968k, j4, realmGet$md5, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6968k, j4, false);
        }
        return j4;
    }
    ...
    public static com_comeback_data_ui_main_bean_VideoCacheBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(VideoCacheBean.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_main_bean_videocachebeanrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_main_bean_videocachebeanrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_main_bean_videocachebeanrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$cachePath() {
        ...
        return this.proxyState.f6380c.q(this.columnInfo.f6966i);
    }

    @Override // com.comeback.data.ui.main.bean.VideoCacheBean, g.a.c1
    public boolean realmGet$downloadFinish() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.m(this.columnInfo.f6965h);
    }

    @Override // com.comeback.data.ui.main.bean.VideoCacheBean, g.a.c1
    public String realmGet$md5() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6968k);
    }

    @Override // com.comeback.data.ui.main.bean.VideoCacheBean, g.a.c1
    public String realmGet$name() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6963f);
    }
    ...
    public String realmGet$tempPath() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6967j);
    }

    @Override // com.comeback.data.ui.main.bean.VideoCacheBean, g.a.c1
    public String realmGet$url() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6964g);
    }
    ...
    public void realmSet$cachePath(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6966i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6966i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6966i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6966i, str);
        }
    }
    ...
    public void realmSet$downloadFinish(boolean z) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().o(this.columnInfo.f6965h, pVar.l(), z, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.i(this.columnInfo.f6965h, z);
    }
    ...
    public void realmSet$md5(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6968k, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6968k, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6968k);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6968k, str);
        }
    }
    ...
    public void realmSet$name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6963f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6963f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6963f);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6963f, str);
        }
    }
    ...
    public void realmSet$tempPath(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6967j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6967j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6967j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6967j, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videoCacheBean2)) {
                if (videoCacheBean2 instanceof n) {
                    ...
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(videoCacheBean2, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$url = videoCacheBean2.realmGet$url();
                if (realmGet$url == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videoCacheBean2)) {
                ...
                if (realmGet$name != null) {
                    ...
                    videoCacheBean = videoCacheBean2;
                    Table.nativeSetNull(j2, aVar.f6963f, createRowWithPrimaryKey, false);
                }
                Table.nativeSetBoolean(j2, aVar.f6965h, createRowWithPrimaryKey, videoCacheBean.realmGet$downloadFinish(), false);
                String realmGet$cachePath = videoCacheBean.realmGet$cachePath();
                if (realmGet$cachePath != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6966i, createRowWithPrimaryKey, false);
                }
                String realmGet$tempPath = videoCacheBean.realmGet$tempPath();
                if (realmGet$tempPath != null) {
                    Table.nativeSetString(j2, aVar.f6967j, createRowWithPrimaryKey, realmGet$tempPath, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6967j, createRowWithPrimaryKey, false);
                }
                String realmGet$md5 = videoCacheBean.realmGet$md5();
                if (realmGet$md5 != null) {
                    Table.nativeSetString(j2, aVar.f6968k, createRowWithPrimaryKey, realmGet$md5, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6968k, createRowWithPrimaryKey, false);
                }
            }
        }
    }
