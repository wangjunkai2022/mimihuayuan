...
public class OsObjectBuilder implements Closeable {
    ...
    public OsObjectBuilder(Table table, long j2, Set<m> set) {
        ...
        this.a = table;
        this.f7034d = table.a;
        this.f7033c = nativeCreateBuilder(j2 + 1);
        this.f7035e = osSharedRealm.context;
        this.f7036f = set.contains(m.CHECK_SAME_VALUES_BEFORE_SET);
    }
    ...
    public UncheckedRow E() {
        try {
            return new UncheckedRow(this.f7035e, this.a, nativeCreateOrUpdate(this.b, this.f7034d, this.f7033c, false, false));
        } finally {
            nativeDestroyBuilder(this.f7033c);
        }
    }

    public void F() {
        try {
            nativeCreateOrUpdate(this.b, this.f7034d, this.f7033c, true, this.f7036f);
        } finally {
            nativeDestroyBuilder(this.f7033c);
        }
    }
    ...
    public void d(long j2, Boolean bool) {
        if (bool == null) {
            nativeAddNull(this.f7033c, j2);
        } else {
            nativeAddBoolean(this.f7033c, j2, bool.booleanValue());
        }
    }
    ...
    public void e(long j2, Integer num) {
        if (num == null) {
            ...
            nativeAddInteger(this.f7033c, j2, num.intValue());
        }
    }
    ...
    public void f(long j2, Long l2) {
        if (l2 == null) {
            ...
            nativeAddInteger(this.f7033c, j2, l2.longValue());
        }
    }
    ...
    public void g(long j2, String str) {
        if (str == null) {
            ...
            nativeAddString(this.f7033c, j2, str);
        }
    }
}
