...
public class OsCollectionChangeSet implements s, i {
    ...
    public static long f6991e = nativeGetFinalizerPtr();
    public final long a;
    public final boolean b;

    /* renamed from: c  reason: collision with root package name */
    public final OsSubscription f6992c;
    ...
    public Throwable c() {
        OsSubscription osSubscription = this.f6992c;
        if (osSubscription == null || osSubscription.a() != OsSubscription.d.ERROR) {
            return null;
        }
        return (Throwable) OsSubscription.nativeGetError(this.f6992c.a);
    }
