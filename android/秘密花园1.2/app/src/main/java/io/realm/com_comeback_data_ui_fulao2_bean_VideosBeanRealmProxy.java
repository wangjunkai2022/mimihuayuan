...
public class com_comeback_data_ui_fulao2_bean_VideosBeanRealmProxy extends VideosBean implements n, t0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6904f = a("video_id", "video_id", a);
            this.f6905g = a("video_title", "video_title", a);
            this.f6906h = a("actor", "actor", a);
            this.f6907i = a("thumb", "thumb", a);
            this.f6908j = a("cover", "cover", a);
            this.f6909k = a("upload_date", "upload_date", a);
            this.f6910l = a("release_date", "release_date", a);
            this.f6911m = a("video_duration", "video_duration", a);
    ...
    public static VideosBean copy(x xVar, a aVar, VideosBean videosBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(VideosBean.class), aVar.f6903e, set);
        osObjectBuilder.g(aVar.f6904f, videosBean.realmGet$video_id());
        osObjectBuilder.g(aVar.f6905g, videosBean.realmGet$video_title());
        osObjectBuilder.g(aVar.f6906h, videosBean.realmGet$actor());
        osObjectBuilder.g(aVar.f6907i, videosBean.realmGet$thumb());
        osObjectBuilder.g(aVar.f6908j, videosBean.realmGet$cover());
        osObjectBuilder.f(aVar.f6909k, Long.valueOf(videosBean.realmGet$upload_date()));
        osObjectBuilder.f(aVar.f6910l, Long.valueOf(videosBean.realmGet$release_date()));
        osObjectBuilder.e(aVar.f6911m, Integer.valueOf(videosBean.realmGet$video_duration()));
    ...
    */
    ...
    public static long insert(x xVar, VideosBean videosBean, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6392j.e(VideosBean.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6392j;
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(VideosBean.class);
        long j3 = aVar.f6904f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$video_title != null) {
                Table.nativeSetString(j2, aVar.f6905g, createRowWithPrimaryKey, realmGet$video_title, false);
            }
            String realmGet$actor = videosBean.realmGet$actor();
            if (realmGet$actor != null) {
                Table.nativeSetString(j2, aVar.f6906h, createRowWithPrimaryKey, realmGet$actor, false);
            }
            String realmGet$thumb = videosBean.realmGet$thumb();
            if (realmGet$thumb != null) {
                Table.nativeSetString(j2, aVar.f6907i, createRowWithPrimaryKey, realmGet$thumb, false);
            }
            String realmGet$cover = videosBean.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6908j, createRowWithPrimaryKey, realmGet$cover, false);
            }
            Table.nativeSetLong(j2, aVar.f6909k, createRowWithPrimaryKey, videosBean.realmGet$upload_date(), false);
            Table.nativeSetLong(j2, aVar.f6910l, createRowWithPrimaryKey, videosBean.realmGet$release_date(), false);
            Table.nativeSetLong(j2, aVar.f6911m, createRowWithPrimaryKey, videosBean.realmGet$video_duration(), false);
    ...
    public static long insertOrUpdate(x xVar, VideosBean videosBean, Map<e0, Long> map) {
        ...
        String realmGet$video_title = videosBean.realmGet$video_title();
        if (realmGet$video_title != null) {
            Table.nativeSetString(j2, aVar.f6905g, j4, realmGet$video_title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6905g, j4, false);
        }
        String realmGet$actor = videosBean.realmGet$actor();
        if (realmGet$actor != null) {
            Table.nativeSetString(j2, aVar.f6906h, j4, realmGet$actor, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6906h, j4, false);
        }
        String realmGet$thumb = videosBean.realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(j2, aVar.f6907i, j4, realmGet$thumb, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6907i, j4, false);
        }
        String realmGet$cover = videosBean.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6908j, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6908j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6909k, j4, videosBean.realmGet$upload_date(), false);
        Table.nativeSetLong(j2, aVar.f6910l, j4, videosBean.realmGet$release_date(), false);
        Table.nativeSetLong(j2, aVar.f6911m, j4, videosBean.realmGet$video_duration(), false);
    ...
    public static com_comeback_data_ui_fulao2_bean_VideosBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(VideosBean.class);
    ...
    public static VideosBean update(x xVar, a aVar, VideosBean videosBean, VideosBean videosBean2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(VideosBean.class), aVar.f6903e, set);
        osObjectBuilder.g(aVar.f6904f, videosBean2.realmGet$video_id());
        osObjectBuilder.g(aVar.f6905g, videosBean2.realmGet$video_title());
        osObjectBuilder.g(aVar.f6906h, videosBean2.realmGet$actor());
        osObjectBuilder.g(aVar.f6907i, videosBean2.realmGet$thumb());
        osObjectBuilder.g(aVar.f6908j, videosBean2.realmGet$cover());
        osObjectBuilder.f(aVar.f6909k, Long.valueOf(videosBean2.realmGet$upload_date()));
        osObjectBuilder.f(aVar.f6910l, Long.valueOf(videosBean2.realmGet$release_date()));
        osObjectBuilder.e(aVar.f6911m, Integer.valueOf(videosBean2.realmGet$video_duration()));
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_fulao2_bean_videosbeanrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_fulao2_bean_videosbeanrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_fulao2_bean_videosbeanrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$actor() {
        ...
        return this.proxyState.f6380c.q(this.columnInfo.f6906h);
    }

    @Override // com.comeback.data.ui.fulao2.bean.VideosBean, g.a.t0
    public String realmGet$cover() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6908j);
    }
    ...
    public long realmGet$release_date() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.p(this.columnInfo.f6910l);
    }

    @Override // com.comeback.data.ui.fulao2.bean.VideosBean, g.a.t0
    public String realmGet$thumb() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6907i);
    }

    @Override // com.comeback.data.ui.fulao2.bean.VideosBean, g.a.t0
    public long realmGet$upload_date() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.p(this.columnInfo.f6909k);
    }

    @Override // com.comeback.data.ui.fulao2.bean.VideosBean, g.a.t0
    public int realmGet$video_duration() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.f6911m);
    }

    @Override // com.comeback.data.ui.fulao2.bean.VideosBean, g.a.t0
    public String realmGet$video_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6904f);
    }
    ...
    public String realmGet$video_title() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6905g);
    }
    ...
    public void realmSet$actor(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6906h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6906h, str);
        }
    }
    ...
    public void realmSet$cover(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6908j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6908j, str);
        }
    }
    ...
    public void realmSet$release_date(long j2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6910l, pVar.l(), j2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6910l, j2);
    }
    ...
    public void realmSet$thumb(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6907i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6907i, str);
        }
    }
    ...
    public void realmSet$upload_date(long j2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6909k, pVar.l(), j2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6909k, j2);
    }
    ...
    public void realmSet$video_duration(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6911m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6911m, i2);
    }
    ...
    public void realmSet$video_title(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6905g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6905g, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videosBean)) {
                if (videosBean instanceof n) {
                    n nVar = (n) videosBean;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(videosBean, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$video_id = videosBean.realmGet$video_id();
                if (realmGet$video_id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$video_title != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6905g, createRowWithPrimaryKey, realmGet$video_title, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$actor = videosBean.realmGet$actor();
                    if (realmGet$actor != null) {
                        Table.nativeSetString(j3, aVar.f6906h, createRowWithPrimaryKey, realmGet$actor, false);
                    }
                    String realmGet$thumb = videosBean.realmGet$thumb();
                    if (realmGet$thumb != null) {
                        Table.nativeSetString(j3, aVar.f6907i, createRowWithPrimaryKey, realmGet$thumb, false);
                    }
                    String realmGet$cover = videosBean.realmGet$cover();
                    if (realmGet$cover != null) {
                        Table.nativeSetString(j3, aVar.f6908j, createRowWithPrimaryKey, realmGet$cover, false);
                    }
                    Table.nativeSetLong(j3, aVar.f6909k, createRowWithPrimaryKey, videosBean.realmGet$upload_date(), false);
                    Table.nativeSetLong(j3, aVar.f6910l, createRowWithPrimaryKey, videosBean.realmGet$release_date(), false);
                    Table.nativeSetLong(j3, aVar.f6911m, createRowWithPrimaryKey, videosBean.realmGet$video_duration(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(videosBean)) {
                ...
                if (realmGet$video_title != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6905g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor = videosBean.realmGet$actor();
                if (realmGet$actor != null) {
                    Table.nativeSetString(j3, aVar.f6906h, createRowWithPrimaryKey, realmGet$actor, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6906h, createRowWithPrimaryKey, false);
                }
                String realmGet$thumb = videosBean.realmGet$thumb();
                if (realmGet$thumb != null) {
                    Table.nativeSetString(j3, aVar.f6907i, createRowWithPrimaryKey, realmGet$thumb, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6907i, createRowWithPrimaryKey, false);
                }
                String realmGet$cover = videosBean.realmGet$cover();
                if (realmGet$cover != null) {
                    Table.nativeSetString(j3, aVar.f6908j, createRowWithPrimaryKey, realmGet$cover, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6908j, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6909k, j5, videosBean.realmGet$upload_date(), false);
                Table.nativeSetLong(j3, aVar.f6910l, j5, videosBean.realmGet$release_date(), false);
                Table.nativeSetLong(j3, aVar.f6911m, j5, videosBean.realmGet$video_duration(), false);
