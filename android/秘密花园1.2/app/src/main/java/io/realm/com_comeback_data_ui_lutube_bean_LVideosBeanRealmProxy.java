...
public class com_comeback_data_ui_lutube_bean_LVideosBeanRealmProxy extends LVideosBean implements n, a1 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6950f = a("video_id", "video_id", a);
            this.f6951g = a("video_title", "video_title", a);
            this.f6952h = a("actor", "actor", a);
            this.f6953i = a("thumb", "thumb", a);
            this.f6954j = a("cover", "cover", a);
            this.f6955k = a("upload_date", "upload_date", a);
            this.f6956l = a("release_date", "release_date", a);
            this.f6957m = a("video_duration", "video_duration", a);
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6950f = aVar.f6950f;
            aVar2.f6951g = aVar.f6951g;
            aVar2.f6952h = aVar.f6952h;
            aVar2.f6953i = aVar.f6953i;
            aVar2.f6954j = aVar.f6954j;
            aVar2.f6955k = aVar.f6955k;
            aVar2.f6956l = aVar.f6956l;
            aVar2.f6957m = aVar.f6957m;
            aVar2.n = aVar.n;
            aVar2.f6949e = aVar.f6949e;
        }
    }
    ...
    public static LVideosBean copy(x xVar, a aVar, LVideosBean lVideosBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(LVideosBean.class), aVar.f6949e, set);
        osObjectBuilder.g(aVar.f6950f, lVideosBean.realmGet$video_id());
        osObjectBuilder.g(aVar.f6951g, lVideosBean.realmGet$video_title());
        osObjectBuilder.g(aVar.f6952h, lVideosBean.realmGet$actor());
        osObjectBuilder.g(aVar.f6953i, lVideosBean.realmGet$thumb());
        osObjectBuilder.g(aVar.f6954j, lVideosBean.realmGet$cover());
        osObjectBuilder.f(aVar.f6955k, Long.valueOf(lVideosBean.realmGet$upload_date()));
        osObjectBuilder.f(aVar.f6956l, Long.valueOf(lVideosBean.realmGet$release_date()));
        osObjectBuilder.e(aVar.f6957m, Integer.valueOf(lVideosBean.realmGet$video_duration()));
    ...
    */
    ...
    public static long insert(x xVar, LVideosBean lVideosBean, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6392j.e(LVideosBean.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6392j;
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(LVideosBean.class);
        long j3 = aVar.f6950f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$video_title != null) {
                Table.nativeSetString(j2, aVar.f6951g, createRowWithPrimaryKey, realmGet$video_title, false);
            }
            String realmGet$actor = lVideosBean.realmGet$actor();
            if (realmGet$actor != null) {
                Table.nativeSetString(j2, aVar.f6952h, createRowWithPrimaryKey, realmGet$actor, false);
            }
            String realmGet$thumb = lVideosBean.realmGet$thumb();
            if (realmGet$thumb != null) {
                Table.nativeSetString(j2, aVar.f6953i, createRowWithPrimaryKey, realmGet$thumb, false);
            }
            String realmGet$cover = lVideosBean.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6954j, createRowWithPrimaryKey, realmGet$cover, false);
            }
            Table.nativeSetLong(j2, aVar.f6955k, createRowWithPrimaryKey, lVideosBean.realmGet$upload_date(), false);
            Table.nativeSetLong(j2, aVar.f6956l, createRowWithPrimaryKey, lVideosBean.realmGet$release_date(), false);
            Table.nativeSetLong(j2, aVar.f6957m, createRowWithPrimaryKey, lVideosBean.realmGet$video_duration(), false);
    ...
    public static long insertOrUpdate(x xVar, LVideosBean lVideosBean, Map<e0, Long> map) {
        ...
        String realmGet$video_title = lVideosBean.realmGet$video_title();
        if (realmGet$video_title != null) {
            Table.nativeSetString(j2, aVar.f6951g, j4, realmGet$video_title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6951g, j4, false);
        }
        String realmGet$actor = lVideosBean.realmGet$actor();
        if (realmGet$actor != null) {
            Table.nativeSetString(j2, aVar.f6952h, j4, realmGet$actor, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6952h, j4, false);
        }
        String realmGet$thumb = lVideosBean.realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(j2, aVar.f6953i, j4, realmGet$thumb, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6953i, j4, false);
        }
        String realmGet$cover = lVideosBean.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6954j, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6954j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6955k, j4, lVideosBean.realmGet$upload_date(), false);
        Table.nativeSetLong(j2, aVar.f6956l, j4, lVideosBean.realmGet$release_date(), false);
        Table.nativeSetLong(j2, aVar.f6957m, j4, lVideosBean.realmGet$video_duration(), false);
    ...
    public static com_comeback_data_ui_lutube_bean_LVideosBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(LVideosBean.class);
    ...
    public static LVideosBean update(x xVar, a aVar, LVideosBean lVideosBean, LVideosBean lVideosBean2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(LVideosBean.class), aVar.f6949e, set);
        osObjectBuilder.g(aVar.f6950f, lVideosBean2.realmGet$video_id());
        osObjectBuilder.g(aVar.f6951g, lVideosBean2.realmGet$video_title());
        osObjectBuilder.g(aVar.f6952h, lVideosBean2.realmGet$actor());
        osObjectBuilder.g(aVar.f6953i, lVideosBean2.realmGet$thumb());
        osObjectBuilder.g(aVar.f6954j, lVideosBean2.realmGet$cover());
        osObjectBuilder.f(aVar.f6955k, Long.valueOf(lVideosBean2.realmGet$upload_date()));
        osObjectBuilder.f(aVar.f6956l, Long.valueOf(lVideosBean2.realmGet$release_date()));
        osObjectBuilder.e(aVar.f6957m, Integer.valueOf(lVideosBean2.realmGet$video_duration()));
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_lutube_bean_lvideosbeanrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_lutube_bean_lvideosbeanrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_lutube_bean_lvideosbeanrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$actor() {
        ...
        return this.proxyState.f6380c.q(this.columnInfo.f6952h);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public String realmGet$cover() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6954j);
    }
    ...
    public long realmGet$release_date() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.p(this.columnInfo.f6956l);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public String realmGet$thumb() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6953i);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public long realmGet$upload_date() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.p(this.columnInfo.f6955k);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public int realmGet$video_duration() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.f6957m);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public String realmGet$video_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6950f);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public boolean realmGet$video_like() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.m(this.columnInfo.n);
    }

    @Override // com.comeback.data.ui.lutube.bean.LVideosBean, g.a.a1
    public String realmGet$video_title() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6951g);
    }
    ...
    public void realmSet$actor(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6952h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6952h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6952h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6952h, str);
        }
    }
    ...
    public void realmSet$cover(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6954j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6954j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6954j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6954j, str);
        }
    }
    ...
    public void realmSet$release_date(long j2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6956l, pVar.l(), j2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6956l, j2);
    }
    ...
    public void realmSet$thumb(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6953i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6953i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6953i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6953i, str);
        }
    }
    ...
    public void realmSet$upload_date(long j2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6955k, pVar.l(), j2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6955k, j2);
    }
    ...
    public void realmSet$video_duration(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6957m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6957m, i2);
    }
    ...
    public void realmSet$video_like(boolean z) {
        ...
        vVar.f6382e.f();
        this.proxyState.f6380c.i(this.columnInfo.n, z);
    }
    ...
    public void realmSet$video_title(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6951g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6951g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6951g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6951g, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lVideosBean)) {
                if (lVideosBean instanceof n) {
                    n nVar = (n) lVideosBean;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(lVideosBean, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$video_id = lVideosBean.realmGet$video_id();
                if (realmGet$video_id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$video_title != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6951g, createRowWithPrimaryKey, realmGet$video_title, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$actor = lVideosBean.realmGet$actor();
                    if (realmGet$actor != null) {
                        Table.nativeSetString(j3, aVar.f6952h, createRowWithPrimaryKey, realmGet$actor, false);
                    }
                    String realmGet$thumb = lVideosBean.realmGet$thumb();
                    if (realmGet$thumb != null) {
                        Table.nativeSetString(j3, aVar.f6953i, createRowWithPrimaryKey, realmGet$thumb, false);
                    }
                    String realmGet$cover = lVideosBean.realmGet$cover();
                    if (realmGet$cover != null) {
                        Table.nativeSetString(j3, aVar.f6954j, createRowWithPrimaryKey, realmGet$cover, false);
                    }
                    Table.nativeSetLong(j3, aVar.f6955k, createRowWithPrimaryKey, lVideosBean.realmGet$upload_date(), false);
                    Table.nativeSetLong(j3, aVar.f6956l, createRowWithPrimaryKey, lVideosBean.realmGet$release_date(), false);
                    Table.nativeSetLong(j3, aVar.f6957m, createRowWithPrimaryKey, lVideosBean.realmGet$video_duration(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lVideosBean)) {
                ...
                if (realmGet$video_title != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6951g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor = lVideosBean.realmGet$actor();
                if (realmGet$actor != null) {
                    Table.nativeSetString(j3, aVar.f6952h, createRowWithPrimaryKey, realmGet$actor, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6952h, createRowWithPrimaryKey, false);
                }
                String realmGet$thumb = lVideosBean.realmGet$thumb();
                if (realmGet$thumb != null) {
                    Table.nativeSetString(j3, aVar.f6953i, createRowWithPrimaryKey, realmGet$thumb, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6953i, createRowWithPrimaryKey, false);
                }
                String realmGet$cover = lVideosBean.realmGet$cover();
                if (realmGet$cover != null) {
                    Table.nativeSetString(j3, aVar.f6954j, createRowWithPrimaryKey, realmGet$cover, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6954j, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6955k, j5, lVideosBean.realmGet$upload_date(), false);
                Table.nativeSetLong(j3, aVar.f6956l, j5, lVideosBean.realmGet$release_date(), false);
                Table.nativeSetLong(j3, aVar.f6957m, j5, lVideosBean.realmGet$video_duration(), false);
