...
public class com_comeback_data_ui_hm_bean_ItemInfoRealmProxy extends ItemInfo implements n, u0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6913f = a("type", "type", a);
            this.f6914g = a("id", "id", a);
            this.f6915h = a("image", "image", a);
            this.f6916i = a(NotificationCompatJellybean.KEY_TITLE, NotificationCompatJellybean.KEY_TITLE, a);
            this.f6917j = a("desc", "desc", a);
            this.f6918k = a(NotificationCompat.CarExtender.KEY_AUTHOR, NotificationCompat.CarExtender.KEY_AUTHOR, a);
            this.f6919l = a("update", "update", a);
            this.f6912e = a.a();
        }
    ...
    public static ItemInfo copy(x xVar, a aVar, ItemInfo itemInfo, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6392j.e(ItemInfo.class);
        long j2 = aVar.f6912e;
    ...
    */
    ...
    public static long insert(x xVar, ItemInfo itemInfo, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(ItemInfo.class);
        long j3 = aVar.f6914g;
        String realmGet$id = itemInfo.realmGet$id();
        if (realmGet$id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            Table.nativeSetLong(j2, aVar.f6913f, createRowWithPrimaryKey, itemInfo.realmGet$type(), false);
            String realmGet$image = itemInfo.realmGet$image();
            if (realmGet$image != null) {
                Table.nativeSetString(j2, aVar.f6915h, createRowWithPrimaryKey, realmGet$image, false);
            }
            String realmGet$title = itemInfo.realmGet$title();
            if (realmGet$title != null) {
                Table.nativeSetString(j2, aVar.f6916i, createRowWithPrimaryKey, realmGet$title, false);
            }
            String realmGet$desc = itemInfo.realmGet$desc();
            if (realmGet$desc != null) {
                Table.nativeSetString(j2, aVar.f6917j, createRowWithPrimaryKey, realmGet$desc, false);
            }
            String realmGet$author = itemInfo.realmGet$author();
            if (realmGet$author != null) {
                Table.nativeSetString(j2, aVar.f6918k, createRowWithPrimaryKey, realmGet$author, false);
            }
            String realmGet$update = itemInfo.realmGet$update();
            if (realmGet$update != null) {
                Table.nativeSetString(j2, aVar.f6919l, createRowWithPrimaryKey, realmGet$update, false);
            }
    ...
    public static long insertOrUpdate(x xVar, ItemInfo itemInfo, Map<e0, Long> map) {
        ...
        Table.nativeSetLong(j2, aVar.f6913f, j4, itemInfo.realmGet$type(), false);
        String realmGet$image = itemInfo.realmGet$image();
        if (realmGet$image != null) {
            Table.nativeSetString(j2, aVar.f6915h, j4, realmGet$image, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6915h, j4, false);
        }
        String realmGet$title = itemInfo.realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(j2, aVar.f6916i, j4, realmGet$title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6916i, j4, false);
        }
        String realmGet$desc = itemInfo.realmGet$desc();
        if (realmGet$desc != null) {
            Table.nativeSetString(j2, aVar.f6917j, j4, realmGet$desc, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6917j, j4, false);
        }
        String realmGet$author = itemInfo.realmGet$author();
        if (realmGet$author != null) {
            Table.nativeSetString(j2, aVar.f6918k, j4, realmGet$author, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6918k, j4, false);
        }
        String realmGet$update = itemInfo.realmGet$update();
        if (realmGet$update != null) {
            Table.nativeSetString(j2, aVar.f6919l, j4, realmGet$update, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6919l, j4, false);
        }
        return j4;
    }
    ...
    public static com_comeback_data_ui_hm_bean_ItemInfoRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(ItemInfo.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_hm_bean_iteminforealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_hm_bean_iteminforealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_hm_bean_iteminforealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$author() {
        ...
        return this.proxyState.f6380c.q(this.columnInfo.f6918k);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$desc() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6917j);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6914g);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$image() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6915h);
    }
    ...
    public String realmGet$title() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6916i);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public int realmGet$type() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.f6913f);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$update() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6919l);
    }
    ...
    public void realmSet$author(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6918k, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6918k, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6918k);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6918k, str);
        }
    }
    ...
    public void realmSet$desc(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6917j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6917j, str);
        }
    }
    ...
    public void realmSet$image(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6915h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6915h, str);
        }
    }
    ...
    public void realmSet$title(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6916i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6916i, str);
        }
    }
    ...
    public void realmSet$type(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6913f, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6913f, i2);
    }
    ...
    public void realmSet$update(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6919l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6919l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6919l);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6919l, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(itemInfo)) {
                if (itemInfo instanceof n) {
                    n nVar = (n) itemInfo;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(itemInfo, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$id = itemInfo.realmGet$id();
                if (realmGet$id == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(itemInfo)) {
                ...
                if (realmGet$image != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6915h, createRowWithPrimaryKey, false);
                }
                String realmGet$title = itemInfo.realmGet$title();
                if (realmGet$title != null) {
                    Table.nativeSetString(j2, aVar.f6916i, createRowWithPrimaryKey, realmGet$title, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6916i, createRowWithPrimaryKey, false);
                }
                String realmGet$desc = itemInfo.realmGet$desc();
                if (realmGet$desc != null) {
                    Table.nativeSetString(j2, aVar.f6917j, createRowWithPrimaryKey, realmGet$desc, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6917j, createRowWithPrimaryKey, false);
                }
                String realmGet$author = itemInfo.realmGet$author();
                if (realmGet$author != null) {
                    Table.nativeSetString(j2, aVar.f6918k, createRowWithPrimaryKey, realmGet$author, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6918k, createRowWithPrimaryKey, false);
                }
                String realmGet$update = itemInfo.realmGet$update();
                if (realmGet$update != null) {
                    Table.nativeSetString(j2, aVar.f6919l, createRowWithPrimaryKey, realmGet$update, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6919l, createRowWithPrimaryKey, false);
                }
                j3 = j4;
            }
        }
