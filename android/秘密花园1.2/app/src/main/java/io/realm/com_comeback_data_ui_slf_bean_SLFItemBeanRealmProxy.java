...
public class com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy extends SLFItemBean implements n, e1 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6980g = a("name", "name", a);
            this.f6981h = a("click", "click", a);
            this.f6982i = a("favorite", "favorite", a);
            this.f6983j = a("img", "img", a);
            this.f6984k = a("sale", "sale", a);
            this.f6985l = a("updateTime", "updateTime", a);
            this.f6986m = a("description", "description", a);
    ...
    public static SLFItemBean copy(x xVar, a aVar, SLFItemBean sLFItemBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(SLFItemBean.class), aVar.f6978e, set);
        osObjectBuilder.g(aVar.f6979f, sLFItemBean.realmGet$id());
        osObjectBuilder.g(aVar.f6980g, sLFItemBean.realmGet$name());
        osObjectBuilder.g(aVar.f6981h, sLFItemBean.realmGet$click());
        osObjectBuilder.g(aVar.f6982i, sLFItemBean.realmGet$favorite());
        osObjectBuilder.g(aVar.f6983j, sLFItemBean.realmGet$img());
        osObjectBuilder.e(aVar.f6984k, Integer.valueOf(sLFItemBean.realmGet$sale()));
        osObjectBuilder.g(aVar.f6985l, sLFItemBean.realmGet$updateTime());
        osObjectBuilder.g(aVar.f6986m, sLFItemBean.realmGet$description());
    ...
    */
    ...
    public static long insert(x xVar, SLFItemBean sLFItemBean, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6392j.e(SLFItemBean.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6392j;
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(SLFItemBean.class);
        long j3 = aVar.f6979f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6980g, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$click = sLFItemBean.realmGet$click();
            if (realmGet$click != null) {
                Table.nativeSetString(j2, aVar.f6981h, createRowWithPrimaryKey, realmGet$click, false);
            }
            String realmGet$favorite = sLFItemBean.realmGet$favorite();
            if (realmGet$favorite != null) {
                Table.nativeSetString(j2, aVar.f6982i, createRowWithPrimaryKey, realmGet$favorite, false);
            }
            String realmGet$img = sLFItemBean.realmGet$img();
            if (realmGet$img != null) {
                Table.nativeSetString(j2, aVar.f6983j, createRowWithPrimaryKey, realmGet$img, false);
            }
            Table.nativeSetLong(j2, aVar.f6984k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
            String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
            if (realmGet$updateTime != null) {
                Table.nativeSetString(j2, aVar.f6985l, createRowWithPrimaryKey, realmGet$updateTime, false);
            }
            String realmGet$description = sLFItemBean.realmGet$description();
            if (realmGet$description != null) {
                Table.nativeSetString(j2, aVar.f6986m, createRowWithPrimaryKey, realmGet$description, false);
            }
    ...
    public static long insertOrUpdate(x xVar, SLFItemBean sLFItemBean, Map<e0, Long> map) {
        ...
        String realmGet$name = sLFItemBean.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6980g, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6980g, j4, false);
        }
        String realmGet$click = sLFItemBean.realmGet$click();
        if (realmGet$click != null) {
            Table.nativeSetString(j2, aVar.f6981h, j4, realmGet$click, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6981h, j4, false);
        }
        String realmGet$favorite = sLFItemBean.realmGet$favorite();
        if (realmGet$favorite != null) {
            Table.nativeSetString(j2, aVar.f6982i, j4, realmGet$favorite, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6982i, j4, false);
        }
        String realmGet$img = sLFItemBean.realmGet$img();
        if (realmGet$img != null) {
            Table.nativeSetString(j2, aVar.f6983j, j4, realmGet$img, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6983j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6984k, j4, sLFItemBean.realmGet$sale(), false);
        String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
        if (realmGet$updateTime != null) {
            Table.nativeSetString(j2, aVar.f6985l, j4, realmGet$updateTime, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6985l, j4, false);
        }
        String realmGet$description = sLFItemBean.realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(j2, aVar.f6986m, j4, realmGet$description, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6986m, j4, false);
        }
        String realmGet$summary = sLFItemBean.realmGet$summary();
        if (realmGet$summary != null) {
    ...
    public static com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(SLFItemBean.class);
    ...
    public static SLFItemBean update(x xVar, a aVar, SLFItemBean sLFItemBean, SLFItemBean sLFItemBean2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(SLFItemBean.class), aVar.f6978e, set);
        osObjectBuilder.g(aVar.f6979f, sLFItemBean2.realmGet$id());
        osObjectBuilder.g(aVar.f6980g, sLFItemBean2.realmGet$name());
        osObjectBuilder.g(aVar.f6981h, sLFItemBean2.realmGet$click());
        osObjectBuilder.g(aVar.f6982i, sLFItemBean2.realmGet$favorite());
        osObjectBuilder.g(aVar.f6983j, sLFItemBean2.realmGet$img());
        osObjectBuilder.e(aVar.f6984k, Integer.valueOf(sLFItemBean2.realmGet$sale()));
        osObjectBuilder.g(aVar.f6985l, sLFItemBean2.realmGet$updateTime());
        osObjectBuilder.g(aVar.f6986m, sLFItemBean2.realmGet$description());
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_slf_bean_slfitembeanrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_slf_bean_slfitembeanrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_slf_bean_slfitembeanrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$click() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6981h);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$description() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6986m);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$favorite() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6982i);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6979f);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$img() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6983j);
    }
    ...
    public String realmGet$name() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6980g);
    }
    ...
    public int realmGet$sale() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.f6984k);
    }
    ...
    public String realmGet$updateTime() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6985l);
    }
    ...
    public void realmSet$click(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6981h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6981h, str);
        }
    }
    ...
    public void realmSet$description(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6986m, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6986m, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6986m);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6986m, str);
        }
    }
    ...
    public void realmSet$favorite(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6982i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6982i, str);
        }
    }
    ...
    public void realmSet$img(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6983j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6983j, str);
        }
    }
    ...
    public void realmSet$name(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6980g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6980g, str);
        }
    }
    ...
    public void realmSet$sale(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6984k, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6984k, i2);
    }
    ...
    public void realmSet$updateTime(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6985l);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6985l, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(sLFItemBean)) {
                if (sLFItemBean instanceof n) {
                    n nVar = (n) sLFItemBean;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(sLFItemBean, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$id = sLFItemBean.realmGet$id();
                if (realmGet$id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$name != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6980g, createRowWithPrimaryKey, realmGet$name, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$click = sLFItemBean.realmGet$click();
                    if (realmGet$click != null) {
                        Table.nativeSetString(j3, aVar.f6981h, createRowWithPrimaryKey, realmGet$click, false);
                    }
                    String realmGet$favorite = sLFItemBean.realmGet$favorite();
                    if (realmGet$favorite != null) {
                        Table.nativeSetString(j3, aVar.f6982i, createRowWithPrimaryKey, realmGet$favorite, false);
                    }
                    String realmGet$img = sLFItemBean.realmGet$img();
                    if (realmGet$img != null) {
                        Table.nativeSetString(j3, aVar.f6983j, createRowWithPrimaryKey, realmGet$img, false);
                    }
                    Table.nativeSetLong(j3, aVar.f6984k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
                    String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
                    if (realmGet$updateTime != null) {
                        Table.nativeSetString(j3, aVar.f6985l, createRowWithPrimaryKey, realmGet$updateTime, false);
                    }
                    String realmGet$description = sLFItemBean.realmGet$description();
                    if (realmGet$description != null) {
                        Table.nativeSetString(j3, aVar.f6986m, createRowWithPrimaryKey, realmGet$description, false);
                    }
                    String realmGet$summary = sLFItemBean.realmGet$summary();
                    if (realmGet$summary != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(sLFItemBean)) {
                ...
                if (realmGet$description != null) {
                    ...
                    Table.nativeSetNull(j3, aVar.f6986m, createRowWithPrimaryKey, false);
                }
                String realmGet$summary = sLFItemBean.realmGet$summary();
                if (realmGet$summary != null) {
                    Table.nativeSetString(j3, aVar.n, createRowWithPrimaryKey, realmGet$summary, false);
