...
public class b0 implements Cloneable, f.a {
    ...
    public final List<y> f6442c;

    /* renamed from: d  reason: collision with root package name */
    public final List<y> f6443d;

    /* renamed from: e  reason: collision with root package name */
    public final t.b f6444e;
    ...
    public final p f6449j;

    /* renamed from: k  reason: collision with root package name */
    public final d f6450k;

    /* renamed from: l  reason: collision with root package name */
    public final s f6451l;

    /* renamed from: m  reason: collision with root package name */
    public final Proxy f6452m;
    ...
    public static final List<m> D = i.m0.b.o(m.f6570g, m.f6571h);
    ...
    public static final class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final List<y> f6453c = new ArrayList();

        /* renamed from: d  reason: collision with root package name */
        public final List<y> f6454d = new ArrayList();

        /* renamed from: e  reason: collision with root package name */
        public t.b f6455e = new i.m0.a(t.a);
        ...
        public final a a(y yVar) {
            this.f6453c.add(yVar);
            return this;
        }

        public final a b(y yVar) {
            this.f6454d.add(yVar);
            return this;
        }
    ...
    */
    ...
    public a b() {
        ...
        aVar.a = this.a;
        aVar.b = this.b;
        c.a.a.b.g.h.d(aVar.f6453c, this.f6442c);
        c.a.a.b.g.h.d(aVar.f6454d, this.f6443d);
        aVar.f6455e = this.f6444e;
        aVar.f6456f = this.f6445f;
        aVar.f6457g = this.f6446g;
        aVar.f6458h = this.f6447h;
        aVar.f6459i = this.f6448i;
        aVar.f6460j = this.f6449j;
        aVar.f6461k = this.f6450k;
        aVar.f6462l = this.f6451l;
        aVar.f6463m = this.f6452m;
        aVar.n = this.n;
        aVar.o = this.o;
        aVar.p = this.p;
        aVar.q = this.q;
