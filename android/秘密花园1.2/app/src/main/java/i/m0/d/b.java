...
public final class b {
    ...
    public final i.m a(SSLSocket sSLSocket) throws IOException {
        ...
        int i2 = this.a;
        int size = this.f6605d.size();
        while (true) {
            if (i2 >= size) {
                mVar = null;
                break;
            }
            mVar = this.f6605d.get(i2);
            if (mVar.b(sSLSocket)) {
                this.a = i2 + 1;
                break;
            }
        ...
        if (mVar == null) {
            ...
            o.append(this.f6604c);
            o.append(',');
            o.append(" modes=");
            o.append(this.f6605d);
            o.append(',');
        ...
        int i3 = this.a;
        int size2 = this.f6605d.size();
        while (true) {
            if (i3 >= size2) {
                z = false;
                break;
            } else if (this.f6605d.get(i3).b(sSLSocket)) {
                z = true;
                break;
            } else {
                i3++;
        ...
        if (mVar.f6573d != null) {
            ...
            enabledProtocols = i.m0.b.v(enabledProtocols3, mVar.f6573d, h.l.a.a);
        } else {
        ...
        i.m a = aVar.a();
        if (a.c() != null) {
            sSLSocket.setEnabledProtocols(a.f6573d);
        }
        if (a.a() != null) {
            sSLSocket.setEnabledCipherSuites(a.f6572c);
        }
        return mVar;
    }
}
