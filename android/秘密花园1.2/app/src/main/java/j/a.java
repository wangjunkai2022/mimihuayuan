...
public final class a {
    public static final byte[] a = k.f7054e.b("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").f7055c;

    static {
        k.f7054e.b("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_");
    }
    ...
    public static String b(byte[] bArr, byte[] bArr2, int i2) {
        ...
        if (bArr == null) {
            ...
            while (i3 < length) {
                ...
                int i10 = i9 + 1;
                bArr4[i9] = bArr3[((b2 & ap.f3116m) << 2) | ((b3 & 255) >> 6)];
                i4 = i10 + 1;
            ...
            if (length2 == 1) {
                ...
                bArr4[i15] = bArr3[(b7 & ap.f3116m) << 2];
                bArr4[i15 + 1] = (byte) 61;
            }
