...
public final class g<T> implements e.b<T, m.e<? extends T>> {
    ...
    public static final class b<T> extends m.j<T> {
        ...
        public static final int f7316j = m.o.d.b.f7370c / 4;

        /* renamed from: e  reason: collision with root package name */
        public final d<T> f7317e;

        /* renamed from: f  reason: collision with root package name */
        public final long f7318f;

        /* renamed from: g  reason: collision with root package name */
        public volatile boolean f7319g;

        /* renamed from: h  reason: collision with root package name */
        public volatile m.o.d.b f7320h;
        ...
        public void f(T t) {
            boolean z;
            d<T> dVar = this.f7317e;
            long j2 = dVar.f7325h.get();
            if (j2 != 0) {
                synchronized (dVar) {
                    j2 = dVar.f7325h.get();
                    if (dVar.f7330m || j2 == 0) {
        ...
        @Override // m.j
        public void g() {
            int i2 = m.o.d.b.f7370c;
            this.f7321i = i2;
            h(i2);
        }

        public void j(long j2) {
            int i2 = this.f7321i - ((int) j2);
            if (i2 > f7316j) {
                this.f7321i = i2;
                return;
            }
            int i3 = m.o.d.b.f7370c;
            this.f7321i = i3;
            int i4 = i3 - i2;
            if (i4 > 0) {
                h(i4);
    ...
    public static final class d<T> extends m.j<m.e<? extends T>> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final m.j<? super T> f7322e;
        ...
        /* renamed from: i  reason: collision with root package name */
        public volatile Queue<Object> f7326i;

        /* renamed from: j  reason: collision with root package name */
        public volatile m.s.a f7327j;

        /* renamed from: k  reason: collision with root package name */
        public volatile ConcurrentLinkedQueue<Throwable> f7328k;

        /* renamed from: l  reason: collision with root package name */
        public volatile boolean f7329l;
        ...
        public void f(Object obj) {
            ...
            if (eVar == m.o.a.a.b) {
                ...
                if (z) {
                    Queue<Object> queue = this.f7326i;
                    if (queue != null && !queue.isEmpty()) {
                        n(null);
                        l();
                        return;
        ...
        public boolean j() {
            ...
            ConcurrentLinkedQueue<Throwable> concurrentLinkedQueue = this.f7328k;
            if (this.f7323f || concurrentLinkedQueue == null || concurrentLinkedQueue.isEmpty()) {
                return false;
            }
            try {
                q();
        ...
        */
        ...
        public Queue<Throwable> m() {
            ...
            if (concurrentLinkedQueue == null) {
                synchronized (this) {
                    concurrentLinkedQueue = this.f7328k;
                    if (concurrentLinkedQueue == null) {
                        concurrentLinkedQueue = new ConcurrentLinkedQueue<>();
                        this.f7328k = concurrentLinkedQueue;
                    }
                }
            }
        ...
        public void n(T t) {
            ...
            if (queue == null) {
                int i2 = this.f7324g;
                if (i2 == Integer.MAX_VALUE) {
                    queue = new m.o.d.i.d<>(m.o.d.b.f7370c);
                } else {
                    if (((i2 + (-1)) & i2) == 0) {
                        if (o.b()) {
        ...
        public void o(b<T> bVar, T t) {
            m.o.d.b bVar2 = bVar.f7320h;
            if (bVar2 == null) {
                if (o.b()) {
                    bVar2 = new m.o.d.b(false, m.o.d.b.f7370c);
                } else {
                    bVar2 = new m.o.d.b();
                }
                bVar.a.b(bVar2);
        ...
        public final void q() {
            ArrayList arrayList = new ArrayList(this.f7328k);
            if (arrayList.size() == 1) {
                this.f7322e.e((Throwable) arrayList.get(0));
            } else {
                this.f7322e.e(new m.m.a(arrayList));
            }
        }
    }
