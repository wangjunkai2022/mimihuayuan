...
public class o {
    ...
    public static final o f7408f = new o();

    /* renamed from: g  reason: collision with root package name */
    public static final m.q.b f7409g = new a();
    public final AtomicReference<m.q.b> a = new AtomicReference<>();
    public final AtomicReference<m> b = new AtomicReference<>();

    /* renamed from: c  reason: collision with root package name */
    public final AtomicReference<q> f7410c = new AtomicReference<>();

    /* renamed from: d  reason: collision with root package name */
    public final AtomicReference<m.q.a> f7411d = new AtomicReference<>();

    /* renamed from: e  reason: collision with root package name */
    public final AtomicReference<p> f7412e = new AtomicReference<>();
    ...
    */
    ...
    public m.q.a a() {
        if (this.f7411d.get() == null) {
            Object d2 = d(m.q.a.class, g());
            if (d2 == null) {
                this.f7411d.compareAndSet(null, new b(this));
            } else {
                this.f7411d.compareAndSet(null, (m.q.a) d2);
            }
        }
        return this.f7411d.get();
    }
    ...
    public m.q.b b() {
        if (this.a.get() == null) {
            ...
            if (d2 == null) {
                this.a.compareAndSet(null, f7409g);
            } else {
    ...
    public p e() {
        if (this.f7412e.get() == null) {
            Object d2 = d(p.class, g());
            if (d2 == null) {
                this.f7412e.compareAndSet(null, p.a);
            } else {
                this.f7412e.compareAndSet(null, (p) d2);
            }
        }
        return this.f7412e.get();
    }

    public q f() {
        if (this.f7410c.get() == null) {
            Object d2 = d(q.class, g());
            if (d2 == null) {
                this.f7410c.compareAndSet(null, r.a);
            } else {
                this.f7410c.compareAndSet(null, (q) d2);
            }
        }
        return this.f7410c.get();
    }
}
