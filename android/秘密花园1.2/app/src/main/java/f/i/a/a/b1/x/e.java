...
public final class e implements f.i.a.a.b1.g {
    ...
    public final f.i.a.a.m1.u f4418c;

    /* renamed from: d  reason: collision with root package name */
    public final f.i.a.a.m1.u f4419d;

    /* renamed from: e  reason: collision with root package name */
    public final f.i.a.a.m1.t f4420e;
    ...
    public final int b(f.i.a.a.b1.d dVar) throws IOException, InterruptedException {
        int i2 = 0;
        while (true) {
            dVar.d(this.f4419d.a, 0, 10, false);
            this.f4419d.A(0);
            if (this.f4419d.r() != n) {
                break;
            }
    ...
    public int c(f.i.a.a.b1.d dVar, f.i.a.a.b1.m mVar) throws IOException, InterruptedException {
        ...
        if (z && !this.f4426k) {
            ...
            int i3 = 0;
            while (true) {
                if (!dVar.d(this.f4419d.a, 0, 2, true)) {
                    break;
                }
                this.f4419d.A(0);
                if (!f.g(this.f4419d.u())) {
                    i3 = 0;
                    break;
                } else if (!dVar.d(this.f4419d.a, 0, 4, true)) {
                    break;
                } else {
                    this.f4420e.j(14);
                    int f2 = this.f4420e.f(13);
                    if (f2 <= 6) {
                        this.f4426k = true;
            ...
            dVar.f4119f = 0;
            if (i3 > 0) {
                this.f4425j = (int) (j3 / i3);
            } else {
                this.f4425j = -1;
            }
            this.f4426k = true;
        }
        int e2 = dVar.e(this.f4418c.a, 0, 2048);
        boolean z2 = e2 == -1;
        if (!this.f4428m) {
            boolean z3 = z && this.f4425j > 0;
            if (!z3 || this.b.q != -9223372036854775807L || z2) {
                f.i.a.a.b1.h hVar = this.f4422g;
                c.a.a.b.g.h.t(hVar);
                if (z3) {
                    long j4 = this.b.q;
                    if (j4 != -9223372036854775807L) {
                        hVar.a(new f.i.a.a.b1.c(j2, this.f4424i, (int) (((i2 * 8) * 1000000) / j4), this.f4425j));
                        this.f4428m = true;
                    }
                }
        ...
        this.f4418c.z(e2);
        if (!this.f4427l) {
            this.b.s = this.f4423h;
            this.f4427l = true;
        }
        this.b.c(this.f4418c);
        return 0;
    }
    ...
    */
    ...
    public e(long j2, int i2) {
        ...
        this.f4418c = new f.i.a.a.m1.u(2048);
        this.f4425j = -1;
        this.f4424i = -1L;
        f.i.a.a.m1.u uVar = new f.i.a.a.m1.u(10);
        this.f4419d = uVar;
        this.f4420e = new f.i.a.a.m1.t(uVar.a);
    }
}
