...
public final class r implements g, i0 {
    ...
    public final f.i.a.a.m1.m<g.a> f5690c;

    /* renamed from: d  reason: collision with root package name */
    public final f.i.a.a.m1.z f5691d;

    /* renamed from: e  reason: collision with root package name */
    public final f.i.a.a.m1.h f5692e;
    ...
    public static void i(r rVar) {
        synchronized (rVar) {
            ...
            rVar.f5696i = F;
            if (F != 1 && F != 0 && F != 8) {
                rVar.f5699l = rVar.j(F);
                long c2 = rVar.f5692e.c();
                rVar.l(rVar.f5693f > 0 ? (int) (c2 - rVar.f5694g) : 0, rVar.f5695h, rVar.f5699l);
                rVar.f5694g = c2;
                rVar.f5695h = 0L;
                rVar.f5698k = 0L;
                rVar.f5697j = 0L;
                f.i.a.a.m1.z zVar = rVar.f5691d;
                zVar.b.clear();
                zVar.f5783d = -1;
                zVar.f5784e = 0;
                zVar.f5785f = 0;
    ...
    public synchronized void d(m mVar, p pVar, boolean z) {
        if (z) {
            c.a.a.b.g.h.v(this.f5693f > 0);
            long c2 = this.f5692e.c();
            int i2 = (int) (c2 - this.f5694g);
            long j2 = i2;
            this.f5697j += j2;
            this.f5698k += this.f5695h;
            if (i2 > 0) {
                this.f5691d.a((int) Math.sqrt(this.f5695h), (float) ((this.f5695h * 8000) / j2));
                if (this.f5697j >= ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS || this.f5698k >= 524288) {
                    this.f5699l = this.f5691d.b(0.5f);
                }
                l(i2, this.f5695h, this.f5699l);
                this.f5694g = c2;
                this.f5695h = 0L;
            }
            this.f5693f--;
    ...
    public final void l(final int i2, final long j2, final long j3) {
        if (i2 == 0 && j2 == 0 && j3 == this.f5700m) {
            return;
        }
        this.f5700m = j3;
        this.f5690c.b(new m.a() { // from class: f.i.a.a.l1.b
    ...
    public r(@Nullable Context context, SparseArray<Long> sparseArray, int i2, f.i.a.a.m1.h hVar, boolean z) {
        this.a = context == null ? null : context.getApplicationContext();
        this.b = sparseArray;
        this.f5690c = new f.i.a.a.m1.m<>();
        this.f5691d = new f.i.a.a.m1.z(i2);
        this.f5692e = hVar;
