...
public final class q implements d0, d0.a {
        ...
        public int i(f.i.a.a.c0 c0Var, f.i.a.a.y0.e eVar, boolean z) {
            ...
            if (i2 == -5) {
                ...
                if (b0Var.y != 0 || b0Var.z != 0) {
                    c0Var.a = b0Var.c(q.this.f4915e != 0 ? 0 : b0Var.y, q.this.f4916f == Long.MIN_VALUE ? b0Var.z : 0);
                }
                return -5;
            }
            long j2 = q.this.f4916f;
            if (j2 == Long.MIN_VALUE || ((i2 != -4 || eVar.f6031d < j2) && !(i2 == -3 && q.this.e() == Long.MIN_VALUE))) {
                return i2;
            }
            eVar.i();
            eVar.a = 4;
    ...
    public q(d0 d0Var, boolean z, long j2, long j3) {
        this.a = d0Var;
        this.f4914d = z ? j2 : -9223372036854775807L;
        this.f4915e = j2;
        this.f4916f = j3;
    }

    public boolean a() {
        return this.f4914d != -9223372036854775807L;
    }
    ...
    */
    ...
    public long l() {
        if (a()) {
            long j2 = this.f4914d;
            this.f4914d = -9223372036854775807L;
            long l2 = l();
