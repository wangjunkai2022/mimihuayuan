...
public final class a {
    ...
    public final MediaCodecInfo.CodecCapabilities f4597d;
    ...
    */
    ...
    public boolean c(b0 b0Var) {
        ...
        Pair<Integer, Integer> c2 = d.c(b0Var.f4085f);
        return c2 != null && ((Integer) c2.first).intValue() == 42;
    }

    public boolean d(b0 b0Var, b0 b0Var2, boolean z) {
        if (this.f4601h) {
            return b0Var.f4088i.equals(b0Var2.f4088i) && b0Var.q == b0Var2.q && (this.f4598e || (b0Var.n == b0Var2.n && b0Var.o == b0Var2.o)) && ((!z && b0Var2.u == null) || h0.b(b0Var.u, b0Var2.u));
        }
        if ("audio/mp4a-latm".equals(this.b) && b0Var.f4088i.equals(b0Var2.f4088i) && b0Var.v == b0Var2.v && b0Var.w == b0Var2.w) {
            Pair<Integer, Integer> c2 = d.c(b0Var.f4085f);
            Pair<Integer, Integer> c3 = d.c(b0Var2.f4085f);
            if (c2 != null && c3 != null) {
    ...
    public boolean e(int i2, int i3, double d2) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.f4597d;
        if (codecCapabilities == null) {
            String str = h0.f5739e;
            return false;
        }
        MediaCodecInfo.VideoCapabilities videoCapabilities = codecCapabilities.getVideoCapabilities();
        if (videoCapabilities == null) {
            String str2 = h0.f5739e;
            return false;
        } else if (a(videoCapabilities, i2, i3, d2)) {
            return true;
        } else {
            if (i2 < i3 && a(videoCapabilities, i3, i2, d2)) {
                String str3 = h0.f5739e;
                return true;
            }
            String str4 = h0.f5739e;
            return false;
        }
    }
