...
public class g {
    ...
    public final f.i.a.a.l1.m f5103c;

    /* renamed from: d  reason: collision with root package name */
    public final q f5104d;

    /* renamed from: e  reason: collision with root package name */
    public final Uri[] f5105e;

    /* renamed from: f  reason: collision with root package name */
    public final b0[] f5106f;

    /* renamed from: g  reason: collision with root package name */
    public final f.i.a.a.h1.u0.t.j f5107g;

    /* renamed from: h  reason: collision with root package name */
    public final o0 f5108h;

    /* renamed from: i  reason: collision with root package name */
    public final List<b0> f5109i;
    ...
    public static final class e extends f.i.a.a.j1.c {
        ...
        public void h(long j2, long j3, long j4, List<? extends f.i.a.a.h1.s0.l> list, f.i.a.a.h1.s0.m[] mVarArr) {
            ...
            if (s(this.f5116g, elapsedRealtime)) {
    ...
    public g(i iVar, f.i.a.a.h1.u0.t.j jVar, Uri[] uriArr, b0[] b0VarArr, h hVar, @Nullable i0 i0Var, q qVar, List<b0> list) {
        ...
        this.f5103c = hVar.a(3);
        this.f5108h = new o0(b0VarArr);
        int[] iArr = new int[uriArr.length];
        for (int i2 = 0; i2 < uriArr.length; i2++) {
            iArr[i2] = i2;
        }
        this.p = new e(this.f5108h, iArr);
    }

    public f.i.a.a.h1.s0.m[] a(@Nullable k kVar, long j2) {
        int a2 = kVar == null ? -1 : this.f5108h.a(kVar.f4942c);
        int length = this.p.length();
        f.i.a.a.h1.s0.m[] mVarArr = new f.i.a.a.h1.s0.m[length];
        for (int i2 = 0; i2 < length; i2++) {
            int e2 = this.p.e(i2);
            Uri uri = this.f5105e[e2];
            if (!((f.i.a.a.h1.u0.t.c) this.f5107g).e(uri)) {
                mVarArr[i2] = f.i.a.a.h1.s0.m.a;
            } else {
                f.i.a.a.h1.u0.t.f d2 = ((f.i.a.a.h1.u0.t.c) this.f5107g).d(uri, false);
                long j3 = d2.f5191f - ((f.i.a.a.h1.u0.t.c) this.f5107g).p;
    ...
    public final long b(@Nullable k kVar, boolean z, f.i.a.a.h1.u0.t.f fVar, long j2, long j3) {
        ...
        if (!fVar.f5197l && j3 >= j5) {
            d2 = fVar.f5194i;
            j4 = fVar.o.size();
        } else {
            d2 = h0.d(fVar.o, Long.valueOf(j3 - j2), true, !((f.i.a.a.h1.u0.t.c) this.f5107g).o || kVar == null);
            j4 = fVar.f5194i;
        }
        return d2 + j4;
    }
    ...
    public final f.i.a.a.h1.s0.d c(@Nullable Uri uri, int i2) {
        ...
        if (this.f5110j.containsKey(uri)) {
            b bVar = this.f5110j;
            bVar.put(uri, bVar.remove(uri));
            return null;
        }
        return new a(this.f5103c, new f.i.a.a.l1.p(uri, 0L, -1L, null, 1), this.f5106f[i2], this.p.l(), this.p.p(), this.f5112l);
    }
}
