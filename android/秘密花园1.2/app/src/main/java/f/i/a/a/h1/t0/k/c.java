...
public class c extends DefaultHandler implements e0.a<b> {
    ...
    public static final Pattern f5041c = Pattern.compile("CC([1-4])=.*");

    /* renamed from: d  reason: collision with root package name */
    public static final Pattern f5042d = Pattern.compile("([1-9]|[1-5][0-9]|6[0-3])=.*");
    ...
    public static final class a {
        ...
        public final ArrayList<e.b> f5045e;

        /* renamed from: f  reason: collision with root package name */
        public final ArrayList<d> f5046f;
    ...
    public static long j(XmlPullParser xmlPullParser, String str, long j2) {
        ...
        Matcher matcher = h0.f5742h.matcher(attributeValue);
        if (matcher.matches()) {
    ...
    */
    ...
    public j.e p(XmlPullParser xmlPullParser, j.e eVar) throws XmlPullParserException, IOException {
        ...
        long m3 = m(xmlPullParser, "presentationTimeOffset", eVar != null ? eVar.f5065c : 0L);
        long j4 = eVar != null ? eVar.f5073d : 0L;
        long j5 = eVar != null ? eVar.f5074e : 0L;
    ...
    public j.b q(XmlPullParser xmlPullParser, j.b bVar) throws XmlPullParserException, IOException {
        ...
        long m3 = m(xmlPullParser, "presentationTimeOffset", bVar != null ? bVar.f5065c : 0L);
        long m4 = m(xmlPullParser, "duration", bVar != null ? bVar.f5067e : -9223372036854775807L);
        long m5 = m(xmlPullParser, "startNumber", bVar != null ? bVar.f5066d : 1L);
        List list2 = null;
        h hVar = null;
        List<j.d> list3 = null;
        do {
    ...
    public j.c r(XmlPullParser xmlPullParser, j.c cVar, List<d> list) throws XmlPullParserException, IOException {
        ...
        long m3 = m(xmlPullParser, "presentationTimeOffset", cVar != null ? cVar.f5065c : 0L);
        long m4 = m(xmlPullParser, "duration", cVar != null ? cVar.f5067e : -9223372036854775807L);
        long m5 = m(xmlPullParser, "startNumber", cVar != null ? cVar.f5066d : 1L);
        int i2 = 0;
        while (true) {
            if (i2 >= list.size()) {
                j2 = -1;
        ...
        long j3 = j2;
        h hVar2 = null;
        l t = t(xmlPullParser, "media", cVar != null ? cVar.f5071h : null);
        l t2 = t(xmlPullParser, "initialization", cVar != null ? cVar.f5070g : null);
        List<j.d> list3 = null;
        do {
            xmlPullParser.next();
            if (c.a.a.b.g.h.o0(xmlPullParser, "Initialization")) {
