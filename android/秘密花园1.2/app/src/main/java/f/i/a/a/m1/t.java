...
public final class t {
    ...
    public final void a() {
        int i2;
        int i3 = this.b;
        c.a.a.b.g.h.v(i3 >= 0 && (i3 < (i2 = this.f5775d) || (i3 == i2 && this.f5774c == 0)));
    }

    public int b() {
        return ((this.f5775d - this.b) * 8) - this.f5774c;
    }
    ...
    public int d() {
        return (this.b * 8) + this.f5774c;
    }

    public boolean e() {
        boolean z = (this.a[this.b] & (128 >> this.f5774c)) != 0;
        k();
        return z;
    }
