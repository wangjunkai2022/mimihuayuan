...
public class n {
    ...
    public final SparseBooleanArray f5648c;

    /* renamed from: d  reason: collision with root package name */
    public final SparseBooleanArray f5649d;
    ...
    public static final class a implements c {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static final String[] f5652e = {"id", Person.KEY_KEY, "metadata"};
        ...
        public boolean b() throws f.i.a.a.x0.a {
            return c.a.a.b.g.h.a0(((SQLiteOpenHelper) this.a).getReadableDatabase(), 1, this.f5653c) != -1;
        }
        ...
        public void c(HashMap<String, m> hashMap) throws IOException {
            ...
            try {
                ...
                for (int i2 = 0; i2 < this.b.size(); i2++) {
                    ...
                    if (valueAt == null) {
                        writableDatabase.delete(this.f5654d, "id = ?", new String[]{Integer.toString(this.b.keyAt(i2))});
                    } else {
        ...
        public void e(long j2) {
            ...
            this.f5653c = hexString;
            this.f5654d = f.b.a.a.a.f("ExoPlayerCacheIndex", hexString);
        }
        ...
        public void g(HashMap<String, m> hashMap, SparseArray<String> sparseArray) throws IOException {
            ...
            try {
                if (c.a.a.b.g.h.a0(((SQLiteOpenHelper) this.a).getReadableDatabase(), 1, this.f5653c) != 1) {
                    SQLiteDatabase writableDatabase = ((SQLiteOpenHelper) this.a).getWritableDatabase();
                    writableDatabase.beginTransaction();
                    j(writableDatabase);
                    writableDatabase.setTransactionSuccessful();
                ...
                Cursor query = ((SQLiteOpenHelper) this.a).getReadableDatabase().query(this.f5654d, f5652e, null, null, null, null, null);
        ...
        public void h() throws f.i.a.a.x0.a {
            ...
            try {
                ...
                writableDatabase.beginTransaction();
                try {
                    if (c.a.a.b.g.h.p1(writableDatabase, "ExoPlayerVersions")) {
        ...
        public final void i(SQLiteDatabase sQLiteDatabase, m mVar) throws IOException {
            ...
            n.b(mVar.f5646d, new DataOutputStream(byteArrayOutputStream));
            byte[] byteArray = byteArrayOutputStream.toByteArray();
            ContentValues contentValues = new ContentValues();
            contentValues.put("id", Integer.valueOf(mVar.a));
            contentValues.put(Person.KEY_KEY, mVar.b);
            contentValues.put("metadata", byteArray);
            sQLiteDatabase.replaceOrThrow(this.f5654d, null, contentValues);
        }

        public final void j(SQLiteDatabase sQLiteDatabase) throws f.i.a.a.x0.a {
            c.a.a.b.g.h.l1(sQLiteDatabase, 1, this.f5653c, 1);
            String str = this.f5654d;
            sQLiteDatabase.execSQL("DROP TABLE IF EXISTS " + str);
            sQLiteDatabase.execSQL("CREATE TABLE " + this.f5654d + " (id INTEGER PRIMARY KEY NOT NULL,key TEXT NOT NULL,metadata BLOB NOT NULL)");
        }
    }
    ...
    public static class b implements c {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final SecretKeySpec f5655c;
        @Nullable

        /* renamed from: d  reason: collision with root package name */
        public final Random f5656d;

        /* renamed from: e  reason: collision with root package name */
        public final f.i.a.a.m1.g f5657e;
        ...
        public b(File file, @Nullable byte[] bArr, boolean z) {
            ...
            this.a = z;
            this.b = cipher;
            this.f5655c = secretKeySpec;
            this.f5656d = z ? new Random() : null;
            this.f5657e = new f.i.a.a.m1.g(file);
        }
        ...
        public void d(HashMap<String, m> hashMap) throws IOException {
            ...
            try {
                OutputStream d2 = this.f5657e.d();
                if (this.f5659g == null) {
                    this.f5659g = new y(d2);
                } else {
                    this.f5659g.d(d2);
                }
                DataOutputStream dataOutputStream2 = new DataOutputStream(this.f5659g);
                try {
                    dataOutputStream2.writeInt(2);
                    dataOutputStream2.writeInt(this.a ? 1 : 0);
                    if (this.a) {
                        byte[] bArr = new byte[16];
                        this.f5656d.nextBytes(bArr);
                        dataOutputStream2.write(bArr);
                        try {
                            this.b.init(1, this.f5655c, new IvParameterSpec(bArr));
                            dataOutputStream2.flush();
                            dataOutputStream2 = new DataOutputStream(new CipherOutputStream(this.f5659g, this.b));
                    ...
                    int i2 = 0;
                    for (m mVar : hashMap.values()) {
                        dataOutputStream2.writeInt(mVar.a);
                        dataOutputStream2.writeUTF(mVar.b);
                        n.b(mVar.f5646d, dataOutputStream2);
                        i2 += i(mVar, 2);
                    }
                    dataOutputStream2.writeInt(i2);
                    f.i.a.a.m1.g gVar = this.f5657e;
                    if (gVar != null) {
        ...
        */
        public void g(java.util.HashMap<java.lang.String, f.i.a.a.l1.k0.m> r11, android.util.SparseArray<java.lang.String> r12) {
            /*
                r10 = this;
                boolean r0 = r10.f5658f
                r1 = 1
                r0 = r0 ^ r1
                c.a.a.b.g.h.v(r0)
                f.i.a.a.m1.g r0 = r10.f5657e
                boolean r0 = r0.b()
                r2 = 0
                if (r0 != 0) goto L12
                goto Lb8
            L12:
                ...
                f.i.a.a.m1.g r4 = r10.f5657e     // Catch: java.lang.Throwable -> Laa java.io.IOException -> Lb1
            ...
            L3a:
                ...
                javax.crypto.spec.SecretKeySpec r8 = r10.f5655c     // Catch: java.security.InvalidAlgorithmParameterException -> L5b java.security.InvalidKeyException -> L5d java.lang.Throwable -> La5 java.io.IOException -> La8
            ...
            L64:
                ...
                if (r3 == 0) goto L6a
                r10.f5658f = r1     // Catch: java.lang.Throwable -> La5 java.io.IOException -> La8
            L6a:
        ...
        public final int i(m mVar, int i2) {
            ...
            if (i2 < 2) {
                long a = o.a(mVar.f5646d);
                return (hashCode * 31) + ((int) (a ^ (a >>> 32)));
            }
            return (hashCode * 31) + mVar.f5646d.hashCode();
        }
    ...
    public n(@Nullable f.i.a.a.x0.b bVar, @Nullable File file, @Nullable byte[] bArr, boolean z, boolean z2) {
        ...
        this.f5648c = new SparseBooleanArray();
        this.f5649d = new SparseBooleanArray();
    ...
    public m d(String str) {
        ...
        if (mVar == null) {
            ...
            m mVar2 = new m(keyAt, str, r.f5660c);
            this.a.put(str, mVar2);
            this.b.put(keyAt, str);
            this.f5649d.put(keyAt, true);
            this.f5650e.f(mVar2);
            return mVar2;
        }
        return mVar;
    ...
    public void e(long j2) throws IOException {
        ...
        if (!this.f5650e.b() && (cVar = this.f5651f) != null && cVar.b()) {
            this.f5651f.g(this.a, this.b);
            this.f5650e.d(this.a);
        } else {
            this.f5650e.g(this.a, this.b);
        }
        c cVar3 = this.f5651f;
        if (cVar3 != null) {
            cVar3.h();
    ...
    public void f(String str) {
        m mVar = this.a.get(str);
        if (mVar == null || !mVar.f5645c.isEmpty() || mVar.f5647e) {
            return;
        }
        this.a.remove(str);
        int i2 = mVar.a;
        boolean z = this.f5649d.get(i2);
        this.f5650e.a(mVar, z);
        if (z) {
            this.b.remove(i2);
            this.f5649d.delete(i2);
            return;
        }
        this.b.put(i2, null);
        this.f5648c.put(i2, true);
    }

    public void g() throws IOException {
        this.f5650e.c(this.a);
        int size = this.f5648c.size();
        for (int i2 = 0; i2 < size; i2++) {
            this.b.remove(this.f5648c.keyAt(i2));
        }
        this.f5648c.clear();
        this.f5649d.clear();
    }
