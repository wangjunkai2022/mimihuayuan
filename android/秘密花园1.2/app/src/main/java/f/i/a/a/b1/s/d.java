...
public class d implements g {
    ...
    public final SparseArray<c> f4172c;

    /* renamed from: d  reason: collision with root package name */
    public final boolean f4173d;

    /* renamed from: e  reason: collision with root package name */
    public final u f4174e;

    /* renamed from: f  reason: collision with root package name */
    public final u f4175f;
    ...
    public final u f4179j;

    /* renamed from: k  reason: collision with root package name */
    public final u f4180k;

    /* renamed from: l  reason: collision with root package name */
    public final u f4181l;

    /* renamed from: m  reason: collision with root package name */
    public final u f4182m;
    public ByteBuffer n;
    public long o;
    public long p;
    public long q;
            ...
            if (i2 == 20529) {
                ...
                switch (i2) {
                    ...
                    case TbsListener.ErrorCode.NEEDDOWNLOAD_FALSE_6 /* 176 */:
                        dVar.t.f4191k = (int) j2;
                        return;
                    case 179:
                        dVar.B.a(dVar.l(j2));
                        return;
                    case 186:
                        dVar.t.f4192l = (int) j2;
                        return;
                    case TbsListener.ErrorCode.COPY_EXCEPTION /* 215 */:
                        dVar.t.f4183c = (int) j2;
                        return;
    ...
    public d(int i2) {
        ...
        this.a = aVar;
        aVar.f4168d = new b(null);
        this.f4173d = (i2 & 1) == 0;
        this.b = new f();
        this.f4172c = new SparseArray<>();
        this.f4176g = new u(4);
        this.f4177h = new u(ByteBuffer.allocate(4).putInt(-1).array());
        this.f4178i = new u(4);
        this.f4174e = new u(s.a);
        this.f4175f = new u(4);
        this.f4179j = new u();
        this.f4180k = new u();
        this.f4181l = new u(8);
    ...
    public final void b(c cVar, long j2) {
        ...
        if (c0062d != null) {
            if (c0062d.b) {
                int i2 = c0062d.f4194c;
                c0062d.f4194c = i2 + 1;
                if (i2 == 0) {
                    c0062d.f4196e = j2;
                }
                if (c0062d.f4194c >= 16) {
                    cVar.U.c(c0062d.f4196e, c0062d.f4197f, c0062d.f4195d, 0, cVar.f4188h);
                    c0062d.f4194c = 0;
                }
            }
        } else {
            ...
            cVar.U.c(j2, this.M, this.V, 0, cVar.f4188h);
        }
        this.W = true;
        k();
    }
    ...
    */
    public final int c(f.i.a.a.b1.d r11, f.i.a.a.b1.m r12) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L3a:
            ...
            r11 = 0
        L3d:
            android.util.SparseArray<f.i.a.a.b1.s.d$c> r12 = r10.f4172c
            int r12 = r12.size()
            if (r11 >= r12) goto L6c
            android.util.SparseArray<f.i.a.a.b1.s.d$c> r12 = r10.f4172c
    ...
    public final void e(c cVar, String str, int i2, long j2, byte[] bArr) {
        ...
        u uVar = this.f4180k;
        pVar.a(uVar, uVar.f5776c);
        this.V += this.f4180k.f5776c;
    }
    ...
    public void f(long j2, long j3) {
        ...
        fVar2.f4199c = 0;
        k();
        for (int i2 = 0; i2 < this.f4172c.size(); i2++) {
            C0062d c0062d = this.f4172c.valueAt(i2).Q;
            if (c0062d != null) {
                c0062d.b = false;
            }
        }
    ...
    public final void h(f.i.a.a.b1.d dVar, int i2) throws IOException, InterruptedException {
        ...
        byte[] bArr = uVar.a;
        if (bArr.length < i2) {
            uVar.y(Arrays.copyOf(bArr, Math.max(bArr.length * 2, i2)), this.f4176g.f5776c);
        }
        u uVar2 = this.f4176g;
        byte[] bArr2 = uVar2.a;
        int i3 = uVar2.f5776c;
    ...
    public final int j(f.i.a.a.b1.d dVar, f.i.a.a.b1.p pVar, int i2) throws IOException, InterruptedException {
        int b2;
        int a2 = this.f4179j.a();
        if (a2 > 0) {
            b2 = Math.min(i2, a2);
            pVar.a(this.f4179j, b2);
        } else {
        ...
        if ("S_TEXT/UTF8".equals(cVar.b)) {
            ...
            if (!this.O) {
                if (cVar.f4186f) {
                    this.M &= -1073741825;
                    if (!this.P) {
                        dVar.g(this.f4176g.a, 0, 1, false);
                        this.N++;
                        byte[] bArr = this.f4176g.a;
                        if ((bArr[0] & 128) != 128) {
                            this.S = bArr[0];
                            this.P = true;
                        } else {
                    ...
                    if ((this.S & 1) == 1) {
                        ...
                        this.M |= 1073741824;
                        if (!this.Q) {
                            dVar.g(this.f4181l.a, 0, 8, false);
                            this.N += 8;
                            this.Q = true;
                            this.f4176g.a[0] = (byte) ((z ? 128 : 0) | 8);
                            this.f4176g.A(0);
                            pVar.a(this.f4176g, 1);
                            this.V++;
                            this.f4181l.A(0);
                            pVar.a(this.f4181l, 8);
                            this.V += 8;
                        }
                        if (z) {
                            if (!this.R) {
                                ...
                                this.N++;
                                this.f4176g.A(0);
                                this.T = this.f4176g.p();
                                this.R = true;
                            }
                            int i5 = this.T * 4;
                            this.f4176g.w(i5);
                            dVar.g(this.f4176g.a, 0, i5, false);
                            this.N += i5;
                            ...
                            this.f4182m.y(this.n.array(), i6);
                            pVar.a(this.f4182m, i6);
                            this.V += i6;
                        }
                    }
                } else {
                    byte[] bArr2 = cVar.f4187g;
                    if (bArr2 != null) {
                        u uVar = this.f4179j;
            ...
            int i10 = i2 + this.f4179j.f5776c;
            if (!"V_MPEG4/ISO/AVC".equals(cVar.b) && !"V_MPEGH/ISO/HEVC".equals(cVar.b)) {
                if (cVar.Q != null) {
                    c.a.a.b.g.h.v(this.f4179j.f5776c == 0);
                    C0062d c0062d = cVar.Q;
                    int i11 = this.M;
                    if (!c0062d.b) {
                ...
                while (this.N < i10) {
                    int i15 = this.U;
                    if (i15 == 0) {
                        int min = Math.min(i13, this.f4179j.a());
                        ...
                        this.N += i13;
                        this.f4175f.A(0);
                        this.U = this.f4175f.s();
                        this.f4174e.A(0);
                        pVar.a(this.f4174e, 4);
                        this.V += 4;
                    } else {
    ...
    public final void n(f.i.a.a.b1.d dVar, byte[] bArr, int i2) throws IOException, InterruptedException {
        ...
        dVar.g(this.f4180k.a, bArr.length, i2, false);
        this.f4180k.w(length);
    }
