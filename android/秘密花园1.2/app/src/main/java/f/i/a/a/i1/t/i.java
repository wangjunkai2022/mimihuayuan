...
public final class i implements f.i.a.a.i1.e {
    ...
    public int a(long j2) {
        int c2 = h0.c(this.f5457d, j2, false, false);
        if (c2 < this.f5457d.length) {
            return c2;
        }
        return -1;
    }
    ...
    public long b(int i2) {
        c.a.a.b.g.h.m(i2 >= 0);
        c.a.a.b.g.h.m(i2 < this.f5457d.length);
        return this.f5457d[i2];
    }
    ...
    public List<f.i.a.a.i1.b> c(long j2) {
        ...
        for (int i2 = 0; i2 < this.b; i2++) {
            ...
            if (jArr[i3] <= j2 && j2 < jArr[i3 + 1]) {
                ...
                if (!(eVar2.f5303d == Float.MIN_VALUE && eVar2.f5306g == Float.MIN_VALUE)) {
