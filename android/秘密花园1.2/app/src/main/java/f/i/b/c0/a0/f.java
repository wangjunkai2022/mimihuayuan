...
public final class f extends f.i.b.e0.c {
    ...
    public final List<f.i.b.o> f6085l;
    ...
    public f.i.b.e0.c E() throws IOException {
        if (!this.f6085l.isEmpty() && this.f6086m == null) {
            if (T() instanceof f.i.b.l) {
                List<f.i.b.o> list = this.f6085l;
    ...
    public final void U(f.i.b.o oVar) {
        if (this.f6086m != null) {
            if (!(oVar instanceof f.i.b.q) || this.f6172i) {
                ((f.i.b.r) T()).c(this.f6086m, oVar);
            }
            this.f6086m = null;
        } else if (this.f6085l.isEmpty()) {
            this.n = oVar;
        } else {
            f.i.b.o T = T();
            if (T instanceof f.i.b.l) {
