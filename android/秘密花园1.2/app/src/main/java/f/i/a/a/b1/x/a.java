...
public final class a implements f.i.a.a.b1.g {
    ...
    public static final int f4366e = h0.C("ID3");
    public final long a = 0;
    public final b b = new b(null);

    /* renamed from: c  reason: collision with root package name */
    public final f.i.a.a.m1.u f4367c = new f.i.a.a.m1.u(2786);
    ...
    public int c(f.i.a.a.b1.d dVar, f.i.a.a.b1.m mVar) throws IOException, InterruptedException {
        int e2 = dVar.e(this.f4367c.a, 0, 2786);
        if (e2 == -1) {
            return -1;
        }
        this.f4367c.A(0);
        this.f4367c.z(e2);
        if (!this.f4368d) {
            this.b.f4384l = this.a;
            this.f4368d = true;
        }
        this.b.c(this.f4367c);
        return 0;
    }
