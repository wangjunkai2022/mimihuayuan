...
public final class f implements i {
    ...
    public final boolean f5102c = true;
    ...
    public i.a a(f.i.a.a.b1.g gVar, Uri uri, f.i.a.a.b0 b0Var, List<f.i.a.a.b0> list, f.i.a.a.z0.e eVar, e0 e0Var, Map<String, List<String>> map, f.i.a.a.b1.d dVar) throws InterruptedException, IOException {
        ...
        if (!"text/vtt".equals(b0Var.f4088i) && !lastPathSegment.endsWith(".webvtt") && !lastPathSegment.endsWith(".vtt")) {
            if (lastPathSegment.endsWith(".aac")) {
                ...
                if (lastPathSegment.endsWith(".ac4")) {
                    ...
                    rVar = d(this.b, this.f5102c, b0Var, list, e0Var);
                } else {
        ...
        if (!(rVar instanceof b0)) {
            b0 d2 = d(this.b, this.f5102c, b0Var, list, e0Var);
            if (e(d2, dVar)) {
                return b(d2);
            }
        }
