...
public final class a extends d {
    ...
    public List<f.i.a.a.i1.b> f5327m;
    public List<f.i.a.a.i1.b> n;
    public int o;
    public int p;
    public boolean q;
    public boolean r;
    ...
    public final u f5321g = new u();

    /* renamed from: k  reason: collision with root package name */
    public final ArrayList<C0079a> f5325k = new ArrayList<>();

    /* renamed from: l  reason: collision with root package name */
    public C0079a f5326l = new C0079a(0, 4);
    public int u = 0;
    ...
    public static class C0079a {
        public final List<C0080a> a = new ArrayList();
        public final List<SpannableString> b = new ArrayList();

        /* renamed from: c  reason: collision with root package name */
        public final StringBuilder f5328c = new StringBuilder();
        ...
        public static class C0080a {
            ...
            public C0080a(int i2, boolean z, int i3) {
                this.a = i2;
                this.b = z;
                this.f5334c = i3;
            }
        ...
        public void a() {
            int length = this.f5328c.length();
            if (length > 0) {
                this.f5328c.delete(length - 1, length);
                for (int size = this.a.size() - 1; size >= 0; size--) {
                    C0080a c0080a = this.a.get(size);
                    int i2 = c0080a.f5334c;
                    if (i2 != length) {
                        return;
                    }
                    c0080a.f5334c = i2 - 1;
        ...
        public f.i.a.a.i1.b b(int i2) {
            ...
            int i6 = this.f5330e + this.f5331f;
            int length = (32 - i6) - spannableStringBuilder.length();
            int i7 = i6 - length;
            if (i2 == Integer.MIN_VALUE) {
                if (this.f5332g != 2 || (Math.abs(i7) >= 3 && length >= 0)) {
                    i2 = (this.f5332g != 2 || i7 <= 0) ? 0 : 2;
                } else {
                    i2 = 1;
                }
            }
            ...
            if (this.f5332g == 1 || (i3 = this.f5329d) > 7) {
                i3 = (this.f5329d - 15) - 2;
                i4 = 2;
            } else {
                i4 = 0;
            }
            return new f.i.a.a.i1.b(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, i3, 1, i4, f2, i2, Float.MIN_VALUE);
        }

        public final SpannableString c() {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f5328c);
            ...
            while (i2 < this.a.size()) {
                ...
                int i9 = c0080a.f5334c;
                i2++;
                if (i9 != (i2 < this.a.size() ? this.a.get(i2).f5334c : length)) {
                    if (i3 != -1 && !z2) {
        ...
        public boolean d() {
            return this.a.isEmpty() && this.b.isEmpty() && this.f5328c.length() == 0;
        }
    ...
    public a(String str, int i2) {
        this.f5322h = "application/x-mp4-cea-608".equals(str) ? 2 : 3;
        if (i2 == 1) {
            this.f5324j = 0;
            this.f5323i = 0;
        } else if (i2 == 2) {
    ...
    public f.i.a.a.i1.e f() {
        List<f.i.a.a.i1.b> list = this.f5327m;
        this.n = list;
        return new e(list);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:216:0x008e A[SYNTHETIC] */
    ...
    */
    ...
    @Override // f.i.a.a.i1.m.d
    public boolean h() {
        return this.f5327m != this.n;
    }

    public final List<f.i.a.a.i1.b> j() {
        int size = this.f5325k.size();
        ArrayList arrayList = new ArrayList(size);
        int i2 = 2;
        for (int i3 = 0; i3 < size; i3++) {
            f.i.a.a.i1.b b = this.f5325k.get(i3).b(Integer.MIN_VALUE);
            arrayList.add(b);
            if (b != null) {
                i2 = Math.min(i2, b.f5307h);
            }
        }
        ArrayList arrayList2 = new ArrayList(size);
        for (int i4 = 0; i4 < size; i4++) {
            f.i.a.a.i1.b bVar = (f.i.a.a.i1.b) arrayList.get(i4);
            if (bVar != null) {
                if (bVar.f5307h != i2) {
                    bVar = this.f5325k.get(i4).b(i2);
                }
                arrayList2.add(bVar);
            }
        }
    ...
    public final void k() {
        this.f5326l.e(this.o);
        this.f5325k.clear();
        this.f5325k.add(this.f5326l);
    }
    ...
    public final void l(int i2) {
        ...
        this.o = i2;
        if (i2 == 3) {
            for (int i4 = 0; i4 < this.f5325k.size(); i4++) {
                this.f5325k.get(i4).f5332g = i2;
            }
            return;
        }
        k();
        if (i3 == 3 || i2 == 1 || i2 == 0) {
            this.f5327m = Collections.emptyList();
        }
    }

    public final void m(int i2) {
        this.p = i2;
        this.f5326l.f5333h = i2;
    }
}
