...
public final class b {
    ...
    public static final byte[] f5361h = {0, 7, 8, ap.f3116m};

    /* renamed from: i  reason: collision with root package name */
    public static final byte[] f5362i = {0, 119, -120, -1};

    /* renamed from: j  reason: collision with root package name */
    public static final byte[] f5363j = {0, 17, 34, 51, 68, 85, 102, 119, -120, -103, -86, -69, -52, -35, -18, -1};
    public final Paint a;
    public final Paint b;

    /* renamed from: c  reason: collision with root package name */
    public final Canvas f5364c;

    /* renamed from: d  reason: collision with root package name */
    public final C0081b f5365d;

    /* renamed from: e  reason: collision with root package name */
    public final a f5366e;

    /* renamed from: f  reason: collision with root package name */
    public final h f5367f;
    ...
    public static final class C0081b {
        ...
        public C0081b(int i2, int i3, int i4, int i5, int i6, int i7) {
            this.a = i2;
            this.b = i3;
            this.f5371c = i4;
            this.f5372d = i5;
    ...
    public static final class d {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final SparseArray<e> f5377c;

        public d(int i2, int i3, int i4, SparseArray<e> sparseArray) {
            this.a = i3;
            this.b = i4;
            this.f5377c = sparseArray;
        }
    }
    ...
    public static final class f {
        ...
        /* renamed from: j  reason: collision with root package name */
        public final SparseArray<g> f5385j;
    ...
    public static final class h {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final SparseArray<f> f5386c = new SparseArray<>();

        /* renamed from: d  reason: collision with root package name */
        public final SparseArray<a> f5387d = new SparseArray<>();

        /* renamed from: e  reason: collision with root package name */
        public final SparseArray<c> f5388e = new SparseArray<>();

        /* renamed from: f  reason: collision with root package name */
        public final SparseArray<a> f5389f = new SparseArray<>();

        /* renamed from: g  reason: collision with root package name */
        public final SparseArray<c> f5390g = new SparseArray<>();

        /* renamed from: h  reason: collision with root package name */
        public C0081b f5391h;
    ...
    public b(int i2, int i3) {
        ...
        this.f5364c = new Canvas();
        this.f5365d = new C0081b(719, 575, 0, 719, 0, 575);
        this.f5366e = new a(0, new int[]{0, -1, -16777216, -8421505}, b(), c());
        this.f5367f = new h(i2, i3);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:116:0x01e6 A[LOOP:3: B:84:0x0155->B:116:0x01e6, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:139:0x012f A[SYNTHETIC] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:71:0x0135 A[LOOP:2: B:38:0x009f->B:71:0x0135, LOOP_END] */
    ...
    */
    ...
    public static a f(t tVar, int i2) {
        ...
        while (i4 > 0) {
            ...
            int f8 = tVar.f(i3);
            int i6 = i4 - 2;
            int[] iArr2 = (f8 & 128) != 0 ? iArr : (f8 & 64) != 0 ? b : c2;
            if ((f8 & 1) != 0) {
                f4 = tVar.f(i3);
                f2 = tVar.f(i3);
                f5 = tVar.f(i3);
            ...
            double d3 = f2 - 128;
            double d4 = f5 - 128;
            iArr2[f7] = d((byte) (255 - (f3 & 255)), h0.o((int) ((1.402d * d3) + d2), 0, 255), h0.o((int) ((d2 - (0.34414d * d4)) - (d3 * 0.71414d)), 0, 255), h0.o((int) ((d4 * 1.772d) + d2), 0, 255));
            iArr = iArr;
            f6 = f6;
            i3 = 8;
            i5 = 4;
        }
        return new a(f6, iArr, b, c2);
    }
