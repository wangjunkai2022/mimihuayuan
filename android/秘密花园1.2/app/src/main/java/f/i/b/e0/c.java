...
public class c implements Closeable, Flushable {
    ...
    public static final String[] f6164j = new String[128];
    ...
    static {
        for (int i2 = 0; i2 <= 31; i2++) {
            f6164j[i2] = String.format("\\u%04x", Integer.valueOf(i2));
        }
        String[] strArr = f6164j;
        strArr[34] = "\\\"";
        strArr[92] = "\\\\";
        strArr[9] = "\\t";
        strArr[8] = "\\b";
    ...
    */
    public final void M(java.lang.String r9) throws java.io.IOException {
        /*
            r8 = this;
            boolean r0 = r8.f6170g
            if (r0 == 0) goto L7
            java.lang.String[] r0 = f.i.b.e0.c.f6165k
            goto L9
        L7:
            java.lang.String[] r0 = f.i.b.e0.c.f6164j
        L9:
    ...
    public c P(Number number) throws IOException {
        ...
        if (!this.f6169f && (obj.equals("-Infinity") || obj.equals("Infinity") || obj.equals("NaN"))) {
    ...
    public final void d() throws IOException {
        ...
        if (J == 1) {
            ...
            this.a.append((CharSequence) this.f6168e);
            L(5);
        }
    }
    ...
    public final c g(int i2, int i3, String str) throws IOException {
        ...
        StringBuilder o = f.b.a.a.a.o("Dangling name: ");
        o.append(this.f6171h);
