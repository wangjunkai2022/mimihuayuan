...
public abstract class s<T> extends o {
    ...
    public final HashMap<T, b> f4933f = new HashMap<>();
    @Nullable

    /* renamed from: g  reason: collision with root package name */
    public Handler f4934g;
    @Nullable

    /* renamed from: h  reason: collision with root package name */
    public f.i.a.a.l1.i0 f4935h;
    ...
    public final class a implements f0 {
        ...
        public final f0.c b(f0.c cVar) {
            long q = s.this.q(this.a, cVar.f4826f);
            long q2 = s.this.q(this.a, cVar.f4827g);
            return (q == cVar.f4826f && q2 == cVar.f4827g) ? cVar : new f0.c(cVar.a, cVar.b, cVar.f4823c, cVar.f4824d, cVar.f4825e, q, q2);
        }
    ...
    public final void v(final T t, e0 e0Var) {
        c.a.a.b.g.h.m(!this.f4933f.containsKey(t));
        ...
        a aVar = new a(t);
        this.f4933f.put(t, new b(e0Var, bVar, aVar));
        Handler handler = this.f4934g;
        c.a.a.b.g.h.t(handler);
        e0Var.g(handler, aVar);
        e0Var.e(bVar, this.f4935h);
    }
}
