...
public final class d {
    ...
    public byte[] f4118e = new byte[65536];
    ...
    public boolean a(int i2, boolean z) throws IOException, InterruptedException {
        int i3 = this.f4119f + i2;
        byte[] bArr = this.f4118e;
        if (i3 > bArr.length) {
            this.f4118e = Arrays.copyOf(this.f4118e, h0.o(bArr.length * 2, 65536 + i3, i3 + 524288));
        }
        int i4 = this.f4120g - this.f4119f;
        while (i4 < i2) {
            i4 = f(this.f4118e, this.f4119f, i2, i4, z);
            if (i4 == -1) {
                return false;
            }
            this.f4120g = this.f4119f + i4;
        }
        this.f4119f += i2;
        return true;
    }
    ...
    public int e(byte[] bArr, int i2, int i3) throws IOException, InterruptedException {
        ...
        if (i4 != 0) {
            ...
            System.arraycopy(this.f4118e, 0, bArr, i2, min);
            i(min);
            i5 = min;
        }
        if (i5 == 0) {
    ...
    public void h(int i2) throws IOException, InterruptedException {
        int min = Math.min(this.f4120g, i2);
        i(min);
        int i3 = min;
        while (i3 < i2 && i3 != -1) {
    ...
    public final void i(int i2) {
        ...
        System.arraycopy(this.f4118e, i2, bArr, 0, this.f4120g);
        this.f4118e = bArr;
    }
}
