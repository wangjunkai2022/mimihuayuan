...
public interface f0 {
    ...
    public static final class c {
        ...
        public final f.i.a.a.b0 f4823c;
    ...
    public static final class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final CopyOnWriteArrayList<C0074a> f4821c;
        ...
        public a() {
            this.f4821c = new CopyOnWriteArrayList<>();
            this.a = 0;
            this.b = null;
            this.f4822d = 0L;
        }
        ...
        public void B() {
            ...
            Iterator<C0074a> it = this.f4821c.iterator();
            while (it.hasNext()) {
                C0074a next = it.next();
        ...
        public a D(int i2, @Nullable e0.a aVar, long j2) {
            return new a(this.f4821c, i2, aVar, j2);
        }
        ...
        public a(CopyOnWriteArrayList<C0074a> copyOnWriteArrayList, int i2, @Nullable e0.a aVar, long j2) {
            this.f4821c = copyOnWriteArrayList;
            this.a = i2;
            this.b = aVar;
            this.f4822d = j2;
        }
