...
public class m<A, B> {
    ...
    public static final class b<A> {
        ...
        public static final Queue<b<?>> f3733d = f.d.a.u.i.d(0);
        public int a;
        public int b;
        ...
        public boolean equals(Object obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                return this.b == bVar.b && this.a == bVar.a && this.f3734c.equals(bVar.f3734c);
            }
            return false;
        }

        public int hashCode() {
            return this.f3734c.hashCode() + (((this.a * 31) + this.b) * 31);
        }
    }
