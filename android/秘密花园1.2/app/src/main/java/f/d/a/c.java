...
public class c implements ComponentCallbacks2 {
    ...
    public static volatile c f3431i;

    /* renamed from: j  reason: collision with root package name */
    public static volatile boolean f3432j;
    ...
    public final f.d.a.o.n.b0.b f3435e;

    /* renamed from: f  reason: collision with root package name */
    public final l f3436f;

    /* renamed from: g  reason: collision with root package name */
    public final f.d.a.p.d f3437g;

    /* renamed from: h  reason: collision with root package name */
    public final List<j> f3438h = new ArrayList();
    ...
    public c(@NonNull Context context, @NonNull f.d.a.o.n.l lVar, @NonNull f.d.a.o.n.c0.i iVar, @NonNull f.d.a.o.n.b0.d dVar, @NonNull f.d.a.o.n.b0.b bVar, @NonNull l lVar2, @NonNull f.d.a.p.d dVar2, int i2, @NonNull a aVar, @NonNull Map map, @NonNull List list, boolean z, boolean z2) {
        ...
        if (Build.VERSION.SDK_INT >= 27) {
            h hVar2 = this.f3434d;
            q qVar = new q();
            f.d.a.r.b bVar3 = hVar2.f3466g;
            synchronized (bVar3) {
                bVar3.a.add(qVar);
            }
        }
        List<ImageHeaderParser> e2 = this.f3434d.e();
        ...
        if (z2 && Build.VERSION.SDK_INT >= 28) {
            ...
            n nVar = new n(this.f3434d.e(), resources.getDisplayMetrics(), dVar, bVar);
        ...
        this.f3433c = new e(context, bVar, this.f3434d, new f.d.a.s.h.f(), aVar, map, list, lVar, z, i2);
    }
    ...
    public static void a(@NonNull Context context, @Nullable GeneratedAppGlideModule generatedAppGlideModule) {
        ...
        if (!f3432j) {
            ...
            dVar.f3449m = generatedAppGlideModule != null ? generatedAppGlideModule.getRequestManagerFactory() : null;
            ...
            if (dVar.f3442f == null) {
                ...
                dVar.f3442f = new f.d.a.o.n.d0.a(new ThreadPoolExecutor(a2, a2, 0L, TimeUnit.MILLISECONDS, new PriorityBlockingQueue(), new a.ThreadFactoryC0038a("source", a.b.b, false)));
            }
            if (dVar.f3443g == null) {
                dVar.f3443g = new f.d.a.o.n.d0.a(new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new PriorityBlockingQueue(), new a.ThreadFactoryC0038a("disk-cache", a.b.b, true)));
            }
            if (dVar.n == null) {
            ...
            if (dVar.f3445i == null) {
                dVar.f3445i = new f.d.a.o.n.c0.j(new j.a(applicationContext));
            }
            if (dVar.f3446j == null) {
                dVar.f3446j = new f.d.a.p.f();
            }
            if (dVar.f3439c == null) {
                int i3 = dVar.f3445i.a;
                if (i3 > 0) {
                    dVar.f3439c = new f.d.a.o.n.b0.j(i3);
                } else {
                    dVar.f3439c = new f.d.a.o.n.b0.e();
                }
            }
            if (dVar.f3440d == null) {
                dVar.f3440d = new f.d.a.o.n.b0.i(dVar.f3445i.f3604d);
            }
            if (dVar.f3441e == null) {
                dVar.f3441e = new f.d.a.o.n.c0.h(dVar.f3445i.b);
            }
            if (dVar.f3444h == null) {
                dVar.f3444h = new f.d.a.o.n.c0.g(applicationContext);
            }
            if (dVar.b == null) {
                dVar.b = new f.d.a.o.n.l(dVar.f3441e, dVar.f3444h, dVar.f3443g, dVar.f3442f, new f.d.a.o.n.d0.a(new ThreadPoolExecutor(0, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, f.d.a.o.n.d0.a.b, TimeUnit.MILLISECONDS, new SynchronousQueue(), new a.ThreadFactoryC0038a("source-unlimited", a.b.b, false))), dVar.n, false);
            }
            ...
            c cVar4 = new c(applicationContext, dVar.b, dVar.f3441e, dVar.f3439c, dVar.f3440d, new l(dVar.f3449m), dVar.f3446j, dVar.f3447k, dVar.f3448l, dVar.a, dVar.o, false, false);
            for (f.d.a.q.c cVar5 : list) {
                try {
                    cVar5.registerComponents(applicationContext, cVar4, cVar4.f3434d);
            ...
            if (generatedAppGlideModule != null) {
                generatedAppGlideModule.registerComponents(applicationContext, cVar4, cVar4.f3434d);
            }
    ...
    public static j d(@NonNull Context context) {
        ...
        return b(context).f3436f.b(context);
    }
