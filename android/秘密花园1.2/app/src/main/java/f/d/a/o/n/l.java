...
public class l implements n, i.a, q.a {
    ...
    public static final boolean f3660i = Log.isLoggable("Engine", 2);
    public final t a;
    public final p b;

    /* renamed from: c  reason: collision with root package name */
    public final f.d.a.o.n.c0.i f3661c;

    /* renamed from: d  reason: collision with root package name */
    public final b f3662d;

    /* renamed from: e  reason: collision with root package name */
    public final z f3663e;

    /* renamed from: f  reason: collision with root package name */
    public final c f3664f;

    /* renamed from: g  reason: collision with root package name */
    public final a f3665g;

    /* renamed from: h  reason: collision with root package name */
    public final f.d.a.o.n.a f3666h;
    ...
    public static class b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final f.d.a.o.n.d0.a f3668c;

        /* renamed from: d  reason: collision with root package name */
        public final f.d.a.o.n.d0.a f3669d;

        /* renamed from: e  reason: collision with root package name */
        public final n f3670e;

        /* renamed from: f  reason: collision with root package name */
        public final q.a f3671f;

        /* renamed from: g  reason: collision with root package name */
        public final Pools.Pool<m<?>> f3672g = f.d.a.u.j.a.a(SwipeRefreshLayout.SCALE_DOWN_DURATION, new a());
        ...
        public class a implements a.b<m<?>> {
            ...
            public m<?> a() {
                b bVar = b.this;
                return new m<>(bVar.a, bVar.b, bVar.f3668c, bVar.f3669d, bVar.f3670e, bVar.f3671f, bVar.f3672g);
            }
        }
    ...
    public l(f.d.a.o.n.c0.i iVar, a.InterfaceC0037a interfaceC0037a, f.d.a.o.n.d0.a aVar, f.d.a.o.n.d0.a aVar2, f.d.a.o.n.d0.a aVar3, f.d.a.o.n.d0.a aVar4, boolean z) {
        this.f3661c = iVar;
        this.f3664f = new c(interfaceC0037a);
        ...
        this.b = new p();
        this.a = new t();
        this.f3662d = new b(aVar, aVar2, aVar3, aVar4, this, this);
        this.f3665g = new a(this.f3664f);
        this.f3663e = new z();
        ((f.d.a.o.n.c0.h) iVar).f3602d = this;
    }
    ...
    public void a(f.d.a.o.f fVar, q<?> qVar) {
        ...
        if (qVar.a) {
            ((f.d.a.o.n.c0.h) this.f3661c).f(fVar, qVar);
        } else {
            this.f3663e.a(qVar);
        }
    }
    ...
    public final q<?> c(o oVar, boolean z, long j2) {
        ...
        if (z) {
            ...
            f.d.a.o.n.c0.h hVar = (f.d.a.o.n.c0.h) this.f3661c;
            synchronized (hVar) {
                remove = hVar.a.remove(oVar);
                if (remove != null) {
                    hVar.f3860c -= hVar.b(remove);
                }
            }
            w wVar = (w) remove;
            if (wVar == null) {
