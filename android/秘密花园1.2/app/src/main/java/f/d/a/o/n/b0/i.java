...
public final class i implements f.d.a.o.n.b0.b {
    ...
    public final Map<Class<?>, NavigableMap<Integer, Integer>> f3579c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    public final Map<Class<?>, f.d.a.o.n.b0.a<?>> f3580d = new HashMap();
    ...
    public static final class a implements l {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof a) {
                a aVar = (a) obj;
                return this.b == aVar.b && this.f3583c == aVar.f3583c;
            }
            return false;
        }
    ...
    */
    public synchronized <T> T f(int r6, java.lang.Class<T> r7) {
        /*
            ...
            r2 = 0
            if (r0 == 0) goto L2c
            int r3 = r5.f3582f     // Catch: java.lang.Throwable -> L4d
            if (r3 == 0) goto L20
            int r4 = r5.f3581e     // Catch: java.lang.Throwable -> L4d
            int r4 = r4 / r3
            r3 = 2
            if (r4 < r3) goto L1e
            goto L20
        ...
        L3a:
            ...
            r0.f3583c = r7     // Catch: java.lang.Throwable -> L4d
            r6 = r0
        L47:
    ...
    public final <T> f.d.a.o.n.b0.a<T> g(Class<T> cls) {
        h hVar = (f.d.a.o.n.b0.a<T>) this.f3580d.get(cls);
        if (hVar == null) {
    ...
    public final NavigableMap<Integer, Integer> i(Class<?> cls) {
        NavigableMap<Integer, Integer> navigableMap = this.f3579c.get(cls);
        if (navigableMap == null) {
            TreeMap treeMap = new TreeMap();
            this.f3579c.put(cls, treeMap);
            return treeMap;
        }
        return navigableMap;
    }
