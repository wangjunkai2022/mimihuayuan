...
public abstract class a<T> implements j<ImageDecoder.Source, T> {
    ...
    public class C0047a implements ImageDecoder.OnHeaderDecodedListener {
        ...
        public final /* synthetic */ f.d.a.o.b f3747d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ m f3748e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ i f3749f;
        ...
        public void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
            boolean z = false;
            if (a.this.a.b(this.a, this.b, this.f3746c, false)) {
                imageDecoder.setAllocator(3);
            } else {
                imageDecoder.setAllocator(1);
            }
            if (this.f3747d == f.d.a.o.b.PREFER_RGB_565) {
            ...
            float b = this.f3748e.b(size.getWidth(), size.getHeight(), i2, i3);
            ...
            if (this.f3749f == i.DISPLAY_P3 && imageInfo.getColorSpace() != null && imageInfo.getColorSpace().isWideGamut()) {
                z = true;
            }
    ...
    public final w<T> a(@NonNull ImageDecoder.Source source, int i2, int i3, @NonNull h hVar) throws IOException {
        C0047a c0047a = new C0047a(i2, i3, hVar.c(n.f3765i) != null && ((Boolean) hVar.c(n.f3765i)).booleanValue(), (f.d.a.o.b) hVar.c(n.f3762f), (m) hVar.c(m.f3759f), (i) hVar.c(n.f3763g));
        d dVar = (d) this;
