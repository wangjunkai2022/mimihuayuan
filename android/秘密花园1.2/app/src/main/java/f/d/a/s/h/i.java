...
public abstract class i<T extends View, Z> extends f.d.a.s.h.a<Z> {
    ...
    public static int f3854c = f.d.a.g.glide_custom_view_target_tag;
    public final T a;
    public final a b;
    ...
    public static final class a {
        ...
        public static Integer f3855d;
        public final View a;
        public final List<g> b = new ArrayList();
        @Nullable

        /* renamed from: c  reason: collision with root package name */
        public ViewTreeObserver$OnPreDrawListenerC0052a f3856c;
        ...
        public void a() {
            ...
            if (viewTreeObserver.isAlive()) {
                viewTreeObserver.removeOnPreDrawListener(this.f3856c);
            }
            this.f3856c = null;
            this.b.clear();
        }
        ...
        public final int b(int i2, int i3, int i4) {
            ...
            if (f3855d == null) {
                ...
                f3855d = Integer.valueOf(Math.max(point.x, point.y));
            }
            return f3855d.intValue();
        }
    ...
    @Nullable
    public f.d.a.s.b f() {
        Object tag = this.a.getTag(f3854c);
        if (tag != null) {
    ...
    public void h(@NonNull g gVar) {
        ...
        if (aVar.f3856c == null) {
            ...
            aVar.f3856c = viewTreeObserver$OnPreDrawListenerC0052a;
