...
public class m implements k {
    ...
    public static final Bitmap.Config[] f3592d;

    /* renamed from: e  reason: collision with root package name */
    public static final Bitmap.Config[] f3593e;

    /* renamed from: f  reason: collision with root package name */
    public static final Bitmap.Config[] f3594f;

    /* renamed from: g  reason: collision with root package name */
    public static final Bitmap.Config[] f3595g;

    /* renamed from: h  reason: collision with root package name */
    public static final Bitmap.Config[] f3596h;
    public final c a = new c();
    public final g<b, Bitmap> b = new g<>();

    /* renamed from: c  reason: collision with root package name */
    public final Map<Bitmap.Config, NavigableMap<Integer, Integer>> f3597c = new HashMap();
    ...
    public static final class b implements l {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                return this.b == bVar.b && f.d.a.u.i.c(this.f3598c, bVar.f3598c);
            }
            return false;
        }
        ...
        public int hashCode() {
            int i2 = this.b * 31;
            Bitmap.Config config = this.f3598c;
            return i2 + (config != null ? config.hashCode() : 0);
        }

        public String toString() {
            return m.h(this.b, this.f3598c);
        }
    }
    ...
    static {
        ...
        f3592d = configArr;
        f3593e = configArr;
        f3594f = new Bitmap.Config[]{Bitmap.Config.RGB_565};
        f3595g = new Bitmap.Config[]{Bitmap.Config.ARGB_4444};
        f3596h = new Bitmap.Config[]{Bitmap.Config.ALPHA_8};
    }
    ...
    public Bitmap a(int i2, int i3, Bitmap.Config config) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && Bitmap.Config.RGBA_F16.equals(config)) {
            ...
            if (i5 == 1) {
                ...
                configArr = i5 != 4 ? new Bitmap.Config[]{config} : f3596h;
            } else {
                configArr = f3595g;
            }
        }
    ...
    public final NavigableMap<Integer, Integer> i(Bitmap.Config config) {
        NavigableMap<Integer, Integer> navigableMap = this.f3597c.get(config);
        if (navigableMap == null) {
            TreeMap treeMap = new TreeMap();
            this.f3597c.put(config, treeMap);
            return treeMap;
        }
        return navigableMap;
    }
    ...
    public String toString() {
        ...
        for (Map.Entry<Bitmap.Config, NavigableMap<Integer, Integer>> entry : this.f3597c.entrySet()) {
