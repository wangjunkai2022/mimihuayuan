...
public class d extends j<VideoList> {
    ...
    public final /* synthetic */ ShortVideoAdapter.TiktopHolder f3940e;

    public d(ShortVideoAdapter.TiktopHolder tiktopHolder) {
        this.f3940e = tiktopHolder;
    }
    ...
    public void f(VideoList videoList) {
        ...
        this.f3940e.b.setUploaderInviteCode(video.getInviteCode());
        this.f3940e.b.setRealVideo(video.getPlayUrl().get(0));
        this.f3940e.f458c.setPlayUri(video.getPlayUrl().get(0));
        ShortVideoAdapter.TiktopHolder tiktopHolder = this.f3940e;
        if (tiktopHolder.a.f456d == tiktopHolder.getAdapterPosition()) {
            this.f3940e.f458c.startPlayer();
        }
    }
}
