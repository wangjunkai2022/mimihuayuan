...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3923d = h0Var.f6527h;
        if (h0Var.g()) {
            i0 i0Var = this.f3923d;
            h.s(i0Var, "Argument must not be null");
            f.d.a.u.b bVar = new f.d.a.u.b(this.f3923d.d(), i0Var.g());
            this.f3922c = bVar;
            this.f3924e.d(f.e.a.j.e0.d.d.b(bVar));
            return;
        }
        this.f3924e.c(new f.d.a.o.e(h0Var.f6523d, h0Var.f6524e));
    }
