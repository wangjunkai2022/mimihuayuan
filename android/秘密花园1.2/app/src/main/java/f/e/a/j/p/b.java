...
public class b extends j<Person> {
    ...
    public final /* synthetic */ HGDDBrowseActivity f4014e;

    public b(HGDDBrowseActivity hGDDBrowseActivity) {
        this.f4014e = hGDDBrowseActivity;
    }

    @Override // m.j
    public void d() {
        this.f4014e.flProgress.setVisibility(8);
    }
    ...
    public void f(Person person) {
        ...
        if (person2.check()) {
            HGDDBrowseActivity.l(this.f4014e, person2.getAddress(), person2.getWechat(), person2.getQq());
        } else {
