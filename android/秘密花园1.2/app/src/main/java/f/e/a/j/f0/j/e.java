...
public class e implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        e0 S = aVar.S();
        if (S.b.f6854j.equals(f.e.a.e.a("XxYXFBhJFhwDE1YLEQlNH1YLEg0eFFhdXQhRE1cCDBhDPRMTCl1NSwc="))) {
            h0 d2 = aVar.d(S);
            String b = b.b(d2.f6527h.H());
            if (!TextUtils.isEmpty(b) && b.length() > 64) {
                b = b.substring(32, b.length() - 32);
            }
            i0 F = i0.F(b, d2.f6527h.E());
            e0 e0Var = d2.b;
            c0 c0Var = d2.f6522c;
            int i2 = d2.f6524e;
            String str = d2.f6523d;
            v vVar = d2.f6525f;
            w.a d3 = d2.f6526g.d();
            h0 h0Var = d2.f6528i;
            h0 h0Var2 = d2.f6529j;
        ...
        String str2 = S.b.f6854j;
        f.e.a.k.f.a();
        new LinkedHashMap();
        x xVar = S.b;
        String str3 = S.f6507c;
        g0 g0Var = S.f6509e;
        if (S.f6510f.isEmpty()) {
        ...
        if (xVar != null) {
            h0 d5 = aVar.d(new e0(xVar, str3, d4.d(), g0Var, i.m0.b.E(linkedHashMap)));
            i0 F2 = i0.F(b.c(d5.f6527h.H(), d5.e(f.e.a.e.a("T08RARgDVl0AAxkLHQQEH18="))), d5.f6527h.E());
            e0 e0Var2 = d5.b;
            c0 c0Var2 = d5.f6522c;
            int i3 = d5.f6524e;
            String str5 = d5.f6523d;
            v vVar2 = d5.f6525f;
            w.a d6 = d5.f6526g.d();
            h0 h0Var4 = d5.f6528i;
            h0 h0Var5 = d5.f6529j;
