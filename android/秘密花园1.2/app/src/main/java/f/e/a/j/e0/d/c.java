...
public class c implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        u uVar;
        int h2;
        if (aVar.S().b.f6854j.contains(f.e.a.e.a("GQgQCwU="))) {
        ...
        String str = new String(f.e.a.k.c.c(j2.getBytes(), d.a.getBytes(), d.f3919c, f.b.a.a.a.l(new StringBuilder(), d.b, substring).getBytes()));
        arrayList.add(x.b.a(x.f6846l, a, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, false, null, 91));
        arrayList2.add(x.b.a(x.f6846l, str, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, false, null, 91));
        e0.a aVar2 = new e0.a(S);
        aVar2.a(f.e.a.e.a("RBcFAgIL"), substring);
        aVar2.f(new u(arrayList, arrayList2));
        h0 d2 = aVar.d(aVar2.b());
        i0 F = i0.F(((MdBean) new j().d(d2.f6527h.H(), MdBean.class)).getDecryptData(), d2.f6527h.E());
        e0 e0Var = d2.b;
        c0 c0Var = d2.f6522c;
        int i3 = d2.f6524e;
