...
public class a {
    ...
    public static String f4015c = e.a("BlAAAA4VXlIRBVACHg1SWQ==");

    /* renamed from: d  reason: collision with root package name */
    public static String f4016d = e.a("dicwSy4wexwjLXc0TzoCD1MLDQM=");

    public static String a(String str) {
        byte[] c2 = c.c(str.getBytes(), f4015c.getBytes(), f4016d, null);
    ...
    public static Host g(String str) {
        ...
        if (hVar != null) {
            ...
            loop1: while (true) {
                ...
                while (it2.hasNext()) {
                    h hVar2 = (h) it2.next();
                    if (hVar2.f7093c.a.equals(e.a("X1A="))) {
                        ...
                        z3 = true;
                    } else if (hVar2.f7093c.a.equals(e.a("X1E="))) {
                        z4 = true;
                    }
                    if (z && hVar2.f7093c.a.equals(e.a("Rw=="))) {
                        host.getNovel().add(hVar2.O());
                    }
                    if (z2 && hVar2.f7093c.a.equals(e.a("Rw=="))) {
