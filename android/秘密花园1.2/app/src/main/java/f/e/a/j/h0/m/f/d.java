...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3954h = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f3955c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f3956d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f3957e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3958f;

    /* renamed from: g  reason: collision with root package name */
    public ByteArrayOutputStream f3959g = null;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3956d = h0Var.f6527h;
        if (h0Var.g()) {
            i0 i0Var = this.f3956d;
            h.s(i0Var, "Argument must not be null");
            InputStream bVar = new f.d.a.u.b(this.f3956d.d(), i0Var.g());
            this.f3955c = bVar;
            d.a<? super InputStream> aVar = this.f3957e;
            try {
        ...
        this.f3957e.c(new f.d.a.o.e(h0Var.f6523d, h0Var.f6524e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3954h, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3957e.c(iOException);
    }
