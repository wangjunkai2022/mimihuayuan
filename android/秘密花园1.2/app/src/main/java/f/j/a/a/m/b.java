...
public class b implements Interpolator {
    ...
    public static int f6258c = 1;

    /* renamed from: d  reason: collision with root package name */
    public static float f6259d = Resources.getSystem().getDisplayMetrics().density;

    /* renamed from: e  reason: collision with root package name */
    public static final float f6260e;

    /* renamed from: f  reason: collision with root package name */
    public static final float f6261f;
    public int a;

    static {
        float k2 = 1.0f / k(1.0f);
        f6260e = k2;
        f6261f = 1.0f - (k(1.0f) * k2);
    }
    ...
    public float getInterpolation(float f2) {
        ...
        float k2 = k(f2) * f6260e;
        return k2 > 0.0f ? k2 + f6261f : k2;
    }
}
