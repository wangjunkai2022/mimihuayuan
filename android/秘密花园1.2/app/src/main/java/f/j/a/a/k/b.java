...
public abstract class b extends RelativeLayout implements g {
    ...
    public b(@NonNull View view) {
        ...
        this.a = view;
        this.f6243c = gVar;
        if ((this instanceof f.j.a.a.j.b) && (gVar instanceof f) && gVar.getSpinnerStyle() == f.j.a.a.g.c.f6211h) {
            gVar.getView().setScaleY(-1.0f);
        } else if (this instanceof f.j.a.a.j.c) {
            g gVar2 = this.f6243c;
            if ((gVar2 instanceof f.j.a.a.f.e) && gVar2.getSpinnerStyle() == f.j.a.a.g.c.f6211h) {
                gVar.getView().setScaleY(-1.0f);
            }
        }
    }
    ...
    public void a(@NonNull i iVar, @NonNull f.j.a.a.g.b bVar, @NonNull f.j.a.a.g.b bVar2) {
        ...
        } else if ((this instanceof f.j.a.a.j.c) && (this.f6243c instanceof f.j.a.a.f.e)) {
            if (bVar.a) {
                bVar = bVar.a();
            }
            if (bVar2.a) {
    ...
    public f.j.a.a.g.c getSpinnerStyle() {
        ...
        if (view != null) {
            ...
            if (layoutParams != null && ((i2 = layoutParams.height) == 0 || i2 == -1)) {
                for (f.j.a.a.g.c cVar3 : f.j.a.a.g.c.f6212i) {
                    if (cVar3.f6213c) {
                        this.b = cVar3;
                        return cVar3;
                    }
        ...
        f.j.a.a.g.c cVar4 = f.j.a.a.g.c.f6207d;
        this.b = cVar4;
        return cVar4;
    }
