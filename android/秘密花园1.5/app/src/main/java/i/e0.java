...
public final class e0 {
    ...
    public final w f6508d;

    /* renamed from: e  reason: collision with root package name */
    public final g0 f6509e;

    /* renamed from: f  reason: collision with root package name */
    public final Map<Class<?>, Object> f6510f;
    ...
    public final String b(String str) {
        return this.f6508d.b(str);
    }

    public String toString() {
        StringBuilder o = f.b.a.a.a.o("Request{method=");
        o.append(this.f6507c);
        o.append(", url=");
        o.append(this.b);
        if (this.f6508d.size() != 0) {
            o.append(", headers=[");
            int i2 = 0;
            for (h.c<? extends String, ? extends String> cVar : this.f6508d) {
                int i3 = i2 + 1;
                if (i2 >= 0) {
    ...
    public static class a {
        ...
        /* renamed from: e  reason: collision with root package name */
        public Map<Class<?>, Object> f6513e;

        public a() {
            this.f6513e = new LinkedHashMap();
            this.b = "GET";
            this.f6511c = new w.a();
        }
        ...
        public e0 b() {
            x xVar = this.a;
            if (xVar != null) {
                return new e0(xVar, this.b, this.f6511c.d(), this.f6512d, b.E(this.f6513e));
            }
        ...
        public <T> a h(Class<? super T> cls, T t) {
            ...
            if (t == null) {
                this.f6513e.remove(cls);
            } else {
                if (this.f6513e.isEmpty()) {
                    this.f6513e = new LinkedHashMap();
                }
                Map<Class<?>, Object> map = this.f6513e;
                T cast = cls.cast(t);
                if (cast == null) {
                    h.o.c.g.e();
                    throw null;
        ...
        public a(e0 e0Var) {
            ...
            this.a = e0Var.b;
            this.b = e0Var.f6507c;
            this.f6512d = e0Var.f6509e;
            if (e0Var.f6510f.isEmpty()) {
                linkedHashMap = new LinkedHashMap();
            } else {
                Map<Class<?>, Object> map = e0Var.f6510f;
                if (map != null) {
            ...
            this.f6513e = linkedHashMap;
            this.f6511c = e0Var.f6508d.d();
        }
    }
}
