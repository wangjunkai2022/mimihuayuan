...
public final class a implements i.m0.e.d {
    ...
    public abstract class AbstractC0109a implements a0 {
        ...
        public long c(g gVar, long j2) {
            if (gVar != null) {
                try {
                    return a.this.f6677f.c(gVar, j2);
                } catch (IOException e2) {
                    h hVar = a.this.f6676e;
                    if (hVar == null) {
                        h.o.c.g.e();
                        throw null;
                    }
    ...
    public final class c extends AbstractC0109a {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final x f6683f;

        /* renamed from: g  reason: collision with root package name */
        public final /* synthetic */ a f6684g;
            ...
            if (j2 >= 0) {
                if (!this.b) {
                    if (this.f6682e) {
                        ...
                        if (j3 == 0 || j3 == -1) {
                            if (this.f6681d != -1) {
                                this.f6684g.f6677f.n();
                            }
                            try {
                                this.f6681d = this.f6684g.f6677f.A();
                                String n = this.f6684g.f6677f.n();
                                if (n != null) {
                                    ...
                                    throw new ProtocolException("expected chunk size and optional extensions but was \"" + this.f6681d + obj + '\"');
                                }
                        ...
                        long c2 = super.c(gVar, Math.min(j2, this.f6681d));
                        if (c2 == -1) {
                            h hVar = this.f6684g.f6676e;
                            if (hVar == null) {
                                h.o.c.g.e();
                                throw null;
                            }
        ...
        public void close() {
            ...
            if (this.f6682e && !i.m0.b.k(this, 100, TimeUnit.MILLISECONDS)) {
                h hVar = this.f6684g.f6676e;
                if (hVar != null) {
                    hVar.i();
                    d();
    ...
    public final class d extends AbstractC0109a {
        ...
        public void close() {
            ...
            if (this.f6685d != 0 && !i.m0.b.k(this, 100, TimeUnit.MILLISECONDS)) {
                h hVar = a.this.f6676e;
                if (hVar != null) {
                    hVar.i();
                    d();
    ...
    public static final void i(a aVar, n nVar) {
        if (aVar != null) {
            j.b0 b0Var = nVar.f7056e;
            nVar.f7056e = j.b0.f7043d;
            b0Var.a();
            b0Var.b();
            return;
        }
        ...
        if (wVar == null) {
            ...
            if (this.a == 0) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    this.f6678g.y(wVar.c(i2)).y(": ").y(wVar.f(i2)).y("\r\n");
                }
                this.f6678g.y("\r\n");
                this.a = 1;
                return;
