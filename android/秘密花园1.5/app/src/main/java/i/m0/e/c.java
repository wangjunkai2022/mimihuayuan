...
public final class c {
    ...
    public static final DateFormat[] f6661c;
    ...
    public static final class a extends ThreadLocal<DateFormat> {
        ...
        public DateFormat initialValue() {
            ...
            simpleDateFormat.setTimeZone(i.m0.b.f6578e);
    ...
    static {
        ...
        b = strArr;
        f6661c = new DateFormat[strArr.length];
    }
        ...
        if (str != null) {
            ...
            synchronized (b) {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    DateFormat dateFormat = f6661c[i2];
                    SimpleDateFormat simpleDateFormat = dateFormat;
                    if (dateFormat == null) {
                        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(b[i2], Locale.US);
                        simpleDateFormat2.setTimeZone(i.m0.b.f6578e);
                        f6661c[i2] = simpleDateFormat2;
