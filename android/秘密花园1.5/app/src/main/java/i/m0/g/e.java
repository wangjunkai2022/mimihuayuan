...
public final class e {
    ...
    public static final e f6720e = new e();
    public static final j.k a = j.k.f7054e.b("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    public static final String[] f6718c = new String[64];
    ...
    static {
        ...
        for (int i3 = 0; i3 < 1; i3++) {
            int i4 = iArr[i3];
            String[] strArr3 = f6718c;
            strArr3[i4 | 8] = strArr3[i4] + ((Object) "|PADDED");
        }
        String[] strArr4 = f6718c;
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            for (int i7 = 0; i7 < 1; i7++) {
                int i8 = iArr[i7];
                int i9 = i8 | i6;
                f6718c[i9] = f6718c[i8] + "|" + f6718c[i6];
                StringBuilder sb = new StringBuilder();
                sb.append(f6718c[i8]);
                sb.append("|");
                f6718c[i9 | 8] = f.b.a.a.a.l(sb, f6718c[i6], "|PADDED");
            }
        }
        int length = f6718c.length;
        for (int i10 = 0; i10 < length; i10++) {
            String[] strArr5 = f6718c;
            if (strArr5[i10] == null) {
                strArr5[i10] = f6719d[i10];
            }
        }
    }
