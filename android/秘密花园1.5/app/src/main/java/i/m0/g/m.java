...
public final class m {
    ...
    public final ArrayDeque<w> f6774e;
    ...
    public final c f6778i;

    /* renamed from: j  reason: collision with root package name */
    public final c f6779j;

    /* renamed from: k  reason: collision with root package name */
    public i.m0.g.b f6780k;

    /* renamed from: l  reason: collision with root package name */
    public IOException f6781l;
    ...
    public final class a implements y {
            ...
            synchronized (m.this) {
                ...
                if (!m.this.f6777h.f6783c) {
                    if (this.a.b > 0) {
                        ...
                        m mVar = m.this;
                        mVar.n.H(mVar.f6782m, true, null, 0L);
                    }
                }
                synchronized (m.this) {
                    this.b = true;
        ...
        public final void d(boolean z) throws IOException {
            ...
            synchronized (m.this) {
                m.this.f6779j.h();
                while (m.this.f6772c >= m.this.f6773d && !this.f6783c && !this.b && m.this.f() == null) {
                    m.this.l();
                }
                m.this.f6779j.n();
                m.this.b();
                min = Math.min(m.this.f6773d - m.this.f6772c, this.a.b);
                m.this.f6772c += min;
                if (z && min == this.a.b) {
                    z2 = m.this.f() == null;
                }
            ...
            m.this.f6779j.h();
            try {
                m.this.n.H(m.this.f6782m, z2, this.a, min);
            } finally {
                m.this.f6779j.n();
            }
        }
                ...
                synchronized (m.this) {
                    ...
                    if (!this.f6785c) {
                        if (this.b.b > j5) {
                            ...
                            if (th == null && j6 >= m.this.n.f6730l.a() / 2) {
                                m.this.n.K(m.this.f6782m, j6);
                                m.this.b = m.this.a;
                            }
                        } else if (this.f6787e || th != null) {
                            j3 = -1;
                        } else {
                            m.this.l();
                            z = true;
    ...
    public m(int i2, f fVar, boolean z, boolean z2, w wVar) {
        if (fVar != null) {
            this.f6782m = i2;
            this.n = fVar;
            this.f6773d = fVar.f6731m.a();
            this.f6774e = new ArrayDeque<>();
            this.f6776g = new b(this.n.f6730l.a(), z2);
            this.f6777h = new a(z);
            this.f6778i = new c();
            this.f6779j = new c();
            if (wVar != null) {
                if (!h()) {
                    this.f6774e.add(wVar);
                    return;
                }
    ...
    public final void a() throws IOException {
        ...
        synchronized (this) {
            if (this.f6776g.f6787e || !this.f6776g.f6785c || (!this.f6777h.f6783c && !this.f6777h.b)) {
                z = false;
            }
            i2 = i();
        }
    ...
    public final void b() throws IOException {
        ...
        if (!aVar.b) {
            if (!aVar.f6783c) {
                if (this.f6780k != null) {
                    Throwable th = this.f6781l;
                    if (th == null) {
                        i.m0.g.b bVar = this.f6780k;
                        if (bVar == null) {
                            h.o.c.g.e();
                            throw null;
                        }
    ...
    public final boolean d(i.m0.g.b bVar, IOException iOException) {
        ...
        if (!h.j.a || z) {
            synchronized (this) {
                ...
                if (this.f6776g.f6787e && this.f6777h.f6783c) {
                    return false;
                }
                this.f6780k = bVar;
                this.f6781l = iOException;
                notifyAll();
                this.n.E(this.f6782m);
                return true;
            }
    ...
    public final boolean h() {
        return this.n.a == ((this.f6782m & 1) == 1);
    }
    ...
    */
    public final void j(i.w r5, boolean r6) {
        ...
        L1a:
            monitor-enter(r4)
            boolean r0 = r4.f6775f     // Catch: java.lang.Throwable -> L47
            if (r0 == 0) goto L28
            if (r6 != 0) goto L22
            goto L28
        L22:
            i.m0.g.m$b r5 = r4.f6776g     // Catch: java.lang.Throwable -> L47
            if (r5 == 0) goto L27
            goto L2f
        L27:
            throw r1     // Catch: java.lang.Throwable -> L47
        L28:
            r4.f6775f = r2     // Catch: java.lang.Throwable -> L47
            java.util.ArrayDeque<i.w> r0 = r4.f6774e     // Catch: java.lang.Throwable -> L47
            r0.add(r5)     // Catch: java.lang.Throwable -> L47
        L2f:
            if (r6 == 0) goto L35
            i.m0.g.m$b r5 = r4.f6776g     // Catch: java.lang.Throwable -> L47
            r5.f6787e = r2     // Catch: java.lang.Throwable -> L47
        L35:
