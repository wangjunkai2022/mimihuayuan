...
public final class z {
    ...
    public static final Pattern f6862d = Pattern.compile("([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)/([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)");

    /* renamed from: e  reason: collision with root package name */
    public static final Pattern f6863e = Pattern.compile(";\\s*(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)=(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)|\"([^\"]*)\"))?");

    /* renamed from: f  reason: collision with root package name */
    public static final a f6864f = null;
    ...
    public static final class a {
        public static final z a(String str) {
            String str2 = null;
            if (str != null) {
                Matcher matcher = z.f6862d.matcher(str);
                if (matcher.lookingAt()) {
                    ...
                    Matcher matcher2 = z.f6863e.matcher(str);
                    int end = matcher.end();
                    while (true) {
                        String str3 = str2;
    ...
    public static Charset a(z zVar, Charset charset, int i2) {
        ...
        try {
            if (zVar.f6865c != null) {
                return Charset.forName(zVar.f6865c);
            }
            return null;
        } catch (IllegalArgumentException unused) {
            return null;
