...
public final class a0 extends g0 {
    ...
    public static final z f6431g;

    /* renamed from: h  reason: collision with root package name */
    public static final z f6432h;

    /* renamed from: i  reason: collision with root package name */
    public static final byte[] f6433i;

    /* renamed from: j  reason: collision with root package name */
    public static final byte[] f6434j;

    /* renamed from: k  reason: collision with root package name */
    public static final byte[] f6435k;

    /* renamed from: l  reason: collision with root package name */
    public static final b f6436l = new b(null);
    public final z b;
    ...
    public final j.k f6438d;

    /* renamed from: e  reason: collision with root package name */
    public final z f6439e;

    /* renamed from: f  reason: collision with root package name */
    public final List<c> f6440f;
    ...
    public static final class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final List<c> f6441c;

        public a() {
            String uuid = UUID.randomUUID().toString();
            h.o.c.g.b(uuid, "UUID.randomUUID().toString()");
            if (uuid != null) {
                this.a = j.k.f7054e.b(uuid);
                this.b = a0.f6431g;
        ...
        public final a0 c() {
            if (!this.f6441c.isEmpty()) {
                return new a0(this.a, this.b, i.m0.b.D(this.f6441c));
            }
    ...
    static {
        ...
        z.a aVar5 = z.f6864f;
        f6432h = z.a.a("multipart/form-data");
        f6433i = new byte[]{(byte) 58, (byte) 32};
        f6434j = new byte[]{(byte) 13, (byte) 10};
        byte b2 = (byte) 45;
        f6435k = new byte[]{b2, b2};
    }
            ...
            if (iVar != null) {
                ...
                if (wVar != null) {
                    ...
                    for (int i3 = 0; i3 < size2; i3++) {
                        iVar.y(wVar.c(i3)).r(f6433i).y(wVar.f(i3)).r(f6434j);
                    }
                }
                z b2 = g0Var.b();
                if (b2 != null) {
                    iVar.y("Content-Type: ").y(b2.a).r(f6434j);
                }
                long a2 = g0Var.a();
                if (a2 != -1) {
                    iVar.y("Content-Length: ").z(a2).r(f6434j);
                } else if (z) {
                    if (gVar != 0) {
                        gVar.skip(gVar.b);
                        return -1L;
