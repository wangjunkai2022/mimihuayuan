...
public class com_comeback_data_ui_main_bean_CollectVideoRealmProxy extends CollectVideo implements n, b1 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6959f = a("name", "name", a);
            this.f6960g = a(TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL, TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL, a);
            this.f6961h = a("addTime", "addTime", a);
            this.f6958e = a.a();
        }
    ...
    public static CollectVideo copy(x xVar, a aVar, CollectVideo collectVideo, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6392j.e(CollectVideo.class);
        long j2 = aVar.f6958e;
    ...
    */
    ...
    public static long insert(x xVar, CollectVideo collectVideo, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(CollectVideo.class);
        long j3 = aVar.f6960g;
        String realmGet$url = collectVideo.realmGet$url();
        if (realmGet$url == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$name = collectVideo.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6959f, createRowWithPrimaryKey, realmGet$name, false);
            }
            Table.nativeSetLong(j2, aVar.f6961h, createRowWithPrimaryKey, collectVideo.realmGet$addTime(), false);
    ...
    public static long insertOrUpdate(x xVar, CollectVideo collectVideo, Map<e0, Long> map) {
        ...
        String realmGet$name = collectVideo.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6959f, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6959f, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6961h, j4, collectVideo.realmGet$addTime(), false);
        return j4;
    }
    ...
    public static com_comeback_data_ui_main_bean_CollectVideoRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(CollectVideo.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_main_bean_collectvideorealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_main_bean_collectvideorealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_main_bean_collectvideorealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public long realmGet$addTime() {
        ...
        return this.proxyState.f6380c.p(this.columnInfo.f6961h);
    }

    @Override // com.comeback.data.ui.main.bean.CollectVideo, g.a.b1
    public String realmGet$name() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6959f);
    }
    ...
    public String realmGet$url() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6960g);
    }
    ...
    public void realmSet$addTime(long j2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6961h, pVar.l(), j2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6961h, j2);
    }
    ...
    public void realmSet$name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6959f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6959f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6959f);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6959f, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(collectVideo)) {
                if (collectVideo instanceof n) {
                    n nVar = (n) collectVideo;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(collectVideo, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$url = collectVideo.realmGet$url();
                if (realmGet$url == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$name != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6959f, createRowWithPrimaryKey, realmGet$name, false);
                    } else {
                        j2 = j4;
                    }
                    Table.nativeSetLong(j3, aVar.f6961h, createRowWithPrimaryKey, collectVideo.realmGet$addTime(), false);
                    j4 = j2;
                } else {
                    Table.s(realmGet$url);
                    throw null;
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(collectVideo)) {
                ...
                if (realmGet$name != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6959f, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.f6961h, createRowWithPrimaryKey, collectVideo.realmGet$addTime(), false);
                j4 = j2;
            }
