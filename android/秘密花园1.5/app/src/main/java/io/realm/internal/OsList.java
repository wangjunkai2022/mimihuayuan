...
public class OsList implements i, ObservableCollection {
    ...
    public static final long f6994e = nativeGetFinalizerPtr();
    public final long a;
    public final h b;

    /* renamed from: c  reason: collision with root package name */
    public final Table f6995c;

    /* renamed from: d  reason: collision with root package name */
    public final k<ObservableCollection.b> f6996d = new k<>();

    public OsList(UncheckedRow uncheckedRow, long j2) {
        OsSharedRealm osSharedRealm = uncheckedRow.b.f7028c;
        long[] nativeCreate = nativeCreate(osSharedRealm.getNativePtr(), uncheckedRow.f7032c, j2);
        this.a = nativeCreate[0];
        h hVar = osSharedRealm.context;
        this.b = hVar;
        hVar.a(this);
        if (nativeCreate[1] != 0) {
            this.f6995c = new Table(osSharedRealm, nativeCreate[1]);
        } else {
            this.f6995c = null;
        }
    }
    ...
    public void notifyChangeListeners(long j2) {
        ...
        this.f6996d.b(new ObservableCollection.a(osCollectionChangeSet));
    }
}
