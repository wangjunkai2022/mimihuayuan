...
public class com_comeback_data_ui_mimei_bean_MimeiComicItemRealmProxy extends MimeiComicItem implements n, d1 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6970f = a("id", "id", a);
            this.f6971g = a("series_hash_key", "series_hash_key", a);
            this.f6972h = a("name", "name", a);
            this.f6973i = a("series", "series", a);
            this.f6974j = a("series_stamp", "series_stamp", a);
            this.f6975k = a("cover_path", "cover_path", a);
            this.f6976l = a("full_cover_path", "full_cover_path", a);
            this.f6977m = a("view_count", "view_count", a);
        ...
        public final void b(c cVar, c cVar2) {
            ...
            aVar2.f6974j = aVar.f6974j;
            aVar2.f6975k = aVar.f6975k;
            aVar2.f6976l = aVar.f6976l;
            aVar2.f6977m = aVar.f6977m;
            aVar2.n = aVar.n;
            aVar2.o = aVar.o;
            aVar2.p = aVar.p;
            aVar2.q = aVar.q;
    ...
    public static MimeiComicItem copy(x xVar, a aVar, MimeiComicItem mimeiComicItem, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(MimeiComicItem.class), aVar.f6969e, set);
        osObjectBuilder.g(aVar.f6970f, mimeiComicItem.realmGet$id());
        osObjectBuilder.g(aVar.f6971g, mimeiComicItem.realmGet$series_hash_key());
        osObjectBuilder.g(aVar.f6972h, mimeiComicItem.realmGet$name());
        osObjectBuilder.g(aVar.f6973i, mimeiComicItem.realmGet$series());
        osObjectBuilder.g(aVar.f6974j, mimeiComicItem.realmGet$series_stamp());
        osObjectBuilder.g(aVar.f6975k, mimeiComicItem.realmGet$cover_path());
        osObjectBuilder.g(aVar.f6976l, mimeiComicItem.realmGet$full_cover_path());
        osObjectBuilder.e(aVar.f6977m, Integer.valueOf(mimeiComicItem.realmGet$view_count()));
    ...
    */
    ...
    public static long insert(x xVar, MimeiComicItem mimeiComicItem, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6392j.e(MimeiComicItem.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6392j;
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(MimeiComicItem.class);
        long j3 = aVar.f6970f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$series_hash_key != null) {
                Table.nativeSetString(j2, aVar.f6971g, createRowWithPrimaryKey, realmGet$series_hash_key, false);
            }
            String realmGet$name = mimeiComicItem.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6972h, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$series = mimeiComicItem.realmGet$series();
            if (realmGet$series != null) {
                Table.nativeSetString(j2, aVar.f6973i, createRowWithPrimaryKey, realmGet$series, false);
            }
            String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
            if (realmGet$series_stamp != null) {
                Table.nativeSetString(j2, aVar.f6974j, createRowWithPrimaryKey, realmGet$series_stamp, false);
            }
            String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
            if (realmGet$cover_path != null) {
                Table.nativeSetString(j2, aVar.f6975k, createRowWithPrimaryKey, realmGet$cover_path, false);
            }
            String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
            if (realmGet$full_cover_path != null) {
                Table.nativeSetString(j2, aVar.f6976l, createRowWithPrimaryKey, realmGet$full_cover_path, false);
            }
            Table.nativeSetLong(j2, aVar.f6977m, createRowWithPrimaryKey, mimeiComicItem.realmGet$view_count(), false);
    ...
    public static long insertOrUpdate(x xVar, MimeiComicItem mimeiComicItem, Map<e0, Long> map) {
        ...
        String realmGet$series_hash_key = mimeiComicItem.realmGet$series_hash_key();
        if (realmGet$series_hash_key != null) {
            Table.nativeSetString(j2, aVar.f6971g, j4, realmGet$series_hash_key, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6971g, j4, false);
        }
        String realmGet$name = mimeiComicItem.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6972h, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6972h, j4, false);
        }
        String realmGet$series = mimeiComicItem.realmGet$series();
        if (realmGet$series != null) {
            Table.nativeSetString(j2, aVar.f6973i, j4, realmGet$series, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6973i, j4, false);
        }
        String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
        if (realmGet$series_stamp != null) {
            Table.nativeSetString(j2, aVar.f6974j, j4, realmGet$series_stamp, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6974j, j4, false);
        }
        String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
        if (realmGet$cover_path != null) {
            Table.nativeSetString(j2, aVar.f6975k, j4, realmGet$cover_path, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6975k, j4, false);
        }
        String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
        if (realmGet$full_cover_path != null) {
            Table.nativeSetString(j2, aVar.f6976l, j4, realmGet$full_cover_path, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6976l, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6977m, j4, mimeiComicItem.realmGet$view_count(), false);
    ...
    public static com_comeback_data_ui_mimei_bean_MimeiComicItemRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(MimeiComicItem.class);
    ...
    public static MimeiComicItem update(x xVar, a aVar, MimeiComicItem mimeiComicItem, MimeiComicItem mimeiComicItem2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(MimeiComicItem.class), aVar.f6969e, set);
        osObjectBuilder.g(aVar.f6970f, mimeiComicItem2.realmGet$id());
        osObjectBuilder.g(aVar.f6971g, mimeiComicItem2.realmGet$series_hash_key());
        osObjectBuilder.g(aVar.f6972h, mimeiComicItem2.realmGet$name());
        osObjectBuilder.g(aVar.f6973i, mimeiComicItem2.realmGet$series());
        osObjectBuilder.g(aVar.f6974j, mimeiComicItem2.realmGet$series_stamp());
        osObjectBuilder.g(aVar.f6975k, mimeiComicItem2.realmGet$cover_path());
        osObjectBuilder.g(aVar.f6976l, mimeiComicItem2.realmGet$full_cover_path());
        osObjectBuilder.e(aVar.f6977m, Integer.valueOf(mimeiComicItem2.realmGet$view_count()));
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_mimei_bean_mimeicomicitemrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_mimei_bean_mimeicomicitemrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_mimei_bean_mimeicomicitemrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$cover_path() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6975k);
    }
    ...
    public String realmGet$full_cover_path() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6976l);
    }

    @Override // com.comeback.data.ui.mimei.bean.MimeiComicItem, g.a.d1
    public String realmGet$id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6970f);
    }
    ...
    public String realmGet$name() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6972h);
    }
    ...
    public String realmGet$series() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6973i);
    }

    @Override // com.comeback.data.ui.mimei.bean.MimeiComicItem, g.a.d1
    public String realmGet$series_hash_key() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6971g);
    }

    @Override // com.comeback.data.ui.mimei.bean.MimeiComicItem, g.a.d1
    public int realmGet$series_number() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.t);
    }

    @Override // com.comeback.data.ui.mimei.bean.MimeiComicItem, g.a.d1
    public String realmGet$series_stamp() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6974j);
    }
    ...
    public int realmGet$view_count() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.f6977m);
    }
    ...
    public void realmSet$cover_path(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6975k, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6975k, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6975k);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6975k, str);
        }
    }
    ...
    public void realmSet$full_cover_path(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6976l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6976l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6976l);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6976l, str);
        }
    }
    ...
    public void realmSet$name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6972h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6972h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6972h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6972h, str);
        }
    }
    ...
    public void realmSet$series(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6973i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6973i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6973i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6973i, str);
        }
    }
    ...
    public void realmSet$series_hash_key(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6971g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6971g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6971g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6971g, str);
        }
    }
    ...
    public void realmSet$series_number(int i2) {
        ...
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.t, i2);
    }
    ...
    public void realmSet$series_stamp(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6974j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6974j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6974j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6974j, str);
        }
    }
    ...
    public void realmSet$view_count(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6977m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6977m, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(mimeiComicItem)) {
                if (mimeiComicItem instanceof n) {
                    n nVar = (n) mimeiComicItem;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(mimeiComicItem, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$id = mimeiComicItem.realmGet$id();
                if (realmGet$id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$series_hash_key != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6971g, createRowWithPrimaryKey, realmGet$series_hash_key, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$name = mimeiComicItem.realmGet$name();
                    if (realmGet$name != null) {
                        Table.nativeSetString(j3, aVar.f6972h, createRowWithPrimaryKey, realmGet$name, false);
                    }
                    String realmGet$series = mimeiComicItem.realmGet$series();
                    if (realmGet$series != null) {
                        Table.nativeSetString(j3, aVar.f6973i, createRowWithPrimaryKey, realmGet$series, false);
                    }
                    String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
                    if (realmGet$series_stamp != null) {
                        Table.nativeSetString(j3, aVar.f6974j, createRowWithPrimaryKey, realmGet$series_stamp, false);
                    }
                    String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
                    if (realmGet$cover_path != null) {
                        Table.nativeSetString(j3, aVar.f6975k, createRowWithPrimaryKey, realmGet$cover_path, false);
                    }
                    String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
                    if (realmGet$full_cover_path != null) {
                        Table.nativeSetString(j3, aVar.f6976l, createRowWithPrimaryKey, realmGet$full_cover_path, false);
                    }
                    Table.nativeSetLong(j3, aVar.f6977m, createRowWithPrimaryKey, mimeiComicItem.realmGet$view_count(), false);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(mimeiComicItem)) {
                ...
                if (realmGet$series_hash_key != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6971g, createRowWithPrimaryKey, false);
                }
                String realmGet$name = mimeiComicItem.realmGet$name();
                if (realmGet$name != null) {
                    Table.nativeSetString(j3, aVar.f6972h, createRowWithPrimaryKey, realmGet$name, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6972h, createRowWithPrimaryKey, false);
                }
                String realmGet$series = mimeiComicItem.realmGet$series();
                if (realmGet$series != null) {
                    Table.nativeSetString(j3, aVar.f6973i, createRowWithPrimaryKey, realmGet$series, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6973i, createRowWithPrimaryKey, false);
                }
                String realmGet$series_stamp = mimeiComicItem.realmGet$series_stamp();
                if (realmGet$series_stamp != null) {
                    Table.nativeSetString(j3, aVar.f6974j, createRowWithPrimaryKey, realmGet$series_stamp, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6974j, createRowWithPrimaryKey, false);
                }
                String realmGet$cover_path = mimeiComicItem.realmGet$cover_path();
                if (realmGet$cover_path != null) {
                    Table.nativeSetString(j3, aVar.f6975k, createRowWithPrimaryKey, realmGet$cover_path, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6975k, createRowWithPrimaryKey, false);
                }
                String realmGet$full_cover_path = mimeiComicItem.realmGet$full_cover_path();
                if (realmGet$full_cover_path != null) {
                    Table.nativeSetString(j3, aVar.f6976l, createRowWithPrimaryKey, realmGet$full_cover_path, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6976l, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6977m, j5, mimeiComicItem.realmGet$view_count(), false);
