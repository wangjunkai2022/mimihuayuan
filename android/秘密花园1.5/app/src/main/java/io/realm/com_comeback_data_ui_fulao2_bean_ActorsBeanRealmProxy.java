...
public class com_comeback_data_ui_fulao2_bean_ActorsBeanRealmProxy extends ActorsBean implements n, s0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6896f = a("actor_id", "actor_id", a);
            this.f6897g = a("actor_name", "actor_name", a);
            this.f6898h = a("actor_url", "actor_url", a);
            this.f6899i = a("actor_like", "actor_like", a);
            this.f6900j = a("actor_collects", "actor_collects", a);
            this.f6901k = a("actor_vip", "actor_vip", a);
            this.f6902l = a("video_title", "video_title", a);
            this.f6895e = a.a();
        }
    ...
    public static ActorsBean copy(x xVar, a aVar, ActorsBean actorsBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6392j.e(ActorsBean.class);
        long j2 = aVar.f6895e;
    ...
    */
    ...
    public static long insert(x xVar, ActorsBean actorsBean, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(ActorsBean.class);
        long j3 = aVar.f6896f;
        String realmGet$actor_id = actorsBean.realmGet$actor_id();
        if (realmGet$actor_id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$actor_name = actorsBean.realmGet$actor_name();
            if (realmGet$actor_name != null) {
                Table.nativeSetString(j2, aVar.f6897g, createRowWithPrimaryKey, realmGet$actor_name, false);
            }
            String realmGet$actor_url = actorsBean.realmGet$actor_url();
            if (realmGet$actor_url != null) {
                Table.nativeSetString(j2, aVar.f6898h, createRowWithPrimaryKey, realmGet$actor_url, false);
            }
            Table.nativeSetBoolean(j2, aVar.f6899i, createRowWithPrimaryKey, actorsBean.realmGet$actor_like(), false);
            Table.nativeSetLong(j2, aVar.f6900j, createRowWithPrimaryKey, actorsBean.realmGet$actor_collects(), false);
            Table.nativeSetBoolean(j2, aVar.f6901k, createRowWithPrimaryKey, actorsBean.realmGet$actor_vip(), false);
            String realmGet$video_title = actorsBean.realmGet$video_title();
            if (realmGet$video_title != null) {
                Table.nativeSetString(j2, aVar.f6902l, createRowWithPrimaryKey, realmGet$video_title, false);
            }
    ...
    public static long insertOrUpdate(x xVar, ActorsBean actorsBean, Map<e0, Long> map) {
        ...
        String realmGet$actor_name = actorsBean.realmGet$actor_name();
        if (realmGet$actor_name != null) {
            Table.nativeSetString(j2, aVar.f6897g, j4, realmGet$actor_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6897g, j4, false);
        }
        String realmGet$actor_url = actorsBean.realmGet$actor_url();
        if (realmGet$actor_url != null) {
            Table.nativeSetString(j2, aVar.f6898h, j4, realmGet$actor_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6898h, j4, false);
        }
        Table.nativeSetBoolean(j2, aVar.f6899i, j4, actorsBean.realmGet$actor_like(), false);
        Table.nativeSetLong(j2, aVar.f6900j, j4, actorsBean.realmGet$actor_collects(), false);
        Table.nativeSetBoolean(j2, aVar.f6901k, j4, actorsBean.realmGet$actor_vip(), false);
        String realmGet$video_title = actorsBean.realmGet$video_title();
        if (realmGet$video_title != null) {
            Table.nativeSetString(j2, aVar.f6902l, j4, realmGet$video_title, false);
        } else {
    ...
    public static com_comeback_data_ui_fulao2_bean_ActorsBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(ActorsBean.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_fulao2_bean_actorsbeanrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_fulao2_bean_actorsbeanrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_fulao2_bean_actorsbeanrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public int realmGet$actor_collects() {
        ...
        return (int) this.proxyState.f6380c.p(this.columnInfo.f6900j);
    }

    @Override // com.comeback.data.ui.fulao2.bean.ActorsBean, g.a.s0
    public String realmGet$actor_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6896f);
    }

    @Override // com.comeback.data.ui.fulao2.bean.ActorsBean, g.a.s0
    public boolean realmGet$actor_like() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.m(this.columnInfo.f6899i);
    }

    @Override // com.comeback.data.ui.fulao2.bean.ActorsBean, g.a.s0
    public String realmGet$actor_name() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6897g);
    }

    @Override // com.comeback.data.ui.fulao2.bean.ActorsBean, g.a.s0
    public String realmGet$actor_url() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6898h);
    }

    @Override // com.comeback.data.ui.fulao2.bean.ActorsBean, g.a.s0
    public boolean realmGet$actor_vip() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.m(this.columnInfo.f6901k);
    }
    ...
    public String realmGet$video_title() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6902l);
    }
    ...
    public void realmSet$actor_collects(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().p(this.columnInfo.f6900j, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.f6900j, i2);
    }
    ...
    public void realmSet$actor_like(boolean z) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().o(this.columnInfo.f6899i, pVar.l(), z, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.i(this.columnInfo.f6899i, z);
    }
    ...
    public void realmSet$actor_name(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6897g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6897g, str);
        }
    }
    ...
    public void realmSet$actor_url(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6898h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6898h, str);
        }
    }
    ...
    public void realmSet$actor_vip(boolean z) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                pVar.d().o(this.columnInfo.f6901k, pVar.l(), z, true);
                return;
            }
            return;
        }
        vVar.f6382e.f();
        this.proxyState.f6380c.i(this.columnInfo.f6901k, z);
    }
    ...
    public void realmSet$video_title(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6902l);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6902l, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(actorsBean)) {
                if (actorsBean instanceof n) {
                    n nVar = (n) actorsBean;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(actorsBean, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$actor_id = actorsBean.realmGet$actor_id();
                if (realmGet$actor_id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$actor_name != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6897g, createRowWithPrimaryKey, realmGet$actor_name, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$actor_url = actorsBean.realmGet$actor_url();
                    if (realmGet$actor_url != null) {
                        Table.nativeSetString(j3, aVar.f6898h, createRowWithPrimaryKey, realmGet$actor_url, false);
                    }
                    Table.nativeSetBoolean(j3, aVar.f6899i, createRowWithPrimaryKey, actorsBean.realmGet$actor_like(), false);
                    Table.nativeSetLong(j3, aVar.f6900j, createRowWithPrimaryKey, actorsBean.realmGet$actor_collects(), false);
                    Table.nativeSetBoolean(j3, aVar.f6901k, createRowWithPrimaryKey, actorsBean.realmGet$actor_vip(), false);
                    String realmGet$video_title = actorsBean.realmGet$video_title();
                    if (realmGet$video_title != null) {
                        Table.nativeSetString(j3, aVar.f6902l, createRowWithPrimaryKey, realmGet$video_title, false);
                    }
                    j4 = j2;
                } else {
                    Table.s(realmGet$actor_id);
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(actorsBean)) {
                ...
                if (realmGet$actor_name != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6897g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor_url = actorsBean.realmGet$actor_url();
                if (realmGet$actor_url != null) {
                    Table.nativeSetString(j3, aVar.f6898h, createRowWithPrimaryKey, realmGet$actor_url, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6898h, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetBoolean(j3, aVar.f6899i, j5, actorsBean.realmGet$actor_like(), false);
                Table.nativeSetLong(j3, aVar.f6900j, j5, actorsBean.realmGet$actor_collects(), false);
                Table.nativeSetBoolean(j3, aVar.f6901k, j5, actorsBean.realmGet$actor_vip(), false);
                String realmGet$video_title = actorsBean.realmGet$video_title();
                if (realmGet$video_title != null) {
                    Table.nativeSetString(j3, aVar.f6902l, createRowWithPrimaryKey, realmGet$video_title, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6902l, createRowWithPrimaryKey, false);
                }
                j4 = j2;
            }
        }
