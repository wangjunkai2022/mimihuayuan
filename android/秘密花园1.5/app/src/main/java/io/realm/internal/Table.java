...
public class Table implements i {
    ...
    public static final long f7027e;
    public final long a;
    public final h b;

    /* renamed from: c  reason: collision with root package name */
    public final OsSharedRealm f7028c;

    static {
        String nativeGetTablePrefix = Util.nativeGetTablePrefix();
        f7026d = nativeGetTablePrefix;
        nativeGetTablePrefix.length();
        f7027e = nativeGetFinalizerPtr();
    }

    public Table(OsSharedRealm osSharedRealm, long j2) {
        h hVar = osSharedRealm.context;
        this.b = hVar;
        this.f7028c = osSharedRealm;
        this.a = j2;
        hVar.a(this);
    }
    ...
    public static String e(String str) {
        ...
        return !str.startsWith(f7026d) ? str : str.substring(f7026d.length());
    }
    ...
    public static String k(String str) {
        ...
        return a.l(new StringBuilder(), f7026d, str);
    }
    ...
    public void a() {
        OsSharedRealm osSharedRealm = this.f7028c;
    ...
    public Table i(long j2) {
        return new Table(this.f7028c, nativeGetLinkTarget(this.a, j2));
    }
