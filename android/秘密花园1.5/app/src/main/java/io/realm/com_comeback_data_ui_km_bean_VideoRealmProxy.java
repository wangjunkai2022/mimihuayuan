...
public class com_comeback_data_ui_km_bean_VideoRealmProxy extends Video implements n, y0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6936f = a("mu_avatar", "mu_avatar", a);
            this.f6937g = a("mu_id", "mu_id", a);
            this.f6938h = a("mu_name", "mu_name", a);
            this.f6939i = a("mv_comment", "mv_comment", a);
            this.f6940j = a("mv_created", "mv_created", a);
            this.f6941k = a("mv_id", "mv_id", a);
            this.f6942l = a("mv_img_url", "mv_img_url", a);
            this.f6943m = a("mv_like", "mv_like", a);
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6936f = aVar.f6936f;
            aVar2.f6937g = aVar.f6937g;
            aVar2.f6938h = aVar.f6938h;
            aVar2.f6939i = aVar.f6939i;
            aVar2.f6940j = aVar.f6940j;
            aVar2.f6941k = aVar.f6941k;
            aVar2.f6942l = aVar.f6942l;
            aVar2.f6943m = aVar.f6943m;
            aVar2.n = aVar.n;
            aVar2.o = aVar.o;
            aVar2.p = aVar.p;
            aVar2.q = aVar.q;
            aVar2.r = aVar.r;
            aVar2.f6935e = aVar.f6935e;
        }
    }
    ...
    public static Video copy(x xVar, a aVar, Video video, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(Video.class), aVar.f6935e, set);
        osObjectBuilder.g(aVar.f6936f, video.realmGet$mu_avatar());
        osObjectBuilder.g(aVar.f6937g, video.realmGet$mu_id());
        osObjectBuilder.g(aVar.f6938h, video.realmGet$mu_name());
        osObjectBuilder.g(aVar.f6939i, video.realmGet$mv_comment());
        osObjectBuilder.g(aVar.f6940j, video.realmGet$mv_created());
        osObjectBuilder.g(aVar.f6941k, video.realmGet$mv_id());
        osObjectBuilder.g(aVar.f6942l, video.realmGet$mv_img_url());
        osObjectBuilder.g(aVar.f6943m, video.realmGet$mv_like());
    ...
    */
    public static com.comeback.data.ui.km.bean.Video copyOrUpdate(g.a.x r9, io.realm.com_comeback_data_ui_km_bean_VideoRealmProxy.a r10, com.comeback.data.ui.km.bean.Video r11, boolean r12, java.util.Map<g.a.e0, g.a.f1.n> r13, java.util.Set<g.a.m> r14) {
        ...
        L6b:
            ...
            io.realm.com_comeback_data_ui_km_bean_VideoRealmProxy r1 = new io.realm.com_comeback_data_ui_km_bean_VideoRealmProxy     // Catch: java.lang.Throwable -> L89
    ...
    */
    ...
    public static long insert(x xVar, Video video, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6392j.e(Video.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6392j;
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(Video.class);
        long j3 = aVar.f6941k;
        String realmGet$mv_id = video.realmGet$mv_id();
        if (realmGet$mv_id == null) {
            nativeFindFirstString = Table.nativeFindFirstNull(j2, j3);
        } else {
            nativeFindFirstString = Table.nativeFindFirstString(j2, j3, realmGet$mv_id);
        }
        if (nativeFindFirstString == -1) {
            long createRowWithPrimaryKey = OsObject.createRowWithPrimaryKey(e2, j3, realmGet$mv_id);
            ...
            if (realmGet$mu_avatar != null) {
                Table.nativeSetString(j2, aVar.f6936f, createRowWithPrimaryKey, realmGet$mu_avatar, false);
            }
            String realmGet$mu_id = video.realmGet$mu_id();
            if (realmGet$mu_id != null) {
                Table.nativeSetString(j2, aVar.f6937g, createRowWithPrimaryKey, realmGet$mu_id, false);
            }
            String realmGet$mu_name = video.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j2, aVar.f6938h, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
            String realmGet$mv_comment = video.realmGet$mv_comment();
            if (realmGet$mv_comment != null) {
                Table.nativeSetString(j2, aVar.f6939i, createRowWithPrimaryKey, realmGet$mv_comment, false);
            }
            String realmGet$mv_created = video.realmGet$mv_created();
            if (realmGet$mv_created != null) {
                Table.nativeSetString(j2, aVar.f6940j, createRowWithPrimaryKey, realmGet$mv_created, false);
            }
            String realmGet$mv_img_url = video.realmGet$mv_img_url();
            if (realmGet$mv_img_url != null) {
                Table.nativeSetString(j2, aVar.f6942l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
            }
            String realmGet$mv_like = video.realmGet$mv_like();
            if (realmGet$mv_like != null) {
                Table.nativeSetString(j2, aVar.f6943m, createRowWithPrimaryKey, realmGet$mv_like, false);
            }
            Table.nativeSetLong(j2, aVar.n, createRowWithPrimaryKey, video.realmGet$mv_play_height(), false);
            String realmGet$mv_play_url = video.realmGet$mv_play_url();
            if (realmGet$mv_play_url != null) {
                Table.nativeSetString(j2, aVar.o, createRowWithPrimaryKey, realmGet$mv_play_url, false);
            }
            Table.nativeSetLong(j2, aVar.p, createRowWithPrimaryKey, video.realmGet$mv_play_width(), false);
            String realmGet$mv_title = video.realmGet$mv_title();
            if (realmGet$mv_title != null) {
                Table.nativeSetString(j2, aVar.q, createRowWithPrimaryKey, realmGet$mv_title, false);
            }
            Table.nativeSetLong(j2, aVar.r, createRowWithPrimaryKey, video.realmGet$is_cat_ads(), false);
    ...
    public static long insertOrUpdate(x xVar, Video video, Map<e0, Long> map) {
        ...
        if (nativeFindFirstString == -1) {
            nativeFindFirstString = OsObject.createRowWithPrimaryKey(e2, j3, realmGet$mv_id);
        }
        long j4 = nativeFindFirstString;
        map.put(video, Long.valueOf(j4));
        String realmGet$mu_avatar = video.realmGet$mu_avatar();
        if (realmGet$mu_avatar != null) {
            Table.nativeSetString(j2, aVar.f6936f, j4, realmGet$mu_avatar, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6936f, j4, false);
        }
        String realmGet$mu_id = video.realmGet$mu_id();
        if (realmGet$mu_id != null) {
            Table.nativeSetString(j2, aVar.f6937g, j4, realmGet$mu_id, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6937g, j4, false);
        }
        String realmGet$mu_name = video.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j2, aVar.f6938h, j4, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6938h, j4, false);
        }
        String realmGet$mv_comment = video.realmGet$mv_comment();
        if (realmGet$mv_comment != null) {
            Table.nativeSetString(j2, aVar.f6939i, j4, realmGet$mv_comment, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6939i, j4, false);
        }
        String realmGet$mv_created = video.realmGet$mv_created();
        if (realmGet$mv_created != null) {
            Table.nativeSetString(j2, aVar.f6940j, j4, realmGet$mv_created, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6940j, j4, false);
        }
        String realmGet$mv_img_url = video.realmGet$mv_img_url();
        if (realmGet$mv_img_url != null) {
            Table.nativeSetString(j2, aVar.f6942l, j4, realmGet$mv_img_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6942l, j4, false);
        }
        String realmGet$mv_like = video.realmGet$mv_like();
        if (realmGet$mv_like != null) {
            Table.nativeSetString(j2, aVar.f6943m, j4, realmGet$mv_like, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6943m, j4, false);
        }
        Table.nativeSetLong(j2, aVar.n, j4, video.realmGet$mv_play_height(), false);
        String realmGet$mv_play_url = video.realmGet$mv_play_url();
        if (realmGet$mv_play_url != null) {
            Table.nativeSetString(j2, aVar.o, j4, realmGet$mv_play_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.o, j4, false);
        }
        Table.nativeSetLong(j2, aVar.p, j4, video.realmGet$mv_play_width(), false);
        String realmGet$mv_title = video.realmGet$mv_title();
        if (realmGet$mv_title != null) {
            Table.nativeSetString(j2, aVar.q, j4, realmGet$mv_title, false);
        } else {
            Table.nativeSetNull(j2, aVar.q, j4, false);
        }
        Table.nativeSetLong(j2, aVar.r, j4, video.realmGet$is_cat_ads(), false);
        return j4;
    }
    ...
    public static Video update(x xVar, a aVar, Video video, Video video2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(Video.class), aVar.f6935e, set);
        osObjectBuilder.g(aVar.f6936f, video2.realmGet$mu_avatar());
        osObjectBuilder.g(aVar.f6937g, video2.realmGet$mu_id());
        osObjectBuilder.g(aVar.f6938h, video2.realmGet$mu_name());
        osObjectBuilder.g(aVar.f6939i, video2.realmGet$mv_comment());
        osObjectBuilder.g(aVar.f6940j, video2.realmGet$mv_created());
        osObjectBuilder.g(aVar.f6941k, video2.realmGet$mv_id());
        osObjectBuilder.g(aVar.f6942l, video2.realmGet$mv_img_url());
        osObjectBuilder.g(aVar.f6943m, video2.realmGet$mv_like());
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_km_bean_videorealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_km_bean_videorealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_km_bean_videorealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$mu_avatar() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6936f);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mu_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6937g);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mu_name() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6938h);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_comment() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6939i);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_created() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6940j);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6941k);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_img_url() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6942l);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_like() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6943m);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public int realmGet$mv_play_height() {
        this.proxyState.f6382e.f();
        return (int) this.proxyState.f6380c.p(this.columnInfo.n);
    }
    ...
    public void realmSet$mu_avatar(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6936f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6936f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6936f);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6936f, str);
        }
    }
    ...
    public void realmSet$mu_id(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6937g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6937g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6937g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6937g, str);
        }
    }
    ...
    public void realmSet$mu_name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6938h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6938h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6938h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6938h, str);
        }
    }
    ...
    public void realmSet$mv_comment(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6939i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6939i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6939i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6939i, str);
        }
    }
    ...
    public void realmSet$mv_created(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6940j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6940j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6940j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6940j, str);
        }
    }
    ...
    public void realmSet$mv_img_url(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6942l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6942l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6942l);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6942l, str);
        }
    }
    ...
    public void realmSet$mv_like(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6943m, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6943m, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6943m);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6943m, str);
        }
    }
    ...
    public void realmSet$mv_play_height(int i2) {
        ...
        vVar.f6382e.f();
        this.proxyState.f6380c.u(this.columnInfo.n, i2);
    }
    ...
    public String toString() {
        if (g0.isValid(this)) {
            ...
            f.b.a.a.a.C(q, realmGet$mu_avatar() != null ? realmGet$mu_avatar() : "null", "}", ",", "{mu_id:");
            f.b.a.a.a.C(q, realmGet$mu_id() != null ? realmGet$mu_id() : "null", "}", ",", "{mu_name:");
            f.b.a.a.a.C(q, realmGet$mu_name() != null ? realmGet$mu_name() : "null", "}", ",", "{mv_comment:");
            f.b.a.a.a.C(q, realmGet$mv_comment() != null ? realmGet$mv_comment() : "null", "}", ",", "{mv_created:");
            f.b.a.a.a.C(q, realmGet$mv_created() != null ? realmGet$mv_created() : "null", "}", ",", "{mv_id:");
            f.b.a.a.a.C(q, realmGet$mv_id() != null ? realmGet$mv_id() : "null", "}", ",", "{mv_img_url:");
            f.b.a.a.a.C(q, realmGet$mv_img_url() != null ? realmGet$mv_img_url() : "null", "}", ",", "{mv_like:");
            f.b.a.a.a.C(q, realmGet$mv_like() != null ? realmGet$mv_like() : "null", "}", ",", "{mv_play_height:");
            q.append(realmGet$mv_play_height());
            q.append("}");
            q.append(",");
            q.append("{mv_play_url:");
            f.b.a.a.a.C(q, realmGet$mv_play_url() != null ? realmGet$mv_play_url() : "null", "}", ",", "{mv_play_width:");
            q.append(realmGet$mv_play_width());
            q.append("}");
            q.append(",");
            q.append("{mv_title:");
            f.b.a.a.a.C(q, realmGet$mv_title() != null ? realmGet$mv_title() : "null", "}", ",", "{is_cat_ads:");
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(video)) {
                if (video instanceof n) {
                    n nVar = (n) video;
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(video, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
                String realmGet$mv_id = video.realmGet$mv_id();
                if (realmGet$mv_id == null) {
                    ...
                    nativeFindFirstString = Table.nativeFindFirstString(j3, j4, realmGet$mv_id);
                }
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$mu_avatar != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6936f, createRowWithPrimaryKey, realmGet$mu_avatar, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$mu_id = video.realmGet$mu_id();
                    if (realmGet$mu_id != null) {
                        Table.nativeSetString(j3, aVar.f6937g, createRowWithPrimaryKey, realmGet$mu_id, false);
                    }
                    String realmGet$mu_name = video.realmGet$mu_name();
                    if (realmGet$mu_name != null) {
                        Table.nativeSetString(j3, aVar.f6938h, createRowWithPrimaryKey, realmGet$mu_name, false);
                    }
                    String realmGet$mv_comment = video.realmGet$mv_comment();
                    if (realmGet$mv_comment != null) {
                        Table.nativeSetString(j3, aVar.f6939i, createRowWithPrimaryKey, realmGet$mv_comment, false);
                    }
                    String realmGet$mv_created = video.realmGet$mv_created();
                    if (realmGet$mv_created != null) {
                        Table.nativeSetString(j3, aVar.f6940j, createRowWithPrimaryKey, realmGet$mv_created, false);
                    }
                    String realmGet$mv_img_url = video.realmGet$mv_img_url();
                    if (realmGet$mv_img_url != null) {
                        Table.nativeSetString(j3, aVar.f6942l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
                    }
                    String realmGet$mv_like = video.realmGet$mv_like();
                    if (realmGet$mv_like != null) {
                        Table.nativeSetString(j3, aVar.f6943m, createRowWithPrimaryKey, realmGet$mv_like, false);
                    }
                    Table.nativeSetLong(j3, aVar.n, createRowWithPrimaryKey, video.realmGet$mv_play_height(), false);
                    String realmGet$mv_play_url = video.realmGet$mv_play_url();
                    if (realmGet$mv_play_url != null) {
                        Table.nativeSetString(j3, aVar.o, createRowWithPrimaryKey, realmGet$mv_play_url, false);
                    }
                    Table.nativeSetLong(j3, aVar.p, createRowWithPrimaryKey, video.realmGet$mv_play_width(), false);
                    String realmGet$mv_title = video.realmGet$mv_title();
                    if (realmGet$mv_title != null) {
                        Table.nativeSetString(j3, aVar.q, createRowWithPrimaryKey, realmGet$mv_title, false);
                    }
                    Table.nativeSetLong(j3, aVar.r, createRowWithPrimaryKey, video.realmGet$is_cat_ads(), false);
                    j4 = j2;
                } else {
                    Table.s(realmGet$mv_id);
                    throw null;
    ...
    public static void insertOrUpdate(x xVar, Iterator<? extends e0> it, Map<e0, Long> map) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(video)) {
                ...
                long createRowWithPrimaryKey = nativeFindFirstString == -1 ? OsObject.createRowWithPrimaryKey(e2, j4, realmGet$mv_id) : nativeFindFirstString;
                map.put(video, Long.valueOf(createRowWithPrimaryKey));
                String realmGet$mu_avatar = video.realmGet$mu_avatar();
                if (realmGet$mu_avatar != null) {
                    j2 = j4;
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6936f, createRowWithPrimaryKey, false);
                }
                String realmGet$mu_id = video.realmGet$mu_id();
                if (realmGet$mu_id != null) {
                    Table.nativeSetString(j3, aVar.f6937g, createRowWithPrimaryKey, realmGet$mu_id, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6937g, createRowWithPrimaryKey, false);
                }
                String realmGet$mu_name = video.realmGet$mu_name();
                if (realmGet$mu_name != null) {
                    Table.nativeSetString(j3, aVar.f6938h, createRowWithPrimaryKey, realmGet$mu_name, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6938h, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_comment = video.realmGet$mv_comment();
                if (realmGet$mv_comment != null) {
                    Table.nativeSetString(j3, aVar.f6939i, createRowWithPrimaryKey, realmGet$mv_comment, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6939i, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_created = video.realmGet$mv_created();
                if (realmGet$mv_created != null) {
                    Table.nativeSetString(j3, aVar.f6940j, createRowWithPrimaryKey, realmGet$mv_created, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6940j, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_img_url = video.realmGet$mv_img_url();
                if (realmGet$mv_img_url != null) {
                    Table.nativeSetString(j3, aVar.f6942l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6942l, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_like = video.realmGet$mv_like();
                if (realmGet$mv_like != null) {
                    Table.nativeSetString(j3, aVar.f6943m, createRowWithPrimaryKey, realmGet$mv_like, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6943m, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.n, createRowWithPrimaryKey, video.realmGet$mv_play_height(), false);
                String realmGet$mv_play_url = video.realmGet$mv_play_url();
                if (realmGet$mv_play_url != null) {
