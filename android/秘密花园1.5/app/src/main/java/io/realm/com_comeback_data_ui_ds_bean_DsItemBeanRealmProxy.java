...
public class com_comeback_data_ui_ds_bean_DsItemBeanRealmProxy extends DsItemBean implements n, r0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6887f = a("id", "id", a);
            this.f6888g = a(NotificationCompatJellybean.KEY_TITLE, NotificationCompatJellybean.KEY_TITLE, a);
            this.f6889h = a("lanmu_id", "lanmu_id", a);
            this.f6890i = a("create_time", "create_time", a);
            this.f6891j = a("update_time", "update_time", a);
            this.f6892k = a("sort", "sort", a);
            this.f6893l = a(NotificationCompat.CATEGORY_STATUS, NotificationCompat.CATEGORY_STATUS, a);
            this.f6894m = a("view", "view", a);
        ...
        public final void b(c cVar, c cVar2) {
            ...
            aVar2.f6892k = aVar.f6892k;
            aVar2.f6893l = aVar.f6893l;
            aVar2.f6894m = aVar.f6894m;
            aVar2.n = aVar.n;
            aVar2.o = aVar.o;
            aVar2.p = aVar.p;
            aVar2.q = aVar.q;
    ...
    public static DsItemBean copy(x xVar, a aVar, DsItemBean dsItemBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(DsItemBean.class), aVar.f6886e, set);
        osObjectBuilder.g(aVar.f6887f, dsItemBean.realmGet$id());
        osObjectBuilder.g(aVar.f6888g, dsItemBean.realmGet$title());
        osObjectBuilder.g(aVar.f6889h, dsItemBean.realmGet$lanmu_id());
        osObjectBuilder.g(aVar.f6890i, dsItemBean.realmGet$create_time());
        osObjectBuilder.g(aVar.f6891j, dsItemBean.realmGet$update_time());
        osObjectBuilder.g(aVar.f6892k, dsItemBean.realmGet$sort());
        osObjectBuilder.g(aVar.f6893l, dsItemBean.realmGet$status());
        osObjectBuilder.g(aVar.f6894m, dsItemBean.realmGet$view());
    ...
    */
    ...
    public static long insert(x xVar, DsItemBean dsItemBean, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6392j.e(DsItemBean.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6392j;
        k0Var.a();
        a aVar = (a) k0Var.f6361f.a(DsItemBean.class);
        long j3 = aVar.f6887f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$title != null) {
                Table.nativeSetString(j2, aVar.f6888g, createRowWithPrimaryKey, realmGet$title, false);
            }
            String realmGet$lanmu_id = dsItemBean.realmGet$lanmu_id();
            if (realmGet$lanmu_id != null) {
                Table.nativeSetString(j2, aVar.f6889h, createRowWithPrimaryKey, realmGet$lanmu_id, false);
            }
            String realmGet$create_time = dsItemBean.realmGet$create_time();
            if (realmGet$create_time != null) {
                Table.nativeSetString(j2, aVar.f6890i, createRowWithPrimaryKey, realmGet$create_time, false);
            }
            String realmGet$update_time = dsItemBean.realmGet$update_time();
            if (realmGet$update_time != null) {
                Table.nativeSetString(j2, aVar.f6891j, createRowWithPrimaryKey, realmGet$update_time, false);
            }
            String realmGet$sort = dsItemBean.realmGet$sort();
            if (realmGet$sort != null) {
                Table.nativeSetString(j2, aVar.f6892k, createRowWithPrimaryKey, realmGet$sort, false);
            }
            String realmGet$status = dsItemBean.realmGet$status();
            if (realmGet$status != null) {
                Table.nativeSetString(j2, aVar.f6893l, createRowWithPrimaryKey, realmGet$status, false);
            }
            String realmGet$view = dsItemBean.realmGet$view();
            if (realmGet$view != null) {
                Table.nativeSetString(j2, aVar.f6894m, createRowWithPrimaryKey, realmGet$view, false);
            }
    ...
    public static long insertOrUpdate(x xVar, DsItemBean dsItemBean, Map<e0, Long> map) {
        ...
        String realmGet$title = dsItemBean.realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(j2, aVar.f6888g, j4, realmGet$title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6888g, j4, false);
        }
        String realmGet$lanmu_id = dsItemBean.realmGet$lanmu_id();
        if (realmGet$lanmu_id != null) {
            Table.nativeSetString(j2, aVar.f6889h, j4, realmGet$lanmu_id, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6889h, j4, false);
        }
        String realmGet$create_time = dsItemBean.realmGet$create_time();
        if (realmGet$create_time != null) {
            Table.nativeSetString(j2, aVar.f6890i, j4, realmGet$create_time, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6890i, j4, false);
        }
        String realmGet$update_time = dsItemBean.realmGet$update_time();
        if (realmGet$update_time != null) {
            Table.nativeSetString(j2, aVar.f6891j, j4, realmGet$update_time, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6891j, j4, false);
        }
        String realmGet$sort = dsItemBean.realmGet$sort();
        if (realmGet$sort != null) {
            Table.nativeSetString(j2, aVar.f6892k, j4, realmGet$sort, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6892k, j4, false);
        }
        String realmGet$status = dsItemBean.realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(j2, aVar.f6893l, j4, realmGet$status, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6893l, j4, false);
        }
        String realmGet$view = dsItemBean.realmGet$view();
        if (realmGet$view != null) {
            Table.nativeSetString(j2, aVar.f6894m, j4, realmGet$view, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6894m, j4, false);
        }
        String realmGet$image = dsItemBean.realmGet$image();
        if (realmGet$image != null) {
    ...
    public static com_comeback_data_ui_ds_bean_DsItemBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6361f.a(DsItemBean.class);
    ...
    public static DsItemBean update(x xVar, a aVar, DsItemBean dsItemBean, DsItemBean dsItemBean2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6392j.e(DsItemBean.class), aVar.f6886e, set);
        osObjectBuilder.g(aVar.f6887f, dsItemBean2.realmGet$id());
        osObjectBuilder.g(aVar.f6888g, dsItemBean2.realmGet$title());
        osObjectBuilder.g(aVar.f6889h, dsItemBean2.realmGet$lanmu_id());
        osObjectBuilder.g(aVar.f6890i, dsItemBean2.realmGet$create_time());
        osObjectBuilder.g(aVar.f6891j, dsItemBean2.realmGet$update_time());
        osObjectBuilder.g(aVar.f6892k, dsItemBean2.realmGet$sort());
        osObjectBuilder.g(aVar.f6893l, dsItemBean2.realmGet$status());
        osObjectBuilder.g(aVar.f6894m, dsItemBean2.realmGet$view());
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_ds_bean_dsitembeanrealmproxy.proxyState.f6382e.b.f6272c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6380c.d().j();
            String j3 = com_comeback_data_ui_ds_bean_dsitembeanrealmproxy.proxyState.f6380c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6380c.l() == com_comeback_data_ui_ds_bean_dsitembeanrealmproxy.proxyState.f6380c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$cjid() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.y);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$cjname() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.A);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$cjstatus() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.z);
    }
    ...
    public String realmGet$cover() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.H);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$create_time() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6890i);
    }
    ...
    public String realmGet$diyu_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.u);
    }
    ...
    public String realmGet$h() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.L);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6887f);
    }
    ...
    public String realmGet$isfree() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.x);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$ishot() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.I);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$isjingpin() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.F);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$isnew() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.K);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$issole() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.J);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$keyword() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.B);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$lanmu_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6889h);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$last_chapter() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.E);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$last_chapter_title() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.C);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$mark() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.r);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$mhstatus() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.v);
    }
    ...
    public String realmGet$searchnums() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.D);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$sort() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6892k);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$status() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6893l);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$ticai_id() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.s);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$title() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6888g);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$tjswitch() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.w);
    }
    ...
    public String realmGet$update_time() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6891j);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$view() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.f6894m);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$vipcanread() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.M);
    }

    @Override // com.comeback.data.ui.ds.bean.DsItemBean, g.a.r0
    public String realmGet$xianmian() {
        this.proxyState.f6382e.f();
        return this.proxyState.f6380c.q(this.columnInfo.G);
    }
    ...
    public void realmSet$cjid(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.y);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.y, str);
        }
    }
    ...
    public void realmSet$cjname(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.A);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.A, str);
        }
    }
    ...
    public void realmSet$cjstatus(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.z);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.z, str);
        }
    }
    ...
    public void realmSet$cover(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.H);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.H, str);
        }
    }
    ...
    public void realmSet$create_time(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6890i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6890i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6890i);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6890i, str);
        }
    }
    ...
    public void realmSet$diyu_id(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.u);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.u, str);
        }
    }
    ...
    public void realmSet$h(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.L);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.L, str);
        }
    }
    ...
    public void realmSet$isfree(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.x);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.x, str);
        }
    }
    ...
    public void realmSet$ishot(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.I);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.I, str);
        }
    }
    ...
    public void realmSet$isjingpin(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.F);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.F, str);
        }
    }
    ...
    public void realmSet$isnew(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.K);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.K, str);
        }
    }
    ...
    public void realmSet$issole(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.J);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.J, str);
        }
    }
    ...
    public void realmSet$keyword(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.B);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.B, str);
        }
    }
    ...
    public void realmSet$lanmu_id(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6889h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6889h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6889h);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6889h, str);
        }
    }
    ...
    public void realmSet$last_chapter(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.E);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.E, str);
        }
    }
    ...
    public void realmSet$last_chapter_title(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.C);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.C, str);
        }
    }
    ...
    public void realmSet$mark(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.r);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.r, str);
        }
    }
    ...
    public void realmSet$mhstatus(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.v);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.v, str);
        }
    }
    ...
    public void realmSet$searchnums(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.D);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.D, str);
        }
    }
    ...
    public void realmSet$sort(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6892k, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6892k, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6892k);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6892k, str);
        }
    }
    ...
    public void realmSet$status(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6893l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6893l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6893l);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6893l, str);
        }
    }
    ...
    public void realmSet$ticai_id(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.s);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.s, str);
        }
    }
    ...
    public void realmSet$title(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6888g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6888g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6888g);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6888g, str);
        }
    }
    ...
    public void realmSet$tjswitch(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.w);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.w, str);
        }
    }
    ...
    public void realmSet$update_time(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6891j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6891j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6891j);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6891j, str);
        }
    }
    ...
    public void realmSet$view(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6383f) {
                p pVar = vVar.f6380c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6894m, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6894m, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.f6894m);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.f6894m, str);
        }
    }
    ...
    public void realmSet$vipcanread(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.M);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.M, str);
        }
    }
    ...
    public void realmSet$xianmian(String str) {
        ...
        vVar.f6382e.f();
        if (str == null) {
            this.proxyState.f6380c.f(this.columnInfo.G);
        } else {
            this.proxyState.f6380c.a(this.columnInfo.G, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(dsItemBean2)) {
                if (dsItemBean2 instanceof n) {
                    ...
                    if (nVar.realmGet$proxyState().f6382e != null && nVar.realmGet$proxyState().f6382e.b.f6272c.equals(xVar.b.f6272c)) {
                        map.put(dsItemBean2, Long.valueOf(nVar.realmGet$proxyState().f6380c.l()));
                    }
                }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(dsItemBean2)) {
                ...
                if (realmGet$update_time != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6891j, createRowWithPrimaryKey, false);
                }
                String realmGet$sort = dsItemBean.realmGet$sort();
                if (realmGet$sort != null) {
                    Table.nativeSetString(j2, aVar.f6892k, createRowWithPrimaryKey, realmGet$sort, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6892k, createRowWithPrimaryKey, false);
                }
                String realmGet$status = dsItemBean.realmGet$status();
                if (realmGet$status != null) {
                    Table.nativeSetString(j2, aVar.f6893l, createRowWithPrimaryKey, realmGet$status, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6893l, createRowWithPrimaryKey, false);
                }
                String realmGet$view = dsItemBean.realmGet$view();
                if (realmGet$view != null) {
                    Table.nativeSetString(j2, aVar.f6894m, createRowWithPrimaryKey, realmGet$view, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6894m, createRowWithPrimaryKey, false);
                }
                String realmGet$image = dsItemBean.realmGet$image();
                if (realmGet$image != null) {
                    Table.nativeSetString(j2, aVar.n, createRowWithPrimaryKey, realmGet$image, false);
