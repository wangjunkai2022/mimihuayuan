...
public class SmartRefreshLayout extends ViewGroup implements f.j.a.a.f.i, NestedScrollingParent {
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (smartRefreshLayout.b == 0 && (bVar = smartRefreshLayout.y0) != (bVar2 = f.j.a.a.g.b.None) && !bVar.f6204e && !bVar.f6203d) {
    ...
    public class f implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ boolean f2454d;
            ...
            if (this.a == 0) {
                ...
                if (smartRefreshLayout.y0 == f.j.a.a.g.b.None && smartRefreshLayout.z0 == f.j.a.a.g.b.Refreshing) {
                    ...
                    if (smartRefreshLayout2.K0 != null) {
                        ...
                        if (bVar.a && (bVar.f6203d || bVar == f.j.a.a.g.b.RefreshReleased)) {
                            SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
                    ...
                    if (smartRefreshLayout4.y0 == f.j.a.a.g.b.Refreshing && smartRefreshLayout4.s0 != null && smartRefreshLayout4.u0 != null) {
                        ...
                        if (this.f2453c == Boolean.FALSE) {
                            SmartRefreshLayout.this.u(false);
                        }
                    }
                }
                if (this.f2453c == Boolean.TRUE) {
            ...
            if (i2 < Integer.MAX_VALUE) {
                ...
                if (smartRefreshLayout7.n || smartRefreshLayout7.e0) {
                    ...
                    if (smartRefreshLayout8.n) {
                        float f2 = smartRefreshLayout8.f2450k;
                        smartRefreshLayout8.f2448i = f2;
                        smartRefreshLayout8.f2443d = 0;
                        smartRefreshLayout8.n = false;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, smartRefreshLayout8.f2449j, (f2 + smartRefreshLayout8.b) - (smartRefreshLayout8.a * 2), 0));
                        SmartRefreshLayout smartRefreshLayout9 = SmartRefreshLayout.this;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 2, smartRefreshLayout9.f2449j, smartRefreshLayout9.f2450k + smartRefreshLayout9.b, 0));
                    }
                    SmartRefreshLayout smartRefreshLayout10 = SmartRefreshLayout.this;
                    if (smartRefreshLayout10.e0) {
                        smartRefreshLayout10.d0 = 0;
                        SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 1, smartRefreshLayout10.f2449j, smartRefreshLayout10.f2450k, 0));
                        SmartRefreshLayout smartRefreshLayout11 = SmartRefreshLayout.this;
                        smartRefreshLayout11.e0 = false;
                        smartRefreshLayout11.f2443d = 0;
                    }
                }
                ...
                if (i3 <= 0) {
                    if (i3 < 0) {
                        smartRefreshLayout12.g(0, i2, smartRefreshLayout12.y, smartRefreshLayout12.f2445f);
                        return;
                    }
                ...
                ValueAnimator g2 = smartRefreshLayout12.g(0, i2, smartRefreshLayout12.y, smartRefreshLayout12.f2445f);
    ...
    public class g implements Runnable {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ boolean f2456c;

        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ boolean f2457d;
            ...
            public void run() {
                ...
                if (i2 > 0) {
                    ...
                    if (animatorUpdateListener == null && i2 != 0) {
                        if (gVar.f2456c && smartRefreshLayout2.G) {
    ...
    public class h implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public long f2460d = AnimationUtils.currentAnimationTimeMillis();
        ...
        public void run() {
            SmartRefreshLayout smartRefreshLayout = SmartRefreshLayout.this;
            if (smartRefreshLayout.J0 != this || smartRefreshLayout.y0.f6205f) {
                return;
            }
            if (Math.abs(smartRefreshLayout.b) >= Math.abs(this.f2459c)) {
                if (this.f2459c != 0) {
                    int i2 = this.a + 1;
                    this.a = i2;
                    this.f2462f = (float) (Math.pow(0.44999998807907104d, i2 * 2) * this.f2462f);
                } else {
                    int i3 = this.a + 1;
                    this.a = i3;
                    this.f2462f = (float) (Math.pow(0.8500000238418579d, i3 * 2) * this.f2462f);
                }
            } else {
                int i4 = this.a + 1;
                this.a = i4;
                this.f2462f = (float) (Math.pow(0.949999988079071d, i4 * 2) * this.f2462f);
            }
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            float f2 = this.f2462f * ((((float) (currentAnimationTimeMillis - this.f2460d)) * 1.0f) / 1000.0f);
            if (Math.abs(f2) >= 1.0f) {
                this.f2460d = currentAnimationTimeMillis;
                float f3 = this.f2461e + f2;
                this.f2461e = f3;
            ...
            if (bVar.f6203d && bVar.a) {
                ((k) smartRefreshLayout2.x0).d(f.j.a.a.g.b.PullDownCanceled);
            } else {
                SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
                f.j.a.a.g.b bVar2 = smartRefreshLayout3.z0;
                if (bVar2.f6203d && bVar2.b) {
                    ((k) smartRefreshLayout3.x0).d(f.j.a.a.g.b.PullUpCanceled);
                }
            }
            SmartRefreshLayout smartRefreshLayout4 = SmartRefreshLayout.this;
            smartRefreshLayout4.J0 = null;
            if (Math.abs(smartRefreshLayout4.b) >= Math.abs(this.f2459c)) {
                SmartRefreshLayout smartRefreshLayout5 = SmartRefreshLayout.this;
                smartRefreshLayout5.g(this.f2459c, 0, smartRefreshLayout5.y, Math.min(Math.max((int) (Math.abs(SmartRefreshLayout.this.b - this.f2459c) / f.j.a.a.m.b.f6259d), 30), 100) * 10);
            }
        }
    }
    ...
    public class i implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public float f2465d = 0.98f;

        /* renamed from: e  reason: collision with root package name */
        public long f2466e = 0;

        /* renamed from: f  reason: collision with root package name */
        public long f2467f = AnimationUtils.currentAnimationTimeMillis();
        ...
        public void run() {
            ...
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            float pow = (float) (Math.pow(this.f2465d, ((float) (currentAnimationTimeMillis - this.f2466e)) / (1000.0f / this.b)) * this.f2464c);
            this.f2464c = pow;
            float f2 = ((((float) (currentAnimationTimeMillis - this.f2467f)) * 1.0f) / 1000.0f) * pow;
            if (Math.abs(f2) > 1.0f) {
                ...
                f.j.a.a.m.b.e(((f.j.a.a.j.a) SmartRefreshLayout.this.u0).f6233c, (int) (-this.f2464c));
                SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
    ...
    public class k implements f.j.a.a.f.h {
        ...
        public ValueAnimator a(int i2) {
            SmartRefreshLayout smartRefreshLayout = SmartRefreshLayout.this;
            return smartRefreshLayout.g(i2, 0, smartRefreshLayout.y, smartRefreshLayout.f2445f);
        }
        ...
        */
        ...
        public f.j.a.a.f.h d(@NonNull f.j.a.a.g.b bVar) {
            switch (bVar.ordinal()) {
                ...
                case 1:
                    SmartRefreshLayout smartRefreshLayout2 = SmartRefreshLayout.this;
                    if (!smartRefreshLayout2.y0.f6204e && smartRefreshLayout2.o(smartRefreshLayout2.A)) {
                ...
                case 2:
                    ...
                    if (smartRefreshLayout3.o(smartRefreshLayout3.B)) {
                        ...
                        if (!bVar4.f6204e && !bVar4.f6205f && (!smartRefreshLayout4.S || !smartRefreshLayout4.G || !smartRefreshLayout4.T)) {
                ...
                case 3:
                    SmartRefreshLayout smartRefreshLayout5 = SmartRefreshLayout.this;
                    if (!smartRefreshLayout5.y0.f6204e && smartRefreshLayout5.o(smartRefreshLayout5.A)) {
                ...
                case 4:
                    ...
                    if (smartRefreshLayout6.o(smartRefreshLayout6.B)) {
                        SmartRefreshLayout smartRefreshLayout7 = SmartRefreshLayout.this;
                        if (!smartRefreshLayout7.y0.f6204e && (!smartRefreshLayout7.S || !smartRefreshLayout7.G || !smartRefreshLayout7.T)) {
                ...
                case 5:
                    SmartRefreshLayout smartRefreshLayout8 = SmartRefreshLayout.this;
                    if (!smartRefreshLayout8.y0.f6204e && smartRefreshLayout8.o(smartRefreshLayout8.A)) {
                ...
                case 6:
                    ...
                    if (smartRefreshLayout9.o(smartRefreshLayout9.B)) {
                        ...
                        if (!bVar5.f6204e && !bVar5.f6205f && (!smartRefreshLayout10.S || !smartRefreshLayout10.G || !smartRefreshLayout10.T)) {
                ...
                case 7:
                    SmartRefreshLayout smartRefreshLayout11 = SmartRefreshLayout.this;
                    if (!smartRefreshLayout11.y0.f6204e && smartRefreshLayout11.o(smartRefreshLayout11.A)) {
                ...
                case 9:
                    SmartRefreshLayout smartRefreshLayout12 = SmartRefreshLayout.this;
                    if (!smartRefreshLayout12.y0.f6204e && smartRefreshLayout12.o(smartRefreshLayout12.A)) {
                ...
                case 10:
                    SmartRefreshLayout smartRefreshLayout13 = SmartRefreshLayout.this;
                    if (!smartRefreshLayout13.y0.f6204e && smartRefreshLayout13.o(smartRefreshLayout13.B)) {
    ...
    public SmartRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        f.j.a.a.g.a aVar = f.j.a.a.g.a.f6185c;
        this.j0 = aVar;
        this.l0 = aVar;
        this.o0 = 2.5f;
        this.p0 = 2.5f;
        ...
        this.f2446g = context.getResources().getDisplayMetrics().heightPixels;
        ...
        this.f2451l = obtainStyledAttributes.getFloat(f.j.a.a.d.SmartRefreshLayout_srlDragRate, this.f2451l);
        ...
        this.f2445f = obtainStyledAttributes.getInt(f.j.a.a.d.SmartRefreshLayout_srlReboundDuration, this.f2445f);
        ...
        this.j0 = obtainStyledAttributes.hasValue(f.j.a.a.d.SmartRefreshLayout_srlHeaderHeight) ? f.j.a.a.g.a.f6191i : this.j0;
        this.l0 = obtainStyledAttributes.hasValue(f.j.a.a.d.SmartRefreshLayout_srlFooterHeight) ? f.j.a.a.g.a.f6191i : this.l0;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x00c6, code lost:
        if (r4.f6205f == false) goto L64;
     */
    /* JADX WARN: Code restructure failed: missing block: B:67:0x00cc, code lost:
        if (r21.y0.a == false) goto L64;
     */
    /* JADX WARN: Code restructure failed: missing block: B:73:0x00da, code lost:
        if (r4.f6205f == false) goto L72;
     */
    ...
    */
        ...
        if (gVar != null && gVar.getView() == view) {
            ...
            if (view2 != null) {
                ...
                if (i2 != 0 && (paint2 = this.v0) != null) {
                    paint2.setColor(i2);
                    if (this.s0.getSpinnerStyle().f6213c) {
                        max = view.getBottom();
                    } else if (this.s0.getSpinnerStyle() == f.j.a.a.g.c.f6207d) {
                        max = view.getBottom() + this.b;
                    }
                    canvas.drawRect(0.0f, view.getTop(), getWidth(), max, this.v0);
                }
                if (this.C && this.s0.getSpinnerStyle() == f.j.a.a.g.c.f6209f) {
                    canvas.save();
        ...
        if (gVar2 != null && gVar2.getView() == view) {
            ...
            if (view2 != null) {
                ...
                if (i3 != 0 && (paint = this.v0) != null) {
                    paint.setColor(i3);
                    if (this.t0.getSpinnerStyle().f6213c) {
                        min = view.getTop();
                    } else if (this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6207d) {
                        min = view.getTop() + this.b;
                    }
                    canvas.drawRect(0.0f, min, getWidth(), view.getBottom(), this.v0);
                }
                if (this.D && this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6209f) {
                    canvas.save();
    ...
    public boolean n(int i2) {
        if (i2 == 0) {
            if (this.K0 != null) {
                ...
                if (bVar.f6205f || bVar == f.j.a.a.g.b.TwoLevelReleased) {
                    return true;
                }
    ...
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            if (aVar3 != null) {
                aVar3.f6239i.b = null;
                ((f.j.a.a.j.a) dVar).f6239i.f6240c = this.O;
                ...
                if (viewGroup2 != null) {
                    aVar4.f6233c = viewGroup2;
                }
                if (findViewById != null || findViewById2 != null) {
                    aVar4.f6234d = findViewById;
                    aVar4.f6235e = findViewById2;
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8 && childAt.getTag(f.j.a.a.c.srl_component_falsify) != childAt) {
                ...
                if (gVar != null && gVar.getView() == childAt) {
                    ...
                    if (!z4 && this.s0.getSpinnerStyle() == f.j.a.a.g.c.f6207d) {
                        int i13 = this.i0;
                        i12 -= i13;
                        measuredHeight2 -= i13;
                    }
                ...
                if (gVar2 != null && gVar2.getView() == childAt) {
                    ...
                    if (this.S && this.T && this.G && this.u0 != null && this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6207d && o(this.B)) {
                        View view4 = ((f.j.a.a.j.a) this.u0).a;
                        ViewGroup.LayoutParams layoutParams4 = view4.getLayoutParams();
                        measuredHeight3 = view4.getMeasuredHeight() + paddingTop + paddingTop + (layoutParams4 instanceof ViewGroup.MarginLayoutParams ? ((ViewGroup.MarginLayoutParams) layoutParams4).topMargin : 0);
                    }
                    if (spinnerStyle == f.j.a.a.g.c.f6211h) {
                        measuredHeight3 = marginLayoutParams3.topMargin - this.n0;
                    } else {
                        if (!z2 && spinnerStyle != f.j.a.a.g.c.f6210g && spinnerStyle != f.j.a.a.g.c.f6209f) {
                            if (spinnerStyle.f6213c && this.b < 0) {
    ...
    */
    ...
    public void onNestedScroll(@NonNull View view, int i2, int i3, int i4, int i5) {
        ...
        if ((i6 < 0 && (this.A || this.J)) || (i6 > 0 && (this.B || this.J))) {
            ...
            if (bVar == f.j.a.a.g.b.None || bVar.f6204e) {
    ...
    public boolean p(boolean z, f.j.a.a.f.g gVar) {
        return z || this.L || gVar == null || gVar.getSpinnerStyle() == f.j.a.a.g.c.f6209f;
    }

    public void q(float f2) {
        f.j.a.a.g.b bVar;
        float f3 = (!this.e0 || this.O || f2 >= 0.0f || ((f.j.a.a.j.a) this.u0).a()) ? f2 : 0.0f;
        if (f3 > this.f2446g * 5 && getTag() == null) {
        ...
        if (this.y0 == f.j.a.a.g.b.TwoLevel && f3 > 0.0f) {
            ...
            if (f3 < i2) {
                ...
                int max = Math.max((this.f2446g * 4) / 3, getHeight());
                int i3 = this.i0;
                double d3 = max - i3;
                double max2 = Math.max(0.0f, (f3 - i3) * this.f2451l);
                double d4 = -max2;
                if (d3 == 0.0d) {
                    d3 = 1.0d;
                }
            ...
            if (f3 > (-i4)) {
                ...
                int max3 = Math.max((this.f2446g * 4) / 3, getHeight());
                int i5 = this.k0;
                double d6 = max3 - i5;
                double d7 = -Math.min(0.0f, (i5 + f3) * this.f2451l);
                double d8 = -d7;
                if (d6 == 0.0d) {
                    d6 = 1.0d;
                }
            ...
            double max4 = Math.max(this.f2446g / 2, getHeight());
            double max5 = Math.max(0.0f, this.f2451l * f3);
            double d10 = -max5;
            if (max4 == 0.0d) {
                max4 = 1.0d;
            }
            ...
            double max6 = Math.max(this.f2446g / 2, getHeight());
            double d12 = -Math.min(0.0f, this.f2451l * f3);
            double d13 = -d12;
            if (max6 == 0.0d) {
                max6 = 1.0d;
            }
        ...
        this.w0.postDelayed(new e(), this.f2445f);
    }
        ...
        if (bVar == f.j.a.a.g.b.TwoLevel) {
            if (this.v > -1000 && this.b > getMeasuredHeight() / 2) {
                ...
                if (smartRefreshLayout.y0 == f.j.a.a.g.b.TwoLevel) {
                    ...
                    kVar.a(0).setDuration(SmartRefreshLayout.this.f2444e);
                }
            }
    ...
    public void setViceState(f.j.a.a.g.b bVar) {
        f.j.a.a.g.b bVar2 = this.y0;
        if (bVar2.f6203d && bVar2.a != bVar.a) {
            r(f.j.a.a.g.b.None);
        }
        if (this.z0 != bVar) {
            this.z0 = bVar;
        ...
        if (this.y0 == f.j.a.a.g.b.Refreshing && z) {
            ...
            if (gVar instanceof f.j.a.a.f.e) {
                if (((f.j.a.a.f.e) gVar).d(z)) {
                    this.T = true;
                    if (this.S && this.G && this.b > 0 && this.t0.getSpinnerStyle() == f.j.a.a.g.c.f6207d && o(this.B) && p(this.A, this.s0)) {
    ...
    public static class j extends ViewGroup.MarginLayoutParams {
        ...
        public j(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(f.j.a.a.d.SmartRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                this.b = f.j.a.a.g.c.f6212i[obtainStyledAttributes.getInt(f.j.a.a.d.SmartRefreshLayout_Layout_layout_srlSpinnerStyle, f.j.a.a.g.c.f6207d.a)];
            }
            obtainStyledAttributes.recycle();
        }
