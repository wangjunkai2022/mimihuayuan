...
public class VTitleAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public MenuBean.ResponseEntity f1857c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            SearchResultActivity.n(vTitleAdapter.a, vTitleAdapter.f1857c.getSearch());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        bVar.a.setText(this.f1857c.getTitle());
        bVar.b.setVisibility(TextUtils.isEmpty(this.f1857c.getSearch()) ? 8 : 0);
