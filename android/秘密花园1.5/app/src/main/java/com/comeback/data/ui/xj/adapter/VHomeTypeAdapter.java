...
public class VHomeTypeAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        aVar.f2304c.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.e.j
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VHomeTypeAdapter.this.f(view);
            }
        });
        aVar.f2305d.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.e.g
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VHomeTypeAdapter.this.g(view);
            }
        });
        aVar.f2306e.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.e.i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VHomeTypeAdapter.this.h(view);
            }
        });
        aVar.f2307f.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.e.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VHomeTypeAdapter.this.i(view);
            }
        });
        aVar.f2308g.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.e.h
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VHomeTypeAdapter.this.j(view);
            }
        });
        aVar.f2309h.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.s0.e.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
