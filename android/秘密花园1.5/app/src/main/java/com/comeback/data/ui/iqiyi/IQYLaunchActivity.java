...
public class IQYLaunchActivity extends BaseActivity {
    ...
    public static String[] f1201f = {e.a("XxYXFFFcFlIDDxoGCAMIHlYLEAwEBgodEAlZ"), e.a("XxYXFFFcFlIDDxoGCAMIHlYLEAwEBgsdEAlZ"), e.a("XxYXFFFcFlIDDxoGCAMIHlYLEAwEBg0dEAlZ")};
    public b0 b;
    ...
    public ArrayList<f> f1202c = new ArrayList<>();

    /* renamed from: e  reason: collision with root package name */
    public g f1204e = new a();
    ...
    public class a implements g {
        ...
        public void c(f fVar, h0 h0Var) {
            if (h0Var.f6524e > 300) {
                if (IQYLaunchActivity.this.f1202c.size() == 1) {
                    IQYLaunchActivity.this.l(IQYLaunchActivity.f1201f);
                    return;
                }
                return;
            }
            Iterator<f> it = IQYLaunchActivity.this.f1202c.iterator();
            while (it.hasNext()) {
                it.next().cancel();
            }
            IQYLaunchActivity iQYLaunchActivity = IQYLaunchActivity.this;
            if (iQYLaunchActivity.f1203d) {
                return;
            }
            iQYLaunchActivity.f1203d = true;
            String replace = fVar.S().b.f6854j.replace(e.a("GAAKAwoDUBwSFkRICAMNDAg9FQEZAFBcHVsFSUxMPA9SFAoHDk5YXRcUWw4c"), "");
            b.v = replace;
