...
public class SearchActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ SearchActivity f971c;

        public a(SearchActivity_ViewBinding searchActivity_ViewBinding, SearchActivity searchActivity) {
            this.f971c = searchActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            this.f971c.etSearch.setText("");
        }
    }
    ...
    public void a() {
        SearchActivity searchActivity = this.f969c;
        if (searchActivity != null) {
            this.f969c = null;
            searchActivity.etSearch = null;
            searchActivity.ivCancel = null;
            searchActivity.rvRecommend = null;
            this.f970d.setOnClickListener(null);
            this.f970d = null;
            super.a();
            return;
        }
