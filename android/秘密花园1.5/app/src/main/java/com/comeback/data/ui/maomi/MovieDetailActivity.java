...
public class MovieDetailActivity extends BaseActivity {
    ...
    public class a extends j<VideoDetail> {
        ...
        public void f(VideoDetail videoDetail) {
            ...
            MovieDetailActivity.this.f1612c.setPlayUri(videoItemBean.getFile());
            MovieDetailActivity.this.f1612c.startPlayer();
            h.h1(MovieDetailActivity.this.f1612c.getVideoPlayerView(), videoItemBean.getFile());
        }
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1612c.onConfigurationChanged(configuration);
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        this.f1612c.onDestroy();
        super.onDestroy();
    }
