...
public class Rang2Fragment extends BaseFragment {
    ...
    @Override // com.comeback.data.base.BaseFragment
    public void e() {
        g(f.e.a.j.l.h.f.b().e(h(f.e.a.e.a("VhQ8Ax4aXVY="))), new a());
        g(f.e.a.j.l.h.f.b().c(h(f.e.a.e.a("VgEXCxk="))), new b());
        g(f.e.a.j.l.h.f.b().e(h(f.e.a.e.a("WQcU"))), new c());
        g(f.e.a.j.l.h.f.b().e(h(f.e.a.e.a("WBAKAwIdWF8sEF0DHQUQ"))), new d());
        g(f.e.a.j.l.h.f.b().e(h(f.e.a.e.a("QgwACx0WSw=="))), new e());
        g(f.e.a.j.l.h.f.b().e(h(f.e.a.e.a("VA0VARk="))), new f());
    }
