...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
    ...
    */
    public final java.lang.Object instantiateItem(android.view.ViewGroup r6, int r7) {
        ...
        L16:
            if (r0 < 0) goto L25
            android.util.SparseArray<android.view.View>[] r2 = r2.f3961d
            int r3 = r2.length
            if (r0 < r3) goto L1e
            goto L25
        L1e:
        ...
        L26:
            ...
            goto L44
        L32:
            android.view.LayoutInflater r0 = r2.f1888d
        ...
        L56:
            if (r7 < 0) goto L67
            java.util.ArrayList<T> r4 = r2.f1887c
            int r4 = r4.size()
            if (r7 < r4) goto L61
            goto L67
        L61:
            java.util.ArrayList<T> r1 = r2.f1887c
    ...
    public void notifyDataSetChanged() {
        a aVar = this.a;
        View[] viewArr = aVar.a;
        int[] iArr = aVar.f3962e;
        boolean z = aVar.f3960c > 1;
        ...
        int i3 = aVar.f3960c;
        SparseArray<View>[] sparseArrayArr = aVar.f3961d;
