...
public class ComicReadActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static String f934i = e.a("");
    public NavBean.DataEntity.ArticleVOSEntity b;

    /* renamed from: c  reason: collision with root package name */
    public ArrayList<ComicDetail.DataEntity.ChaptersEntity> f935c;
    ...
    public class a extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(@NonNull RecyclerView recyclerView, int i2, int i3) {
            ...
            textView.setText(e.a("0M7P") + (comicReadActivity.f940h + 1) + e.a("383+REs=") + (findFirstVisibleItemPosition + 1) + e.a("GA==") + comicReadActivity.f939g.getItemCount());
        }
    }
    ...
    public class b extends j<ComicRead> {
        ...
        public void f(ComicRead comicRead) {
            ...
            ComicReadActivity comicReadActivity = ComicReadActivity.this;
            PicAdapter picAdapter = comicReadActivity.f939g;
            if (picAdapter == null) {
                comicReadActivity.f939g = new PicAdapter(comicReadActivity);
                ...
                comicReadActivity3.rvList.setAdapter(comicReadActivity3.f939g);
            } else {
                picAdapter.c();
            }
            ComicReadActivity.this.f939g.a(comicRead2.getContent().getDataList());
            ComicReadActivity comicReadActivity4 = ComicReadActivity.this;
            comicReadActivity4.f939g.f1026d = comicReadActivity4;
        }
    }
    ...
    public void c(Intent intent) {
        ...
        this.f935c = intent.getParcelableArrayListExtra(e.a("UwMXBQ=="));
        this.f936d = intent.getIntExtra(e.a("RQcQCx4BWlY6Ag=="), 0);
    }
    ...
    public void e() {
        ...
        this.f940h = 0;
        while (true) {
            if (i2 >= this.f935c.size()) {
                break;
            } else if (this.f936d == this.f935c.get(i2).getId()) {
                this.f940h = i2;
                break;
            } else {
                i2++;
    ...
    public final void l() {
        PicAdapter picAdapter = this.f939g;
        if (picAdapter != null) {
            picAdapter.c();
        }
        k(f.e.a.j.n.p.e.b().m(this.f935c.get(this.f940h).getId(), f934i), new b());
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        this.rvChapter.setLayoutManager(linearLayoutManager);
        ChapterAdapter chapterAdapter = new ChapterAdapter(this);
        chapterAdapter.f981e = this.f940h;
        chapterAdapter.f980d = new ChapterAdapter.a() { // from class: f.e.a.j.n.a
        ...
        chapterAdapter.a(this.f935c);
        linearLayoutManager.scrollToPosition(this.f940h);
        TextView textView = this.tvTitle;
        textView.setText(this.b.getNameCn() + e.a("F0KEyMc=") + (this.f940h + 1) + e.a("0MnD"));
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_next /* 2131297003 */:
                if (this.f940h < this.f935c.size() - 1) {
                    this.f940h++;
                    l();
                    return;
                }
