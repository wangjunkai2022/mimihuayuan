...
public class ActorListFragment extends BaseRefreshFragment {
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            ...
            try {
                ArrayList<Actor> a = f.e.a.j.v.e.a.a(g0Var.b.H());
                if (this.a == 1) {
    ...
    public void a() {
        this.f1300i = getArguments().getString(e.a("XgY="));
    }
    ...
    public void l(int i2) {
        ...
        f.b.a.a.a.B(sb, f.e.a.j.v.e.a.a, "GAMAEAQBSg==");
        sb.append(this.f1300i);
        sb.append(e.a("CBICAw5O"));
        sb.append(i2);
        d<i0> b = c.a().b(sb.toString(), b.h0, b.f4045c);
        this.f1301j = b;
        b.X(new a(i2));
    }
