...
public class ComicHAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f2057c;

    /* renamed from: d  reason: collision with root package name */
    public boolean f2058d;

    /* renamed from: e  reason: collision with root package name */
    public int f2059e = new Random().nextInt(1000);
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(ComicHAdapter comicHAdapter, View view) {
            ...
            this.f2060c = (TextView) view.findViewById(R.id.tv_intro);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        if (viewHolder instanceof b) {
            b bVar = (b) viewHolder;
            SLFItemBean sLFItemBean = this.f2057c.get(i2);
            h.N0(sLFItemBean.getImg(), bVar.a, 0);
            bVar.b.setText(sLFItemBean.getName());
            h.k1(bVar.f2060c, sLFItemBean.getDescription());
