...
public class AnchorCardFragment extends BaseFragment {
    ...
    public AnchorList.DataBean f1683g;
    @BindView
    ...
    public void a() {
        if (getArguments() != null) {
            this.f1683g = (AnchorList.DataBean) getArguments().getParcelable(e.a("UwMXBQ=="));
        }
    }
    ...
    @Override // com.comeback.data.base.BaseFragment
    public void f() {
        this.mTvTitle.setText(this.f1683g.getName());
        h.L0(this.f1683g.getAvatar(), this.mIvImg, 6);
    }
}
