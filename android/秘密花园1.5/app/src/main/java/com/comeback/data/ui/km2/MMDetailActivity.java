...
public class MMDetailActivity extends BaseActivity {
    ...
    public class a extends j<MMInfo> {
        ...
        public void f(MMInfo mMInfo) {
            ...
            try {
                ...
                textView2.setText(e.a("0fnXgv3D36TFj6PTl9b5") + h.O0(Integer.valueOf(info.getCreate_at()).intValue() * 1000));
            ...
            mMDetailActivity.tabLayout.addOnTabSelectedListener(new f.e.a.j.y.h(mMDetailActivity));
        }
    }
    ...
    public void c(Intent intent) {
        ...
        this.f1408c = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void e() {
        ...
        try {
            jSONObject.put(e.a("VRAMEAMWVWwaAg=="), this.f1408c);
        } catch (Exception unused) {
        }
        k(d.a().c(f.e.a.j.y.j.a.a(jSONObject)), new a());
    }
}
