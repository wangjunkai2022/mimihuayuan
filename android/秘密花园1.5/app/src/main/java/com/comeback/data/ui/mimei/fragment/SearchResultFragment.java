...
public class SearchResultFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1794i = getArguments().getBoolean(e.a("XhEgCwYaWg=="), true);
        this.f1795j = getArguments().getString(e.a("XAca"));
    }
    ...
    public RecyclerView.LayoutManager i() {
        return new GridLayoutManager(getContext(), this.f1794i ? 3 : 2);
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public void l(int i2) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(e.a("XAcaEwQBXUA="), this.f1795j);
