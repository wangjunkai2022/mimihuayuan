...
public class HotVAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<HotUser.DataEntity.ResultListEntity> f1164c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(HotVAdapter hotVAdapter, View view) {
            ...
            this.f1165c = (TextView) view.findViewById(R.id.tv_desc);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        HotUser.DataEntity.ResultListEntity resultListEntity = this.f1164c.get(i2);
        bVar.b.setText(resultListEntity.getUsername());
        TextView textView = bVar.f1165c;
