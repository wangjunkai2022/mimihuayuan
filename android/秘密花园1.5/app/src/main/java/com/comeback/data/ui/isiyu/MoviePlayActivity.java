...
public class MoviePlayActivity extends BaseActivity {
    ...
    public class a extends j<Video> {
        ...
        public void f(Video video) {
            ...
            MoviePlayActivity.this.f1242c.setPlayUri(video2.getPlay_url_m3u8());
            MoviePlayActivity.this.f1242c.startPlayer();
            h.h1(MoviePlayActivity.this.f1242c.getVideoPlayerView(), video2.getPlay_url_m3u8());
        }
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1242c.onConfigurationChanged(configuration);
    }
