...
public class CatIdActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1983d = intent.getStringExtra(e.a("XgY="));
        this.f1984e = intent.getStringExtra(e.a("VAMXLQ8="));
        this.f1985f = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1986g = intent.getStringExtra(e.a("QxsTAQ=="));
    }
    ...
    public void e() {
        ...
        super.e();
        this.tvTitle.setText(this.f1985f);
    }

    @Override // com.comeback.data.base.BaseRefreshActivity
    public BaseAbstractAdapter l() {
        if (this.f1986g.equals(e.a("Xg8CAw4="))) {
            return new ImageAdapter(this, 0);
        }
        if (this.f1986g.equals(e.a("VAMREAQcVw=="))) {
            return new CartoonAdapter(this);
        }
        if (this.f1986g.equals(e.a("QQsHAQQ="))) {
    ...
    public void p(int i2) {
        ...
        if (!TextUtils.isEmpty(this.f1984e)) {
            rVar.e(e.a("VAMXLQ8="), this.f1984e);
            k(f.e.a.j.l0.h.b.a().d(this.f1986g, d.a(rVar.toString())), new a(i2));
        }
        if (TextUtils.isEmpty(this.f1983d)) {
            return;
        }
        rVar.e(e.a("XgY="), this.f1983d);
        k(f.e.a.j.l0.h.b.a().n(this.f1986g, d.a(rVar.toString())), new b(i2));
    }
}
