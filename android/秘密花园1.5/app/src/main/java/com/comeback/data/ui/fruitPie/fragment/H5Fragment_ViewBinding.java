...
public class H5Fragment_ViewBinding implements Unbinder {
    ...
    public class a extends d.c.b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ H5Fragment f749c;

        public a(H5Fragment_ViewBinding h5Fragment_ViewBinding, H5Fragment h5Fragment) {
            this.f749c = h5Fragment;
        }

        @Override // d.c.b
        public void a(View view) {
            H5Fragment h5Fragment = this.f749c;
            if (TextUtils.isEmpty(h5Fragment.f741i)) {
                return;
            }
            PlayActivity.l(h5Fragment.getContext(), h5Fragment.f741i);
        }
    }
    ...
    public class b extends d.c.b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ H5Fragment f750c;

        public b(H5Fragment_ViewBinding h5Fragment_ViewBinding, H5Fragment h5Fragment) {
            this.f750c = h5Fragment;
        }

        @Override // d.c.b
        public void a(View view) {
            H5Fragment h5Fragment = this.f750c;
            if (h5Fragment.f744l == -1) {
                return;
            }
            ActorDetailActivity.t(h5Fragment.getContext(), h5Fragment.f744l, e.a(h5Fragment.f743k ? "Bg==" : "BQ=="), h5Fragment.f745m);
        }
    }
