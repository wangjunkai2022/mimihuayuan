    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (getClass().getName().equals(e.a("VA0OSggcVFYRB1cMVg4CH1ZMFg1FHlhaHUh5BhEEIghDCxUNHwo="))) {
            try {
                ...
                if (currentTimeMillis - b.a.getLong(e.a("UQsRFx8sTVoeAw=="), -1L) > 259200000) {
        ...
        if (getClass().getName().equals(e.a("VA0OSggcVFYRB1cMVg4CH1ZMFg1FHlhaHUhnAhsYBh9wAxEADh14UAcPQg4MEw=="))) {
            try {
                ...
                if (currentTimeMillis2 - b2.a.getLong(e.a("UQsRFx8sTVoeAw=="), -1L) > 259200000) {
                    UpdateActivity.l(this);
                }
            } catch (Exception e3) {
                e3.printStackTrace();
