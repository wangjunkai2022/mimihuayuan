...
public class SenLinActivity extends BaseVRefreshActivity {
    ...
    public static String f1892h = "";

    /* renamed from: e  reason: collision with root package name */
    public boolean f1893e;

    /* renamed from: f  reason: collision with root package name */
    public SenlinList.ClassEntity f1894f;
    ...
    public class a extends BaseRefreshActivity.a<SenlinList> {
        ...
        public void f(Object obj) {
            ...
            if (this.f1896f == 1) {
                ...
                SenLinActivity.this.f1893e = false;
            }
            SenLinActivity senLinActivity = SenLinActivity.this;
            if (!senLinActivity.f1893e) {
                ...
                c cVar = new c();
                if (TextUtils.isEmpty(senLinActivity.f1895g)) {
                    SenlinList.ClassEntity classEntity = senLinActivity.f1894f;
                    str = classEntity == null ? e.a("0f7jjNTi36jHgKLX") : classEntity.getType_name();
                } else {
                    str = senLinActivity.f1895g;
                }
                senLinActivity.f119d.b(new VTitleAdapter(senLinActivity, str, cVar));
                senLinActivity.f1893e = true;
            }
    ...
    public void p(int i2) {
        ...
        if (TextUtils.isEmpty(this.f1895g)) {
            if (this.f1894f != null) {
                hashMap.put(e.a("Qw=="), String.valueOf(this.f1894f.getType_id()));
            }
        } else {
            hashMap.put(e.a("QAY="), this.f1895g);
        }
