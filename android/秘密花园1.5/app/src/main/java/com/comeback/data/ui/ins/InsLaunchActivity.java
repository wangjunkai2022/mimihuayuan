...
public class InsLaunchActivity extends BaseActivity {
    ...
    public class a extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            webView.loadUrl(str, InsLaunchActivity.this.f1147c);
            return true;
        }
    ...
    public class b extends WebChromeClient {
        ...
        /* renamed from: c  reason: collision with root package name */
        public IX5WebChromeClient.CustomViewCallback f1148c;
        ...
        public void onHideCustomView() {
            IX5WebChromeClient.CustomViewCallback customViewCallback = this.f1148c;
        ...
        public void onShowCustomView(View view, IX5WebChromeClient.CustomViewCallback customViewCallback) {
            ...
            this.a = view;
            this.b = webView;
            this.f1148c = customViewCallback;
        }
    }
    ...
    public final void n() {
        ...
        this.webView.loadUrl(f.e.a.k.b.s0, this.f1147c);
