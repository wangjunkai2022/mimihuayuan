...
public class AMJItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<AMJList.DataBean> f1817c;
    ...
    public class a extends RecyclerView.ViewHolder {
        ...
        public a(AMJItemAdapter aMJItemAdapter, View view) {
            ...
            this.f1819d = (TextView) view.findViewById(R.id.tv_title);
            this.f1818c = (TextView) view.findViewById(R.id.tv_area);
            this.f1820e = (TextView) view.findViewById(R.id.tv_detail);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        final AMJList.DataBean dataBean = this.f1817c.get(i2);
        aVar.f1819d.setText(dataBean.getName());
        h.u0(dataBean.getPic(), aVar.a);
        aVar.b.setText(dataBean.getState());
        aVar.f1818c.setText(dataBean.getType());
        aVar.f1820e.setVisibility(8);
        aVar.itemView.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.g0.g.a
