...
public class AreaChooseActivity extends BaseVRefreshActivity {
    ...
    public static AreaBean f1391f;

    /* renamed from: e  reason: collision with root package name */
    public TagAdapter.b f1392e = new a();
    ...
    public void e() {
        j(-1);
        this.refreshLayout.a0 = new d() { // from class: f.e.a.j.y.a
            @Override // f.j.a.a.l.d
            public final void b(f.j.a.a.f.i iVar) {
                AreaChooseActivity.this.y(iVar);
            }
        };
        this.refreshLayout.v(new f.j.a.a.l.b() { // from class: f.e.a.j.y.b
    ...
    public void p(int i2) {
        ...
        k(f.e.a.j.y.j.d.a().f(f.e.a.j.y.j.a.c(jSONObject)), new b(i2));
    }

    public final void w(String str, List<AreaBean.DataEntity.AreaLisCityEntity.CityEntity> list) {
        this.f119d.b(new AAdapter(this, str, new i()));
        g gVar = new g(4);
        gVar.q(15, 0, 15, 0);
        gVar.D(15);
        gVar.C(15);
        gVar.s = false;
        this.f119d.b(new TagAdapter(this, list, gVar, this.f1392e));
    }
    ...
    public /* synthetic */ void y(f.j.a.a.f.i iVar) {
        this.b = 0;
        int i2 = 0 + 1;
        this.b = i2;
        p(i2);
    ...
    public /* synthetic */ void z(f.j.a.a.f.i iVar) {
        int i2 = this.b + 1;
        this.b = i2;
        p(i2);
    }
