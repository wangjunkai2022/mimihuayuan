...
public class ActorDetailActivity extends BaseRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<VideoList> {
        ...
        public final /* synthetic */ int f1467f;
    ...
    public void c(Intent intent) {
        this.f1466d = (LActorsBean) intent.getParcelableExtra(e.a("UwMXBQ=="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.z0(this.f1466d.getActor_url(), this.ivHead);
        this.tvName.setText(this.f1466d.getActor_name());
        if (g.d(this.f1466d.getRealm()).b(this.f1466d.getClass(), e.a("VgEXCxksUFc="), this.f1466d.getActor_id())) {
            t();
        }
    }
    ...
    public void p(int i2) {
        b a2 = d.a();
        String actor_id = this.f1466d.getActor_id();
