...
public class NComic3Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<NavBean.DataEntity.ArticleVOSEntity> f1017c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(NComic3Adapter nComic3Adapter, View view) {
            ...
            this.f1018c = (TextView) view.findViewById(R.id.tv_intro);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        NavBean.DataEntity.ArticleVOSEntity articleVOSEntity = this.f1017c.get(i2);
        h.u0(articleVOSEntity.getCoverH(), bVar.a);
        bVar.f1018c.setText(articleVOSEntity.getInfo());
