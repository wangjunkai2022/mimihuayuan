...
public class VideoDetailActivity extends BaseRefreshActivity implements ChapterAdapter.a {
    ...
    public SenlinDetail.ListEntity f1898d;
    ...
    public static void r(VideoDetailActivity videoDetailActivity, SenlinDetail senlinDetail) {
        if (videoDetailActivity != null) {
            if (senlinDetail.getList() != null && senlinDetail.getList().size() != 0) {
                ...
                videoDetailActivity.f1898d = listEntity;
                videoDetailActivity.mTvTitle.setText(listEntity.getVod_name());
                videoDetailActivity.mTvDetail.setText(videoDetailActivity.f1898d.getVod_content());
                h.u0(videoDetailActivity.f1898d.getVod_pic(), videoDetailActivity.mIvBg);
                videoDetailActivity.f114c.a(videoDetailActivity.f1898d.getVod_play_urlList());
                return;
            }
    ...
    public void c(Intent intent) {
        this.f1899e = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void p(int i2) {
        ...
        hashMap.put(a.i("UwcXBQIf", hashMap, e.a("VgE="), "XgYQ"), this.f1899e);
