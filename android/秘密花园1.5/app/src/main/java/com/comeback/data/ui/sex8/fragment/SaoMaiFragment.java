...
public class SaoMaiFragment extends BaseRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<YXNovelList> {
        ...
        public void f(Object obj) {
            ...
            if (this.f1949f == 1) {
                SaoMaiFragment.this.f117h.c();
            }
            SaoMaiFragment.this.f117h.a(yXNovelList.getData());
        }
    }
    ...
    public void l(int i2) {
        ...
        yXParams.setCategory(e.a("RwMQFwIcV2weD1c="));
