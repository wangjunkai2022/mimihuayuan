...
public class ScreenActivity extends BaseRefreshActivity {
    ...
    public TabLayout.OnTabSelectedListener f787f = new a();
    @BindView
    ...
    public void c(Intent intent) {
        this.f785d = intent.getIntExtra(e.a("XgwHARM="), 0);
        this.f786e = intent.getStringExtra(e.a("QxsTAQ=="));
    }
    ...
    public void e() {
        ...
        this.tab1.addOnTabSelectedListener(this.f787f);
        this.tab2.addOnTabSelectedListener(this.f787f);
        super.e();
        String str = "";
        if (this.f786e.equals(e.a("QgwACx0WSw=="))) {
            int i2 = this.f785d;
            if (i2 == 0) {
                str = e.a("0f7jgv3D");
            } else if (i2 == 17) {
    ...
    public void p(int i2) {
        ...
        hashMap.put(e.a("QxsTAQ=="), this.f786e);
