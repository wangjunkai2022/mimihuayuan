...
public class ShortActivity extends BaseActivity {
    ...
    public ShortVideoAdapter f2284d;
    @BindView
    ...
    public class a extends PagerSnapHelper {
        ...
        public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i2, int i3) {
            ...
            ShortActivity.this.f2284d.f2299d = findTargetSnapPosition;
    ...
    public void c(Intent intent) {
        ...
        this.f2283c = intent.getIntExtra(e.a("XgwHARM="), 0);
    }
    ...
    public void e() {
        ...
        this.f2284d = shortVideoAdapter;
        shortVideoAdapter.f2299d = this.f2283c;
        this.mRvList.setAdapter(shortVideoAdapter);
        this.f2284d.a(this.b);
        linearLayoutManager.scrollToPosition(this.f2283c);
    }
