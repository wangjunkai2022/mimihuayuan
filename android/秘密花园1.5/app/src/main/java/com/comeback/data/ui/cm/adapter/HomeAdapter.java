...
public class HomeAdapter extends BaseHeaderAdapter<HomeBean.RescontEntity> {
    ...
    public static class HeadHolder extends BaseViewHolder<String> {
        ...
        public void onClick(View view) {
            int i2;
            switch (view.getId()) {
                case R.id.tv_1 /* 2131296910 */:
                    i2 = 28;
                    break;
                case R.id.tv_2 /* 2131296911 */:
                    i2 = 57;
                    break;
                case R.id.tv_3 /* 2131296912 */:
                    i2 = 30;
                    break;
                case R.id.tv_4 /* 2131296913 */:
                    i2 = 33;
                    break;
                case R.id.tv_5 /* 2131296914 */:
                    i2 = 59;
                    break;
                case R.id.tv_6 /* 2131296915 */:
                    i2 = 65;
                    break;
                case R.id.tv_7 /* 2131296916 */:
                    i2 = 58;
                    break;
                default:
                    i2 = 0;
    ...
    public static class Holder extends BaseViewHolder<HomeBean.RescontEntity> {
        ...
        public void a(HomeBean.RescontEntity rescontEntity) {
            ...
            this.llVideo4.setVisibility(list.size() >= 1 ? 0 : 8);
            if (list.size() >= 4) {
