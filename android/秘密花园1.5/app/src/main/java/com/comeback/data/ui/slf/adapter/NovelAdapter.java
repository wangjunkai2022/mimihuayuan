...
public class NovelAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f2083c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(NovelAdapter novelAdapter, View view) {
            ...
            this.f2084c = (TextView) view.findViewById(R.id.tv_view);
            this.f2085d = (TextView) view.findViewById(R.id.tv_collect);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        SLFItemBean sLFItemBean = this.f2083c.get(i2);
        bVar.a.setText(sLFItemBean.getName());
        h.k1(bVar.b, sLFItemBean.getDescription());
        bVar.f2084c.setText(sLFItemBean.getClick());
        bVar.f2085d.setText(sLFItemBean.getFavorite());
