...
public class VideoList2Fragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1509i = getArguments().getInt(e.a("XgY="), 0);
        this.f1510j = getArguments().getString(e.a("QxsTAQ=="));
        this.f1511k = getArguments().getString(e.a("WBAHARk="));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("WBAHARk="), this.f1511k);
        hashMap.put(f.b.a.a.a.G(this.f1509i, hashMap, e.a("VAMXAQwcS0o="), "QQsHAQQsTUoDAw=="), this.f1510j);
