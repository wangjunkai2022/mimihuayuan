...
public class XJLaunchActivity extends BaseActivity {
    ...
    public static String[] f2290f = {e.a("TwsCCgwLUFIdAVUXCBlNCFgP"), e.a("UBcMAx4cWEMDFRoEFwc="), e.a("TwgQFAoDSUBdBVsK"), e.a("WwMECwoDSUBdBVsK"), e.a("RwsTDQoDSUBdBVsK"), e.a("Xg0QSgkLXkYEA1pJGwUO")};
    public b0 b;
    ...
    public ArrayList<f> f2291c = new ArrayList<>();

    /* renamed from: e  reason: collision with root package name */
    public g f2293e = new a();
    ...
    public class a implements g {
        ...
        public void c(f fVar, h0 h0Var) {
            if (h0Var.f6524e > 300) {
                if (XJLaunchActivity.this.f2291c.size() == 1) {
                    XJLaunchActivity.this.l();
                    return;
                }
                return;
            }
            Iterator<f> it = XJLaunchActivity.this.f2291c.iterator();
            while (it.hasNext()) {
                it.next().cancel();
            }
            XJLaunchActivity xJLaunchActivity = XJLaunchActivity.this;
            if (xJLaunchActivity.f2292d) {
                return;
            }
            xJLaunchActivity.f2292d = true;
            String replace = fVar.S().b.f6854j.replace(e.a("GAUGECwfVlESCnAGDAs="), "");
            b.f4051i = replace;
