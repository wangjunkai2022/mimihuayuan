...
public class Video2Adapter extends BaseAbstractAdapter<VideoList.DataEntity.ListEntity> {
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f725c;
            ...
            public void a(View view) {
                Holder holder = this.f725c;
                DetailActivity.n(holder.a.a, holder.b.getLibrary_id(), holder.a.f723d);
            }
        }
    ...
    public Video2Adapter(Context context, String str) {
        super(context);
        this.f723d = str;
    }
    ...
    public Holder f(@NonNull ViewGroup viewGroup) {
        return new Holder(this.f107c.inflate(R.layout.item_fruit_video, viewGroup, false), this);
    }
