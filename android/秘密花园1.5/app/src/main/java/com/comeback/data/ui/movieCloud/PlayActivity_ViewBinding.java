...
public class PlayActivity_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ PlayActivity f1808c;

        public a(PlayActivity_ViewBinding playActivity_ViewBinding, PlayActivity playActivity) {
            this.f1808c = playActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            PlayActivity playActivity = this.f1808c;
            List<PlayListBean> list = playActivity.f1802e;
            if (list != null && list.size() != 0) {
                ArrayList arrayList = new ArrayList();
                for (PlayListBean playListBean : playActivity.f1802e) {
                    CollectVideo collectVideo = new CollectVideo();
                    collectVideo.setUrl(playListBean.getUri());
                    collectVideo.setName(playActivity.f1803f + e.a("Gg==") + playListBean.getName());
                    collectVideo.setAddTime(System.currentTimeMillis());
                    arrayList.add(collectVideo);
                }
                g d2 = g.d(x.P());
                if (d2 != null) {
                    g.a.N(new h(d2, arrayList));
                    c.a.a.b.g.h.n1(e.a("0fbVjPz837vjg774l9bvj4rChuvEl4KWlvqcjt78isqChPfSg+S21vvx3MbQjtvg39/ejMz10JHi"));
                    return;
                }
                throw null;
            }
            c.a.a.b.g.h.n1(e.a("0ejSgsb61o//g4n0nePug4Lmhd77l4G+lfKbgfTrheKOi+TrjeeP2+Tp29v0gszc0v7Lgvne36fNg63PnuPojr3KhfDdm668"));
        }
    }
