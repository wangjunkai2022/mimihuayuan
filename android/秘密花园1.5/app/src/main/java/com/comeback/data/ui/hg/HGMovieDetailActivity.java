...
public class HGMovieDetailActivity extends BasePlayByIdActivity {
    ...
    public void c(Intent intent) {
        this.f1081d = (f.e.a.j.o.c.a) intent.getSerializableExtra(e.a("RwMRBQY="));
    }
    ...
    public void e() {
        ...
        this.f1082e = new b0();
        e0.a aVar = new e0.a();
        aVar.i(this.f1081d.a);
        Map<String, String> map = this.f1081d.b;
        for (String str : map.keySet()) {
            aVar.c(str, map.get(str));
        }
        ((d0) this.f1082e.a(aVar.b())).W(new f.e.a.j.o.b(this));
        if (TextUtils.isEmpty(this.f1081d.f4007c)) {
            return;
        }
