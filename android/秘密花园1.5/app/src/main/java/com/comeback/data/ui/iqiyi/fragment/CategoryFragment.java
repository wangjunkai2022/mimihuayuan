...
public class CategoryFragment extends BaseRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<ArrayList<VideoInfo>> {
        ...
        public final /* synthetic */ int f1225f;
    ...
    public void a() {
        this.f1223i = getArguments().getString(e.a("XgY="));
        this.f1224j = getArguments().getString(e.a("WBAHARk="));
    }
    ...
    public void l(int i2) {
        g(d.a().b(b.c(this.f1223i, this.f1224j, i2)), new a(i2));
    }
}
