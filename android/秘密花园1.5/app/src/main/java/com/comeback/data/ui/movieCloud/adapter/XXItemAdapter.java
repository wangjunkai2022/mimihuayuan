...
public class XXItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<XXList.DataBean.VodrowsBean> f1828c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(XXItemAdapter xXItemAdapter, View view) {
            ...
            this.f1830d = (TextView) view.findViewById(R.id.tv_title);
            this.f1829c = (TextView) view.findViewById(R.id.tv_area);
            this.f1831e = (TextView) view.findViewById(R.id.tv_detail);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        XXList.DataBean.VodrowsBean vodrowsBean = this.f1828c.get(i2);
        bVar.f1830d.setText(vodrowsBean.getTitle());
        h.u0(vodrowsBean.getCoverpic(), bVar.a);
        bVar.b.setText(vodrowsBean.getScorenum());
        bVar.f1829c.setText(vodrowsBean.getAreaname());
        bVar.f1831e.setText(vodrowsBean.getIntro());
