...
public class HomeTitleAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeData.DataBean f1666c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (HomeTitleAdapter.this.f1666c.isComic()) {
                return;
            }
            HomeTitleAdapter homeTitleAdapter = HomeTitleAdapter.this;
            SpecialDetailActivity.w(homeTitleAdapter.a, homeTitleAdapter.f1666c.getId(), HomeTitleAdapter.this.f1666c.getName(), HomeTitleAdapter.this.f1666c.getDescribe(), HomeTitleAdapter.this.f1666c.getImage());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        bVar.a.setText(this.f1666c.getName());
