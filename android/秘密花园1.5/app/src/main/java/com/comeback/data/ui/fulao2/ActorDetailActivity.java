...
public class ActorDetailActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f766d = (ActorsBean) intent.getParcelableExtra(e.a("VQcCCg=="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.z0(this.f766d.getActor_url(), this.ivHead);
        this.tvName.setText(this.f766d.getActor_name());
        if (g.d(this.f766d.getRealm()).b(this.f766d.getClass(), e.a("VgEXCxksUFc="), this.f766d.getActor_id())) {
            t();
        }
    }
    ...
    public void p(int i2) {
        b b = f.b();
        String actor_id = this.f766d.getActor_id();
