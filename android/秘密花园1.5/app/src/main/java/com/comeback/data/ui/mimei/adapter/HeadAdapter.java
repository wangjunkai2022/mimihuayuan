...
public class HeadAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.tv_like /* 2131296983 */:
                    ComicTypeActivity.n(HeadAdapter.this.a, e.a("RQcACwYeXF0X"), this.a.f1769c.getText().toString(), HeadAdapter.this.f1768c);
                    return;
                case R.id.tv_new /* 2131297002 */:
                    ComicTypeActivity.n(HeadAdapter.this.a, e.a("WQcU"), this.a.a.getText().toString(), HeadAdapter.this.f1768c);
                    return;
                case R.id.tv_rank /* 2131297026 */:
                    ComicTypeActivity.n(HeadAdapter.this.a, e.a("RQMNDwIdXg=="), this.a.b.getText().toString(), HeadAdapter.this.f1768c);
                    return;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(HeadAdapter headAdapter, View view) {
            super(view);
            this.f1770d = (TextView) view.findViewById(R.id.tv_search);
            this.a = (TextView) view.findViewById(R.id.tv_new);
            this.b = (TextView) view.findViewById(R.id.tv_rank);
            this.f1769c = (TextView) view.findViewById(R.id.tv_like);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        bVar.b.setText(e.a(this.f1768c ? "0d7Ig//I373hjpXr" : "0tLsjMTH373hjpXr"));
        bVar.f1769c.setText(e.a(this.f1768c ? "0ezLjObj34/YgaDc" : "0ezLjObj3IP8jpvT"));
        bVar.f1770d.setOnClickListener(aVar);
        bVar.a.setOnClickListener(aVar);
        bVar.b.setOnClickListener(aVar);
        bVar.f1769c.setOnClickListener(aVar);
    }
