...
public class InfoActivity extends BaseActivity {
    ...
    public void e() {
        ...
        if (list != null && list.size() != 0) {
            ...
            if (this.f1326c.length() > 0) {
                StringBuffer stringBuffer2 = this.f1326c;
