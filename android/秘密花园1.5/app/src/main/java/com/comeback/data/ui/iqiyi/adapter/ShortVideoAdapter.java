...
public class ShortVideoAdapter extends BaseAbstractAdapter<VideoInfo> {
    ...
    public static class TiktopHolder extends BaseViewHolder<VideoInfo> {
        ...
        public ExoUserPlayer f1217c;

        /* renamed from: d  reason: collision with root package name */
        public Runnable f1218d;
        @BindView
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                ExoUserPlayer exoUserPlayer = tiktopHolder.f1217c;
                if (exoUserPlayer == null || tiktopHolder.mSeekBar == null || !exoUserPlayer.isPlaying()) {
                    return;
                }
                long currentPosition = TiktopHolder.this.f1217c.getCurrentPosition();
                TiktopHolder tiktopHolder2 = TiktopHolder.this;
                tiktopHolder2.mSeekBar.setProgress((int) ((currentPosition * 1000) / tiktopHolder2.f1217c.getDuration()));
                if (TiktopHolder.this.f1217c.isPlaying()) {
                    TiktopHolder tiktopHolder3 = TiktopHolder.this;
                    tiktopHolder3.mSeekBar.postDelayed(tiktopHolder3.f1218d, 300L);
                }
            }
        }
        ...
        public void a(VideoInfo videoInfo) {
            ...
            this.f1217c.setPlayUri(videoInfo2.getVideoNone());
            ...
            h.F0(videoInfo2.getImg(), this.f1217c.getVideoPlayerView().getPreviewImage(), 1);
            ...
            this.f1217c.addVideoInfoListener(new c(this));
        }

        public /* synthetic */ void b(View view) {
            if (this.f1217c.isPlaying()) {
                this.f1217c.onPause();
            } else {
                c();
            }
        ...
        public final void c() {
            ExoUserPlayer exoUserPlayer = this.f1217c;
            ...
            if (exoUserPlayer.getCurrentPosition() <= 500) {
                ...
                this.f1217c.startPlayer();
                return;
            }
            this.f1217c.onResume();
        }
    }
    ...
    public class TiktopHolder_ViewBinding implements Unbinder {
        ...
        public class a extends d.c.b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ TiktopHolder f1220c;

            public a(TiktopHolder_ViewBinding tiktopHolder_ViewBinding, TiktopHolder tiktopHolder) {
                this.f1220c = tiktopHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                TiktopHolder tiktopHolder = this.f1220c;
