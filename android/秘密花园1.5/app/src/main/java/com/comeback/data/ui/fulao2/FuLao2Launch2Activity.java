...
public class FuLao2Launch2Activity extends BaseActivity {
    ...
    public static void l(FuLao2Launch2Activity fuLao2Launch2Activity) {
        ...
        if (fuLao2Launch2Activity != null) {
            ...
            a0.a aVar = new a0.a();
            aVar.d(a0.f6432h);
            aVar.a(e.a("XwMQDA=="), fuLao2Launch2Activity.f776e);
            ...
            String str2 = fuLao2Launch2Activity.f777f;
            if (str2 != null && !str2.isEmpty()) {
                for (String str3 : fuLao2Launch2Activity.f777f.split(e.a("EQ=="))) {
    ...
    public void e() {
        ...
        this.f774c = random.nextInt(255) + e.a("GQ==") + random.nextInt(255) + e.a("GQ==") + random.nextInt(255) + e.a("GQ==") + random.nextInt(255);
        ...
        this.f775d = hashMap;
        hashMap.put(e.a("T08FCxkEWEEXA1BKHgUR"), this.f774c);
        this.webView.loadUrl(f.e.a.k.b.a, this.f775d);
