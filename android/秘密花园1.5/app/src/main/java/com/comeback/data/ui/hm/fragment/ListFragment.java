...
public class ListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1142i = getArguments().getBoolean(e.a("XhErCQ=="));
        this.f1143j = getArguments().getString(e.a("RBcBDg4QTX0SC1E="), "");
    }
    ...
    public void l(int i2) {
        d<i0> c2 = c.a().c(f.e.a.j.r.f.a.b(i2, this.f1142i, this.f1143j, ""));
        this.f1144k.add(c2);
        c2.X(new a(i2));
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Iterator<d<i0>> it = this.f1144k.iterator();
        while (it.hasNext()) {
            it.next().cancel();
        }
    }
