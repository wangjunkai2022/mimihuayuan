...
public class ComicVAdapter2 extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f2069c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(ComicVAdapter2 comicVAdapter2, View view) {
            ...
            this.f2071c = (TextView) view.findViewById(R.id.tv_intro);
            this.f2072d = (TextView) view.findViewById(R.id.tv_state);
            this.f2073e = (TextView) view.findViewById(R.id.tv_watch);
            this.f2074f = (TextView) view.findViewById(R.id.tv_collect);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        SLFItemBean sLFItemBean = this.f2069c.get(i2);
        h.N0(sLFItemBean.getImg(), bVar.a, 0);
        bVar.b.setText(sLFItemBean.getName());
        h.k1(bVar.f2071c, sLFItemBean.getSummary());
        TextView textView = bVar.f2072d;
        textView.setText(sLFItemBean.getTagStr() + e.a("F01D") + sLFItemBean.getDescription());
        bVar.f2073e.setText(sLFItemBean.getClick());
        bVar.f2074f.setText(sLFItemBean.getFavorite());
