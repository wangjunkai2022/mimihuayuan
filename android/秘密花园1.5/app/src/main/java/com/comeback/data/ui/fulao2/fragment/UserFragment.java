...
public class UserFragment extends BaseFragment {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            int c2 = j.b().c(UserFragment.this.f859g);
            if (c2 == 3) {
    ...
    @Override // com.comeback.data.base.BaseFragment
    public void f() {
        this.f859g = UserFragment.class.getName();
        int c2 = j.b().c(this.f859g);
        if (c2 == -1) {
            c2 = 1;
        }
        if (c2 == 1) {
