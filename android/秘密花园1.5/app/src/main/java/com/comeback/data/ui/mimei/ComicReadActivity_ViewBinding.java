...
public class ComicReadActivity_ViewBinding implements Unbinder {
    ...
    public void a() {
        ...
        if (comicReadActivity != null) {
            ...
            this.f1737e = null;
            this.f1738f.setOnClickListener(null);
            this.f1738f = null;
            return;
        }
