...
public class LauncherActivity extends BaseActivity {
    ...
    public static String[] f1546k = {e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sIy57KT01MD92NiY=")};
    public boolean b;
    ...
    public Runnable f1550f = new a();

    /* renamed from: g  reason: collision with root package name */
    public int f1551g = 6;

    /* renamed from: h  reason: collision with root package name */
    public Runnable f1552h = new b();

    /* renamed from: j  reason: collision with root package name */
    public AD f1554j = null;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            int i2 = launcherActivity.f1549e - 1;
            launcherActivity.f1549e = i2;
            if (i2 > 0) {
                launcherActivity.tvName.postDelayed(launcherActivity.f1550f, 250L);
            } else if (i2 == 0) {
                launcherActivity.tvName.postDelayed(launcherActivity.f1550f, 500L);
            } else {
                launcherActivity.f1548d = true;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            LauncherActivity launcherActivity = LauncherActivity.this;
            int i2 = launcherActivity.f1551g;
            int i3 = i2 - 1;
            launcherActivity.f1551g = i3;
            if (i2 > 2) {
                launcherActivity.tvCount.setText(String.valueOf(i3));
                LauncherActivity launcherActivity2 = LauncherActivity.this;
                launcherActivity2.tvCount.postDelayed(launcherActivity2.f1550f, 1200L);
                return;
            }
            launcherActivity.f1551g = i3 - 1;
            if (i3 > 0) {
                launcherActivity.tvCount.setText(e.a("39XQjNT0"));
                LauncherActivity.this.tvCount.setClickable(true);
                LauncherActivity launcherActivity3 = LauncherActivity.this;
                launcherActivity3.tvCount.postDelayed(launcherActivity3.f1550f, 1200L);
                return;
            }
            launcherActivity.o();
        }
    ...
    public static void l(LauncherActivity launcherActivity) {
        if (launcherActivity.f1548d) {
            if (!launcherActivity.f1547c) {
                launcherActivity.llLogo.setVisibility(8);
                launcherActivity.flProgress.setVisibility(0);
            } else if (App.f104e != null && launcherActivity.f1554j != null) {
                launcherActivity.flAd.setVisibility(0);
                launcherActivity.flProgress.setVisibility(8);
                h.u0(launcherActivity.f1554j.getImage(), launcherActivity.ivCover);
                launcherActivity.tvCount.setClickable(false);
                launcherActivity.tvCount.postDelayed(launcherActivity.f1552h, 150L);
            } else {
                launcherActivity.o();
            }
        }
    ...
    public static void m(LauncherActivity launcherActivity) {
        if (launcherActivity != null) {
            d<i0> c2 = f.e.a.j.i0.c.a().c(e.a("XxYXFBhJFhwAAURWVhwWB0MQDAYBFlpHAEhXCBVFDgZfG1tcU0sWUBBIXhcf"));
            launcherActivity.f1553i = c2;
    ...
    public void e() {
        ...
        i();
        d<i0> c2 = f.e.a.j.i0.c.a().c(e.a("XxYXFBhJFhweD1kOEBNNBEQRTgcFXkpbEghTDxkDTQpbCxoRBRBKHRAJWUgbCU0BRwU="));
        this.f1553i = c2;
        c2.X(new j(this));
        p();
    }
    ...
    public final void n() {
        ...
        this.tvName.postDelayed(this.f1550f, 250L);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        d<i0> dVar = this.f1553i;
        if (dVar != null) {
            dVar.cancel();
        }
        this.tvName.removeCallbacks(this.f1550f);
        this.tvCount.removeCallbacks(this.f1552h);
    }
    ...
    public void onViewClicked(View view) {
        ...
        this.tvCount.removeCallbacks(this.f1550f);
        try {
            startActivity(new Intent(e.a("VgwHFgQaXR0aCEACFh5NClQWCgsFXW96NjE="), Uri.parse(this.f1554j.getTargetUrl())));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        this.b = true;
    ...
    public void p() {
        try {
            if (ContextCompat.checkSelfPermission(this, e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sIy57KT01MD92NiY=")) != 0) {
                ActivityCompat.requestPermissions(this, f1546k, 1);
            } else {
                n();
            }
        } catch (Exception e2) {
