...
public class TomatoActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f2158c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.n0.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f2158c);
    }
