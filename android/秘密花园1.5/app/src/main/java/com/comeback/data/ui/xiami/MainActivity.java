...
public class MainActivity extends BaseActivity {
    ...
    public static Category f2211d;
    public ArrayList<BaseFragment> b;

    /* renamed from: c  reason: collision with root package name */
    public BottomNavigationView.OnNavigationItemSelectedListener f2212c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.q0.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f2212c);
    }
    ...
    public /* synthetic */ boolean l(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.navigation_hot /* 2131296622 */:
                ...
                return true;
            case R.id.navigation_special /* 2131296635 */:
