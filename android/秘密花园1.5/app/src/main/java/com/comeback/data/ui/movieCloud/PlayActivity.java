...
public class PlayActivity extends BaseActivity {
    ...
    public List<PlayListBean> f1802e;
    ...
    public class a extends j<AMJPlay> {
        ...
        public void f(AMJPlay aMJPlay) {
            ...
            chapterAdapter.f1821d = new ChapterAdapter.a() { // from class: f.e.a.j.g0.a
    ...
    public class b extends j<XXPlay> {
        ...
        public void f(XXPlay xXPlay) {
            ...
            playActivity.rvChapter.setAdapter(chapterAdapter);
            chapterAdapter.b(playList, chapterAdapter.b.size());
            chapterAdapter.f1821d = new ChapterAdapter.a() { // from class: f.e.a.j.g0.b
                @Override // com.comeback.data.ui.movieCloud.adapter.ChapterAdapter.a
                public final void a(int i2, String str) {
                    PlayActivity.this.m(i2, str);
                }
            };
            playActivity.k(f.e.a.j.g0.h.b.a().c(playActivity.f1801d, playList.get(0).getUri()), new c());
        }
    }
    ...
    public void c(Intent intent) {
        this.f1800c = intent.getStringExtra(e.a("Vg8JLQ8="));
        this.f1801d = intent.getStringExtra(e.a("TxoqAA=="));
    }
    ...
    public void e() {
        ...
        if (!TextUtils.isEmpty(this.f1800c)) {
            k(f.e.a.j.g0.h.b.a().f("", this.f1800c), new a());
        } else {
            k(f.e.a.j.g0.h.b.a().e(this.f1801d), new b());
        }
    }
    ...
    public final void n(String str) {
        k(f.e.a.j.g0.h.b.a().c(this.f1801d, str), new c());
    }
