...
public class MMActivity extends BaseRefreshActivity {
    ...
    public void onActivityResult(int i2, int i3, @Nullable Intent intent) {
        ...
        if (i2 == 100) {
            this.f1402d = intent.getStringExtra(e.a("XgY="));
    ...
    public void onDestroy() {
        ...
        AreaChooseActivity.f1391f = null;
    }
    ...
    public void p(int i2) {
        ...
        try {
            jSONObject.put(e.a("VhAGBTQaXQ=="), this.f1402d);
            jSONObject.put(e.a("RwMEAQ=="), i2);
            jSONObject.put(e.a("QwMEOwIX"), "");
        } catch (Exception unused) {
        }
        k(d.a().d(f.e.a.j.y.j.a.c(jSONObject)), new a(i2));
    }
}
