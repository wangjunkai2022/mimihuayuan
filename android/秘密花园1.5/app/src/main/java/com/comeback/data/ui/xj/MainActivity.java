...
public class MainActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f2262c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.s0.a
    ...
    @Override // com.comeback.data.base.BaseActivity
    public void e() {
        if (TextUtils.isEmpty(b.f4052j) || TextUtils.isEmpty(b.f4053k)) {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f2262c);
    }
