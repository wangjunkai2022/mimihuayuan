...
public class ActorAdapter extends BaseAbstractAdapter<ActorsBean> {

    /* loaded from: classes.dex */
    public static class HomeListHolder extends BaseViewHolder<ActorsBean> {
        ...
        public void a(ActorsBean actorsBean) {
            ...
            this.b = actorsBean2;
            h.C0(actorsBean2.getActor_url(), this.ivCover, 0);
            this.tvTitle.setText(actorsBean2.getActor_name());
        }
    }
    ...
    public class HomeListHolder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ HomeListHolder f799c;

            public a(HomeListHolder_ViewBinding homeListHolder_ViewBinding, HomeListHolder homeListHolder) {
                this.f799c = homeListHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                HomeListHolder homeListHolder = this.f799c;
