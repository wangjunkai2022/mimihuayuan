...
public class TbsDownloadConfig {
    ...
    public TbsDownloadConfig(Context context) {
        ...
        this.f2509c = applicationContext;
    ...
    public synchronized int getDownloadInterruptCode() {
        ...
        if (!this.mPreferences.contains(TbsConfigKey.KEY_DOWNLOAD_INTERRUPT_CODE)) {
            try {
                if (new File(new File(this.f2509c.getFilesDir(), "shared_prefs"), "tbs_download_config").exists()) {
        ...
        if (this.f2509c == null || !TbsConfig.APP_QQ.equals(this.f2509c.getApplicationInfo().packageName) || "CN".equals(Locale.getDefault().getCountry())) {
    ...
    */
    public synchronized void uploadDownloadInterruptCodeIfNeeded(android.content.Context r6) {
        /*
            ...
            android.content.Context r3 = r5.f2509c     // Catch: java.lang.Throwable -> L4d
