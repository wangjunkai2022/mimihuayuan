...
public class UrlRequestBuilderImpl extends UrlRequest.Builder {
    ...
    public final UrlRequest.Callback f2568c;
    ...
    public final ArrayList<Pair<String, String>> f2571f = new ArrayList<>();
    ...
    public UrlRequestBuilderImpl addHeader(String str, String str2) {
        if (str != null) {
            if (str2 != null) {
                ...
                this.f2571f.add(Pair.create(str, str2));
                return this;
            }
