...
public class TbsLogReport {
    ...
    public static class TbsLogInfo implements Cloneable {
        ...
        public void resetArgs() {
            ...
            this.f2533g = 0;
            this.f2534h = 2;
            this.f2535i = EnvironmentCompat.MEDIA_UNKNOWN;
            this.f2536j = 0;
            this.f2537k = 2;
            this.f2538l = 0L;
            this.f2539m = 0L;
    ...
    private SharedPreferences d() {
        return this.f2527c.getSharedPreferences("tbs_download_stat", 4);
    }
    ...
    */
    ...
    public void b() {
        ...
        if (a2 != null && a2.length() != 0) {
            ...
            try {
                String a3 = com.tencent.smtt.utils.g.a(com.tencent.smtt.utils.n.a(this.f2527c).c(), a2.toString().getBytes("utf-8"), new g.a() { // from class: com.tencent.smtt.sdk.TbsLogReport.3
    ...
    private void a(int i2, TbsLogInfo tbsLogInfo, EventType eventType) {
        tbsLogInfo.setErrorCode(i2);
        tbsLogInfo.setEventTime(System.currentTimeMillis());
        QbSdk.f2492m.onInstallFinish(i2);
    ...
    public void a(int i2, TbsLogInfo tbsLogInfo) {
        ...
        sb.append(a(i2));
        sb.append(a(com.tencent.smtt.utils.b.c(this.f2527c)));
        sb.append(a(com.tencent.smtt.utils.l.a(this.f2527c)));
        sb.append(a(l.a().i(this.f2527c)));
        ...
        sb.append(a(str));
        String packageName = this.f2527c.getPackageName();
        sb.append(a(packageName));
        if (TbsConfig.APP_WX.equals(packageName)) {
            sb.append(a(com.tencent.smtt.utils.b.a(this.f2527c, TbsDownloader.TBS_METADATA)));
        } else {
            sb.append(a(com.tencent.smtt.utils.b.b(this.f2527c)));
        }
        sb.append(a(a(tbsLogInfo.b)));
        sb.append(a(tbsLogInfo.f2529c));
        sb.append(a(tbsLogInfo.f2530d));
        sb.append(a(tbsLogInfo.f2531e));
        sb.append(a(tbsLogInfo.f2532f));
        sb.append(a(tbsLogInfo.f2533g));
        sb.append(a(tbsLogInfo.f2534h));
        sb.append(a(tbsLogInfo.f2535i));
        sb.append(a(tbsLogInfo.f2536j));
        sb.append(a(tbsLogInfo.f2537k));
        sb.append(b(tbsLogInfo.q));
        sb.append(b(tbsLogInfo.f2538l));
        sb.append(b(tbsLogInfo.f2539m));
        sb.append(a(tbsLogInfo.n));
        sb.append(a(tbsLogInfo.a));
        sb.append(a(tbsLogInfo.o));
        sb.append(a(tbsLogInfo.p));
        sb.append(a(TbsDownloadConfig.getInstance(this.f2527c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0)));
        sb.append(a(com.tencent.smtt.utils.b.f(this.f2527c)));
        ...
        edit.commit();
        if (this.f2528d || i2 != EventType.TYPE_LOAD.a) {
            b();
        }
    }
