...
public class q extends FrameLayout implements MediaPlayer.OnErrorListener {
    ...
    public VideoView f2670c;

    /* renamed from: d  reason: collision with root package name */
    public Context f2671d;
    ...
    private void b(Bundle bundle, Object obj) {
        ...
        VideoView videoView = this.f2670c;
        if (videoView != null) {
            videoView.stopPlayback();
        }
        if (this.f2670c == null) {
            this.f2670c = new VideoView(getContext());
        }
        String string = bundle.getString("videoUrl");
        this.f2672e = string;
        this.f2670c.setVideoURI(Uri.parse(string));
        this.f2670c.setOnErrorListener(this);
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i2, int i3) {
        try {
            if (this.f2671d instanceof Activity) {
                Activity activity = (Activity) this.f2671d;
            ...
            if (context != null) {
                ...
                intent.addFlags(268435456);
                intent.setDataAndType(Uri.parse(this.f2672e), "video/*");
                applicationContext.startActivity(intent);
            }
            return true;
    ...
    public void a(Activity activity) {
        VideoView videoView;
        if (b() || (videoView = this.f2670c) == null) {
            return;
        }
        if (videoView.getParent() == null) {
            ...
            mediaController.setMediaPlayer(this.f2670c);
            this.f2670c.setMediaController(mediaController);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -1);
            layoutParams.gravity = 17;
            frameLayout.addView(this.f2670c, layoutParams);
        }
        this.f2670c.start();
    }
    ...
    public void a(Activity activity, int i2) {
        ...
        if (i2 == 3 && !b() && (videoView2 = this.f2670c) != null) {
            videoView2.pause();
        }
        if (i2 == 4) {
            this.f2671d = null;
