...
public class l {
    ...
    public static String f2760c = "GE";

    /* renamed from: d  reason: collision with root package name */
    public static String f2761d = "9422";

    /* renamed from: e  reason: collision with root package name */
    public static String f2762e = "0";

    /* renamed from: f  reason: collision with root package name */
    public static String f2763f = "";

    /* renamed from: g  reason: collision with root package name */
    public static boolean f2764g = false;

    /* renamed from: h  reason: collision with root package name */
    public static boolean f2765h = false;

    /* renamed from: i  reason: collision with root package name */
    public static boolean f2766i = false;

    public static String a(Context context) {
        if (!TextUtils.isEmpty(a)) {
            return a;
        }
        String a2 = a(context, String.valueOf(WebView.getTbsSDKVersion(context)), "0", b, f2760c, f2761d, f2762e, f2763f, f2764g);
        a = a2;
        return a2;
    }
