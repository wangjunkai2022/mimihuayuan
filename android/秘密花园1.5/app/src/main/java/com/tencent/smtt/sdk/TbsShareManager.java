...
public class TbsShareManager {
    ...
    public static String f2553c = null;

    /* renamed from: d  reason: collision with root package name */
    public static String f2554d = null;

    /* renamed from: e  reason: collision with root package name */
    public static int f2555e = 0;

    /* renamed from: f  reason: collision with root package name */
    public static String f2556f = null;

    /* renamed from: g  reason: collision with root package name */
    public static boolean f2557g = false;

    /* renamed from: h  reason: collision with root package name */
    public static boolean f2558h = false;

    /* renamed from: i  reason: collision with root package name */
    public static boolean f2559i = false;

    /* renamed from: j  reason: collision with root package name */
    public static String f2560j = null;

    /* renamed from: k  reason: collision with root package name */
    public static boolean f2561k = false;

    /* renamed from: l  reason: collision with root package name */
    public static boolean f2562l = false;
    ...
    public static int findCoreForThirdPartyApp(Context context) {
        n(context);
        TbsLog.i("TbsShareManager", "core_info mAvailableCoreVersion is " + f2555e + " mAvailableCorePath is " + f2554d + " mSrcPackageName is " + f2556f);
        if (f2556f == null) {
            TbsLog.e("TbsShareManager", "mSrcPackageName is null !!!");
        }
        String str = f2556f;
        if (str != null && str.equals("AppDefined")) {
            if (f2555e != l.a().a(f2553c)) {
                f2555e = 0;
                f2554d = null;
                f2556f = null;
        ...
        if (f2555e > 0) {
            ...
            if ((!("com.tencent.android.qqdownloader".equals(applicationInfo.packageName) || "com.jd.jrapp".equals(applicationInfo.packageName)) ? QbSdk.a(context, f2555e) : false) || f2557g) {
                f2555e = 0;
                f2554d = null;
                f2556f = null;
    ...
    public static void forceToLoadX5ForThirdApp(Context context, boolean z) {
        ...
        try {
            if (QbSdk.isNeedInitX5FirstTime() && isThirdPartyApp(context) && !QbSdk.getOnlyDownload() && (r = l.a().r(context)) != null) {
                ...
                if (f2553c != null && (a2 = l.a().a(f2553c)) > 0) {
                    f2554d = f2553c;
                    f2556f = "AppDefined";
                    f2555e = a2;
                    TbsLog.i("TbsShareManager", "forceToLoadX5ForThirdApp #1 -- mAvailableCoreVersion: " + f2555e + " " + Log.getStackTraceString(new Throwable("#")));
                    writeProperties(context, Integer.toString(f2555e), f2556f, f2554d, Integer.toString(1));
                    return;
                }
                ...
                for (String str : coreProviderAppList) {
                    ...
                    if (coreShareDecoupleCoreVersion >= h2 && coreShareDecoupleCoreVersion >= i2 && coreShareDecoupleCoreVersion > 0) {
                        f2554d = l.a().c(context, getPackageContext(context, str, true)).getAbsolutePath();
                        f2556f = str;
                        f2555e = coreShareDecoupleCoreVersion;
                        TbsLog.i("TbsShareManager", "forceToLoadX5ForThirdApp #2 -- mAvailableCoreVersion: " + f2555e + " " + Log.getStackTraceString(new Throwable("#")));
                        if (QbSdk.canLoadX5FirstTimeThirdApp(context)) {
                            ...
                            writeProperties(context, Integer.toString(f2555e), f2556f, f2554d, Integer.toString(b2));
                            return;
                        }
                        f2555e = 0;
                        f2554d = null;
                ...
                for (String str2 : coreProviderAppList) {
                    ...
                    if (sharedTbsCoreVersion >= h2 && sharedTbsCoreVersion >= i2 && sharedTbsCoreVersion > 0) {
                        f2554d = l.a().b(context, getPackageContext(context, str2, true)).getAbsolutePath();
                        f2556f = str2;
                        f2555e = sharedTbsCoreVersion;
                        TbsLog.i("TbsShareManager", "forceToLoadX5ForThirdApp #3 -- mAvailableCoreVersion: " + f2555e + " " + Log.getStackTraceString(new Throwable("#")));
                        if (QbSdk.canLoadX5FirstTimeThirdApp(context)) {
                            writeProperties(context, Integer.toString(f2555e), f2556f, f2554d, Integer.toString(com.tencent.smtt.utils.b.b(context)));
                            return;
                        }
                        f2555e = 0;
                        f2554d = null;
    ...
    public static String g(Context context) {
        try {
            n(context);
            if (f2554d != null && !TextUtils.isEmpty(f2554d)) {
                return f2554d + File.separator + "res.apk";
            }
            return null;
        } catch (Throwable th) {
    ...
    public static boolean i(Context context) {
        try {
            ...
            if (f2553c == null) {
                if (f2555e != 0 && getSharedTbsCoreVersion(context, f2556f) == f2555e) {
                    return true;
                }
            } else if (f2555e != 0 && l.a().a(f2553c) == f2555e) {
                return true;
            }
            if (l(context)) {
                return true;
            ...
            tbsCoreLoadStat.a(context, TbsListener.ErrorCode.INFO_CORE_EXIST_NOT_LOAD, new Throwable("mAvailableCoreVersion=" + f2555e + "; mSrcPackageName=" + f2556f + "; getSharedTbsCoreVersion(ctx, mSrcPackageName) is " + getSharedTbsCoreVersion(context, f2556f) + "; getHostCoreVersions is " + getHostCoreVersions(context)));
            f2554d = null;
            f2555e = 0;
    ...
    public static boolean k(Context context) {
        ...
        return f2555e == getSharedTbsCoreVersion(context, str) || f2555e == getCoreShareDecoupleCoreVersion(context, f2556f);
    }
    ...
    public static boolean l(Context context) {
        ...
        for (String str : coreProviderAppList) {
            ...
            if (i2 > 0 && i2 == getSharedTbsCoreVersion(context, str)) {
                Context packageContext = getPackageContext(context, str, true);
                if (l.a().f(context)) {
                    f2554d = l.a().b(context, packageContext).getAbsolutePath();
                    f2556f = str;
                    return true;
                }
            }
        ...
        for (String str2 : coreProviderAppList) {
            ...
            if (i3 > 0 && i3 == getCoreShareDecoupleCoreVersion(context, str2)) {
                ...
                if (l.a().f(context)) {
                    f2554d = l.a().c(context, packageContext2).getAbsolutePath();
                    f2556f = str2;
                    return true;
                }
            }
    ...
    public static void n(Context context) {
        ...
        synchronized (TbsShareManager.class) {
            ...
            try {
                ...
                String property = properties.getProperty("core_version", "");
                if (!"".equals(property)) {
                    f2555e = Math.max(Integer.parseInt(property), 0);
                    TbsLog.i("TbsShareManager", "loadProperties -- mAvailableCoreVersion: " + f2555e + " " + Log.getStackTraceString(new Throwable("#")));
                }
                String property2 = properties.getProperty("core_packagename", "");
                if (!"".equals(property2)) {
                    f2556f = property2;
                }
                if (f2556f != null && a != null) {
                    if (f2556f.equals(a.getPackageName())) {
                        f2561k = true;
                    } else {
                        f2561k = false;
                    }
                ...
                f2557g = Boolean.parseBoolean(properties.getProperty("core_disabled", "false"));
                f2562l = true;
            } catch (Throwable th3) {
                th = th3;
                th.printStackTrace();
    ...
    public static synchronized void writeCoreInfoForThirdPartyApp(Context context, int i2, boolean z) {
        synchronized (TbsShareManager.class) {
            ...
            if (h2 < 0) {
                ...
                if (f2553c != null) {
                    if (i2 == l.a().a(f2553c)) {
                        writeProperties(context, Integer.toString(i2), "AppDefined", f2553c, Integer.toString(1));
                        File tbsShareFile = getTbsShareFile(context, "core_info");
                        if (!f2559i && tbsShareFile != null) {
                        ...
                        for (String str : d2) {
                            if (i2 == getSharedTbsCoreVersion(context, str)) {
                                ...
                                if (l.a().f(packageContext)) {
                                    com.tencent.smtt.utils.f.a(new File(absolutePath), new File(f2553c), new FileFilter() { // from class: com.tencent.smtt.sdk.TbsShareManager.1
