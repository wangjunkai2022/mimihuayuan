...
public class d implements j<d, e>, Serializable, Cloneable {
    ...
    public static final Map<e, v> f3349d;

    /* renamed from: e  reason: collision with root package name */
    public static final long f3350e = 2846460275012375038L;

    /* renamed from: f  reason: collision with root package name */
    public static final an f3351f = new an("Imprint");

    /* renamed from: g  reason: collision with root package name */
    public static final ad f3352g = new ad("property", ap.f3114k, 1);

    /* renamed from: h  reason: collision with root package name */
    public static final ad f3353h = new ad("version", (byte) 8, 2);

    /* renamed from: i  reason: collision with root package name */
    public static final ad f3354i = new ad("checksum", (byte) 11, 3);

    /* renamed from: j  reason: collision with root package name */
    public static final Map<Class<? extends aq>, ar> f3355j;

    /* renamed from: k  reason: collision with root package name */
    public static final int f3356k = 0;
        ...
        public void b(ai aiVar, d dVar) throws p {
            ...
            while (true) {
                ...
                if (s != 1) {
                    ...
                    af n = aiVar.n();
                    dVar.a = new HashMap(n.f3095c * 2);
                    for (int i2 = 0; i2 < n.f3095c; i2++) {
                        String z = aiVar.z();
    ...
    public static class c extends at<d> {
        ...
        public void b(ai aiVar, d dVar) throws p {
            ...
            dVar.a = new HashMap(afVar.f3095c * 2);
    ...
    static {
        ...
        f3355j.put(at.class, new C0029d());
        EnumMap enumMap = new EnumMap(e.class);
        enumMap.put((EnumMap) e.PROPERTY, (e) new v("property", (byte) 1, new y(ap.f3114k, new w((byte) 11), new aa((byte) 12, com.umeng.commonsdk.statistics.proto.e.class))));
    ...
    public void g() {
        this.f3358l = g.b(this.f3358l, 0);
    }

    public boolean h() {
        return g.a(this.f3358l, 0);
    }
    ...
    public void read(ai aiVar) throws p {
        f3355j.get(aiVar.D()).b().b(aiVar, this);
    }
    ...
    public void write(ai aiVar) throws p {
        f3355j.get(aiVar.D()).b().a(aiVar, this);
    }
    ...
    public enum e implements q {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final Map<String, e> f3360d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final short f3362e;
    ...
    public void b(boolean z) {
        this.f3358l = g.a(this.f3358l, 0, z);
    }
