...
public class ab extends ai {
    ...
    public static final an f3063h = new an();
    ...
    public ByteBuffer A() throws p {
        ...
        d(w);
        if (this.f3099g.h() >= w) {
            ByteBuffer wrap = ByteBuffer.wrap(this.f3099g.f(), this.f3099g.g(), w);
            this.f3099g.a(w);
            return wrap;
        }
        byte[] bArr = new byte[w];
        this.f3099g.d(bArr, 0, w);
    ...
    public String z() throws p {
        ...
        if (this.f3099g.h() >= w) {
            try {
                String str = new String(this.f3099g.f(), this.f3099g.g(), w, "UTF-8");
                this.f3099g.a(w);
                return str;
            } catch (UnsupportedEncodingException unused) {
                throw new p("JVM DOES NOT SUPPORT UTF-8");
    ...
    public ab(aw awVar, boolean z, boolean z2) {
        ...
        this.f3065d = true;
        this.f3067f = false;
        this.f3068i = new byte[1];
        this.f3069j = new byte[2];
        this.f3070k = new byte[4];
        this.f3071l = new byte[8];
        this.f3072m = new byte[1];
        this.n = new byte[2];
        this.o = new byte[4];
        this.p = new byte[8];
        this.f3064c = z;
    ...
    public void a(byte b2) throws p {
        byte[] bArr = this.f3068i;
        bArr[0] = b2;
        this.f3099g.b(bArr, 0, 1);
    }

    @Override // com.umeng.commonsdk.proguard.ai
    public void a(short s) throws p {
        byte[] bArr = this.f3069j;
        bArr[0] = (byte) ((s >> 8) & 255);
        bArr[1] = (byte) (s & 255);
        this.f3099g.b(bArr, 0, 2);
    }
    ...
    public void a(int i2) throws p {
        ...
        bArr[3] = (byte) (i2 & 255);
        this.f3099g.b(bArr, 0, 4);
    }

    @Override // com.umeng.commonsdk.proguard.ai
    public void a(long j2) throws p {
        byte[] bArr = this.f3071l;
    ...
    public void a(String str) throws p {
        try {
            ...
            a(bytes.length);
            this.f3099g.b(bytes, 0, bytes.length);
        } catch (UnsupportedEncodingException unused) {
            throw new p("JVM DOES NOT SUPPORT UTF-8");
        }
    }
    ...
    public void a(ByteBuffer byteBuffer) throws p {
        ...
        a(limit);
        this.f3099g.b(byteBuffer.array(), byteBuffer.arrayOffset() + byteBuffer.position(), limit);
    }

    private int a(byte[] bArr, int i2, int i3) throws p {
        d(i3);
        return this.f3099g.d(bArr, i2, i3);
    }
}
