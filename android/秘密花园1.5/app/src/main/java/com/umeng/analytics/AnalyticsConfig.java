...
public class AnalyticsConfig {
    ...
    public static String f2782c;

    /* renamed from: d  reason: collision with root package name */
    public static String f2783d;
    ...
    public static long kContinueSessionMillis = com.umeng.commonsdk.proguard.c.f3127d;
    ...
    public static String getSecretKey(Context context) {
        if (TextUtils.isEmpty(f2783d)) {
            f2783d = z.a(context).c();
        }
        return f2783d;
    }
