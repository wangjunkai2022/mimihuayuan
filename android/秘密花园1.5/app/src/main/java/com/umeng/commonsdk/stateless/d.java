...
public class d {
    ...
    public static HandlerThread f3230c = null;

    /* renamed from: d  reason: collision with root package name */
    public static Handler f3231d = null;

    /* renamed from: f  reason: collision with root package name */
    public static final int f3233f = 512;

    /* renamed from: g  reason: collision with root package name */
    public static IntentFilter f3234g = null;

    /* renamed from: h  reason: collision with root package name */
    public static boolean f3235h = false;

    /* renamed from: e  reason: collision with root package name */
    public static Object f3232e = new Object();

    /* renamed from: i  reason: collision with root package name */
    public static BroadcastReceiver f3236i = new BroadcastReceiver() { // from class: com.umeng.commonsdk.stateless.d.1
        ...
        synchronized (f3232e) {
            if (context != null) {
                try {
                    ...
                    if (applicationContext != null && f3230c == null) {
                        HandlerThread handlerThread = new HandlerThread("SL-NetWorkSender");
                        f3230c = handlerThread;
                        handlerThread.start();
                        if (f3231d == null) {
                            f3231d = new Handler(f3230c.getLooper()) { // from class: com.umeng.commonsdk.stateless.d.2
                        ...
                        if (DeviceConfig.checkPermission(b, "android.permission.ACCESS_NETWORK_STATE")) {
                            ...
                            if (f3234g == null) {
                                ...
                                if (f3236i != null) {
                                    ...
                                    b.registerReceiver(f3236i, f3234g);
                                }
                            }
                        }
                    }
    ...
    public static void f() {
        if (f3234g != null) {
            BroadcastReceiver broadcastReceiver = f3236i;
        ...
        HandlerThread handlerThread = f3230c;
    ...
    public static void b(int i2) {
        try {
            if (!f3235h || f3231d == null || f3231d.hasMessages(i2)) {
                return;
            }
            ULog.i("walle", "[stateless] sendMsgOnce !!!!");
            Message obtainMessage = f3231d.obtainMessage();
            obtainMessage.what = i2;
            f3231d.sendMessage(obtainMessage);
        } catch (Throwable th) {
            UMCrashManager.reportCrash(b, th);
        }
    }
