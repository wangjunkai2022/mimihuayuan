...
public class k {
    ...
    public static final String f2895l = "first_activate_time";

    /* renamed from: m  reason: collision with root package name */
    public static final String f2896m = "ana_is_f";
    ...
    public static class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final int f2906c = 4099;

        /* renamed from: d  reason: collision with root package name */
        public static final int f2907d = 4100;

        /* renamed from: e  reason: collision with root package name */
        public static final int f2908e = 4101;

        /* renamed from: f  reason: collision with root package name */
        public static final int f2909f = 4102;

        /* renamed from: g  reason: collision with root package name */
        public static final int f2910g = 4103;

        /* renamed from: h  reason: collision with root package name */
        public static final int f2911h = 4104;

        /* renamed from: i  reason: collision with root package name */
        public static final int f2912i = 4105;

        /* renamed from: j  reason: collision with root package name */
        public static final int f2913j = 4106;

        /* renamed from: k  reason: collision with root package name */
        public static final int f2914k = 4352;

        /* renamed from: l  reason: collision with root package name */
        public static final int f2915l = 4353;

        /* renamed from: m  reason: collision with root package name */
        public static final int f2916m = 4354;
    ...
    private void e(Object obj) {
        try {
            ...
            if (2050 == jSONObject.getInt("__t")) {
                if (!a(this.f2905k, this.f2903i)) {
                    return;
                }
                this.f2903i++;
            } else if (2049 == jSONObject.getInt("__t")) {
                if (!a(this.f2905k, this.f2904j)) {
                    return;
                }
                this.f2904j++;
            }
            if (this.f2901g.length() >= this.f2900f) {
                g.a(a).a(this.f2901g);
                this.f2901g = new JSONArray();
            }
            if (this.f2905k == 0) {
                this.f2905k = System.currentTimeMillis();
            }
            this.f2901g.put(jSONObject);
        } catch (Throwable th) {
            MLog.e(th);
        }
    }
    ...
    private JSONObject m() {
        ...
        try {
            ...
            jSONObject.put(com.umeng.analytics.pro.b.f2811i, AnalyticsConfig.getVerticalType(a));
            ...
            if (t()) {
                ...
                if (sharedPreferences != null) {
                    sharedPreferences.edit().putLong(f2896m, 0L).commit();
                }
            }
            jSONObject.put(com.umeng.analytics.pro.b.f2814l, n());
            jSONObject.put(com.umeng.analytics.pro.b.f2815m, o());
            if (sharedPreferences != null) {
                String string = sharedPreferences.getString("vers_name", "");
                if (!TextUtils.isEmpty(string)) {
                    String format = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()));
                    if (TextUtils.isEmpty(imprintProperty)) {
                        jSONObject.put(com.umeng.analytics.pro.b.f2814l, sharedPreferences.getString("vers_pre_version", "0"));
                        jSONObject.put(com.umeng.analytics.pro.b.f2815m, sharedPreferences.getString("vers_date", format));
                    }
    ...
    private String n() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (this.f2897c == null) {
                    this.f2897c = PreferenceWrapper.getDefault(a);
                }
                String string = this.f2897c.getString("pre_version", "");
                String appVersionName = DeviceConfig.getAppVersionName(a);
                if (TextUtils.isEmpty(string)) {
                    this.f2897c.edit().putString("pre_version", "0").putString("cur_version", appVersionName).commit();
                    str = "0";
                } else {
                    String string2 = this.f2897c.getString("cur_version", "");
                    if (appVersionName.equals(string2)) {
                        str = string;
                    } else {
                        this.f2897c.edit().putString("pre_version", string2).putString("cur_version", appVersionName).commit();
                        str = string2;
                    }
                }
            }
    ...
    private String o() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                if (!TextUtils.isEmpty(this.f2899e)) {
                    return this.f2899e;
                }
                if (this.f2897c == null) {
                    this.f2897c = PreferenceWrapper.getDefault(a);
                }
                String string = this.f2897c.getString("pre_date", "");
                if (TextUtils.isEmpty(string)) {
                    string = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()));
                    this.f2897c.edit().putString("pre_date", string).commit();
                } else {
                    String format = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()));
                    if (!string.equals(format)) {
                        this.f2897c.edit().putString("pre_date", format).commit();
                        str = format;
                    }
                }
                str = string;
    ...
    private boolean q() {
        try {
            ...
            if (this.f2901g.length() > 0) {
                for (int i2 = 0; i2 < this.f2901g.length(); i2++) {
                    JSONObject optJSONObject = this.f2901g.optJSONObject(i2);
    ...
    private void r() {
        if (this.f2901g.length() > 0) {
            ...
            for (int i2 = 0; i2 < this.f2901g.length(); i2++) {
                try {
                    JSONObject jSONObject = this.f2901g.getJSONObject(i2);
    ...
    private boolean t() {
        ...
        try {
            ...
            return sharedPreferences.getLong(f2896m, -1L) != 0;
        } catch (Throwable unused) {
            return false;
        }
    }
    ...
    public void d() {
        try {
            ...
            PreferenceWrapper.getDefault(a).edit().putLong("thtstart", this.f2905k).putInt("gkvc", this.f2903i).putInt("ekvc", this.f2904j).commit();
        } catch (Throwable unused) {
        }
    }
    ...
    public k() {
        ...
        this.f2900f = 10;
        this.f2901g = new JSONArray();
        this.f2902h = TbsReaderView.ReaderCallback.GET_BAR_ANIMATING;
        this.f2903i = 0;
        this.f2904j = 0;
        this.f2905k = 0L;
        ...
        try {
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(a);
            this.f2905k = sharedPreferences.getLong("thtstart", 0L);
            this.f2903i = sharedPreferences.getInt("gkvc", 0);
            this.f2904j = sharedPreferences.getInt("ekvc", 0);
            this.b = new c();
        } catch (Throwable unused) {
        }
    }
    ...
    public static class c {
        ...
        /* renamed from: f  reason: collision with root package name */
        public ABTest f2920f;

        public c() {
            this.f2920f = null;
            this.f2920f = ABTest.getService(k.a);
        }
        ...
        public void b() {
            ...
            if (!service.isOpen()) {
                ...
                if (MLog.DEBUG && z) {
                ...
                } else if (this.f2920f.isInTest() && "RPT".equals(this.f2920f.getTestName())) {
                    if (this.f2920f.getTestPolicy() == 6) {
                    ...
                    this.a = b(this.f2920f.getTestPolicy(), i2);
                } else {
                    int i3 = this.f2918d;
                    int i4 = this.f2919e;
                    int i5 = this.b;
        ...
        if (a != null) {
            synchronized (this.w) {
                if (this.u) {
                    ...
                    UMWorkDispatch.sendEvent(a, a.f2915l, CoreProtocol.getInstance(a), null);
                }
            }
            synchronized (this.w) {
                if (this.v) {
                    UMWorkDispatch.sendEvent(a, a.f2916m, CoreProtocol.getInstance(a), null);
                }
            }
        }
    }
