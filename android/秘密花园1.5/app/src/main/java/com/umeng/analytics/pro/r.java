...
public class r {
    ...
    public static JSONArray f2939c = new JSONArray();

    /* renamed from: d  reason: collision with root package name */
    public static Object f2940d = new Object();

    /* renamed from: e  reason: collision with root package name */
    public final Map<String, Long> f2941e = new HashMap();
    ...
    public static void a(Context context) {
        ...
        if (context != null) {
            try {
                ...
                synchronized (f2940d) {
                    jSONArray = f2939c.toString();
                    f2939c = new JSONArray();
                }
    ...
    public void b(String str) {
        ...
        if (this.f2941e.containsKey(str)) {
            synchronized (this.f2941e) {
                l2 = this.f2941e.get(str);
            }
            if (l2 == null) {
                return;
            }
            ...
            synchronized (f2940d) {
                try {
                    ...
                    f2939c.put(jSONObject);
                    if (f2939c.length() >= 5 && (appContext = UMGlobalContext.getAppContext(null)) != null) {
    ...
    public void a(String str) {
        ...
        synchronized (this.f2941e) {
            this.f2941e.put(str, Long.valueOf(System.currentTimeMillis()));
    ...
    public void b() {
        ...
        synchronized (this.f2941e) {
            str = null;
            long j2 = 0;
            for (Map.Entry<String, Long> entry : this.f2941e.entrySet()) {
