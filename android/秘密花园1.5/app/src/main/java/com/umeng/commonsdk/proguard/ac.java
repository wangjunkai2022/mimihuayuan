...
public class ac extends ai {
    ...
    public static final an f3074d = new an("");

    /* renamed from: e  reason: collision with root package name */
    public static final ad f3075e = new ad("", (byte) 0, 0);

    /* renamed from: f  reason: collision with root package name */
    public static final byte[] f3076f;

    /* renamed from: h  reason: collision with root package name */
    public static final byte f3077h = -126;

    /* renamed from: i  reason: collision with root package name */
    public static final byte f3078i = 1;

    /* renamed from: j  reason: collision with root package name */
    public static final byte f3079j = 31;

    /* renamed from: k  reason: collision with root package name */
    public static final byte f3080k = -32;

    /* renamed from: l  reason: collision with root package name */
    public static final int f3081l = 5;
    public byte[] a;
    public byte[] b;
    ...
    public static class b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final byte f3084c = 3;

        /* renamed from: d  reason: collision with root package name */
        public static final byte f3085d = 4;

        /* renamed from: e  reason: collision with root package name */
        public static final byte f3086e = 5;

        /* renamed from: f  reason: collision with root package name */
        public static final byte f3087f = 6;

        /* renamed from: g  reason: collision with root package name */
        public static final byte f3088g = 7;

        /* renamed from: h  reason: collision with root package name */
        public static final byte f3089h = 8;

        /* renamed from: i  reason: collision with root package name */
        public static final byte f3090i = 9;

        /* renamed from: j  reason: collision with root package name */
        public static final byte f3091j = 10;

        /* renamed from: k  reason: collision with root package name */
        public static final byte f3092k = 11;

        /* renamed from: l  reason: collision with root package name */
        public static final byte f3093l = 12;
    }
    ...
    private int E() throws p {
        int i2 = 0;
        if (this.f3099g.h() >= 5) {
            byte[] f2 = this.f3099g.f();
            int g2 = this.f3099g.g();
            int i3 = 0;
            int i4 = 0;
            while (true) {
                byte b2 = f2[g2 + i2];
    ...
    public af n() throws p {
        int E = E();
        byte u = E == 0 ? (byte) 0 : u();
        return new af(d((byte) (u >> 4)), d((byte) (u & ap.f3116m)), E);
    }
    ...
    public byte u() throws p {
        if (this.f3099g.h() > 0) {
            byte b2 = this.f3099g.f()[this.f3099g.g()];
            this.f3099g.a(1);
            return b2;
        }
        this.f3099g.d(this.f3082c, 0, 1);
    ...
    public String z() throws p {
        ...
        try {
            if (this.f3099g.h() >= E) {
                String str = new String(this.f3099g.f(), this.f3099g.g(), E, "UTF-8");
                this.f3099g.a(E);
                return str;
            }
