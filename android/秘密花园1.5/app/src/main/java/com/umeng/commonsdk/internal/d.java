    ...
    public static void c(Context context) {
        if (context != null) {
            try {
                ...
                f.a(context, context.getFilesDir() + "/" + com.umeng.commonsdk.stateless.a.f3193e + "/" + Base64.encodeToString(a.a.getBytes(), 0), 10);
        ...
        if (context != null && (b = com.umeng.commonsdk.internal.utils.a.b((applicationContext = context.getApplicationContext()))) != null && b.size() > 0) {
            for (ScanResult scanResult : b) {
                try {
                    ...
                    jSONObject.put(com.umeng.commonsdk.internal.utils.f.f3038i, scanResult.frequency);
                    jSONObject.put("ts", System.currentTimeMillis());
                    ...
                    jSONObject.put(com.umeng.commonsdk.internal.utils.f.f3035f, scanResult.describeContents());
    ...
    public static void b(Context context, JSONObject jSONObject) {
        if (context != null) {
            ...
            try {
                ...
                if (jSONObject2.has(l.f3061d)) {
                    jSONObject.put(l.f3061d, jSONObject2.opt(l.f3061d));
                }
                if (jSONObject2.has(l.f3060c)) {
                    jSONObject.put(l.f3060c, jSONObject2.opt(l.f3060c));
                }
        ...
        try {
            ...
            if (a != null) {
                ...
                try {
                    ...
                    jSONObject.put("cpus", a.f3021c);
                    jSONObject.put("fea", a.f3022d);
                    jSONObject.put("imp", a.f3023e);
                    jSONObject.put("arc", a.f3024f);
                    jSONObject.put("var", a.f3025g);
                    jSONObject.put("par", a.f3026h);
                    jSONObject.put("rev", a.f3027i);
                    jSONObject.put("har", a.f3028j);
                    jSONObject.put("rev", a.f3029k);
                    jSONObject.put("ser", a.f3030l);
