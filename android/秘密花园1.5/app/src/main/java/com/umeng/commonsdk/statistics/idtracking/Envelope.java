...
public class Envelope {
    ...
    public void export(Context context) {
        ...
        String imprintProperty = UMEnvelopeBuild.imprintProperty(context, com.umeng.commonsdk.proguard.e.f3134f, null);
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject2.put(com.umeng.commonsdk.proguard.e.f3134f, HelperUtils.getUmengMD5(imprintProperty));
            }
