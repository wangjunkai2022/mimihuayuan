...
public class u {
    ...
    public static volatile u f2942c;
    public s a = new t();
    public String b;

    /* renamed from: d  reason: collision with root package name */
    public List<a> f2943d;
    ...
    private String f(Context context) {
        try {
            ...
            edit.putString(q.f2933d, d(context));
            edit.commit();
    ...
    private boolean j(Context context) {
        try {
            ...
            long j2 = sharedPreferences.getLong(q.f2934e, 0L);
            long j3 = sharedPreferences.getLong(q.f2935f, 0L);
    ...
    public String d(Context context) {
        if (TextUtils.isEmpty(this.b)) {
            try {
                this.b = PreferenceWrapper.getDefault(context).getString(q.f2932c, null);
            } catch (Exception unused) {
            }
        }
        return this.b;
    ...
    public String a(Context context) {
        ...
        try {
            synchronized (u.class) {
                str = PreferenceWrapper.getDefault(appContext).getString(q.f2933d, "");
            }
        } catch (Exception unused) {
        }
        return str;
    ...
    public void b(a aVar) {
        List<a> list;
        if (aVar == null || (list = this.f2943d) == null || list.size() == 0) {
            return;
        }
        this.f2943d.remove(aVar);
    }
