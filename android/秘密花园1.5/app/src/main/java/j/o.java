...
public final class o implements a0 {
    ...
    public o(a0 a0Var) {
        if (a0Var != null) {
            ...
            this.f7058d = new p(this.b, inflater);
        ...
        if (i2 >= 0) {
            ...
            if (this.a == 0) {
                ...
                if (z) {
                    u uVar2 = this.b;
                    uVar2.x(2L);
                    d("FHCRC", uVar2.a.G(), (short) this.f7059e.getValue());
                    this.f7059e.reset();
                }
                this.a = (byte) 1;
            }
            ...
            if (this.a == 2) {
                d("CRC", this.b.f(), (int) this.f7059e.getValue());
                d("ISIZE", this.b.f(), (int) this.f7057c.getBytesWritten());
                this.a = (byte) 3;
                if (!this.b.p()) {
    ...
    public final void e(g gVar, long j2, long j3) {
        ...
        do {
            ...
            if (j2 < i3 - i4) {
                while (j3 > 0) {
                    int min = (int) Math.min(vVar.f7065c - i2, j3);
                    this.f7059e.update(vVar.a, (int) (vVar.b + j2), min);
                    j3 -= min;
                    vVar = vVar.f7068f;
                    if (vVar == null) {
                        h.o.c.g.e();
