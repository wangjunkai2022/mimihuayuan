...
public final class g implements j, i, Cloneable, ByteChannel {
    ...
    public static final byte[] f7052c;
    public v a;
    public long b;
    ...
    */
    ...
    public final v L(int i2) {
        ...
        if ((i2 < 1 || i2 > 8192) ? false : false) {
            ...
            if (vVar == null) {
                ...
                v vVar2 = vVar.f7069g;
                if (vVar2 != null) {
                    if (vVar2.f7065c + i2 > 8192 || !vVar2.f7067e) {
                        v b2 = w.b();
                        vVar2.b(b2);
                        return b2;
                    }
    ...
    public g O(byte[] bArr, int i2, int i3) {
        if (bArr != null) {
            ...
            while (i2 < i4) {
                v L = L(1);
                int min = Math.min(i4 - i2, 8192 - L.f7065c);
                System.arraycopy(bArr, i2, L.a, L.f7065c, min);
                i2 += min;
                L.f7065c += min;
            }
            this.b += j2;
    ...
    public g k(long j2) {
        ...
        for (int i3 = (i2 + numberOfTrailingZeros) - 1; i3 >= i2; i3--) {
            bArr[i3] = f7052c[(int) (15 & j2)];
            j2 >>>= 4;
        }
        L.f7065c += numberOfTrailingZeros;
    ...
    public Object clone() {
        ...
        if (this.b != 0) {
            ...
            if (vVar != null) {
                ...
                v vVar2 = this.a;
                if (vVar2 != null) {
                    for (v vVar3 = vVar2.f7068f; vVar3 != this.a; vVar3 = vVar3.f7068f) {
                        v vVar4 = gVar.a;
                        if (vVar4 == null) {
                            h.o.c.g.e();
                            throw null;
                        }
                        v vVar5 = vVar4.f7069g;
                        if (vVar5 == null) {
                            h.o.c.g.e();
                            throw null;
                        } else if (vVar3 != null) {
    ...
    public final long d() {
        ...
        if (vVar2 != null) {
            int i2 = vVar2.f7065c;
            return (i2 >= 8192 || !vVar2.f7067e) ? j2 : j2 - (i2 - vVar2.b);
        }
        h.o.c.g.e();
        throw null;
    }
                ...
                if (j2 < i2 - i3) {
                    while (j3 > 0) {
                        if (vVar != null) {
                            ...
                            int i4 = c2.b + ((int) j2);
                            c2.b = i4;
                            c2.f7065c = Math.min(i4 + ((int) j3), c2.f7065c);
                            v vVar2 = gVar.a;
                            if (vVar2 == null) {
                                c2.f7069g = c2;
                                c2.f7068f = c2;
        ...
        if (obj instanceof g) {
            ...
            if (vVar != null) {
                ...
                if (vVar2 != null) {
                    ...
                    long j4 = 0;
                    while (j4 < this.b) {
                        long min = Math.min(vVar.f7065c - i2, vVar2.f7065c - i3);
                        long j5 = j3;
                        while (j5 < min) {
                            int i4 = i2 + 1;
                            int i5 = i3 + 1;
    ...
    public long g(byte b, long j2, long j3) {
        ...
        if (0 <= j4 && j5 >= j4) {
            ...
            if (j9 - j4 < j4) {
                ...
                while (j9 < j5) {
                    byte[] bArr = vVar.a;
                    int min = (int) Math.min(vVar.f7065c, (vVar.b + j5) - j9);
            ...
            while (true) {
                long j10 = (vVar.f7065c - vVar.b) + j6;
                if (j10 > j4) {
                    while (j6 < j5) {
                        byte[] bArr2 = vVar.a;
                        int min2 = (int) Math.min(vVar.f7065c, (vVar.b + j5) - j6);
                        for (int i3 = (int) ((vVar.b + j4) - j6); i3 < min2; i3++) {
                            if (bArr2[i3] == b) {
                                return (i3 - vVar.b) + j6;
                            }
                        }
                        j6 += vVar.f7065c - vVar.b;
                        vVar = vVar.f7068f;
                        if (vVar == null) {
                            h.o.c.g.e();
                            throw null;
            ...
            while (j2 > 0) {
                ...
                if (vVar2 != null) {
                    if (j2 < i2 - vVar2.b) {
                        ...
                        if (vVar != null && vVar.f7067e) {
                            if ((vVar.f7065c + j2) - (vVar.f7066d ? 0 : vVar.b) <= 8192) {
                                v vVar4 = gVar.a;
                                if (vVar4 != null) {
                                    vVar4.d(vVar, (int) j2);
                                    gVar.b -= j2;
                        ...
                        int i3 = (int) j2;
                        if (vVar5 != null) {
                            if (i3 > 0 && i3 <= vVar5.f7065c - vVar5.b) {
                                if (i3 >= 1024) {
                                    b = vVar5.c();
                                } else {
                                    b = w.b();
                    ...
                    if (vVar7 != null) {
                        ...
                        if (vVar8 == null) {
                            ...
                            v vVar9 = vVar8.f7069g;
                            if (vVar9 != null) {
                                vVar9.b(vVar7);
                                if (vVar7.f7069g != vVar7) {
                                    v vVar10 = vVar7.f7069g;
                                    if (vVar10 == null) {
                                        h.o.c.g.e();
                                        throw null;
                                    } else if (vVar10.f7067e) {
                                        int i4 = vVar7.f7065c - vVar7.b;
                                        if (i4 <= (8192 - vVar10.f7065c) + (vVar10.f7066d ? 0 : vVar10.b)) {
                                            v vVar11 = vVar7.f7069g;
                                            if (vVar11 != null) {
                                                vVar7.d(vVar11, i4);
                                                vVar7.a();
                                                w.a(vVar7);
    ...
    public int read(byte[] bArr, int i2, int i3) {
        ...
        v vVar = this.a;
        if (vVar != null) {
            int min = Math.min(i3, vVar.f7065c - vVar.b);
    ...
    public void skip(long j2) throws EOFException {
        while (j2 > 0) {
            v vVar = this.a;
            if (vVar != null) {
                int min = (int) Math.min(j2, vVar.f7065c - vVar.b);
                long j3 = min;
                this.b -= j3;
                j2 -= j3;
                int i2 = vVar.b + min;
    ...
    */
    ...
    public int write(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer != null) {
            ...
            while (i2 > 0) {
                v L = L(1);
                int min = Math.min(i2, 8192 - L.f7065c);
                byteBuffer.get(L.a, L.f7065c, min);
                i2 -= min;
                L.f7065c += min;
            }
            this.b += remaining;
    ...
    public int read(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer != null) {
            v vVar = this.a;
            if (vVar != null) {
                int min = Math.min(byteBuffer.remaining(), vVar.f7065c - vVar.b);
