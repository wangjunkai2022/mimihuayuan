        ...
        while (i9 < childCount) {
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.isGuideline) {
                    ...
                    if (i18 != -1) {
                        ConstraintWidget targetWidget5 = getTargetWidget(i18);
                        ...
                        if (i12 != -1) {
                            ...
                            if (targetWidget6 != null) {
                                ...
                                i2 = i17;
                                i3 = i15;
                                viewWidget2.immediateConnect(type, targetWidget6, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i16);
                            } else {
                                f2 = f4;
                                i2 = i17;
                                i3 = i15;
                            ...
                            if (i13 != -1 && (targetWidget = getTargetWidget(i13)) != null) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget, ConstraintAnchor.Type.RIGHT, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i16);
                            }
                        }
                        if (i14 != -1) {
                            ...
                            int i19 = i3;
                            if (i19 != -1 && (targetWidget2 = getTargetWidget(i19)) != null) {
                        ...
                        if (i20 != -1) {
                            ConstraintWidget targetWidget8 = getTargetWidget(i20);
                        ...
                        if (i22 != -1) {
                            ConstraintWidget targetWidget9 = getTargetWidget(i22);
                            ...
                            if (i23 != -1 && (targetWidget4 = getTargetWidget(i23)) != null) {
                        ...
                        if (i24 != -1) {
                            View view = this.mChildrenByIds.get(i24);
