...
public final class l0 {
    ...
    public static final class b implements ParameterizedType {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.a = type;
            this.b = type2;
            this.f7270c = (Type[]) typeArr.clone();
        }
        ...
        public int hashCode() {
            int hashCode = Arrays.hashCode(this.f7270c) ^ this.b.hashCode();
            Type type = this.a;
            return hashCode ^ (type != null ? type.hashCode() : 0);
        }

        public String toString() {
            Type[] typeArr = this.f7270c;
            if (typeArr.length == 0) {
                return l0.p(this.b);
            }
            ...
            sb.append("<");
            sb.append(l0.p(this.f7270c[0]));
            for (int i2 = 1; i2 < this.f7270c.length; i2++) {
                sb.append(", ");
                sb.append(l0.p(this.f7270c[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static i.i0 a(i.i0 i0Var) throws IOException {
        j.g gVar = new j.g();
        i0Var.G().w(gVar);
        return new i.j0(gVar, i0Var.E(), i0Var.g());
    }
