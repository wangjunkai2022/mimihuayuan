...
public abstract class c {
    ...
    public static final c b = new c("BeforeHtml", 1) { // from class: k.a.f.c.p
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.c()) {
                ...
                if (iVar.f()) {
                    i.h hVar = (i.h) iVar;
                    if (hVar.f7159c.equals("html")) {
                        bVar.t(hVar);
                        bVar.f7115k = c.f7118c;
                        return true;
                    }
                }
                if (iVar.e() && k.a.d.a.d(((i.g) iVar).f7159c, x.f7131e)) {
                    return d(iVar, bVar);
                }
                if (iVar.e()) {
                    bVar.k(this);
        ...
        public final boolean d(k.a.f.i iVar, k.a.f.b bVar) {
            if (bVar != null) {
                k.a.e.h hVar = new k.a.e.h(k.a.f.h.a("html", bVar.f7199h), null, null);
                bVar.A(hVar);
                bVar.f7196e.add(hVar);
                c cVar = c.f7118c;
                bVar.f7115k = cVar;
                bVar.f7198g = iVar;
    ...
    public static final c f7118c = new c("BeforeHead", 2) { // from class: k.a.f.c.q
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (c.a(iVar)) {
                bVar.u((i.c) iVar);
                ...
                bVar.k(this);
                return false;
            } else if (iVar.f() && ((i.h) iVar).f7159c.equals("html")) {
                return c.f7122g.c(iVar, bVar);
            } else {
                if (iVar.f()) {
                    i.h hVar = (i.h) iVar;
                    if (hVar.f7159c.equals("head")) {
                        bVar.n = bVar.t(hVar);
                        bVar.f7115k = c.f7119d;
                        return true;
                    }
                }
                if (iVar.e() && k.a.d.a.d(((i.g) iVar).f7159c, x.f7131e)) {
                    bVar.e("head");
                    bVar.f7198g = iVar;
                    return bVar.f7115k.c(iVar, bVar);
                } else if (iVar.e()) {
                    bVar.k(this);
                    return false;
                } else {
    ...
    public static final c f7119d = new c("InHead", 3) { // from class: k.a.f.c.r
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (c.a(iVar)) {
                bVar.u((i.c) iVar);
            ...
            if (ordinal == 1) {
                ...
                if (k.a.d.a.d(str, x.a)) {
                    ...
                    if (str.equals("base") && w2.m("href") && !bVar.f7117m) {
                        String a2 = w2.a("href");
                        if (a2.length() != 0) {
                            bVar.f7197f = a2;
                            bVar.f7117m = true;
                            k.a.e.f fVar = bVar.f7195d;
                            if (fVar != null) {
                                j.b.s(a2);
                                fVar.d().n(k.a.e.h.f7092h, a2);
                            } else {
                                throw null;
                            }
                        }
                    ...
                    bVar.f7194c.f7172c = k.a.f.l.f7183c;
                    bVar.f7116l = bVar.f7115k;
                    bVar.f7115k = c.f7123h;
                    bVar.t(hVar);
                } else if (k.a.d.a.d(str, x.b)) {
                    c.b(hVar, bVar);
                } else if (str.equals("noscript")) {
                    bVar.t(hVar);
                    bVar.f7115k = c.f7120e;
                } else if (str.equals("script")) {
                    bVar.f7194c.f7172c = k.a.f.l.f7186f;
                    bVar.f7116l = bVar.f7115k;
                    bVar.f7115k = c.f7123h;
                    bVar.t(hVar);
                ...
                String str2 = ((i.g) iVar).f7159c;
                if (str2.equals("head")) {
                    bVar.E();
                    bVar.f7115k = c.f7121f;
                } else if (k.a.d.a.d(str2, x.f7129c)) {
                    return d(iVar, bVar);
                } else {
                    bVar.k(this);
                    return false;
    ...
    public static final c f7120e = new c("InHeadNoscript", 4) { // from class: k.a.f.c.s
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.c()) {
                bVar.k(this);
                ...
                bVar.f7198g = iVar;
                return cVar.c(iVar, bVar);
            } else if (iVar.e() && ((i.g) iVar).f7159c.equals("noscript")) {
                bVar.E();
                bVar.f7115k = c.f7119d;
            } else if (!c.a(iVar) && !iVar.b() && (!iVar.f() || !k.a.d.a.d(((i.h) iVar).f7159c, x.f7132f))) {
                if (iVar.e() && ((i.g) iVar).f7159c.equals("br")) {
                    bVar.k(this);
                    i.c cVar2 = new i.c();
                    cVar2.b = iVar.toString();
                    bVar.u(cVar2);
                    return true;
                } else if ((iVar.f() && k.a.d.a.d(((i.h) iVar).f7159c, x.K)) || iVar.e()) {
                    bVar.k(this);
                    return false;
                } else {
                    bVar.k(this);
    ...
    public static final c f7121f = new c("AfterHead", 5) { // from class: k.a.f.c.t
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (c.a(iVar)) {
                bVar.u((i.c) iVar);
                ...
                if (str.equals("html")) {
                    ...
                    bVar.t(hVar);
                    bVar.t = false;
                    bVar.f7115k = c.f7122g;
                    return true;
                } else if (str.equals("frameset")) {
                    bVar.t(hVar);
                    bVar.f7115k = c.s;
                    return true;
                } else if (k.a.d.a.d(str, x.f7133g)) {
                    bVar.k(this);
                    k.a.e.h hVar2 = bVar.n;
                    bVar.f7196e.add(hVar2);
                    c cVar2 = c.f7119d;
                    bVar.f7198g = iVar;
                    cVar2.c(iVar, bVar);
                    bVar.J(hVar2);
                ...
                if (k.a.d.a.d(((i.g) iVar).f7159c, x.f7130d)) {
                    d(iVar, bVar);
                    return true;
                }
                bVar.k(this);
    ...
    public static final c f7122g = new c("InBody", 6) { // from class: k.a.f.c.u
        ...
        */
        ...
        public boolean d(k.a.f.i iVar, k.a.f.b bVar) {
            String str = ((i.g) iVar).f7159c;
            ArrayList<k.a.e.h> arrayList = bVar.f7196e;
    ...
    public static final c f7123h = new c("Text", 7) { // from class: k.a.f.c.v
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.a()) {
                bVar.u((i.c) iVar);
    ...
    public static final c f7124i = new c("InTable", 8) { // from class: k.a.f.c.w
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.a()) {
                ...
                if (str.equals("caption")) {
                    ...
                    bVar.z();
                    bVar.t(hVar);
                    bVar.f7115k = c.f7126k;
                } else if (str.equals("colgroup")) {
                    bVar.j();
                    bVar.t(hVar);
                    bVar.f7115k = c.f7127l;
                    ...
                    if (!hVar.f7166j.g("type").equalsIgnoreCase("hidden")) {
                        return d(iVar, bVar);
                    }
                    bVar.w(hVar);
                ...
                if (bVar.a().f7093c.b.equals("html")) {
                    bVar.k(this);
                }
                return true;
            } else {
        ...
        public boolean d(k.a.f.i iVar, k.a.f.b bVar) {
            bVar.k(this);
            if (k.a.d.a.d(bVar.a().f7093c.b, x.C)) {
                bVar.u = true;
                c cVar = c.f7122g;
                bVar.f7198g = iVar;
    ...
    public static final c f7125j = new c("InTableText", 9) { // from class: k.a.f.c.a
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
    ...
    public static final c f7126k = new c("InCaption", 10) { // from class: k.a.f.c.b
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.e()) {
                i.g gVar = (i.g) iVar;
                if (gVar.f7159c.equals("caption")) {
                    if (!bVar.s(gVar.f7159c)) {
                        bVar.k(this);
                        return false;
                    }
                    bVar.l(null);
                    if (!bVar.a().f7093c.b.equals("caption")) {
                        bVar.k(this);
                    }
                    bVar.F("caption");
                    bVar.g();
                    bVar.f7115k = c.f7124i;
                    return true;
                }
            }
            if ((iVar.f() && k.a.d.a.d(((i.h) iVar).f7159c, x.A)) || (iVar.e() && ((i.g) iVar).f7159c.equals("table"))) {
                bVar.k(this);
                if (bVar.d("caption")) {
                    bVar.f7198g = iVar;
                    return bVar.f7115k.c(iVar, bVar);
                ...
                return true;
            } else if (iVar.e() && k.a.d.a.d(((i.g) iVar).f7159c, x.L)) {
                bVar.k(this);
                return false;
            } else {
                c cVar = c.f7122g;
    ...
    public static final c f7127l = new c("InColumnGroup", 11) { // from class: k.a.f.c.c
        ...
        */
        public boolean c(k.a.f.i r8, k.a.f.b r9) {
            ...
            L43:
                ...
                java.lang.String r0 = r0.f7159c
                java.lang.String r4 = "colgroup"
                boolean r0 = r0.equals(r4)
                if (r0 == 0) goto L6a
                k.a.e.h r8 = r9.a()
                k.a.f.h r8 = r8.f7093c
    ...
    public static final c f7128m = new c("InTableBody", 12) { // from class: k.a.f.c.d
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            int ordinal = iVar.a.ordinal();
            if (ordinal == 1) {
                ...
                if (str.equals("template")) {
                    ...
                    bVar.e("tr");
                    bVar.f7198g = hVar;
                    return bVar.f7115k.c(hVar, bVar);
    ...
    public static final c o = new c("InCell", 14) { // from class: k.a.f.c.f
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            ...
            } else if (iVar.f() && k.a.d.a.d(((i.h) iVar).f7159c, x.A)) {
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            ...
            if (ordinal == 1) {
                ...
                if (str.equals("html")) {
                    ...
                    if (bVar.a().f7093c.b.equals("option")) {
                        bVar.d("option");
                    }
                    bVar.t(hVar);
                    ...
                    if (bVar.a().f7093c.b.equals("optgroup")) {
                        bVar.d("optgroup");
                    }
                    bVar.t(hVar);
                ...
                if (c2 == 0) {
                    if (bVar.a().f7093c.b.equals("option") && bVar.f(bVar.a()) != null && bVar.f(bVar.a()).f7093c.b.equals("optgroup")) {
                        bVar.d("option");
                    }
                    if (bVar.a().f7093c.b.equals("optgroup")) {
                        bVar.E();
                ...
                } else if (bVar.a().f7093c.b.equals("option")) {
                    bVar.E();
                } else {
                    bVar.k(this);
                }
                ...
                bVar.k(this);
                return false;
            } else if (!bVar.a().f7093c.b.equals("html")) {
                bVar.k(this);
            }
            return true;
        }
    ...
    public static final c q = new c("InSelectInTable", 16) { // from class: k.a.f.c.h
        @Override // k.a.f.c
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.f() && k.a.d.a.d(((i.h) iVar).f7159c, x.I)) {
                bVar.k(this);
                bVar.d("select");
                bVar.f7198g = iVar;
                return bVar.f7115k.c(iVar, bVar);
    ...
    public static final c r = new c("AfterBody", 17) { // from class: k.a.f.c.i
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (c.a(iVar)) {
                ...
                bVar.f7198g = iVar;
                return cVar.c(iVar, bVar);
            } else if (iVar.e() && ((i.g) iVar).f7159c.equals("html")) {
                if (bVar.v) {
                    bVar.k(this);
                    return false;
                }
    ...
    public static final c s = new c("InFrameset", 18) { // from class: k.a.f.c.j
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            ...
            } else if (iVar.e() && ((i.g) iVar).f7159c.equals("frameset")) {
                if (bVar.a().f7093c.b.equals("html")) {
                    bVar.k(this);
                    return false;
                }
                bVar.E();
                if (!bVar.v && !bVar.a().f7093c.b.equals("frameset")) {
                    bVar.f7115k = c.t;
                }
            } else if (iVar.d()) {
                if (!bVar.a().f7093c.b.equals("html")) {
    ...
    public static final c t = new c("AfterFrameset", 19) { // from class: k.a.f.c.l
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (c.a(iVar)) {
                ...
                bVar.f7115k = c.v;
                return true;
            } else if (iVar.f() && ((i.h) iVar).f7159c.equals("noframes")) {
                c cVar2 = c.f7119d;
                bVar.f7198g = iVar;
                return cVar2.c(iVar, bVar);
            } else if (iVar.d()) {
        ...
        */
        public boolean c(k.a.f.i r12, k.a.f.b r13) {
            ...
            L28:
                ...
                r13.u(r12)
                java.util.ArrayList<k.a.e.h> r12 = r13.f7196e
                r12.add(r0)
                java.util.ArrayList<k.a.e.h> r12 = r13.f7196e
    ...
    public static final c v = new c("AfterAfterFrameset", 21) { // from class: k.a.f.c.n
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            if (iVar.b()) {
                bVar.v((i.d) iVar);
                return true;
            } else if (!iVar.c() && !c.a(iVar) && (!iVar.f() || !((i.h) iVar).f7159c.equals("html"))) {
                if (iVar.d()) {
                    return true;
                }
                if (iVar.f() && ((i.h) iVar).f7159c.equals("noframes")) {
                    c cVar = c.f7119d;
                    bVar.f7198g = iVar;
                    return cVar.c(iVar, bVar);
                }
        ...
        public boolean c(k.a.f.i iVar, k.a.f.b bVar) {
            ...
            if (iVar.b()) {
                ...
                if (fVar != null) {
                    ...
                    k.a.e.g gVar = new k.a.e.g(trim, eVar.f7156d.toString(), eVar.f7157e.toString());
    ...
    public static final class x {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final String[] f7129c = {"body", "br", "html"};

        /* renamed from: d  reason: collision with root package name */
        public static final String[] f7130d = {"body", "html"};

        /* renamed from: e  reason: collision with root package name */
        public static final String[] f7131e = {"body", "br", "head", "html"};

        /* renamed from: f  reason: collision with root package name */
        public static final String[] f7132f = {"basefont", "bgsound", "link", "meta", "noframes", "style"};

        /* renamed from: g  reason: collision with root package name */
        public static final String[] f7133g = {"base", "basefont", "bgsound", "command", "link", "meta", "noframes", "script", "style", NotificationCompatJellybean.KEY_TITLE};

        /* renamed from: h  reason: collision with root package name */
        public static final String[] f7134h = {"address", "article", "aside", "blockquote", "center", "details", "dir", "div", "dl", "fieldset", "figcaption", "figure", "footer", "header", "hgroup", SupportMenuInflater.XML_MENU, "nav", "ol", com.umeng.commonsdk.proguard.e.ao, "section", "summary", "ul"};

        /* renamed from: i  reason: collision with root package name */
        public static final String[] f7135i = {"h1", "h2", "h3", "h4", "h5", "h6"};

        /* renamed from: j  reason: collision with root package name */
        public static final String[] f7136j = {"address", "div", com.umeng.commonsdk.proguard.e.ao};

        /* renamed from: k  reason: collision with root package name */
        public static final String[] f7137k = {"dd", "dt"};

        /* renamed from: l  reason: collision with root package name */
        public static final String[] f7138l = {"b", "big", "code", "em", "font", com.umeng.commonsdk.proguard.e.aq, com.umeng.commonsdk.proguard.e.ap, "small", "strike", "strong", "tt", "u"};

        /* renamed from: m  reason: collision with root package name */
        public static final String[] f7139m = {"applet", "marquee", "object"};
    ...
    static {
        ...
        w = cVar;
        y = new c[]{a, b, f7118c, f7119d, f7120e, f7121f, f7122g, f7123h, f7124i, f7125j, f7126k, f7127l, f7128m, n, o, p, q, r, s, t, u, v, cVar};
    ...
    public static void b(i.h hVar, k.a.f.b bVar) {
        bVar.f7194c.f7172c = k.a.f.l.f7185e;
        bVar.f7116l = bVar.f7115k;
        bVar.f7115k = f7123h;
        bVar.t(hVar);
    }
