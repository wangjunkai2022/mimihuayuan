...
public class b {
    ...
    public static String f3917c = e.a("dicw");

    /* renamed from: d  reason: collision with root package name */
    public static String f3918d = SignHelper.getMM2(App.b);

    public static String a(String str) {
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(f3918d.getBytes(e.a("QhYFSVM=")), f3917c);
