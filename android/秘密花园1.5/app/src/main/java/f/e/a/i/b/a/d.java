...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3885h = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f3886c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f3887d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f3888e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3889f;

    /* renamed from: g  reason: collision with root package name */
    public ByteArrayOutputStream f3890g = null;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3887d = h0Var.f6527h;
        if (h0Var.g()) {
            i0 i0Var = this.f3887d;
            h.s(i0Var, "Argument must not be null");
            InputStream bVar = new f.d.a.u.b(this.f3887d.d(), i0Var.g());
            this.f3886c = bVar;
            d.a<? super InputStream> aVar = this.f3888e;
            try {
        ...
        this.f3888e.c(new f.d.a.o.e(h0Var.f6523d, h0Var.f6524e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3885h, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3888e.c(iOException);
    }
