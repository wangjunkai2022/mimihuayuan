...
public class f extends j<TokenBean> {
    ...
    public final /* synthetic */ FuLao2Launch2Activity f3974e;

    public f(FuLao2Launch2Activity fuLao2Launch2Activity) {
        this.f3974e = fuLao2Launch2Activity;
    }
    ...
    public void f(TokenBean tokenBean) {
        ...
        f.e.a.k.f.b();
        FuLao2Launch2Activity fuLao2Launch2Activity = this.f3974e;
        fuLao2Launch2Activity.f778g = true;
