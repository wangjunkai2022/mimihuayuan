...
public class g {
    ...
    public void c(Class<? extends g0> cls, int i2) {
        ...
        if (!g.a.e0.class.isAssignableFrom(cls)) {
            ...
            Table table = xVar.f6392j.d(cls).f6345c;
            tableQuery = new TableQuery(table.b, table, table.nativeWhere(table.a));
        }
        xVar.f();
        g.a.f1.w.a aVar = g.a.f1.w.a.f6330d;
        if (aVar.a != null) {
            b2 = g.a.f1.r.e(xVar.f6266d, tableQuery, descriptorOrdering, aVar);
        } else {
            b2 = OsResults.b(xVar.f6266d, tableQuery, descriptorOrdering);
        }
