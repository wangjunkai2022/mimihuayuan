...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3976g = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f3977c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f3978d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f3979e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3980f;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        Closeable closeable;
        this.f3978d = h0Var.f6527h;
        if (h0Var.g()) {
            i0 i0Var = this.f3978d;
            h.s(i0Var, "Argument must not be null");
            f.d.a.u.b bVar = new f.d.a.u.b(this.f3978d.d(), i0Var.g());
            this.f3977c = bVar;
            d.a<? super InputStream> aVar = this.f3979e;
            try {
                ...
                e2.printStackTrace();
                closeable = this.f3977c;
            }
            aVar.d(closeable);
            return;
        }
        this.f3979e.c(new f.d.a.o.e(h0Var.f6523d, h0Var.f6524e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3976g, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3979e.c(iOException);
    }
