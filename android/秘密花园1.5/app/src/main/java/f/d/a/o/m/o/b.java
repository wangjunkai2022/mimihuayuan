...
public class b implements f.d.a.o.m.d<InputStream> {
    ...
    public static b c(Context context, Uri uri, c cVar) {
        return new b(uri, new d(f.d.a.c.b(context).f3434d.e(), cVar, f.d.a.c.b(context).f3435e, context.getContentResolver()));
    }
    ...
    @Override // f.d.a.o.m.d
    public void b() {
        InputStream inputStream = this.f3564c;
        if (inputStream != null) {
            try {
                inputStream.close();
