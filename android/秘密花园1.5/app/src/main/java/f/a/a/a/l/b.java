...
public abstract class b extends j {
    ...
    public Rect f3383k = new Rect();

    /* renamed from: m  reason: collision with root package name */
    public float f3385m = Float.NaN;
    public int n = 0;
    ...
    public void a(RecyclerView.Recycler recycler, RecyclerView.State state, int i2, int i3, int i4, f.a.a.a.c cVar) {
        View view;
        if (y()) {
            if (((i4 == Integer.MAX_VALUE || i4 == Integer.MIN_VALUE) ? false : true) && (view = this.f3384l) != null) {
                this.f3383k.union(view.getLeft(), this.f3384l.getTop(), this.f3384l.getRight(), this.f3384l.getBottom());
            }
            if (!this.f3383k.isEmpty()) {
                if ((i4 == Integer.MAX_VALUE || i4 == Integer.MIN_VALUE) ? false : true) {
                    if (cVar.getOrientation() == 1) {
                        this.f3383k.offset(0, -i4);
                    } else {
                        this.f3383k.offset(-i4, 0);
                    }
                }
                ...
                if (virtualLayoutManager.getOrientation() != 1 ? this.f3383k.intersects((-j2) / 4, 0, (j2 / 4) + j2, i5) : this.f3383k.intersects(0, (-i5) / 4, j2, (i5 / 4) + i5)) {
                    if (this.f3384l == null) {
                    ...
                    if (virtualLayoutManager.getOrientation() == 1) {
                        this.f3383k.left = virtualLayoutManager.getPaddingLeft() + this.f3396g;
                        this.f3383k.right = (virtualLayoutManager.j() - virtualLayoutManager.getPaddingRight()) - this.f3397h;
                    } else {
                        this.f3383k.top = virtualLayoutManager.getPaddingTop() + this.f3398i;
                        this.f3383k.bottom = (virtualLayoutManager.j() - virtualLayoutManager.getPaddingBottom()) - this.f3399j;
                    }
                    View view2 = this.f3384l;
                    view2.measure(View.MeasureSpec.makeMeasureSpec(this.f3383k.width(), 1073741824), View.MeasureSpec.makeMeasureSpec(this.f3383k.height(), 1073741824));
                    Rect rect = this.f3383k;
                    ...
                    this.f3383k.set(0, 0, 0, 0);
                    return;
                }
                this.f3383k.set(0, 0, 0, 0);
                View view3 = this.f3384l;
                if (view3 != null) {
                    view3.layout(0, 0, 0, 0);
                }
            }
        }
        View view4 = this.f3384l;
        if (view4 != null) {
    ...
    */
    ...
    public void t(h hVar, View view) {
        ...
        if (!hVar.f3391d && !view.isFocusable()) {
            z = false;
        }
        hVar.f3391d = z;
    }
    ...
    public void u(View view, int i2, int i3, int i4, int i5, @NonNull f.a.a.a.c cVar) {
        ...
        if (y()) {
            this.f3383k.union(i2 - this.f3392c, i3 - this.f3394e, i4 + this.f3393d, i5 + this.f3395f);
        }
    }
