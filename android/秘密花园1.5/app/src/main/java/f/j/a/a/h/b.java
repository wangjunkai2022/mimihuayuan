...
public class b extends c<b> implements e {
    ...
    public b(Context context) {
        ...
        this.f6253m = obtainStyledAttributes.getInt(d.ClassicsFooter_srlFinishDuration, this.f6253m);
        this.b = f.j.a.a.g.c.f6212i[obtainStyledAttributes.getInt(d.ClassicsFooter_srlClassicsSpinnerStyle, this.b.a)];
        if (obtainStyledAttributes.hasValue(d.ClassicsFooter_srlDrawableArrow)) {
            this.f6245e.setImageDrawable(obtainStyledAttributes.getDrawable(d.ClassicsFooter_srlDrawableArrow));
        ...
        if (obtainStyledAttributes.hasValue(d.ClassicsFooter_srlDrawableProgress)) {
            this.f6246f.setImageDrawable(obtainStyledAttributes.getDrawable(d.ClassicsFooter_srlDrawableProgress));
        ...
        if (obtainStyledAttributes.hasValue(d.ClassicsFooter_srlTextSizeTitle)) {
            this.f6244d.setTextSize(0, obtainStyledAttributes.getDimensionPixelSize(d.ClassicsFooter_srlTextSizeTitle, f.j.a.a.m.b.d(16.0f)));
        }
        ...
        this.f6244d.setText(isInEditMode() ? this.s : this.q);
        if (isInEditMode()) {
        ...
        if (ordinal == 0) {
            ...
            if (ordinal != 6) {
                switch (ordinal) {
                    ...
                    case 12:
                        imageView.setVisibility(8);
                        this.f6244d.setText(this.s);
                        return;
                    case 11:
                        this.f6244d.setText(this.t);
                        imageView.setVisibility(8);
                        return;
                    default:
                        return;
            ...
            this.f6244d.setText(this.r);
            imageView.animate().rotation(0.0f);
            return;
        }
        this.f6244d.setText(this.q);
    ...
    public int i(@NonNull i iVar, boolean z) {
        ...
        this.f6244d.setText(z ? this.u : this.v);
