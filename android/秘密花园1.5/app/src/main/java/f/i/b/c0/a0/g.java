...
public final class g implements a0 {
    ...
    public final class a<K, V> extends z<Map<K, V>> {
        ...
        public final t<? extends Map<K, V>> f6087c;
                    ...
                    if (zVar != null) {
                        try {
                            ...
                            if (fVar.f6085l.isEmpty()) {
                                ...
                                throw new IllegalStateException("Expected one JSON element but was " + fVar.f6085l);
                            }
