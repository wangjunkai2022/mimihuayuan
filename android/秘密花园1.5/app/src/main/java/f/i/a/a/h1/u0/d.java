...
public class d implements f.i.a.a.l1.m {
    ...
    public CipherInputStream f5101d;
    ...
    public final long b(f.i.a.a.l1.p pVar) throws IOException {
        try {
            ...
            try {
                cipher.init(2, new SecretKeySpec(this.b, "AES"), new IvParameterSpec(this.f5100c));
                f.i.a.a.l1.o oVar = new f.i.a.a.l1.o(this.a, pVar);
                this.f5101d = new CipherInputStream(oVar, cipher);
                if (oVar.f5675d) {
                    return -1L;
                }
                oVar.a.b(oVar.b);
    ...
    public final int read(byte[] bArr, int i2, int i3) throws IOException {
        c.a.a.b.g.h.t(this.f5101d);
        int read = this.f5101d.read(bArr, i2, i3);
        if (read < 0) {
            return -1;
        }
        return read;
