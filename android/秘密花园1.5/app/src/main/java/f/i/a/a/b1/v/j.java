...
public final class j extends h {
    ...
    public void c(long j2) {
        ...
        this.p = j2 != 0;
        m mVar = this.q;
        this.o = mVar != null ? mVar.f4356d : 0;
    }
    ...
    public long d(u uVar) {
        ...
        byte b = bArr[0];
        a aVar = this.n;
        if (!aVar.f4353c[(b >> 1) & (255 >>> (8 - aVar.f4354d))].a) {
            i2 = aVar.a.f4356d;
        } else {
            i2 = aVar.a.f4357e;
        }
        long j2 = this.p ? (this.o + i2) / 4 : 0;
        uVar.z(uVar.f5776c + 4);
        byte[] bArr2 = uVar.a;
        int i3 = uVar.f5776c;
    ...
    public boolean e(u uVar, long j2, h.b bVar) throws IOException, InterruptedException {
        ...
        if (this.q == null) {
            ...
            int f4 = uVar.f();
            int p2 = uVar.p();
            this.q = new m(g2, p, g3, f2, f3, f4, (int) Math.pow(2.0d, p2 & 15), (int) Math.pow(2.0d, (p2 & TbsListener.ErrorCode.TPATCH_VERSION_FAILED) >> 4), (uVar.p() & 1) > 0, Arrays.copyOf(uVar.a, uVar.f5776c));
        } else if (this.r == null) {
            ...
            while (true) {
                ...
                if (i8 < p3) {
                    if (iVar.b(24) == 5653314) {
                        ...
                        o.append((iVar.f4351c * 8) + iVar.f4352d);
        ...
        arrayList.add(this.n.a.f4358f);
        arrayList.add(this.n.b);
        m mVar = this.n.a;
        bVar.a = b0.j(null, "audio/vorbis", null, mVar.f4355c, -1, mVar.a, (int) mVar.b, arrayList, null, 0, null);
        return true;
    }
