...
public class b implements h {
    ...
    public String a(b0 b0Var) {
        String c2;
        int f2 = r.f(b0Var.f4088i);
        if (f2 == -1) {
            if (r.g(b0Var.f4085f) == null) {
                if (r.a(b0Var.f4085f) == null) {
    ...
    public final String d(b0 b0Var) {
        String string = (b0Var.f4083d & 2) != 0 ? this.a.getString(R.string.exo_track_role_alternate) : "";
        if ((b0Var.f4083d & 4) != 0) {
        ...
        return (b0Var.f4083d & 1088) != 0 ? e(string, this.a.getString(R.string.exo_track_role_closed_captions)) : string;
    }
