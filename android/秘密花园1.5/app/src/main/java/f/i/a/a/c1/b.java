...
public abstract class b extends p {
    ...
    public final int F(b0 b0Var) throws w {
        try {
            return k0(this.f4602j, this.f4603k, b0Var);
        } catch (d.c e2) {
            throw w.a(e2, this.f5834c);
        }
    }
    ...
    public final List<f.i.a.a.c1.a> O(boolean z) throws d.c {
        List<f.i.a.a.c1.a> R = R(this.f4602j, this.u, z);
        if (R.isEmpty() && z) {
            R = R(this.f4602j, this.u, false);
            if (!R.isEmpty()) {
                StringBuilder o = f.b.a.a.a.o("Drm session requires secure decoder for ");
                o.append(this.u.f4088i);
    ...
    public final void S(f.i.a.a.c1.a aVar, MediaCrypto mediaCrypto) throws Exception {
        ...
        int i2;
        String str = aVar.a;
        float Q = h0.a < 23 ? -1.0f : Q(this.B, this.u, this.f5837f);
        ...
        try {
            ...
            try {
                ...
                this.E = f2;
                this.D = this.u;
                if (h0.a <= 25 && "OMX.Exynos.avc.dec.secure".equals(str) && (h0.f5738d.startsWith("SM-T585") || h0.f5738d.startsWith("SM-A510") || h0.f5738d.startsWith("SM-A520") || h0.f5738d.startsWith("SM-J700"))) {
                    i2 = 2;
                } else {
                ...
                this.I = i2;
                this.J = h0.f5738d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(str);
                this.K = h0.a < 21 && this.D.f4090k.isEmpty() && "OMX.MTK.VIDEO.DECODER.AVC".equals(str);
                int i3 = h0.a;
                this.L = i3 < 18 || (i3 == 18 && ("OMX.SEC.avc.dec".equals(str) || "OMX.SEC.avc.dec.secure".equals(str))) || (h0.a == 19 && h0.f5738d.startsWith("SM-G800") && ("OMX.Exynos.avc.dec".equals(str) || "OMX.Exynos.avc.dec.secure".equals(str)));
                ...
                String str2 = aVar.a;
                this.R = ((h0.a <= 25 && "OMX.rk.video_decoder.avc".equals(str2)) || ((h0.a <= 17 && "OMX.allwinner.video.decoder.avc".equals(str2)) || ("Amazon".equals(h0.f5737c) && "AFTS".equals(h0.f5738d) && aVar.f4599f))) || P();
                f0();
                g0();
                this.U = this.f5835d == 2 ? SystemClock.elapsedRealtime() + 1000 : -9223372036854775807L;
                this.a0 = false;
                this.b0 = 0;
                this.f0 = false;
                this.e0 = false;
            ...
            if (this.y == null) {
                ...
                if (a2 == null) {
                    ...
                    try {
                        ...
                        this.y = mediaCrypto;
                        this.z = !a2.f6077c && mediaCrypto.requiresSecureDecoderComponent(str);
                    } catch (MediaCryptoException e2) {
                        throw w.a(e2, this.f5834c);
                    }
                }
            }
            if ("Amazon".equals(h0.f5737c) && ("AFTM".equals(h0.f5738d) || "AFTB".equals(h0.f5738d))) {
                z = true;
            }
            if (z) {
                int c2 = this.w.c();
                if (c2 == 1) {
                    throw w.a(this.w.b(), this.f5834c);
                }
                if (c2 != 4) {
                    return;
                }
        ...
        if (!this.F.isEmpty()) {
            while (this.C == null) {
                ...
                try {
                    ...
                    a aVar = new a("Decoder init failed: " + str2 + ", " + b0Var, e3, b0Var.f4088i, z, str2, (h0.a < 21 || !(e3 instanceof MediaCodec.CodecException)) ? null : ((MediaCodec.CodecException) e3).getDiagnosticInfo(), null);
                    a aVar2 = this.G;
                    if (aVar2 == null) {
                        this.G = aVar;
                    } else {
                        this.G = new a(aVar2.getMessage(), aVar2.getCause(), aVar2.a, aVar2.b, aVar2.f4606c, aVar2.f4607d, aVar);
                    }
                    if (this.F.isEmpty()) {
                        throw this.G;
                    }
    ...
    */
    ...
    public boolean d() {
        ...
        if (!(g() ? this.f5840i : this.f5836e.d())) {
    ...
    public final void h0(@Nullable f<j> fVar) {
        ...
        ((f.i.a.a.z0.d) this.f4603k).b(fVar2);
    }
    ...
    */
    ...
    public final void l(float f2) throws w {
        this.B = f2;
        if (this.C == null || this.d0 == 3 || this.f5835d == 0) {
            return;
        }
        l0();
    }
    ...
    public final void l0() throws w {
        ...
        float Q = Q(this.B, this.D, this.f5837f);
        float f2 = this.E;
        if (f2 == Q) {
            return;
        }
    ...
    public final b0 n0(long j2) {
        ...
        synchronized (d0Var) {
            b0Var = null;
            while (d0Var.f5735d > 0 && j2 - d0Var.a[d0Var.f5734c] >= 0) {
                b0[] b0VarArr = d0Var.b;
                int i2 = d0Var.f5734c;
                b0 b0Var2 = b0VarArr[i2];
                b0VarArr[i2] = null;
                d0Var.f5734c = (i2 + 1) % b0VarArr.length;
                d0Var.f5735d--;
                b0Var = b0Var2;
            }
        }
        ...
        */
        public a(f.i.a.a.b0 r11, java.lang.Throwable r12, boolean r13, int r14) {
            /*
                ...
                java.lang.String r5 = r11.f4088i
                if (r14 >= 0) goto L20
