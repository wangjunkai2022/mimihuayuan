...
public final class b implements a.b {
    ...
    */
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        b bVar = (b) obj;
        return this.a == bVar.a && h0.b(this.b, bVar.b) && h0.b(this.f4625c, bVar.f4625c) && h0.b(this.f4626d, bVar.f4626d) && this.f4627e == bVar.f4627e && this.f4628f == bVar.f4628f;
    }
    ...
    public int hashCode() {
        ...
        return ((((hashCode2 + (str3 != null ? str3.hashCode() : 0)) * 31) + (this.f4627e ? 1 : 0)) * 31) + this.f4628f;
    }

    public String toString() {
        StringBuilder o = f.b.a.a.a.o("IcyHeaders: name=\"");
        o.append(this.f4625c);
        o.append("\", genre=\"");
        o.append(this.b);
        o.append("\", bitrate=");
        o.append(this.a);
        o.append(", metadataInterval=");
        o.append(this.f4628f);
        return o.toString();
    }
