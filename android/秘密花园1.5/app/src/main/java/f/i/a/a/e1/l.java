...
public class l implements x {
    ...
    public static final Constructor<? extends v> f4708c;
    @Nullable

    /* renamed from: d  reason: collision with root package name */
    public static final Constructor<? extends v> f4709d;
    public final w a;
    ...
    public v a(u uVar) {
        ...
        if (c2 != 0) {
            if (c2 != 1) {
                if (c2 != 2) {
                    if (c2 == 3) {
                        return b(uVar, f4709d);
                    }
                    StringBuilder o = f.b.a.a.a.o("Unsupported type: ");
                    o.append(uVar.b);
                    throw new IllegalArgumentException(o.toString());
                }
                return b(uVar, f4708c);
            }
            return b(uVar, b);
        }
        return new a0(uVar.f4763c, uVar.f4765e, this.a);
    }

    public final v b(u uVar, @Nullable Constructor<? extends v> constructor) {
        if (constructor != null) {
            try {
                return constructor.newInstance(uVar.f4763c, uVar.f4764d, this.a);
            } catch (Exception e2) {
