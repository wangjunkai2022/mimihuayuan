...
public final class c0 {
    ...
    public c0(int i2, int i3, float f2, float f3, int i4) {
        ...
        int i6 = i5 * 2;
        this.f5907h = i6;
        this.f5908i = new short[i6];
        this.f5909j = new short[i6 * i3];
        this.f5911l = new short[i6 * i3];
    ...
    public final void a(short[] sArr, int i2, int i3) {
        short[] c2 = c(this.f5911l, this.f5912m, i3);
        this.f5911l = c2;
        int i4 = this.b;
        System.arraycopy(sArr, i2 * i4, c2, this.f5912m * i4, i4 * i3);
        this.f5912m += i3;
    }

    public final void b(short[] sArr, int i2, int i3) {
        int i4 = this.f5907h / i3;
        int i5 = this.b;
        int i6 = i3 * i5;
        int i7 = i2 * i5;
    ...
    public final void f() {
        ...
        float f4 = f2 / f3;
        float f5 = this.f5904e * f3;
        double d2 = f4;
        float f6 = 1.0f;
        int i10 = 1;
        if (d2 <= 1.00001d && d2 >= 0.99999d) {
            a(this.f5909j, 0, this.f5910k);
            this.f5910k = 0;
        } else {
            int i11 = this.f5910k;
            if (i11 >= this.f5907h) {
                ...
                while (true) {
                    int i13 = this.r;
                    if (i13 > 0) {
                        int min = Math.min(this.f5907h, i13);
                        a(this.f5909j, i12, min);
                        this.r -= min;
                        i12 += min;
                    } else {
                        short[] sArr = this.f5909j;
                        int i14 = this.a;
                        int i15 = i14 > 4000 ? i14 / 4000 : 1;
                        if (this.b == i10 && i15 == i10) {
                            i2 = d(sArr, i12, this.f5905f, this.f5906g);
                        } else {
                            b(sArr, i12, i15);
                            int d3 = d(this.f5908i, 0, this.f5905f / i15, this.f5906g / i15);
                            if (i15 != i10) {
                                int i16 = d3 * i15;
                                int i17 = i15 * 4;
                                int i18 = i16 - i17;
                        ...
                        if (d2 > 1.0d) {
                            ...
                            short[] c2 = c(this.f5911l, this.f5912m, i4);
                            this.f5911l = c2;
                            int i24 = i4;
                            e(i4, this.b, c2, this.f5912m, sArr2, i12, sArr2, i12 + i23);
                            this.f5912m += i24;
                            i12 = i23 + i24 + i12;
                        } else {
                            int i25 = i23;
                            short[] sArr3 = this.f5909j;
                            if (f4 < 0.5f) {
                                i3 = (int) ((i25 * f4) / (f6 - f4));
                            } else {
                            ...
                            int i26 = i25 + i3;
                            short[] c3 = c(this.f5911l, this.f5912m, i26);
                            this.f5911l = c3;
                            int i27 = this.b;
                            System.arraycopy(sArr3, i12 * i27, c3, this.f5912m * i27, i27 * i25);
                            e(i3, this.b, this.f5911l, this.f5912m + i25, sArr3, i12 + i25, sArr3, i12);
                            this.f5912m += i26;
                            i12 += i3;
                        }
                    }
                    if (this.f5907h + i12 > i11) {
                        break;
                    }
                    f6 = 1.0f;
                    i10 = 1;
                }
                int i28 = this.f5910k - i12;
                short[] sArr4 = this.f5909j;
                int i29 = this.b;
        ...
        int i32 = this.f5912m - i9;
        short[] c4 = c(this.n, this.o, i32);
        this.n = c4;
        short[] sArr5 = this.f5911l;
        int i33 = this.b;
        ...
        while (true) {
            ...
            while (true) {
                ...
                this.f5911l = c(this.f5911l, this.f5912m, 1);
                int i36 = 0;
                while (true) {
                    int i37 = this.b;
                    if (i36 < i37) {
                        ...
                        int i43 = i41 - i40;
                        this.f5911l[(this.f5912m * i37) + i36] = (short) ((((i43 - i42) * s2) + (s * i42)) / i43);
                        i36++;
                    }
                }
                this.q++;
