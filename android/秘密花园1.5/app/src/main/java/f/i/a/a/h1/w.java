...
public final class w implements d0, d0.a {
    ...
    public final f.i.a.a.l1.e f5280c;
    ...
    public long f5284g = -9223372036854775807L;
    ...
    public void a(e0.a aVar) {
        ...
        d0 c2 = this.a.c(aVar, this.f5280c, j2);
        this.f5281d = c2;
        if (this.f5282e != null) {
            c2.m(this, j2);
        }
    ...
    public long j(f.i.a.a.j1.j[] jVarArr, boolean[] zArr, k0[] k0VarArr, boolean[] zArr2, long j2) {
        long j3;
        long j4 = this.f5284g;
        if (j4 == -9223372036854775807L || j2 != this.f5283f) {
            j3 = j2;
        } else {
            this.f5284g = -9223372036854775807L;
            j3 = j4;
        }
        return this.f5281d.j(jVarArr, zArr, k0VarArr, zArr2, j3);
    }

    @Override // f.i.a.a.h1.d0
    public long l() {
        return this.f5281d.l();
    }
