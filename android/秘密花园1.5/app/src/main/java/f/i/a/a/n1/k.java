...
public final class k extends Surface {
    ...
    public static int f5810c;

    /* renamed from: d  reason: collision with root package name */
    public static boolean f5811d;
    public final b a;
    public boolean b;
    ...
    public static class b extends HandlerThread implements Handler.Callback {
        ...
        /* renamed from: d  reason: collision with root package name */
        public RuntimeException f5813d;
        @Nullable
            ...
            if (lVar != null) {
                ...
                if (eglGetDisplay != null) {
                    ...
                    if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                        lVar.f5752d = eglGetDisplay;
                        EGLConfig[] eGLConfigArr = new EGLConfig[1];
                        int[] iArr2 = new int[1];
                        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, f.i.a.a.m1.l.f5750h, 0, eGLConfigArr, 0, 1, iArr2, 0);
                        if (eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null) {
                            EGLConfig eGLConfig = eGLConfigArr[0];
                            EGLContext eglCreateContext = EGL14.eglCreateContext(lVar.f5752d, eGLConfig, EGL14.EGL_NO_CONTEXT, i2 == 0 ? new int[]{12440, 2, 12344} : new int[]{12440, 2, 12992, 1, 12344}, 0);
                            if (eglCreateContext != null) {
                                lVar.f5753e = eglCreateContext;
                                EGLDisplay eGLDisplay = lVar.f5752d;
                                if (i2 == 1) {
                                ...
                                if (EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext)) {
                                    lVar.f5754f = eglCreatePbufferSurface;
                                    ...
                                    lVar.f5755g = surfaceTexture;
                                    surfaceTexture.setOnFrameAvailableListener(lVar);
                                    SurfaceTexture surfaceTexture2 = this.a.f5755g;
                                    c.a.a.b.g.h.t(surfaceTexture2);
                                    this.f5814e = new k(this, surfaceTexture2, i2 != 0, null);
                                    return;
                                }
        ...
        public final void b() {
            ...
            try {
                ...
                if (eGLDisplay != null && !eGLDisplay.equals(EGL14.EGL_NO_DISPLAY)) {
                    EGLDisplay eGLDisplay2 = lVar.f5752d;
                    EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                    EGL14.eglMakeCurrent(eGLDisplay2, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
                }
                EGLSurface eGLSurface2 = lVar.f5754f;
                if (eGLSurface2 != null && !eGLSurface2.equals(EGL14.EGL_NO_SURFACE)) {
                    EGL14.eglDestroySurface(lVar.f5752d, lVar.f5754f);
                }
                EGLContext eGLContext = lVar.f5753e;
                if (eGLContext != null) {
                    EGL14.eglDestroyContext(lVar.f5752d, eGLContext);
                }
                if (h0.a >= 19) {
                    EGL14.eglReleaseThread();
                }
                EGLDisplay eGLDisplay3 = lVar.f5752d;
                if (eGLDisplay3 != null && !eGLDisplay3.equals(EGL14.EGL_NO_DISPLAY)) {
                    EGL14.eglTerminate(lVar.f5752d);
                }
                lVar.f5752d = null;
                lVar.f5753e = null;
                lVar.f5754f = null;
    ...
    public static int a(Context context) {
        ...
        if (h0.a >= 26 || !("samsung".equals(h0.f5737c) || "XT1650".equals(h0.f5738d))) {
    ...
    public static k c(Context context, boolean z) {
        if (h0.a >= 17) {
            ...
            synchronized (bVar) {
                ...
                while (bVar.f5814e == null && bVar.f5813d == null && bVar.f5812c == null) {
                    try {
                        bVar.wait();
            ...
            RuntimeException runtimeException = bVar.f5813d;
            if (runtimeException == null) {
                Error error = bVar.f5812c;
                if (error == null) {
                    k kVar = bVar.f5814e;
                    c.a.a.b.g.h.t(kVar);
                    return kVar;
