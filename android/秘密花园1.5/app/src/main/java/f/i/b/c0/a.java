...
public final class a {
    ...
    public static final class b implements ParameterizedType, Serializable {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f6083c = typeArr2;
            int length = typeArr2.length;
            for (int i2 = 0; i2 < length; i2++) {
                c.a.a.b.g.h.u(this.f6083c[i2]);
                a.b(this.f6083c[i2]);
                Type[] typeArr3 = this.f6083c;
        ...
        public int hashCode() {
            int hashCode = Arrays.hashCode(this.f6083c) ^ this.b.hashCode();
            Type type = this.a;
        ...
        public String toString() {
            ...
            sb.append("<");
            sb.append(a.i(this.f6083c[0]));
            for (int i2 = 1; i2 < length; i2++) {
                sb.append(", ");
                sb.append(a.i(this.f6083c[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
