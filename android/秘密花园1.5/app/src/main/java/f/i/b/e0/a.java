...
public class a implements Closeable {
    ...
    public final char[] f6144c = new char[1024];
    ...
    public final boolean G(int i2) throws IOException {
        ...
        do {
            ...
            int i9 = this.f6146e + read;
            this.f6146e = i9;
            if (this.f6147f == 0 && (i3 = this.f6148g) == 0 && i9 > 0 && cArr[0] == 65279) {
                this.f6145d++;
                this.f6148g = i3 + 1;
                i2++;
            }
        } while (this.f6146e < i2);
        return true;
    }
    ...
    public String K() {
        return " at line " + (this.f6147f + 1) + " column " + ((this.f6145d - this.f6148g) + 1) + " path " + H();
    }
    ...
    public double M() throws IOException {
        ...
        if (i2 == 16) {
            this.f6152k = new String(this.f6144c, this.f6145d, this.f6151j);
            this.f6145d += this.f6151j;
        } else if (i2 == 8 || i2 == 9) {
            this.f6152k = S(i2 == 8 ? '\'' : '\"');
        } else if (i2 == 10) {
            this.f6152k = U();
        ...
        this.f6149h = 11;
        double parseDouble = Double.parseDouble(this.f6152k);
    ...
    public int N() throws IOException {
        ...
        if (i2 == 16) {
            ...
            try {
                int parseInt = Integer.parseInt(this.f6152k);
                this.f6149h = 0;
                int[] iArr2 = this.o;
                int i5 = this.f6154m - 1;
                iArr2[i5] = iArr2[i5] + 1;
                return parseInt;
    ...
    public long O() throws IOException {
        ...
        if (i2 == 16) {
            ...
            try {
                long parseLong = Long.parseLong(this.f6152k);
                this.f6149h = 0;
                int[] iArr2 = this.o;
                int i4 = this.f6154m - 1;
                iArr2[i4] = iArr2[i4] + 1;
            ...
            if (c2 == '\n') {
                ...
                if (c2 == '/') {
                    ...
                    if (c3 == '*') {
                        this.f6145d = i5 + 1;
                        while (true) {
                            if (this.f6145d + 2 > this.f6146e && !G(2)) {
                                z2 = false;
                                break;
                            }
                            char[] cArr2 = this.f6144c;
                            int i6 = this.f6145d;
                            if (cArr2[i6] != '\n') {
                                for (int i7 = 0; i7 < 2; i7++) {
                                    if (this.f6144c[this.f6145d + i7] != "*/".charAt(i7)) {
                                        break;
                                    }
                                }
                                break;
    ...
    */
    ...
    public String T() throws IOException {
        ...
        if (i2 == 10) {
            ...
            str = Long.toString(this.f6150i);
        } else if (i2 == 16) {
            str = new String(this.f6144c, this.f6145d, this.f6151j);
            this.f6145d += this.f6151j;
        } else {
    ...
    */
    ...
    public final void W(int i2) {
        ...
        if (i3 == iArr.length) {
            ...
            System.arraycopy(this.o, 0, iArr3, 0, this.f6154m);
            System.arraycopy(this.n, 0, strArr, 0, this.f6154m);
            this.f6153l = iArr2;
            this.o = iArr3;
            this.n = strArr;
        }
        int[] iArr4 = this.f6153l;
        int i4 = this.f6154m;
        this.f6154m = i4 + 1;
        iArr4[i4] = i2;
    }
    ...
    public final char X() throws IOException {
        int i2;
        int i3;
        if (this.f6145d == this.f6146e && !G(1)) {
                                    ...
                                    while (i6 < i7) {
                                        ...
                                        if (c4 < '0' || c4 > '9') {
                                            if (c4 >= 'a' && c4 <= 'f') {
                                                ...
                                                o.append(new String(this.f6144c, this.f6145d, 4));
                                                throw new NumberFormatException(o.toString());
                                            } else {
                                                i2 = c4 - 'A';
                                            }
                ...
                if (i3 == 4) {
                    ...
                    if (i3 == 14 || i3 == 10) {
                        do {
                            int i4 = 0;
                            while (true) {
                                int i5 = this.f6145d + i4;
                                if (i5 < this.f6146e) {
                                    char c2 = this.f6144c[i5];
                                    if (c2 != '\t' && c2 != '\n' && c2 != '\f' && c2 != '\r' && c2 != ' ') {
                                        if (c2 != '#') {
                                            if (c2 != ',') {
                                                if (c2 != '/' && c2 != '=') {
