...
public final class r {
    ...
    public r(a aVar) {
        ...
        if (h0.a >= 18) {
            try {
                this.f5965l = AudioTrack.class.getMethod("getLatency", null);
    ...
    public final long a(long j2) {
        return (j2 * 1000000) / this.f5960g;
    }

    public final long b() {
        AudioTrack audioTrack = this.f5956c;
        c.a.a.b.g.h.t(audioTrack);
        AudioTrack audioTrack2 = audioTrack;
        if (this.v != -9223372036854775807L) {
            return Math.min(this.y, this.x + ((((SystemClock.elapsedRealtime() * 1000) - this.v) * this.f5960g) / 1000000));
        }
    ...
    */
    public boolean c(long r6) {
        /*
            ...
            if (r4 > 0) goto L29
            boolean r6 = r5.f5961h
            if (r6 == 0) goto L26
            android.media.AudioTrack r6 = r5.f5956c
            c.a.a.b.g.h.t(r6)
