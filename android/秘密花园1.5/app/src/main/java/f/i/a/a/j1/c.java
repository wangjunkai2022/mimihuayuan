...
public abstract class c implements j {
    ...
    public static final class b implements Comparator<b0> {
        ...
        public int compare(b0 b0Var, b0 b0Var2) {
            return b0Var2.f4084e - b0Var.f4084e;
        }
    }
    ...
    public c(o0 o0Var, int... iArr) {
        ...
        if (o0Var != null) {
            ...
            this.b = length;
            this.f5478d = new b0[length];
            for (int i3 = 0; i3 < iArr.length; i3++) {
                this.f5478d[i3] = o0Var.b[iArr[i3]];
            }
            Arrays.sort(this.f5478d, new b(null));
            this.f5477c = new int[this.b];
            while (true) {
                int i4 = this.b;
                if (i2 < i4) {
                    this.f5477c[i2] = o0Var.a(this.f5478d[i2]);
                    i2++;
                } else {
                    this.f5479e = new long[i4];
                    return;
                }
            }
        } else {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        c cVar = (c) obj;
        return this.a == cVar.a && Arrays.equals(this.f5477c, cVar.f5477c);
    }
    ...
    public int hashCode() {
        if (this.f5480f == 0) {
            this.f5480f = Arrays.hashCode(this.f5477c) + (System.identityHashCode(this.a) * 31);
        }
        return this.f5480f;
    }
    ...
    @Override // f.i.a.a.j1.j
    public final b0 k() {
        return this.f5478d[m()];
    }

    @Override // f.i.a.a.j1.j
    public final int length() {
        return this.f5477c.length;
    }
