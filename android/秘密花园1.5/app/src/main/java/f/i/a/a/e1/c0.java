...
public final class c0 implements Comparable<c0>, Parcelable {
    ...
    public int compareTo(@NonNull c0 c0Var) {
        ...
        if (i2 == 0) {
            ...
            return i3 == 0 ? this.f4703c - c0Var2.f4703c : i3;
        }
        return i2;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        c0 c0Var = (c0) obj;
        return this.a == c0Var.a && this.b == c0Var.b && this.f4703c == c0Var.f4703c;
    }

    public int hashCode() {
        return (((this.a * 31) + this.b) * 31) + this.f4703c;
    }

    public String toString() {
        return this.a + "." + this.b + "." + this.f4703c;
    }
