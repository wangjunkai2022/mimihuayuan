...
public final class a extends d {
    ...
    public static final int[] f4148e = {5512, 11025, 22050, 44100};
    public boolean b;
    ...
    public boolean b(u uVar) throws d.a {
        if (!this.b) {
            ...
            this.f4150d = i2;
            if (i2 == 2) {
                this.a.d(b0.j(null, "audio/mpeg", null, -1, -1, 1, f4148e[(p >> 2) & 3], null, null, 0, null));
                this.f4149c = true;
            } else if (i2 == 7 || i2 == 8) {
                this.a.d(b0.i(null, this.f4150d == 7 ? "audio/g711-alaw" : "audio/g711-mlaw", null, -1, -1, 1, 8000, (p & 1) == 1 ? 2 : 3, null, null, 0, null));
                this.f4149c = true;
            } else if (i2 != 10) {
                StringBuilder o = f.b.a.a.a.o("Audio format not supported: ");
                o.append(this.f4150d);
