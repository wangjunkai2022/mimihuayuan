...
public final class n implements j {
    ...
    public void c(f.i.a.a.m1.u uVar) {
        if (this.f4522c) {
            ...
            if (i2 < 10) {
                ...
                System.arraycopy(uVar.a, uVar.b, this.a.a, this.f4525f, min);
                if (this.f4525f + min == 10) {
                    this.a.A(0);
                    if (73 == this.a.p() && 68 == this.a.p() && 51 == this.a.p()) {
                        this.a.B(3);
                        this.f4524e = this.a.o() + 10;
                    } else {
                        this.f4522c = false;
                        return;
                    }
            ...
            int min2 = Math.min(a, this.f4524e - this.f4525f);
            this.b.a(uVar, min2);
            this.f4525f += min2;
        }
    }
    ...
    public void d() {
        int i2;
        if (this.f4522c && (i2 = this.f4524e) != 0 && this.f4525f == i2) {
            this.b.c(this.f4523d, 1, i2, 0, null);
            this.f4522c = false;
        }
    }
