...
public class b extends f.i.a.a.j1.c {
    ...
    public final InterfaceC0084b f5461g;

    /* renamed from: h  reason: collision with root package name */
    public final long f5462h;
    ...
    public final f.i.a.a.m1.h f5467m;
    public final b0[] n;
    public final int[] o;
    public final int[] p;
    public h q;
    ...
    public static class d implements j.b {
        ...
        /* renamed from: h  reason: collision with root package name */
        public final f.i.a.a.m1.h f5475h;
        ...
        public d() {
            ...
            this.f5472e = 0.75f;
            this.f5473f = 0.75f;
            this.f5474g = ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS;
            this.f5475h = hVar;
            this.f5476i = h.a;
        }
        ...
        public final j[] a(j.a[] aVarArr, f.i.a.a.l1.g gVar) {
            ...
            while (i4 < aVarArr2.length) {
                ...
                if (aVar == null) {
                    ...
                    if (iArr2.length > 1) {
                        i3 = i4;
                        gVar2 = gVar3;
                        b bVar = new b(aVar.a, iArr2, new c(gVar3, this.f5472e), this.b, this.f5470c, this.f5471d, this.f5473f, this.f5474g, this.f5475h, null);
                        bVar.q = this.f5476i;
                        arrayList.add(bVar);
                        jVarArr[i3] = bVar;
                    } else {
                        gVar2 = gVar3;
                        i3 = i4;
                        jVarArr[i3] = new e(aVar.a, iArr2[0], aVar.f5519c, aVar.f5520d);
                        int i5 = aVar.a.b[aVar.b[0]].f4084e;
                    }
                }
                i4 = i3 + 1;
                aVarArr2 = aVarArr;
            ...
            if (arrayList.size() > 1) {
                ...
                for (int i6 = 0; i6 < arrayList.size(); i6++) {
                    ...
                    jArr[i6] = new long[bVar2.f5477c.length];
                    int i7 = 0;
                    while (true) {
                        if (i7 < bVar2.f5477c.length) {
                            jArr[i6][i7] = bVar2.f5478d[(iArr.length - i7) - 1].f4084e;
                            i7++;
                        }
                    }
                }
                ...
                for (int i20 = 0; i20 < arrayList.size(); i20++) {
                    ...
                    c cVar = (c) ((b) arrayList.get(i20)).f5461g;
                    if (cVar != null) {
    ...
    public b(o0 o0Var, int[] iArr, InterfaceC0084b interfaceC0084b, long j2, long j3, long j4, float f2, long j5, f.i.a.a.m1.h hVar, a aVar) {
        ...
        for (int i3 = 0; i3 < this.b; i3++) {
            b0 b0Var = this.f5478d[i3];
            b0[] b0VarArr = this.n;
            b0VarArr[i3] = b0Var;
            this.o[i3] = b0VarArr[i3].f4084e;
        }
    }
    ...
    public int f(long j2, List<? extends f.i.a.a.h1.s0.l> list) {
        int i2;
        int i3;
        long c2 = this.f5467m.c();
        long j3 = this.u;
        if (!(j3 == -9223372036854775807L || c2 - j3 >= this.f5466l)) {
            return list.size();
        }
        this.u = c2;
        if (list.isEmpty()) {
        ...
        int size = list.size();
        long I = h0.I(list.get(size - 1).f4945f - j2, this.r);
        long j4 = this.f5464j;
        if (I < j4) {
            return size;
        }
        b0 b0Var = this.f5478d[t(c2, this.o)];
        for (int i4 = 0; i4 < size; i4++) {
            f.i.a.a.h1.s0.l lVar = list.get(i4);
            b0 b0Var2 = lVar.f4942c;
            if (h0.I(lVar.f4945f - j2, this.r) >= j4 && b0Var2.f4084e < b0Var.f4084e && (i2 = b0Var2.o) != -1 && i2 < 720 && (i3 = b0Var2.n) != -1 && i3 < 1280 && i2 < b0Var.o) {
                return i4;
            }
        }
        return size;
    ...
    public void h(long j2, long j3, long j4, List<? extends f.i.a.a.h1.s0.l> list, f.i.a.a.h1.s0.m[] mVarArr) {
        ...
        if (!s(i2, c2)) {
            b0[] b0VarArr = this.f5478d;
            b0 b0Var = b0VarArr[i2];
            b0 b0Var2 = b0VarArr[this.s];
            if (b0Var2.f4084e > b0Var.f4084e) {
                if (j3 < ((j4 == -9223372036854775807L || j4 > this.f5462h) ? false : false ? ((float) j4) * this.f5465k : this.f5462h)) {
                    this.s = i2;
                }
            }
            if (b0Var2.f4084e < b0Var.f4084e && j3 >= this.f5463i) {
                this.s = i2;
            }
        }
        if (this.s != i2) {
    ...
    public final int t(long j2, int[] iArr) {
        c cVar = (c) this.f5461g;
        long max = Math.max(0L, (((float) cVar.a.c()) * cVar.b) - cVar.f5468c);
        if (cVar.f5469d != null) {
            int i2 = 1;
            while (true) {
                long[][] jArr = cVar.f5469d;
                if (i2 >= jArr.length - 1 || jArr[i2][0] >= max) {
                    break;
                }
                i2++;
            }
            long[][] jArr2 = cVar.f5469d;
