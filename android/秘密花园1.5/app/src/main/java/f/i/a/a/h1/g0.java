...
public final class g0 implements d0, f.i.a.a.b1.h, c0.b<a>, c0.f, j0.b {
    ...
    public final f.i.a.a.l1.b0 f4829c;

    /* renamed from: d  reason: collision with root package name */
    public final f0.a f4830d;

    /* renamed from: e  reason: collision with root package name */
    public final c f4831e;

    /* renamed from: f  reason: collision with root package name */
    public final f.i.a.a.l1.e f4832f;
    @Nullable
    ...
    public final f.i.a.a.l1.c0 f4835i = new f.i.a.a.l1.c0("Loader:ProgressiveMediaPeriod");

    /* renamed from: k  reason: collision with root package name */
    public final f.i.a.a.m1.k f4837k = new f.i.a.a.m1.k();

    /* renamed from: l  reason: collision with root package name */
    public final Runnable f4838l = new Runnable() { // from class: f.i.a.a.h1.b
    ...
    public final Runnable f4839m = new Runnable() { // from class: f.i.a.a.h1.m
        @Override // java.lang.Runnable
        public final void run() {
            g0.this.A();
        }
    ...
    public final class a implements c0.e, a0.a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final b f4840c;

        /* renamed from: d  reason: collision with root package name */
        public final f.i.a.a.b1.h f4841d;

        /* renamed from: e  reason: collision with root package name */
        public final f.i.a.a.m1.k f4842e;
        ...
        /* renamed from: j  reason: collision with root package name */
        public f.i.a.a.l1.p f4847j;
        @Nullable

        /* renamed from: l  reason: collision with root package name */
        public f.i.a.a.b1.p f4849l;

        /* renamed from: m  reason: collision with root package name */
        public boolean f4850m;

        /* renamed from: f  reason: collision with root package name */
        public final f.i.a.a.b1.m f4843f = new f.i.a.a.b1.m();

        /* renamed from: h  reason: collision with root package name */
        public boolean f4845h = true;

        /* renamed from: k  reason: collision with root package name */
        public long f4848k = -1;
        ...
        public a(Uri uri, f.i.a.a.l1.m mVar, b bVar, f.i.a.a.b1.h hVar, f.i.a.a.m1.k kVar) {
            ...
            this.f4841d = hVar;
            this.f4842e = kVar;
            this.f4847j = new f.i.a.a.l1.p(this.a, 0L, -1L, g0.this.f4833g, 22);
        }
        ...
        public void a() throws IOException, InterruptedException {
            ...
            f.i.a.a.b1.d dVar;
            int i2 = 0;
            while (i2 == 0 && !this.f4844g) {
                f.i.a.a.b1.d dVar2 = null;
                try {
                    j2 = this.f4843f.a;
                    f.i.a.a.l1.p pVar = new f.i.a.a.l1.p(this.a, j2, -1L, g0.this.f4833g, 22);
                    this.f4847j = pVar;
                    ...
                    if (g0.this.q != null && g0.this.q.f4628f != -1) {
                        mVar = new a0(this.b, g0.this.q.f4628f, this);
                        f.i.a.a.b1.p E = g0.this.E(new f(0, true));
                        this.f4849l = E;
                        E.d(g0.K);
                    }
                    dVar = new f.i.a.a.b1.d(mVar, j2, this.f4848k);
                } catch (Throwable th) {
                    th = th;
                }
                try {
                    f.i.a.a.b1.g a = this.f4840c.a(dVar, this.f4841d, d2);
                    if (this.f4845h) {
                        a.f(j2, this.f4846i);
                        this.f4845h = false;
                    }
                    while (i2 == 0 && !this.f4844g) {
                        f.i.a.a.m1.k kVar = this.f4842e;
                        synchronized (kVar) {
                            while (!kVar.a) {
                                kVar.wait();
                            }
                        }
                        i2 = a.c(dVar, this.f4843f);
                        if (dVar.f4117d > g0.this.f4834h + j2) {
                            j2 = dVar.f4117d;
                            f.i.a.a.m1.k kVar2 = this.f4842e;
                            synchronized (kVar2) {
                                kVar2.a = false;
                            }
                            g0.this.n.post(g0.this.f4839m);
                        }
                    }
                    if (i2 == 1) {
                        i2 = 0;
                    } else {
                        this.f4843f.a = dVar.f4117d;
                    }
    ...
    public static final class d {
        ...
        public d(f.i.a.a.b1.n nVar, p0 p0Var, boolean[] zArr) {
            ...
            this.f4851c = zArr;
            int i2 = p0Var.a;
            this.f4852d = new boolean[i2];
            this.f4853e = new boolean[i2];
        }
    }
    ...
    public final class e implements k0 {
        ...
        public void a() throws IOException {
            g0 g0Var = g0.this;
            g0Var.f4835i.e(((f.i.a.a.l1.w) g0Var.f4829c).b(g0Var.x));
        }
    ...
    public final void B() {
        ...
        while (i3 < length) {
            ...
            if (bVar != null) {
                ...
                if (h2 && n.f4084e == -1 && (i2 = bVar.a) != -1) {
                    zArr = zArr2;
                    b0Var = new f.i.a.a.b0(n.a, n.b, n.f4082c, n.f4083d, i2, n.f4085f, n.f4086g, n.f4087h, n.f4088i, n.f4089j, n.f4090k, n.f4091l, n.f4092m, n.n, n.o, n.p, n.q, n.r, n.t, n.s, n.u, n.v, n.w, n.x, n.y, n.z, n.A, n.B);
        ...
        this.u = true;
        ((h0) this.f4831e).q(this.C, nVar.g());
        d0.a aVar2 = this.o;
        c.a.a.b.g.h.t(aVar2);
        aVar2.h(this);
    }
    ...
    public final void C(int i2) {
        d y = y();
        boolean[] zArr = y.f4853e;
        if (zArr[i2]) {
            return;
        }
        f.i.a.a.b0 b0Var = y.b.b[i2].b[0];
        this.f4830d.b(f.i.a.a.m1.r.f(b0Var.f4088i), b0Var, 0, null, this.E);
        zArr[i2] = true;
    }

    public final void D(int i2) {
        boolean[] zArr = y().f4851c;
    ...
    public final void F() {
        a aVar = new a(this.a, this.b, this.f4836j, this, this.f4837k);
        if (this.u) {
        ...
        this.H = w();
        this.f4830d.w(aVar.f4847j, 1, -1, null, 0, null, aVar.f4846i, this.C, this.f4835i.g(aVar, this, ((f.i.a.a.l1.w) this.f4829c).b(this.x)));
    }
    ...
    public void k(a aVar, long j2, long j3, boolean z) {
        a aVar2 = aVar;
        f0.a aVar3 = this.f4830d;
        f.i.a.a.l1.p pVar = aVar2.f4847j;
        f.i.a.a.l1.g0 g0Var = aVar2.b;
        aVar3.n(pVar, g0Var.f5588c, g0Var.f5589d, 1, -1, null, 0, null, aVar2.f4846i, this.C, j2, j3, g0Var.b);
        if (z) {
            return;
        }
        if (this.D == -1) {
    ...
    */
    public f.i.a.a.l1.c0.c p(f.i.a.a.h1.g0.a r31, long r32, long r34, java.io.IOException r36, int r37) {
        ...
        L12:
            ...
            if (r9 != 0) goto L30
            f.i.a.a.l1.c0$c r2 = f.i.a.a.l1.c0.f5564e
            goto L8b
        L30:
            int r9 = r30.w()
            int r10 = r0.H
        ...
        L82:
            ...
            goto L8b
        L89:
            f.i.a.a.l1.c0$c r2 = f.i.a.a.l1.c0.f5563d
        L8b:
            f.i.a.a.h1.f0$a r9 = r0.f4830d
            f.i.a.a.l1.p r10 = r1.f4847j
            f.i.a.a.l1.g0 r3 = r1.b
            android.net.Uri r11 = r3.f5588c
            java.util.Map<java.lang.String, java.util.List<java.lang.String>> r12 = r3.f5589d
            r13 = 1
            r16 = 0
            r17 = 0
            long r4 = r1.f4846i
    ...
    public void r(a aVar, long j2, long j3) {
        ...
        if (this.C == -9223372036854775807L && (nVar = this.p) != null) {
            ...
            this.C = j4;
            ((h0) this.f4831e).q(j4, g2);
        }
        f0.a aVar3 = this.f4830d;
        f.i.a.a.l1.p pVar = aVar2.f4847j;
        f.i.a.a.l1.g0 g0Var = aVar2.b;
        aVar3.q(pVar, g0Var.f5588c, g0Var.f5589d, 1, -1, null, 0, null, aVar2.f4846i, this.C, j2, j3, g0Var.b);
        if (this.D == -1) {
            this.D = aVar2.f4848k;
        }
        this.I = true;
    ...
    public void s() throws IOException {
        this.f4835i.e(((f.i.a.a.l1.w) this.f4829c).b(this.x));
        if (this.I && !this.u) {
