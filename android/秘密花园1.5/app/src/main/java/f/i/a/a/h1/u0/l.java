...
public final class l implements d0, n.a, j.b {
    ...
    public final i0 f5123d;

    /* renamed from: e  reason: collision with root package name */
    public final b0 f5124e;

    /* renamed from: f  reason: collision with root package name */
    public final f0.a f5125f;

    /* renamed from: g  reason: collision with root package name */
    public final f.i.a.a.l1.e f5126g;

    /* renamed from: h  reason: collision with root package name */
    public final IdentityHashMap<k0, Integer> f5127h;

    /* renamed from: i  reason: collision with root package name */
    public final q f5128i;

    /* renamed from: j  reason: collision with root package name */
    public final v f5129j;
    ...
    public l(i iVar, f.i.a.a.h1.u0.t.j jVar, h hVar, @Nullable i0 i0Var, b0 b0Var, f0.a aVar, f.i.a.a.l1.e eVar, v vVar, boolean z, boolean z2) {
        ...
        if (vVar != null) {
            ...
            this.f5127h = new IdentityHashMap<>();
            this.f5128i = new q();
            this.p = new n[0];
            this.q = new n[0];
            this.r = new int[0];
    ...
    public static f.i.a.a.b0 p(f.i.a.a.b0 b0Var, f.i.a.a.b0 b0Var2, boolean z) {
        ...
        int i4;
        if (b0Var2 != null) {
            String str4 = b0Var2.f4085f;
            int i5 = b0Var2.v;
            int i6 = b0Var2.f4082c;
            int i7 = b0Var2.f4083d;
        ...
        return f.i.a.a.b0.g(b0Var.a, str2, b0Var.f4087h, f.i.a.a.m1.r.c(str), str, z ? b0Var.f4084e : -1, i2, -1, null, i3, i4, str3);
    }
    ...
    */
    ...
    public final n k(int i2, Uri[] uriArr, f.i.a.a.b0[] b0VarArr, f.i.a.a.b0 b0Var, List<f.i.a.a.b0> list, Map<String, f.i.a.a.z0.e> map, long j2) {
        return new n(i2, this, new g(this.a, this.b, uriArr, b0VarArr, this.f5122c, this.f5123d, this.f5128i, list), map, this.f5126g, j2, b0Var, this.f5124e, this.f5125f);
    }
    ...
    */
    ...
    public List<c0> n(List<f.i.a.a.j1.j> list) {
        ...
        int i3;
        l lVar = this;
        f.i.a.a.h1.u0.t.e eVar = ((f.i.a.a.h1.u0.t.c) lVar.b).f5164l;
        c.a.a.b.g.h.t(eVar);
        int i4 = !eVar.f5177e.isEmpty();
        int length = lVar.p.length - eVar.f5179g.size();
        int i5 = 0;
        if (i4 != 0) {
            n nVar = lVar.p[0];
            iArr = lVar.r[0];
        ...
        if (z && !z2) {
            int i10 = iArr[0];
            int i11 = eVar.f5177e.get(iArr[0]).b.f4084e;
            for (int i12 = 1; i12 < iArr.length; i12++) {
                int i13 = eVar.f5177e.get(iArr[i12]).b.f4084e;
                if (i13 < i11) {
                    i10 = iArr[i12];
                    i11 = i13;
                }
