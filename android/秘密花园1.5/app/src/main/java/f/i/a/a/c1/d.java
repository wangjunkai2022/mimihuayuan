...
public final class d {
    ...
    public static final SparseIntArray f4608c;

    /* renamed from: d  reason: collision with root package name */
    public static final SparseIntArray f4609d;

    /* renamed from: e  reason: collision with root package name */
    public static final Map<String, Integer> f4610e;

    /* renamed from: f  reason: collision with root package name */
    public static final Map<String, Integer> f4611f;

    /* renamed from: g  reason: collision with root package name */
    public static final Map<String, Integer> f4612g;

    /* renamed from: h  reason: collision with root package name */
    public static final SparseIntArray f4613h;
    public static final Pattern a = Pattern.compile("^\\D?(\\d+)$");
    public static final HashMap<b, List<f.i.a.a.c1.a>> b = new HashMap<>();

    /* renamed from: i  reason: collision with root package name */
    public static int f4614i = -1;
    ...
    public static final class b {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            b bVar = (b) obj;
            return TextUtils.equals(this.a, bVar.a) && this.b == bVar.b && this.f4615c == bVar.f4615c;
        }

        public int hashCode() {
            String str = this.a;
            return (((((str == null ? 0 : str.hashCode()) + 31) * 31) + (this.b ? 1231 : 1237)) * 31) + (this.f4615c ? 1231 : 1237);
        }
    }
    ...
    static {
        ...
        f4610e.put("L90", 64);
        f4610e.put("L93", 256);
        f4610e.put("L120", 1024);
        f4610e.put("L123", 4096);
        f4610e.put("L150", 16384);
        f4610e.put("L153", 65536);
        f4610e.put("L156", 262144);
        f4610e.put("L180", 1048576);
        f4610e.put("L183", 4194304);
        f4610e.put("L186", 16777216);
        f4610e.put("H30", 2);
        f4610e.put("H60", 8);
        f4610e.put("H63", 32);
        f4610e.put("H90", 128);
        f4610e.put("H93", 512);
        f4610e.put("H120", 2048);
        f4610e.put("H123", 8192);
        f4610e.put("H150", 32768);
        f4610e.put("H153", 131072);
        f4610e.put("H156", 524288);
        f4610e.put("H180", 2097152);
        f4610e.put("H183", 8388608);
        f4610e.put("H186", 33554432);
    ...
    public static String b(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (!mediaCodecInfo.isEncoder() && (z || !str.endsWith(".secure")) && ((h0.a >= 21 || !("CIPAACDecoder".equals(str) || "CIPMP3Decoder".equals(str) || "CIPVorbisDecoder".equals(str) || "CIPAMRNBDecoder".equals(str) || "AACDecoder".equals(str) || "MP3Decoder".equals(str))) && (!(h0.a < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str) && ("a70".equals(h0.b) || ("Xiaomi".equals(h0.f5737c) && h0.b.startsWith("HM")))) && (!(h0.a == 16 && "OMX.qcom.audio.decoder.mp3".equals(str) && ("dlxu".equals(h0.b) || "protou".equals(h0.b) || "ville".equals(h0.b) || "villeplus".equals(h0.b) || "villec2".equals(h0.b) || h0.b.startsWith("gee") || "C6602".equals(h0.b) || "C6603".equals(h0.b) || "C6606".equals(h0.b) || "C6616".equals(h0.b) || "L36h".equals(h0.b) || "SO-02E".equals(h0.b))) && (!(h0.a == 16 && "OMX.qcom.audio.decoder.aac".equals(str) && ("C1504".equals(h0.b) || "C1505".equals(h0.b) || "C1604".equals(h0.b) || "C1605".equals(h0.b))) && ((h0.a >= 24 || !(("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(h0.f5737c) && (h0.b.startsWith("zeroflte") || h0.b.startsWith("zerolte") || h0.b.startsWith("zenlte") || "SC-05G".equals(h0.b) || "marinelteatt".equals(h0.b) || "404SC".equals(h0.b) || "SC-04G".equals(h0.b) || "SCV31".equals(h0.b)))) && !((h0.a <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(h0.f5737c) && (h0.b.startsWith("d2") || h0.b.startsWith("serrano") || h0.b.startsWith("jflte") || h0.b.startsWith("santos") || h0.b.startsWith("t0"))) || ((h0.a <= 19 && h0.b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) || ("audio/eac3-joc".equals(str2) && "OMX.MTK.AUDIO.DECODER.DSPAC3".equals(str)))))))))) {
        ...
        switch (c2) {
            ...
            case 1:
                if (split.length >= 2) {
                    try {
                        ...
                        i2 = f4608c.get(parseInt, -1);
                        if (i2 == -1 || (i3 = f4609d.get(parseInt2, -1)) == -1) {
                            return null;
                        }
            ...
            case 3:
                ...
                if (matcher.matches()) {
                    ...
                    Integer num = f4610e.get(split[3]);
                    if (num == null) {
                        return null;
                    }
            ...
            case 5:
                ...
                if (matcher2.matches()) {
                    Integer num2 = f4611f.get(matcher2.group(1));
                    if (num2 == null) {
                        return null;
                    }
                    Integer num3 = f4612g.get(split[2]);
                    if (num3 == null) {
                        return null;
                    }
            ...
            case 6:
                if (split.length == 3) {
                    try {
                        ...
                        i4 = f4613h.get(Integer.parseInt(split[2]), -1);
                        if (i4 == -1) {
                            return null;
                        }
            ...
            for (int i2 = 0; i2 < c2; i2++) {
                ...
                if (b2 != null) {
                    try {
                        ...
                        if ((bVar.f4615c || !b3) && (!bVar.f4615c || d2)) {
                            ...
                            if ((bVar.b || !b4) && (!bVar.b || d3)) {
                                boolean z = h0.a <= 22 && ("ODROID-XU3".equals(h0.f5738d) || "Nexus 10".equals(h0.f5738d)) && ("OMX.Exynos.AVC.Decoder".equals(name) || "OMX.Exynos.AVC.Decoder.secure".equals(name));
    ...
    public static int g() throws c {
        ...
        if (f4614i == -1) {
            ...
            if (d2 != null) {
                MediaCodecInfo.CodecCapabilities codecCapabilities = d2.f4597d;
