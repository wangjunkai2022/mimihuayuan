    ...
    public e k(byte[] bArr, int i2, boolean z) throws g {
        ...
        if (u2 == 0) {
            ...
            if (uVar.a() >= 2) {
                ...
                if (c2 == 65279 || c2 == 65534) {
                    n = uVar.n(u2, Charset.forName("UTF-16"));
                }
            }
            n = uVar.n(u2, Charset.forName("UTF-8"));
        }
        if (n.isEmpty()) {
            return b.b;
        }
        ...
        while (this.n.a() >= 8) {
            ...
            if (d3 == u) {
                ...
                l(this.n.a() >= 2);
                f2 = h0.n(this.n.u() / this.t, 0.0f, 0.95f);
            }
            this.n.A(i6 + d2);
            i3 = 1;
        }
        return new b(new f.i.a.a.i1.b(spannableStringBuilder, null, f2, 0, 0, Float.MIN_VALUE, Integer.MIN_VALUE, Float.MIN_VALUE));
    }
}
