...
public final class e0<T> implements c0.e {
    ...
    public final g0 f5574c;

    /* renamed from: d  reason: collision with root package name */
    public final a<? extends T> f5575d;
    @Nullable

    /* renamed from: e  reason: collision with root package name */
    public volatile T f5576e;
    ...
    public final void a() throws IOException {
        this.f5574c.b = 0L;
        o oVar = new o(this.f5574c, this.a);
        try {
            if (!oVar.f5675d) {
                oVar.a.b(oVar.b);
                oVar.f5675d = true;
            }
            Uri d2 = this.f5574c.d();
            c.a.a.b.g.h.t(d2);
            this.f5576e = this.f5575d.a(d2, oVar);
        } finally {
            f.i.a.a.m1.h0.l(oVar);
        }
    }
