...
public class a {
    ...
    public final List<i> f5028c;

    /* renamed from: d  reason: collision with root package name */
    public final List<d> f5029d;

    /* renamed from: e  reason: collision with root package name */
    public final List<d> f5030e;
    ...
    public a(int i2, int i3, List<i> list, List<d> list2, List<d> list3) {
        ...
        this.a = i2;
        this.b = i3;
        this.f5028c = Collections.unmodifiableList(list);
        if (list2 == null) {
            unmodifiableList = Collections.emptyList();
        } else {
            unmodifiableList = Collections.unmodifiableList(list2);
        }
        this.f5029d = unmodifiableList;
        if (list3 == null) {
            unmodifiableList2 = Collections.emptyList();
        } else {
            unmodifiableList2 = Collections.unmodifiableList(list3);
        }
        this.f5030e = unmodifiableList2;
    }
}
