...
public abstract class g0 implements e0 {
    ...
    public static <E extends e0> Observable<Object<E>> asChangesetObservable(E e2) {
        if (e2 instanceof g.a.f1.n) {
            a aVar = ((g.a.f1.n) e2).realmGet$proxyState().f6382e;
    ...
    public static <E extends e0> void deleteFromRealm(E e2) {
        if (e2 instanceof g.a.f1.n) {
            ...
            if (nVar.realmGet$proxyState().f6380c != null) {
                if (nVar.realmGet$proxyState().f6382e != null) {
                    nVar.realmGet$proxyState().f6382e.f();
                    g.a.f1.p pVar = nVar.realmGet$proxyState().f6380c;
                    Table d2 = pVar.d();
                    long l2 = pVar.l();
                    d2.a();
                    d2.nativeMoveLastOver(d2.a, l2);
                    nVar.realmGet$proxyState().f6380c = g.a.f1.g.INSTANCE;
                    return;
                }
        ...
        if (e0Var != null) {
            if (!(e0Var instanceof DynamicRealmObject)) {
                if (e0Var instanceof g.a.f1.n) {
                    a aVar = ((g.a.f1.n) e0Var).realmGet$proxyState().f6382e;
                    aVar.f();
                    if (isValid(e0Var)) {
                        return (x) aVar;
                    }
    ...
    public static <E extends e0> boolean isLoaded(E e2) {
        if (e2 instanceof g.a.f1.n) {
            g.a.f1.n nVar = (g.a.f1.n) e2;
            nVar.realmGet$proxyState().f6382e.f();
            return !(nVar.realmGet$proxyState().f6380c instanceof g.a.f1.l);
        }
        return true;
    }
    ...
    public static <E extends e0> boolean isValid(E e2) {
        ...
        g.a.f1.p pVar = ((g.a.f1.n) e2).realmGet$proxyState().f6380c;
    ...
    public static <E extends e0> void removeAllChangeListeners(E e2) {
        if (e2 instanceof g.a.f1.n) {
            g.a.f1.n nVar = (g.a.f1.n) e2;
            a aVar = nVar.realmGet$proxyState().f6382e;
            if (aVar.H()) {
                RealmLog.c("Calling removeChangeListener on a closed Realm %s, make sure to close all listeners before closing the Realm.", aVar.b.f6272c);
            }
            v realmGet$proxyState = nVar.realmGet$proxyState();
            OsObject osObject = realmGet$proxyState.f6381d;
            if (osObject != null) {
                osObject.removeListener(realmGet$proxyState.a);
                return;
            }
            g.a.f1.k<OsObject.b> kVar = realmGet$proxyState.f6384g;
            kVar.b = true;
            kVar.a.clear();
            return;
        }
    ...
    public static <E extends e0> void addChangeListener(E e2, h0<E> h0Var) {
        ...
        if (h0Var != null) {
            if (e2 instanceof g.a.f1.n) {
                ...
                a aVar = nVar.realmGet$proxyState().f6382e;
                aVar.f();
                ((g.a.f1.s.a) aVar.f6266d.capabilities).b("Listeners cannot be used on current thread.");
                v realmGet$proxyState = nVar.realmGet$proxyState();
                g.a.f1.p pVar = realmGet$proxyState.f6380c;
                if (pVar instanceof g.a.f1.l) {
                    realmGet$proxyState.f6384g.a(new OsObject.b(realmGet$proxyState.a, h0Var));
                    return;
        ...
        if (h0Var != null) {
            if (e2 instanceof g.a.f1.n) {
                ...
                if (osObject != null) {
                    ...
                    realmGet$proxyState.f6384g.d(realmGet$proxyState.a, h0Var);
                    return;
                }
            }
