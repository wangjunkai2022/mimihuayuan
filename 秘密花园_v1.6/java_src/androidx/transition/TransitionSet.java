...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i2) {
        if (i2 == 0) {
            ...
            throw new AndroidRuntimeException(a.J("Invalid parameter for TransitionSet ordering: ", i2));
        }
        return this;
    }
    ...
    public String toString(String str) {
        ...
        for (int i2 = 0; i2 < this.mTransitions.size(); i2++) {
            StringBuilder r = a.r(transition, g.a);
            r.append(this.mTransitions.get(i2).toString(str + "  "));
    ...
    public Transition clone() {
        ...
        int size = this.mTransitions.size();
        for (int i2 = 0; i2 < size; i2++) {
            transitionSet.addTransition(this.mTransitions.get(i2).m5clone());
        }
