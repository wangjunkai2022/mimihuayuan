...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    public float getMinHeight() {
        ...
        return (((this.mRawMaxShadowSize * 1.5f) + this.mInsetShadow) * 2.0f) + (Math.max(f2, f3 + this.mCornerRadius + this.mInsetShadow) * 2.0f);
    }

    public float getMinWidth() {
        float f2 = this.mRawMaxShadowSize;
        float f3 = f2 / 2.0f;
        return ((this.mRawMaxShadowSize + this.mInsetShadow) * 2.0f) + (Math.max(f2, f3 + this.mCornerRadius + this.mInsetShadow) * 2.0f);
    }
