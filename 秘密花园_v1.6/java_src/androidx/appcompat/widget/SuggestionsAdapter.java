                ...
                if (pathSegments != null) {
                    ...
                    if (size == 1) {
                        try {
                            ...
                            throw new FileNotFoundException(a.d("Single path segment is not a resource ID: ", uri));
                        }
                    } else if (size == 2) {
                        parseInt = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), authority);
                    } else {
                        throw new FileNotFoundException(a.d("More than two path segments: ", uri));
                    }
                    if (parseInt != 0) {
                        return resourcesForApplication.getDrawable(parseInt);
                    }
                    throw new FileNotFoundException(a.d("No resource found for: ", uri));
                }
                throw new FileNotFoundException(a.d("No path: ", uri));
            } catch (PackageManager.NameNotFoundException unused2) {
                throw new FileNotFoundException(a.d("No package found for authority: ", uri));
            }
        }
        throw new FileNotFoundException(a.d("No authority: ", uri));
    }
