...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public void onActivityResult(int i2, int i3, @Nullable Intent intent) {
        ...
        if (i4 != 0) {
            ...
            findFragmentByWho.onActivityResult(i2 & SupportMenu.USER_MASK, i3, intent);
            return;
        }
    ...
    public void onRequestPermissionsResult(int i2, @NonNull String[] strArr, @NonNull int[] iArr) {
        ...
        if (i3 != 0) {
            ...
            findFragmentByWho.onRequestPermissionsResult(i2 & SupportMenu.USER_MASK, strArr, iArr);
        }
    }
    ...
    public void requestPermissionsFromFragment(@NonNull Fragment fragment, @NonNull String[] strArr, int i2) {
        ...
        try {
            ...
            ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + 1) << 16) + (i2 & SupportMenu.USER_MASK));
        } finally {
    ...
    public void startIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i2, @Nullable Intent intent, int i3, int i4, int i5, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        try {
            ...
            checkForValidRequestCode(i2);
            ActivityCompat.startIntentSenderForResult(this, intentSender, ((allocateRequestIndex(fragment) + 1) << 16) + (i2 & SupportMenu.USER_MASK), intent, i3, i4, i5, bundle);
        } finally {
    ...
    public void startActivityFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) Intent intent, int i2, @Nullable Bundle bundle) {
        ...
        try {
            ...
            checkForValidRequestCode(i2);
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + 1) << 16) + (i2 & SupportMenu.USER_MASK), bundle);
        } finally {
