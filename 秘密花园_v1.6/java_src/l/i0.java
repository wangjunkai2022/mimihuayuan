...
public abstract class i0<T> {
    public static <T> i0<T> a(h0 h0Var, Method method) {
        ...
        for (Annotation annotation : aVar.f7258c) {
        ...
        if (aVar.n != null) {
            ...
            int length = aVar.f7259d.length;
            aVar.v = new c0[length];
            int i8 = length - 1;
            int i9 = 0;
            while (i9 < length) {
                c0<?>[] c0VarArr = aVar.v;
                Type type = aVar.f7260e[i9];
                Annotation[] annotationArr2 = aVar.f7259d[i9];
                boolean z2 = i9 == i8;
                                    ...
                                    if (annotation2 instanceof l.o0.s) {
                                                ...
                                                if (Iterable.class.isAssignableFrom(f9)) {
                                                    if (type instanceof ParameterizedType) {
                                                        ...
                                                        if (!a0.c.class.isAssignableFrom(l0.f(e5))) {
                                                            c0Var2 = new a0(new c0.e(aVar.b, i9, c2, aVar.a.d(e5, annotationArr2, aVar.f7258c)));
                                                        } else {
                                                    ...
                                                    if (!a0.c.class.isAssignableFrom(a)) {
                                                        c0Var2 = new b0(new c0.e(aVar.b, i9, c2, aVar.a.d(a, annotationArr2, aVar.f7258c)));
                                                    } else {
                                                        throw l0.l(aVar.b, i9, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                                                    }
                                                } else if (!a0.c.class.isAssignableFrom(f9)) {
                                                    eVar = new c0.e<>(aVar.b, i9, c2, aVar.a.d(type, annotationArr2, aVar.f7258c));
                                                    c0Var2 = eVar;
                                                } else {
                                                    throw l0.l(aVar.b, i9, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                                                }
                                        ...
                                        if (annotation2 instanceof l.o0.p) {
                                                ...
                                                if (Map.class.isAssignableFrom(f10)) {
                                                    ...
                                                    if (g4 instanceof ParameterizedType) {
                                                        ...
                                                        if (!a0.c.class.isAssignableFrom(l0.f(e7))) {
                                                            c0Var2 = new c0.f<>(aVar.b, i9, aVar.a.d(e7, annotationArr2, aVar.f7258c), ((l.o0.p) annotation2).encoding());
                                                        } else {
                                            ...
                                            if (!aVar.p && !aVar.q) {
                                                if (!aVar.f7263h) {
                                                    try {
                                                        l<T, i.g0> d2 = aVar.a.d(type, annotationArr2, aVar.f7258c);
                                                        aVar.f7263h = true;
                ...
                if (!l0.h(genericReturnType2)) {
                    if (genericReturnType2 != Void.TYPE) {
                        ...
                        try {
                            ...
                            if (a3 != i.h0.class) {
                                if (a3 != g0.class) {
                                    if (f0Var.f7249c.equals("HEAD") && !Void.class.equals(a3)) {
