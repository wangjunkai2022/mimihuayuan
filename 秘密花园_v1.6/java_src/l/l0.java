...
public final class l0 {
    ...
    public static final class b implements ParameterizedType {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.a = type;
            this.b = type2;
            this.f7279c = (Type[]) typeArr.clone();
        }
        ...
        public int hashCode() {
            int hashCode = Arrays.hashCode(this.f7279c) ^ this.b.hashCode();
            Type type = this.a;
            return hashCode ^ (type != null ? type.hashCode() : 0);
        }

        public String toString() {
            Type[] typeArr = this.f7279c;
            if (typeArr.length == 0) {
                return l0.p(this.b);
            }
            ...
            sb.append("<");
            sb.append(l0.p(this.f7279c[0]));
            for (int i2 = 1; i2 < this.f7279c.length; i2++) {
                sb.append(", ");
                sb.append(l0.p(this.f7279c[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
