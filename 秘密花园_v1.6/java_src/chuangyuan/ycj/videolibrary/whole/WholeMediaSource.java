...
public class WholeMediaSource extends MediaSourceBuilder {
    ...
    public e0 initMediaSource(@NonNull Uri uri) {
        ...
        if (inferContentType == 0) {
            ...
            w wVar = new w(5);
            c.a.a.b.g.h.v(!factory.f2391i);
            factory.f2388f = wVar;
            c.a.a.b.g.h.v(!factory.f2391i);
            factory.f2389g = 10000L;
            factory.f2390h = true;
            ...
            w wVar2 = new w(5);
            c.a.a.b.g.h.v(!factory2.f2428h);
            factory2.f2426f = wVar2;
            c.a.a.b.g.h.v(true ^ factory2.f2428h);
            factory2.f2427g = 10000L;
            return factory2.createMediaSource(uri);
        } else if (inferContentType == 2) {
            HlsMediaSource.Factory factory3 = new HlsMediaSource.Factory(new e(getDataSource()));
            c.a.a.b.g.h.v(!factory3.f2414i);
            factory3.f2413h = true;
            c.a.a.b.g.h.v(!factory3.f2414i);
            factory3.f2412g = new w(5);
            f fVar = new f();
            c.a.a.b.g.h.v(true ^ factory3.f2414i);
            factory3.b = fVar;
