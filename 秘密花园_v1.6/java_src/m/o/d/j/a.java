...
public abstract class a<E> extends b<E> {
    ...
    public static final int f7398c = Integer.getInteger("sparse.shift", 0).intValue();

    /* renamed from: d  reason: collision with root package name */
    public static final long f7399d;

    /* renamed from: e  reason: collision with root package name */
    public static final int f7400e;
    public final long a;
    public final E[] b;
    ...
    static {
        ...
        f7399d = o.a.arrayBaseOffset(Object[].class) + (32 << (f7400e - f7398c));
    }

    public a(int i2) {
        int v = j.b.v(i2);
        this.a = v - 1;
        this.b = (E[]) new Object[(v << f7398c) + 64];
    }

    public final long b(long j2) {
        return f7399d + ((j2 & this.a) << f7400e);
    }
