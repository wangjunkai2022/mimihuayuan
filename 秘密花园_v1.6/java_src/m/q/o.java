...
public class o {
    ...
    public static final o f7417f = new o();

    /* renamed from: g  reason: collision with root package name */
    public static final m.q.b f7418g = new a();
    public final AtomicReference<m.q.b> a = new AtomicReference<>();
    public final AtomicReference<m> b = new AtomicReference<>();

    /* renamed from: c  reason: collision with root package name */
    public final AtomicReference<q> f7419c = new AtomicReference<>();

    /* renamed from: d  reason: collision with root package name */
    public final AtomicReference<m.q.a> f7420d = new AtomicReference<>();

    /* renamed from: e  reason: collision with root package name */
    public final AtomicReference<p> f7421e = new AtomicReference<>();
    ...
    */
    ...
    public m.q.a a() {
        if (this.f7420d.get() == null) {
            Object d2 = d(m.q.a.class, g());
            if (d2 == null) {
                this.f7420d.compareAndSet(null, new b(this));
            } else {
                this.f7420d.compareAndSet(null, (m.q.a) d2);
            }
        }
        return this.f7420d.get();
    }
    ...
    public m.q.b b() {
        if (this.a.get() == null) {
            ...
            if (d2 == null) {
                this.a.compareAndSet(null, f7418g);
            } else {
    ...
    public p e() {
        if (this.f7421e.get() == null) {
            ...
            if (d2 == null) {
                this.f7421e.compareAndSet(null, p.a);
            } else {
                this.f7421e.compareAndSet(null, (p) d2);
            }
        }
        return this.f7421e.get();
    }

    public q f() {
        if (this.f7419c.get() == null) {
            Object d2 = d(q.class, g());
            if (d2 == null) {
                this.f7419c.compareAndSet(null, r.a);
            } else {
                this.f7419c.compareAndSet(null, (q) d2);
            }
        }
