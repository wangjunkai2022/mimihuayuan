...
public final class g implements j, i, Cloneable, ByteChannel {
    ...
    public static final byte[] f7061c;
    public v a;
    public long b;
    ...
    */
    ...
    public final v L(int i2) {
        ...
        if ((i2 < 1 || i2 > 8192) ? false : false) {
            ...
            if (vVar == null) {
                ...
                v vVar2 = vVar.f7078g;
                if (vVar2 != null) {
                    if (vVar2.f7074c + i2 > 8192 || !vVar2.f7076e) {
                        v b2 = w.b();
                        vVar2.b(b2);
                        return b2;
                    }
    ...
    public g O(byte[] bArr, int i2, int i3) {
        if (bArr != null) {
            ...
            while (i2 < i4) {
                v L = L(1);
                int min = Math.min(i4 - i2, 8192 - L.f7074c);
                System.arraycopy(bArr, i2, L.a, L.f7074c, min);
                i2 += min;
                L.f7074c += min;
            }
            this.b += j2;
    ...
    public g k(long j2) {
        ...
        for (int i3 = (i2 + numberOfTrailingZeros) - 1; i3 >= i2; i3--) {
            bArr[i3] = f7061c[(int) (15 & j2)];
            j2 >>>= 4;
        }
        L.f7074c += numberOfTrailingZeros;
    ...
    public Object clone() {
        ...
        if (this.b != 0) {
            ...
            if (vVar != null) {
                ...
                v vVar2 = this.a;
                if (vVar2 != null) {
                    for (v vVar3 = vVar2.f7077f; vVar3 != this.a; vVar3 = vVar3.f7077f) {
                        v vVar4 = gVar.a;
                        if (vVar4 == null) {
                            h.o.c.g.e();
                            throw null;
                        }
                        v vVar5 = vVar4.f7078g;
                        if (vVar5 == null) {
                            h.o.c.g.e();
                            throw null;
                        } else if (vVar3 != null) {
    ...
    public final long d() {
        ...
        if (vVar2 != null) {
            int i2 = vVar2.f7074c;
            return (i2 >= 8192 || !vVar2.f7076e) ? j2 : j2 - (i2 - vVar2.b);
        }
        h.o.c.g.e();
        throw null;
    }
                ...
                if (j2 < i2 - i3) {
                    while (j3 > 0) {
                        if (vVar != null) {
                            ...
                            int i4 = c2.b + ((int) j2);
                            c2.b = i4;
                            c2.f7074c = Math.min(i4 + ((int) j3), c2.f7074c);
                            v vVar2 = gVar.a;
                            if (vVar2 == null) {
                                c2.f7078g = c2;
                                c2.f7077f = c2;
        ...
        if (obj instanceof g) {
            ...
            if (vVar != null) {
                ...
                if (vVar2 != null) {
                    ...
                    long j4 = 0;
                    while (j4 < this.b) {
                        long min = Math.min(vVar.f7074c - i2, vVar2.f7074c - i3);
                        long j5 = j3;
                        while (j5 < min) {
                            int i4 = i2 + 1;
                            int i5 = i3 + 1;
    ...
    public long g(byte b, long j2, long j3) {
        ...
        if (0 <= j4 && j5 >= j4) {
            ...
            if (j9 - j4 < j4) {
                ...
                while (j9 < j5) {
                    byte[] bArr = vVar.a;
                    int min = (int) Math.min(vVar.f7074c, (vVar.b + j5) - j9);
            ...
            while (true) {
                long j10 = (vVar.f7074c - vVar.b) + j6;
                if (j10 > j4) {
                    while (j6 < j5) {
                        byte[] bArr2 = vVar.a;
                        int min2 = (int) Math.min(vVar.f7074c, (vVar.b + j5) - j6);
                        for (int i3 = (int) ((vVar.b + j4) - j6); i3 < min2; i3++) {
                            if (bArr2[i3] == b) {
                                return (i3 - vVar.b) + j6;
                            }
                        }
                        j6 += vVar.f7074c - vVar.b;
                        vVar = vVar.f7077f;
                        if (vVar == null) {
                            h.o.c.g.e();
                            throw null;
            ...
            while (j2 > 0) {
                ...
                if (vVar2 != null) {
                    if (j2 < i2 - vVar2.b) {
                        ...
                        if (vVar != null && vVar.f7076e) {
                            if ((vVar.f7074c + j2) - (vVar.f7075d ? 0 : vVar.b) <= 8192) {
                                v vVar4 = gVar.a;
                                if (vVar4 != null) {
                                    vVar4.d(vVar, (int) j2);
                                    gVar.b -= j2;
                        ...
                        int i3 = (int) j2;
                        if (vVar5 != null) {
                            if (i3 > 0 && i3 <= vVar5.f7074c - vVar5.b) {
                                if (i3 >= 1024) {
                                    b = vVar5.c();
                                } else {
                                    b = w.b();
                    ...
                    if (vVar7 != null) {
                        ...
                        if (vVar8 == null) {
                            ...
                            v vVar9 = vVar8.f7078g;
                            if (vVar9 != null) {
                                vVar9.b(vVar7);
                                if (vVar7.f7078g != vVar7) {
                                    v vVar10 = vVar7.f7078g;
                                    if (vVar10 == null) {
                                        h.o.c.g.e();
                                        throw null;
                                    } else if (vVar10.f7076e) {
                                        int i4 = vVar7.f7074c - vVar7.b;
                                        if (i4 <= (8192 - vVar10.f7074c) + (vVar10.f7075d ? 0 : vVar10.b)) {
                                            v vVar11 = vVar7.f7078g;
                                            if (vVar11 != null) {
                                                vVar7.d(vVar11, i4);
                                                vVar7.a();
                                                w.a(vVar7);
    ...
    public int read(byte[] bArr, int i2, int i3) {
        ...
        v vVar = this.a;
        if (vVar != null) {
            int min = Math.min(i3, vVar.f7074c - vVar.b);
    ...
    */
    ...
    public int write(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer != null) {
            ...
            while (i2 > 0) {
                v L = L(1);
                int min = Math.min(i2, 8192 - L.f7074c);
                byteBuffer.get(L.a, L.f7074c, min);
                i2 -= min;
                L.f7074c += min;
            }
            this.b += remaining;
    ...
    public int read(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer != null) {
            v vVar = this.a;
            if (vVar != null) {
                int min = Math.min(byteBuffer.remaining(), vVar.f7074c - vVar.b);
