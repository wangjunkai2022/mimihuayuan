...
public class k implements Serializable, Comparable<k> {
    ...
    public final byte[] f7064c;

    /* renamed from: e  reason: collision with root package name */
    public static final a f7063e = new a(null);

    /* renamed from: d  reason: collision with root package name */
    public static final k f7062d = j.c0.a.b;
    ...
    public k a(String str) {
        byte[] digest = MessageDigest.getInstance(str).digest(this.f7064c);
