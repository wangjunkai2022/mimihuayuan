...
public final class u implements j {
    ...
    public int D(r rVar) {
        if (rVar != null) {
            if (!this.b) {
                ...
                } while (this.f7073c.c(this.a, 8192) != -1);
                return -1;
            }
    ...
    public long c(g gVar, long j2) {
        ...
        if (j2 >= 0) {
            if (!this.b) {
                g gVar2 = this.a;
                if (gVar2.b == 0 && this.f7073c.c(gVar2, 8192) == -1) {
                    return -1L;
                }
        ...
        if (!this.b) {
            ...
            while (j2 < j3) {
                ...
                if (g2 == -1) {
                    g gVar = this.a;
                    long j4 = gVar.b;
                    if (j4 >= j3 || this.f7073c.c(gVar, 8192) == -1) {
                        break;
                    }
                    j2 = Math.max(j2, j4);
                } else {
    ...
    public boolean g(long j2) {
        ...
        if (j2 >= 0) {
            if (!this.b) {
                ...
                } while (this.f7073c.c(gVar, 8192) != -1);
                return false;
            }
            throw new IllegalStateException("closed".toString());
        }
    ...
    public boolean p() {
        if (!this.b) {
            return this.a.p() && this.f7073c.c(this.a, (long) 8192) == -1;
        }
        throw new IllegalStateException("closed".toString());
    }
    ...
    public int read(ByteBuffer byteBuffer) {
        if (byteBuffer != null) {
            g gVar = this.a;
            if (gVar.b == 0 && this.f7073c.c(gVar, 8192) == -1) {
                return -1;
            }
    ...
    */
    ...
    public static final class a extends InputStream {
        ...
        public int read() {
            ...
            if (!uVar.b) {
                g gVar = uVar.a;
                if (gVar.b == 0 && uVar.f7073c.c(gVar, 8192) == -1) {
                    return -1;
                }
