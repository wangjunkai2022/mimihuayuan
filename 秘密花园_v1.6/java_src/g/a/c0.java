...
public class c0<E> extends AbstractList<E> implements OrderedRealmCollection<E> {
    ...
    public final o<E> f6302c;

    /* renamed from: d  reason: collision with root package name */
    public final g.a.a f6303d;

    /* renamed from: e  reason: collision with root package name */
    public List<E> f6304e;
    ...
    public class b implements Iterator<E> {
        ...
        public b(a aVar) {
            this.f6305c = ((AbstractList) c0.this).modCount;
        }

        public final void a() {
            if (((AbstractList) c0.this).modCount != this.f6305c) {
    ...
    public void clear() {
        if (i()) {
            this.f6303d.f();
            OsList.nativeRemoveAll(this.f6302c.b.a);
        } else {
            this.f6304e.clear();
        }
        ((AbstractList) this).modCount++;
    ...
    public boolean contains(Object obj) {
        if (i()) {
            this.f6303d.f();
            if ((obj instanceof g.a.f1.n) && ((g.a.f1.n) obj).realmGet$proxyState().f6389c == g.a.f1.g.INSTANCE) {
                return false;
            }
            return super.contains(obj);
        }
        return this.f6304e.contains(obj);
    }
    ...
    public E get(int i2) {
        if (i()) {
            this.f6303d.f();
            return this.f6302c.c(i2);
        }
        return this.f6304e.get(i2);
    }
    ...
    public E remove(int i2) {
        ...
        if (i()) {
            this.f6303d.f();
            remove = get(i2);
            OsList.nativeRemove(this.f6302c.b.a, i2);
        } else {
            remove = this.f6304e.remove(i2);
        }
        ((AbstractList) this).modCount++;
        return remove;
    }
    ...
    public String toString() {
        ...
        if (!i()) {
            ...
            if (str != null) {
                ...
                sb.append(this.f6303d.G().d(this.a).a());
            } else {
                Class<E> cls = this.a;
                if (cls == byte[].class) {
            ...
            if (!(oVar != null && OsList.nativeIsValid(oVar.b.a))) {
                ...
                while (i2 < size()) {
                    sb.append(((g.a.f1.n) get(i2)).realmGet$proxyState().f6389c.l());
                    sb.append(",");
                    i2++;
                }
                if (size() > 0) {
    ...
    public c0(Class<E> cls, OsList osList, g.a.a aVar) {
        this.a = cls;
        this.f6302c = g(aVar, osList, cls, null);
        this.f6303d = aVar;
    }
    ...
    public c0(String str, OsList osList, g.a.a aVar) {
        this.f6303d = aVar;
        this.b = str;
        this.f6302c = g(aVar, osList, null, str);
    }
