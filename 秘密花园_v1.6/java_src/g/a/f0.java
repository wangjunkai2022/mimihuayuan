...
public final class f0<T> extends o<T> {
    ...
    public void a(Object obj) {
        ...
        OsList.nativeAddRow(osList.a, ((g.a.f1.n) h((e0) obj)).realmGet$proxyState().f6389c.l());
    }
    ...
    public T c(int i2) {
        ...
        OsList osList = this.b;
        return (T) aVar.F(cls, str, osList.f7004c.m(OsList.nativeGetRow(osList.a, i2)));
    }
    ...
    public void e(int i2, Object obj) {
        ...
        if (i2 >= 0 && i3 >= i2) {
            OsList.nativeInsertRow(this.b.a, i2, ((g.a.f1.n) h((e0) obj)).realmGet$proxyState().f6389c.l());
            return;
        }
    ...
    public void g(int i2, Object obj) {
        OsList osList = this.b;
        OsList.nativeSetRow(osList.a, i2, ((g.a.f1.n) h((e0) obj)).realmGet$proxyState().f6389c.l());
    }
    ...
    public final <E extends e0> E h(E e2) {
        if (e2 instanceof g.a.f1.n) {
            ...
            if (nVar instanceof DynamicRealmObject) {
                ...
                } else if (aVar2.a == nVar.realmGet$proxyState().f6391e.a) {
                    throw new IllegalArgumentException("Cannot copy DynamicRealmObject between Realm instances.");
                } else {
                    throw new IllegalStateException("Cannot copy an object to a Realm instance created in another thread.");
                }
            } else if (nVar.realmGet$proxyState().f6389c != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(this.a.b.f6281c)) {
                if (this.a == nVar.realmGet$proxyState().f6391e) {
                    return e2;
                }
        ...
        x xVar = (x) this.a;
        if (OsObjectStore.a(xVar.f6275d, xVar.b.f6288j.g(e2.getClass())) != null) {
            m[] mVarArr = new m[0];
            xVar.J(e2);
            Class<?> cls = e2.getClass();
            OsObjectSchemaInfo a = xVar.f6275d.getSchemaInfo().a(xVar.b.f6288j.g(cls));
