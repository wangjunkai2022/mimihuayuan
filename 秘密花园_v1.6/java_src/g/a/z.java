...
public final class z {
    ...
    public static final List<WeakReference<z>> f6404e = new ArrayList();

    /* renamed from: f  reason: collision with root package name */
    public static final Collection<z> f6405f = new ConcurrentLinkedQueue();
    ...
    public final AtomicBoolean f6407d = new AtomicBoolean(false);
    ...
    */
    public static void a(java.lang.String r6, java.io.File r7) {
        ...
        L7:
            r0 = 0
            android.content.Context r1 = g.a.a.f6271g     // Catch: java.lang.Throwable -> L66 java.io.IOException -> L69
    ...
    */
    ...
    public static z d(String str, boolean z) {
        z zVar;
        synchronized (f6404e) {
            Iterator<WeakReference<z>> it = f6404e.iterator();
            zVar = null;
            while (it.hasNext()) {
                z zVar2 = it.next().get();
                if (zVar2 == null) {
            ...
            if (zVar == null && z) {
                zVar = new z(str);
                f6404e.add(new WeakReference<>(zVar));
            }
        }
        return zVar;
    }
    ...
    public final void f(b0 b0Var) {
        if (this.f6406c.equals(b0Var)) {
            return;
        }
        if (Arrays.equals(this.f6406c.a(), b0Var.a())) {
            d0 d0Var = b0Var.f6285g;
            d0 d0Var2 = this.f6406c.f6285g;
