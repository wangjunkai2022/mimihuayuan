...
public abstract class c {
    ...
    public static final Pattern f6329h = Pattern.compile("\\.");

    /* renamed from: i  reason: collision with root package name */
    public static final Set<RealmFieldType> f6330i;

    /* renamed from: j  reason: collision with root package name */
    public static final Set<RealmFieldType> f6331j;

    /* renamed from: k  reason: collision with root package name */
    public static final Set<RealmFieldType> f6332k;

    /* renamed from: l  reason: collision with root package name */
    public static final Set<RealmFieldType> f6333l;
    public final List<String> a;
    public final Set<RealmFieldType> b;

    /* renamed from: c  reason: collision with root package name */
    public final Set<RealmFieldType> f6334c;

    /* renamed from: d  reason: collision with root package name */
    public String f6335d;

    /* renamed from: e  reason: collision with root package name */
    public RealmFieldType f6336e;
    ...
    public c(String str, Set<RealmFieldType> set, Set<RealmFieldType> set2) {
        ...
        if (str != null && !str.equals("")) {
            ...
            if (lastIndexOf != str.length() - 1) {
                if (lastIndexOf > -1) {
                    singletonList = Arrays.asList(f6329h.split(str));
                } else {
    ...
    public final void e(String str, String str2, RealmFieldType realmFieldType, long[] jArr, long[] jArr2) {
        Set<RealmFieldType> set = this.f6334c;
        if (set != null && set.size() > 0) {
            f(str, str2, realmFieldType, this.f6334c);
        }
        this.f6335d = str2;
        this.f6336e = realmFieldType;
        this.f6337f = jArr;
        this.f6338g = jArr2;
    }
