...
public class r extends OsResults {
    ...
    public class c implements Runnable {
        ...
        public void run() {
            ...
            r rVar = r.this;
            if (rVar.f6323l || rVar.f6321j) {
                r rVar2 = r.this;
                OsSubscription osSubscription = rVar2.f6321j ? rVar2.f6322k : null;
                if (rVar2.f6320i != 0 || osSubscription == null || rVar2.f6324m || osSubscription.a() == OsSubscription.d.ERROR || osSubscription.a() == OsSubscription.d.COMPLETE) {
                    if (rVar2.f6320i == 0) {
                        osCollectionChangeSet = new d(osSubscription, rVar2.f6324m, true);
                    } else {
                        osCollectionChangeSet = new OsCollectionChangeSet(rVar2.f6320i, rVar2.f6324m, osSubscription, true);
                    }
                    if (osCollectionChangeSet.e() && rVar2.f7027e) {
                        return;
                    }
                    rVar2.f7027e = true;
                    rVar2.f6324m = false;
                    rVar2.f7029g.b(new ObservableCollection.a(osCollectionChangeSet));
                }
            }
        }
    }
