...
public class a {
    ...
    public static final byte[] f2596c = {37, -110, 60, Byte.MAX_VALUE, 42, -27, -17, -110};

    /* renamed from: d  reason: collision with root package name */
    public static final byte[] f2597d = {-122, -8, -23, -84, -125, 113, 84, 99};

    /* renamed from: e  reason: collision with root package name */
    public static final byte[] f2598e = "AL!#$AC9Ahg@KLJ1".getBytes();

    public static void a(int[] iArr, int[][] iArr2) {
        int[] iArr3 = new int[56];
        for (int i2 = 0; i2 < 56; i2++) {
            iArr3[i2] = iArr[f2601h[i2] - 1];
        }
        for (int i3 = 0; i3 < 16; i3++) {
            a(iArr3, f2606m[i3]);
            for (int i4 = 0; i4 < 48; i4++) {
                iArr2[i3][i4] = iArr3[f2602i[i4] - 1];
            }
        }
    }
    ...
    public static void a(int[] iArr, int i2, int i3, int[][] iArr2) {
        ...
        while (i6 < i7) {
            ...
            iArr9[i6] = f2605l[i6][(iArr8[i6][c2] << 1) + iArr8[i6][5]][(iArr8[i6][1] << 3) + (iArr8[i6][2] << 2) + (iArr8[i6][3] << 1) + iArr8[i6][4]];
        ...
        for (int i10 = 0; i10 < 32; i10++) {
            iArr11[i10] = iArr10[f2604k[i10] - 1];
            iArr5[i10] = iArr4[i10];
