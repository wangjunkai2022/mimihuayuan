...
public class c {
    ...
    public static class a {
        ...
        public String f2608d = "0";

        /* renamed from: e  reason: collision with root package name */
        public String f2609e = null;
    }
    ...
    public static boolean c(Context context) {
        ...
        boolean z = false;
        try {
            if (Long.valueOf(a2.f2608d).longValue() >= 6001500) {
                z = true;
            }
    ...
    */
    ...
    public static a a(Context context) {
        ...
        try {
            ...
            try {
                ...
                aVar.a = 2;
                aVar.f2609e = TbsConfig.APP_QB;
                aVar.f2607c = "ADRQB_";
                if (packageInfo != null && packageInfo.versionCode > 420000) {
                    aVar.b = packageInfo.versionCode;
                    aVar.f2607c += packageInfo.versionName.replaceAll("\\.", "");
                    aVar.f2608d = packageInfo.versionName.replaceAll("\\.", "");
                    return aVar;
                }
            ...
            try {
                try {
                    try {
                        try {
                            ...
                            aVar.a = 1;
                            aVar.f2609e = "com.tencent.qbx5";
                            aVar.f2607c = "ADRQBX5_";
                        }
                ...
                aVar.f2609e = "com.tencent.mtt.x86";
                aVar.a = 2;
                aVar.f2607c = "ADRQB_";
            }
            if (packageInfo != null) {
    ...
    public static boolean a(Context context, long j2, long j3) {
        ...
        boolean z = false;
        try {
            if (Long.valueOf(a2.f2608d).longValue() >= j2) {
                z = true;
            }
        } catch (NumberFormatException e2) {
            e2.printStackTrace();
