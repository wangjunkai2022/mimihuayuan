...
public class TbsReaderView extends FrameLayout {
    ...
    public ReaderCallback f2555d;

    /* renamed from: e  reason: collision with root package name */
    public ReaderCallback f2556e;
    ...
    public TbsReaderView(Context context, ReaderCallback readerCallback) throws RuntimeException {
        ...
        if (context instanceof Activity) {
            this.f2555d = readerCallback;
            this.a = context;
            this.f2556e = new ReaderCallback() { // from class: com.tencent.smtt.sdk.TbsReaderView.1
    ...
    public void doCommand(Integer num, Object obj, Object obj2) {
        ...
        if (readerWizard == null || (obj3 = this.f2554c) == null) {
            return;
        }
    ...
    public void onSizeChanged(int i2, int i3) {
        Object obj;
        ReaderWizard readerWizard = this.b;
        if (readerWizard == null || (obj = this.f2554c) == null) {
            return;
        }
    ...
    public void onStop() {
        ...
        if (readerWizard != null) {
            readerWizard.destroy(this.f2554c);
            this.f2554c = null;
        }
        this.a = null;
        f2553f = false;
    ...
    public void openFile(Bundle bundle) {
        if (this.f2554c == null || bundle == null) {
            return;
        }
        ...
        this.b.openFile(this.f2554c, this.a, bundle, this);
    }
    ...
    public boolean preOpen(String str, boolean z) {
        if (isSupportExt(this.a, str)) {
            ...
            if (a) {
                boolean a2 = a();
                if (z && a2) {
                    return this.b.checkPlugin(this.f2554c, this.a, str, Apn.getApnType(this.a) == 3);
                }
                return a2;
            }
            return a;
    ...
    public void userStatistics(String str) {
        ReaderWizard readerWizard = this.b;
        if (readerWizard != null) {
            readerWizard.userStatistics(this.f2554c, str);
        }
    }
    ...
    public boolean a() {
        try {
            if (this.b == null) {
                this.b = new ReaderWizard(this.f2556e);
            }
            if (this.f2554c == null) {
                this.f2554c = this.b.getTbsReader();
            }
            if (this.f2554c != null) {
                return this.b.initTbsReader(this.f2554c, this.a);
            }
            return false;
