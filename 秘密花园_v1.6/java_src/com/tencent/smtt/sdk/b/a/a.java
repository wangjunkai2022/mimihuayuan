...
public class a extends ArrayAdapter<b> implements View.OnClickListener, ListAdapter {
    ...
    public WeakReference<ListView> f2611d;

    /* renamed from: e  reason: collision with root package name */
    public WeakReference<c> f2612e;

    /* renamed from: f  reason: collision with root package name */
    public b f2613f;

    /* renamed from: g  reason: collision with root package name */
    public Handler f2614g;
    ...
    public ValueCallback<String> f2617j;

    /* renamed from: k  reason: collision with root package name */
    public Map<String, Drawable> f2618k;
    ...
    public a(Context context, Intent intent, b bVar, b bVar2, c cVar, ListView listView, ValueCallback<String> valueCallback) {
        ...
        this.f2617j = valueCallback;
        this.f2614g = new Handler() { // from class: com.tencent.smtt.sdk.b.a.a.1
        ...
        this.f2615h[1] = d.b("x5_tbs_activity_picker_recommend_with_chinese_brace_to_trim");
        a(context, bVar2);
    }
    ...
    public void b() {
        ...
        if (Looper.myLooper() != Looper.getMainLooper()) {
            this.f2614g.obtainMessage(1).sendToTarget();
            return;
        }
        ListView listView = this.f2611d.get();
        if (listView == null || (findViewWithTag = listView.findViewWithTag(this.f2613f)) == null) {
            return;
        }
        a(this.f2613f, findViewWithTag);
    }

    public void a(ListView listView) {
        this.f2611d = new WeakReference<>(listView);
    }

    public void a(c cVar) {
        this.f2612e = new WeakReference<>(cVar);
    }
    ...
    public void a(Context context, b bVar) {
        ...
        boolean z = false;
        boolean z2 = false;
        for (ResolveInfo resolveInfo : context.getPackageManager().queryIntentActivities(this.f2610c, 65536)) {
    ...
    private void a(b bVar, View view) {
        ...
        ((ImageView) view.findViewById(101)).setImageDrawable(bVar.a(this.f2618k));
        String replaceAll = bVar.a().trim().replaceAll(" ", "");
        for (String str : this.f2615h) {
        ...
        if (bVar.b() == null) {
            Iterator<ResolveInfo> it = getContext().getPackageManager().queryIntentActivities(this.f2610c, 65536).iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                ...
                public void onClick(View view2) {
                    if (TbsConfig.APP_QQ.equals(a.this.getContext().getApplicationContext().getPackageName())) {
                        if (a.this.f2617j != null) {
                            a.this.f2617j.onReceiveValue("http://mdc.html5.qq.com/d/directdown.jsp?channel_id=11047");
                        }
                        ((c) a.this.f2612e.get()).dismiss();
                        return;
                    }
    ...
    private void a(boolean z) {
        c cVar;
        WeakReference<c> weakReference = this.f2612e;
