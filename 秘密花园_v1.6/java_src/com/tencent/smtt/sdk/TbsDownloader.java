...
public class TbsDownloader {
    ...
    public static Context f2521c = null;

    /* renamed from: d  reason: collision with root package name */
    public static Handler f2522d = null;

    /* renamed from: e  reason: collision with root package name */
    public static String f2523e = null;

    /* renamed from: f  reason: collision with root package name */
    public static Object f2524f = new byte[0];

    /* renamed from: g  reason: collision with root package name */
    public static i f2525g = null;

    /* renamed from: h  reason: collision with root package name */
    public static HandlerThread f2526h = null;

    /* renamed from: i  reason: collision with root package name */
    public static boolean f2527i = false;

    /* renamed from: j  reason: collision with root package name */
    public static boolean f2528j = false;

    /* renamed from: k  reason: collision with root package name */
    public static boolean f2529k = false;

    /* renamed from: l  reason: collision with root package name */
    public static long f2530l = -1;
    ...
    public static boolean c() {
        try {
            for (String str : TbsShareManager.getCoreProviderAppList()) {
                if (TbsShareManager.getSharedTbsCoreVersion(f2521c, str) > 0) {
                    return true;
                }
            }
        } catch (Exception e2) {
    ...
    public static synchronized void d() {
        synchronized (TbsDownloader.class) {
            if (f2526h == null) {
                ...
                try {
                    f2525g = new i(f2521c);
                    f2522d = new Handler(f2526h.getLooper()) { // from class: com.tencent.smtt.sdk.TbsDownloader.1
                        ...
                        public void handleMessage(Message message) {
                                ...
                                switch (i2) {
                                    case 100:
                                        ...
                                        if (obj != null && (obj instanceof TbsDownloaderCallback)) {
                                            ...
                                            String str = (TbsDownloader.f2521c == null || TbsDownloader.f2521c.getApplicationContext() == null || TbsDownloader.f2521c.getApplicationContext().getApplicationInfo() == null) ? "" : TbsDownloader.f2521c.getApplicationContext().getApplicationInfo().packageName;
                                            if (!b2 || z) {
                                                ((TbsDownloaderCallback) message.obj).onNeedDownloadFinish(b2, TbsDownloadConfig.getInstance(TbsDownloader.f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0));
                                        ...
                                        if (TbsShareManager.isThirdPartyApp(TbsDownloader.f2521c) && b2) {
                                            TbsDownloader.startDownload(TbsDownloader.f2521c);
                                            return;
                                        }
                                        return;
                                    case 101:
                                    ...
                                    case 102:
                                        ...
                                        int a2 = TbsShareManager.isThirdPartyApp(TbsDownloader.f2521c) ? TbsShareManager.a(TbsDownloader.f2521c, false) : l.a().m(TbsDownloader.f2521c);
                                        TbsLog.i(TbsDownloader.LOGTAG, "[TbsDownloader.handleMessage] localTbsVersion=" + a2);
                                        TbsDownloader.f2525g.a(a2);
                                        TbsLogReport.getInstance(TbsDownloader.f2521c).dailyReport();
                                        return;
                                    case 103:
                                    ...
                                    case 104:
                                        ...
                                        TbsLogReport.getInstance(TbsDownloader.f2521c).reportTbsLog();
                                        return;
                                    default:
                                        return;
                                }
                            ...
                            if (TbsShareManager.isThirdPartyApp(TbsDownloader.f2521c)) {
                                fileOutputStream = null;
                            } else {
                                StringBuilder o = f.b.a.a.a.o("tbs_download_lock_file");
                                o.append(TbsDownloadConfig.getInstance(TbsDownloader.f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0));
                                o.append(".txt");
                                fileOutputStream = com.tencent.smtt.utils.f.b(TbsDownloader.f2521c, false, o.toString());
                                if (fileOutputStream != null) {
                                    fileLock = com.tencent.smtt.utils.f.a(TbsDownloader.f2521c, fileOutputStream);
                                    if (fileLock == null) {
                                        QbSdk.f2496m.onDownloadFinish(TbsListener.ErrorCode.NONEEDDOWNLOAD_OTHER_PROCESS_DOWNLOADING);
                                        TbsLog.i(TbsDownloader.LOGTAG, "file lock locked,wx or qq is downloading");
                                        TbsDownloadConfig.getInstance(TbsDownloader.f2521c).setDownloadInterruptCode(-203);
                                        TbsLog.i(TbsDownloader.LOGTAG, "MSG_START_DOWNLOAD_DECOUPLECORE return #1");
                                        return;
                                    }
                                } else if (com.tencent.smtt.utils.f.a(TbsDownloader.f2521c)) {
                                    TbsDownloadConfig.getInstance(TbsDownloader.f2521c).setDownloadInterruptCode(-204);
                                    TbsLog.i(TbsDownloader.LOGTAG, "MSG_START_DOWNLOAD_DECOUPLECORE return #2");
                                    return;
                                }
                            }
                            boolean z2 = message.arg1 == 1;
                            TbsDownloadConfig tbsDownloadConfig = TbsDownloadConfig.getInstance(TbsDownloader.f2521c);
                            if (TbsDownloader.b(false, z2, 108 == message.what, true)) {
                                if (z2 && l.a().b(TbsDownloader.f2521c, TbsDownloadConfig.getInstance(TbsDownloader.f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0))) {
                                    QbSdk.f2496m.onDownloadFinish(122);
                                    ...
                                    TbsDownloadConfig.getInstance(TbsDownloader.f2521c).setDownloadInterruptCode(-215);
                                    TbsDownloader.f2525g.b(z2, 108 == message.what);
                                } else {
                                    QbSdk.f2496m.onDownloadFinish(110);
                                }
                            } else {
                                QbSdk.f2496m.onDownloadFinish(110);
                            }
    ...
    public static boolean e() {
        try {
            return TbsDownloadConfig.getInstance(f2521c).mPreferences.getString(TbsDownloadConfig.TbsConfigKey.KEY_LAST_THIRDAPP_SENDREQUEST_COREVERSION, "").equals(g().toString());
        } catch (Exception unused) {
            return false;
        }
    }
    ...
    public static String[] f() {
        if (QbSdk.getOnlyDownload()) {
            return new String[]{f2521c.getApplicationContext().getPackageName()};
        }
        String[] coreProviderAppList = TbsShareManager.getCoreProviderAppList();
        String packageName = f2521c.getApplicationContext().getPackageName();
        if (packageName.equals(TbsShareManager.f(f2521c))) {
    ...
    public static JSONArray g() {
        if (TbsShareManager.isThirdPartyApp(f2521c)) {
        ...
        synchronized (TbsDownloader.class) {
            if (!f2529k) {
                ...
                if (tbsDownloadConfig.mPreferences.contains(TbsDownloadConfig.TbsConfigKey.KEY_IS_OVERSEA)) {
                    f2528j = tbsDownloadConfig.mPreferences.getBoolean(TbsDownloadConfig.TbsConfigKey.KEY_IS_OVERSEA, false);
                    TbsLog.i(LOGTAG, "[TbsDownloader.getOverSea]  first called. sOverSea = " + f2528j);
                }
                TbsLog.i(LOGTAG, "[TbsDownloader.getOverSea]  sOverSea = " + f2528j);
            }
            z = f2528j;
        }
        return z;
    ...
    public static boolean h() {
        TbsDownloadConfig tbsDownloadConfig = TbsDownloadConfig.getInstance(f2521c);
        if (tbsDownloadConfig.mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_DOWNLOAD_SUCCESS_RETRYTIMES, 0) >= tbsDownloadConfig.getDownloadSuccessMaxRetrytimes()) {
            ...
            return false;
        } else if (!com.tencent.smtt.utils.f.b(f2521c)) {
    ...
    public static boolean needDownloadDecoupleCore() {
        int i2;
        if (TbsShareManager.isThirdPartyApp(f2521c) || a(f2521c)) {
            return false;
        }
        return System.currentTimeMillis() - TbsDownloadConfig.getInstance(f2521c).mPreferences.getLong(TbsDownloadConfig.TbsConfigKey.KEY_LAST_DOWNLOAD_DECOUPLE_CORE, 0L) >= TbsDownloadConfig.getInstance(f2521c).getRetryInterval() * 1000 && (i2 = TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_DECOUPLECOREVERSION, 0)) > 0 && i2 != l.a().h(f2521c) && TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0) != i2;
    }
    ...
    public static boolean startDecoupleCoreIfNeeded() {
        ...
        if (a(f2521c) || f2522d == null) {
            return false;
        }
        TbsLog.i(LOGTAG, "startDecoupleCoreIfNeeded #2");
        long j2 = TbsDownloadConfig.getInstance(f2521c).mPreferences.getLong(TbsDownloadConfig.TbsConfigKey.KEY_LAST_DOWNLOAD_DECOUPLE_CORE, 0L);
        if (System.currentTimeMillis() - j2 < TbsDownloadConfig.getInstance(f2521c).getRetryInterval() * 1000) {
            return false;
        }
        TbsLog.i(LOGTAG, "startDecoupleCoreIfNeeded #3");
        int i2 = TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_DECOUPLECOREVERSION, 0);
        if (i2 > 0 && i2 != l.a().h(f2521c)) {
            if (TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0) == i2 && TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V_TYPE, 0) != 1) {
                StringBuilder o = f.b.a.a.a.o("startDecoupleCoreIfNeeded no need, KEY_TBS_DOWNLOAD_V is ");
                o.append(TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0));
                o.append(" deCoupleCoreVersion is ");
                o.append(i2);
                o.append(" KEY_TBS_DOWNLOAD_V_TYPE is ");
                o.append(TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V_TYPE, 0));
                TbsLog.i(LOGTAG, o.toString());
            } else {
                TbsLog.i(LOGTAG, "startDecoupleCoreIfNeeded #4");
                a = true;
                f2522d.removeMessages(108);
                Message obtain = Message.obtain(f2522d, 108, QbSdk.f2496m);
                obtain.arg1 = 0;
                obtain.sendToTarget();
                TbsDownloadConfig.getInstance(f2521c).a.put(TbsDownloadConfig.TbsConfigKey.KEY_LAST_DOWNLOAD_DECOUPLE_CORE, Long.valueOf(System.currentTimeMillis()));
                return true;
            }
        } else {
    ...
    public static void stopDownload() {
        ...
        Handler handler = f2522d;
        if (handler != null) {
            handler.removeMessages(100);
            f2522d.removeMessages(101);
            f2522d.removeMessages(108);
        }
    }
    ...
    public static synchronized void startDownload(Context context, boolean z) {
        synchronized (TbsDownloader.class) {
            ...
            TbsLog.i(LOGTAG, "[TbsDownloader.startDownload] sAppContext=" + f2521c);
            if (l.b) {
            ...
            f2521c = applicationContext;
            TbsDownloadConfig.getInstance(applicationContext).setDownloadInterruptCode(-200);
            d();
            if (f2527i) {
                QbSdk.f2496m.onDownloadFinish(121);
                TbsDownloadConfig.getInstance(f2521c).setDownloadInterruptCode(-202);
            ...
            f2522d.removeMessages(101);
            f2522d.removeMessages(100);
            Message obtain = Message.obtain(f2522d, 101, QbSdk.f2496m);
            if (!z) {
                i2 = 0;
            }
            obtain.arg1 = i2;
    ...
    */
    ...
    public static boolean needDownload(Context context, boolean z, boolean z2, boolean z3, TbsDownloaderCallback tbsDownloaderCallback) {
        ...
        f2522d.removeMessages(102);
        Message.obtain(f2522d, 102).sendToTarget();
        if (QbSdk.f2486c || !TbsShareManager.isThirdPartyApp(context)) {
        ...
        if (z4) {
            ...
            if (!a2 && m2 > 0) {
                ...
                f2522d.removeMessages(103);
                if (m2 <= 0 && !a2) {
                    Message.obtain(f2522d, 103, 0, 0, f2521c).sendToTarget();
                } else {
                    Message.obtain(f2522d, 103, 1, 0, f2521c).sendToTarget();
                }
    ...
    public static void c(JSONArray jSONArray) {
        String[] f2;
        boolean z;
        if (TbsPVConfig.getInstance(f2521c).isDisableHostBackupCore()) {
            return;
        }
        for (String str : f()) {
            int backupCoreVersion = TbsShareManager.getBackupCoreVersion(f2521c, str);
            boolean z2 = true;
            if (backupCoreVersion > 0) {
                Context packageContext = TbsShareManager.getPackageContext(f2521c, str, false);
            ...
            int backupDecoupleCoreVersion = TbsShareManager.getBackupDecoupleCoreVersion(f2521c, str);
            if (backupDecoupleCoreVersion > 0) {
                Context packageContext2 = TbsShareManager.getPackageContext(f2521c, str, false);
    ...
    */
    ...
    public static boolean a(Context context, boolean z) {
        TbsDownloadConfig tbsDownloadConfig = TbsDownloadConfig.getInstance(context);
        if (QbSdk.f2486c || !TbsShareManager.isThirdPartyApp(f2521c) || c()) {
            if (!tbsDownloadConfig.mPreferences.contains(TbsDownloadConfig.TbsConfigKey.KEY_IS_OVERSEA)) {
            ...
            try {
                matcher = Pattern.compile("i686|mips|x86_64").matcher(f2523e);
            } catch (Exception unused) {
            }
    ...
    public static void a(boolean z, TbsDownloaderCallback tbsDownloaderCallback, boolean z2) {
        ...
        f2522d.removeMessages(100);
        Message obtain = Message.obtain(f2522d, 100);
        if (tbsDownloaderCallback != null) {
    ...
    public static void a(JSONArray jSONArray) {
        ...
        while (true) {
            ...
            String str = f3[i2];
            int sharedTbsCoreVersion = TbsShareManager.getSharedTbsCoreVersion(f2521c, str);
            if (sharedTbsCoreVersion > 0) {
                Context packageContext = TbsShareManager.getPackageContext(f2521c, str, true);
                if (packageContext == null || l.a().f(packageContext)) {
                    int i3 = 0;
                    while (true) {
                        if (i3 >= jSONArray.length()) {
        ...
        for (String str2 : f()) {
            int coreShareDecoupleCoreVersion = TbsShareManager.getCoreShareDecoupleCoreVersion(f2521c, str2);
            if (coreShareDecoupleCoreVersion > 0) {
                Context packageContext2 = TbsShareManager.getPackageContext(f2521c, str2, true);
                if (packageContext2 == null || l.a().f(packageContext2)) {
                    int i4 = 0;
                    while (true) {
    ...
    public static JSONObject a(boolean z, boolean z2, boolean z3) {
        ...
        TbsDownloadConfig tbsDownloadConfig = TbsDownloadConfig.getInstance(f2521c);
        String b2 = b(f2521c);
        String d2 = com.tencent.smtt.utils.b.d(f2521c);
        String c2 = com.tencent.smtt.utils.b.c(f2521c);
        String f2 = com.tencent.smtt.utils.b.f(f2521c);
        String id = TimeZone.getDefault().getID();
        String str = id != null ? id : "";
        try {
            TelephonyManager telephonyManager = (TelephonyManager) f2521c.getSystemService("phone");
        ...
        try {
            ...
            if (TbsShareManager.isThirdPartyApp(f2521c)) {
                if (QbSdk.f2486c) {
                    m2 = TbsShareManager.a(f2521c, false);
                } else {
                    m2 = TbsDownloadConfig.getInstance(f2521c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0);
                }
            } else {
                if (z3) {
                    m2 = l.a().i(f2521c);
                ...
                if (m2 == 0 && l.a().l(f2521c)) {
                    m2 = -1;
                    if (TbsConfig.APP_QQ.equals(f2521c.getApplicationInfo().packageName)) {
                        TbsDownloadUpload.clear();
                        TbsDownloadUpload tbsDownloadUpload = TbsDownloadUpload.getInstance(f2521c);
                        tbsDownloadUpload.a.put(TbsDownloadUpload.TbsUploadKey.KEY_LOCAL_CORE_VERSION, -1);
                        tbsDownloadUpload.commit();
                        TbsPVConfig.releaseInstance();
                        if (TbsPVConfig.getInstance(f2521c).getLocalCoreVersionMoreTimes() == 1) {
                            m2 = l.a().i(f2521c);
                        }
                    }
                }
            ...
            if (TbsShareManager.isThirdPartyApp(f2521c)) {
                ...
                JSONArray a2 = a(z3);
                if (Apn.getApnType(f2521c) != 3 && a2.length() != 0 && m2 == 0 && z) {
                    jSONObject.put("TBSBACKUPARR", a2);
                }
            }
            jSONObject.put("APPN", f2521c.getPackageName());
            ...
            tbsDownloadConfig.commit();
            if (m2 != 0) {
                jSONObject.put("TBSBACKUPV", f2525g.b(z3));
            }
            jSONObject.put("CPU", f2523e);
            ...
            if (!TbsShareManager.isThirdPartyApp(f2521c)) {
                if (m2 != 0) {
                    jSONObject.put("STATUS", QbSdk.a(f2521c, m2) ? 0 : 1);
                } else {
                    jSONObject.put("STATUS", 0);
                }
                jSONObject.put("TBSDV", l.a().h(f2521c));
            }
            boolean z5 = TbsDownloadConfig.getInstance(f2521c).mPreferences.getBoolean(TbsDownloadConfig.TbsConfigKey.KEY_FULL_PACKAGE, false);
            Object a3 = QbSdk.a(f2521c, "can_unlzma", (Bundle) null);
    ...
    public static File b(int i2) {
        ...
        while (i3 < length) {
            ...
            File file2 = new File(com.tencent.smtt.utils.f.a(f2521c, str, 4, false), getOverSea(f2521c) ? "x5.oversea.tbs.org" : "x5.tbs.org");
            if (file2.exists() && com.tencent.smtt.utils.a.a(f2521c, file2) == i2) {
                StringBuilder o = f.b.a.a.a.o("local tbs version fond,path = ");
                o.append(file2.getAbsolutePath());
                TbsLog.i(LOGTAG, o.toString());
            } else {
                file2 = new File(com.tencent.smtt.utils.f.a(f2521c, str, 4, false), "x5.tbs.decouple");
                if (file2.exists() && com.tencent.smtt.utils.a.a(f2521c, file2) == i2) {
    ...
    public static File a(int i2) {
        ...
        while (true) {
            ...
            String str = coreProviderAppList[i3];
            if (!str.equals(f2521c.getApplicationInfo().packageName)) {
                file = new File(com.tencent.smtt.utils.f.a(f2521c, str, 4, false), getOverSea(f2521c) ? "x5.oversea.tbs.org" : "x5.tbs.org");
                if (file.exists()) {
                    if (com.tencent.smtt.utils.a.a(f2521c, file) == i2) {
                        StringBuilder o = f.b.a.a.a.o("local tbs version fond,path = ");
    ...
    public static JSONArray a(boolean z) {
        ...
        for (String str : TbsShareManager.getCoreProviderAppList()) {
            if (z) {
                ...
                file = new File(com.tencent.smtt.utils.f.a(f2521c, str, 4, false), "x5.tbs.decouple");
            }
            if (file.exists()) {
                long a2 = com.tencent.smtt.utils.a.a(f2521c, file);
                if (a2 > 0) {
                    int i2 = 0;
                    while (true) {
                        if (i2 >= jSONArray.length()) {
