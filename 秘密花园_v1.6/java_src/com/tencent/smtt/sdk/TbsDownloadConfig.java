...
public class TbsDownloadConfig {
    ...
    public TbsDownloadConfig(Context context) {
        ...
        this.f2513c = applicationContext;
    ...
    public synchronized int getDownloadInterruptCode() {
        ...
        if (!this.mPreferences.contains(TbsConfigKey.KEY_DOWNLOAD_INTERRUPT_CODE)) {
            try {
                if (new File(new File(this.f2513c.getFilesDir(), "shared_prefs"), "tbs_download_config").exists()) {
                    i2 = !this.mPreferences.contains(TbsConfigKey.KEY_NEEDDOWNLOAD) ? -96 : -101;
                } else {
                    i2 = -97;
                }
        ...
        if (this.f2513c == null || !TbsConfig.APP_QQ.equals(this.f2513c.getApplicationInfo().packageName) || "CN".equals(Locale.getDefault().getCountry())) {
    ...
    */
    public synchronized void uploadDownloadInterruptCodeIfNeeded(android.content.Context r6) {
        /*
            ...
            android.content.Context r3 = r5.f2513c     // Catch: java.lang.Throwable -> L4d
