...
public class TbsShareManager {
    ...
    public static String f2557c = null;

    /* renamed from: d  reason: collision with root package name */
    public static String f2558d = null;

    /* renamed from: e  reason: collision with root package name */
    public static int f2559e = 0;

    /* renamed from: f  reason: collision with root package name */
    public static String f2560f = null;

    /* renamed from: g  reason: collision with root package name */
    public static boolean f2561g = false;

    /* renamed from: h  reason: collision with root package name */
    public static boolean f2562h = false;

    /* renamed from: i  reason: collision with root package name */
    public static boolean f2563i = false;

    /* renamed from: j  reason: collision with root package name */
    public static String f2564j = null;

    /* renamed from: k  reason: collision with root package name */
    public static boolean f2565k = false;

    /* renamed from: l  reason: collision with root package name */
    public static boolean f2566l = false;
    ...
    public static int findCoreForThirdPartyApp(Context context) {
        n(context);
        TbsLog.i("TbsShareManager", "core_info mAvailableCoreVersion is " + f2559e + " mAvailableCorePath is " + f2558d + " mSrcPackageName is " + f2560f);
        if (f2560f == null) {
            TbsLog.e("TbsShareManager", "mSrcPackageName is null !!!");
        }
        String str = f2560f;
        if (str != null && str.equals("AppDefined")) {
            if (f2559e != l.a().a(f2557c)) {
                f2559e = 0;
                f2558d = null;
                f2560f = null;
        ...
        if (f2559e > 0) {
            ...
            if ((!("com.tencent.android.qqdownloader".equals(applicationInfo.packageName) || "com.jd.jrapp".equals(applicationInfo.packageName)) ? QbSdk.a(context, f2559e) : false) || f2561g) {
                f2559e = 0;
                f2558d = null;
                f2560f = null;
    ...
    public static void forceToLoadX5ForThirdApp(Context context, boolean z) {
        ...
        try {
            if (QbSdk.isNeedInitX5FirstTime() && isThirdPartyApp(context) && !QbSdk.getOnlyDownload() && (r = l.a().r(context)) != null) {
                ...
                if (f2557c != null && (a2 = l.a().a(f2557c)) > 0) {
                    f2558d = f2557c;
                    f2560f = "AppDefined";
                    f2559e = a2;
                    TbsLog.i("TbsShareManager", "forceToLoadX5ForThirdApp #1 -- mAvailableCoreVersion: " + f2559e + " " + Log.getStackTraceString(new Throwable("#")));
                    writeProperties(context, Integer.toString(f2559e), f2560f, f2558d, Integer.toString(1));
                    return;
                }
                ...
                for (String str : coreProviderAppList) {
                    ...
                    if (coreShareDecoupleCoreVersion >= h2 && coreShareDecoupleCoreVersion >= i2 && coreShareDecoupleCoreVersion > 0) {
                        f2558d = l.a().c(context, getPackageContext(context, str, true)).getAbsolutePath();
                        f2560f = str;
                        f2559e = coreShareDecoupleCoreVersion;
                        TbsLog.i("TbsShareManager", "forceToLoadX5ForThirdApp #2 -- mAvailableCoreVersion: " + f2559e + " " + Log.getStackTraceString(new Throwable("#")));
                        if (QbSdk.canLoadX5FirstTimeThirdApp(context)) {
                            ...
                            writeProperties(context, Integer.toString(f2559e), f2560f, f2558d, Integer.toString(b2));
                            return;
                        }
                        f2559e = 0;
                        f2558d = null;
                ...
                for (String str2 : coreProviderAppList) {
                    ...
                    if (sharedTbsCoreVersion >= h2 && sharedTbsCoreVersion >= i2 && sharedTbsCoreVersion > 0) {
                        f2558d = l.a().b(context, getPackageContext(context, str2, true)).getAbsolutePath();
                        f2560f = str2;
                        f2559e = sharedTbsCoreVersion;
                        TbsLog.i("TbsShareManager", "forceToLoadX5ForThirdApp #3 -- mAvailableCoreVersion: " + f2559e + " " + Log.getStackTraceString(new Throwable("#")));
                        if (QbSdk.canLoadX5FirstTimeThirdApp(context)) {
                            writeProperties(context, Integer.toString(f2559e), f2560f, f2558d, Integer.toString(com.tencent.smtt.utils.b.b(context)));
                            return;
                        }
                        f2559e = 0;
                        f2558d = null;
    ...
    public static String g(Context context) {
        try {
            n(context);
            if (f2558d != null && !TextUtils.isEmpty(f2558d)) {
                return f2558d + File.separator + "res.apk";
            }
            return null;
        } catch (Throwable th) {
    ...
    public static boolean i(Context context) {
        try {
            ...
            if (f2557c == null) {
                if (f2559e != 0 && getSharedTbsCoreVersion(context, f2560f) == f2559e) {
                    return true;
                }
            } else if (f2559e != 0 && l.a().a(f2557c) == f2559e) {
                return true;
            }
            if (l(context)) {
                return true;
            ...
            tbsCoreLoadStat.a(context, TbsListener.ErrorCode.INFO_CORE_EXIST_NOT_LOAD, new Throwable("mAvailableCoreVersion=" + f2559e + "; mSrcPackageName=" + f2560f + "; getSharedTbsCoreVersion(ctx, mSrcPackageName) is " + getSharedTbsCoreVersion(context, f2560f) + "; getHostCoreVersions is " + getHostCoreVersions(context)));
            f2558d = null;
            f2559e = 0;
    ...
    public static boolean k(Context context) {
        ...
        return f2559e == getSharedTbsCoreVersion(context, str) || f2559e == getCoreShareDecoupleCoreVersion(context, f2560f);
    }
    ...
    public static boolean l(Context context) {
        ...
        for (String str : coreProviderAppList) {
            ...
            if (i2 > 0 && i2 == getSharedTbsCoreVersion(context, str)) {
                Context packageContext = getPackageContext(context, str, true);
                if (l.a().f(context)) {
                    f2558d = l.a().b(context, packageContext).getAbsolutePath();
                    f2560f = str;
                    return true;
                }
            }
        ...
        for (String str2 : coreProviderAppList) {
            ...
            if (i3 > 0 && i3 == getCoreShareDecoupleCoreVersion(context, str2)) {
                ...
                if (l.a().f(context)) {
                    f2558d = l.a().c(context, packageContext2).getAbsolutePath();
                    f2560f = str2;
                    return true;
                }
            }
    ...
    public static void n(Context context) {
        ...
        synchronized (TbsShareManager.class) {
            ...
            try {
                ...
                String property = properties.getProperty("core_version", "");
                if (!"".equals(property)) {
                    f2559e = Math.max(Integer.parseInt(property), 0);
                    TbsLog.i("TbsShareManager", "loadProperties -- mAvailableCoreVersion: " + f2559e + " " + Log.getStackTraceString(new Throwable("#")));
                }
                String property2 = properties.getProperty("core_packagename", "");
                if (!"".equals(property2)) {
                    f2560f = property2;
                }
                if (f2560f != null && a != null) {
                    if (f2560f.equals(a.getPackageName())) {
                        f2565k = true;
                    } else {
                        f2565k = false;
                    }
                ...
                f2561g = Boolean.parseBoolean(properties.getProperty("core_disabled", "false"));
                f2566l = true;
                try {
                    bufferedInputStream.close();
                } catch (Exception e2) {
    ...
    public static synchronized void writeCoreInfoForThirdPartyApp(Context context, int i2, boolean z) {
        synchronized (TbsShareManager.class) {
            ...
            if (h2 < 0) {
                ...
                if (f2557c != null) {
                    if (i2 == l.a().a(f2557c)) {
                        writeProperties(context, Integer.toString(i2), "AppDefined", f2557c, Integer.toString(1));
                        File tbsShareFile = getTbsShareFile(context, "core_info");
                        if (!f2563i && tbsShareFile != null) {
                        ...
                        for (String str : d2) {
                            if (i2 == getSharedTbsCoreVersion(context, str)) {
                                ...
                                if (l.a().f(packageContext)) {
                                    com.tencent.smtt.utils.f.a(new File(absolutePath), new File(f2557c), new FileFilter() { // from class: com.tencent.smtt.sdk.TbsShareManager.1
