...
public class TbsLogReport {
    ...
    public static class TbsLogInfo implements Cloneable {
        ...
        public void resetArgs() {
            ...
            this.f2537g = 0;
            this.f2538h = 2;
            this.f2539i = EnvironmentCompat.MEDIA_UNKNOWN;
            this.f2540j = 0;
            this.f2541k = 2;
            this.f2542l = 0L;
            this.f2543m = 0L;
    ...
    public TbsLogReport(Context context) {
        this.b = null;
        this.f2531c = context.getApplicationContext();
    ...
    private SharedPreferences d() {
        return this.f2531c.getSharedPreferences("tbs_download_stat", 4);
    }
    ...
    */
    ...
    public void b() {
        ...
        if (a2 != null && a2.length() != 0) {
            ...
            try {
                String a3 = com.tencent.smtt.utils.g.a(com.tencent.smtt.utils.n.a(this.f2531c).c(), a2.toString().getBytes("utf-8"), new g.a() { // from class: com.tencent.smtt.sdk.TbsLogReport.3
    ...
    private void a(int i2, TbsLogInfo tbsLogInfo, EventType eventType) {
        tbsLogInfo.setErrorCode(i2);
        tbsLogInfo.setEventTime(System.currentTimeMillis());
        QbSdk.f2496m.onInstallFinish(i2);
    ...
    public void a(int i2, TbsLogInfo tbsLogInfo) {
        ...
        sb.append(a(i2));
        sb.append(a(com.tencent.smtt.utils.b.c(this.f2531c)));
        sb.append(a(com.tencent.smtt.utils.l.a(this.f2531c)));
        sb.append(a(l.a().i(this.f2531c)));
        ...
        sb.append(a(str));
        String packageName = this.f2531c.getPackageName();
        sb.append(a(packageName));
        if (TbsConfig.APP_WX.equals(packageName)) {
            sb.append(a(com.tencent.smtt.utils.b.a(this.f2531c, TbsDownloader.TBS_METADATA)));
        } else {
            sb.append(a(com.tencent.smtt.utils.b.b(this.f2531c)));
        }
        sb.append(a(a(tbsLogInfo.b)));
        sb.append(a(tbsLogInfo.f2533c));
        sb.append(a(tbsLogInfo.f2534d));
        sb.append(a(tbsLogInfo.f2535e));
        sb.append(a(tbsLogInfo.f2536f));
        sb.append(a(tbsLogInfo.f2537g));
        sb.append(a(tbsLogInfo.f2538h));
        sb.append(a(tbsLogInfo.f2539i));
        sb.append(a(tbsLogInfo.f2540j));
        sb.append(a(tbsLogInfo.f2541k));
        sb.append(b(tbsLogInfo.q));
        sb.append(b(tbsLogInfo.f2542l));
        sb.append(b(tbsLogInfo.f2543m));
        sb.append(a(tbsLogInfo.n));
        sb.append(a(tbsLogInfo.a));
        sb.append(a(tbsLogInfo.o));
        sb.append(a(tbsLogInfo.p));
        sb.append(a(TbsDownloadConfig.getInstance(this.f2531c).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0)));
        sb.append(a(com.tencent.smtt.utils.b.f(this.f2531c)));
        ...
        edit.commit();
        if (this.f2532d || i2 != EventType.TYPE_LOAD.a) {
            b();
        }
    }
