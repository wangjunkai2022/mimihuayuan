...
public class r {
    ...
    public DexLoader f2679e;

    /* renamed from: f  reason: collision with root package name */
    public String f2680f;

    /* renamed from: g  reason: collision with root package name */
    public String f2681g = null;
    ...
    public r(Context context, Context context2, String str, String str2, String[] strArr, String str3) throws Exception {
        ...
        if (context != null && ((context2 != null || TbsShareManager.getHostCorePathAppDefined() != null) && !TextUtils.isEmpty(str) && strArr != null && strArr.length != 0)) {
            ...
            this.f2678d = strArr;
            this.f2680f = str2;
            for (int i2 = 0; i2 < this.f2678d.length; i2++) {
                StringBuilder p = f.b.a.a.a.p("#2 mDexFileList[", i2, "]: ");
                p.append(this.f2678d[i2]);
            ...
            this.f2679e = new DexLoader(str3, this.a, this.f2678d, str2, QbSdk.n);
            System.currentTimeMillis();
            a(context);
            libwebp.loadWepLibraryIfNeed(context2, this.f2677c);
            if ("com.nd.android.pandahome2".equals(this.a.getApplicationInfo().packageName)) {
                this.f2679e.invokeStaticMethod("com.tencent.tbs.common.beacon.X5CoreBeaconUploader", "getInstance", new Class[]{Context.class}, this.a);
            }
            if (QbSdk.n != null) {
                try {
                ...
                this.f2679e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTbsSettings", new Class[]{Map.class}, QbSdk.n);
            }
            int b = b(context);
            if (b >= 0) {
    ...
    private int b(Context context) {
        ...
        if (this.b == null && TbsShareManager.getHostCorePathAppDefined() != null) {
            DexLoader dexLoader = this.f2679e;
            invokeStaticMethod = dexLoader.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class, String.class, Integer.TYPE, String.class, String.class}, context, this.b, dexLoader, this.f2677c, this.f2680f, TbsConfig.TBS_SDK_VERSIONNAME, 43697, QbSdk.a(), TbsShareManager.getHostCorePathAppDefined());
        } else {
            TbsLog.i("TbsWizard", "initTesRuntimeEnvironment callerContext is " + context + " mHostContext is " + this.b + " mDexLoader is " + this.f2679e + " mtbsInstallLocation is " + this.f2677c + " mDexOptPath is " + this.f2680f);
            DexLoader dexLoader2 = this.f2679e;
            invokeStaticMethod = dexLoader2.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class, String.class, Integer.TYPE, String.class}, context, this.b, dexLoader2, this.f2677c, this.f2680f, TbsConfig.TBS_SDK_VERSIONNAME, 43697, QbSdk.a());
        }
        if (invokeStaticMethod == null) {
            c();
            d();
            DexLoader dexLoader3 = this.f2679e;
            invokeStaticMethod = dexLoader3.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class}, context, this.b, dexLoader3, this.f2677c, this.f2680f);
        }
        if (invokeStaticMethod == null) {
            i2 = -3;
        ...
        if (i2 < 0) {
            Object invokeStaticMethod2 = this.f2679e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "getLoadFailureDetails", new Class[0], new Object[0]);
            if (invokeStaticMethod2 instanceof Throwable) {
                ...
                o.append("; th: ");
                o.append(th);
                this.f2681g = o.toString();
            }
            if (invokeStaticMethod2 instanceof String) {
                this.f2681g = (String) invokeStaticMethod2;
            }
        } else {
            this.f2681g = null;
        }
    ...
    private void c() {
        this.f2679e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "setTesSdkVersionName", new Class[]{String.class}, TbsConfig.TBS_SDK_VERSIONNAME);
    }

    private void d() {
        this.f2679e.setStaticField("com.tencent.tbs.tbsshell.TBSShell", "VERSION", 43697);
    }
    ...
    */
    ...
    public void a(Context context, Context context2, String str, String str2, String[] strArr, String str3) throws Exception {
        ...
        if (map != null) {
            this.f2679e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTbsSettings", new Class[]{Map.class}, map);
        }
        int b = b(context);
        if (b >= 0) {
            return;
        ...
        p.append(this.f2681g);
        throw new Exception(p.toString());
    }

    public String a() {
        String str = null;
        Object invokeStaticMethod = this.f2679e.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "invokeStaticMethod", new Class[]{Boolean.TYPE, String.class, String.class, Class[].class, Object[].class}, Boolean.TRUE, "com.tencent.smtt.util.CrashTracker", "getCrashExtraInfo", null, new Object[0]);
        if (invokeStaticMethod == null) {
            invokeStaticMethod = this.f2679e.invokeStaticMethod("com.tencent.smtt.util.CrashTracker", "getCrashExtraInfo", null, new Object[0]);
        }
        if (invokeStaticMethod != null) {
    ...
    public boolean a(Context context, String str, String str2, Bundle bundle) {
        Object invokeStaticMethod = this.f2679e.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "installLocalQbApk", new Class[]{Context.class, String.class, String.class, Bundle.class}, context, str, str2, bundle);
        if (invokeStaticMethod == null) {
            return false;
        }
