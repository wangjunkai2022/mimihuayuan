...
public class l {
    ...
    public static l f2660d;

    /* renamed from: f  reason: collision with root package name */
    public FileLock f2666f;

    /* renamed from: g  reason: collision with root package name */
    public FileOutputStream f2667g;

    /* renamed from: i  reason: collision with root package name */
    public static final ReentrantLock f2661i = new ReentrantLock();

    /* renamed from: j  reason: collision with root package name */
    public static final Lock f2662j = new ReentrantLock();

    /* renamed from: l  reason: collision with root package name */
    public static FileLock f2663l = null;
    ...
    public static Handler f2664m = null;
    ...
    public static final FileFilter f2659c = new FileFilter() { // from class: com.tencent.smtt.sdk.l.2
    ...
    public l() {
        if (f2664m == null) {
            f2664m = new Handler(k.a().getLooper()) { // from class: com.tencent.smtt.sdk.l.3
    ...
    private synchronized boolean c(Context context, boolean z) {
        ...
        boolean z2 = false;
        if (t(context)) {
            boolean tryLock = f2661i.tryLock();
    ...
    private boolean w(Context context) {
        ...
        if (!z) {
            f2663l = t.a().b(context);
        } else {
            f2663l = com.tencent.smtt.utils.f.f(context);
        }
        if (f2663l == null) {
        ...
        if (tryLock) {
            ...
            try {
                try {
                    ...
                    if (!file.exists()) {
                        try {
                            if (f2661i.isHeldByCurrentThread()) {
                                f2661i.unlock();
                            }
                        } catch (Throwable th) {
    ...
    */
    ...
    public synchronized void b() {
        if (this.f2665e <= 0) {
            TbsLog.i("TbsInstaller", "releaseTbsInstallingFileLock currentTbsFileLockStackCount=" + this.f2665e + "call stack:" + Log.getStackTraceString(new Throwable()));
        } else if (this.f2665e > 1) {
            ...
            if (this.f2665e == 1) {
                ...
                com.tencent.smtt.utils.f.a(this.f2666f, this.f2667g);
                this.f2665e = 0;
            }
        }
    }
