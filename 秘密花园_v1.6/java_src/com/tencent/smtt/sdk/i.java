...
public class i {
    ...
    public static int f2648d = 5;

    /* renamed from: e  reason: collision with root package name */
    public static int f2649e = 1;

    /* renamed from: f  reason: collision with root package name */
    public static final String[] f2650f = {"tbs_downloading_com.tencent.mtt", "tbs_downloading_com.tencent.mm", "tbs_downloading_com.tencent.mobileqq", "tbs_downloading_com.tencent.tbs", "tbs_downloading_com.qzone"};
    public Set<String> A;
    public boolean C;
    public String a;
    ...
    private boolean b(int i2) {
        try {
            File file = new File(this.f2656k, "x5.tbs");
            File a = a(this.f2652g);
            if (a != null) {
                File file2 = new File(a, TbsDownloader.getOverSea(this.f2652g) ? "x5.oversea.tbs.org" : "x5.tbs.org");
                file.delete();
                com.tencent.smtt.utils.f.b(file2, file);
                if (com.tencent.smtt.utils.a.a(this.f2652g, file, 0L, i2)) {
                    return true;
                }
    ...
    private void c(boolean z) {
        com.tencent.smtt.utils.q.a(this.f2652g);
        TbsDownloadConfig tbsDownloadConfig = TbsDownloadConfig.getInstance(this.f2652g);
        ...
        QbSdk.f2496m.onDownloadFinish(z ? 100 : 120);
        int i2 = tbsDownloadConfig.mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_RESPONSECODE, 0);
        boolean a = TbsDownloader.a(this.f2652g);
        if (i2 == 5) {
            Bundle a2 = a(i2, a);
            if (a2 == null) {
                return;
            }
            l.a().b(this.f2652g, a2);
        } else if (i2 != 3 && i2 <= 10000) {
            l.a().a(this.f2652g, new File(this.f2656k, "x5.tbs").getAbsolutePath(), tbsDownloadConfig.mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0));
            a(new File(this.f2656k, "x5.tbs"), this.f2652g);
        } else {
            File a3 = a(this.f2652g);
            if (a3 != null) {
                l.a().b(this.f2652g, a(i2, a3, a));
                return;
            }
            c();
    ...
    private boolean d(boolean z) {
        ...
        if (z) {
            file = new File(this.f2656k, "x5.tbs");
        } else {
            file = new File(this.f2656k, "x5.tbs.temp");
        }
        if (file.exists()) {
            return file.delete();
        }
    ...
    private void f() {
        ...
        if (!this.r && this.y) {
            ...
            String apnInfo = Apn.getApnInfo(this.f2652g);
            if (apnInfo == null) {
                apnInfo = "";
            }
            int apnType = Apn.getApnType(this.f2652g);
            ...
            if ((i3 == 0 || i3 == 107) && this.v.getDownFinalFlag() == 0) {
                if (!Apn.isNetworkAvailable(this.f2652g)) {
                    a(101, (String) null, true);
                } else if (!k()) {
                    a(101, (String) null, true);
                }
            }
            if (TbsDownloader.a(this.f2652g)) {
                TbsLogReport.getInstance(this.f2652g).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD_DECOUPLE, this.v);
            } else {
                TbsLogReport.getInstance(this.f2652g).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD, this.v);
            }
            this.v.resetArgs();
            if (i2 != 100) {
                QbSdk.f2496m.onDownloadFinish(i2);
                return;
            }
            return;
        }
    ...
    private boolean g() {
        File file = new File(com.tencent.smtt.utils.f.a(this.f2652g, 4), TbsDownloader.getOverSea(this.f2652g) ? "x5.oversea.tbs.org" : "x5.tbs.org");
        int i2 = TbsDownloadConfig.getInstance(this.f2652g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_USE_BACKUP_VERSION, 0);
        if (i2 == 0) {
            i2 = TbsDownloadConfig.getInstance(this.f2652g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0);
        }
        return com.tencent.smtt.utils.a.a(this.f2652g, file, 0L, i2);
    }
    ...
    private void h() {
        try {
            ...
            if (file.exists()) {
                ...
                Pattern compile = Pattern.compile(com.tencent.smtt.utils.a.a(TbsDownloader.a(this.f2652g)) + "(.*)");
    ...
    private boolean i() {
        return new File(this.f2656k, "x5.tbs.temp").exists();
    }

    private long j() {
        File file = new File(this.f2656k, "x5.tbs.temp");
        if (file.exists()) {
            return file.length();
        }
        return 0L;
    ...
    private void a(String str) throws Exception {
        ...
        httpURLConnection2.setRequestProperty("User-Agent", TbsDownloader.b(this.f2652g));
        ...
        this.t.setReadTimeout(this.f2658m);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:248:0x0559, code lost:
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).a.put(r9, java.lang.Long.valueOf(r22));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:273:0x060d, code lost:
        a(113, "tbsApkFileSize=" + r5 + "  but contentLength=" + r36.f2657l, true);
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).setDownloadInterruptCode(-310);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:277:0x065b, code lost:
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).commit();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:308:0x06de, code lost:
        ...
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).setDownloadInterruptCode(-309);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:332:0x0749, code lost:
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).setDownloadInterruptCode(-311);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:353:0x07b4, code lost:
        ...
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).setDownloadInterruptCode(-307);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:463:0x0a42, code lost:
        r2 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).a;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:484:0x0a9a, code lost:
        a(105, "freespace=" + com.tencent.smtt.utils.q.a() + ",and minFreeSpace=" + com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).getDownloadMinFreeSpace(), true);
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).setDownloadInterruptCode(-308);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x022a, code lost:
        com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r36.f2652g).a.put(r11, java.lang.Long.valueOf(r12));
     */
    ...
    */
    ...
    public boolean a() {
        ...
        try {
            File file = new File(com.tencent.smtt.utils.f.a(this.f2652g, 4), "x5.tbs.decouple");
            if (file.exists()) {
                TbsLog.i("TbsApkDownloader", "verifyAndInstallDecoupleCoreFromBackup #2");
            } else {
                File b = TbsDownloader.b(TbsDownloadConfig.getInstance(this.f2652g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_DECOUPLECOREVERSION, -1));
                if (b != null && b.exists()) {
                    com.tencent.smtt.utils.f.b(b, file);
                }
            }
            if (com.tencent.smtt.utils.a.a(this.f2652g, file, 0L, TbsDownloadConfig.getInstance(this.f2652g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_DECOUPLECOREVERSION, -1))) {
                TbsLog.i("TbsApkDownloader", "verifyAndInstallDecoupleCoreFromBackup #3");
                return l.a().e(this.f2652g);
            }
            return false;
        } catch (Exception unused) {
            return false;
    ...
    public boolean a(boolean z) {
        String[] strArr;
        int i2;
        if ((!z || m() || (QbSdk.getDownloadWithoutWifi() && Apn.isNetworkAvailable(this.f2652g))) && (strArr = this.b) != null && (i2 = this.f2651c) >= 0 && i2 < strArr.length) {
            this.f2651c = i2 + 1;
            this.f2655j = strArr[i2];
            this.p = 0;
            this.q = 0;
            this.f2657l = -1L;
            this.o = false;
    ...
    public Bundle a(int i2, boolean z) {
        ...
        if (z) {
            q = l.a().p(this.f2652g);
            i3 = l.a().h(this.f2652g);
        } else {
            q = l.a().q(this.f2652g);
            i3 = l.a().i(this.f2652g);
        }
        File file = new File(this.f2656k, "x5.tbs");
        ...
        int i4 = TbsDownloadConfig.getInstance(this.f2652g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0);
        if (z) {
            f2 = l.a().f(this.f2652g, 6);
        } else {
            f2 = l.a().f(this.f2652g, 5);
        }
        ...
        String a = com.tencent.smtt.utils.f.a(this.f2652g, 7);
    ...
    public Bundle a(int i2, File file, boolean z) {
        ...
        if (z) {
            ...
            file2 = new File(file, TbsDownloader.getOverSea(this.f2652g) ? "x5.oversea.tbs.org" : "x5.tbs.org");
        }
        int a = com.tencent.smtt.utils.a.a(this.f2652g, file2);
        File file3 = new File(this.f2656k, "x5.tbs");
        String absolutePath = file3.exists() ? file3.getAbsolutePath() : null;
        int i3 = TbsDownloadConfig.getInstance(this.f2652g).mPreferences.getInt(TbsDownloadConfig.TbsConfigKey.KEY_TBS_DOWNLOAD_V, 0);
        Bundle bundle = new Bundle();
        bundle.putInt("operation", i2);
    ...
    public void a(int i2) {
        if (l.a().t(this.f2652g)) {
            l.a().b();
            try {
                File file = new File(this.f2656k, "x5.tbs");
                int a = com.tencent.smtt.utils.a.a(this.f2652g, file);
                if (-1 == a || (i2 > 0 && i2 == a)) {
    ...
    public int b(boolean z) {
        ...
        if (z) {
            ...
            return com.tencent.smtt.utils.a.a(this.f2652g, new File(a, "x5.tbs.decouple"));
        } else if (a == null) {
            return 0;
        } else {
            return com.tencent.smtt.utils.a.a(this.f2652g, new File(a, TbsDownloader.getOverSea(this.f2652g) ? "x5.oversea.tbs.org" : "x5.tbs.org"));
        }
    }

    public void b() {
        this.r = true;
        if (TbsShareManager.isThirdPartyApp(this.f2652g)) {
            TbsLogReport.TbsLogInfo tbsLogInfo = TbsLogReport.getInstance(this.f2652g).tbsLogInfo();
            tbsLogInfo.setErrorCode(-309);
            tbsLogInfo.setFailDetail(new Exception());
            if (TbsDownloader.a(this.f2652g)) {
                TbsLogReport.getInstance(this.f2652g).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD_DECOUPLE, tbsLogInfo);
            } else {
                TbsLogReport.getInstance(this.f2652g).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD, tbsLogInfo);
            }
        }
    }
}
