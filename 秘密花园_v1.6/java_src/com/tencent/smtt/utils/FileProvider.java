...
public class FileProvider extends ContentProvider {
    ...
    public static HashMap<String, a> f2685c = new HashMap<>();
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (!providerInfo.exported) {
            if (providerInfo.grantUriPermissions) {
                this.f2686d = b(context, providerInfo.authority);
                return;
            }
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f2686d.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File a2 = this.f2686d.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.f2686d.a(uri), a(str));
    }
