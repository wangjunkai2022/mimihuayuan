...
public class TbsLog {
    ...
    public static TbsLogClient f2687c;
    ...
    public static void d(String str, String str2) {
        TbsLogClient tbsLogClient = f2687c;
    ...
    public static void setLogView(TextView textView) {
        ...
        if (textView == null || (tbsLogClient = f2687c) == null) {
            return;
        }
