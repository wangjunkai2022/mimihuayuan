...
public class b implements UMImprintChangeCallback {
    ...
    public static Handler f2976c = null;

    /* renamed from: d  reason: collision with root package name */
    public static final int f2977d = 200;

    /* renamed from: e  reason: collision with root package name */
    public static final int f2978e = 273;

    /* renamed from: f  reason: collision with root package name */
    public static final int f2979f = 274;

    /* renamed from: g  reason: collision with root package name */
    public static final int f2980g = 512;

    /* renamed from: h  reason: collision with root package name */
    public static final int f2981h = 769;

    /* renamed from: i  reason: collision with root package name */
    public static a f2982i = null;

    /* renamed from: j  reason: collision with root package name */
    public static ConnectivityManager f2983j = null;

    /* renamed from: k  reason: collision with root package name */
    public static NetworkInfo f2984k = null;

    /* renamed from: l  reason: collision with root package name */
    public static IntentFilter f2985l = null;

    /* renamed from: m  reason: collision with root package name */
    public static boolean f2986m = false;
    ...
    public static BroadcastReceiver v = new BroadcastReceiver() { // from class: com.umeng.commonsdk.framework.b.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                ...
                ConnectivityManager unused = b.f2983j = (ConnectivityManager) appContext.getSystemService("connectivity");
                try {
                    if (b.f2983j != null) {
                        NetworkInfo unused2 = b.f2984k = b.f2983j.getActiveNetworkInfo();
                        if (b.f2984k != null && b.f2984k.isAvailable()) {
                            ULog.i("--->>> network isAvailable, check if there are any files to send.");
                            boolean unused3 = b.f2986m = true;
                            synchronized (b.o) {
                            ...
                            b.c(273);
                            if (b.f2984k.getType() != 1 || context == null) {
                                return;
                            }
                            try {
                                if (UMWorkDispatch.eventHasExist(com.umeng.commonsdk.internal.a.f3003j)) {
                                    return;
                                }
                                UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f3003j, com.umeng.commonsdk.internal.b.a(context).a(), null);
                                return;
                        ...
                        boolean unused5 = b.f2986m = false;
                    }
                } catch (Throwable th) {
    ...
    public b(Context context, Handler handler) {
        ...
        try {
            if (a == null) {
                ...
                Context appContext = UMModuleRegister.getAppContext();
                if (DeviceConfig.checkPermission(appContext, "android.permission.ACCESS_NETWORK_STATE") && f2985l == null) {
                    IntentFilter intentFilter = new IntentFilter();
                    f2985l = intentFilter;
                    intentFilter.addAction("android.net.conn.CONNECTIVITY_CHANGE");
                    if (v != null) {
                        appContext.registerReceiver(v, f2985l);
                    }
                }
                m();
                if (b == null) {
    ...
    public static void e() {
        a((int) f2979f, (int) PathInterpolatorCompat.MAX_NUM_POINTS);
    }
    ...
    public static void b(int i2) {
        Handler handler;
        if (!f2986m || (handler = b) == null || handler.hasMessages(i2)) {
            return;
        }
