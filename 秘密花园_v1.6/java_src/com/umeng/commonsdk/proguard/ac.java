...
public class ac extends ai {
    ...
    public static final an f3078d = new an("");

    /* renamed from: e  reason: collision with root package name */
    public static final ad f3079e = new ad("", (byte) 0, 0);

    /* renamed from: f  reason: collision with root package name */
    public static final byte[] f3080f;

    /* renamed from: h  reason: collision with root package name */
    public static final byte f3081h = -126;

    /* renamed from: i  reason: collision with root package name */
    public static final byte f3082i = 1;

    /* renamed from: j  reason: collision with root package name */
    public static final byte f3083j = 31;

    /* renamed from: k  reason: collision with root package name */
    public static final byte f3084k = -32;

    /* renamed from: l  reason: collision with root package name */
    public static final int f3085l = 5;
    public byte[] a;
    public byte[] b;
    ...
    public static class b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final byte f3088c = 3;

        /* renamed from: d  reason: collision with root package name */
        public static final byte f3089d = 4;

        /* renamed from: e  reason: collision with root package name */
        public static final byte f3090e = 5;

        /* renamed from: f  reason: collision with root package name */
        public static final byte f3091f = 6;

        /* renamed from: g  reason: collision with root package name */
        public static final byte f3092g = 7;

        /* renamed from: h  reason: collision with root package name */
        public static final byte f3093h = 8;

        /* renamed from: i  reason: collision with root package name */
        public static final byte f3094i = 9;

        /* renamed from: j  reason: collision with root package name */
        public static final byte f3095j = 10;

        /* renamed from: k  reason: collision with root package name */
        public static final byte f3096k = 11;

        /* renamed from: l  reason: collision with root package name */
        public static final byte f3097l = 12;
    }
    ...
    private int E() throws p {
        int i2 = 0;
        if (this.f3103g.h() >= 5) {
            byte[] f2 = this.f3103g.f();
            int g2 = this.f3103g.g();
            int i3 = 0;
            int i4 = 0;
            while (true) {
                byte b2 = f2[g2 + i2];
    ...
    public af n() throws p {
        int E = E();
        byte u = E == 0 ? (byte) 0 : u();
        return new af(d((byte) (u >> 4)), d((byte) (u & ap.f3120m)), E);
    }
    ...
    public String z() throws p {
        ...
        try {
            if (this.f3103g.h() >= E) {
                String str = new String(this.f3103g.f(), this.f3103g.g(), E, "UTF-8");
                this.f3103g.a(E);
                return str;
            }
