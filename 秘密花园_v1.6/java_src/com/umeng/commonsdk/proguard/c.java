...
public class c {
    ...
    public static final String f3130c = "ts";

    /* renamed from: d  reason: collision with root package name */
    public static final long f3131d = 30000;

    /* renamed from: e  reason: collision with root package name */
    public static final int f3132e = 200;

    /* renamed from: f  reason: collision with root package name */
    public static final String f3133f = "UMSysLocationCache";
                    ...
                    while (c.f3134g) {
                        try {
                            ...
                            if (b2 != null && b2.length() >= 200) {
                                boolean unused = c.f3134g = false;
                                return;
                            }
                            ULog.i(c.f3133f, "location status is ok, time is " + System.currentTimeMillis());
                                ...
                                public void a(Location location) {
                                    ...
                                    if (location != null) {
                                        try {
                                            ...
                                            ULog.i(c.f3133f, "lon is " + longitude + ", lat is " + latitude + ", acc is " + accuracy + ", alt is " + altitude);
                                            if (longitude != 0.0d && latitude != 0.0d) {
                                                ...
                                                try {
                                                    ...
                                                    ULog.i(c.f3133f, "e is " + e2);
                                                }
                                                ULog.i(c.f3133f, "locationJSONObject is " + jSONObject.toString());
                                                SharedPreferences sharedPreferences = context.getSharedPreferences(com.umeng.commonsdk.internal.a.p, 0);
                                                if (sharedPreferences != null) {
                                                    ...
                                                    ULog.i(c.f3133f, "--->>> get lon is " + string + ", lat is " + string2);
                                                    try {
