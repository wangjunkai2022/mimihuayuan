...
public abstract class t<T extends t<?, ?>, F extends q> implements j<T, F> {
    ...
    public static final Map<Class<? extends aq>, ar> f3181c;
    public Object a;
    public F b;
    ...
    public void read(ai aiVar) throws p {
        f3181c.get(aiVar.D()).b().b(aiVar, this);
    }
    ...
    public void write(ai aiVar) throws p {
        f3181c.get(aiVar.D()).b().a(aiVar, this);
    }
