...
public class f {
    public static int a;
    public static final byte[] b = {10, 1, 11, 5, 4, ap.f3120m, 7, 9, 23, 3, 1, 6, 8, 12, ap.f3118k, 91};

    /* renamed from: c  reason: collision with root package name */
    public static Object f3242c = new Object();
                ...
                try {
                    synchronized (f3242c) {
                        try {
                            ...
                            File file = new File(context.getFilesDir() + "/" + a.f3197e);
                            if (!file.isDirectory()) {
                                file.mkdir();
                            }
        ...
        try {
            synchronized (f3242c) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + "/" + a.f3197e;
