...
public class e {
    ...
    private void a() {
        String imprintProperty = UMEnvelopeBuild.imprintProperty(this.f3241c, "sl_domain_p", "");
        if (TextUtils.isEmpty(imprintProperty)) {
            return;
        }
        a.f3199g = DataHelper.assembleStatelessURL(imprintProperty);
    }

    private void b() {
        String imprintProperty = UMEnvelopeBuild.imprintProperty(this.f3241c, "sl_domain_p", "");
        String imprintProperty2 = UMEnvelopeBuild.imprintProperty(this.f3241c, "oversea_sl_domain_p", "");
        if (!TextUtils.isEmpty(imprintProperty)) {
            a.f3198f = DataHelper.assembleStatelessURL(imprintProperty);
        }
        if (!TextUtils.isEmpty(imprintProperty2)) {
            a.f3200h = DataHelper.assembleStatelessURL(imprintProperty2);
        }
        a.f3199g = a.f3200h;
    ...
    private boolean c() {
        ...
        if (context == null || context.getPackageManager().checkPermission("android.permission.ACCESS_NETWORK_STATE", this.f3241c.getPackageName()) != 0) {
            return false;
        }
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) this.f3241c.getSystemService("connectivity");
            if (DeviceConfig.checkPermission(this.f3241c, "android.permission.ACCESS_NETWORK_STATE") && connectivityManager != null && (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) != null && activeNetworkInfo.getType() != 1 && (extraInfo = activeNetworkInfo.getExtraInfo()) != null) {
            ...
            UMCrashManager.reportCrash(this.f3241c, th);
        }
        return false;
    }
        ...
        if (bArr != null && str != null) {
            ...
            try {
                try {
                    try {
                        if (c()) {
                            httpsURLConnection = (HttpsURLConnection) new URL(a.f3199g + "/" + str).openConnection(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(this.a, this.b)));
                        } else {
                            httpsURLConnection = (HttpsURLConnection) new URL(a.f3199g + "/" + str).openConnection();
                        }
                    } catch (Throwable th) {
            ...
            try {
                ...
                if (httpsURLConnection.getResponseCode() == 200) {
                    UMRTLog.i(UMRTLog.RTLOG_TAG, "--->>> send stateless message success : " + a.f3199g + "/" + str);
                    z = true;
                }
                try {
                    outputStream.close();
    ...
    */
    public boolean b(byte[] r9, java.lang.String r10) {
        ...
        L7:
            ...
            java.lang.String r6 = com.umeng.commonsdk.stateless.a.f3199g     // Catch: java.lang.Throwable -> La9
        ...
        L40:
            ...
            java.lang.String r5 = com.umeng.commonsdk.stateless.a.f3199g     // Catch: java.lang.Throwable -> La9
        ...
        La9:
            ...
            r10 = r1
        Lab:
            android.content.Context r2 = r8.f3241c     // Catch: java.lang.Throwable -> Lbb
