...
public class UMSLEnvelopeBuild {
    ...
    public synchronized JSONObject buildSLBaseHeader(Context context) {
        ...
        if (!TextUtils.isEmpty(cacheSystemheader)) {
            ...
            jSONObject.put(com.umeng.commonsdk.proguard.e.f3135c, SdkVersion.SDK_TYPE);
            if (!TextUtils.isEmpty(module)) {
                jSONObject.put(com.umeng.commonsdk.proguard.e.f3136d, module);
            }
        ...
        try {
            if (SdkVersion.SDK_TYPE != 1) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    jSONObject.put(com.umeng.commonsdk.proguard.e.f3137e, str);
                }
            }
        } catch (Exception unused3) {
        }
        try {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(applicationContext, com.umeng.commonsdk.proguard.e.f3138f, null);
            if (!TextUtils.isEmpty(imprintProperty)) {
        ...
        try {
            if (SdkVersion.SDK_TYPE != 1 && com.umeng.commonsdk.proguard.a.b(applicationContext) != null) {
                jSONObject.put(com.umeng.commonsdk.proguard.e.f3139g, com.umeng.commonsdk.proguard.a.b(applicationContext));
            }
    ...
    public synchronized JSONObject buildSLEnvelope(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str) {
        ...
        if (context != null && str != null) {
            ...
            if (f.a(jSONObject.toString().getBytes().length, a.f3195c)) {
            ...
            } else if (constructEnvelope != null && f.a(constructEnvelope.b().length, a.f3196d)) {
