...
public class d implements j<d, e>, Serializable, Cloneable {
    ...
    public static final Map<e, v> f3353d;

    /* renamed from: e  reason: collision with root package name */
    public static final long f3354e = 2846460275012375038L;

    /* renamed from: f  reason: collision with root package name */
    public static final an f3355f = new an("Imprint");

    /* renamed from: g  reason: collision with root package name */
    public static final ad f3356g = new ad("property", ap.f3118k, 1);

    /* renamed from: h  reason: collision with root package name */
    public static final ad f3357h = new ad("version", (byte) 8, 2);

    /* renamed from: i  reason: collision with root package name */
    public static final ad f3358i = new ad("checksum", (byte) 11, 3);

    /* renamed from: j  reason: collision with root package name */
    public static final Map<Class<? extends aq>, ar> f3359j;

    /* renamed from: k  reason: collision with root package name */
    public static final int f3360k = 0;
        ...
        public void b(ai aiVar, d dVar) throws p {
            ...
            while (true) {
                ...
                if (s != 1) {
                    ...
                    af n = aiVar.n();
                    dVar.a = new HashMap(n.f3099c * 2);
                    for (int i2 = 0; i2 < n.f3099c; i2++) {
                        String z = aiVar.z();
    ...
    public static class c extends at<d> {
        ...
        public void b(ai aiVar, d dVar) throws p {
            ...
            dVar.a = new HashMap(afVar.f3099c * 2);
    ...
    static {
        ...
        f3359j.put(at.class, new C0029d());
        EnumMap enumMap = new EnumMap(e.class);
        enumMap.put((EnumMap) e.PROPERTY, (e) new v("property", (byte) 1, new y(ap.f3118k, new w((byte) 11), new aa((byte) 12, com.umeng.commonsdk.statistics.proto.e.class))));
    ...
    public void g() {
        this.f3362l = g.b(this.f3362l, 0);
    }

    public boolean h() {
        return g.a(this.f3362l, 0);
    }
    ...
    public void read(ai aiVar) throws p {
        f3359j.get(aiVar.D()).b().b(aiVar, this);
    }
    ...
    public void write(ai aiVar) throws p {
        f3359j.get(aiVar.D()).b().a(aiVar, this);
    }
    ...
    public enum e implements q {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final Map<String, e> f3364d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final short f3366e;
    ...
    public void b(boolean z) {
        this.f3362l = g.a(this.f3362l, 0, z);
    }
