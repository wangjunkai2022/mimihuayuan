...
public class b implements j<b, e>, Serializable, Cloneable {
    ...
    public static final Map<e, v> f3323d;

    /* renamed from: e  reason: collision with root package name */
    public static final long f3324e = -6496538196005191531L;

    /* renamed from: f  reason: collision with root package name */
    public static final an f3325f = new an("IdSnapshot");

    /* renamed from: g  reason: collision with root package name */
    public static final ad f3326g = new ad("identity", (byte) 11, 1);

    /* renamed from: h  reason: collision with root package name */
    public static final ad f3327h = new ad("ts", (byte) 10, 2);

    /* renamed from: i  reason: collision with root package name */
    public static final ad f3328i = new ad("version", (byte) 8, 3);

    /* renamed from: j  reason: collision with root package name */
    public static final Map<Class<? extends aq>, ar> f3329j;

    /* renamed from: k  reason: collision with root package name */
    public static final int f3330k = 0;

    /* renamed from: l  reason: collision with root package name */
    public static final int f3331l = 1;
    public String a;
    public long b;
    ...
    public void f() {
        this.f3333m = g.b(this.f3333m, 0);
    }

    public boolean g() {
        return g.a(this.f3333m, 0);
    }
    ...
    public void i() {
        this.f3333m = g.b(this.f3333m, 1);
    }

    public boolean j() {
        return g.a(this.f3333m, 1);
    }
    ...
    public void read(ai aiVar) throws p {
        f3329j.get(aiVar.D()).b().b(aiVar, this);
    }
    ...
    public String toString() {
        ...
        q.append(", ");
        q.append("version:");
        return f.b.a.a.a.k(q, this.f3332c, ")");
    }

    @Override // com.umeng.commonsdk.proguard.j
    public void write(ai aiVar) throws p {
        f3329j.get(aiVar.D()).b().a(aiVar, this);
    }
    ...
    public enum e implements q {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final Map<String, e> f3335d = new HashMap();
    ...
    public void b(boolean z) {
        this.f3333m = g.a(this.f3333m, 0, z);
    }

    public void c(boolean z) {
        this.f3333m = g.a(this.f3333m, 1, z);
    }
    ...
    public b(b bVar) {
        this.f3333m = (byte) 0;
        this.f3333m = bVar.f3333m;
        if (bVar.d()) {
            this.a = bVar.a;
        }
        this.b = bVar.b;
        this.f3332c = bVar.f3332c;
    }
