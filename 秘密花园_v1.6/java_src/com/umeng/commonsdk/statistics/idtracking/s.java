...
public class s extends a {
    ...
    public static final String f3293e = "yosuid";

    /* renamed from: f  reason: collision with root package name */
    public static final String f3294f = "23346339";
    public Context b;
    ...
    */
    ...
    public String f() {
        ...
        try {
            ...
            String string = sharedPreferences.getString(f3293e, "");
            if (TextUtils.isEmpty(string)) {
                String b = b(f3294f);
                this.f3296d = b;
                if (!TextUtils.isEmpty(b) && this.b != null && (edit = sharedPreferences.edit()) != null) {
                    edit.putString(f3293e, this.f3296d).commit();
                }
                return this.f3296d;
            }
            return string;
