...
public class b {
    ...
    public static final String f3245c = "EnvelopeManager";

    /* renamed from: d  reason: collision with root package name */
    public static String f3246d;

    /* renamed from: f  reason: collision with root package name */
    public static boolean f3247f;
    ...
    public static JSONObject b(Context context) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(f3246d)) {
                try {
                    jSONObject = new JSONObject(f3246d);
                ...
                jSONObject2.put(e.f3135c, SdkVersion.SDK_TYPE);
                if (!TextUtils.isEmpty(a)) {
                    jSONObject2.put(e.f3136d, a);
                }
                f3246d = jSONObject2.toString();
        ...
        try {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(context, e.f3138f, null);
            if (!TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(e.f3138f, imprintProperty);
            }
        } catch (Exception e4) {
        ...
        try {
            if (SdkVersion.SDK_TYPE != 1 && com.umeng.commonsdk.proguard.a.b(context) != null) {
                jSONObject.put(e.f3139g, com.umeng.commonsdk.proguard.a.b(context));
            }
                ...
                if (next != null && (next instanceof String)) {
                    ...
                    if (jSONObject2.opt(str) != null) {
                        try {
                            ...
                            if (str.equals(com.umeng.analytics.pro.b.f2815i) && (jSONObject2.opt(str) instanceof Integer)) {
                                this.f3248e = ((Integer) jSONObject2.opt(str)).intValue();
                            }
                        } catch (Exception unused) {
                        }
                    }
