...
public class l {
    ...
    public static final String f3064c = "_thm_z";

    /* renamed from: d  reason: collision with root package name */
    public static final String f3065d = "_gdf_r";

    /* renamed from: e  reason: collision with root package name */
    public static Object f3066e = new Object();
        ...
        try {
            ...
            if (sharedPreferences != null) {
                ...
                synchronized (f3066e) {
                    ...
                    jSONObject.put(f3064c, sharedPreferences.getString(f3064c, ""));
                    jSONObject.put(f3065d, sharedPreferences.getString(f3065d, ""));
                }
    ...
    public static void b(Context context, String[] strArr) {
        ...
        synchronized (f3066e) {
            sharedPreferences.edit().putString(b, strArr[0]).putString(f3064c, strArr[1]).putString(f3065d, strArr[2]).commit();
        }
    }
