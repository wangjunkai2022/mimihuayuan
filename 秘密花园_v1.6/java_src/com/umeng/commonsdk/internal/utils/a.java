...
public class a {
        ...
        try {
            if (DeviceConfig.checkPermission(context, "android.permission.BLUETOOTH")) {
                ...
                if (defaultAdapter.isEnabled()) {
                    ...
                    bVar.f3009c = defaultAdapter.getName();
                    UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f3002i, com.umeng.commonsdk.internal.b.a(context).a(), bVar);
                }
            }
    ...
    public static void d(Context context) {
        ...
        cVar.b = c2.getBSSID();
        cVar.f3010c = c2.getSSID();
        cVar.f3011d = c2.getFrequency();
        boolean z = true;
        if (c2.getHiddenSSID()) {
            cVar.f3012e = 1;
        } else {
        ...
        cVar.f3013f = c2.getIpAddress();
        cVar.f3014g = c2.getLinkSpeed();
        cVar.f3015h = DeviceConfig.getMac(context);
        cVar.f3016i = c2.getNetworkId();
        cVar.f3017j = c2.getRssi();
        cVar.f3018k = g(context);
        cVar.f3019l = System.currentTimeMillis();
        try {
            JSONArray b2 = f.b(context);
            if (b2 != null && b2.length() > 0) {
                for (int i2 = 0; i2 < b2.length(); i2++) {
                    String optString = b2.optJSONObject(i2).optString(f.f3041h, null);
                    if (optString != null && optString.equals(cVar.f3010c)) {
                        break;
                    }
                }
            }
