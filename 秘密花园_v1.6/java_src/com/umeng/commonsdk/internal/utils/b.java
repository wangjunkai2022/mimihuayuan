...
public class b {
    ...
    public static Context f3021d;
    public PhoneStateListener a;

    /* renamed from: e  reason: collision with root package name */
    public TelephonyManager f3022e;

    /* compiled from: BaseStationUtils.java */
    /* loaded from: classes.dex */
    public static class a {
        public static final b a = new b(b.f3021d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public String e() {
        try {
            TelephonyManager telephonyManager = (TelephonyManager) f3021d.getSystemService("phone");
    ...
    public b(Context context) {
        this.a = new PhoneStateListener() { // from class: com.umeng.commonsdk.internal.utils.b.1
            ...
            public void onSignalStrengthsChanged(SignalStrength signalStrength) {
                ...
                try {
                    b.this.f3022e = (TelephonyManager) b.f3021d.getSystemService("phone");
                    String[] split = signalStrength.toString().split(" ");
                    String str = null;
                    if (b.this.f3022e == null || b.this.f3022e.getNetworkType() != 13) {
                        if (b.this.f3022e != null && (b.this.f3022e.getNetworkType() == 8 || b.this.f3022e.getNetworkType() == 10 || b.this.f3022e.getNetworkType() == 9 || b.this.f3022e.getNetworkType() == 3)) {
                            String e2 = b.this.e();
                    ...
                    if (!TextUtils.isEmpty(sb)) {
                        try {
                            UMWorkDispatch.sendEvent(b.f3021d, com.umeng.commonsdk.internal.a.f3001h, com.umeng.commonsdk.internal.b.a(b.f3021d).a(), sb);
                        } catch (Throwable unused) {
                        }
                    }
                    b.this.c();
        ...
        if (context != null) {
            try {
                this.f3022e = (TelephonyManager) context.getSystemService("phone");
            } catch (Throwable unused) {
            }
        }
    }
