...
public class k {
    ...
    public static final String f2899l = "first_activate_time";

    /* renamed from: m  reason: collision with root package name */
    public static final String f2900m = "ana_is_f";
    ...
    public SharedPreferences f2901c;
    ...
    public static class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final int f2910c = 4099;

        /* renamed from: d  reason: collision with root package name */
        public static final int f2911d = 4100;

        /* renamed from: e  reason: collision with root package name */
        public static final int f2912e = 4101;

        /* renamed from: f  reason: collision with root package name */
        public static final int f2913f = 4102;

        /* renamed from: g  reason: collision with root package name */
        public static final int f2914g = 4103;

        /* renamed from: h  reason: collision with root package name */
        public static final int f2915h = 4104;

        /* renamed from: i  reason: collision with root package name */
        public static final int f2916i = 4105;

        /* renamed from: j  reason: collision with root package name */
        public static final int f2917j = 4106;

        /* renamed from: k  reason: collision with root package name */
        public static final int f2918k = 4352;

        /* renamed from: l  reason: collision with root package name */
        public static final int f2919l = 4353;

        /* renamed from: m  reason: collision with root package name */
        public static final int f2920m = 4354;
    ...
    private void e(Object obj) {
        try {
            ...
            if (2050 == jSONObject.getInt("__t")) {
                if (!a(this.f2909k, this.f2907i)) {
                    return;
                }
                this.f2907i++;
            } else if (2049 == jSONObject.getInt("__t")) {
                if (!a(this.f2909k, this.f2908j)) {
                    return;
                }
                this.f2908j++;
            }
            if (this.f2905g.length() >= this.f2904f) {
                g.a(a).a(this.f2905g);
                this.f2905g = new JSONArray();
            }
            if (this.f2909k == 0) {
                this.f2909k = System.currentTimeMillis();
            }
            this.f2905g.put(jSONObject);
        } catch (Throwable th) {
            MLog.e(th);
        }
    }
    ...
    private JSONObject m() {
        ...
        try {
            ...
            jSONObject.put(com.umeng.analytics.pro.b.f2815i, AnalyticsConfig.getVerticalType(a));
            ...
            if (t()) {
                jSONObject.put(com.umeng.analytics.pro.b.ag, UMRTLog.RTLOG_ENABLE);
                if (sharedPreferences != null) {
                    sharedPreferences.edit().putLong(f2900m, 0L).commit();
                }
            }
            jSONObject.put(com.umeng.analytics.pro.b.f2818l, n());
            jSONObject.put(com.umeng.analytics.pro.b.f2819m, o());
            if (sharedPreferences != null) {
                String string = sharedPreferences.getString("vers_name", "");
                if (!TextUtils.isEmpty(string)) {
                    String format = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()));
                    if (TextUtils.isEmpty(imprintProperty)) {
                        jSONObject.put(com.umeng.analytics.pro.b.f2818l, sharedPreferences.getString("vers_pre_version", "0"));
                        jSONObject.put(com.umeng.analytics.pro.b.f2819m, sharedPreferences.getString("vers_date", format));
                    }
    ...
    private String n() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                if (!TextUtils.isEmpty(this.f2902d)) {
                    return this.f2902d;
                }
                if (this.f2901c == null) {
                    this.f2901c = PreferenceWrapper.getDefault(a);
                }
                String string = this.f2901c.getString("pre_version", "");
                String appVersionName = DeviceConfig.getAppVersionName(a);
                if (TextUtils.isEmpty(string)) {
                    this.f2901c.edit().putString("pre_version", "0").putString("cur_version", appVersionName).commit();
                    str = "0";
                } else {
                    String string2 = this.f2901c.getString("cur_version", "");
                    if (appVersionName.equals(string2)) {
                        str = string;
                    } else {
                        this.f2901c.edit().putString("pre_version", string2).putString("cur_version", appVersionName).commit();
                        str = string2;
                    }
                }
            }
    ...
    private String o() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                String string = this.f2901c.getString("pre_date", "");
                if (TextUtils.isEmpty(string)) {
                    string = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()));
                    this.f2901c.edit().putString("pre_date", string).commit();
                } else {
                    String format = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()));
                    if (!string.equals(format)) {
                        this.f2901c.edit().putString("pre_date", format).commit();
                        str = format;
                    }
                }
                str = string;
    ...
    private boolean q() {
        try {
            ...
            if (this.f2905g.length() > 0) {
                for (int i2 = 0; i2 < this.f2905g.length(); i2++) {
                    JSONObject optJSONObject = this.f2905g.optJSONObject(i2);
    ...
    private void r() {
        if (this.f2905g.length() > 0) {
            ...
            for (int i2 = 0; i2 < this.f2905g.length(); i2++) {
                try {
                    JSONObject jSONObject = this.f2905g.getJSONObject(i2);
    ...
    private void s() {
        ...
        try {
            if (!t() || a == null || (sharedPreferences = PreferenceWrapper.getDefault(a)) == null || sharedPreferences.getLong("first_activate_time", 0L) != 0) {
                return;
            }
    ...
    private boolean t() {
        ...
        try {
            ...
            return sharedPreferences.getLong(f2900m, -1L) != 0;
        } catch (Throwable unused) {
            return false;
        }
    }
    ...
    public void d() {
        try {
            ...
            PreferenceWrapper.getDefault(a).edit().putLong("thtstart", this.f2909k).putInt("gkvc", this.f2907i).putInt("ekvc", this.f2908j).commit();
        } catch (Throwable unused) {
        }
    }
    ...
    public k() {
        ...
        this.f2904f = 10;
        this.f2905g = new JSONArray();
        this.f2906h = TbsReaderView.ReaderCallback.GET_BAR_ANIMATING;
        this.f2907i = 0;
        this.f2908j = 0;
        this.f2909k = 0L;
        ...
        try {
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(a);
            this.f2909k = sharedPreferences.getLong("thtstart", 0L);
            this.f2907i = sharedPreferences.getInt("gkvc", 0);
            this.f2908j = sharedPreferences.getInt("ekvc", 0);
            this.b = new c();
        } catch (Throwable unused) {
        }
    }
    ...
    public static class c {
        ...
        /* renamed from: f  reason: collision with root package name */
        public ABTest f2924f;

        public c() {
            this.f2924f = null;
            this.f2924f = ABTest.getService(k.a);
        }
        ...
        public void b() {
            ...
            if (!service.isOpen()) {
                ...
                if (MLog.DEBUG && z) {
                ...
                } else if (this.f2924f.isInTest() && "RPT".equals(this.f2924f.getTestName())) {
                    if (this.f2924f.getTestPolicy() == 6) {
                    ...
                    this.a = b(this.f2924f.getTestPolicy(), i2);
                } else {
                    int i3 = this.f2922d;
                    int i4 = this.f2923e;
                    int i5 = this.b;
        ...
        private ReportPolicy.ReportStrategy b(int i2, int i3) {
            if (i2 == 0) {
                ...
                return new ReportPolicy.ReportByInterval(StatTracer.getInstance(k.a), i3);
            } else if (i2 == 8) {
        ...
        if (a != null) {
            synchronized (this.w) {
                if (this.u) {
                    ...
                    UMWorkDispatch.sendEvent(a, a.f2919l, CoreProtocol.getInstance(a), null);
                }
            }
            synchronized (this.w) {
                if (this.v) {
                    UMWorkDispatch.sendEvent(a, a.f2920m, CoreProtocol.getInstance(a), null);
                }
            }
        }
    }
