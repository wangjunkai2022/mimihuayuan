...
public class r {
    ...
    public static JSONArray f2943c = new JSONArray();

    /* renamed from: d  reason: collision with root package name */
    public static Object f2944d = new Object();

    /* renamed from: e  reason: collision with root package name */
    public final Map<String, Long> f2945e = new HashMap();
    ...
    public static void a(Context context) {
        ...
        if (context != null) {
            try {
                ...
                synchronized (f2944d) {
                    jSONArray = f2943c.toString();
                    f2943c = new JSONArray();
                }
    ...
    public void b(String str) {
        ...
        if (this.f2945e.containsKey(str)) {
            synchronized (this.f2945e) {
                l2 = this.f2945e.get(str);
            }
            if (l2 == null) {
                return;
            }
            ...
            synchronized (f2944d) {
                try {
                    ...
                    f2943c.put(jSONObject);
                    if (f2943c.length() >= 5 && (appContext = UMGlobalContext.getAppContext(null)) != null) {
    ...
    public void a(String str) {
        ...
        synchronized (this.f2945e) {
            this.f2945e.put(str, Long.valueOf(System.currentTimeMillis()));
    ...
    public void b() {
        ...
        synchronized (this.f2945e) {
            str = null;
            long j2 = 0;
            for (Map.Entry<String, Long> entry : this.f2945e.entrySet()) {
