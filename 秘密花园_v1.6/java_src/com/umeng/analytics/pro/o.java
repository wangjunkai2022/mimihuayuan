...
public class o {
    ...
    public static final String f2930f = "-1";
    ...
    public static o a(Context context) {
        if (f2931g == null && context != null) {
            f2931g = context.getApplicationContext();
        }
        return a.a;
    }
    ...
    private void b(Context context) {
        try {
            ...
            if (!TextUtils.isEmpty(string)) {
                this.f2935h = new JSONObject(string);
            }
            a();
    ...
    private void c(Context context) {
        try {
            if (this.f2935h != null) {
                PreferenceWrapper.getDefault(f2931g).edit().putString(a, this.f2935h.toString()).commit();
            }
    ...
    public void a(String str, String str2, long j2, int i2, String str3) {
        ...
        try {
            if (a(str) && b(str2)) {
                ...
                if (UMGlobalContext.getInstance().isMainProcess(f2931g)) {
                    a2 = u.a().d(UMGlobalContext.getAppContext(f2931g));
                } else {
                    a2 = u.a().a(UMGlobalContext.getAppContext(f2931g), currentTimeMillis);
                }
                ...
                jSONObject.put(b.ad, UMGlobalContext.getInstance().getProcessName(f2931g));
                a();
                if (this.f2935h != null && this.f2935h.has(str) && !((Boolean) this.f2935h.get(str)).booleanValue()) {
                    jSONObject.put(b.X, 1);
                    this.f2935h.put(str, true);
                    c(f2931g);
                }
                UMWorkDispatch.sendEvent(f2931g, 4097, CoreProtocol.getInstance(f2931g), jSONObject);
                return;
            }
            UMLog.aq(h.f2891l, 0, "\\|");
            ...
            if (!a(str)) {
                ...
                if (map.size() > 10) {
                    ...
                    if (UMGlobalContext.getInstance().isMainProcess(f2931g)) {
                        ...
                        a2 = u.a().a(UMGlobalContext.getAppContext(f2931g), jSONObject.getLong("ts"));
                    }
                    if (TextUtils.isEmpty(a2)) {
                        a2 = "-1";
                    }
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String d2 = u.a().d(UMGlobalContext.getAppContext(f2931g));
                ...
                UMWorkDispatch.sendEvent(f2931g, 4098, CoreProtocol.getInstance(f2931g), jSONObject);
            }
        } catch (Throwable unused2) {
        }
    }
    ...
    private void a() {
        try {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(f2931g, "track_list", "");
            ...
            if (this.f2935h != null) {
                for (String str : split) {
                    ...
                    if (this.f2935h.has(subStr)) {
                        jSONObject.put(subStr, this.f2935h.get(subStr));
                    }
                }
            }
            this.f2935h = new JSONObject();
            if (split.length >= 10) {
                while (i2 < 10) {
    ...
    private void a(String str, boolean z) {
        try {
            if (b.X.equals(str) || b.V.equals(str) || "id".equals(str) || "ts".equals(str) || this.f2935h.has(str)) {
                return;
            }
            this.f2935h.put(str, z);
        } catch (Exception unused) {
        }
    }
