...
public class UMProcessDBHelper {
    ...
    public class InsertEventCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str, Object obj) {
            ...
            if (str.startsWith(com.umeng.analytics.process.a.f2962c)) {
                str = str.replaceFirst(com.umeng.analytics.process.a.f2962c, "");
            }
            UMProcessDBHelper.this.insertEvents(str.replace(com.umeng.analytics.process.a.f2963d, ""), (JSONArray) obj);
            return true;
        }
    }
    ...
    public class ProcessToMainCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            UMProcessDBHelper.this.processToMain(str.replace(com.umeng.analytics.process.a.f2963d, ""));
            return true;
        }
    ...
    private List<a> datasAdapter(String str, JSONArray jSONArray) {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            try {
                ...
                a aVar = new a();
                aVar.f2955c = jSONObject.optString("id");
                aVar.f2959g = UMUtils.getAppVersionName(this.mContext);
                aVar.f2960h = UMUtils.getAppVersionCode(this.mContext);
                aVar.b = jSONObject.optString("__i");
                aVar.f2957e = jSONObject.optInt("__t");
                aVar.f2958f = str;
                ...
                aVar.f2956d = w.a().a(jSONObject.toString());
                jSONObject.remove(com.umeng.analytics.pro.b.ac);
                arrayList.add(aVar);
                ...
                try {
                    ...
                    for (a aVar : list) {
                        try {
                            ...
                            contentValues.put("__e", aVar.f2955c);
                            contentValues.put("__t", Integer.valueOf(aVar.f2957e));
                            contentValues.put(a.InterfaceC0020a.f2971f, aVar.f2958f);
                            contentValues.put("__av", aVar.f2959g);
                            contentValues.put("__vc", aVar.f2960h);
                            contentValues.put("__s", aVar.f2956d);
    ...
    public void processToMain(String str) {
        if (dbIsExists(str)) {
            ...
            if (!readEventByProcess.isEmpty() && insertEvents_(com.umeng.analytics.process.a.f2967h, readEventByProcess)) {
    ...
    */
    private java.util.List<com.umeng.analytics.process.UMProcessDBHelper.a> readEventByProcess(java.lang.String r8) {
        ...
        L1b:
            ...
            int r5 = r0.getColumnIndex(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = r0.getString(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            r4.f2955c = r5     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = "__s"
            int r5 = r0.getColumnIndex(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = r0.getString(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            r4.f2956d = r5     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = "__t"
            int r5 = r0.getColumnIndex(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            int r5 = r0.getInt(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            r4.f2957e = r5     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = "__pn"
            int r5 = r0.getColumnIndex(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = r0.getString(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            r4.f2958f = r5     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = "__av"
            int r5 = r0.getColumnIndex(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = r0.getString(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            r4.f2959g = r5     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = "__vc"
            int r5 = r0.getColumnIndex(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            java.lang.String r5 = r0.getString(r5)     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
            r4.f2960h = r5     // Catch: java.lang.Exception -> L85 java.lang.Throwable -> Lb2
    ...
    */
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) {
        ...
        cursor = null;
        try {
            sQLiteDatabase = c.a(this.mContext).a(com.umeng.analytics.process.a.f2967h);
            try {
                try {
                    sQLiteDatabase.beginTransaction();
                                    ...
                                    try {
                                        ...
                                        if (cursor != null) {
                                            try {
                                                ...
                                                c.a(this.mContext).b(com.umeng.analytics.process.a.f2967h);
                                                return jSONObject;
                                            }
                                        }
                                        if (sQLiteDatabase != null) {
