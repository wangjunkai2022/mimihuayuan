...
public final class SubtitleView extends View implements k {
    ...
    private a getUserCaptionStyleV19() {
        ...
        if (h0.a >= 21) {
            return new a(userStyle.hasForegroundColor() ? userStyle.foregroundColor : a.f5306g.a, userStyle.hasBackgroundColor() ? userStyle.backgroundColor : a.f5306g.b, userStyle.hasWindowColor() ? userStyle.windowColor : a.f5306g.f5307c, userStyle.hasEdgeType() ? userStyle.edgeType : a.f5306g.f5308d, userStyle.hasEdgeColor() ? userStyle.edgeColor : a.f5306g.f5309e, userStyle.getTypeface());
        }
    ...
    public void b() {
        setStyle((h0.a < 19 || !((CaptioningManager) getContext().getSystemService("captioning")).isEnabled() || isInEditMode()) ? a.f5306g : getUserCaptionStyleV19());
    }
    ...
    */
    ...
    public void setApplyEmbeddedStyles(boolean z) {
        if (this.f2431e == z && this.f2432f == z) {
            return;
        }
        this.f2431e = z;
        this.f2432f = z;
    ...
    public void setFractionalTextSize(float f2) {
        if (this.f2429c == 0 && this.f2430d == f2) {
            return;
        }
        this.f2429c = 0;
        this.f2430d = f2;
