...
public final class DashMediaSource extends o {
    ...
    public final m.a f2378g;

    /* renamed from: h  reason: collision with root package name */
    public final c.a f2379h;

    /* renamed from: i  reason: collision with root package name */
    public final v f2380i;

    /* renamed from: j  reason: collision with root package name */
    public final b0 f2381j;
    ...
    public final boolean f2377f = false;

    /* renamed from: m  reason: collision with root package name */
    public final f0.a f2384m = j(null);
    ...
    public static final class Factory {
        ...
        public e0.a<? extends f.i.a.a.h1.t0.k.b> f2385c;
        @Nullable

        /* renamed from: d  reason: collision with root package name */
        public List<f.i.a.a.e1.c0> f2386d;
        ...
        public DashMediaSource createMediaSource(Uri uri) {
            this.f2391i = true;
            if (this.f2385c == null) {
                this.f2385c = new f.i.a.a.h1.t0.k.c();
            }
            List<f.i.a.a.e1.c0> list = this.f2386d;
            if (list != null) {
                this.f2385c = new z(this.f2385c, list);
            }
            if (uri != null) {
                return new DashMediaSource(null, uri, this.b, this.f2385c, this.a, this.f2387e, this.f2388f, this.f2389g, this.f2390h, null, null);
            }
            throw null;
        }

        public Factory setStreamKeys(List<f.i.a.a.e1.c0> list) {
            c.a.a.b.g.h.v(!this.f2391i);
            this.f2386d = list;
            return this;
        }
        ...
        public Factory(c.a aVar, @Nullable m.a aVar2) {
            ...
            this.b = aVar2;
            this.f2388f = new w();
            this.f2389g = com.umeng.commonsdk.proguard.c.f3131d;
            this.f2387e = new v();
        }
    }
    ...
    public static final class b extends u0 {
        ...
        /* renamed from: h  reason: collision with root package name */
        public final f.i.a.a.h1.t0.k.b f2397h;
        @Nullable

        /* renamed from: i  reason: collision with root package name */
        public final Object f2398i;
        ...
        public int b(Object obj) {
            int intValue;
            if ((obj instanceof Integer) && (intValue = ((Integer) obj).intValue() - this.f2393d) >= 0 && intValue < i()) {
                return intValue;
            }
            return -1;
        }
        ...
        public u0.b g(int i2, u0.b bVar, boolean z) {
            ...
            bVar.g(z ? this.f2397h.f5049l.get(i2).a : null, z ? Integer.valueOf(this.f2393d + i2) : null, 0, q.a(this.f2397h.d(i2)), q.a(this.f2397h.f5049l.get(i2).b - this.f2397h.b(0).b) - this.f2394e);
            return bVar;
        }
        ...
        public Object m(int i2) {
            c.a.a.b.g.h.q(i2, 0, i());
            return Integer.valueOf(this.f2393d + i2);
        }
    ...
    public final class e implements c0.b<e0<f.i.a.a.h1.t0.k.b>> {
        ...
        public c0.c p(e0<f.i.a.a.h1.t0.k.b> e0Var, long j2, long j3, IOException iOException, int i2) {
            ...
            long c3 = ((w) dashMediaSource.f2381j).c(4, j3, iOException, i2);
            if (c3 == -9223372036854775807L) {
                c2 = c0.f5573e;
            } else {
                c2 = c0.c(false, c3);
            }
            f0.a aVar = dashMediaSource.f2384m;
            p pVar = e0Var2.a;
    ...
    public static final class g {
        ...
        public static g a(f.i.a.a.h1.t0.k.f fVar, long j2) {
            ...
            boolean z2;
            int i2;
            int size = fVar.f5060c.size();
            int i3 = 0;
            for (int i4 = 0; i4 < size; i4++) {
                int i5 = fVar.f5060c.get(i4).b;
                if (i5 == 1 || i5 == 2) {
                    z = true;
                    break;
                }
            ...
            boolean z4 = false;
            while (i6 < size) {
                f.i.a.a.h1.t0.k.a aVar = fVar.f5060c.get(i6);
                if (!z || aVar.b != 3) {
                    f.i.a.a.h1.t0.f i7 = aVar.f5037c.get(i3).i();
                    if (i7 == null) {
    ...
    public final class h implements c0.b<e0<Long>> {
        ...
        public c0.c p(e0<Long> e0Var, long j2, long j3, IOException iOException, int i2) {
            ...
            p pVar = e0Var2.a;
            g0 g0Var = e0Var2.f5583c;
            aVar.u(pVar, g0Var.f5597c, g0Var.f5598d, e0Var2.b, j2, j3, g0Var.b, iOException, true);
        ...
        public void r(e0<Long> e0Var, long j2, long j3) {
            ...
            dashMediaSource.H = e0Var2.f5585e.longValue() - j2;
            dashMediaSource.s(true);
        }
    }
    ...
    public f.i.a.a.h1.d0 c(e0.a aVar, f.i.a.a.l1.e eVar, long j2) {
        ...
        c.a.a.b.g.h.m(true);
        f.i.a.a.h1.t0.e eVar2 = new f.i.a.a.h1.t0.e(this.K + intValue, this.D, intValue, this.f2379h, this.y, this.f2381j, this.b.D(0, aVar, j3), this.H, this.u, eVar, this.f2380i, this.t);
    ...
    public void d(f.i.a.a.h1.d0 d0Var) {
        ...
        j jVar = eVar.f4998k;
        jVar.f5034k = true;
        jVar.f5027d.removeCallbacksAndMessages(null);
    ...
    public void l(@Nullable i0 i0Var) {
        ...
        this.w = this.f2378g.createDataSource();
    ...
    public void n() {
        ...
        this.F = 0L;
        this.G = 0L;
        this.D = this.f2377f ? this.D : null;
        this.C = this.B;
        this.z = null;
    ...
    public void q(f.i.a.a.l1.e0<?> e0Var, long j2, long j3) {
        f0.a aVar = this.f2384m;
        p pVar = e0Var.a;
        g0 g0Var = e0Var.f5583c;
        aVar.o(pVar, g0Var.f5597c, g0Var.f5598d, e0Var.b, j2, j3, g0Var.b);
    }
    ...
    public final void s(boolean z) {
        ...
        for (int i2 = 0; i2 < this.q.size(); i2++) {
            ...
            if (keyAt >= this.K) {
                ...
                valueAt.r = bVar;
                valueAt.s = i3;
                j jVar = valueAt.f4998k;
                jVar.f5033j = false;
                jVar.f5030g = -9223372036854775807L;
                jVar.f5029f = bVar;
                Iterator<Map.Entry<Long, Long>> it = jVar.f5028e.entrySet().iterator();
                while (it.hasNext()) {
                    if (it.next().getKey().longValue() < jVar.f5029f.f5045h) {
                        it.remove();
                    }
                }
                ...
                if (gVarArr != null) {
                    for (f.i.a.a.h1.s0.g<f.i.a.a.h1.t0.c> gVar : gVarArr) {
                        gVar.f4971e.d(bVar, i3);
                    }
                    valueAt.n.i(valueAt);
                }
                valueAt.t = bVar.f5049l.get(i3).f5061d;
                for (f.i.a.a.h1.t0.i iVar : valueAt.p) {
                    Iterator<f.i.a.a.h1.t0.k.e> it2 = valueAt.t.iterator();
                    while (true) {
                        if (it2.hasNext()) {
                            f.i.a.a.h1.t0.k.e next = it2.next();
                            if (next.a().equals(iVar.f5022e.a())) {
                                iVar.c(next, bVar.f5041d && i3 == bVar.c() - 1);
                            }
                        }
                    }
                }
    ...
    public final void t(f.i.a.a.h1.t0.k.m mVar, e0.a<Long> aVar) {
        ...
        this.f2384m.x(e0Var.a, e0Var.b, this.x.g(e0Var, new h(null), 1));
    }
    ...
    public final void u() {
        ...
        this.f2384m.x(e0Var.a, e0Var.b, this.x.g(e0Var, this.o, ((w) this.f2381j).b(4)));
    }
}
