...
public class GifDrawable extends Drawable implements f.b, Animatable, Animatable2Compat {
    ...
    public void a() {
        ...
        invalidateSelf();
        f.a aVar = this.a.a.f3803j;
        if ((aVar != null ? aVar.f3808e : -1) == this.a.a.a.d() - 1) {
            this.f92f++;
        }
        int i2 = this.f93g;
    ...
    public final void d() {
        ...
        if (this.a.a.a.d() == 1) {
            ...
            f fVar = this.a.a;
            if (!fVar.f3804k) {
                if (!fVar.f3796c.contains(this)) {
                    boolean isEmpty = fVar.f3796c.isEmpty();
                    fVar.f3796c.add(this);
                    if (isEmpty && !fVar.f3799f) {
                        fVar.f3799f = true;
                        fVar.f3804k = false;
                        fVar.a();
                    }
    ...
    public final void e() {
        this.b = false;
        f fVar = this.a.a;
        fVar.f3796c.remove(this);
        if (fVar.f3796c.isEmpty()) {
            fVar.f3799f = false;
        }
    }
