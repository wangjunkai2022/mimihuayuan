...
import com.comeback.data.ui.fruitPie.FruitLaunchActivity;
...
public class SecretGardenActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener {
    ...
    public MainAdapter.a f1569d = new MainAdapter.a() { // from class: f.e.a.j.c0.f
    ...
    public class a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i2) {
            ...
            SecretGardenActivity.this.f1568c = true;
        }
    }
    ...
    */
    ...
    public final void n() {
        ...
        if (configBean != null && !TextUtils.isEmpty(configBean.getShareText2())) {
            ...
            h.p1(e.a("09rojNbO3K/Dg6nnnc7ujr/Uhez7lrOsnNq4gsfBhuWMh+vij8mS1Mj/0cLFjP/g0u3ogfvU"));
            return;
        }
    ...
    public final void r() {
        ...
        arrayList2.add(new HomeBean(e.a("0dLXgvXv34fN"), R.mipmap.launcher_pie, 51, ""));
    ...
    public final void s(RecyclerView recyclerView, List<HomeBean> list) {
        ...
        mainAdapter.f1583d = this.f1569d;
    }
