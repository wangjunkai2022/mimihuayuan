...
public class ADLauncherActivity extends BaseActivity {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            int i2 = aDLauncherActivity.f1531c;
            int i3 = i2 - 1;
            aDLauncherActivity.f1531c = i3;
            if (i2 > 3) {
                aDLauncherActivity.tvCount.setText(String.valueOf(i3));
                ADLauncherActivity aDLauncherActivity2 = ADLauncherActivity.this;
                aDLauncherActivity2.tvCount.postDelayed(aDLauncherActivity2.f1532d, 1000L);
                return;
            }
            aDLauncherActivity.f1531c = i3 - 1;
            if (i3 >= 0) {
                ...
                aDLauncherActivity3.tvCount.postDelayed(aDLauncherActivity3.f1532d, 1000L);
    ...
    public void e() {
        ...
        this.tvCount.postDelayed(this.f1532d, 150L);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        this.tvCount.removeCallbacks(this.f1532d);
    }
