...
public class DownloadActivity extends BaseActivity implements DownloadAdapter.a, c {
    ...
    public static String[] f1544f = {e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sNj5gIiokIidoMTcrOTJ+dg=="), e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")};
    ...
    public void c(Intent intent) {
        this.f1545c = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1546d = intent.getStringExtra(e.a("QhAP"));
    }
    ...
    public void e() {
        try {
            if (ContextCompat.checkSelfPermission(this, e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")) != 0) {
                ActivityCompat.requestPermissions(this, f1544f, 1);
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        ...
        if (aVar != null) {
            ...
            textView.setText(e.a("0c/Agffb3Yv4jonal9b5") + aVar.f3871e.getName());
            aVar.a = this;
        }
        if (TextUtils.isEmpty(this.f1546d) && TextUtils.isEmpty(this.f1545c)) {
            return;
        }
        AlertDialog.Builder title = new AlertDialog.Builder(this).setTitle(e.a("0e3zg8/J"));
        title.setMessage(e.a("0MnogebA3Yv4jona") + this.f1545c).setNeutralButton(e.a("0vLF"), b.a).setNegativeButton(e.a("0MnogebA3Yv4jona"), new DialogInterface.OnClickListener() { // from class: f.e.a.j.c0.c
    ...
    public final void l() {
        ...
        realmQuery.a(e.a("QhAP"), this.f1546d);
        if (((VideoCacheBean) realmQuery.c()) != null) {
            h.p1(this.f1545c + e.a("0tXRg9D83K/bgonHn/Dnj4zZhu7KlrGkm8ecg8DH"));
            return;
        }
        VideoCacheBean videoCacheBean = new VideoCacheBean(this.f1545c, this.f1546d);
        TextView textView = this.tvName;
    ...
    public void onRequestPermissionsResult(int i2, String[] strArr, int[] iArr) {
        ...
        if (iArr.length <= 0 || iArr[0] != 0) {
            h.p1(e.a("09rug9Dq3Yv4jonanvfggq7yh9nLl4G4m9uJg8DAitOWh+fbhM+m"));
        }
    }
