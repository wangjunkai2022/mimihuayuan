...
public class LauncherActivity extends BaseActivity {
    ...
    public static String[] f1550k = {e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sIy57KT01MD92NiY=")};
    public boolean b;
    ...
    public Runnable f1554f = new a();

    /* renamed from: g  reason: collision with root package name */
    public int f1555g = 6;

    /* renamed from: h  reason: collision with root package name */
    public Runnable f1556h = new b();

    /* renamed from: j  reason: collision with root package name */
    public AD f1558j = null;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            int i2 = launcherActivity.f1553e - 1;
            launcherActivity.f1553e = i2;
            if (i2 > 0) {
                launcherActivity.tvName.postDelayed(launcherActivity.f1554f, 250L);
            } else if (i2 == 0) {
                launcherActivity.tvName.postDelayed(launcherActivity.f1554f, 500L);
            } else {
                launcherActivity.f1552d = true;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            LauncherActivity launcherActivity = LauncherActivity.this;
            int i2 = launcherActivity.f1555g;
            int i3 = i2 - 1;
            launcherActivity.f1555g = i3;
            if (i2 > 2) {
                launcherActivity.tvCount.setText(String.valueOf(i3));
                LauncherActivity launcherActivity2 = LauncherActivity.this;
                launcherActivity2.tvCount.postDelayed(launcherActivity2.f1554f, 1200L);
                return;
            }
            launcherActivity.f1555g = i3 - 1;
            if (i3 > 0) {
                launcherActivity.tvCount.setText(e.a("39XQjNT0"));
                LauncherActivity.this.tvCount.setClickable(true);
                LauncherActivity launcherActivity3 = LauncherActivity.this;
                launcherActivity3.tvCount.postDelayed(launcherActivity3.f1554f, 1200L);
                return;
            }
            launcherActivity.o();
        }
    ...
    public static void l(LauncherActivity launcherActivity) {
        if (launcherActivity.f1552d) {
            if (!launcherActivity.f1551c) {
                launcherActivity.llLogo.setVisibility(8);
                launcherActivity.flProgress.setVisibility(0);
            } else if (App.f104e != null && launcherActivity.f1558j != null) {
                launcherActivity.flAd.setVisibility(0);
                launcherActivity.flProgress.setVisibility(8);
                h.u0(launcherActivity.f1558j.getImage(), launcherActivity.ivCover);
                launcherActivity.tvCount.setClickable(false);
                launcherActivity.tvCount.postDelayed(launcherActivity.f1556h, 150L);
            } else {
                launcherActivity.o();
            }
        }
    ...
    public static void m(LauncherActivity launcherActivity) {
        if (launcherActivity != null) {
            d<i0> c2 = f.e.a.j.i0.c.a().c(e.a("XxYXFBhJFhwAAURWVhwWB0MQDAYBFlpHAEhXCBVFAgpWTQAHRRlJVA=="));
            launcherActivity.f1557i = c2;
    ...
    public final void n() {
        ...
        this.tvName.postDelayed(this.f1554f, 250L);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        d<i0> dVar = this.f1557i;
        if (dVar != null) {
            dVar.cancel();
        }
        this.tvName.removeCallbacks(this.f1554f);
        this.tvCount.removeCallbacks(this.f1556h);
    }
    ...
    public void onViewClicked(View view) {
        ...
        this.tvCount.removeCallbacks(this.f1554f);
        try {
            startActivity(new Intent(e.a("VgwHFgQaXR0aCEACFh5NClQWCgsFXW96NjE="), Uri.parse(this.f1558j.getTargetUrl())));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        this.b = true;
    ...
    public void p() {
        try {
            if (ContextCompat.checkSelfPermission(this, e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sIy57KT01MD92NiY=")) != 0) {
                ActivityCompat.requestPermissions(this, f1550k, 1);
            } else {
                n();
            }
        } catch (Exception e2) {
