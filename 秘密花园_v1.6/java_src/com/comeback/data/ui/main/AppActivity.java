...
public class AppActivity extends BaseActivity {
    ...
    public static void m(AppActivity appActivity, String str) {
        if (appActivity != null) {
            ...
            while (it.hasNext()) {
                ...
                appInfo.setUrl(appActivity.f1541d + e.a("GBYT") + hVar.b(e.a("XxAGAg==")));
                appInfo.setName(hVar.L());
                appInfo.setImage(appActivity.f1541d + hVar.J(e.a("Xg8E")).get(0).b(e.a("RBAA")));
    ...
    public void c(Intent intent) {
        ...
        this.f1540c = intent.getBooleanExtra(e.a("RAoMEyEGVEMxFFsQCw8R"), false);
    }
