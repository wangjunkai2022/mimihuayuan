...
public class LNKLDetailActivity extends BaseActivity {
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            if (g0Var.a.f6533e < 300) {
                try {
                    VideoInfo Y0 = h.Y0(g0Var.b.H());
                    LNKLDetailActivity.this.f1462d = Y0.getTorrentUrl();
                    TextView textView = LNKLDetailActivity.this.tvLink;
                    textView.setText(e.a("0MXugcbj0KDNgLrCl9b5") + LNKLDetailActivity.this.f1462d);
    ...
    public void c(Intent intent) {
        ...
        this.f1461c = intent.getStringExtra(e.a("QhAP"));
        d<i0> c2 = c.a().c(this.f1461c);
        this.f1463e = c2;
        c2.X(new a());
    }
    ...
    public void onViewClicked(View view) {
        if (TextUtils.isEmpty(this.f1462d)) {
            h.p1(e.a("383Ug8b63I32joHjntDzg5DBhfr7lbGjluyr"));
            return;
        }
        int id = view.getId();
        if (id == R.id.tv_copy) {
            ((ClipboardManager) getSystemService(e.a("VA4KFAkcWEEX"))).setPrimaryClip(ClipData.newPlainText(e.a("ewMBAQc="), this.f1462d));
            h.p1(e.a("0sbugePF37vjg774"));
        } else if (id != R.id.tv_down) {
        } else {
            try {
                Intent intent = new Intent(e.a("VgwHFgQaXR0aCEACFh5NClQWCgsFXW96NjE="), Uri.parse(this.f1462d));
                intent.addCategory(e.a("VgwHFgQaXR0aCEACFh5NCFYWBgMEAUAdNyNyJi0mNw=="));
                startActivity(intent);
            } catch (Exception unused) {
                h.p1(e.a("383Uge773J36jpfikNXmgqzV"));
            }
        }
    }
}
