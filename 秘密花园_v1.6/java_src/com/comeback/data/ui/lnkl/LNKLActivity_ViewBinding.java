...
public class LNKLActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ LNKLActivity f1460c;

        public a(LNKLActivity_ViewBinding lNKLActivity_ViewBinding, LNKLActivity lNKLActivity) {
            this.f1460c = lNKLActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            final LNKLActivity lNKLActivity = this.f1460c;
    ...
    public void a() {
        LNKLActivity lNKLActivity = this.f1458c;
        if (lNKLActivity != null) {
            this.f1458c = null;
