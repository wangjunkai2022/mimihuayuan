...
public class LNKLActivity extends BaseRefreshActivity {
    ...
    public String[] f1455d = {e.a("GANMBR0EVBwaCFACAA=="), e.a("GANMCwYSTxwaCFACAA=="), e.a("GANMHQZcUF0XA0w="), e.a("GANMDhpcUF0XA0w="), e.a("GANMEhlcUF0XA0w="), e.a("GANMCAxcUF0XA0w="), e.a("GANMHhxcUF0XA0w="), e.a("GANMFgZcUF0XA0w="), e.a("GANMAAZcUF0XA0w="), e.a("GANMDhpcUF0XA0w="), e.a("GANMHhtcUF0XA0w=")};

    /* renamed from: e  reason: collision with root package name */
    public String f1456e = e.a("GANMBR0EVBwaCFACAA==");
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            ...
            if (g0Var.a.f6533e < 300) {
                try {
                    ArrayList<Video> Z0 = h.Z0(g0Var.b.H());
                    if (this.a == 1) {
                        LNKLActivity.this.f114c.c();
                    }
                    LNKLActivity.this.f114c.a(Z0);
                    return;
    ...
    public void p(int i2) {
        String str;
        if (i2 == 1) {
            str = f.b.a.a.a.n(new StringBuilder(), this.f1456e, "GQoXCQc=");
        } else {
            str = this.f1456e + e.a("aA==") + i2 + e.a("GQoXCQc=");
        }
