...
public class VideoFragment extends BaseRefreshFragment {
    ...
    public Category.DataBean.InfoBean f2262i;
    ...
    public void a() {
        this.f2262i = (Category.DataBean.InfoBean) getArguments().getParcelable(e.a("UwMXBSkWWF0="));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(f.b.a.a.a.i("QAcBOwQVX1oQD1UL", hashMap, f.b.a.a.a.G(this.f116g, hashMap, e.a("RwMEASUc"), "VAoCCgUWVQ=="), "VAoKCA86XQ=="), String.valueOf(this.f2262i.getChildId()));
        hashMap.put(e.a("VAMXAQwcS0o6Ag=="), this.f2262i.getCategoryId());
