...
public class NovelFragment extends BaseRefreshFragment {
    ...
    public Category.DataBean.InfoBean f2253i;
    ...
    public void a() {
        this.f2253i = (Category.DataBean.InfoBean) getArguments().getParcelable(e.a("UwMXBSkWWF0="));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(f.b.a.a.a.i("QAcBOwQVX1oQD1UL", hashMap, f.b.a.a.a.G(this.f116g, hashMap, e.a("RwMEASUc"), "VAoCCgUWVQ=="), "VAoKCA86XQ=="), String.valueOf(this.f2253i.getChildId()));
