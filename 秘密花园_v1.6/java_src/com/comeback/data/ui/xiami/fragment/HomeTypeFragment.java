...
public class HomeTypeFragment extends BaseViewPagerFragment {
    ...
    public Category.DataBean f2246g;
    ...
    public void a() {
        this.f2246g = (Category.DataBean) getArguments().getParcelable(e.a("UwMXBSkWWF0="));
    }
    ...
    public ArrayList<BaseFragment> h() {
        ...
        for (Category.DataBean.InfoBean infoBean : this.f2246g.getInfo()) {
            infoBean.setCategoryId(String.valueOf(this.f2246g.getId()));
            if (this.f2246g.getType().equals(e.a("BQ=="))) {
                arrayList.add(VideoFragment.o(infoBean));
            }
            if (this.f2246g.getType().equals(e.a("BA=="))) {
                arrayList.add(ImageFragment.o(infoBean));
            }
            if (this.f2246g.getType().equals(e.a("Aw=="))) {
    ...
    @Override // com.comeback.data.base.BaseViewPagerFragment
    public String[] i() {
        List<Category.DataBean.InfoBean> info = this.f2246g.getInfo();
