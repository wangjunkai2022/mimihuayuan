...
public class VideoVAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<VideoInfo> f2243c;

    /* renamed from: d  reason: collision with root package name */
    public int f2244d = new Random().nextInt(1000);
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(VideoVAdapter videoVAdapter, View view) {
            ...
            this.f2245c = (TextView) view.findViewById(R.id.tv_intro);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        if (viewHolder instanceof b) {
            b bVar = (b) viewHolder;
            VideoInfo videoInfo = this.f2243c.get(i2);
            h.u0(videoInfo.getVideoImage(), bVar.a);
            bVar.b.setText(videoInfo.getVideoTitle());
            h.m1(bVar.f2245c, videoInfo.getVideoTime());
