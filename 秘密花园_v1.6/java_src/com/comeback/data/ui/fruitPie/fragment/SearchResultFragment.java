...
public class SearchResultFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f767i = getArguments().getString(e.a("QxsTAQ=="));
        this.f768j = getArguments().getString(e.a("WQMOAQ=="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public BaseAbstractAdapter h() {
        return new SearchAdapter(getContext(), this.f767i);
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("VA0NAAIHUFwdFQ=="), this.f768j);
        hashMap.put(f.b.a.a.a.i("Bw==", hashMap, e.a("UQsGCA8="), "QwMRAw4H"), this.f767i);
