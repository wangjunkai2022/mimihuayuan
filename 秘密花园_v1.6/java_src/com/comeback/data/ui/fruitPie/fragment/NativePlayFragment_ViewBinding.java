...
public class NativePlayFragment_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ NativePlayFragment f766c;

        public a(NativePlayFragment_ViewBinding nativePlayFragment_ViewBinding, NativePlayFragment nativePlayFragment) {
            this.f766c = nativePlayFragment;
        }

        @Override // d.c.b
        public void a(View view) {
            NativePlayFragment nativePlayFragment = this.f766c;
            if (TextUtils.isEmpty(nativePlayFragment.f763g)) {
                return;
            }
            PlayActivity.l(nativePlayFragment.getContext(), nativePlayFragment.f763g);
        }
    }
