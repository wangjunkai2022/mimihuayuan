...
public class H5Fragment extends BaseFragment {
    ...
    public static void h(H5Fragment h5Fragment, IdDetail idDetail) {
        if (h5Fragment != null) {
            NativePlayFragment.f762h = idDetail.getData().getFilm_id();
            ...
            if (columnist != null && columnist.size() != 0) {
                ...
                h5Fragment.f747k = false;
                h5Fragment.f748l = columnist2.getColumnist_id();
                h5Fragment.f749m = columnist2.getColumnist_name();
            ...
            if (anchors != null && anchors.size() != 0) {
                ...
                h5Fragment.f747k = true;
                h5Fragment.f748l = authorBean.getAnchors_id();
                h5Fragment.f749m = authorBean.getAnchors_name();
            ...
            for (IdDetail.DataEntity.DetailEntity detailEntity : idDetail.getData().getDetail()) {
                if (detailEntity.getType() == 1 && !TextUtils.isEmpty(detailEntity.getContent())) {
                    ...
                    h5Fragment.f745i = detailEntity.getUrl();
                }
            }
            return;
        }
    ...
    public void a() {
        this.f743g = getArguments().getInt(e.a("XgY="));
        this.f744h = getArguments().getString(e.a("QxsTAQ=="), e.a("Bg=="));
    }
    ...
    public void e() {
        ...
        hashMap.put(f.b.a.a.a.G(this.f743g, hashMap, e.a("WwsBFgoBQGwaAg=="), "WxYaFA4="), this.f744h);
