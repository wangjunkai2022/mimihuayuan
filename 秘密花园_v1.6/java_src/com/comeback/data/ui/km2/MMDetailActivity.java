...
public class MMDetailActivity extends BaseActivity {
    ...
    public class a extends j<MMInfo> {
        ...
        public void f(MMInfo mMInfo) {
            ...
            try {
                ...
                textView2.setText(e.a("0fnXgv3D36TFj6PTl9b5") + h.Q0(Integer.valueOf(info.getCreate_at()).intValue() * 1000));
    ...
    public void c(Intent intent) {
        ...
        this.f1412c = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void e() {
        ...
        try {
            jSONObject.put(e.a("VRAMEAMWVWwaAg=="), this.f1412c);
        } catch (Exception unused) {
        }
