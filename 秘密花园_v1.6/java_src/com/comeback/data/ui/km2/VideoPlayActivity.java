...
public class VideoPlayActivity extends BaseActivity {
    ...
    public void c(Intent intent) {
        this.f1443d = intent.getStringExtra(e.a("XgY="));
        this.f1444e = intent.getBooleanExtra(e.a("WwMNABgQWEMW"), false);
    }
    ...
    @Override // com.comeback.data.base.BaseActivity
    public void e() {
        this.f1442c = h.h(this, this.videoView);
        ...
        this.f1442c.setPlayUri(e.a("XxYXFFFcFkQEERoFGQMHHhkBDAk="));
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(e.a("QQsHAQQsUFc="), this.f1443d);
        ...
        if (g.d(x.P()).b(Km2Video.class, e.a("XgY="), this.f1443d)) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1442c.onConfigurationChanged(configuration);
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        this.f1442c.onDestroy();
        super.onDestroy();
    }
