...
public class Km2LaunchActivity extends BaseActivity {
    ...
    public static String[] f1400h = {e.a("BlNaSllLFwFBXhpVTVk="), e.a("BldTSlpDAB1HUhpRTg==")};
    public b0 b;
    ...
    public ArrayList<f> f1403e = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public g f1405g = new a();
    ...
    public class a implements g {
        ...
        public void c(f fVar, h0 h0Var) {
            if (h0Var.f6533e > 300) {
                if (Km2LaunchActivity.this.f1403e.size() == 1) {
                    Km2LaunchActivity.this.m();
                    return;
                }
                return;
            }
            Iterator<f> it = Km2LaunchActivity.this.f1403e.iterator();
            while (it.hasNext()) {
                it.next().cancel();
            }
            Km2LaunchActivity km2LaunchActivity = Km2LaunchActivity.this;
            if (km2LaunchActivity.f1404f) {
                return;
            }
            km2LaunchActivity.f1404f = true;
            b.f4058g = fVar.S().b.f6863j.replace(e.a("GAMTDUQQVl0VD1NIEQQHDk8="), "");
            Km2LaunchActivity km2LaunchActivity2 = Km2LaunchActivity.this;
            synchronized (km2LaunchActivity2) {
                if (km2LaunchActivity2.f1402d) {
    ...
    public static void l(Km2LaunchActivity km2LaunchActivity) {
        if (km2LaunchActivity != null) {
            int length = f1400h.length;
            String[] strArr = new String[length];
            for (int i2 = 0; i2 < length; i2++) {
                String str = f1400h[i2];
                strArr[i2] = e.a("XxYXFFFcFg==") + str + e.a("DVpTXVI=");
            }
            km2LaunchActivity.f1403e.clear();
            for (int i3 = 0; i3 < length; i3++) {
                ...
                km2LaunchActivity.f1403e.add(a2);
                ((d0) a2).W(km2LaunchActivity.f1405g);
            }
            return;
        }
        throw null;
    ...
    public void c(Intent intent) {
        this.f1402d = intent.getBooleanExtra(e.a("XhEuKQ=="), false);
    }
    ...
    public void onDestroy() {
        ...
        ArrayList<f> arrayList = this.f1403e;
        if (arrayList != null) {
