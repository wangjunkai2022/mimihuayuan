...
public class UserCenterActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1427e = intent.getStringExtra(e.a("XgY="));
        this.f1426d = intent.getStringExtra(e.a("WQMOAQ=="));
    }
    ...
    public void e() {
        ...
        this.tvName.setText(this.f1426d);
        if (g.d(x.P()).f(Km2User.class, e.a("Whc8DQ8="), this.f1427e).size() != 0) {
            t(this.tvFollow);
        }
    }
    ...
    public void p(int i2) {
        ...
        try {
            jSONObject.put(e.a("VRs8DQ8="), this.f1427e);
