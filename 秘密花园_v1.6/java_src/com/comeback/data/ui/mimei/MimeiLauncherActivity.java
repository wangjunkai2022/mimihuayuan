...
public class MimeiLauncherActivity extends BaseActivity {
    ...
    public ArrayList<f> f1752d = new ArrayList<>();
        ...
        public void onCheckedChanged(RadioGroup radioGroup, int i2) {
            switch (i2) {
                case R.id.radio_host1 /* 2131296684 */:
                    d.f3933e = e.a("XxYXFBhJFhwSFl1JAQEbAlYNBxFFEFc=");
                    d.b = e.a("Wgs3HgQLfUI1FVsfCw==");
                    d.f3931c = e.a("XxYXFBhJFhwQCVkOG0QaAE8LAgsPBhdQHQ==");
                    break;
                case R.id.radio_host2 /* 2131296685 */:
                    d.f3933e = e.a("XxYXFBhJFhwSFl1JCwIPHxoHBxFFEFc=");
                    d.b = e.a("Wgs3HgQLfUI1FVsfCw==");
                    d.f3931c = e.a("XxYXFBhJFhwQCVkOG0dSWAdQUVxSRwgHXQBdCx1EDhJGAQ8LHhcXUBwL");
                    break;
                case R.id.radio_host3 /* 2131296686 */:
                    d.f3933e = e.a("XxYXFBhJFhxCUwNRSF5UUgRRTVVcHlBeFg8aBBcH");
                    d.b = e.a("Wgs7Iig7fFwgPn5JNQ==");
                    d.f3931c = e.a("XxYXFBhJFhwQCVkOG0RSXFoLDgECXVpcHg==");
                    break;
                case R.id.radio_novel1 /* 2131296696 */:
                    d.f3932d = e.a("XxYXFBhJFhwVD1cTEQUNRVMYCxUYHlodEAg=");
                    break;
                case R.id.radio_novel2 /* 2131296697 */:
                    d.f3932d = e.a("XxYXFBhJFhwVD1cTEQUNRQZVDg0GFlAdEAlZ");
                    break;
            }
            synchronized (f.e.a.j.f0.j.f.class) {
                f.e.a.j.f0.j.f.b = null;
            }
        }
    }
        ...
        if (mimeiLauncherActivity != null) {
            if (hostBean != null && hostBean.getApi() != null) {
                ...
                while (it.hasNext()) {
                    ...
                    f a2 = mimeiLauncherActivity.f1751c.a(f.b.a.a.a.s("VA4MFw4=", aVar, e.a("dA0NCg4QTVocCA==")));
                    mimeiLauncherActivity.f1752d.add(a2);
            ...
            if (hostBean != null && hostBean.getComic() != null) {
                ...
                while (it2.hasNext()) {
                    ...
                    f a3 = mimeiLauncherActivity.f1751c.a(f.b.a.a.a.s("VA4MFw4=", aVar2, e.a("dA0NCg4QTVocCA==")));
                    mimeiLauncherActivity.f1752d.add(a3);
                    ((d0) a3).W(new f.e.a.j.f0.g(mimeiLauncherActivity, comic));
                }
            }
            ...
            while (it3.hasNext()) {
                ...
                f a4 = mimeiLauncherActivity.f1751c.a(f.b.a.a.a.s("VA4MFw4=", aVar3, e.a("dA0NCg4QTVocCA==")));
                mimeiLauncherActivity.f1752d.add(a4);
    ...
    public void onDestroy() {
        super.onDestroy();
        ArrayList<f> arrayList = this.f1752d;
        if (arrayList != null) {
    ...
    public final void p() {
        ...
        this.f1753e = true;
        Iterator<f> it = this.f1752d.iterator();
        while (it.hasNext()) {
            it.next().cancel();
        }
