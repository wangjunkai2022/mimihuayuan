...
public class SearchResultFragment extends BaseRefreshFragment {
    ...
    public class b extends BaseRefreshFragment.a<NovelHomeType> {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ int f1802f;
    ...
    public void a() {
        this.f1798i = getArguments().getBoolean(e.a("XhEgCwYaWg=="), true);
        this.f1799j = getArguments().getString(e.a("XAca"));
    }
    ...
    public RecyclerView.LayoutManager i() {
        return new GridLayoutManager(getContext(), this.f1798i ? 3 : 2);
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public void l(int i2) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(e.a("XAcaEwQBXUA="), this.f1799j);
