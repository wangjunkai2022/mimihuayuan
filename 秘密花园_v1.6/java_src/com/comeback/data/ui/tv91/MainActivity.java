...
public class MainActivity extends BaseActivity {
    ...
    public NovelFragment f2165c;

    /* renamed from: d  reason: collision with root package name */
    public BottomNavigationView.OnNavigationItemSelectedListener f2166d = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.o0.a
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f2166d);
        j b = j.b();
    ...
    public void onBackPressed() {
        ...
        if (this.viewPager.getCurrentItem() == 3) {
            NovelFragment novelFragment = this.f2165c;
