...
public class SearchActivity extends BaseRefreshActivity {
    ...
    public void e() {
        ...
        this.refreshLayout.a0 = new d() { // from class: f.e.a.j.o0.d
            @Override // f.j.a.a.l.d
            public final void b(i iVar) {
                SearchActivity.this.t(iVar);
            }
        };
        this.refreshLayout.v(new b() { // from class: f.e.a.j.o0.c
        ...
        this.etSearch.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: f.e.a.j.o0.b
    ...
    public void p(int i2) {
        if (TextUtils.isEmpty(this.f2175d)) {
            this.refreshLayout.j(true);
            this.refreshLayout.k();
            return;
        }
        h.c0(this);
        k(f.e.a.j.o0.i.b.a().b(TiktopParam.buildSearchParams(i2, this.f2175d)), new a(i2));
    }
