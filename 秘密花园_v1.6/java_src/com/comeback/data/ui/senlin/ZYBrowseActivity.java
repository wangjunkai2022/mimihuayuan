...
public class ZYBrowseActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_ab /* 2131296741 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwQDBoGCAMCCU0bTQcEHg==");
                break;
            case R.id.rl_ikun /* 2131296744 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwaDUEJAhMCG15MAAsG");
                break;
            case R.id.rl_kd /* 2131296745 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwYE1AOGQRSWxkBDAk=");
                break;
            case R.id.rl_ly /* 2131296746 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwSFl1JGRoKB04YGkoIHFQc");
                break;
            case R.id.rl_lz /* 2131296747 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwQDBoLAgMCG15MAAsG");
                break;
            case R.id.rl_senlin /* 2131296750 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwAClUXEQgFRVQNDg==");
                break;
            case R.id.rl_sky /* 2131296751 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwSFl1JDAMCBVwNDQMKA1AdEAlZ");
                break;
            case R.id.rl_tk /* 2131296754 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwHB1oAExAaRVQNDg==");
                break;
            case R.id.rl_tom /* 2131296755 */:
                SenLinActivity.f1896h = e.a("XxYXFBhJFhwSFl1JDAUOCFYLCQ1FEFZe");
                break;
        }
