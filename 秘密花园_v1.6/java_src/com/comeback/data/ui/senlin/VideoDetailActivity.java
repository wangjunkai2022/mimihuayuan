...
public class VideoDetailActivity extends BaseRefreshActivity implements ChapterAdapter.a {
    ...
    public static void r(VideoDetailActivity videoDetailActivity, SenlinDetail senlinDetail) {
        if (videoDetailActivity != null) {
            if (senlinDetail.getList() != null && senlinDetail.getList().size() != 0) {
                ...
                videoDetailActivity.f1902d = listEntity;
                videoDetailActivity.mTvTitle.setText(listEntity.getVod_name());
                videoDetailActivity.mTvDetail.setText(videoDetailActivity.f1902d.getVod_content());
                h.u0(videoDetailActivity.f1902d.getVod_pic(), videoDetailActivity.mIvBg);
                videoDetailActivity.f114c.a(videoDetailActivity.f1902d.getVod_play_urlList());
                return;
            }
            h.p1(e.a("39fngtHj3YvRg5DW"));
            return;
        }
        throw null;
    }
    ...
    public void c(Intent intent) {
        this.f1903e = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void p(int i2) {
        f.e.a.j.j0.f.a a = b.a();
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(a.i("UwcXBQIf", hashMap, e.a("VgE="), "XgYQ"), this.f1903e);
