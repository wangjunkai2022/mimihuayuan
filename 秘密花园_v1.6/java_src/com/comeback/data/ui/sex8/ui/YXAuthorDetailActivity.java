...
public class YXAuthorDetailActivity extends BaseRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<YXNovelList> {
        ...
        public final /* synthetic */ int f1960f;
    ...
    public void c(Intent intent) {
        this.f1959d = (YXHostBean) intent.getParcelableExtra(e.a("Xw0QECkWWF0="));
    }
    ...
    public void e() {
        j(-1);
        super.e();
        this.tvTitle.setText(this.f1959d.getName());
        this.tvSpecial.setText(this.f1959d.getWorks_count());
        this.tvHot.setText(this.f1959d.getHits_count());
        h.u0(this.f1959d.getImg(), this.ivHeader);
    }
    ...
    public void p(int i2) {
        ...
        yXParams.setHostid(this.f1959d.getHost_id());
        yXParams.setPage(i2);
