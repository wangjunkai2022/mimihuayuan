...
public class YXPlayActivity_ViewBinding implements Unbinder {
    ...
    public class e extends d.c.b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ YXPlayActivity f1986c;

        public e(YXPlayActivity_ViewBinding yXPlayActivity_ViewBinding, YXPlayActivity yXPlayActivity) {
            this.f1986c = yXPlayActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            this.f1986c.onViewClicked(view);
        }
    }
    ...
    public void a() {
        ...
        if (yXPlayActivity != null) {
            ...
            this.f1980f = null;
            this.f1981g.setOnClickListener(null);
            this.f1981g = null;
            return;
        }
