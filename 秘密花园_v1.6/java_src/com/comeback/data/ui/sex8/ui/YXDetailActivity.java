...
public class YXDetailActivity extends BaseRefreshActivity {
    ...
    public static String f1963e;

    /* renamed from: d  reason: collision with root package name */
    public YXNovelDetail.DataBean f1964d;
    @BindView
    ...
    public static void r(YXDetailActivity yXDetailActivity, YXNovelDetail yXNovelDetail) {
        if (yXDetailActivity != null) {
            ...
            yXDetailActivity.f1964d = data;
            yXDetailActivity.tvName.setText(data.getName());
            yXDetailActivity.tvTitle.setText(yXDetailActivity.f1964d.getName());
            h.u0(yXDetailActivity.f1964d.getCover_img(), yXDetailActivity.ivPic);
            TextView textView = yXDetailActivity.tvDetail;
            textView.setText(yXDetailActivity.f1964d.getRadio_count() + "    " + yXDetailActivity.f1964d.getRadio_count() + e.a("3vnl"));
            YXHostBean host = yXDetailActivity.f1964d.getHost();
            ...
            yXDetailActivity.f114c.a(yXDetailActivity.f1964d.getRadio_list());
            return;
        }
        throw null;
    }
    ...
    public void c(Intent intent) {
        f1963e = intent.getStringExtra(e.a("Vg4BEQYsUFc="));
    }
