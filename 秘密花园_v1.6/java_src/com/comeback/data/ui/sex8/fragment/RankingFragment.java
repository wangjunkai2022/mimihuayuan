...
public class RankingFragment extends BaseFragment {
    ...
    public ArrayList<BaseFragment> f1951g;

    /* renamed from: h  reason: collision with root package name */
    public RadioGroup.OnCheckedChangeListener f1952h = new a();
    @BindView
    ...
    public void f() {
        ...
        this.f1951g.add(RankListFragment.o(e.a("Xw0X")));
        this.f1951g.add(RankListFragment.o(e.a("WQcU")));
        this.f1951g.add(new RankHostFragment());
        f.b.a.a.a.D(this.f1951g, -1, this.viewPager);
        this.viewPager.setAdapter(new BaseViewPagerAdapter(getChildFragmentManager(), null, this.f1951g));
        this.viewPager.setScrollable(false);
        this.rgTab.setOnCheckedChangeListener(this.f1952h);
    }
}
