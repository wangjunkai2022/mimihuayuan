...
import f.e.a.j.t.d.b;
import f.e.a.j.t.d.c;
...
public class ShortVideoAdapter extends BaseAbstractAdapter<VideoInfo> {
    ...
    public static class TiktopHolder extends BaseViewHolder<VideoInfo> {
        ...
        public ExoUserPlayer f1221c;

        /* renamed from: d  reason: collision with root package name */
        public Runnable f1222d;
        @BindView
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                ExoUserPlayer exoUserPlayer = tiktopHolder.f1221c;
                if (exoUserPlayer == null || tiktopHolder.mSeekBar == null || !exoUserPlayer.isPlaying()) {
                    return;
                }
                long currentPosition = TiktopHolder.this.f1221c.getCurrentPosition();
                TiktopHolder tiktopHolder2 = TiktopHolder.this;
                tiktopHolder2.mSeekBar.setProgress((int) ((currentPosition * 1000) / tiktopHolder2.f1221c.getDuration()));
                if (TiktopHolder.this.f1221c.isPlaying()) {
                    TiktopHolder tiktopHolder3 = TiktopHolder.this;
                    tiktopHolder3.mSeekBar.postDelayed(tiktopHolder3.f1222d, 300L);
                }
            }
        }
        ...
        public void a(VideoInfo videoInfo) {
            ...
            this.f1221c.setPlayUri(videoInfo2.getVideoNone());
            ...
            h.F0(videoInfo2.getImg(), this.f1221c.getVideoPlayerView().getPreviewImage(), 1);
            ...
            this.mIvPlay.setOnClickListener(new View.OnClickListener() { // from class: f.e.a.j.t.d.a
            ...
            this.f1221c.addVideoInfoListener(new c(this));
        }

        public /* synthetic */ void b(View view) {
            if (this.f1221c.isPlaying()) {
                this.f1221c.onPause();
            } else {
                c();
            }
        ...
        public final void c() {
            ExoUserPlayer exoUserPlayer = this.f1221c;
            if (exoUserPlayer == null) {
                return;
            }
            if (exoUserPlayer.getCurrentPosition() <= 500) {
                if (TextUtils.isEmpty(this.b.getVideoLink())) {
                    e<VideoInfo> a2 = d.a().a(f.e.a.j.t.e.b.e(this.b.getId()));
                    a2.d(m.r.a.a()).b(m.l.b.a.a()).c(new f.e.a.j.t.d.d(this));
                    return;
                }
                this.f1221c.startPlayer();
                return;
            }
            this.f1221c.onResume();
        }
    }
    ...
    public class TiktopHolder_ViewBinding implements Unbinder {
        ...
        public class a extends d.c.b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ TiktopHolder f1224c;

            public a(TiktopHolder_ViewBinding tiktopHolder_ViewBinding, TiktopHolder tiktopHolder) {
                this.f1224c = tiktopHolder;
            }

            @Override // d.c.b
            public void a(View view) {
                TiktopHolder tiktopHolder = this.f1224c;
