...
public class UserCenterActivity extends BaseActivity {
    ...
    public void c(Intent intent) {
        ...
        this.f1215c = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1216d = intent.getStringExtra(e.a("XwcCACIeWFQW"));
    }
    ...
    public void e() {
        ...
        h.E0(this.f1216d, this.ivHeader);
        this.tvName.setText(this.f1215c);
