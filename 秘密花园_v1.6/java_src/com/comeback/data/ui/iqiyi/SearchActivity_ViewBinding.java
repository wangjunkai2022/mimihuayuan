...
public class SearchActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ SearchActivity f1214c;

        public a(SearchActivity_ViewBinding searchActivity_ViewBinding, SearchActivity searchActivity) {
            this.f1214c = searchActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            this.f1214c.etSearch.setText("");
        }
    }
    ...
    public void a() {
        SearchActivity searchActivity = this.f1212c;
