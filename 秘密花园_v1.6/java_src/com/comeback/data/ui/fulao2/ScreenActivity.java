...
public class ScreenActivity extends BaseRefreshActivity {
    ...
    public TabLayout.OnTabSelectedListener f791f = new a();
    @BindView
    ...
    public void c(Intent intent) {
        this.f789d = intent.getIntExtra(e.a("XgwHARM="), 0);
        this.f790e = intent.getStringExtra(e.a("QxsTAQ=="));
    }
    ...
    public void e() {
        ...
        this.tab1.addOnTabSelectedListener(this.f791f);
        this.tab2.addOnTabSelectedListener(this.f791f);
        super.e();
        String str = "";
        if (this.f790e.equals(e.a("QgwACx0WSw=="))) {
            int i2 = this.f789d;
            if (i2 == 0) {
                str = e.a("0f7jgv3D");
            } else if (i2 == 17) {
    ...
    public void p(int i2) {
        ...
        hashMap.put(e.a("QxsTAQ=="), this.f790e);
