...
public class SearchResultFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f854i = getArguments().getString(e.a("QxsTAQ=="));
        this.f855j = getArguments().getString(e.a("WQMOAQ=="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public BaseAbstractAdapter h() {
        return new VideoListAdapter(getContext(), this.f854i.equals(e.a("QQcREAIQWF8=")));
    }
    ...
    public void l(int i2) {
        b b = f.b();
        String str = this.f854i;
        String str2 = this.f855j;
