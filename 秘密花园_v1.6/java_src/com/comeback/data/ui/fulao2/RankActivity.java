...
public class RankActivity extends BaseActivity {
    ...
    public String[] f784c = {e.a("0f7Pgfrb3L7yg5DAnvzTjL7l"), e.a("0f7Pgfrb3L7yg5DAnv3DjJfj"), e.a("0f7Pgfrb3L7yg5DAnvbqjJfj"), e.a("0f7Pgfrb3L7yg5DAnc/Qj4v6")};

    /* renamed from: d  reason: collision with root package name */
    public String[] f785d = {e.a("WQcU"), e.a("QgwACx0WSw=="), e.a("VA0VARk="), e.a("VgEXCxk=")};

    /* renamed from: e  reason: collision with root package name */
    public int[] f786e = {R.drawable.bg_ranking_item_three, R.drawable.bg_ranking_item_one, R.drawable.bg_ranking_item_two, R.drawable.bg_ranking_item_four};
    @BindView
    ...
    public void e() {
        i();
        this.ivCover.setImageResource(this.f786e[this.b]);
        this.tvTitle.setText(this.f784c[this.b]);
        if (this.b != 3) {
            k(f.b().e(l()), new a());
        } else {
            k(f.b().c(l()), new b());
    ...
    public final HashMap<String, String> l() {
        ...
        hashMap.put(e.a("QxsTAQ=="), this.f785d[this.b]);
