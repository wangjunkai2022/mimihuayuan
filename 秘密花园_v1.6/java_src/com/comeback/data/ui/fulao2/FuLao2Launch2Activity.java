...
public class FuLao2Launch2Activity extends BaseActivity {
    ...
    public static void l(FuLao2Launch2Activity fuLao2Launch2Activity) {
        ...
        if (fuLao2Launch2Activity != null) {
            ...
            a0.a aVar = new a0.a();
            aVar.d(a0.f6441h);
            aVar.a(e.a("XwMQDA=="), fuLao2Launch2Activity.f780e);
            ...
            String str2 = fuLao2Launch2Activity.f781f;
            if (str2 != null && !str2.isEmpty()) {
                for (String str3 : fuLao2Launch2Activity.f781f.split(e.a("EQ=="))) {
            ...
            fuLao2Launch2Activity.k(b.g(str, hashMap, c2), new f.e.a.j.l.f(fuLao2Launch2Activity));
            return;
        }
        throw null;
    }
    ...
    public void e() {
        ...
        this.f778c = random.nextInt(255) + e.a("GQ==") + random.nextInt(255) + e.a("GQ==") + random.nextInt(255) + e.a("GQ==") + random.nextInt(255);
        this.webView.setWebViewClient(new d(this));
        this.webView.setWebChromeClient(new f.e.a.j.l.e(this));
        ...
        this.f779d = hashMap;
        hashMap.put(e.a("T08FCxkEWEEXA1BKHgUR"), this.f778c);
        this.webView.loadUrl(f.e.a.k.b.a, this.f779d);
