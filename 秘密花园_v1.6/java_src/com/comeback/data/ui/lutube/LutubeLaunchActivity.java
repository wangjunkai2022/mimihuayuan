...
public class LutubeLaunchActivity extends BaseActivity {
    ...
    public static void l(LutubeLaunchActivity lutubeLaunchActivity, HostInfo hostInfo) {
        lutubeLaunchActivity.f1476c = true;
    ...
    public static /* synthetic */ int m(LutubeLaunchActivity lutubeLaunchActivity) {
        int i2 = lutubeLaunchActivity.f1477d;
        lutubeLaunchActivity.f1477d = i2 + 1;
        return i2;
    }

    public static void n(final LutubeLaunchActivity lutubeLaunchActivity) {
        if (lutubeLaunchActivity.f1477d < 3) {
            return;
        }
        synchronized (d.class) {
            d.b = null;
        }
        lutubeLaunchActivity.getWindow().getDecorView().postDelayed(new Runnable() { // from class: f.e.a.j.b0.a
    ...
    public void e() {
        ...
        e<HostInfo> d2 = d.a().d();
        e<HostInfo> e2 = d.a().e();
        f.e.a.j.b0.d dVar = new f.e.a.j.b0.d(this);
        f.e.a.j.b0.e eVar = new f.e.a.j.b0.e(this);
        f fVar = new f(this);
        k(j2, dVar);
        k(d2, eVar);
        k(e2, fVar);
