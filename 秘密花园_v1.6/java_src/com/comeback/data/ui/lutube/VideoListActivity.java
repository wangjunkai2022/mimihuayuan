...
public class VideoListActivity extends BaseViewPagerActivity {
    ...
    public void c(Intent intent) {
        ...
        this.f1484c = intent.getIntExtra(e.a("XgY="), 0);
        this.f1485d = intent.getBooleanExtra(e.a("XhEiEg=="), true);
    }
    ...
    public ArrayList<BaseFragment> l() {
        ...
        arrayList.add(VideoList2Fragment.o(this.f1484c, this.f1485d ? e.a("Ww0NAw==") : e.a("RAoMFh8="), e.a("QwsOAQ==")));
        arrayList.add(VideoList2Fragment.o(this.f1484c, this.f1485d ? e.a("Ww0NAw==") : e.a("RAoMFh8="), e.a("QQsGExg=")));
        return arrayList;
    }
