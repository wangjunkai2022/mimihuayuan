...
public class VideoListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1522i = getArguments().getInt(e.a("XgY="), 0);
        this.f1523j = getArguments().getString(e.a("QxsTAQ=="));
    }
    ...
    public RecyclerView.LayoutManager i() {
        if (this.f1523j.equals(e.a("RAoMFh8="))) {
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("QQsHAQQsTUoDAw=="), this.f1523j);
