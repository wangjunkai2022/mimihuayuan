...
public class VideoList2Fragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1513i = getArguments().getInt(e.a("XgY="), 0);
        this.f1514j = getArguments().getString(e.a("QxsTAQ=="));
        this.f1515k = getArguments().getString(e.a("WBAHARk="));
    }
    ...
    public void l(int i2) {
        ...
        hashMap.put(e.a("WBAHARk="), this.f1515k);
        hashMap.put(f.b.a.a.a.G(this.f1513i, hashMap, e.a("VAMXAQwcS0o="), "QQsHAQQsTUoDAw=="), this.f1514j);
