...
public class VideoList3Fragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1518i = getArguments().getString(e.a("QxsTAQ=="));
        this.f1519j = getArguments().getString(e.a("WQMOAQ=="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public BaseAbstractAdapter h() {
        return new VideoListAdapter(getContext(), this.f1518i.equals(e.a("Ww0NAw==")));
    }
