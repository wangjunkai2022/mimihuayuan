...
public class ActorFragment extends BaseRefreshFragment {
    ...
    public String[] f1503i = {"", e.a("dg=="), e.a("dQ=="), e.a("dA=="), e.a("cw=="), e.a("cg=="), e.a("cQ=="), e.a("cA==")};

    /* renamed from: j  reason: collision with root package name */
    public TabLayout.OnTabSelectedListener f1504j = new a();
    @BindView
    ...
    public void f() {
        ...
        this.tab1.addOnTabSelectedListener(this.f1504j);
        this.tab2.addOnTabSelectedListener(this.f1504j);
        super.f();
    }
    ...
    public void l(int i2) {
        f.e.a.j.b0.k.b a2 = d.a();
        HashMap hashMap = new HashMap();
        int selectedTabPosition = this.tab1.getSelectedTabPosition();
        int selectedTabPosition2 = this.tab2.getSelectedTabPosition();
        hashMap.put(f.b.a.a.a.i(selectedTabPosition == 0 ? "QQsGExg=" : "QQEMEQUH", hashMap, e.a("WBAHARk="), "VBcT"), this.f1503i[selectedTabPosition2]);
