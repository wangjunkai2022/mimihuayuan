...
public class MineFragment extends BaseFragment {
    ...
    public RadioGroup.OnCheckedChangeListener f1512k = new RadioGroup.OnCheckedChangeListener() { // from class: f.e.a.j.b0.j.b
    ...
    @Override // com.comeback.data.base.BaseFragment
    public void f() {
        this.f1508g = MineFragment.class.getName();
        int c2 = j.b().c(this.f1508g);
        if (c2 == -1) {
            c2 = 0;
        }
        this.f1509h = c2 % 10;
        this.f1510i = (c2 / 10) % 10;
        this.f1511j = (c2 / 100) % 10;
    }
    ...
    public /* synthetic */ void i() {
        ...
        this.radioGroupHost.setOnCheckedChangeListener(this.f1512k);
        this.radioGroupPlay.setOnCheckedChangeListener(this.f1512k);
        this.radioGroupImage.setOnCheckedChangeListener(this.f1512k);
    }

    public final void j() {
        j.b().g(this.f1508g, (this.f1511j * 100) + (this.f1510i * 10) + this.f1509h);
