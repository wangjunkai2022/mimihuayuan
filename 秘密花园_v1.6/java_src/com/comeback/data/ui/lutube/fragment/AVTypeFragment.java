...
public class AVTypeFragment extends BaseFragment {
    ...
    public VideoTypeAdapter f1500g;
    ...
    public class a extends j<VideoType> {
        ...
        public void f(VideoType videoType) {
            AVTypeFragment.this.f1500g.a(videoType.getResponse().getCategories());
        }
    }
    ...
    public void a() {
        this.f1501h = getArguments().getBoolean(e.a("XhEiEg=="));
    }
    ...
    public void f() {
        ...
        VideoTypeAdapter videoTypeAdapter = new VideoTypeAdapter(getContext(), this.f1501h);
        this.f1500g = videoTypeAdapter;
