...
public class ActorDetailActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public ActorDetailActivity f1473c;
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ ActorDetailActivity f1475c;

        public a(ActorDetailActivity_ViewBinding actorDetailActivity_ViewBinding, ActorDetailActivity actorDetailActivity) {
            this.f1475c = actorDetailActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            ActorDetailActivity actorDetailActivity = this.f1475c;
            g.d(actorDetailActivity.f1470d.getRealm()).a(actorDetailActivity.f1470d);
    ...
    public ActorDetailActivity_ViewBinding(ActorDetailActivity actorDetailActivity, View view) {
        ...
        this.f1473c = actorDetailActivity;
    ...
    public void a() {
        ActorDetailActivity actorDetailActivity = this.f1473c;
