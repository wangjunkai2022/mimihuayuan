...
public class VideoListAdapter extends BaseAbstractAdapter<LVideosBean> {
    ...
    public static class Holder extends BaseViewHolder<LVideosBean> {
        ...
        public void a(LVideosBean lVideosBean) {
            ...
            this.b = lVideosBean2;
            if (this.a.f1492d) {
                h.K0(lVideosBean2.getThumb(), this.imageCover);
            } else {
                h.K0(lVideosBean2.getCover(), this.imageCover);
            }
            h.m1(this.textMainTag, lVideosBean2.getMain_tagString());
            ...
            h.m1(this.textDate, lVideosBean2.getTime());
            h.m1(this.textActor, lVideosBean2.getActor());
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends d.c.b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1495c;
        ...
        public class b extends d.c.b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1496c;
    ...
    public BaseViewHolder f(@NonNull ViewGroup viewGroup) {
        return new Holder(this.f107c.inflate(this.f1492d ? R.layout.item_lutube_video2 : R.layout.item_lutube_video, viewGroup, false), this);
    }
