...
public class HomeFragment extends BaseVRefreshFragment {
    ...
    public class a extends BaseRefreshFragment.a<HomeData> {
        ...
        public void f(Object obj) {
            ...
            homeFragment.f2334j = homeData;
            homeFragment.f120i.b(new Banner2Adapter(homeFragment.getContext(), new i(), homeData.getData().getV2sliderows(), new AdPagerAdapter.a() { // from class: f.e.a.j.s0.f.a
