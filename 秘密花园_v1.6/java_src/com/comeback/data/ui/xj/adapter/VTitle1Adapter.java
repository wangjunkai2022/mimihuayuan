...
public class VTitle1Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public Channel.DataBean.RowsBean f2329c;
    ...
    public /* synthetic */ void d(View view) {
        SpecialDetailActivity.w(this.a, this.f2329c);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        aVar.a.setText(this.f2329c.getSpname());
        aVar.b.setText(this.f2329c.getItemcount());
