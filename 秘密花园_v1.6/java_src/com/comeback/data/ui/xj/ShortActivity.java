...
public class ShortActivity extends BaseActivity {
    ...
    public ShortVideoAdapter f2288d;
    @BindView
    ...
    public class a extends PagerSnapHelper {
        ...
        public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i2, int i3) {
            ...
            ShortActivity.this.f2288d.f2303d = findTargetSnapPosition;
    ...
    public void c(Intent intent) {
        ...
        this.f2287c = intent.getIntExtra(e.a("XgwHARM="), 0);
    }
    ...
    public void e() {
        ...
        this.f2288d = shortVideoAdapter;
        shortVideoAdapter.f2303d = this.f2287c;
        this.mRvList.setAdapter(shortVideoAdapter);
        this.f2288d.a(this.b);
        linearLayoutManager.scrollToPosition(this.f2287c);
    }
