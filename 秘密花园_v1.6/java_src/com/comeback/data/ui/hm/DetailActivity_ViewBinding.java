...
public class DetailActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ DetailActivity f1113c;

        public a(DetailActivity_ViewBinding detailActivity_ViewBinding, DetailActivity detailActivity) {
            this.f1113c = detailActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            DetailActivity detailActivity = this.f1113c;
            if (detailActivity.f1110f) {
                h.p1(e.a("0u31gt3736fFjqPo"));
                detailActivity.t(false);
                g d2 = g.d(x.P());
                String a = e.a("XgY=");
                String id = detailActivity.f1109e.getId();
                if (d2 != null) {
                    x xVar = g.a;
                    xVar.f();
            ...
            g.d(x.P()).a(detailActivity.f1109e);
        }
    }
    ...
    public void a() {
        DetailActivity detailActivity = this.f1111c;
