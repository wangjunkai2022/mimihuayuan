...
public class DetailActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1109e = (ItemInfo) intent.getParcelableExtra(e.a("XgwFCw=="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.u0(this.f1109e.getImage(), this.ivImg);
        this.tvTitle.setText(this.f1109e.getTitle());
        this.tvAuthor.setText(this.f1109e.getAuthor());
        this.tvUpdate.setText(this.f1109e.getUpdate());
        this.tvDesc.setText(this.f1109e.getDesc());
        t(g.d(x.P()).f(ItemInfo.class, e.a("XgY="), this.f1109e.getId()).size() != 0);
    }
    ...
    public void p(int i2) {
        f.e.a.j.i0.a a2 = c.a();
        boolean isHm = this.f1109e.isHm();
        String id = this.f1109e.getId();
