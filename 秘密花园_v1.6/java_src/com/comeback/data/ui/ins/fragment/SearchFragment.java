...
public class SearchFragment extends BaseRefreshFragment {
    ...
    public void l(int i2) {
        if (TextUtils.isEmpty(this.f1187i)) {
    ...
    public final HashMap<String, String> o(int i2) {
        ...
        hashMap.put(f.b.a.a.a.G(!this.f1188j ? 1 : 0, hashMap, f.b.a.a.a.i("VhEA", hashMap, f.b.a.a.a.G(20, hashMap, f.b.a.a.a.G(i2, hashMap, f.e.a.e.a("RwMEAQ=="), "RAsZAQ=="), "RA0REA=="), "QxsTAQ=="), "VA0NEA4dTQ=="), this.f1187i);
        return hashMap;
    }
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id != R.id.tv_image) {
            if (id == R.id.tv_video && this.f1188j) {
                this.f1188j = false;
