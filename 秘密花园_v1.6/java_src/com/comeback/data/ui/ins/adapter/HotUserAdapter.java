...
public class HotUserAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<HotUser.DataEntity.ResultListEntity> f1167c;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        HotUser.DataEntity.ResultListEntity resultListEntity = this.f1167c.get(i2);
        bVar.b.setText(resultListEntity.getUsername());
        h.I0(resultListEntity.getHeadImgUrl(), bVar.a);
