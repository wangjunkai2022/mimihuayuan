...
public class InsLaunchActivity extends BaseActivity {
    ...
    public class a extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            webView.loadUrl(str, InsLaunchActivity.this.f1151c);
            return true;
        }
        ...
        public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
            ...
            if (webResourceRequest.getUrl().toString().contains(e.a("GAMTFEQGSlYB"))) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    f.e.a.k.b.v0 = str;
                    e.a("aD08OwIdSg==");
                    String str2 = f.e.a.k.b.v0;
                    f.b();
                    InsLaunchActivity.this.runOnUiThread(new Runnable() { // from class: f.e.a.j.s.b
    ...
    public class b extends WebChromeClient {
        ...
        /* renamed from: c  reason: collision with root package name */
        public IX5WebChromeClient.CustomViewCallback f1152c;
        ...
        public void onHideCustomView() {
            IX5WebChromeClient.CustomViewCallback customViewCallback = this.f1152c;
        ...
        public void onShowCustomView(View view, IX5WebChromeClient.CustomViewCallback customViewCallback) {
            ...
            this.a = view;
            this.b = webView;
            this.f1152c = customViewCallback;
        }
    }
    ...
    public void e() {
        j(-1);
        k(f.e.a.j.s.e.b.a().e(), new c(this));
        n();
    }
    ...
    public final void n() {
        ...
        this.webView.loadUrl(f.e.a.k.b.s0, this.f1151c);
    ...
    public void onDestroy() {
        super.onDestroy();
        synchronized (f.e.a.j.s.e.b.class) {
            f.e.a.j.s.e.b.b = null;
        }
