...
public class UserCenterActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public UserCenterActivity f1162c;
    ...
    public void a() {
        UserCenterActivity userCenterActivity = this.f1162c;
