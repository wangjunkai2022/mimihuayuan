...
public class CgReadActivity extends BaseActivity {
    ...
    public class a extends j<ComicRead> {
        ...
        public void f(ComicRead comicRead) {
            ...
            PicAdapter picAdapter = cgReadActivity.f921c;
            if (picAdapter == null) {
                cgReadActivity.f921c = new PicAdapter(cgReadActivity);
                ...
                cgReadActivity3.rvList.setAdapter(cgReadActivity3.f921c);
                return;
            }
            picAdapter.c();
        }
