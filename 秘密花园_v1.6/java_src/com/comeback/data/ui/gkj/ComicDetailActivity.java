...
public class ComicDetailActivity extends BaseActivity implements ComicDetailAdapter.a {
    ...
    public ComicDetailAdapter f925e;

    /* renamed from: f  reason: collision with root package name */
    public ComicDetailAdapter f926f;

    /* renamed from: g  reason: collision with root package name */
    public List<ComicDetail.DataEntity.ChaptersEntity> f927g;

    /* renamed from: h  reason: collision with root package name */
    public List<ComicDetail.DataEntity.ChaptersEntity> f928h;
    @BindView
    ...
    public class a extends j<ComicDetail> {
        ...
        public void f(ComicDetail comicDetail) {
            ...
            if (comicDetailActivity != null) {
                comicDetailActivity.f928h = new ArrayList();
                comicDetailActivity.f927g = new ArrayList();
                for (int i2 = 0; i2 < chapters.size() && i2 < 5; i2++) {
                    comicDetailActivity.f928h.add(chapters.get(i2));
                }
                for (int i3 = 0; i3 < chapters.size() && i3 < 5; i3++) {
                    comicDetailActivity.f927g.add(chapters.get((chapters.size() - i3) - 1));
                }
                ComicDetailActivity comicDetailActivity2 = ComicDetailActivity.this;
                comicDetailActivity2.f926f = new ComicDetailAdapter(comicDetailActivity2);
                ...
                comicDetailActivity4.rvList.setAdapter(comicDetailActivity4.f926f);
                ComicDetailActivity comicDetailActivity5 = ComicDetailActivity.this;
                comicDetailActivity5.f925e = new ComicDetailAdapter(comicDetailActivity5);
                ...
                comicDetailActivity7.rvList2.setAdapter(comicDetailActivity7.f925e);
                ComicDetailActivity comicDetailActivity8 = ComicDetailActivity.this;
                comicDetailActivity8.f926f.a(comicDetailActivity8.f928h);
                ComicDetailAdapter comicDetailAdapter = ComicDetailActivity.this.f925e;
                comicDetailAdapter.b(chapters, comicDetailAdapter.b.size());
                ComicDetailActivity comicDetailActivity9 = ComicDetailActivity.this;
                comicDetailActivity9.f926f.f1012d = comicDetailActivity9;
                comicDetailActivity9.f925e.f1012d = comicDetailActivity9;
                return;
            }
            throw null;
        }
    ...
    public final void m() {
        this.tvOrder.setTextColor(this.f923c ? this.kmColorAccent : this.primary_text);
        this.tvReverse.setTextColor(this.f923c ? this.primary_text : this.kmColorAccent);
    }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_order /* 2131297011 */:
                if (this.f923c || (comicDetailAdapter = this.f926f) == null || this.f925e == null) {
                    return;
                }
                comicDetailAdapter.c();
                this.f926f.a(this.f928h);
                this.f923c = true;
                m();
                return;
            case R.id.tv_reverse /* 2131297029 */:
                if (!this.f923c || (comicDetailAdapter2 = this.f926f) == null || this.f925e == null) {
                    return;
                }
                this.f923c = false;
                comicDetailAdapter2.c();
                this.f926f.a(this.f927g);
                m();
                return;
            default:
                return;
