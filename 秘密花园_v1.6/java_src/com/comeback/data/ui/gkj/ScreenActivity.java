...
public class ScreenActivity extends BaseRefreshActivity {
    ...
    public TagAdapter f961d;

    /* renamed from: e  reason: collision with root package name */
    public Tag2Adapter f962e;

    /* renamed from: f  reason: collision with root package name */
    public Tag3Adapter f963f;

    /* renamed from: g  reason: collision with root package name */
    public Tag3Adapter f964g;

    /* renamed from: h  reason: collision with root package name */
    public Tag3Adapter f965h;
    @BindView
    ...
    public class a extends j<ScreenBean> {
        ...
        public void f(ScreenBean screenBean) {
            ...
            screenActivity.f961d = tagAdapter;
            screenActivity.rvList1.setAdapter(tagAdapter);
            screenActivity.f961d.a(screenBean2.getType());
            ...
            screenActivity.f962e = tag2Adapter;
            screenActivity.rvList2.setAdapter(tag2Adapter);
            screenActivity.f962e.a(screenBean2.getType().get(0).getChildren());
            ...
            screenActivity.f963f = tag3Adapter;
            screenActivity.rvList3.setAdapter(tag3Adapter);
            screenActivity.f963f.a(screenBean2.getState());
            ...
            screenActivity.f964g = tag3Adapter2;
            screenActivity.rvList4.setAdapter(tag3Adapter2);
            screenActivity.f964g.a(screenBean2.getPay());
            ...
            screenActivity.f965h = tag3Adapter3;
            screenActivity.rvList5.setAdapter(tag3Adapter3);
            screenActivity.f965h.a(screenBean2.getSort());
    ...
    public void p(int i2) {
        c b2 = e.b();
        TagAdapter tagAdapter = this.f961d;
        String key = ((ScreenBean.TypeBean) tagAdapter.b.get(tagAdapter.f1045d)).getKey();
        Tag2Adapter tag2Adapter = this.f962e;
        int id = ((ScreenBean.TypeBean.ChildrenBean) tag2Adapter.b.get(tag2Adapter.f1037d)).getId();
        String f2 = this.f963f.f();
        String f3 = this.f964g.f();
        String f4 = this.f965h.f();
    ...
    public void u(int i2) {
        this.f962e.c();
        this.f962e.a(((ScreenBean.TypeBean) this.f961d.b.get(i2)).getChildren());
