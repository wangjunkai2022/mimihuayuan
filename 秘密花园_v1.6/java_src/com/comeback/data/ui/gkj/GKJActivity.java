...
public class GKJActivity extends BaseActivity {
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener f954c = new BottomNavigationView.OnNavigationItemSelectedListener() { // from class: f.e.a.j.n.b
    ...
    public void e() {
        ...
        this.navigation.setOnNavigationItemSelectedListener(this.f954c);
    }
