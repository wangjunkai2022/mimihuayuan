...
public class NVideo3Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<NavBean.DataEntity.ArticleVOSEntity> f1026c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        /* renamed from: c  reason: collision with root package name */
        public TextView f1027c;

        /* renamed from: d  reason: collision with root package name */
        public TextView f1028d;

        public b(NVideo3Adapter nVideo3Adapter, View view) {
            super(view);
            this.a = (ImageView) view.findViewById(R.id.iv_cover);
            this.b = (TextView) view.findViewById(R.id.tv_title);
            this.f1027c = (TextView) view.findViewById(R.id.tv_intro);
            this.f1028d = (TextView) view.findViewById(R.id.tv_duration);
        }
    }

    public NVideo3Adapter(Context context, List<NavBean.DataEntity.ArticleVOSEntity> list, f.a.a.a.a aVar) {
        this.a = context;
        this.f1026c = list;
        this.b = aVar;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        NavBean.DataEntity.ArticleVOSEntity articleVOSEntity = this.f1026c.get(i2);
        h.u0(articleVOSEntity.getCover(), bVar.a);
        bVar.f1027c.setText(articleVOSEntity.getInfo());
        bVar.f1027c.setVisibility(8);
        try {
            bVar.f1028d.setText(h.h1(Integer.valueOf(articleVOSEntity.getVideoTime()).intValue()));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
        return new b(this, f.b.a.a.a.b(viewGroup, R.layout.item_gkj_video2, viewGroup, false));
    }
}
