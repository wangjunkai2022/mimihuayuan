...
public class Title2Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public NavBean.DataEntity f1049c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            SpecialActivity.v(title2Adapter.a, title2Adapter.f1049c.getId(), Title2Adapter.this.f1049c.getSpecialName(), Title2Adapter.this.f1049c.getType(), Title2Adapter.this.f1049c.getStyle());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        bVar.a.setText(this.f1049c.getSpecialName());
        bVar.b.setText(this.f1049c.getTotalText());
