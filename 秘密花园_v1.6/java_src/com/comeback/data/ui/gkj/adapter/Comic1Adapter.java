...
public class Comic1Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<ViewModel.DataBean.MComicDataBean> f988c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(Comic1Adapter comic1Adapter, View view) {
            ...
            this.f989c = (TextView) view.findViewById(R.id.tv_intro);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        ViewModel.DataBean.MComicDataBean mComicDataBean = this.f988c.get(i2);
        h.D0(mComicDataBean.getCover_url(), bVar.a, 20);
        bVar.f989c.setText(mComicDataBean.getIntro());
