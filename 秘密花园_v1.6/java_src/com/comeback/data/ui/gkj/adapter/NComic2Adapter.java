...
public class NComic2Adapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    public Context a;
    public f.a.a.a.a b;

    /* renamed from: c  reason: collision with root package name */
    public List<NavBean.DataEntity.ArticleVOSEntity> f1019c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ComicDetailActivity.o(NComic2Adapter.this.a, this.a);
        }
    }
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(NComic2Adapter nComic2Adapter, View view) {
            super(view);
            this.a = (ImageView) view.findViewById(R.id.iv_cover);
            this.b = (TextView) view.findViewById(R.id.tv_title);
            this.f1020c = (TextView) view.findViewById(R.id.tv_intro);
        }
    }

    public NComic2Adapter(Context context, List<NavBean.DataEntity.ArticleVOSEntity> list, f.a.a.a.a aVar) {
        this.a = context;
        this.f1019c = list;
        this.b = aVar;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        NavBean.DataEntity.ArticleVOSEntity articleVOSEntity = this.f1019c.get(i2);
        h.u0(articleVOSEntity.getCoverH(), bVar.a);
        bVar.f1020c.setText(articleVOSEntity.getInfo());
