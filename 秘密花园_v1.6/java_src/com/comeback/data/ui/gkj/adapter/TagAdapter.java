...
public class TagAdapter extends BaseAbstractAdapter<ScreenBean.TypeBean> {
    ...
    public static class Holder extends BaseViewHolder<ScreenBean.TypeBean> {
        ...
        public void a(ScreenBean.TypeBean typeBean) {
            ...
            textView.setBackground(adapterPosition == tagAdapter.f1045d ? tagAdapter.a.getDrawable(R.drawable.bg_radius_red_stroke) : null);
            this.tvTag.setTextColor(getAdapterPosition() == this.a.f1045d ? Color.parseColor(e.a("FAQFUF9HDQ==")) : this.thirdText);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1048c;
            ...
            public void a(View view) {
                Holder holder = this.f1048c;
                int adapterPosition = holder.getAdapterPosition();
                TagAdapter tagAdapter = holder.a;
                int i2 = tagAdapter.f1045d;
                tagAdapter.f1045d = adapterPosition;
                tagAdapter.notifyItemChanged(i2);
                holder.a.notifyItemChanged(adapterPosition);
                holder.a.f1046e.a(adapterPosition);
            }
        }
