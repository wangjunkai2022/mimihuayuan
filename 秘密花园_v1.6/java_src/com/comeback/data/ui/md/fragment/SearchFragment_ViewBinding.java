...
public class SearchFragment_ViewBinding extends BaseRefreshFragment_ViewBinding {
    ...
    public void a() {
        SearchFragment searchFragment = this.f1728c;
