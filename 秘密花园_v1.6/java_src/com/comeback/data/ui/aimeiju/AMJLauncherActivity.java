    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            if (g0Var.a.f6533e < 300) {
                try {
                    b.f4056e = ((BaseUrlBean) new j().d(g0Var.b.H(), BaseUrlBean.class)).getData().getBaseUrl().replace(e.a("GAsNAA4LF0MbFhsGCBpMAlgRTA=="), "");
                } catch (IOException e2) {
                    e2.printStackTrace();
                    h.p1(e.a("3+zUgeTl0Lb+gYnJnc7Sg4PHjNjnl4SMlPKcjsPyi8WTi+bpjM6X"));
