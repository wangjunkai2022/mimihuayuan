...
public class TestExoActivity extends AppCompatActivity {
    ...
    public static String[] f2156e = {e.a("VgwHFgQaXR0DA0YKERkQAlgMTTYuMn1sNj5gIiokIidoMTcrOTJ+dg=="), e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")};

    /* renamed from: f  reason: collision with root package name */
    public static String f2157f = e.a("YwcQEA==");
    public ExoUserPlayer a;
    public Runnable b = new a();

    /* renamed from: c  reason: collision with root package name */
    public SeekBar f2158c;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (exoUserPlayer == null || testExoActivity.f2158c == null || !exoUserPlayer.isPlaying()) {
                return;
            }
            long currentPosition = TestExoActivity.this.a.getCurrentPosition();
            TestExoActivity testExoActivity2 = TestExoActivity.this;
            testExoActivity2.f2158c.setProgress((int) ((currentPosition * 1000) / testExoActivity2.a.getDuration()));
            if (TestExoActivity.this.a.isPlaying()) {
                TestExoActivity testExoActivity3 = TestExoActivity.this;
                testExoActivity3.f2158c.postDelayed(testExoActivity3.b, 300L);
            }
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (TestExoActivity.this.a.isPlaying()) {
                TestExoActivity.this.f2159d.setImageDrawable(null);
            } else {
                TestExoActivity.this.f2159d.setImageResource(R.mipmap.player_icon_start_play);
            }
        }
    }
    ...
    public class d implements VideoInfoListener {
        ...
        public void onPlayStart(long j2) {
            TestExoActivity testExoActivity = TestExoActivity.this;
            testExoActivity.f2158c.postDelayed(testExoActivity.b, 300L);
            TestExoActivity.this.f2159d.setClickable(true);
        }

        @Override // chuangyuan.ycj.videolibrary.listener.VideoInfoListener
        public void onPlayerError(@Nullable w wVar) {
            TestExoActivity.this.f2159d.setClickable(false);
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        try {
            if (ContextCompat.checkSelfPermission(this, e.a("VgwHFgQaXR0DA0YKERkQAlgMTTM5Om12LCNsMz04LSp7PTAwJCF4dDY=")) != 0) {
                ActivityCompat.requestPermissions(this, f2156e, 1);
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        ...
        this.f2158c = (SeekBar) findViewById(R.id.seek_bar);
