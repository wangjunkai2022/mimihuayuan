...
public class MineFragment extends BaseFragment {
    ...
    public static final String f1363i = e.a("XA88DAQATQ==");

    /* renamed from: j  reason: collision with root package name */
    public static final String f1364j = e.a("XA88DRs=");
    @BindView
    ...
    public RadioGroup.OnCheckedChangeListener f1366h = b.a;
    @BindView
    ...
    public /* synthetic */ void i() {
        ...
        this.radioGroupHost.setOnCheckedChangeListener(this.f1366h);
    }
    ...
    public void onViewClicked(View view) {
        ...
        if (id == R.id.ll_collect) {
            ...
            if (TextUtils.isEmpty(trim)) {
                h.p1(e.a("09rujOjO3YvJgZ3d"));
            } else if (!Video.targetUrlDetail.contains(trim)) {
                h.p1(e.a("0u3JjOjO0Z3NgYnJnNLojr/1huPLl4GZlfq5gvLLhvKf"));
            } else {
                j.b().h(f1364j, trim);
