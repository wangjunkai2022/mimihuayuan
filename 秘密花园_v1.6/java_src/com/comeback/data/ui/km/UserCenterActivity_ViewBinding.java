...
public class UserCenterActivity_ViewBinding extends BaseRefreshActivity_ViewBinding {
    ...
    public UserCenterActivity f1381c;
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ UserCenterActivity f1383c;

        public a(UserCenterActivity_ViewBinding userCenterActivity_ViewBinding, UserCenterActivity userCenterActivity) {
            this.f1383c = userCenterActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            UserCenterActivity userCenterActivity = this.f1383c;
            userCenterActivity.t(userCenterActivity.tvFollow);
            User user = new User();
            user.setMu_id(userCenterActivity.f1378e);
            user.setMu_name(userCenterActivity.f1377d);
    ...
    public UserCenterActivity_ViewBinding(UserCenterActivity userCenterActivity, View view) {
        ...
        this.f1381c = userCenterActivity;
    ...
    public void a() {
        UserCenterActivity userCenterActivity = this.f1381c;
