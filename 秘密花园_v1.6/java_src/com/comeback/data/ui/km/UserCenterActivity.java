...
public class UserCenterActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1378e = intent.getStringExtra(e.a("XgY="));
        this.f1377d = intent.getStringExtra(e.a("WQMOAQ=="));
    }
    ...
    public void e() {
        ...
        this.tvName.setText(this.f1377d);
        if (g.d(x.P()).f(User.class, e.a("Whc8DQ8="), this.f1378e).size() != 0) {
            t(this.tvFollow);
        }
    }
    ...
    public void p(int i2) {
        ...
        try {
            jSONObject.put(e.a("QisH"), this.f1378e);
