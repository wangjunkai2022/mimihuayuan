...
public class VideoPlayActivity extends BaseActivity {
    ...
    @Override // com.comeback.data.base.BaseActivity
    public void e() {
        this.f1394c = h.h(this, this.videoView);
        ...
        this.f1394c.setPlayUri(this.b.getMv_play_url());
        this.f1394c.startPlayer();
        h.j1(this.f1394c.getVideoPlayerView(), this.b.getMv_play_url());
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.f1394c.onConfigurationChanged(configuration);
    }

    @Override // com.comeback.data.base.BaseActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onDestroy() {
        this.f1394c.onDestroy();
        super.onDestroy();
    }
