...
public class TypeDetailActivity extends BaseViewPagerActivity {
    ...
    public void c(Intent intent) {
        ...
        this.f1849c = intent.getStringExtra(e.a("QQsHAQQnQEMW"));
    }
    ...
    public ArrayList<BaseFragment> l() {
        ...
        arrayList.add(VideoListFragment.p(this.f1849c, e.a("QwsOAQ=="), this.b));
        arrayList.add(VideoListFragment.p(this.f1849c, e.a("QQsGExg="), this.b));
        return arrayList;
    }
