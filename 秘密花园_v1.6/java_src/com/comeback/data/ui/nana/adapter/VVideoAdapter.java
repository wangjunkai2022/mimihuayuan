...
public class VVideoAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<VideoListBean.ResponseEntity.VideosEntity> f1862c;
    ...
    public class a extends RecyclerView.ViewHolder {
        ...
        public a(VVideoAdapter vVideoAdapter, View view) {
            ...
            this.f1863c = (TextView) view.findViewById(R.id.tv_title);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        final VideoListBean.ResponseEntity.VideosEntity videosEntity = this.f1862c.get(i2);
        aVar.f1863c.setText(videosEntity.getTitle());
        h.M0(videosEntity.getCover(), aVar.a);
        aVar.b.setText(h.h1(videosEntity.getVideo_duration()));
