...
public class BannerAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdPagerAdapter.a f1852c;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        AdPagerAdapter.a aVar = this.f1852c;
        if (pageView != null) {
            if (list != null && list.size() != 0) {
                AdPagerAdapter adPagerAdapter = pageView.a;
                adPagerAdapter.f1888e = aVar;
                adPagerAdapter.f1891c.clear();
                if (list.size() > 0) {
                    adPagerAdapter.f1891c.addAll(list);
                }
                adPagerAdapter.notifyDataSetChanged();
                pageView.mViewPager.setCurrentItem((pageView.a.getCount() / 2) + new Random().nextInt(list.size()));
            }
            pageView.f1894d = true;
            pageView.b.postDelayed(pageView.f1893c, 6000L);
            return;
        }
        throw null;
    }
