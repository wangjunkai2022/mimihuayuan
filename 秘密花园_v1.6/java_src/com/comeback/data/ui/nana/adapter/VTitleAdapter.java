...
public class VTitleAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public MenuBean.ResponseEntity f1861c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            SearchResultActivity.n(vTitleAdapter.a, vTitleAdapter.f1861c.getSearch());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        bVar.a.setText(this.f1861c.getTitle());
        bVar.b.setVisibility(TextUtils.isEmpty(this.f1861c.getSearch()) ? 8 : 0);
