...
public class NanaLaunchActivity extends BaseActivity {
    ...
    public ArrayList<f> f1843d = new ArrayList<>();
    ...
    public static void n(NanaLaunchActivity nanaLaunchActivity) {
        if (nanaLaunchActivity.f1844e) {
            return;
        }
        if ((TextUtils.isEmpty(f.e.a.j.h0.m.d.b) || TextUtils.isEmpty(f.e.a.j.h0.m.d.f3956c) || TextUtils.isEmpty(f.e.a.j.h0.m.d.f3957d)) || !nanaLaunchActivity.b) {
            return;
        }
        nanaLaunchActivity.f1844e = true;
    ...
    public void onDestroy() {
        super.onDestroy();
        ArrayList<f> arrayList = this.f1843d;
        if (arrayList != null) {
    ...
    public final void r(HostInfo hostInfo) {
        if (hostInfo != null && hostInfo.getApi_pwa() != null) {
            for (HostInfo.ApiEntity apiEntity : hostInfo.getApi_pwa()) {
                ...
                f a = this.f1842c.a(a.s("VA4MFw4=", aVar, f.e.a.e.a("dA0NCg4QTVocCA==")));
                this.f1843d.add(a);
                ((d0) a).W(new h(this));
            }
        }
        if (hostInfo != null && hostInfo.getImg_pwa() != null) {
            for (HostInfo.ApiEntity apiEntity2 : hostInfo.getImg_pwa()) {
                ...
                f a2 = this.f1842c.a(a.s("VA4MFw4=", aVar2, f.e.a.e.a("dA0NCg4QTVocCA==")));
                this.f1843d.add(a2);
                ((d0) a2).W(new i(this));
            }
        }
        ...
        for (HostInfo.ApiEntity apiEntity3 : hostInfo.getStream_pwa()) {
            ...
            f a3 = this.f1842c.a(a.s("VA4MFw4=", aVar3, f.e.a.e.a("dA0NCg4QTVocCA==")));
            this.f1843d.add(a3);
