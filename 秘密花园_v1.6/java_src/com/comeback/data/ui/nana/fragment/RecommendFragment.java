...
public class RecommendFragment extends BaseVRefreshFragment {
    ...
    public static void q(RecommendFragment recommendFragment, MenuBean menuBean, int i2) {
        if (recommendFragment != null) {
            ...
            recommendFragment.g(e.a().f(recommendFragment.f1873j, responseEntity.getId(), d.a), new f.e.a.j.h0.l.a(recommendFragment, i2, responseEntity, menuBean));
            return;
        }
        throw null;
    }
    ...
    public void a() {
        this.f1873j = getArguments().getString(f.e.a.e.a("QQsHAQQsTUoDAw=="), "");
    }
