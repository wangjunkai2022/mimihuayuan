...
public class SearchFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1875i = getArguments().getString(e.a("QQsHAQQsTUoDAw=="), "");
        this.f1876j = getArguments().getString(e.a("XAca"), "");
    }
    ...
    public RecyclerView.LayoutManager i() {
        if (this.f1875i.equals(e.a("Ww0NAw=="))) {
    ...
    public void l(int i2) {
        g(f.e.a.j.h0.m.e.a().l(this.f1875i, this.f1876j, d.a), new a(i2));
    }
}
