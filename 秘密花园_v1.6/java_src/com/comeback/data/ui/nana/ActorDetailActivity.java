...
public class ActorDetailActivity extends BaseRefreshActivity {
    ...
    public ActorBean.ResponseEntity.ActorsEntity f1836d;
    @BindView
    ...
    public void c(Intent intent) {
        this.f1836d = (ActorBean.ResponseEntity.ActorsEntity) intent.getSerializableExtra(e.a("UwMXBQ=="));
    }
    ...
    public void e() {
        super.e();
        j(-16777216);
        h.M0(this.f1836d.getActor_url(), this.ivHead);
        this.tvName.setText(this.f1836d.getActor_name());
    }
    ...
    public void p(int i2) {
        ...
        int actor_id = this.f1836d.getActor_id();
