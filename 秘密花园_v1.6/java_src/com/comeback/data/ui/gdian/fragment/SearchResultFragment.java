...
public class SearchResultFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f913i = getArguments().getString(e.a("XAca"));
        this.f914j = getArguments().getInt(e.a("QxsTAQ=="), 0);
    }
    ...
    public void l(int i2) {
        int i3 = this.f914j;
        if (i3 == 0) {
            g(f.e.a.j.m.e.e.a().c(0, e.a("WwMXARgH"), 20, i2, this.f913i), new c(this, i2));
        } else if (i3 == 1) {
            g(f.e.a.j.m.e.e.a().h(e.a("WwMXARgH"), 20, i2, this.f913i), new b(this, i2));
        } else if (i3 != 2) {
        } else {
            g(f.e.a.j.m.e.e.a().d(e.a("WwMXARgH"), 20, i2, this.f913i), new a(this, i2));
        }
    }
}
