...
public class NovelFragment extends BaseViewPagerFragment {
    ...
    public ArrayList<BaseFragment> h() {
        ...
        arrayList.add(NovelTypeFragment.o(e.a("WwMXARgH")));
        arrayList.add(NovelTypeFragment.o(e.a("Xw0X")));
        arrayList.add(NovelTypeFragment.o(e.a("RAEMFg4=")));
        return arrayList;
    }

    @Override // com.comeback.data.base.BaseViewPagerFragment
    public String[] i() {
        return new String[]{e.a("0f7jgv3D3Yv5gY7Y"), e.a("0OHOjfzb"), e.a("0sfejMT3")};
    }
}
