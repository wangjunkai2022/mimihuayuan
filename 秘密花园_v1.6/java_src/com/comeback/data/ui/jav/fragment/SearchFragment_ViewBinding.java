...
public class SearchFragment_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ SearchFragment f1313c;

        public a(SearchFragment_ViewBinding searchFragment_ViewBinding, SearchFragment searchFragment) {
            this.f1313c = searchFragment;
        }

        @Override // d.c.b
        public void a(View view) {
            SearchFragment searchFragment = this.f1313c;
            String obj = searchFragment.etSearch.getText().toString();
            if (TextUtils.isEmpty(obj)) {
                h.p1(e.a("3vX/jebG3J7kgozqkOnej4/YhM3R"));
            } else if (obj.length() < 2) {
                h.p1(e.a("3vX/jebG3J7kgLPukO3QjofzUYHr+Nye5IGYwQ=="));
            } else {
