...
public class RankItemFragment extends BaseRefreshFragment {
    ...
    public String f1307j = e.a("UwMKCBI=");
        ...
        public void onCheckedChanged(RadioGroup radioGroup, int i2) {
            switch (i2) {
                case R.id.rb_1 /* 2131296710 */:
                    ...
                    rankItemFragment.f1308k = false;
                    rankItemFragment.f1307j = e.a("UwMKCBI=");
                    break;
                case R.id.rb_2 /* 2131296711 */:
                    RankItemFragment rankItemFragment2 = RankItemFragment.this;
                    rankItemFragment2.f1308k = false;
                    rankItemFragment2.f1307j = e.a("QAcGDwcK");
                    break;
                case R.id.rb_3 /* 2131296712 */:
                    RankItemFragment rankItemFragment3 = RankItemFragment.this;
                    rankItemFragment3.f1308k = false;
                    rankItemFragment3.f1307j = e.a("Wg0NEAMfQA==");
                    break;
                case R.id.rb_4 /* 2131296713 */:
                    RankItemFragment rankItemFragment4 = RankItemFragment.this;
                    rankItemFragment4.f1308k = true;
                    rankItemFragment4.f1307j = rankItemFragment4.f1306i.replace(e.a("QQsHAQQ="), e.a("VgEXCxk="));
                    if (RankItemFragment.this.f1307j.equals(e.a("VgEXCxksWlYdFVsVHQ4="))) {
                        RankItemFragment.this.f1307j = e.a("VgEXCxksVFwdElwLAQ==");
                        break;
                    }
                    break;
            }
    ...
    public class b implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            ...
            try {
                String H = g0Var.b.H();
                if (RankItemFragment.this.f1308k) {
                    RankItemFragment.this.f1309l = true;
                    ...
                    RankItemFragment.this.f1309l = d2.isVertical();
                    RankItemFragment.this.f117h.c();
                    RankItemFragment.this.mRvList.setLayoutManager(RankItemFragment.this.i());
                    RecyclerView recyclerView = RankItemFragment.this.mRvList;
                    RankItemFragment rankItemFragment = RankItemFragment.this;
                    VideoAdapter videoAdapter = new VideoAdapter(rankItemFragment.getContext(), rankItemFragment.f1309l);
    ...
    public void a() {
        this.f1306i = getArguments().getString(e.a("XgY="));
    }
    ...
    public BaseAbstractAdapter h() {
        VideoAdapter videoAdapter = new VideoAdapter(getContext(), this.f1309l);
    ...
    public RecyclerView.LayoutManager i() {
        return new GridLayoutManager(getContext(), this.f1309l ? 3 : 2);
    }
    ...
    public void l(int i2) {
        ...
        if (this.f1308k) {
            ...
            f.b.a.a.a.B(sb3, this.f1307j, "ERZe");
            sb3.append(this.f1306i);
            sb = sb3.toString();
        }
        sb2.append(sb);
        String sb4 = sb2.toString();
        f.e.a.k.f.a();
        d<i0> b2 = c.a().b(sb4, f.e.a.k.b.h0, f.e.a.k.b.f4054c);
        this.f1310m = b2;
        b2.X(new b());
    }
