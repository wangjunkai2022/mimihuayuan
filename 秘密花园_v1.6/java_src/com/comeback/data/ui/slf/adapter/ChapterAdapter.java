...
public class ChapterAdapter extends BaseAbstractAdapter<ChapterBean> {
    ...
    public static class Holder extends BaseViewHolder<ChapterBean> {
        ...
        public void a(ChapterBean chapterBean) {
            ...
            this.tvTitle.setTextColor(this.a.f2055e == getAdapterPosition() ? this.kmColorAccent : this.white);
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f2057c;
            ...
            public void a(View view) {
                Holder holder = this.f2057c;
                a aVar = holder.a.f2054d;
                if (aVar != null) {
                    aVar.a(holder.getAdapterPosition());
                    ChapterAdapter chapterAdapter = holder.a;
                    chapterAdapter.notifyItemChanged(chapterAdapter.f2055e);
                    holder.a.f2055e = holder.getAdapterPosition();
                    ChapterAdapter chapterAdapter2 = holder.a;
                    chapterAdapter2.notifyItemChanged(chapterAdapter2.f2055e);
                }
            }
        }
