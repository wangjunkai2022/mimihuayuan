...
public class PicAdapter extends BaseAbstractAdapter<String> {
    ...
    public View.OnClickListener f2090d;
    ...
    public static class Holder extends BaseViewHolder<String> {
        ...
        /* JADX WARN: Type inference failed for: r1v5, types: [f.e.a.j.l0.h.e.b] */
        ...
        public void a(String str) {
            ...
            d2.o(str2).q(R.drawable.default_img_bg).p(Integer.MIN_VALUE, Integer.MIN_VALUE).G(imageView);
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends d.c.b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f2092c;
            ...
            public void a(View view) {
                Holder holder = this.f2092c;
                View.OnClickListener onClickListener = holder.a.f2090d;
