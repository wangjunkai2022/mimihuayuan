...
public class NovelAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<SLFItemBean> f2087c;
    ...
    public class b extends RecyclerView.ViewHolder {
        ...
        public b(NovelAdapter novelAdapter, View view) {
            ...
            this.f2088c = (TextView) view.findViewById(R.id.tv_view);
            this.f2089d = (TextView) view.findViewById(R.id.tv_collect);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        SLFItemBean sLFItemBean = this.f2087c.get(i2);
        bVar.a.setText(sLFItemBean.getName());
        h.m1(bVar.b, sLFItemBean.getDescription());
        bVar.f2088c.setText(sLFItemBean.getClick());
        bVar.f2089d.setText(sLFItemBean.getFavorite());
