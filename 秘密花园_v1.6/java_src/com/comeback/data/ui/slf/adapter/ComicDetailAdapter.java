...
public class ComicDetailAdapter extends BaseAbstractAdapter<ChapterBean> {
    ...
    public static class Holder extends BaseViewHolder<ChapterBean> {
        ...
        public void a(ChapterBean chapterBean) {
            ...
            h.P0(chapterBean2.getImg(), this.ivCover, 0);
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f2060c;
            ...
            public void a(View view) {
                Holder holder = this.f2060c;
                if (holder != null) {
                    a aVar = holder.a.f2058d;
                    if (aVar != null) {
                        ComicDetailActivity comicDetailActivity = (ComicDetailActivity) aVar;
                        ComicReadActivity.q(comicDetailActivity, (ArrayList) comicDetailActivity.f1998e.b, holder.getAdapterPosition(), comicDetailActivity.b.getId());
