...
public class SpecialActivity extends BaseRefreshActivity {
    ...
    public class a extends BaseRefreshActivity.a<ArrayList<Special>> {
        ...
        public final /* synthetic */ int f2045f;
    ...
    public void c(Intent intent) {
        this.f2044d = intent.getStringExtra(e.a("QxsTAQ=="));
    }
    ...
    public BaseAbstractAdapter l() {
        return new SpecialAdapter(this, this.f2044d);
    }
    ...
    public void p(int i2) {
        ...
        k(b.a().o(this.f2044d, d.a(rVar.toString())), new a(i2));
    }
}
