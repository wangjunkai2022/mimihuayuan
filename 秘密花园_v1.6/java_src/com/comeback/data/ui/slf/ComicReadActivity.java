...
public class ComicReadActivity extends BaseActivity implements View.OnClickListener {
    ...
    public class b extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(@NonNull RecyclerView recyclerView, int i2, int i3) {
            ...
            textView.setText(e.a("0M7P") + (comicReadActivity.f2016g + 1) + e.a("383+REs=") + (findFirstVisibleItemPosition + 1) + e.a("GA==") + comicReadActivity.f2015f.getItemCount());
        }
    }
    ...
    public void c(Intent intent) {
        ...
        this.f2012c = intent.getStringExtra(e.a("XgY="));
        this.b = (List) new j().e(stringExtra, new a(this).b);
        this.f2016g = intent.getIntExtra(e.a("XgwHARM="), 0);
    }
    ...
    public void e() {
        ...
        h.p1(e.a("0ffTgubd0LT8gJvzkNTgjpPFjNjnlZSQlvqcgvLKi9aKjd76"));
        r rVar = new r();
        rVar.e(e.a("XgY="), this.f2012c);
    ...
    public final void n() {
        ...
        chapterAdapter.f2055e = this.f2016g;
        chapterAdapter.f2054d = new ChapterAdapter.a() { // from class: f.e.a.j.l0.a
        ...
        linearLayoutManager.scrollToPosition(this.f2016g);
    }
    ...
    public final void p() {
        if (this.f2015f == null) {
            ...
            this.f2015f = picAdapter;
            picAdapter.f2090d = this;
            this.rvList.setLayoutManager(new LinearLayoutManager(this));
            this.rvList.setAdapter(this.f2015f);
        }
        this.f2015f.c();
        this.f2015f.a(this.b.get(this.f2016g).getImages());
        if (this.f2015f.getItemCount() == 0) {
            h.p1(e.a("3+zUgeTl3JfCjoDCl9f9"));
        }
    }
}
