...
public class RankFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f2139i = getArguments().getString(e.a("QxsTAQ=="));
        this.f2140j = getArguments().getString(e.a("WBAHARk="));
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public BaseAbstractAdapter h() {
        if (this.f2139i.equals(e.a("Xg8CAw4="))) {
            return new ImageAdapter(getContext(), 0);
        }
        if (this.f2139i.equals(e.a("VAMREAQcVw=="))) {
            return new CartoonAdapter(getContext());
        }
        if (this.f2139i.equals(e.a("QQsHAQQ="))) {
    ...
    public void l(int i2) {
        r rVar = new r();
        rVar.e(e.a("WBAHARk="), this.f2140j);
        rVar.d(e.a("RwMEAQ=="), Integer.valueOf(i2));
        g(b.a().d(this.f2139i, d.a(rVar.toString())), new a(i2));
    }
}
