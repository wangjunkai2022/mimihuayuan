...
public class ComicDetailActivity extends BaseActivity implements ComicDetailAdapter.a {
    ...
    public ComicDetailAdapter f1998e;

    /* renamed from: f  reason: collision with root package name */
    public ComicDetailAdapter f1999f;

    /* renamed from: g  reason: collision with root package name */
    public List<ChapterBean> f2000g;

    /* renamed from: h  reason: collision with root package name */
    public List<ChapterBean> f2001h;
    @BindView
    ...
    public class a extends j<ComicDetail> {
        ...
        public void f(ComicDetail comicDetail) {
            ...
            comicDetailActivity.f1999f = new ComicDetailAdapter(comicDetailActivity);
            ...
            comicDetailActivity3.rvList.setAdapter(comicDetailActivity3.f1999f);
            ComicDetailActivity comicDetailActivity4 = ComicDetailActivity.this;
            comicDetailActivity4.f1998e = new ComicDetailAdapter(comicDetailActivity4);
            ...
            comicDetailActivity6.rvList2.setAdapter(comicDetailActivity6.f1998e);
            ComicDetailActivity comicDetailActivity7 = ComicDetailActivity.this;
            comicDetailActivity7.f1999f.a(comicDetailActivity7.f2001h);
            ComicDetailAdapter comicDetailAdapter = ComicDetailActivity.this.f1998e;
            comicDetailAdapter.b(chapter, comicDetailAdapter.b.size());
            ComicDetailActivity comicDetailActivity8 = ComicDetailActivity.this;
            comicDetailActivity8.f1999f.f2058d = comicDetailActivity8;
            comicDetailActivity8.f1998e.f2058d = comicDetailActivity8;
        }
    }
    ...
    public static void l(ComicDetailActivity comicDetailActivity, List list) {
        if (comicDetailActivity != null) {
            comicDetailActivity.f2001h = new ArrayList();
            comicDetailActivity.f2000g = new ArrayList();
            for (int i2 = 0; i2 < list.size() && i2 < 5; i2++) {
                comicDetailActivity.f2001h.add(list.get(i2));
            }
            for (int i3 = 0; i3 < list.size() && i3 < 5; i3++) {
                comicDetailActivity.f2000g.add(list.get((list.size() - i3) - 1));
            }
            return;
        }
        throw null;
    ...
    public void e() {
        ...
        h.P0(this.b.getImg(), this.ivCover, 20);
    ...
    public final void m() {
        this.tvOrder.setTextColor(this.f1996c ? this.kmColorAccent : this.primary_text);
        this.tvReverse.setTextColor(this.f1996c ? this.primary_text : this.kmColorAccent);
    }
