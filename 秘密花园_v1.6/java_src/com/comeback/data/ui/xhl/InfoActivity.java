...
public class InfoActivity extends BaseActivity {
    ...
    public class a implements f<i0> {
        ...
        public void a(d<i0> dVar, g0<i0> g0Var) {
            if (g0Var.a.f6533e < 300) {
                try {
                    c I = b.u(g0Var.b.H()).I(e.a("Qz0FFxE="));
                    ...
                    c.a.a.b.g.h.p1(e.a("0ffTgubd0ZTQgKr3nc7Sg4PH"));
                    return;
                }
            }
            c.a.a.b.g.h.p1(e.a("3+zUgeTl3JfCjoDC"));
        }
    ...
    public static void l(Context context, String str) {
        if (str.contains(e.a("EQ8MBgIfXA5B"))) {
            str = str.replace(e.a("EQ8MBgIfXA5B"), "");
        }
    ...
    public void e() {
        j(-1);
        d<i0> j2 = f.e.a.j.i0.c.a().j(this.b, f.e.a.k.b.S);
        this.f2210c = j2;
        j2.X(new a());
        this.webView.setWebViewClient(new f.e.a.j.p0.a(this));
