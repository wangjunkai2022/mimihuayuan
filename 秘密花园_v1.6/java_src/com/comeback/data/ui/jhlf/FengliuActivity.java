...
public class FengliuActivity extends BaseRefreshActivity {
    ...
    public HashMap<String, HashMap<String, String>> f1317d;

    /* renamed from: e  reason: collision with root package name */
    public List<List<b>> f1318e;

    /* renamed from: f  reason: collision with root package name */
    public ArrayList<b> f1319f;
    @BindView
    public FloatingActionButton floatingActionButton;

    /* renamed from: g  reason: collision with root package name */
    public String f1320g = e.a("Vg4P");
    ...
    public static void t(FengliuActivity fengliuActivity, boolean z, String str) {
        if (fengliuActivity != null) {
            ...
            if (z) {
                ...
                SearchResultActivity.u(fengliuActivity, str, fengliuActivity.f1322i, fengliuActivity.f1321h);
                return;
            }
        }
        throw null;
    ...
    public void c(Intent intent) {
        this.f1321h = intent.getStringExtra(e.a("WQMOAQ=="));
        this.f1322i = intent.getStringExtra(e.a("XgY="));
    }
    ...
    public void e() {
        ...
        HashMap<String, String> hashMap2 = this.f1317d.get(e.a("D1Q="));
        TextView textView = this.tvArea;
        textView.setText(this.f1321h + e.a("GofmzI7ohA=="));
        this.f1319f.add(new b(this, e.a("0ufLjejb"), e.a("Vg4P")));
        for (String str : hashMap2.keySet()) {
            this.f1319f.add(new b(this, hashMap2.get(str), str));
        }
        Iterator<b> it = this.f1319f.iterator();
        while (it.hasNext()) {
            b next = it.next();
            ArrayList arrayList = new ArrayList();
            this.f1318e.add(arrayList);
            arrayList.add(new b(this, e.a("0ufLjejb"), next.b));
            HashMap<String, String> hashMap3 = this.f1317d.get(next.b);
    ...
    public void onViewClicked(View view) {
        ...
        eVar.f(this.f1319f, this.f1318e, null);
        eVar.e();
    }

    @Override // com.comeback.data.base.BaseRefreshActivity
    public void p(int i2) {
        k(c.a().b(i2, this.f1320g, this.f1322i), new a(i2));
    }

    public void u(int i2, int i3, int i4, View view) {
        b bVar = this.f1318e.get(i2).get(i3);
        this.f1320g = bVar.b;
        TextView textView = this.tvArea;
        StringBuilder sb = new StringBuilder();
        f.b.a.a.a.B(sb, this.f1321h, "Gg==");
        f.b.a.a.a.B(sb, this.f1319f.get(i2).a, "Gg==");
        sb.append(bVar.a);
