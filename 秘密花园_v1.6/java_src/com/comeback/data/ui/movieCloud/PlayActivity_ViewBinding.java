...
public class PlayActivity_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ PlayActivity f1812c;

        public a(PlayActivity_ViewBinding playActivity_ViewBinding, PlayActivity playActivity) {
            this.f1812c = playActivity;
        }

        @Override // d.c.b
        public void a(View view) {
            PlayActivity playActivity = this.f1812c;
            List<PlayListBean> list = playActivity.f1806e;
            if (list != null && list.size() != 0) {
                ArrayList arrayList = new ArrayList();
                for (PlayListBean playListBean : playActivity.f1806e) {
                    CollectVideo collectVideo = new CollectVideo();
                    collectVideo.setUrl(playListBean.getUri());
                    collectVideo.setName(playActivity.f1807f + e.a("Gg==") + playListBean.getName());
                ...
                if (d2 != null) {
                    ...
                    c.a.a.b.g.h.p1(e.a("0fbVjPz837vjg774l9bvj4rChuvEl4KWlvqcjt78isqChPfSg+S21vvx3MbQjtvg39/ejMz10JHi"));
                    return;
                }
                throw null;
            }
            c.a.a.b.g.h.p1(e.a("0ejSgsb61o//g4n0nePug4Lmhd77l4G+lfKbgfTrheKOi+TrjeeP2+Tp29v0gszc0v7Lgvne36fNg63PnuPojr3KhfDdm668"));
        }
    }
