...
public class AMJItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<AMJList.DataBean> f1821c;
    ...
    public class a extends RecyclerView.ViewHolder {
        ...
        public a(AMJItemAdapter aMJItemAdapter, View view) {
            ...
            this.f1823d = (TextView) view.findViewById(R.id.tv_title);
            this.f1822c = (TextView) view.findViewById(R.id.tv_area);
            this.f1824e = (TextView) view.findViewById(R.id.tv_detail);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        a aVar = (a) viewHolder;
        final AMJList.DataBean dataBean = this.f1821c.get(i2);
        aVar.f1823d.setText(dataBean.getName());
        h.u0(dataBean.getPic(), aVar.a);
        aVar.b.setText(dataBean.getState());
        aVar.f1822c.setText(dataBean.getType());
