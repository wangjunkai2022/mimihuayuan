...
public class ChapterAdapter extends BaseAbstractAdapter<PlayListBean> {
    ...
    public static class Holder extends BaseViewHolder<PlayListBean> {
        ...
        public void a(PlayListBean playListBean) {
            ...
            this.tvTag.setTextColor(Color.parseColor(e.a(this.b.f1826e == getLayoutPosition() ? "FFJTUVxHew==" : "FFtaXVJKAA==")));
        }
    }
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1828c;
            ...
            public void a(View view) {
                Holder holder = this.f1828c;
                a aVar = holder.b.f1825d;
                if (aVar != null) {
                    aVar.a(holder.getAdapterPosition(), holder.a.getUri());
                    ChapterAdapter chapterAdapter = holder.b;
                    chapterAdapter.notifyItemChanged(chapterAdapter.f1826e);
                    holder.b.f1826e = holder.getLayoutPosition();
                    ChapterAdapter chapterAdapter2 = holder.b;
                    chapterAdapter2.notifyItemChanged(chapterAdapter2.f1826e);
                }
            }
        }
