...
public class PlayActivity extends BaseActivity {
    ...
    public List<PlayListBean> f1806e;
    ...
    public class a extends j<AMJPlay> {
        ...
        public void f(AMJPlay aMJPlay) {
            ...
            chapterAdapter.f1825d = new ChapterAdapter.a() { // from class: f.e.a.j.g0.a
            ...
            h.j1(playActivity.b.getVideoPlayerView(), playList.get(0).getUri());
        }
    }
    ...
    public class b extends j<XXPlay> {
        ...
        public void f(XXPlay xXPlay) {
            ...
            playActivity.rvChapter.setAdapter(chapterAdapter);
            chapterAdapter.b(playList, chapterAdapter.b.size());
            chapterAdapter.f1825d = new ChapterAdapter.a() { // from class: f.e.a.j.g0.b
                @Override // com.comeback.data.ui.movieCloud.adapter.ChapterAdapter.a
                public final void a(int i2, String str) {
                    PlayActivity.this.m(i2, str);
                }
            };
            playActivity.k(f.e.a.j.g0.h.b.a().c(playActivity.f1805d, playList.get(0).getUri()), new c());
        }
    }
    ...
    public class c extends j<PlayIndex> {
        ...
        public void f(PlayIndex playIndex) {
            ...
            h.j1(PlayActivity.this.b.getVideoPlayerView(), playIndex2.getData().getHttpurl());
    ...
    public void c(Intent intent) {
        this.f1804c = intent.getStringExtra(e.a("Vg8JLQ8="));
        this.f1805d = intent.getStringExtra(e.a("TxoqAA=="));
    }
    ...
    public void e() {
        ...
        if (!TextUtils.isEmpty(this.f1804c)) {
            k(f.e.a.j.g0.h.b.a().f("", this.f1804c), new a());
        } else {
            k(f.e.a.j.g0.h.b.a().e(this.f1805d), new b());
        }
    }
    ...
    public /* synthetic */ void l(int i2, String str) {
        ...
        h.j1(this.b.getVideoPlayerView(), str);
    }
    ...
    public final void n(String str) {
        k(f.e.a.j.g0.h.b.a().c(this.f1805d, str), new c());
    }
