...
public class MoviePlayActivity extends BasePlayByIdActivity {
    ...
    public class a extends j<HashMap<String, String>> {
        ...
        public void f(HashMap<String, String> hashMap) {
            ...
            if (moviePlayActivity != null) {
                ...
                h.j1(moviePlayActivity.f113c.getVideoPlayerView(), sb3);
                return;
            }
            throw null;
        }
    ...
    public final void o() {
        ...
        textView.setText(e.a("0fXVjf7M1o/p") + h.h1(this.f155d.getDuration()) + e.a("F0KF9saVrY2a4buIxPA=") + this.f155d.getPlayCount());
    ...
    public /* synthetic */ void p(RadioGroup radioGroup, int i2) {
        switch (i2) {
            case R.id.radio_line1 /* 2131296694 */:
                this.f157f = e.a("Bg==");
                break;
            case R.id.radio_line2 /* 2131296695 */:
                this.f157f = e.a("BlM=");
                break;
            default:
                switch (i2) {
                    case R.id.radio_type1 /* 2131296706 */:
                        this.f158g = 0;
                        break;
                    case R.id.radio_type2 /* 2131296707 */:
                        this.f158g = 1;
                        break;
                    case R.id.radio_type3 /* 2131296708 */:
                        this.f158g = 2;
                        break;
                    case R.id.radio_type4 /* 2131296709 */:
                        this.f158g = 3;
                        break;
                }
        }
