...
public class CartoonActivity extends BaseActivity {
    ...
    public class a extends j<Cartoon> {
        ...
        public final /* synthetic */ DiscoverAdapter f1589e;

        public a(CartoonActivity cartoonActivity, DiscoverAdapter discoverAdapter) {
            this.f1589e = discoverAdapter;
        }
        ...
        public void f(Cartoon cartoon) {
            this.f1589e.a(cartoon.getData().getData().subList(0, 6));
        }
    }
    ...
    public class b extends j<Cartoon> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ DiscoverAdapter f1590e;

        public b(CartoonActivity cartoonActivity, DiscoverAdapter discoverAdapter) {
            this.f1590e = discoverAdapter;
        }
        ...
        @Override // m.j
        public void f(Cartoon cartoon) {
            this.f1590e.a(cartoon.getData().getData().subList(0, 6));
        }
    }
    ...
    public class c extends j<Cartoon> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ DiscoverAdapter f1591e;

        public c(CartoonActivity cartoonActivity, DiscoverAdapter discoverAdapter) {
            this.f1591e = discoverAdapter;
        }
        ...
        @Override // m.j
        public void f(Cartoon cartoon) {
            this.f1591e.a(cartoon.getData().getData().subList(0, 6));
        }
    }
    ...
    public void e() {
        ...
        k(d.a().g(e.a("RQcACwYeXF0X"), f.e.a.j.d0.m.b.a(jSONObject.toString())), new a(this, discoverAdapter));
        k(d.a().g(e.a("QhIHBR8W"), f.e.a.j.d0.m.b.a(jSONObject.toString())), new b(this, discoverAdapter2));
        k(d.a().g(e.a("Rw0TEQcSSw=="), f.e.a.j.d0.m.b.a(jSONObject.toString())), new c(this, discoverAdapter3));
    }
