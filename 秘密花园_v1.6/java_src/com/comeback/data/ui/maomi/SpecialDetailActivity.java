...
public class SpecialDetailActivity extends BaseVRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1628g = intent.getStringExtra(e.a("XgY="));
        this.f1627f = intent.getStringExtra(e.a("QwsXCA4="));
        this.f1626e = intent.getStringExtra(e.a("UwcQBw=="));
        this.f1629h = intent.getStringExtra(e.a("Xg8E"));
    }
    ...
    public void e() {
        ...
        this.tvTitle.setText(this.f1627f);
        if (TextUtils.isEmpty(this.f1626e)) {
            this.tvDetail.setVisibility(8);
        } else {
            this.tvDetail.setText(this.f1626e);
        }
        h.u0(this.f1629h, this.ivBg);
    }
    ...
    public void p(int i2) {
        ...
        try {
            jSONObject.put(e.a("RBIGBwISVWwaAg=="), this.f1628g);
