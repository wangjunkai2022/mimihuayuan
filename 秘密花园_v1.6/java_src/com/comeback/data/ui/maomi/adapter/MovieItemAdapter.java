...
public class MovieItemAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeData.DataBean f1674c;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (MovieItemAdapter.this.f1674c.isComic()) {
                h.p1(e.a("0d7Ig//I"));
            } else {
    ...
    public int getItemCount() {
        return this.f1674c.getVideos().size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        HomeData.DataBean.VideosBean videosBean = this.f1674c.getVideos().get(i2);
        bVar.f1675c.setText(videosBean.getName());
