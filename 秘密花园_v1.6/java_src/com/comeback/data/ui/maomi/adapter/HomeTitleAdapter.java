...
public class HomeTitleAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (HomeTitleAdapter.this.f1670c.isComic()) {
                return;
            }
            HomeTitleAdapter homeTitleAdapter = HomeTitleAdapter.this;
            SpecialDetailActivity.w(homeTitleAdapter.a, homeTitleAdapter.f1670c.getId(), HomeTitleAdapter.this.f1670c.getName(), HomeTitleAdapter.this.f1670c.getDescribe(), HomeTitleAdapter.this.f1670c.getImage());
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        b bVar = (b) viewHolder;
        bVar.a.setText(this.f1670c.getName());
