...
public class HotWordAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<HotWords.DataBeanX.DataBean> f1671c;
    ...
    public class Holder_ViewBinding implements Unbinder {
        ...
        public class a extends b {
            ...
            /* renamed from: c  reason: collision with root package name */
            public final /* synthetic */ Holder f1673c;
            ...
            public void a(View view) {
                Holder holder = this.f1673c;
                a aVar = holder.a.b;
                if (aVar != null) {
                    i iVar = (i) aVar;
                    iVar.a.etSearch.setText(holder.b.getName());
                    SearchActivity searchActivity = iVar.a;
                    searchActivity.f1621f = searchActivity.etSearch.getText().toString().trim();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        HotWords.DataBeanX.DataBean dataBean = this.f1671c.get(i2);
        holder.b = dataBean;
