...
public class CartoonDetailActivity extends BaseRefreshActivity {
    ...
    public Cartoon.DataBeanX.DataBean f1600d;
    @BindView
    ...
    public class a extends BaseRefreshActivity.a<CartoonDetail> {
        ...
        public final /* synthetic */ int f1601f;
    ...
    public void c(Intent intent) {
        this.f1600d = (Cartoon.DataBeanX.DataBean) intent.getParcelableExtra(e.a("UwMXBQ=="));
    }
    ...
    public void e() {
        ...
        this.mTvTitle.setText(this.f1600d.getTitle());
        this.mTvDetail.setText(this.f1600d.getDescriptions());
        this.mTvDetail.setVisibility(TextUtils.isEmpty(this.f1600d.getDescriptions()) ? 8 : 0);
        h.u0(this.f1600d.getThumb(), this.mIvBg);
    }
    ...
    public void p(int i2) {
        ...
        try {
            ...
            jSONObject.put(e.a("XgY="), this.f1600d.getId());
