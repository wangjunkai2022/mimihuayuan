...
public class CartoonListActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1605e = intent.getStringExtra(e.a("QwsXCA4="));
        this.f1604d = intent.getStringExtra(e.a("XAca"));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        this.mTvTitle.setText(this.f1605e);
    }
    ...
    public void p(int i2) {
        ...
        k(d.a().g(this.f1604d, b.a(jSONObject.toString())), new a(i2));
    }
}
