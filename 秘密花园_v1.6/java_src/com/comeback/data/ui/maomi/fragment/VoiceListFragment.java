...
public class VoiceListFragment extends BaseRefreshFragment {
    ...
    public void a() {
        this.f1710i = getArguments().getString(e.a("XAca"));
        this.f1711j = getArguments().getBoolean(e.a("XhEvCwUU"), false);
    }

    @Override // com.comeback.data.base.BaseRefreshFragment
    public BaseAbstractAdapter h() {
        return new VoiceListAdapter(getContext(), this.f1711j);
    }
    ...
    public void l(int i2) {
        ...
        g(d.a().e(this.f1710i, b.a(jSONObject.toString())), new a());
    }
}
