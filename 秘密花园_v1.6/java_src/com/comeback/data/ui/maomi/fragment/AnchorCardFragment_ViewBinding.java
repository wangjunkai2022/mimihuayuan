...
public class AnchorCardFragment_ViewBinding implements Unbinder {
    ...
    public class a extends b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ AnchorCardFragment f1689c;

        public a(AnchorCardFragment_ViewBinding anchorCardFragment_ViewBinding, AnchorCardFragment anchorCardFragment) {
            this.f1689c = anchorCardFragment;
        }

        @Override // d.c.b
        public void a(View view) {
            AnchorCardFragment anchorCardFragment = this.f1689c;
            VoiceAnchorDetailActivity.n(anchorCardFragment.getContext(), anchorCardFragment.f1687g);
        }
    }
