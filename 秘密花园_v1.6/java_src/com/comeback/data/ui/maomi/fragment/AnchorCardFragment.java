...
public class AnchorCardFragment extends BaseFragment {
    ...
    public AnchorList.DataBean f1687g;
    @BindView
    ...
    public void a() {
        if (getArguments() != null) {
            this.f1687g = (AnchorList.DataBean) getArguments().getParcelable(e.a("UwMXBQ=="));
        }
    }
    ...
    @Override // com.comeback.data.base.BaseFragment
    public void f() {
        this.mTvTitle.setText(this.f1687g.getName());
        h.N0(this.f1687g.getAvatar(), this.mIvImg, 6);
    }
}
