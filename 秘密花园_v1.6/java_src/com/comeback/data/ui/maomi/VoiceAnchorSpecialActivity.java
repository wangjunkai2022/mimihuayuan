...
public class VoiceAnchorSpecialActivity extends BaseRefreshActivity {
    ...
    public void c(Intent intent) {
        this.f1645e = intent.getStringExtra(e.a("XgY="));
        this.f1644d = intent.getStringExtra(e.a("VgwADAQBZloX"));
        this.f1646f = intent.getStringExtra(e.a("Xg8E"));
        this.f1647g = intent.getStringExtra(e.a("QwsXCA4="));
    }
    ...
    public void e() {
        super.e();
        j(-1);
        h.z0(this.f1646f, this.ivHeader);
        this.tvTitle.setText(this.f1647g);
    }
    ...
    public void p(int i2) {
        ...
        try {
            jSONObject.put(e.a("XgY="), this.f1644d);
            jSONObject.put(e.a("RA0REA=="), e.a("Bg=="));
            jSONObject.put(e.a("RBIGBwISVWwaAg=="), this.f1645e);
