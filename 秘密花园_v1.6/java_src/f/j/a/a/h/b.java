...
public class b extends c<b> implements e {
    ...
    public b(Context context) {
        ...
        this.f6255f = imageView2;
        this.f6253d = (TextView) findViewById(f.j.a.a.a.srl_classics_title);
        ...
        this.f6262m = obtainStyledAttributes.getInt(d.ClassicsFooter_srlFinishDuration, this.f6262m);
        this.b = f.j.a.a.g.c.f6221i[obtainStyledAttributes.getInt(d.ClassicsFooter_srlClassicsSpinnerStyle, this.b.a)];
        if (obtainStyledAttributes.hasValue(d.ClassicsFooter_srlDrawableArrow)) {
            this.f6254e.setImageDrawable(obtainStyledAttributes.getDrawable(d.ClassicsFooter_srlDrawableArrow));
        } else if (this.f6254e.getDrawable() == null) {
            f.j.a.a.k.a aVar = new f.j.a.a.k.a();
            this.f6257h = aVar;
            aVar.a.setColor(-10066330);
            this.f6254e.setImageDrawable(this.f6257h);
        }
        if (obtainStyledAttributes.hasValue(d.ClassicsFooter_srlDrawableProgress)) {
            this.f6255f.setImageDrawable(obtainStyledAttributes.getDrawable(d.ClassicsFooter_srlDrawableProgress));
        } else if (this.f6255f.getDrawable() == null) {
            f.j.a.a.k.e eVar = new f.j.a.a.k.e();
            this.f6258i = eVar;
            eVar.a.setColor(-10066330);
            this.f6255f.setImageDrawable(this.f6258i);
        }
        if (obtainStyledAttributes.hasValue(d.ClassicsFooter_srlTextSizeTitle)) {
            this.f6253d.setTextSize(0, obtainStyledAttributes.getDimensionPixelSize(d.ClassicsFooter_srlTextSizeTitle, f.j.a.a.m.b.d(16.0f)));
        }
        ...
        this.f6253d.setText(isInEditMode() ? this.s : this.q);
        if (isInEditMode()) {
    ...
    public void a(@NonNull i iVar, @NonNull f.j.a.a.g.b bVar, @NonNull f.j.a.a.g.b bVar2) {
        ImageView imageView = this.f6254e;
        if (this.x) {
            return;
        }
        ...
        if (ordinal == 0) {
            ...
            if (ordinal != 6) {
                switch (ordinal) {
                    ...
                    case 12:
                        imageView.setVisibility(8);
                        this.f6253d.setText(this.s);
                        return;
                    case 11:
                        this.f6253d.setText(this.t);
                        imageView.setVisibility(8);
                        return;
                    default:
                        return;
            ...
            this.f6253d.setText(this.r);
            imageView.animate().rotation(0.0f);
            return;
        }
        this.f6253d.setText(this.q);
    ...
    public int i(@NonNull i iVar, boolean z) {
        ...
        this.f6253d.setText(z ? this.u : this.v);
