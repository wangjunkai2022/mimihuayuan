...
public class b extends c<b> implements f {
    ...
    public b(Context context) {
        ...
        this.f6262m = obtainStyledAttributes.getInt(d.ClassicsHeader_srlFinishDuration, this.f6262m);
        this.v = obtainStyledAttributes.getBoolean(d.ClassicsHeader_srlEnableLastTime, this.v);
        this.b = f.j.a.a.g.c.f6221i[obtainStyledAttributes.getInt(d.ClassicsHeader_srlClassicsSpinnerStyle, this.b.a)];
        if (obtainStyledAttributes.hasValue(d.ClassicsHeader_srlDrawableArrow)) {
            this.f6254e.setImageDrawable(obtainStyledAttributes.getDrawable(d.ClassicsHeader_srlDrawableArrow));
        ...
        if (obtainStyledAttributes.hasValue(d.ClassicsHeader_srlDrawableProgress)) {
            this.f6255f.setImageDrawable(obtainStyledAttributes.getDrawable(d.ClassicsHeader_srlDrawableProgress));
        ...
        if (obtainStyledAttributes.hasValue(d.ClassicsHeader_srlTextSizeTitle)) {
            this.f6253d.setTextSize(0, obtainStyledAttributes.getDimensionPixelSize(d.ClassicsHeader_srlTextSizeTitle, f.j.a.a.m.b.d(16.0f)));
        }
        ...
        this.f6253d.setText(isInEditMode() ? this.x : this.w);
        if (isInEditMode()) {
    ...
    public void a(@NonNull i iVar, @NonNull f.j.a.a.g.b bVar, @NonNull f.j.a.a.g.b bVar2) {
        ...
        if (ordinal == 0) {
            ...
            if (ordinal == 5) {
                this.f6253d.setText(this.z);
                imageView.animate().rotation(180.0f);
                return;
            } else if (ordinal == 7) {
                this.f6253d.setText(this.D);
                imageView.animate().rotation(0.0f);
                return;
            } else if (ordinal == 9 || ordinal == 11) {
                this.f6253d.setText(this.x);
                imageView.setVisibility(8);
                return;
            } else if (ordinal != 12) {
                return;
    ...
    public int i(@NonNull i iVar, boolean z) {
        if (z) {
            this.f6253d.setText(this.A);
            if (this.r != null) {
                q(new Date());
            }
        } else {
            this.f6253d.setText(this.B);
        }
