...
public class a extends f.j.a.a.k.b implements f {
    ...
    public class C0097a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            if (b == 0) {
                ...
                aVar.f6241m = ((Integer) valueAnimator.getAnimatedValue()).intValue() / 2;
            } else if (2 == b) {
    ...
    public a(Context context) {
        ...
        this.f6239k.setStrokeWidth(f.j.a.a.m.b.d(3.0f));
        ...
        this.f6237i = obtainStyledAttributes.getBoolean(d.BezierRadarHeader_srlEnableHorizontalDrag, this.f6237i);
        this.f6232d = obtainStyledAttributes.getColor(d.BezierRadarHeader_srlAccentColor, -1);
        this.f6235g = true;
        this.f6233e = obtainStyledAttributes.getColor(d.BezierRadarHeader_srlPrimaryColor, -14540254);
        this.f6234f = true;
        this.f6235g = obtainStyledAttributes.hasValue(d.BezierRadarHeader_srlAccentColor);
        this.f6234f = obtainStyledAttributes.hasValue(d.BezierRadarHeader_srlPrimaryColor);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.f6238j.reset();
        this.f6238j.lineTo(0.0f, this.f6240l);
        Path path = this.f6238j;
        int i3 = this.n;
        float f3 = 2.0f;
        float f4 = i3 >= 0 ? i3 : width / 2.0f;
        float f5 = width;
        path.quadTo(f4, this.f6241m + i2, f5, this.f6240l);
        this.f6238j.lineTo(f5, 0.0f);
        this.f6239k.setColor(this.f6233e);
        canvas.drawPath(this.f6238j, this.f6239k);
        if (this.p > 0.0f) {
            this.f6239k.setColor(this.f6232d);
            float f6 = height;
            float f7 = f6 / f.j.a.a.m.b.f6268d;
            float f8 = 7.0f;
            ...
            int i4 = 0;
            while (i4 < 7) {
                this.f6239k.setAlpha((int) ((1.0d - (1.0d / Math.pow((f7 / 800.0d) + 1.0d, 15.0d))) * this.p * (1.0f - ((Math.abs(f2) / f8) * f3)) * 255.0f));
                float f14 = (1.0f - (1.0f / ((f7 / 10.0f) + 1.0f))) * this.r;
                canvas.drawCircle((((i4 + 1.0f) - 4.0f) * f11) + ((f5 / 2.0f) - (f14 / 2.0f)), f13 / 2.0f, f14, this.f6239k);
                i4++;
                f8 = 7.0f;
                f3 = 2.0f;
            }
            this.f6239k.setAlpha(255);
        }
        if (this.x != null || isInEditMode()) {
            ...
            this.f6239k.setColor(this.f6232d);
            this.f6239k.setStyle(Paint.Style.FILL);
            float f19 = f5 / 2.0f;
            float f20 = height / 2.0f;
            canvas.drawCircle(f19, f20, f17, this.f6239k);
            this.f6239k.setStyle(Paint.Style.STROKE);
            float f21 = f18 + f17;
            canvas.drawCircle(f19, f20, f21, this.f6239k);
            this.f6239k.setColor((this.f6233e & ViewCompat.MEASURED_SIZE_MASK) | 1426063360);
            this.f6239k.setStyle(Paint.Style.FILL);
            this.y.set(f19 - f17, f20 - f17, f19 + f17, f17 + f20);
            canvas.drawArc(this.y, 270.0f, this.t, true, this.f6239k);
            this.f6239k.setStyle(Paint.Style.STROKE);
            this.y.set(f19 - f21, f20 - f21, f19 + f21, f20 + f21);
            canvas.drawArc(this.y, 270.0f, this.t, false, this.f6239k);
            this.f6239k.setStyle(Paint.Style.FILL);
        }
        if (this.s > 0.0f) {
            this.f6239k.setColor(this.f6232d);
            canvas.drawCircle(f5 / 2.0f, height / 2.0f, this.s, this.f6239k);
        }
    ...
    public void h(boolean z, float f2, int i2, int i3, int i4) {
        ...
        if (z || this.f6236h) {
            this.f6236h = true;
            this.f6240l = Math.min(i3, i2);
            this.f6241m = (int) (Math.max(0, i2 - i3) * 1.9f);
            this.q = f2;
            invalidate();
        }
    }
    ...
    public void setPrimaryColors(@ColorInt int... iArr) {
        if (iArr.length > 0 && !this.f6234f) {
            this.f6233e = iArr[0];
            this.f6234f = true;
            this.f6234f = false;
        }
        if (iArr.length <= 1 || this.f6235g) {
            return;
        }
        this.f6232d = iArr[1];
        this.f6235g = true;
