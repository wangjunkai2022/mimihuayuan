...
public abstract class c<T extends c> extends b implements g {
    ...
    public c(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.o = 20;
        this.p = 0;
        this.b = f.j.a.a.g.c.f6216d;
    }

    @Override // f.j.a.a.k.b, f.j.a.a.f.g
    public void b(@NonNull i iVar, int i2, int i3) {
        ImageView imageView = this.f6255f;
        if (imageView.getVisibility() != 0) {
            imageView.setVisibility(0);
            Drawable drawable = this.f6255f.getDrawable();
    ...
    public void e(@NonNull h hVar, int i2, int i3) {
        this.f6256g = hVar;
        ((SmartRefreshLayout.k) hVar).c(this, this.f6261l);
    }
    ...
    public T o(@ColorInt int i2) {
        this.f6259j = true;
        this.f6253d.setTextColor(i2);
        d dVar = this.f6257h;
        if (dVar != null) {
            dVar.a.setColor(i2);
            this.f6254e.invalidateDrawable(this.f6257h);
        }
        d dVar2 = this.f6258i;
        if (dVar2 != null) {
            dVar2.a.setColor(i2);
            this.f6255f.invalidateDrawable(this.f6258i);
        }
        return this;
    }
    ...
    public void onDetachedFromWindow() {
        ...
        ImageView imageView2 = this.f6255f;
    ...
    public void setPrimaryColors(@ColorInt int... iArr) {
        if (iArr.length > 0) {
            if (!(getBackground() instanceof BitmapDrawable) && !this.f6260k) {
                p(iArr[0]);
                this.f6260k = false;
            }
            if (this.f6259j) {
