...
public final class f extends f.i.b.e0.c {
    ...
    public final List<f.i.b.o> f6094l;
    ...
    public f.i.b.e0.c E() throws IOException {
        if (!this.f6094l.isEmpty() && this.f6095m == null) {
            if (T() instanceof f.i.b.l) {
                List<f.i.b.o> list = this.f6094l;
    ...
    public final void U(f.i.b.o oVar) {
        if (this.f6095m != null) {
            if (!(oVar instanceof f.i.b.q) || this.f6181i) {
                ((f.i.b.r) T()).c(this.f6095m, oVar);
            }
            this.f6095m = null;
        } else if (this.f6094l.isEmpty()) {
            this.n = oVar;
        } else {
            f.i.b.o T = T();
            if (T instanceof f.i.b.l) {
