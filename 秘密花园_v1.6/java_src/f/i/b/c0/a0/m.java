...
public final class m<T> extends z<T> {
    ...
    public final f.i.b.j f6108c;

    /* renamed from: d  reason: collision with root package name */
    public final f.i.b.d0.a<T> f6109d;

    /* renamed from: g  reason: collision with root package name */
    public z<T> f6112g;

    /* renamed from: f  reason: collision with root package name */
    public final m<T>.b f6111f = new b(this, null);

    /* renamed from: e  reason: collision with root package name */
    public final a0 f6110e = null;
    ...
    */
    public T a(f.i.b.e0.a r4) throws java.io.IOException {
        /*
            ...
            f.i.b.n<T> r0 = r3.b
            if (r0 != 0) goto L1a
            f.i.b.z<T> r0 = r3.f6112g
            if (r0 == 0) goto L9
            goto L15
        L9:
            f.i.b.j r0 = r3.f6108c
            f.i.b.a0 r1 = r3.f6110e
            f.i.b.d0.a<T> r2 = r3.f6109d
        ...
        L4c:
            f.i.b.n<T> r0 = r3.b
            f.i.b.d0.a<T> r1 = r3.f6109d
            java.lang.reflect.Type r1 = r1.b
            f.i.b.c0.a0.m<T>$b r2 = r3.f6111f
    ...
    public void b(f.i.b.e0.c cVar, T t) throws IOException {
        v<T> vVar = this.a;
        if (vVar == null) {
            z<T> zVar = this.f6112g;
            if (zVar == null) {
                zVar = this.f6108c.g(this.f6110e, this.f6109d);
                this.f6112g = zVar;
            }
            zVar.b(cVar, t);
        } else if (t == null) {
            ...
            o.X.b(cVar, vVar.a(t, this.f6109d.b, this.f6111f));
        }
    }
}
