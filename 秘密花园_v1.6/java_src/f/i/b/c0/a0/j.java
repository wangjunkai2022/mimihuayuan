...
public final class j implements a0 {
    ...
    public final f.i.b.c0.o f6104c;

    /* renamed from: d  reason: collision with root package name */
    public final d f6105d;

    /* renamed from: e  reason: collision with root package name */
    public final f.i.b.c0.b0.b f6106e = f.i.b.c0.b0.b.a;
    ...
    public static final class a<T> extends z<T> {
        ...
        public T a(f.i.b.e0.a aVar) throws IOException {
            ...
            try {
                ...
                while (aVar.I()) {
                    ...
                    if (bVar != null && bVar.f6107c) {
                        i iVar = (i) bVar;
                        Object a2 = iVar.f6100f.a(aVar);
                        if (a2 != null || !iVar.f6103i) {
                            iVar.f6098d.set(a, a2);
                        }
                    }
                    aVar.a0();
                }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:17:0x0042, code lost:
            if (r1.f6099e == false) goto L21;
         */
        /* JADX WARN: Code restructure failed: missing block: B:18:0x0044, code lost:
            r1 = r1.f6100f;
         */
        /* JADX WARN: Code restructure failed: missing block: B:19:0x0047, code lost:
            r1 = new f.i.b.c0.a0.n(r1.f6101g, r1.f6100f, r1.f6102h.b);
         */
        ...
        */
        public void b(f.i.b.e0.c r7, T r8) throws java.io.IOException {
            ...
            L13:
                ...
                goto L31
            L28:
                java.lang.reflect.Field r2 = r2.f6098d     // Catch: java.lang.IllegalAccessException -> L5d
            ...
            L31:
                ...
                java.lang.reflect.Field r2 = r1.f6098d     // Catch: java.lang.IllegalAccessException -> L5d
                java.lang.Object r2 = r2.get(r8)     // Catch: java.lang.IllegalAccessException -> L5d
                boolean r3 = r1.f6099e     // Catch: java.lang.IllegalAccessException -> L5d
                if (r3 == 0) goto L47
                f.i.b.z r1 = r1.f6100f     // Catch: java.lang.IllegalAccessException -> L5d
                goto L55
            L47:
                f.i.b.c0.a0.n r3 = new f.i.b.c0.a0.n     // Catch: java.lang.IllegalAccessException -> L5d
                f.i.b.j r4 = r1.f6101g     // Catch: java.lang.IllegalAccessException -> L5d
                f.i.b.z r5 = r1.f6100f     // Catch: java.lang.IllegalAccessException -> L5d
                f.i.b.d0.a r1 = r1.f6102h     // Catch: java.lang.IllegalAccessException -> L5d
    ...
    */
    ...
    public boolean b(Field field, boolean z) {
        boolean z2;
        f.i.b.c0.o oVar = this.f6104c;
        Class<?> type = field.getType();
        if (!(oVar.b(type) || oVar.c(type, z))) {
            if ((oVar.b & field.getModifiers()) != 0 || ((oVar.a != -1.0d && !oVar.f((f.i.b.b0.c) field.getAnnotation(f.i.b.b0.c.class), (f.i.b.b0.d) field.getAnnotation(f.i.b.b0.d.class))) || field.isSynthetic() || ((!oVar.f6131c && oVar.e(field.getType())) || oVar.d(field.getType())))) {
                z2 = true;
                break;
            }
            List<f.i.b.a> list = z ? oVar.f6132d : oVar.f6133e;
            if (!list.isEmpty()) {
