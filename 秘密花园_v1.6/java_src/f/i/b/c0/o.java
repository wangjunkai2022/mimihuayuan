...
public final class o implements a0, Cloneable {
    ...
    public static final o f6130f = new o();
    ...
    public List<f.i.b.a> f6132d = Collections.emptyList();

    /* renamed from: e  reason: collision with root package name */
    public List<f.i.b.a> f6133e = Collections.emptyList();
    ...
    public class a extends f.i.b.z<T> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ f.i.b.j f6135d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ f.i.b.d0.a f6136e;
        ...
        public T a(f.i.b.e0.a aVar) throws IOException {
            ...
            f.i.b.z zVar = this.a;
            if (zVar == null) {
                zVar = this.f6135d.g(o.this, this.f6136e);
                this.a = zVar;
            }
            return zVar.a(aVar);
        }
    ...
    public final boolean b(Class<?> cls) {
        if (this.a == -1.0d || f((f.i.b.b0.c) cls.getAnnotation(f.i.b.b0.c.class), (f.i.b.b0.d) cls.getAnnotation(f.i.b.b0.d.class))) {
            return (!this.f6131c && e(cls)) || d(cls);
        }
        return true;
    }

    public final boolean c(Class<?> cls, boolean z) {
        for (f.i.b.a aVar : z ? this.f6132d : this.f6133e) {
            if (aVar.a(cls)) {
                return true;
            }
        }
