...
public class c implements Closeable, Flushable {
    ...
    public static final String[] f6173j = new String[128];
    ...
    static {
        for (int i2 = 0; i2 <= 31; i2++) {
            f6173j[i2] = String.format("\\u%04x", Integer.valueOf(i2));
        }
    ...
    */
    public final void M(java.lang.String r9) throws java.io.IOException {
        /*
            r8 = this;
            boolean r0 = r8.f6179g
            if (r0 == 0) goto L7
            java.lang.String[] r0 = f.i.b.e0.c.f6174k
            goto L9
        L7:
            java.lang.String[] r0 = f.i.b.e0.c.f6173j
        L9:
    ...
    public c P(Number number) throws IOException {
        ...
        if (!this.f6178f && (obj.equals("-Infinity") || obj.equals("Infinity") || obj.equals("NaN"))) {
    ...
    public final void d() throws IOException {
        ...
        if (J == 1) {
            ...
            this.a.append((CharSequence) this.f6177e);
            L(5);
        }
    }
