...
public final class s {
    ...
    public static int[] f5770d = new int[10];
    ...
    public static void b(ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            if (i4 < position) {
                ...
                if (i3 == 3) {
                    if (i5 == 1 && (byteBuffer.get(i4) & ac.f3083j) == 7) {
    ...
    */
    ...
    public static boolean d(String str, byte b2) {
        if ("video/avc".equals(str) && (b2 & ac.f3083j) == 6) {
            return true;
        }
    ...
    public static int g(byte[] bArr, int i2) {
        ...
        synchronized (f5769c) {
            ...
            while (i4 < i2) {
                ...
                if (i4 < i2) {
                    if (f5770d.length <= i5) {
                        f5770d = Arrays.copyOf(f5770d, f5770d.length * 2);
                    }
                    f5770d[i5] = i4;
                    i4 += 3;
                    i5++;
