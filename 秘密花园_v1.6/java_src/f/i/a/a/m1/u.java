...
public final class u {
    ...
    public void A(int i2) {
        c.a.a.b.g.h.m(i2 >= 0 && i2 <= this.f5785c);
        this.b = i2;
    }
    ...
    public String e() {
        ...
        int i2 = this.b;
        while (i2 < this.f5785c && !h0.U(this.a[i2])) {
            i2++;
        }
        int i3 = this.b;
        if (i2 - i3 >= 3) {
    ...
    public String k() {
        ...
        int i2 = this.b;
        while (i2 < this.f5785c && this.a[i2] != 0) {
            i2++;
        }
        byte[] bArr = this.a;
        int i3 = this.b;
    ...
    public String l(int i2) {
        ...
        int i3 = (this.b + i2) - 1;
        String w = h0.w(this.a, this.b, (i3 >= this.f5785c || this.a[i3] != 0) ? i2 : i2 - 1);
        this.b += i2;
        return w;
    }
