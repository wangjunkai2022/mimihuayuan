...
public class d extends f {
    ...
    public static final int[] f5490f = new int[0];

    /* renamed from: d  reason: collision with root package name */
    public final j.b f5491d;

    /* renamed from: e  reason: collision with root package name */
    public final AtomicReference<c> f5492e = new AtomicReference<>(c.A);
    ...
    public static final class a {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            a aVar = (a) obj;
            return this.a == aVar.a && this.b == aVar.b && TextUtils.equals(this.f5493c, aVar.f5493c);
        }
    ...
    public static final class b implements Comparable<b> {
        ...
        public b(b0 b0Var, c cVar, int i2) {
            ...
            this.b = cVar;
            int i4 = 0;
            this.f5494c = d.f(i2, false);
            this.f5495d = d.d(b0Var, cVar.a);
            boolean z = true;
            this.f5498g = (b0Var.f4091c & 1) != 0;
            this.f5499h = b0Var.v;
            this.f5500i = b0Var.w;
            int i5 = b0Var.f4093e;
            this.f5501j = i5;
        ...
        public int compareTo(@NonNull b bVar) {
            ...
            if (z2 != bVar.a) {
                return z2 ? 1 : -1;
            } else if (this.b.u && (c2 = d.c(this.f5501j, bVar.f5501j)) != 0) {
                return c2 > 0 ? -1 : 1;
            } else {
                boolean z3 = this.f5498g;
                if (z3 != bVar.f5498g) {
                    return z3 ? 1 : -1;
                }
                int i5 = this.f5496e;
                ...
                return d.b(this.f5501j, bVar.f5501j) * i2;
            }
        }
    }
    ...
    public static final class c extends l {
        ...
        */
        public c() {
            /*
                r26 = this;
                r0 = r26
                f.i.a.a.j1.l r1 = f.i.a.a.j1.l.f5531e
                java.lang.String r11 = r1.a
                java.lang.String r2 = r1.b
                r17 = r2
                boolean r2 = r1.f5532c
                r18 = r2
                int r1 = r1.f5533d
                r19 = r1
        ...
        */
        ...
        @Override // f.i.a.a.j1.l
        public int hashCode() {
            return (((((((((((((((((((((((((((((((((((((super.hashCode() * 31) + this.f5502f) * 31) + this.f5503g) * 31) + this.f5504h) * 31) + this.f5505i) * 31) + (this.f5506j ? 1 : 0)) * 31) + (this.f5507k ? 1 : 0)) * 31) + (this.f5508l ? 1 : 0)) * 31) + (this.o ? 1 : 0)) * 31) + this.f5509m) * 31) + this.n) * 31) + this.p) * 31) + this.q) * 31) + (this.r ? 1 : 0)) * 31) + (this.s ? 1 : 0)) * 31) + (this.t ? 1 : 0)) * 31) + (this.u ? 1 : 0)) * 31) + (this.v ? 1 : 0)) * 31) + (this.w ? 1 : 0)) * 31) + this.x;
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f5504h);
            parcel.writeInt(this.f5505i);
            parcel.writeInt(this.f5506j ? 1 : 0);
            parcel.writeInt(this.f5507k ? 1 : 0);
            parcel.writeInt(this.f5508l ? 1 : 0);
        ...
        public c(Parcel parcel) {
            super(parcel);
            this.f5502f = parcel.readInt();
            this.f5503g = parcel.readInt();
            this.f5504h = parcel.readInt();
            this.f5505i = parcel.readInt();
            this.f5506j = parcel.readInt() != 0;
            this.f5507k = parcel.readInt() != 0;
            this.f5508l = parcel.readInt() != 0;
    ...
    public static final class C0085d extends l.b {
        ...
        public C0085d(c cVar) {
            super(cVar);
            this.f5510e = cVar.f5502f;
            this.f5511f = cVar.f5503g;
            this.f5512g = cVar.f5504h;
            this.f5513h = cVar.f5505i;
            this.f5514i = cVar.f5506j;
            this.f5515j = cVar.f5507k;
            this.f5516k = cVar.f5508l;
            this.f5517l = cVar.f5509m;
            this.f5518m = cVar.n;
            this.n = cVar.o;
            this.o = cVar.p;
            this.p = cVar.q;
        ...
        public c a() {
            return new c(this.f5510e, this.f5511f, this.f5512g, this.f5513h, this.f5514i, this.f5515j, this.f5516k, this.f5517l, this.f5518m, this.n, this.a, this.o, this.p, this.q, this.r, this.s, this.b, this.f5534c, this.f5535d, this.t, this.u, this.v, this.w, this.x, this.y);
        }
    ...
    */
    ...
    public static boolean g(b0 b0Var, int i2, a aVar, int i3, boolean z, boolean z2) {
        ...
        if (f(i2, false)) {
            ...
            if ((i6 == -1 || i6 <= i3) && (i4 = b0Var.v) != -1 && i4 == aVar.a) {
                if (z || ((str = b0Var.f4097i) != null && TextUtils.equals(str, aVar.f5493c))) {
    ...
    public static boolean h(b0 b0Var, @Nullable String str, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        if (str == null || h0.b(b0Var.f4097i, str)) {
            int i8 = b0Var.n;
            if (i8 == -1 || i8 <= i4) {
                int i9 = b0Var.o;
                if (i9 == -1 || i9 <= i5) {
    ...
    public void i(c cVar) {
        m.a aVar;
        if (cVar != null) {
            if (this.f5492e.getAndSet(cVar).equals(cVar) || (aVar = this.a) == null) {
                return;
            }
            aVar.a();
            return;
    ...
    public static final class e implements Parcelable {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            e eVar = (e) obj;
            return this.a == eVar.a && Arrays.equals(this.b, eVar.b) && this.f5520d == eVar.f5520d && this.f5521e == eVar.f5521e;
        }

        public int hashCode() {
            return ((((Arrays.hashCode(this.b) + (this.a * 31)) * 31) + this.f5520d) * 31) + this.f5521e;
        }
