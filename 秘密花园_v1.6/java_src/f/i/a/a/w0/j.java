...
public final class j {
    ...
    public static final j f5952c = new j(new int[]{2}, 8);

    /* renamed from: d  reason: collision with root package name */
    public static final j f5953d = new j(new int[]{2, 5, 6}, 8);
    public final int[] a;
    public final int b;
    ...
    public static j a(Context context) {
        ...
        if ((h0.a >= 17 && "Amazon".equals(h0.f5746c)) && Settings.Global.getInt(context.getContentResolver(), "external_surround_sound_enabled", 0) == 1) {
            return f5953d;
        }
