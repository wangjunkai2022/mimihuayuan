...
public class z extends f.i.a.a.c1.b implements f.i.a.a.m1.q {
    ...
    public int I(MediaCodec mediaCodec, f.i.a.a.c1.a aVar, f.i.a.a.b0 b0Var, f.i.a.a.b0 b0Var2) {
        if (o0(aVar, b0Var2) <= this.t0 && b0Var.y == 0 && b0Var.z == 0 && b0Var2.y == 0 && b0Var2.z == 0) {
            ...
            if (h0.b(b0Var.f4097i, b0Var2.f4097i) && b0Var.v == b0Var2.v && b0Var.w == b0Var2.w && b0Var.w(b0Var2)) {
                return 1;
            }
        }
        return 0;
    ...
    public void J(f.i.a.a.c1.a aVar, MediaCodec mediaCodec, f.i.a.a.b0 b0Var, MediaCrypto mediaCrypto, float f2) {
        f.i.a.a.b0[] b0VarArr = this.f5846f;
        ...
        this.t0 = o0;
        this.v0 = h0.a < 24 && "OMX.SEC.aac.dec".equals(aVar.a) && "samsung".equals(h0.f5746c) && (h0.b.startsWith("zeroflte") || h0.b.startsWith("herolte") || h0.b.startsWith("heroqlte"));
        this.w0 = h0.a < 21 && "OMX.SEC.mp3.dec".equals(aVar.a) && "samsung".equals(h0.f5746c) && (h0.b.startsWith("baffin") || h0.b.startsWith("grand") || h0.b.startsWith("fortuna") || h0.b.startsWith("gprimelte") || h0.b.startsWith("j2y18lte") || h0.b.startsWith("ms01"));
        boolean z = aVar.f4609g;
        this.u0 = z;
        String str = z ? "audio/raw" : aVar.f4605c;
        int i2 = this.t0;
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString("mime", str);
        mediaFormat.setInteger("channel-count", b0Var.v);
        mediaFormat.setInteger("sample-rate", b0Var.w);
        c.a.a.b.g.h.i1(mediaFormat, b0Var.f4099k);
        c.a.a.b.g.h.S0(mediaFormat, "max-input-size", i2);
        if (h0.a >= 23) {
            mediaFormat.setInteger("priority", 0);
            if (f2 != -1.0f) {
                if (!(h0.a == 23 && ("ZTE B2017G".equals(h0.f5747d) || "AXON 7 mini".equals(h0.f5747d)))) {
                    mediaFormat.setFloat("operating-rate", f2);
                }
            }
        }
        if (h0.a <= 28 && "audio/ac4".equals(b0Var.f4097i)) {
            mediaFormat.setInteger("ac4-is-sync", 1);
        }
        mediaCodec.configure(mediaFormat, (Surface) null, mediaCrypto, 0);
        if (this.u0) {
            this.x0 = mediaFormat;
            mediaFormat.setString("mime", b0Var.f4097i);
            return;
        }
        this.x0 = null;
    }
    ...
    public List<f.i.a.a.c1.a> R(f.i.a.a.c1.c cVar, f.i.a.a.b0 b0Var, boolean z) throws d.c {
        f.i.a.a.c1.a b2;
        if ((p0(b0Var.v, b0Var.f4097i) != 0) && (b2 = cVar.b()) != null) {
            return Collections.singletonList(b2);
        }
        List<f.i.a.a.c1.a> a2 = cVar.a(b0Var.f4097i, z, false);
        if ("audio/eac3-joc".equals(b0Var.f4097i)) {
    ...
    public void W(final f.i.a.a.b0 b0Var) throws f.i.a.a.w {
        ...
        this.y0 = "audio/raw".equals(b0Var.f4097i) ? b0Var.x : 2;
        this.z0 = b0Var.v;
        this.A0 = b0Var.y;
        this.B0 = b0Var.z;
    }
    ...
    public void X(MediaCodec mediaCodec, MediaFormat mediaFormat) throws f.i.a.a.w {
        ...
        try {
            ...
            throw f.i.a.a.w.a(e2, this.f5843c);
        }
    }
    ...
    public void Z(f.i.a.a.y0.e eVar) {
        if (this.D0 && !eVar.g()) {
            if (Math.abs(eVar.f6040d - this.C0) > 500000) {
                this.C0 = eVar.f6040d;
            }
            this.D0 = false;
        }
        this.F0 = Math.max(eVar.f6040d, this.F0);
    }
    ...
    */
    public int k0(f.i.a.a.c1.c r11, f.i.a.a.z0.g<f.i.a.a.z0.j> r12, f.i.a.a.b0 r13) throws f.i.a.a.c1.d.c {
        /*
            r10 = this;
            java.lang.String r0 = r13.f4097i
        ...
        L70:
            ...
            if (r6 == 0) goto L8c
            if (r8 == 0) goto L8b
            java.lang.String r12 = r13.f4097i
    ...
    */
    ...
    public j0 s(j0 j0Var) {
        ...
        j0 j0Var3 = vVar.q;
        if (j0Var3 == null) {
            if (!vVar.f5991j.isEmpty()) {
                j0Var3 = vVar.f5991j.getLast().a;
            } else {
                j0Var3 = vVar.r;
            }
        }
