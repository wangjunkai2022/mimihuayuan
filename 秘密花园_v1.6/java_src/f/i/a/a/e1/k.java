...
public final class k implements d0 {
    ...
    public static final String f4713e = f(3, 4);

    /* renamed from: f  reason: collision with root package name */
    public static final String[] f4714f = {"id", NotificationCompatJellybean.KEY_TITLE, "uri", "stream_keys", "custom_cache_key", "data", "state", "start_time_ms", "update_time_ms", "content_length", "stop_reason", "failure_reason", "percent_downloaded", "bytes_downloaded"};
    public final String a = "";
    public final String b = "ExoPlayerDownloads";

    /* renamed from: c  reason: collision with root package name */
    public final f.i.a.a.x0.b f4715c;
    ...
    public final void a() throws f.i.a.a.x0.a {
        ...
        try {
            if (c.a.a.b.g.h.a0(((SQLiteOpenHelper) this.f4715c).getReadableDatabase(), 0, this.a) != 2) {
                SQLiteDatabase writableDatabase = ((SQLiteOpenHelper) this.f4715c).getWritableDatabase();
                writableDatabase.beginTransaction();
                c.a.a.b.g.h.n1(writableDatabase, 0, this.a, 2);
    ...
    public final Cursor b(String str, @Nullable String[] strArr) throws f.i.a.a.x0.a {
        try {
            return ((SQLiteOpenHelper) this.f4715c).getReadableDatabase().query(this.b, f4714f, str, strArr, null, null, "start_time_ms ASC");
    ...
    public void g(m mVar) throws f.i.a.a.x0.a {
        ...
        contentValues.put("uri", mVar.a.f4772c.toString());
        List<c0> list = mVar.a.f4773d;
        ...
        contentValues.put("custom_cache_key", mVar.a.f4774e);
        contentValues.put("data", mVar.a.f4775f);
        contentValues.put("state", Integer.valueOf(mVar.b));
        contentValues.put("start_time_ms", Long.valueOf(mVar.f4719c));
        contentValues.put("update_time_ms", Long.valueOf(mVar.f4720d));
        contentValues.put("content_length", Long.valueOf(mVar.f4721e));
        contentValues.put("stop_reason", Integer.valueOf(mVar.f4722f));
        contentValues.put("failure_reason", Integer.valueOf(mVar.f4723g));
        contentValues.put("percent_downloaded", Float.valueOf(mVar.f4724h.b));
        contentValues.put("bytes_downloaded", Long.valueOf(mVar.f4724h.a));
        try {
            ((SQLiteOpenHelper) this.f4715c).getWritableDatabase().replaceOrThrow(this.b, null, contentValues);
        } catch (SQLiteException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
    ...
    public void h() throws f.i.a.a.x0.a {
        ...
        try {
            ...
            ((SQLiteOpenHelper) this.f4715c).getWritableDatabase().update(this.b, contentValues, "state = 2", null);
        } catch (SQLException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
    ...
    public void i(int i2) throws f.i.a.a.x0.a {
        ...
        try {
            ...
            ((SQLiteOpenHelper) this.f4715c).getWritableDatabase().update(this.b, contentValues, f4713e, null);
        } catch (SQLException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
    ...
    public void j(String str, int i2) throws f.i.a.a.x0.a {
        ...
        try {
            ...
            SQLiteDatabase writableDatabase = ((SQLiteOpenHelper) this.f4715c).getWritableDatabase();
            String str2 = this.b;
            writableDatabase.update(str2, contentValues, f4713e + " AND id = ?", new String[]{str});
        } catch (SQLException e2) {
            throw new f.i.a.a.x0.a(e2);
        }
    }
