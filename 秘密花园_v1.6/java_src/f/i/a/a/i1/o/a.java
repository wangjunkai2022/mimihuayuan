                ...
                if (p != 128) {
                    switch (p) {
                                ...
                                if (u >= 4) {
                                    ...
                                    if ((uVar5.p() & 128) != 0) {
                                        if (i10 >= 7 && (r = uVar5.r()) >= 4) {
                                            c0082a.f5407h = uVar5.u();
                                            c0082a.f5408i = uVar5.u();
                                            c0082a.a.w(r - 4);
                                            i10 -= 7;
                                        }
                                    }
                        ...
                        case 22:
                            if (c0082a != null) {
                                if (u >= 19) {
                                    c0082a.f5403d = uVar5.u();
                                    c0082a.f5404e = uVar5.u();
                                    uVar5.B(11);
                                    c0082a.f5405f = uVar5.u();
                                    c0082a.f5406g = uVar5.u();
                                }
                                uVar = uVar5;
                                bVar = null;
                                break;
                    ...
                    uVar = uVar5;
                    if (c0082a.f5403d == 0 || c0082a.f5404e == 0 || c0082a.f5407h == 0 || c0082a.f5408i == 0 || (i3 = (uVar2 = c0082a.a).f5785c) == 0 || uVar2.b != i3 || !c0082a.f5402c) {
                        bVar2 = null;
                    } else {
                        uVar2.A(0);
                        int i13 = c0082a.f5407h * c0082a.f5408i;
                        ...
                        Bitmap createBitmap = Bitmap.createBitmap(iArr, c0082a.f5407h, c0082a.f5408i, Bitmap.Config.ARGB_8888);
                        float f2 = c0082a.f5403d;
                        float f3 = c0082a.f5404e;
                        bVar2 = new f.i.a.a.i1.b(createBitmap, c0082a.f5405f / f2, 0, c0082a.f5406g / f3, 0, c0082a.f5407h / f2, c0082a.f5408i / f3);
                    }
                    c0082a.a();
                }
                uVar.A(i7);
