...
public abstract class c extends f.i.a.a.y0.g<i, j, g> implements f {
    public c(String str) {
        ...
        c.a.a.b.g.h.v(this.f6046g == this.f6044e.length);
        for (f.i.a.a.y0.e eVar : this.f6044e) {
            eVar.k(1024);
        }
    }
    ...
    public g f(i iVar, j jVar, boolean z) {
        ...
        j jVar2 = jVar;
        try {
            ByteBuffer byteBuffer = iVar2.f6039c;
            e k2 = k(byteBuffer.array(), byteBuffer.limit(), z);
            long j2 = iVar2.f6040d;
            long j3 = iVar2.f5323f;
            jVar2.b = j2;
            jVar2.f5324c = k2;
