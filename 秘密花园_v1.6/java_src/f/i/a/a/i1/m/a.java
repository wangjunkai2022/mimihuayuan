...
public final class a extends d {
    ...
    public List<f.i.a.a.i1.b> f5336m;
    ...
    public final u f5330g = new u();

    /* renamed from: k  reason: collision with root package name */
    public final ArrayList<C0079a> f5334k = new ArrayList<>();

    /* renamed from: l  reason: collision with root package name */
    public C0079a f5335l = new C0079a(0, 4);
    public int u = 0;
    ...
    public static class C0079a {
        ...
        public final StringBuilder f5337c = new StringBuilder();
        ...
        public void a() {
            int length = this.f5337c.length();
            if (length > 0) {
                this.f5337c.delete(length - 1, length);
                for (int size = this.a.size() - 1; size >= 0; size--) {
                    C0080a c0080a = this.a.get(size);
                    int i2 = c0080a.f5343c;
                    if (i2 != length) {
                        return;
                    }
                    c0080a.f5343c = i2 - 1;
        ...
        public f.i.a.a.i1.b b(int i2) {
            ...
            int i6 = this.f5339e + this.f5340f;
            int length = (32 - i6) - spannableStringBuilder.length();
            int i7 = i6 - length;
            if (i2 == Integer.MIN_VALUE) {
                if (this.f5341g != 2 || (Math.abs(i7) >= 3 && length >= 0)) {
                    i2 = (this.f5341g != 2 || i7 <= 0) ? 0 : 2;
                } else {
                    i2 = 1;
                }
            }
            ...
            if (this.f5341g == 1 || (i3 = this.f5338d) > 7) {
                i3 = (this.f5338d - 15) - 2;
                i4 = 2;
            } else {
                i4 = 0;
        ...
        public final SpannableString c() {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f5337c);
            ...
            while (i2 < this.a.size()) {
                ...
                int i9 = c0080a.f5343c;
                i2++;
                if (i9 != (i2 < this.a.size() ? this.a.get(i2).f5343c : length)) {
                    if (i3 != -1 && !z2) {
        ...
        public boolean d() {
            return this.a.isEmpty() && this.b.isEmpty() && this.f5337c.length() == 0;
        }
    ...
    public a(String str, int i2) {
        this.f5331h = "application/x-mp4-cea-608".equals(str) ? 2 : 3;
        if (i2 == 1) {
            this.f5333j = 0;
            this.f5332i = 0;
        } else if (i2 == 2) {
    ...
    public f.i.a.a.i1.e f() {
        List<f.i.a.a.i1.b> list = this.f5336m;
        this.n = list;
        return new e(list);
    }
    ...
    */
    ...
    @Override // f.i.a.a.i1.m.d
    public boolean h() {
        return this.f5336m != this.n;
    }

    public final List<f.i.a.a.i1.b> j() {
        int size = this.f5334k.size();
        ArrayList arrayList = new ArrayList(size);
        int i2 = 2;
        for (int i3 = 0; i3 < size; i3++) {
            f.i.a.a.i1.b b = this.f5334k.get(i3).b(Integer.MIN_VALUE);
            arrayList.add(b);
            if (b != null) {
                i2 = Math.min(i2, b.f5316h);
            }
        }
    ...
    public final void k() {
        this.f5335l.e(this.o);
        this.f5334k.clear();
        this.f5334k.add(this.f5335l);
    }
    ...
    public final void l(int i2) {
        ...
        this.o = i2;
        if (i2 == 3) {
            for (int i4 = 0; i4 < this.f5334k.size(); i4++) {
                this.f5334k.get(i4).f5341g = i2;
            }
            return;
        }
        k();
        if (i3 == 3 || i2 == 1 || i2 == 0) {
            this.f5336m = Collections.emptyList();
        }
    }

    public final void m(int i2) {
        this.p = i2;
        this.f5335l.f5342h = i2;
    }
}
