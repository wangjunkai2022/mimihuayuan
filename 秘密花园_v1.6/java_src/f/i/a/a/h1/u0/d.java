...
public class d implements f.i.a.a.l1.m {
    ...
    public final byte[] f5109c;
    @Nullable

    /* renamed from: d  reason: collision with root package name */
    public CipherInputStream f5110d;
    ...
    public final long b(f.i.a.a.l1.p pVar) throws IOException {
        try {
            ...
            try {
                cipher.init(2, new SecretKeySpec(this.b, "AES"), new IvParameterSpec(this.f5109c));
                f.i.a.a.l1.o oVar = new f.i.a.a.l1.o(this.a, pVar);
                this.f5110d = new CipherInputStream(oVar, cipher);
                if (oVar.f5684d) {
                    return -1L;
                }
                oVar.a.b(oVar.b);
    ...
    public final int read(byte[] bArr, int i2, int i3) throws IOException {
        c.a.a.b.g.h.t(this.f5110d);
        int read = this.f5110d.read(bArr, i2, i3);
        if (read < 0) {
            return -1;
        }
        return read;
