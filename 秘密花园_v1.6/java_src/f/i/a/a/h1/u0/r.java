...
public final class r implements f.i.a.a.b1.g {
    ...
    public static final Pattern f5158g = Pattern.compile("LOCAL:([^,]+)");

    /* renamed from: h  reason: collision with root package name */
    public static final Pattern f5159h = Pattern.compile("MPEGTS:(\\d+)");
    public final String a;
    public final e0 b;

    /* renamed from: d  reason: collision with root package name */
    public f.i.a.a.b1.h f5161d;

    /* renamed from: f  reason: collision with root package name */
    public int f5163f;

    /* renamed from: c  reason: collision with root package name */
    public final u f5160c = new u();

    /* renamed from: e  reason: collision with root package name */
    public byte[] f5162e = new byte[1024];
    ...
    public final f.i.a.a.b1.p b(long j2) {
        f.i.a.a.b1.p q = this.f5161d.q(0, 3);
    ...
    public int c(f.i.a.a.b1.d dVar, f.i.a.a.b1.m mVar) throws IOException, InterruptedException {
        Matcher matcher;
        String e2;
        int i2 = (int) dVar.f4125c;
        int i3 = this.f5163f;
        byte[] bArr = this.f5162e;
        if (i3 == bArr.length) {
            this.f5162e = Arrays.copyOf(bArr, ((i2 != -1 ? i2 : bArr.length) * 3) / 2);
        }
        byte[] bArr2 = this.f5162e;
        int i4 = this.f5163f;
        int e3 = dVar.e(bArr2, i4, bArr2.length - i4);
        if (e3 != -1) {
            int i5 = this.f5163f + e3;
            this.f5163f = i5;
            if (i2 == -1 || i5 != i2) {
                return 0;
            }
        }
        u uVar = new u(this.f5162e);
        ...
        while (true) {
            ...
            if (TextUtils.isEmpty(e4)) {
                ...
                if (matcher == null) {
                    ...
                    this.f5160c.y(this.f5162e, this.f5163f);
                    b2.a(this.f5160c, this.f5163f);
                    b2.c(b, 1, this.f5163f, 0, null);
                }
                return -1;
            } else if (e4.startsWith("X-TIMESTAMP-MAP")) {
                Matcher matcher2 = f5158g.matcher(e4);
                if (matcher2.find()) {
                    Matcher matcher3 = f5159h.matcher(e4);
                    if (matcher3.find()) {
    ...
    public boolean i(f.i.a.a.b1.d dVar) throws IOException, InterruptedException {
        dVar.d(this.f5162e, 0, 6, false);
        this.f5160c.y(this.f5162e, 6);
        if (f.i.a.a.i1.t.h.a(this.f5160c)) {
            return true;
        }
        dVar.d(this.f5162e, 6, 3, false);
        this.f5160c.y(this.f5162e, 9);
        return f.i.a.a.i1.t.h.a(this.f5160c);
    }
}
