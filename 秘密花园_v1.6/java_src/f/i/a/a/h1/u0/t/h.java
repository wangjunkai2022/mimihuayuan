...
public final class h implements e0.a<g> {
    ...
    public static final Pattern f5218c = Pattern.compile("VIDEO=\"(.+?)\"");

    /* renamed from: d  reason: collision with root package name */
    public static final Pattern f5219d = Pattern.compile("AUDIO=\"(.+?)\"");

    /* renamed from: e  reason: collision with root package name */
    public static final Pattern f5220e = Pattern.compile("SUBTITLES=\"(.+?)\"");

    /* renamed from: f  reason: collision with root package name */
    public static final Pattern f5221f = Pattern.compile("CLOSED-CAPTIONS=\"(.+?)\"");

    /* renamed from: g  reason: collision with root package name */
    public static final Pattern f5222g = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");

    /* renamed from: h  reason: collision with root package name */
    public static final Pattern f5223h = Pattern.compile("CHANNELS=\"(.+?)\"");

    /* renamed from: i  reason: collision with root package name */
    public static final Pattern f5224i = Pattern.compile("CODECS=\"(.+?)\"");

    /* renamed from: j  reason: collision with root package name */
    public static final Pattern f5225j = Pattern.compile("RESOLUTION=(\\d+x\\d+)");

    /* renamed from: k  reason: collision with root package name */
    public static final Pattern f5226k = Pattern.compile("FRAME-RATE=([\\d\\.]+)\\b");

    /* renamed from: l  reason: collision with root package name */
    public static final Pattern f5227l = Pattern.compile("#EXT-X-TARGETDURATION:(\\d+)\\b");

    /* renamed from: m  reason: collision with root package name */
    public static final Pattern f5228m = Pattern.compile("#EXT-X-VERSION:(\\d+)\\b");
    ...
    public static class a {
        ...
        public boolean a() throws IOException {
            ...
            if (!this.b.isEmpty()) {
                this.f5229c = this.b.poll();
                return true;
            }
            do {
                String readLine = this.a.readLine();
                this.f5229c = readLine;
                if (readLine == null) {
                    return false;
                }
                trim = readLine.trim();
    ...
    public static e.b c(String str, String str2, Map<String, String> map) throws h0 {
        ...
        if ("urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2)) {
            ...
            return new e.b(q.f5851d, "video/mp4", Base64.decode(k2.substring(k2.indexOf(44)), 0));
        } else if ("com.widevine".equals(str2)) {
            return new e.b(q.f5851d, "hls", f.i.a.a.m1.h0.O(str));
        } else {
            if ("com.microsoft.playready".equals(str2) && UMRTLog.RTLOG_ENABLE.equals(i2)) {
                String k3 = k(str, x, map);
                return new e.b(q.f5852e, "video/mp4", c.a.a.b.g.h.i(q.f5852e, Base64.decode(k3.substring(k3.indexOf(44)), 0)));
            }
            return null;
        }
    }
    ...
    public static e f(a aVar, String str) throws IOException {
            ...
            if (b2.startsWith("#EXT-X-DEFINE")) {
                ...
                if (b2.startsWith("#EXT-X-SESSION-KEY")) {
                    ...
                    if (b2.startsWith("#EXT-X-STREAM-INF")) {
                        ...
                        String j3 = j(b2, f5224i, hashMap3);
                        String j4 = j(b2, f5225j, hashMap3);
                        if (j4 != null) {
                        ...
                        String j5 = j(b2, f5226k, hashMap3);
                        float parseFloat = j5 != null ? Float.parseFloat(j5) : -1.0f;
                        String j6 = j(b2, f5218c, hashMap3);
                        String j7 = j(b2, f5219d, hashMap3);
                        String j8 = j(b2, f5220e, hashMap3);
                        String j9 = j(b2, f5221f, hashMap3);
                        Uri g1 = c.a.a.b.g.h.g1(str4, l(aVar.b(), hashMap3));
                        ArrayList arrayList12 = arrayList10;
                        arrayList4.add(new e.b(g1, b0.s(Integer.toString(arrayList4.size()), null, "application/x-mpegURL", null, j3, e2, i5, i6, parseFloat, null, 0, 0), j6, j7, j8, j9));
                        ArrayList arrayList13 = (ArrayList) hashMap2.get(g1);
                        if (arrayList13 == null) {
                            arrayList13 = new ArrayList();
                            hashMap2.put(g1, arrayList13);
                        }
        ...
        while (true) {
            ...
            if (hashSet2.add(bVar3.a)) {
                c.a.a.b.g.h.v(bVar3.b.f4095g == null);
                hashMap = hashMap2;
                hashSet = hashSet2;
                arrayList17.add(new e.b(bVar3.a, bVar3.b.e(new f.i.a.a.d1.a(new o(null, null, (List) hashMap2.get(bVar3.a)))), bVar3.f5194c, bVar3.f5195d, bVar3.f5196e, bVar3.f5197f));
            } else {
                hashMap = hashMap2;
                hashSet = hashSet2;
            }
        ...
        while (i9 < arrayList9.size()) {
            ...
            Uri g12 = j10 == null ? null : c.a.a.b.g.h.g1(str4, j10);
            ...
            if (c2 == 0) {
                ...
                if (bVar != null) {
                    b0 b0Var3 = bVar.b;
                    String y2 = f.i.a.a.m1.h0.y(b0Var3.f4094f, 2);
                    int i12 = b0Var3.n;
                    int i13 = b0Var3.o;
                    f2 = b0Var3.p;
                    str2 = y2;
                ...
                if (g12 != null) {
                    arrayList5.add(new e.a(g12, e3, k2, k3));
                }
            } else if (c2 == 1) {
                int i14 = 0;
                while (true) {
                ...
                String y3 = bVar2 != null ? f.i.a.a.m1.h0.y(bVar2.b.f4094f, 1) : null;
                String c4 = y3 != null ? r.c(y3) : null;
                String j13 = j(str5, f5223h, hashMap3);
                ...
                if (g12 == null) {
                    ...
                    arrayList6.add(new e.a(g12, g3.e(aVar2), k2, k3));
                }
            } else if (c2 == 2) {
                arrayList7.add(new e.a(g12, b0.o(g2, k3, "application/x-mpegURL", "text/vtt", null, -1, z6 ? 1 : 0, i2, j11).e(aVar2), k2, k3));
            } else if (c2 == 3) {
                        ...
                        if (b2.startsWith("#EXT-X-TARGETDURATION")) {
                            ...
                            if (b2.startsWith("#EXT-X-MEDIA-SEQUENCE")) {
                                ...
                                if (b2.startsWith("#EXT-X-DEFINE")) {
                                    ...
                                    if (j22 != null) {
                                        String str10 = eVar3.f5191j.get(j22);
                                        if (str10 != null) {
                                    ...
                                    if (eVar5 != null || treeMap2.isEmpty()) {
                                        ...
                                        if (eVar4 == null) {
                                            ...
                                            while (i11 < bVarArr.length) {
                                                ...
                                                bVarArr2[i11] = new e.b(bVar.b, bVar.f6082c, bVar.f6083d, null, bVar.f6085f);
                                                i11++;
                                                str7 = str7;
                                                j23 = j23;
                                            }
