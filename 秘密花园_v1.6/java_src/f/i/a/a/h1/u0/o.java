...
public final class o implements a.b {
    ...
    public o(@Nullable String str, @Nullable String str2, List<b> list) {
        this.a = str;
        this.b = str2;
        this.f5154c = Collections.unmodifiableList(new ArrayList(list));
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        o oVar = (o) obj;
        return TextUtils.equals(this.a, oVar.a) && TextUtils.equals(this.b, oVar.b) && this.f5154c.equals(oVar.f5154c);
    }
    ...
    public int hashCode() {
        ...
        String str2 = this.b;
        return this.f5154c.hashCode() + ((hashCode + (str2 != null ? str2.hashCode() : 0)) * 31);
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            parcel.writeParcelable(this.f5154c.get(i3), 0);
        }
    }
    ...
    public o(Parcel parcel) {
        ...
        this.f5154c = Collections.unmodifiableList(arrayList);
    }
    ...
    public static final class b implements Parcelable {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            b bVar = (b) obj;
            return this.a == bVar.a && TextUtils.equals(this.b, bVar.b) && TextUtils.equals(this.f5155c, bVar.f5155c) && TextUtils.equals(this.f5156d, bVar.f5156d) && TextUtils.equals(this.f5157e, bVar.f5157e);
        }
