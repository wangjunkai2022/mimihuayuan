...
public final class k extends f.i.a.a.h1.s0.l {
    ...
    public final Uri f5129l;
    @Nullable

    /* renamed from: m  reason: collision with root package name */
    public final f.i.a.a.l1.m f5130m;
    @Nullable
    ...
    public static k e(i iVar, f.i.a.a.l1.m mVar, b0 b0Var, long j2, f.i.a.a.h1.u0.t.f fVar, int i2, Uri uri, @Nullable List<b0> list, int i3, @Nullable Object obj, boolean z, q qVar, @Nullable k kVar, @Nullable byte[] bArr, @Nullable byte[] bArr2) {
        ...
        f.i.a.a.l1.p pVar2 = new f.i.a.a.l1.p(c.a.a.b.g.h.g1(fVar.a, aVar.a), aVar.f5214i, aVar.f5215j, null);
        boolean z4 = bArr != null;
        f.i.a.a.l1.m dVar2 = bArr != null ? new d(dVar, bArr, z4 ? g(aVar.f5213h) : null) : dVar;
        f.a aVar2 = aVar.b;
        if (aVar2 != null) {
            boolean z5 = bArr2 != null;
            byte[] g2 = z5 ? g(aVar2.f5213h) : null;
            boolean z6 = z5;
            f.i.a.a.l1.p pVar3 = new f.i.a.a.l1.p(c.a.a.b.g.h.g1(fVar.a, aVar2.a), aVar2.f5214i, aVar2.f5215j, null);
            if (bArr2 != null) {
        ...
        long j3 = j2 + aVar.f5210e;
        long j4 = j3 + aVar.f5208c;
        int i4 = fVar.f5202h + aVar.f5209d;
        if (kVar != null) {
            f.i.a.a.d1.i.g gVar3 = kVar.w;
            u uVar2 = kVar.x;
            boolean z7 = (uri.equals(kVar.f5129l) && kVar.G) ? false : true;
            gVar = gVar3;
            uVar = uVar2;
            gVar2 = (kVar.B && kVar.f5128k == i4 && !z7) ? kVar.A : null;
            z3 = z7;
        } else {
        ...
        long j5 = fVar.f5203i + i2;
        boolean z8 = aVar.f5216k;
        e0 e0Var = qVar.a.get(i4);
        if (e0Var == null) {
            e0Var = new e0(RecyclerView.FOREVER_NS);
            qVar.a.put(i4, e0Var);
        }
        return new k(iVar, dVar2, pVar2, b0Var, z4, mVar2, pVar, z2, uri, list, i3, obj, j3, j4, j5, i4, z8, z, e0Var, aVar.f5211f, gVar2, gVar, uVar, z3);
    }
    ...
    public void a() throws IOException, InterruptedException {
        ...
        if (this.A == null && (gVar = this.v) != null) {
            ...
            this.B = true;
            this.E = false;
            this.C.y(this.f5127j, this.r, true);
        }
        if (this.E) {
            f(this.f5130m, this.n, this.z);
            this.D = 0;
            this.E = false;
        }
        if (this.F) {
        ...
        if (!this.p) {
            if (!this.o) {
                e0 e0Var = this.q;
                synchronized (e0Var) {
                    while (e0Var.f5745c == -9223372036854775807L) {
                        e0Var.wait();
                    }
                }
            } else {
                ...
                if (e0Var2.a == RecyclerView.FOREVER_NS) {
                    e0Var2.d(this.f4954f);
                }
            }
            f(this.f4956h, this.a, this.y);
        }
        this.G = true;
    }
    ...
    public final void f(f.i.a.a.l1.m mVar, f.i.a.a.l1.p pVar, boolean z) throws IOException, InterruptedException {
        ...
        try {
            ...
            this.D = (int) (h2.f4126d - pVar.f5688d);
        } finally {
            h0.k(mVar);
        }
    }
    ...
    public final f.i.a.a.b1.d h(f.i.a.a.l1.m mVar, f.i.a.a.l1.p pVar) throws IOException, InterruptedException {
        long j2;
        j0[] j0VarArr;
        f.i.a.a.b1.d dVar = new f.i.a.a.b1.d(mVar, pVar.f5688d, mVar.b(pVar));
        if (this.A == null) {
            dVar.f4128f = 0;
            try {
                        ...
                        for (int i3 = 0; i3 < length; i3++) {
                            ...
                            if (bVar instanceof f.i.a.a.d1.i.k) {
                                ...
                                if ("com.apple.streaming.transportStreamTimestamp".equals(kVar.b)) {
                                    System.arraycopy(kVar.f4662c, 0, this.x.a, 0, 8);
                                    this.x.w(8);
            ...
            dVar.f4128f = 0;
            i.a a = this.s.a(this.v, pVar.a, this.f4951c, this.t, this.u, this.q, mVar.a(), dVar);
            this.A = a.a;
            this.B = a.f5126c;
            if (a.b) {
                n nVar = this.C;
                long b = j2 != -9223372036854775807L ? this.q.b(j2) : this.f4954f;
                nVar.R = b;
                for (j0 j0Var : nVar.q) {
                    if (j0Var.f4896l != b) {
                        j0Var.f4896l = b;
            ...
            this.C.y(this.f5127j, this.r, false);
            this.A.d(this.C);
            return dVar;
        }
        return dVar;
