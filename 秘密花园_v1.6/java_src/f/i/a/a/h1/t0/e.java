...
public final class e implements d0, l0.a<f.i.a.a.h1.s0.g<c>>, g.b<c> {
    ...
    public final f.i.a.a.l1.d0 f4993f;

    /* renamed from: g  reason: collision with root package name */
    public final f.i.a.a.l1.e f4994g;

    /* renamed from: h  reason: collision with root package name */
    public final p0 f4995h;

    /* renamed from: i  reason: collision with root package name */
    public final a[] f4996i;

    /* renamed from: j  reason: collision with root package name */
    public final v f4997j;

    /* renamed from: k  reason: collision with root package name */
    public final j f4998k;

    /* renamed from: m  reason: collision with root package name */
    public final f0.a f5000m;
    @Nullable
    public d0.a n;
    public l0 q;
    ...
    public final IdentityHashMap<f.i.a.a.h1.s0.g<c>, j.c> f4999l = new IdentityHashMap<>();
    ...
    public e(int i2, f.i.a.a.h1.t0.k.b bVar, int i3, c.a aVar, @Nullable i0 i0Var, b0 b0Var, f0.a aVar2, long j2, f.i.a.a.l1.d0 d0Var, f.i.a.a.l1.e eVar, v vVar, j.b bVar2) {
        ...
        this.f4994g = eVar;
        this.f4997j = vVar;
        this.f4998k = new j(bVar, bVar2, eVar);
        f.i.a.a.h1.s0.g<c>[] gVarArr = this.o;
        if (vVar != null) {
            this.q = new t(gVarArr);
            f.i.a.a.h1.t0.k.f fVar = bVar.f5049l.get(i3);
            List<f.i.a.a.h1.t0.k.e> list2 = fVar.f5061d;
            this.t = list2;
            List<f.i.a.a.h1.t0.k.a> list3 = fVar.f5060c;
            int size = list3.size();
            ...
            for (int i9 = 0; i9 < size; i9++) {
                if (!zArr[i9]) {
                    zArr[i9] = true;
                    List<f.i.a.a.h1.t0.k.d> list4 = list3.get(i9).f5039e;
                    int i10 = 0;
                    while (true) {
                        if (i10 >= list4.size()) {
                            dVar = null;
            ...
            for (int i14 = 0; i14 < length2; i14++) {
                ...
                while (true) {
                    ...
                    List<f.i.a.a.h1.t0.k.i> list5 = list3.get(iArr4[i15]).f5037c;
                    for (int i16 = 0; i16 < list5.size(); i16++) {
                        if (!list5.get(i16).f5068d.isEmpty()) {
                            z = true;
                            break;
                        }
                    }
                ...
                while (true) {
                    ...
                    List<f.i.a.a.h1.t0.k.d> list6 = list3.get(i18).f5038d;
                    int i19 = 0;
            ...
            while (i23 < length2) {
                ...
                int i24 = 0;
                while (i24 < length5) {
                    arrayList.addAll(list3.get(iArr7[i24]).f5037c);
                    i24++;
                    length2 = length2;
                }
                int i25 = length2;
            ...
            this.f4995h = (p0) create.first;
            this.f4996i = (a[]) create.second;
            aVar2.y();
            return;
        }
        throw null;
    ...
    public final int d(int i2, int[] iArr) {
        ...
        int i4 = this.f4996i[i3].f5003e;
        for (int i5 = 0; i5 < iArr.length; i5++) {
            int i6 = iArr[i5];
            if (i6 == i4 && this.f4996i[i6].f5001c == 0) {
                return i5;
            }
        }
        return -1;
    ...
    public long j(f.i.a.a.j1.j[] jVarArr, boolean[] zArr, k0[] k0VarArr, boolean[] zArr2, long j2) {
        ...
        while (true) {
            ...
            if (jVarArr2[i6] != null) {
                iArr3[i6] = this.f4995h.a(jVarArr2[i6].j());
            } else {
                iArr3[i6] = -1;
            }
            i6++;
        ...
        while (i9 < jVarArr2.length) {
            ...
            if (jVar == null) {
                ...
                zArr2[i9] = z;
                a aVar = this.f4996i[iArr3[i9]];
                int i10 = aVar.f5001c;
                if (i10 == 0) {
                    boolean z2 = aVar.f5004f != i2;
                    if (z2) {
                        o0Var = this.f4995h.b[aVar.f5004f];
                        i4 = 1;
                    } else {
                        o0Var = null;
                        i4 = 0;
                    }
                    boolean z3 = aVar.f5005g != i2;
                    if (z3) {
                        o0Var2 = this.f4995h.b[aVar.f5005g];
                        i4 += o0Var2.a;
                    } else {
                        o0Var2 = null;
                    }
                    ...
                    i3 = i9;
                    iArr2 = iArr3;
                    f.i.a.a.h1.s0.g<c> gVar = new f.i.a.a.h1.s0.g<>(aVar.b, iArr4, b0VarArr, this.b.a(this.f4993f, this.r, this.s, aVar.a, jVar, aVar.b, this.f4992e, z2, arrayList, cVar2, this.f4990c), this, this.f4994g, j2, this.f4991d, this.f5000m);
                    synchronized (this) {
                        this.f4999l.put(gVar, cVar2);
                    }
                    k0VarArr[i3] = gVar;
                } else {
                    i3 = i9;
                    iArr2 = iArr3;
                    if (i10 == 2) {
                        k0VarArr[i3] = new i(this.t.get(aVar.f5002d), jVar.j().b[0], this.r.f5041d);
                    }
                }
            } else {
                i3 = i9;
                ...
                if (k0VarArr[i3] instanceof f.i.a.a.h1.s0.g) {
                    ((c) ((f.i.a.a.h1.s0.g) k0VarArr[i3]).f4971e).c(jVar);
                }
            }
            i9 = i3 + 1;
            jVarArr2 = jVarArr;
                ...
                if (aVar2.f5001c == 1) {
                    ...
                    if (d3 == -1) {
                        ...
                        for (int i14 = 0; i14 < gVar2.n.length; i14++) {
                            if (gVar2.b[i14] == i13) {
                                c.a.a.b.g.h.v(!gVar2.f4970d[i14]);
                                gVar2.f4970d[i14] = true;
                                gVar2.n[i14].v();
    ...
    public List<c0> n(List<f.i.a.a.j1.j> list) {
        List<f.i.a.a.h1.t0.k.a> list2 = this.r.b(this.s).f5060c;
        ArrayList arrayList = new ArrayList();
        for (f.i.a.a.j1.j jVar : list) {
            a aVar = this.f4996i[this.f4995h.a(jVar.j())];
            if (aVar.f5001c == 0) {
                int[] iArr = aVar.a;
                ...
                Arrays.sort(iArr2);
                int size = list2.get(iArr[0]).f5037c.size();
                int i3 = 0;
                int i4 = 0;
                for (int i5 = 0; i5 < length; i5++) {
                    while (true) {
                        ...
                        if (iArr2[i5] >= i6) {
                            i3++;
                            size = list2.get(iArr[i3]).f5037c.size();
                            i4 = i6;
                        }
                    }
