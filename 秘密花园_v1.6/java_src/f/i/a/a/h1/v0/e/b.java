...
public class b implements e0.a<f.i.a.a.h1.v0.e.a> {
    ...
    public static abstract class a {
        ...
        public final List<Pair<String, Object>> f5266d = new LinkedList();
        ...
        public final Object c(String str) {
            for (int i2 = 0; i2 < this.f5266d.size(); i2++) {
                Pair<String, Object> pair = this.f5266d.get(i2);
    ...
    public static class c extends a {
        ...
        public void k(XmlPullParser xmlPullParser) {
            if ("ProtectionHeader".equals(xmlPullParser.getName())) {
                ...
                this.f5268f = UUID.fromString(attributeValue);
            }
        }
        ...
        public void l(XmlPullParser xmlPullParser) {
            if (this.f5267e) {
                this.f5269g = Base64.decode(xmlPullParser.getText(), 0);
            }
        }
    }
    ...
    public static class d extends a {
        ...
        */
        ...
        public void k(XmlPullParser xmlPullParser) throws h0 {
            ...
            if (intValue == 2) {
                this.f5270e = b0.s(attributeValue, str2, "video/mp4", str, null, i2, i(xmlPullParser, "MaxWidth"), i(xmlPullParser, "MaxHeight"), -1.0f, m(xmlPullParser.getAttributeValue(null, "CodecPrivateData")), 0, 0);
                return;
            }
            char c2 = 65535;
            int i3 = 0;
            if (intValue != 1) {
                if (intValue == 3) {
                    ...
                    this.f5270e = b0.o(attributeValue, str2, "application/mp4", str, null, i2, 0, c2 != 0 ? c2 != 1 ? 0 : 1024 : 64, (String) c("Language"));
                    return;
                }
                this.f5270e = b0.k(attributeValue, str2, "application/mp4", str, null, i2, 0, 0, null);
                return;
            }
            if (str == null) {
                str = "audio/mp4a-latm";
            ...
            this.f5270e = b0.g(attributeValue, str2, "audio/mp4", str, null, i2, i4, i5, m2, 0, 0, (String) c("Language"));
        }
    }
    ...
    public static class e extends a {
        ...
        public a.C0077a f5279m;

        public e(a aVar, String str) {
            super(null, str, "SmoothStreamingMedia");
            this.f5277k = -1;
            this.f5279m = null;
            this.f5271e = new LinkedList();
        }

        @Override // f.i.a.a.h1.v0.e.b.a
        public void a(Object obj) {
            if (obj instanceof a.b) {
                this.f5271e.add((a.b) obj);
            } else if (obj instanceof a.C0077a) {
                h.v(this.f5279m == null);
                this.f5279m = (a.C0077a) obj;
            }
        }

        @Override // f.i.a.a.h1.v0.e.b.a
        public Object b() {
            int size = this.f5271e.size();
            a.b[] bVarArr = new a.b[size];
            this.f5271e.toArray(bVarArr);
            a.C0077a c0077a = this.f5279m;
            if (c0077a != null) {
            ...
            return new f.i.a.a.h1.v0.e.a(this.f5272f, this.f5273g, this.f5274h, this.f5275i, this.f5276j, this.f5277k, this.f5278l, this.f5279m, bVarArr);
        }

        @Override // f.i.a.a.h1.v0.e.b.a
        public void k(XmlPullParser xmlPullParser) throws h0 {
            this.f5272f = i(xmlPullParser, "MajorVersion");
            this.f5273g = i(xmlPullParser, "MinorVersion");
            this.f5274h = h(xmlPullParser, "TimeScale", 10000000L);
            String attributeValue = xmlPullParser.getAttributeValue(null, "Duration");
            if (attributeValue != null) {
                try {
                    this.f5275i = Long.parseLong(attributeValue);
                    this.f5276j = h(xmlPullParser, "DVRWindowLength", 0L);
                    this.f5277k = g(xmlPullParser, "LookaheadCount", -1);
                    String attributeValue2 = xmlPullParser.getAttributeValue(null, "IsLive");
                    this.f5278l = attributeValue2 != null ? Boolean.parseBoolean(attributeValue2) : false;
                    this.f5266d.add(Pair.create("TimeScale", Long.valueOf(this.f5274h)));
                    return;
                } catch (NumberFormatException e2) {
                    throw new h0(e2);
                }
    ...
    public static class f extends a {
        ...
        public f(a aVar, String str) {
            ...
            this.f5280e = str;
            this.f5281f = new LinkedList();
        }

        @Override // f.i.a.a.h1.v0.e.b.a
        public void a(Object obj) {
            if (obj instanceof b0) {
                this.f5281f.add((b0) obj);
            }
        }

        @Override // f.i.a.a.h1.v0.e.b.a
        public Object b() {
            b0[] b0VarArr = new b0[this.f5281f.size()];
            this.f5281f.toArray(b0VarArr);
            String str = this.f5280e;
            String str2 = this.f5286k;
            int i2 = this.f5282g;
            String str3 = this.f5283h;
            long j2 = this.f5284i;
        ...
        public void k(XmlPullParser xmlPullParser) throws h0 {
            ...
            if ("c".equals(xmlPullParser.getName())) {
                ...
                if (attributeValue != null) {
                    ...
                    this.f5282g = i2;
                    this.f5266d.add(Pair.create("Type", Integer.valueOf(i2)));
                    if (this.f5282g == 3) {
                        this.f5283h = j(xmlPullParser, "Subtype");
                    } else {
                        this.f5283h = xmlPullParser.getAttributeValue(null, "Subtype");
                    }
                    this.f5266d.add(Pair.create("Subtype", this.f5283h));
                    this.f5285j = xmlPullParser.getAttributeValue(null, "Name");
                    this.f5286k = j(xmlPullParser, "Url");
                    this.f5287l = g(xmlPullParser, "MaxWidth", -1);
                    this.f5288m = g(xmlPullParser, "MaxHeight", -1);
                    this.n = g(xmlPullParser, "DisplayWidth", -1);
                    this.o = g(xmlPullParser, "DisplayHeight", -1);
                    String attributeValue2 = xmlPullParser.getAttributeValue(null, "Language");
                    this.p = attributeValue2;
                    this.f5266d.add(Pair.create("Language", attributeValue2));
                    long g2 = g(xmlPullParser, "TimeScale", -1);
                    this.f5284i = g2;
                    if (g2 == -1) {
                        this.f5284i = ((Long) c("TimeScale")).longValue();
                    }
