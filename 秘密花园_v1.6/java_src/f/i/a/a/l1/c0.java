...
public final class c0 implements d0 {
    ...
    public static final c f5572d = new c(2, -9223372036854775807L, null);

    /* renamed from: e  reason: collision with root package name */
    public static final c f5573e = new c(3, -9223372036854775807L, null);
    public final ExecutorService a;
    public d<? extends e> b;

    /* renamed from: c  reason: collision with root package name */
    public IOException f5574c;
    ...
    public final class d<T extends e> extends Handler implements Runnable {
        ...
        /* renamed from: e  reason: collision with root package name */
        public IOException f5577e;

        /* renamed from: f  reason: collision with root package name */
        public int f5578f;

        /* renamed from: g  reason: collision with root package name */
        public volatile Thread f5579g;
        ...
        public void a(boolean z) {
            ...
            if (hasMessages(0)) {
                ...
                this.b.b();
                if (this.f5579g != null) {
                    this.f5579g.interrupt();
                }
            }
            if (z) {
                c0.this.b = null;
                long elapsedRealtime = SystemClock.elapsedRealtime();
                this.f5576d.k(this.b, elapsedRealtime, elapsedRealtime - this.f5575c, true);
                this.f5576d = null;
            }
        }
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 0) {
                ...
                c0.this.b = null;
                long elapsedRealtime = SystemClock.elapsedRealtime();
                long j2 = elapsedRealtime - this.f5575c;
                if (this.f5580h) {
                    this.f5576d.k(this.b, elapsedRealtime, j2, false);
                    return;
                }
                int i3 = message.what;
                if (i3 == 1) {
                    ...
                    try {
                        this.f5576d.r(this.b, elapsedRealtime, j2);
                    } catch (RuntimeException e2) {
                        c0.this.f5574c = new h(e2);
                    }
                } else if (i3 != 3) {
                } else {
                    IOException iOException = (IOException) message.obj;
                    this.f5577e = iOException;
                    int i4 = this.f5578f + 1;
                    this.f5578f = i4;
                    c p = this.f5576d.p(this.b, elapsedRealtime, j2, iOException, i4);
                    int i5 = p.a;
                    if (i5 == 3) {
                        c0.this.f5574c = this.f5577e;
                    } else if (i5 != 2) {
                        if (i5 == 1) {
                            this.f5578f = 1;
                        }
                        ...
                        if (j3 == -9223372036854775807L) {
                            j3 = Math.min((this.f5578f - 1) * 1000, (int) TbsReaderView.ReaderCallback.GET_BAR_ANIMATING);
                        }
                        b(j3);
                    }
                }
        ...
        public void run() {
            try {
                this.f5579g = Thread.currentThread();
                if (!this.f5580h) {
    ...
    public void e(int i2) throws IOException {
        ...
        if (iOException == null) {
            ...
            if (dVar != null) {
                ...
                IOException iOException2 = dVar.f5577e;
                if (iOException2 != null && dVar.f5578f > i2) {
                    throw iOException2;
                }
                return;
            }
