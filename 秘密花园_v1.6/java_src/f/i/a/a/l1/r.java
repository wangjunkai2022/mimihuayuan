...
public final class r implements g, i0 {
    ...
    public final f.i.a.a.m1.m<g.a> f5699c;

    /* renamed from: d  reason: collision with root package name */
    public final f.i.a.a.m1.z f5700d;

    /* renamed from: e  reason: collision with root package name */
    public final f.i.a.a.m1.h f5701e;
    ...
    public static final class a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public f.i.a.a.m1.h f5711d;

        public a(Context context) {
            this.a = context == null ? null : context.getApplicationContext();
            int[] iArr = r.n.get(f.i.a.a.m1.h0.A(context));
        ...
        public static synchronized b a(Context context) {
            ...
            synchronized (b.class) {
                if (f5712c == null) {
                    ...
                    context.registerReceiver(f5712c, intentFilter);
                }
                bVar = f5712c;
            }
            return bVar;
    ...
    @Deprecated
    public r() {
        this(null, new SparseArray(), 2000, f.i.a.a.m1.h.a, false);
    }

    public static void i(r rVar) {
        synchronized (rVar) {
            int F = rVar.a == null ? 0 : f.i.a.a.m1.h0.F(rVar.a);
            if (rVar.f5705i == F) {
                return;
            }
            rVar.f5705i = F;
            if (F != 1 && F != 0 && F != 8) {
                rVar.f5708l = rVar.j(F);
                long c2 = rVar.f5701e.c();
                rVar.l(rVar.f5702f > 0 ? (int) (c2 - rVar.f5703g) : 0, rVar.f5704h, rVar.f5708l);
                rVar.f5703g = c2;
                rVar.f5704h = 0L;
                rVar.f5707k = 0L;
                rVar.f5706j = 0L;
                f.i.a.a.m1.z zVar = rVar.f5700d;
                zVar.b.clear();
                zVar.f5792d = -1;
                zVar.f5793e = 0;
                zVar.f5794f = 0;
    ...
    public synchronized void d(m mVar, p pVar, boolean z) {
        if (z) {
            c.a.a.b.g.h.v(this.f5702f > 0);
            long c2 = this.f5701e.c();
            int i2 = (int) (c2 - this.f5703g);
            long j2 = i2;
            this.f5706j += j2;
            this.f5707k += this.f5704h;
            if (i2 > 0) {
                this.f5700d.a((int) Math.sqrt(this.f5704h), (float) ((this.f5704h * 8000) / j2));
                if (this.f5706j >= ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS || this.f5707k >= 524288) {
                    this.f5708l = this.f5700d.b(0.5f);
                }
                l(i2, this.f5704h, this.f5708l);
                this.f5703g = c2;
                this.f5704h = 0L;
            }
            this.f5702f--;
    ...
    public final void l(final int i2, final long j2, final long j3) {
        if (i2 == 0 && j2 == 0 && j3 == this.f5709m) {
            return;
        }
        this.f5709m = j3;
        this.f5699c.b(new m.a() { // from class: f.i.a.a.l1.b
            @Override // f.i.a.a.m1.m.a
            public final void a(Object obj) {
                r.k(i2, j2, j3, (g.a) obj);
            }
        });
    }

    public r(@Nullable Context context, SparseArray<Long> sparseArray, int i2, f.i.a.a.m1.h hVar, boolean z) {
        this.a = context == null ? null : context.getApplicationContext();
        this.b = sparseArray;
        this.f5699c = new f.i.a.a.m1.m<>();
        this.f5700d = new f.i.a.a.m1.z(i2);
        this.f5701e = hVar;
        int F = context == null ? 0 : f.i.a.a.m1.h0.F(context);
        this.f5705i = F;
        this.f5708l = j(F);
        if (context == null || !z) {
            return;
        ...
        synchronized (a2) {
            ...
            a2.a.post(new Runnable() { // from class: f.i.a.a.l1.c
