...
public class a extends h implements a0 {
    ...
    public final f.a f4077e;

    /* renamed from: f  reason: collision with root package name */
    public final a0.f f4078f;
    @Nullable
    ...
    public Map<String, List<String>> a() {
        h0 h0Var = this.f4084l;
        return h0Var == null ? Collections.emptyMap() : h0Var.f6535g.e();
    }
    ...
    public long b(p pVar) throws a0.c {
        ...
        if (uri != null) {
            ...
            if (xVar != null) {
                ...
                a0.f fVar = this.f4082j;
                if (fVar != null) {
                    for (Map.Entry<String, String> entry : fVar.a().entrySet()) {
                        aVar2.c(entry.getKey(), entry.getValue());
                    }
                }
                for (Map.Entry<String, String> entry2 : this.f4078f.a().entrySet()) {
                ...
                byte[] bArr = pVar.f5687c;
                if (bArr != null) {
                    g0Var = g0.d(null, bArr);
                } else if (pVar.b == 2) {
                    g0Var = g0.d(null, f.i.a.a.m1.h0.f5749f);
                }
                aVar2.e(p.a(pVar.b), g0Var);
                try {
                    h0 T = this.f4077e.a(aVar2.b()).T();
                    this.f4084l = T;
                    i0 i0Var = T.f6536h;
                    c.a.a.b.g.h.t(i0Var);
                    this.f4085m = i0Var.d();
                    int i2 = T.f6533e;
                    if (!T.g()) {
                        Map<String, List<String>> e2 = T.f6535g.e();
                        i();
                        a0.e eVar3 = new a0.e(i2, T.f6532d, e2, pVar);
                        if (i2 == 416) {
    ...
    public Uri d() {
        ...
        return Uri.parse(h0Var.b.b.f6863j);
    }

    public final void i() {
        h0 h0Var = this.f4084l;
        if (h0Var != null) {
            i0 i0Var = h0Var.f6536h;
            c.a.a.b.g.h.t(i0Var);
            i0Var.close();
            this.f4084l = null;
        }
