...
public abstract class u0 {
    ...
    public static final class b {
        ...
        public f.i.a.a.h1.r0.a f5882f = f.i.a.a.h1.r0.a.f4936f;

        public long a(int i2, int i3) {
            a.C0075a c0075a = this.f5882f.f4937c[i2];
            if (c0075a.a != -1) {
                return c0075a.f4941d[i3];
            }
            return -9223372036854775807L;
        }

        public int b(long j2) {
            f.i.a.a.h1.r0.a aVar = this.f5882f;
            long j3 = this.f5880d;
            if (aVar != null) {
                if (j2 != Long.MIN_VALUE) {
                    if (j3 == -9223372036854775807L || j2 < j3) {
                        ...
                        while (true) {
                            long[] jArr = aVar.b;
                            if (i2 >= jArr.length || jArr[i2] == Long.MIN_VALUE || (j2 < jArr[i2] && aVar.f4937c[i2].b())) {
                                break;
                            }
                            i2++;
                        }
        ...
        */
        public int c(long r10) {
            ...
            L33:
                if (r1 < 0) goto L40
                f.i.a.a.h1.r0.a$a[] r10 = r0.f4937c
                r10 = r10[r1]
                boolean r10 = r10.b()
                if (r10 == 0) goto L40
                goto L41
        ...
        public long d(int i2) {
            return this.f5882f.b[i2];
        }

        public int e(int i2) {
            return this.f5882f.f4937c[i2].a(-1);
        }

        public boolean f(int i2, int i3) {
            a.C0075a c0075a = this.f5882f.f4937c[i2];
            return (c0075a.a == -1 || c0075a.f4940c[i3] == 0) ? false : true;
        }

        public b g(@Nullable Object obj, @Nullable Object obj2, int i2, long j2, long j3) {
            f.i.a.a.h1.r0.a aVar = f.i.a.a.h1.r0.a.f4936f;
            this.a = obj;
            this.b = obj2;
            this.f5879c = i2;
            this.f5880d = j2;
    ...
    public final int d(int i2, b bVar, c cVar, int i3, boolean z) {
        int i4 = g(i2, bVar, false).f5879c;
        if (n(i4, cVar).f5887g == i2) {
            int e2 = e(i4, i3, z);
            if (e2 == -1) {
                return -1;
            }
            return n(e2, cVar).f5886f;
        }
        return i2 + 1;
    }
    ...
    public final Pair<Object, Long> k(c cVar, b bVar, int i2, long j2, long j3) {
        ...
        int i3 = cVar.f5886f;
        long j4 = cVar.f5890j + j2;
        long j5 = g(i3, bVar, true).f5880d;
        while (j5 != -9223372036854775807L && j4 >= j5 && i3 < cVar.f5887g) {
            j4 -= j5;
            i3++;
            j5 = g(i3, bVar, true).f5880d;
        }
        Object obj = bVar.b;
        c.a.a.b.g.h.t(obj);
