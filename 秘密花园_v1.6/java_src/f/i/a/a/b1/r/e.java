...
public final class e extends d {
    ...
    public boolean c(u uVar, long j2) throws h0 {
        ...
        if (p == 0 && !this.f4173e) {
            ...
            h b = h.b(uVar2);
            this.f4172d = b.b;
            this.a.d(b0.t(null, "video/avc", null, -1, -1, b.f5813c, b.f5814d, -1.0f, b.a, -1, b.f5815e, null));
            this.f4173e = true;
            return false;
        } else if (p == 1 && this.f4173e) {
            int i6 = this.f4175g == 1 ? 1 : 0;
            if (this.f4174f || i6 != 0) {
                byte[] bArr2 = this.f4171c.a;
                bArr2[0] = 0;
                bArr2[1] = 0;
                bArr2[2] = 0;
                int i7 = 4 - this.f4172d;
                int i8 = 0;
                while (uVar.a() > 0) {
                    uVar.c(this.f4171c.a, i7, this.f4172d);
                    this.f4171c.A(0);
                    int s = this.f4171c.s();
                    this.b.A(0);
                    this.a.a(this.b, 4);
