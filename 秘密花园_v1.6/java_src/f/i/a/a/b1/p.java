...
public interface p {
    ...
    public static final class a {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            a aVar = (a) obj;
            return this.a == aVar.a && this.f4144c == aVar.f4144c && this.f4145d == aVar.f4145d && Arrays.equals(this.b, aVar.b);
        }

        public int hashCode() {
            return ((((Arrays.hashCode(this.b) + (this.a * 31)) * 31) + this.f4144c) * 31) + this.f4145d;
        }
    }
