...
public class c implements n {
    ...
    public c(long j2, long j3, int i2, int i3) {
        this.a = j2;
        this.b = j3;
        this.f4121c = i3 == -1 ? 1 : i3;
        this.f4123e = i2;
        if (j2 == -1) {
            this.f4122d = -1L;
            this.f4124f = -9223372036854775807L;
            return;
        }
        this.f4122d = j2 - j3;
        this.f4124f = c(j2, j3, i2);
    }
    ...
    public long a(long j2) {
        return c(j2, this.b, this.f4123e);
    }
    ...
    public n.a h(long j2) {
        ...
        long j4 = this.f4121c;
        long p = this.b + h0.p((((this.f4123e * j2) / 8000000) / j4) * j4, 0L, j3 - j4);
        long a = a(p);
        o oVar = new o(a, p);
        if (a < j2) {
            int i2 = this.f4121c;
