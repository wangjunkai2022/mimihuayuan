...
public final class b extends h {
    ...
    public class a implements f, f.i.a.a.b1.n {
        ...
        public void d(long j2) {
            this.f4336d = this.a[h0.f(this.a, j2, true, true)];
        }
        ...
        public n.a h(long j2) {
            int f2 = h0.f(this.a, (b.this.f4355i * j2) / 1000000, true, true);
            long a = b.this.a(this.a[f2]);
            o oVar = new o(a, this.f4335c + this.b[f2]);
            if (a < j2) {
                long[] jArr = this.a;
                if (f2 != jArr.length - 1) {
                    int i2 = f2 + 1;
                    return new n.a(oVar, new o(b.this.a(jArr[i2]), this.f4335c + this.b[i2]));
                }
            }
            return new n.a(oVar);
        }
        ...
        public long j() {
            ...
            return (nVar.f5767d * 1000000) / nVar.a;
        }
    }
    ...
    public boolean e(u uVar, long j2, h.b bVar) throws IOException, InterruptedException {
        ...
        if (this.n == null) {
            ...
            byte[] copyOfRange = Arrays.copyOfRange(bArr, 9, uVar.f5785c);
