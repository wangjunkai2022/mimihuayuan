...
public final class a implements f {
    ...
    public final class b implements n {
        ...
        public n.a h(long j2) {
            ...
            long j3 = aVar.b;
            long j4 = aVar.f4325c;
            return new n.a(new o(j2, h0.p(((((j4 - j3) * ((aVar.f4326d.f4355i * j2) / 1000000)) / aVar.f4328f) + j3) - com.umeng.commonsdk.proguard.c.f3131d, j3, j4 - 1)));
        }

        @Override // f.i.a.a.b1.n
        public long j() {
            a aVar = a.this;
            return aVar.f4326d.a(aVar.f4328f);
        }
    }
    ...
    public final boolean b(f.i.a.a.b1.d dVar, long j2) throws IOException, InterruptedException {
        int i2;
        long min = Math.min(j2 + 3, this.f4325c);
        int i3 = 2048;
    ...
    */
    ...
    public void d(long j2) {
        this.f4330h = h0.p(j2, 0L, this.f4328f - 1);
        this.f4327e = 2;
        this.f4331i = this.b;
        this.f4332j = this.f4325c;
        this.f4333k = 0L;
        this.f4334l = this.f4328f;
    }
}
