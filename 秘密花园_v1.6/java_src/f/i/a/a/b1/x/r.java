...
public final class r implements c0 {
    ...
    public final void c(f.i.a.a.m1.u uVar, int i2) throws h0 {
        ...
        while (uVar.a() > 0) {
            ...
            if (i6 != 0) {
                if (i6 != 1) {
                    if (i6 == 2) {
                        if (d(uVar, this.b.a, Math.min(10, this.f4565i)) && d(uVar, null, this.f4565i)) {
                            this.b.j(0);
                            ...
                            if (this.f4562f) {
                                ...
                                this.b.l(1);
                                if (!this.f4564h && this.f4563g) {
                                    this.b.l(4);
                                    this.b.l(1);
                                    this.b.l(1);
                                    this.b.l(1);
                                    this.f4561e.b((this.b.f(3) << 30) | (this.b.f(15) << 15) | this.b.f(15));
                                    this.f4564h = true;
                                }
                                this.f4568l = this.f4561e.b(f2);
                            }
                            i5 |= this.f4567k ? 4 : 0;
                            this.a.e(this.f4568l, i5);
                            e(3);
                        }
                    } else if (i6 == 3) {
                        int a = uVar.a();
                    ...
                    if (this.b.f(24) != 1) {
                        ...
                        int f3 = this.b.f(16);
                        this.b.l(5);
                        this.f4567k = this.b.e();
                        this.b.l(2);
                        this.f4562f = this.b.e();
                        this.f4563g = this.b.e();
                        this.b.l(6);
                        int f4 = this.b.f(8);
                        this.f4565i = f4;
                        if (f3 == 0) {
    ...
    public final boolean d(f.i.a.a.m1.u uVar, byte[] bArr, int i2) {
        int min = Math.min(uVar.a(), i2 - this.f4560d);
        if (min <= 0) {
            return true;
        }
        if (bArr == null) {
            ...
            System.arraycopy(uVar.a, uVar.b, bArr, this.f4560d, min);
            uVar.b += min;
        }
        int i3 = this.f4560d + min;
        this.f4560d = i3;
        return i3 == i2;
    }
