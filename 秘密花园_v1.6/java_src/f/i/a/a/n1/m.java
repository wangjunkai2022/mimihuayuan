...
public class m extends f.i.a.a.c1.b {
    ...
    public m(Context context, f.i.a.a.c1.c cVar, long j2, @Nullable f.i.a.a.z0.g<f.i.a.a.z0.j> gVar, boolean z, boolean z2, @Nullable Handler handler, @Nullable s sVar, int i2) {
        ...
        this.u0 = "NVIDIA".equals(h0.f5746c);
        this.v0 = new long[10];
        this.w0 = new long[10];
    ...
    public static int r0(f.i.a.a.c1.a aVar, String str, int i2, int i3) {
        ...
        if (c2 != 0 && c2 != 1) {
            if (c2 == 2) {
                if ("BRAVIA 4K 2015".equals(h0.f5747d) || ("Amazon".equals(h0.f5746c) && ("KFSOWI".equals(h0.f5747d) || ("AFTS".equals(h0.f5747d) && aVar.f4608f)))) {
                    return -1;
                }
    ...
    public static int s0(f.i.a.a.c1.a aVar, b0 b0Var) {
        if (b0Var.f4098j != -1) {
            int size = b0Var.f4099k.size();
            int i2 = 0;
            for (int i3 = 0; i3 < size; i3++) {
                i2 += b0Var.f4099k.get(i3).length;
            }
            return b0Var.f4098j + i2;
        }
        return r0(aVar, b0Var.f4097i, b0Var.n, b0Var.o);
    }
    ...
    public final boolean E0(f.i.a.a.c1.a aVar) {
        return h0.a >= 23 && !this.U0 && !q0(aVar.a) && (!aVar.f4608f || k.b(this.p0));
    }
    ...
    public void F0(int i2) {
        ...
        int i3 = this.H0 + i2;
        this.H0 = i3;
        dVar.f6037h = Math.max(i3, dVar.f6037h);
        int i4 = this.t0;
        if (i4 <= 0 || this.G0 < i4) {
            return;
        }
    ...
    public int I(MediaCodec mediaCodec, f.i.a.a.c1.a aVar, b0 b0Var, b0 b0Var2) {
        if (aVar.d(b0Var, b0Var2, true)) {
            int i2 = b0Var2.n;
            b bVar = this.x0;
            if (i2 > bVar.a || b0Var2.o > bVar.b || s0(aVar, b0Var2) > this.x0.f5824c) {
                return 0;
            }
    ...
    */
    ...
    public List<f.i.a.a.c1.a> R(f.i.a.a.c1.c cVar, b0 b0Var, boolean z) throws d.c {
        return Collections.unmodifiableList(cVar.a(b0Var.f4097i, z, this.U0));
    }
    ...
    public void Z(f.i.a.a.y0.e eVar) {
        this.I0++;
        this.X0 = Math.max(eVar.f6040d, this.X0);
        if (h0.a >= 23 || !this.U0) {
            return;
        }
        z0(eVar.f6040d);
    ...
    */
        ...
        if (surface == null) {
            ...
            if (surface2 != null) {
                ...
                if (aVar != null && E0(aVar)) {
                    surface = k.c(this.p0, aVar.f4608f);
                    this.A0 = surface;
                }
            }
        }
    ...
    public int k0(f.i.a.a.c1.c cVar, f.i.a.a.z0.g<f.i.a.a.z0.j> gVar, b0 b0Var) throws d.c {
        boolean z;
        int i2 = 0;
        if (f.i.a.a.m1.r.j(b0Var.f4097i)) {
            f.i.a.a.z0.e eVar = b0Var.f4100l;
            if (eVar != null) {
                z = false;
                for (int i3 = 0; i3 < eVar.f6081d; i3++) {
                    z |= eVar.a[i3].f6085f;
                }
            } else {
                z = false;
