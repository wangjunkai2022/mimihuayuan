...
public class d extends FrameLayout {
    ...
    public final View f5540e;

    /* renamed from: f  reason: collision with root package name */
    public final View f5541f;

    /* renamed from: g  reason: collision with root package name */
    public final View f5542g;

    /* renamed from: h  reason: collision with root package name */
    public final ImageView f5543h;
    ...
    public final TextView f5546k;

    /* renamed from: l  reason: collision with root package name */
    public final g f5547l;

    /* renamed from: m  reason: collision with root package name */
    public final StringBuilder f5548m;
    ...
    public final class View$OnClickListenerC0087d extends l0.a implements g.a, View.OnClickListener {
        ...
        public void c(g gVar, long j2) {
            d dVar = d.this;
            TextView textView = dVar.f5546k;
            if (textView != null) {
                textView.setText(h0.L(dVar.f5548m, dVar.n, j2));
            }
        }
    ...
    public d(Context context, AttributeSet attributeSet, int i2, AttributeSet attributeSet2) {
        ...
        this.o = new u0.b();
        this.p = new u0.c();
        this.f5548m = new StringBuilder();
        this.n = new Formatter(this.f5548m, Locale.getDefault());
        this.S = new long[0];
        ...
        this.f5545j = (TextView) findViewById(R.id.exo_duration);
        this.f5546k = (TextView) findViewById(R.id.exo_position);
        this.f5547l = (g) findViewById(R.id.exo_progress);
        ...
        this.f5539d = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setOnClickListener(this.a);
        }
        View findViewById3 = findViewById(R.id.exo_pause);
        this.f5540e = findViewById3;
        ...
        this.f5538c = findViewById5;
        if (findViewById5 != null) {
            findViewById5.setOnClickListener(this.a);
        }
        View findViewById6 = findViewById(R.id.exo_rew);
        this.f5542g = findViewById6;
        if (findViewById6 != null) {
            findViewById6.setOnClickListener(this.a);
        }
        View findViewById7 = findViewById(R.id.exo_ffwd);
        this.f5541f = findViewById7;
        if (findViewById7 != null) {
            findViewById7.setOnClickListener(this.a);
        }
        ImageView imageView = (ImageView) findViewById(R.id.exo_repeat_toggle);
        this.f5543h = imageView;
        if (imageView != null) {
            imageView.setOnClickListener(this.a);
        }
        View findViewById8 = findViewById(R.id.exo_shuffle);
        this.f5544i = findViewById8;
    ...
    public void l() {
        ...
        View view2;
        boolean j2 = j();
        if (!j2 && (view2 = this.f5539d) != null) {
            view2.requestFocus();
        } else if (!j2 || (view = this.f5540e) == null) {
        } else {
            view.requestFocus();
        }
    }
    ...
    */
    public final void s() {
        ...
        L23:
            ...
            boolean r3 = r0.f5884d
            r4 = -1
            if (r3 != 0) goto L50
            boolean r0 = r0.f5885e
            if (r0 == 0) goto L50
            f.i.a.a.l0 r0 = r6.E
        ...
        L66:
            ...
            r6.o(r0, r5)
            android.view.View r0 = r6.f5538c
            r6.o(r4, r0)
            int r0 = r6.N
            if (r0 <= 0) goto L78
            if (r3 == 0) goto L78
        ...
        L78:
            r0 = 0
        L79:
            android.view.View r4 = r6.f5541f
            r6.o(r0, r4)
            int r0 = r6.M
            if (r0 <= 0) goto L85
            if (r3 == 0) goto L85
        ...
        L85:
            r1 = 0
        L86:
            android.view.View r0 = r6.f5542g
            r6.o(r1, r0)
            f.i.a.a.k1.g r0 = r6.f5547l
            if (r0 == 0) goto L92
            r0.setEnabled(r3)
        L92:
            return
    ...
    public void t() {
        ...
        if (k() && this.I) {
            ...
            if (view != null) {
                ...
                this.f5539d.setVisibility(j2 ? 8 : 0);
            } else {
                z = false;
            }
            View view2 = this.f5540e;
            if (view2 != null) {
                z |= (j2 || !view2.isFocused()) ? false : false;
                this.f5540e.setVisibility(j2 ? 0 : 8);
            }
            if (z) {
                l();
            }
    ...
    public final void u() {
        ...
        if (this.I) {
            ...
            if (l0Var != null) {
                ...
                if (w.q()) {
                    ...
                    while (true) {
                        ...
                        u0.c cVar2 = this.p;
                        int i6 = i5;
                        if (cVar2.f5889i == -9223372036854775807L) {
                        ...
                        while (true) {
                            ...
                            if (i7 <= cVar.f5887g) {
                                w.f(i7, this.o);
                                int i8 = this.o.f5882f.a;
                                int i9 = 0;
                                while (i9 < i8) {
                                    long d2 = this.o.d(i9);
                                    if (d2 == Long.MIN_VALUE) {
                                        i4 = z2;
                                        long j7 = this.o.f5880d;
                                    ...
                                    long j8 = d2 + this.o.f5881e;
                                    if (j8 >= 0 && j8 <= this.p.f5889i) {
                                        long[] jArr = this.S;
                                        if (i3 == jArr.length) {
                                        ...
                                        this.S[i3] = q.b(j6 + j8);
                                        this.T[i3] = !this.o.f5882f.f4937c[i9].b();
                                        i3++;
                                    }
                                    i9++;
                                    z2 = i4;
                ...
                if (this.f5547l != null) {
                    ...
                    this.f5547l.setAdGroupTimesMs(this.S, this.T, i10);
                }
            } else {
                j2 = 0;
                j3 = 0;
            ...
            if (textView != null) {
                textView.setText(h0.L(this.f5548m, this.n, j5));
            }
            TextView textView2 = this.f5546k;
            if (textView2 != null && !this.L) {
                textView2.setText(h0.L(this.f5548m, this.n, j2));
            }
            g gVar = this.f5547l;
            if (gVar != null) {
                gVar.setPosition(j2);
                this.f5547l.setBufferedPosition(j3);
                this.f5547l.setDuration(j5);
            }
            removeCallbacks(this.W);
            l0 l0Var2 = this.E;
            if (l0Var2 == null) {
    ...
    public final void v() {
        ImageView imageView;
        if (k() && this.I && (imageView = this.f5543h) != null) {
            if (this.P == 0) {
                ...
                int u = this.E.u();
                if (u == 0) {
                    this.f5543h.setImageDrawable(this.q);
                    this.f5543h.setContentDescription(this.t);
                } else if (u == 1) {
                    this.f5543h.setImageDrawable(this.r);
                    this.f5543h.setContentDescription(this.u);
                } else if (u == 2) {
                    this.f5543h.setImageDrawable(this.s);
                    this.f5543h.setContentDescription(this.v);
                }
    ...
    public final void w() {
        View view;
        if (k() && this.I && (view = this.f5544i) != null) {
            if (!this.Q) {
