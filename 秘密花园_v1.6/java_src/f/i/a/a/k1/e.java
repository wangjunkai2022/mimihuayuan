...
public class e extends FrameLayout {
    ...
    public final f.i.a.a.f1.a f5549c;

    /* renamed from: d  reason: collision with root package name */
    public final AppCompatImageView f5550d;

    /* renamed from: e  reason: collision with root package name */
    public final SubtitleView f5551e;

    /* renamed from: f  reason: collision with root package name */
    public final d f5552f;

    /* renamed from: g  reason: collision with root package name */
    public final b f5553g;

    /* renamed from: h  reason: collision with root package name */
    public final FrameLayout f5554h;
    ...
    public final class b extends l0.a implements k, q {
        ...
        public void a(int i2, int i3, int i4, float f2) {
            f.i.a.a.f1.a aVar;
            e eVar = e.this;
            if (eVar.a == null || (aVar = eVar.f5549c) == null) {
                return;
            }
            aVar.setPixelWidthHeightRatio(f2);
            e.this.f5549c.a(i2, i3);
            e.this.f5549c.c(0, 0);
        }
        ...
        public void e(List<f.i.a.a.i1.b> list) {
            SubtitleView subtitleView = e.this.f5551e;
    ...
    public e(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                this.f5558l = obtainStyledAttributes.getBoolean(R.styleable.PlayerView_keep_content_on_player_reset, this.f5558l);
        ...
        if (this.a != null && i4 != 0) {
            ...
            this.f5549c.getRenderView().setLayoutParams(layoutParams);
            this.a.addView(this.f5549c.getRenderView(), 0);
            this.f5549c.b(i6);
        } else {
            this.f5549c = null;
        }
        this.f5554h = (FrameLayout) findViewById(R.id.exo_overlay);
        AppCompatImageView appCompatImageView = (AppCompatImageView) findViewById(R.id.exo_artwork);
        this.f5550d = appCompatImageView;
        this.f5557k = z4 && appCompatImageView != null;
        SubtitleView subtitleView = (SubtitleView) findViewById(R.id.exo_subtitles);
        this.f5551e = subtitleView;
        if (subtitleView != null) {
            subtitleView.b();
            this.f5551e.c();
        }
        ...
        if (dVar2 != null) {
            ...
            viewGroup.addView(this.f5552f, indexOfChild);
        } else {
            this.f5552f = null;
        }
        this.f5559m = this.f5552f == null ? 0 : i7;
        this.p = z6;
        this.n = z;
        this.o = z2;
        this.f5556j = z5 && this.f5552f != null;
        d();
    }
    ...
    public void c() {
        AppCompatImageView appCompatImageView = this.f5550d;
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        l0 l0Var = this.f5555i;
        if (l0Var != null && l0Var.h()) {
            this.f5554h.requestFocus();
            return super.dispatchKeyEvent(keyEvent);
        }
        int keyCode = keyEvent.getKeyCode();
        boolean z = (keyCode == 19 || keyCode == 270 || keyCode == 22 || keyCode == 271 || keyCode == 20 || keyCode == 269 || keyCode == 21 || keyCode == 268 || keyCode == 23) && this.f5556j && !this.f5552f.k();
        f(true);
        if (!z) {
            if (!(this.f5556j && this.f5552f.e(keyEvent)) && !super.dispatchKeyEvent(keyEvent)) {
                return false;
            }
        }
        return true;
    ...
    public final boolean e() {
        l0 l0Var = this.f5555i;
        return l0Var != null && l0Var.h() && this.f5555i.m();
    }

    public void f(boolean z) {
        if (!(e() && this.o) && this.f5556j) {
            boolean z2 = this.f5552f.k() && this.f5552f.getShowTimeoutMs() <= 0;
            boolean g2 = g();
            if (z || z2 || g2) {
                i(g2);
            }
    ...
    public boolean g() {
        ...
        int o = l0Var.o();
        return this.n && (o == 1 || o == 4 || !this.f5555i.m());
    }
    ...
    public int getResizeMode() {
        ...
        return this.f5549c.getResizeMode();
    }
    ...
    public final void i(boolean z) {
        if (this.f5556j) {
            this.f5552f.setShowTimeoutMs(z ? 0 : this.f5559m);
            d dVar = this.f5552f;
            if (!dVar.k()) {
    ...
    public void j(boolean z) {
        ...
        if (l0Var != null) {
            if (!(l0Var.t().a == 0)) {
                ...
                f.i.a.a.j1.k A = this.f5555i.A();
                for (int i2 = 0; i2 < A.a; i2++) {
                    if (this.f5555i.B(i2) == 2 && A.b[i2] != null) {
                        c();
                        return;
                    }
                }
                    ...
                    for (int i3 = 0; i3 < A.a; i3++) {
                        ...
                        if (jVar != null) {
                            for (int i4 = 0; i4 < jVar.length(); i4++) {
                                f.i.a.a.d1.a aVar = jVar.c(i4).f4095g;
                                if (aVar != null) {
                                    int i5 = 0;
                                    while (true) {
                                        a.b[] bVarArr = aVar.a;
                                        ...
                                        if (bVar instanceof f.i.a.a.d1.i.a) {
                                            byte[] bArr = ((f.i.a.a.d1.i.a) bVar).f4640e;
                                            Bitmap decodeByteArray = BitmapFactory.decodeByteArray(bArr, 0, bArr.length);
                                            if (decodeByteArray != null) {
                                                int width = decodeByteArray.getWidth();
                                                int height = decodeByteArray.getHeight();
                                                if (width > 0 && height > 0) {
                                                    this.f5550d.setImageBitmap(decodeByteArray);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.f5556j && this.f5555i != null && motionEvent.getActionMasked() == 0) {
            if (!this.f5552f.k()) {
                f(true);
            } else if (this.p) {
                this.f5552f.g();
    ...
    public boolean onTrackballEvent(MotionEvent motionEvent) {
        if (!this.f5556j || this.f5555i == null) {
            return false;
        }
        f(true);
        return true;
    ...
    public void setControlDispatcher(@Nullable r rVar) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setControlDispatcher(rVar);
    }
    ...
    public void setControllerVisibilityListener(d.e eVar) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setVisibilityListener(eVar);
    }

    public void setFastForwardIncrementMs(int i2) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setFastForwardIncrementMs(i2);
    }
    ...
    public void setPlaybackPreparer(@Nullable k0 k0Var) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setPlaybackPreparer(k0Var);
    }
    ...
    public void setPlayer(l0 l0Var) {
        ...
        if (l0Var2 != null) {
            ...
            if (g2 != null) {
                t0 t0Var = (t0) g2;
                t0Var.f5869f.remove(this.f5553g);
                f.i.a.a.f1.a aVar = this.f5549c;
        ...
        if (l0Var != null) {
            l0.d g3 = l0Var.g();
            if (g3 != null) {
                f.i.a.a.f1.a aVar2 = this.f5549c;
    ...
    public void setRepeatToggleModes(int i2) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setRepeatToggleModes(i2);
    }
    ...
    public void setRewindIncrementMs(int i2) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setRewindIncrementMs(i2);
    }

    public void setShowMultiWindowTimeBar(boolean z) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setShowMultiWindowTimeBar(z);
    }

    public void setShowShuffleButton(boolean z) {
        c.a.a.b.g.h.v(this.f5552f != null);
        this.f5552f.setShowShuffleButton(z);
    }
    ...
    public void setUseController(boolean z) {
        c.a.a.b.g.h.v((z && this.f5552f == null) ? false : true);
        if (this.f5556j == z) {
            return;
        }
        this.f5556j = z;
        if (z) {
            this.f5552f.setPlayer(this.f5555i);
            return;
        }
        d dVar = this.f5552f;
        if (dVar != null) {
            dVar.g();
            this.f5552f.setPlayer(null);
        }
    }
