...
public final class d {
    ...
    public static final SparseIntArray f4617c;

    /* renamed from: d  reason: collision with root package name */
    public static final SparseIntArray f4618d;

    /* renamed from: e  reason: collision with root package name */
    public static final Map<String, Integer> f4619e;

    /* renamed from: f  reason: collision with root package name */
    public static final Map<String, Integer> f4620f;

    /* renamed from: g  reason: collision with root package name */
    public static final Map<String, Integer> f4621g;

    /* renamed from: h  reason: collision with root package name */
    public static final SparseIntArray f4622h;
    public static final Pattern a = Pattern.compile("^\\D?(\\d+)$");
    public static final HashMap<b, List<f.i.a.a.c1.a>> b = new HashMap<>();

    /* renamed from: i  reason: collision with root package name */
    public static int f4623i = -1;
    ...
    public static final class b {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            b bVar = (b) obj;
            return TextUtils.equals(this.a, bVar.a) && this.b == bVar.b && this.f4624c == bVar.f4624c;
        }

        public int hashCode() {
            String str = this.a;
            return (((((str == null ? 0 : str.hashCode()) + 31) * 31) + (this.b ? 1231 : 1237)) * 31) + (this.f4624c ? 1231 : 1237);
        }
    }
    ...
    static {
        ...
        f4619e.put("L90", 64);
        f4619e.put("L93", 256);
        f4619e.put("L120", 1024);
        f4619e.put("L123", 4096);
        f4619e.put("L150", 16384);
        f4619e.put("L153", 65536);
        f4619e.put("L156", 262144);
        f4619e.put("L180", 1048576);
        f4619e.put("L183", 4194304);
        f4619e.put("L186", 16777216);
        f4619e.put("H30", 2);
        f4619e.put("H60", 8);
        f4619e.put("H63", 32);
        f4619e.put("H90", 128);
        f4619e.put("H93", 512);
        f4619e.put("H120", 2048);
        f4619e.put("H123", 8192);
        f4619e.put("H150", 32768);
        f4619e.put("H153", 131072);
        f4619e.put("H156", 524288);
        f4619e.put("H180", 2097152);
        f4619e.put("H183", 8388608);
        f4619e.put("H186", 33554432);
    ...
    public static String b(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (!mediaCodecInfo.isEncoder() && (z || !str.endsWith(".secure")) && ((h0.a >= 21 || !("CIPAACDecoder".equals(str) || "CIPMP3Decoder".equals(str) || "CIPVorbisDecoder".equals(str) || "CIPAMRNBDecoder".equals(str) || "AACDecoder".equals(str) || "MP3Decoder".equals(str))) && (!(h0.a < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str) && ("a70".equals(h0.b) || ("Xiaomi".equals(h0.f5746c) && h0.b.startsWith("HM")))) && (!(h0.a == 16 && "OMX.qcom.audio.decoder.mp3".equals(str) && ("dlxu".equals(h0.b) || "protou".equals(h0.b) || "ville".equals(h0.b) || "villeplus".equals(h0.b) || "villec2".equals(h0.b) || h0.b.startsWith("gee") || "C6602".equals(h0.b) || "C6603".equals(h0.b) || "C6606".equals(h0.b) || "C6616".equals(h0.b) || "L36h".equals(h0.b) || "SO-02E".equals(h0.b))) && (!(h0.a == 16 && "OMX.qcom.audio.decoder.aac".equals(str) && ("C1504".equals(h0.b) || "C1505".equals(h0.b) || "C1604".equals(h0.b) || "C1605".equals(h0.b))) && ((h0.a >= 24 || !(("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(h0.f5746c) && (h0.b.startsWith("zeroflte") || h0.b.startsWith("zerolte") || h0.b.startsWith("zenlte") || "SC-05G".equals(h0.b) || "marinelteatt".equals(h0.b) || "404SC".equals(h0.b) || "SC-04G".equals(h0.b) || "SCV31".equals(h0.b)))) && !((h0.a <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(h0.f5746c) && (h0.b.startsWith("d2") || h0.b.startsWith("serrano") || h0.b.startsWith("jflte") || h0.b.startsWith("santos") || h0.b.startsWith("t0"))) || ((h0.a <= 19 && h0.b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) || ("audio/eac3-joc".equals(str2) && "OMX.MTK.AUDIO.DECODER.DSPAC3".equals(str)))))))))) {
        ...
        switch (c2) {
            ...
            case 1:
                if (split.length >= 2) {
                    try {
                        ...
                        i2 = f4617c.get(parseInt, -1);
                        if (i2 == -1 || (i3 = f4618d.get(parseInt2, -1)) == -1) {
                            return null;
                        }
            ...
            case 3:
                ...
                if (matcher.matches()) {
                    ...
                    Integer num = f4619e.get(split[3]);
                    if (num == null) {
                        return null;
                    }
            ...
            case 5:
                ...
                if (matcher2.matches()) {
                    Integer num2 = f4620f.get(matcher2.group(1));
                    if (num2 == null) {
                        return null;
                    }
                    Integer num3 = f4621g.get(split[2]);
                    if (num3 == null) {
                        return null;
                    }
            ...
            case 6:
                if (split.length == 3) {
                    try {
                        ...
                        i4 = f4622h.get(Integer.parseInt(split[2]), -1);
                        if (i4 == -1) {
                            return null;
                        }
            ...
            for (int i2 = 0; i2 < c2; i2++) {
                ...
                if (b2 != null) {
                    try {
                        ...
                        if ((bVar.f4624c || !b3) && (!bVar.f4624c || d2)) {
                            ...
                            if ((bVar.b || !b4) && (!bVar.b || d3)) {
                                boolean z = h0.a <= 22 && ("ODROID-XU3".equals(h0.f5747d) || "Nexus 10".equals(h0.f5747d)) && ("OMX.Exynos.AVC.Decoder".equals(name) || "OMX.Exynos.AVC.Decoder.secure".equals(name));
    ...
    public static int g() throws c {
        ...
        if (f4623i == -1) {
            ...
            if (d2 != null) {
                MediaCodecInfo.CodecCapabilities codecCapabilities = d2.f4606d;
