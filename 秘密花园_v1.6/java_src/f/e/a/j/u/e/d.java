        ...
        if (S != null) {
            ...
            if (g0Var instanceof u) {
                ...
                for (int i3 = 0; i3 < uVar.h(); i3++) {
                    hashMap2.put(x.b.d(x.f6855l, uVar.b.get(i3), 0, 0, true, 3), x.b.d(x.f6855l, uVar.f6848c.get(i3), 0, 0, true, 3));
                }
            } else {
                i2 = 0;
            }
            ...
            if (c3 != null) {
                arrayList2.add(x.b.a(x.f6855l, a4, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, false, null, 91));
                arrayList3.add(x.b.a(x.f6855l, c3, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, false, null, 91));
                ...
                try {
                    str = a.a(URLDecoder.decode(new JSONObject(d2.f6536h.H()).getString(f.e.a.e.a("RQcQEQcH")), f.e.a.e.a("YjYlSVM=")));
                } catch (JSONException e2) {
                    e2.printStackTrace();
                    str = "";
                }
                i0 F = i0.F(str, d2.f6536h.E());
                e0 e0Var = d2.b;
                c0 c0Var = d2.f6531c;
                int i5 = d2.f6533e;
