...
public class b {
    ...
    public static volatile b f3900e;
    public String a = h.c1();
    public String b;
    ...
    public b() {
        ...
        this.f3902d = new String[]{new String(Base64.encode(e.a("TEAACx4dTUEKJVsDHUhZSRxaVUZHUVRcEQ9YAlpQQVoEUFRUW0oMA0dfFktaGgIYRBUMFg9RAxFCVAdTTVxBFg==").getBytes(), 2)), new String(Base64.encode(e.a("TEAACx4dTUEKJVsDHUhZSRxaVUZHUVRcEQ9YAlpQQVoEUVdXXUQLB0tQFktaGgIYRBUMFg9RAxFDVgRXSFpBFg==").getBytes(), 2)), new String(Base64.encode(e.a("TEAACx4dTUEKJVsDHUhZSRxaVUZHUVRcEQ9YAlpQQVoEUVJXW0QNA0RUFktaGgIYRBUMFg9RAxFDVgRXSFpBFg==").getBytes(), 2))}[i2];
        this.b = strArr[i2];
    }
