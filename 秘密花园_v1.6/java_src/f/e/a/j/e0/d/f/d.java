...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3925g = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f3926c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f3927d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f3928e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3929f;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3927d = h0Var.f6536h;
        if (h0Var.g()) {
            i0 i0Var = this.f3927d;
            h.s(i0Var, "Argument must not be null");
            f.d.a.u.b bVar = new f.d.a.u.b(this.f3927d.d(), i0Var.g());
            this.f3926c = bVar;
            this.f3928e.d(f.e.a.j.e0.d.d.b(bVar));
            return;
        }
        this.f3928e.c(new f.d.a.o.e(h0Var.f6532d, h0Var.f6533e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3925g, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3928e.c(iOException);
    }
