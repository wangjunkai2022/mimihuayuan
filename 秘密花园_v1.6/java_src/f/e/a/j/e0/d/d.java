...
public class d {
    ...
    public static String f3923c = f.e.a.e.a("dicwSygxehwjLXc0TzoCD1MLDQM=");
    ...
    public static Map<String, String> a(TreeMap<String, String> treeMap) {
        ...
        treeMap.put(a2, h.T0(sb.toString().substring(1) + f.e.a.e.a("EQ8eFU4WWAVJKnAEFTlcCnxLIAEtQQEEETZCA0FTIy4bWzYUNQ==")));
        return treeMap;
    }
