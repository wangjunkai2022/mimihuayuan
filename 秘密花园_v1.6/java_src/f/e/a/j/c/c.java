...
public class c extends j<ComicDetailBean> {
    ...
    public final /* synthetic */ ComicReadActivity f3912e;

    public c(ComicReadActivity comicReadActivity) {
        this.f3912e = comicReadActivity;
    }
    ...
    public void f(ComicDetailBean comicDetailBean) {
        this.f3912e.f226f = comicDetailBean.getSelf();
        final ComicReadActivity comicReadActivity = this.f3912e;
