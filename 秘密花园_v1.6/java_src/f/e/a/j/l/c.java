...
public class c extends j<Host> {
    ...
    public final /* synthetic */ FuLao2Launch2Activity f3975e;

    public c(FuLao2Launch2Activity fuLao2Launch2Activity) {
        this.f3975e = fuLao2Launch2Activity;
    }
    ...
    public void f(Host host) {
        Host host2 = host;
        FuLao2Launch2Activity fuLao2Launch2Activity = this.f3975e;
        ...
        FuLao2Activity.f776d = host2;
        FuLao2Launch2Activity fuLao2Launch2Activity2 = this.f3975e;
        if (fuLao2Launch2Activity2.b && fuLao2Launch2Activity2.f782g) {
