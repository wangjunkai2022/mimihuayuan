...
public class b implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f4030g = f.e.a.e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f4031c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f4032d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f4033e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f4034f;
    ...
    */
    public void c(@androidx.annotation.NonNull i.f r6, @androidx.annotation.NonNull i.h0 r7) {
        ...
        Lc6:
            ...
            f.d.a.o.m.d$a<? super java.io.InputStream> r7 = r5.f4033e
            java.io.ByteArrayInputStream r0 = new java.io.ByteArrayInputStream
            r0.<init>(r6)
            r7.d(r0)
            goto Le3
        Ld5:
            f.d.a.o.m.d$a<? super java.io.InputStream> r6 = r5.f4033e
            f.d.a.o.e r0 = new f.d.a.o.e
            java.lang.String r1 = r7.f6532d
            int r7 = r7.f6533e
            r0.<init>(r1, r7)
            r6.c(r0)
        Le3:
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f4030g, 3)) {
            f.e.a.e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f4033e.c(iOException);
    }
