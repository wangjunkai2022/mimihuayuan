...
public class d extends j<PlayUrl> {
    ...
    public final /* synthetic */ ShortVideoAdapter.TiktopHolder f3951e;

    public d(ShortVideoAdapter.TiktopHolder tiktopHolder) {
        this.f3951e = tiktopHolder;
    }
    ...
    public void f(PlayUrl playUrl) {
        ...
        this.f3951e.f554d.setHref(url);
        this.f3951e.a.setPlayUri(url);
        ShortVideoAdapter.TiktopHolder tiktopHolder = this.f3951e;
        if (tiktopHolder.f553c.f552d == tiktopHolder.getAdapterPosition()) {
            this.f3951e.a.startPlayer();
        }
    }
}
