...
public class a {
    ...
    public static int f4012c = 0;

    /* renamed from: d  reason: collision with root package name */
    public static int f4013d = 1;

    /* renamed from: e  reason: collision with root package name */
    public static int f4014e = 2;

    /* renamed from: f  reason: collision with root package name */
    public static int f4015f = 3;
    ...
    public static void b(WebResourceRequest webResourceRequest) {
        ...
        if (bVar != null) {
            ...
            f.e.a.j.o.c.a aVar3 = a.get(HGMovieDetailActivity.this.f1085d.f4011c);
            if (aVar3 != null) {
                ...
                if (hGMovieDetailActivity != null) {
                    ...
                    ((d0) hGMovieDetailActivity.f1086e.a(aVar4.b())).W(new f.e.a.j.o.a(hGMovieDetailActivity));
                    return;
                }
                throw null;
            }
    ...
    public static f.e.a.j.o.c.a c(WebResourceRequest webResourceRequest) {
        f.e.a.j.o.c.a aVar = new f.e.a.j.o.c.a();
        Uri url = webResourceRequest.getUrl();
        aVar.f4011c = url.getQueryParameter(e.a("Wg0VLQ8="));
        aVar.b = webResourceRequest.getRequestHeaders();
        aVar.a = url.toString();
        return aVar;
    }
