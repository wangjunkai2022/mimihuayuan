...
public class b implements g {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            h.j1(hGMovieDetailActivity.f113c.getVideoPlayerView(), dataBean.getPlayUrl().get(0));
        }
    }
    ...
    public void c(f fVar, h0 h0Var) throws IOException {
        this.a.runOnUiThread(new a((VideoList) new j().d(h0Var.f6536h.H(), VideoList.class)));
    }
