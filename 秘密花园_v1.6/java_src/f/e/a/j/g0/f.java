...
public class f extends BaseRefreshActivity.a<XXList> {
    ...
    public final /* synthetic */ VideoSearchActivity f3950f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(VideoSearchActivity videoSearchActivity) {
        super();
        this.f3950f = videoSearchActivity;
    }

    @Override // m.j
    public void f(Object obj) {
        XXList xXList = (XXList) obj;
        VideoSearchActivity videoSearchActivity = this.f3950f;
        videoSearchActivity.f1813e = xXList;
