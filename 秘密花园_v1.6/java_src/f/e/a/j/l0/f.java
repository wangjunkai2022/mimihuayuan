...
public class f extends j<ComicDetail> {

    /* renamed from: e  reason: collision with root package name */
    public final /* synthetic */ ComicReadActivity f3985e;

    public f(ComicReadActivity comicReadActivity) {
        this.f3985e = comicReadActivity;
    }
    ...
    public void f(ComicDetail comicDetail) {
        h.p1(f.e.a.e.a("0ujDjNbO37vjg774l9f9"));
        this.f3985e.b = comicDetail.getChapter();
        this.f3985e.n();
    }
}
