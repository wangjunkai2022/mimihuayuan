...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3968h = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f3969c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f3970d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f3971e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3972f;

    /* renamed from: g  reason: collision with root package name */
    public ByteArrayOutputStream f3973g = null;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3970d = h0Var.f6536h;
        if (h0Var.g()) {
            i0 i0Var = this.f3970d;
            h.s(i0Var, "Argument must not be null");
            InputStream bVar = new f.d.a.u.b(this.f3970d.d(), i0Var.g());
            this.f3969c = bVar;
            d.a<? super InputStream> aVar = this.f3971e;
            try {
        ...
        this.f3971e.c(new f.d.a.o.e(h0Var.f6532d, h0Var.f6533e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3968h, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3971e.c(iOException);
    }
