...
public class f extends BaseRefreshFragment.a<TopStar> {
    ...
    public final /* synthetic */ ColumnFragment f3946f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(ColumnFragment columnFragment) {
        super();
        this.f3946f = columnFragment;
    }
    ...
    public void f(Object obj) {
        ...
        delegateAdapter = this.f3946f.f120i;
        delegateAdapter.b(new Title4Adapter(this.f3946f.getContext(), f.e.a.e.a("09jZgtvn3JbAgoj/"), cVar));
        ColumnFragment columnFragment = this.f3946f;
