...
public class e extends j<StarWork> {
    ...
    public final /* synthetic */ MovieDetailActivity f3943e;

    public e(MovieDetailActivity movieDetailActivity) {
        this.f3943e = movieDetailActivity;
    }
    ...
    public void f(StarWork starWork) {
        ...
        if (starWork2.getData().size() != 0) {
            MovieDetailActivity movieDetailActivity = this.f3943e;
        ...
        this.f3943e.rlStar.setVisibility(8);
    }
}
