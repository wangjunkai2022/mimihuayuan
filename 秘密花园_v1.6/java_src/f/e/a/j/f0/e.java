...
public class e implements x.a {
    ...
    public void a(x xVar) {
        ...
        if (!e0.class.isAssignableFrom(MimeiComicItem.class)) {
            ...
            Table table = xVar.f6401j.d(MimeiComicItem.class).f6354c;
        ...
        int i2 = 0;
        if (aVar.a != null) {
            b = r.e(xVar.f6275d, tableQuery, descriptorOrdering, aVar);
        } else {
            b = OsResults.b(xVar.f6275d, tableQuery, descriptorOrdering);
        }
