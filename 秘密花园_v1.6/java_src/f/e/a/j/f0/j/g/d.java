...
public class d implements f.d.a.o.m.d<InputStream>, g {
    ...
    public static final String f3934h = e.a("eAkrEB8Df1YHBVwCCg==");
    public final f.a a;
    public final f.d.a.o.o.g b;

    /* renamed from: c  reason: collision with root package name */
    public InputStream f3935c;

    /* renamed from: d  reason: collision with root package name */
    public i0 f3936d;

    /* renamed from: e  reason: collision with root package name */
    public d.a<? super InputStream> f3937e;

    /* renamed from: f  reason: collision with root package name */
    public volatile f f3938f;

    /* renamed from: g  reason: collision with root package name */
    public ByteArrayOutputStream f3939g = null;
    ...
    public void c(@NonNull f fVar, @NonNull h0 h0Var) {
        this.f3936d = h0Var.f6536h;
        if (h0Var.g()) {
            i0 i0Var = this.f3936d;
            h.s(i0Var, "Argument must not be null");
            InputStream bVar = new f.d.a.u.b(this.f3936d.d(), i0Var.g());
            this.f3935c = bVar;
            d.a<? super InputStream> aVar = this.f3937e;
            try {
        ...
        this.f3937e.c(new f.d.a.o.e(h0Var.f6532d, h0Var.f6533e));
    }
    ...
    public void d(@NonNull f fVar, @NonNull IOException iOException) {
        if (Log.isLoggable(f3934h, 3)) {
            e.a("eAkrEB8DGVUSD1gCHEoXBBcNARAKGlcTAQNHEhQe");
        }
        this.f3937e.c(iOException);
    }
