...
public class e implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        e0 S = aVar.S();
        if (S.b.f6863j.equals(f.e.a.e.a("XxYXFBhJFhwDE1YLEQlNH1YLEg0eFFhdXQhRE1cCDBhDPRMTCl1NSwc="))) {
            h0 d2 = aVar.d(S);
            String b = b.b(d2.f6536h.H());
            if (!TextUtils.isEmpty(b) && b.length() > 64) {
                b = b.substring(32, b.length() - 32);
            }
            i0 F = i0.F(b, d2.f6536h.E());
            e0 e0Var = d2.b;
            c0 c0Var = d2.f6531c;
            int i2 = d2.f6533e;
        ...
        String str2 = S.b.f6863j;
        f.e.a.k.f.a();
        new LinkedHashMap();
        x xVar = S.b;
        String str3 = S.f6516c;
        g0 g0Var = S.f6518e;
        if (S.f6519f.isEmpty()) {
        ...
        if (xVar != null) {
            ...
            i0 F2 = i0.F(b.c(d5.f6536h.H(), d5.e(f.e.a.e.a("T08RARgDVl0AAxkLHQQEH18="))), d5.f6536h.E());
            e0 e0Var2 = d5.b;
            c0 c0Var2 = d5.f6531c;
            int i3 = d5.f6533e;
            String str5 = d5.f6532d;
            v vVar2 = d5.f6534f;
            w.a d6 = d5.f6535g.d();
            h0 h0Var4 = d5.f6537i;
            h0 h0Var5 = d5.f6538j;
