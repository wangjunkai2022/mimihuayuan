...
public class f extends j<ComicDetailBean> {
    ...
    public final /* synthetic */ ComicReadActivity f3967e;

    public f(ComicReadActivity comicReadActivity) {
        this.f3967e = comicReadActivity;
    }
    ...
    public void e(Throwable th) {
        c.a.a.b.g.h.p1(f.e.a.e.a("0MnDjOHx3YzSgLXIkOTUjrj0hsDam42W"));
    }

    @Override // m.j
    public void f(ComicDetailBean comicDetailBean) {
        ComicDetailBean comicDetailBean2 = comicDetailBean;
        this.f3967e.f580f = comicDetailBean2;
        if (!comicDetailBean2.isSucc()) {
            c.a.a.b.g.h.p1(comicDetailBean2.getMsg());
        }
        final ComicReadActivity comicReadActivity = this.f3967e;
