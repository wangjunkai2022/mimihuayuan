    ...
    public void v(RecyclerView.Recycler recycler, RecyclerView.State state, VirtualLayoutManager.f fVar, h hVar, f.a.a.a.c cVar) {
        ...
        if (cVar.getOrientation() == 1) {
            if (virtualLayoutManager.isLayoutRTL()) {
                d3 = ((virtualLayoutManager.j() - cVar.getPaddingRight()) - this.f3401h) - this.f3397d;
                paddingLeft = d3 - iVar.d(w);
            } else {
                paddingLeft = this.f3396c + cVar.getPaddingLeft() + this.f3400g;
            ...
            paddingTop = cVar.getPaddingTop() + this.f3402i + this.f3398e;
