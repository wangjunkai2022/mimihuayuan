...
public abstract class b extends j {
    ...
    public Rect f3387k = new Rect();

    /* renamed from: m  reason: collision with root package name */
    public float f3389m = Float.NaN;
    public int n = 0;
    ...
    public void a(RecyclerView.Recycler recycler, RecyclerView.State state, int i2, int i3, int i4, f.a.a.a.c cVar) {
        View view;
        if (y()) {
            if (((i4 == Integer.MAX_VALUE || i4 == Integer.MIN_VALUE) ? false : true) && (view = this.f3388l) != null) {
                this.f3387k.union(view.getLeft(), this.f3388l.getTop(), this.f3388l.getRight(), this.f3388l.getBottom());
            }
            if (!this.f3387k.isEmpty()) {
                if ((i4 == Integer.MAX_VALUE || i4 == Integer.MIN_VALUE) ? false : true) {
                    if (cVar.getOrientation() == 1) {
                        this.f3387k.offset(0, -i4);
                    } else {
                        this.f3387k.offset(-i4, 0);
                    }
                }
                ...
                if (virtualLayoutManager.getOrientation() != 1 ? this.f3387k.intersects((-j2) / 4, 0, (j2 / 4) + j2, i5) : this.f3387k.intersects(0, (-i5) / 4, j2, (i5 / 4) + i5)) {
                    if (this.f3388l == null) {
                    ...
                    if (virtualLayoutManager.getOrientation() == 1) {
                        this.f3387k.left = virtualLayoutManager.getPaddingLeft() + this.f3400g;
                        this.f3387k.right = (virtualLayoutManager.j() - virtualLayoutManager.getPaddingRight()) - this.f3401h;
                    } else {
                        this.f3387k.top = virtualLayoutManager.getPaddingTop() + this.f3402i;
                        this.f3387k.bottom = (virtualLayoutManager.j() - virtualLayoutManager.getPaddingBottom()) - this.f3403j;
                    }
                    View view2 = this.f3388l;
                    view2.measure(View.MeasureSpec.makeMeasureSpec(this.f3387k.width(), 1073741824), View.MeasureSpec.makeMeasureSpec(this.f3387k.height(), 1073741824));
                    Rect rect = this.f3387k;
                    ...
                    this.f3387k.set(0, 0, 0, 0);
                    return;
                }
                this.f3387k.set(0, 0, 0, 0);
                View view3 = this.f3388l;
                if (view3 != null) {
                    view3.layout(0, 0, 0, 0);
                }
            }
        }
        View view4 = this.f3388l;
        if (view4 != null) {
    ...
    */
    ...
    public void t(h hVar, View view) {
        ...
        if (!hVar.f3395d && !view.isFocusable()) {
            z = false;
        }
        hVar.f3395d = z;
    }
    ...
    public void u(View view, int i2, int i3, int i4, int i5, @NonNull f.a.a.a.c cVar) {
        ...
        if (y()) {
            this.f3387k.union(i2 - this.f3396c, i3 - this.f3398e, i4 + this.f3397d, i5 + this.f3399f);
        }
    }
