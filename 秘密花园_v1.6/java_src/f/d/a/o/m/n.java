...
public class n extends l<InputStream> {
    ...
    public static final UriMatcher f3567d;

    static {
        UriMatcher uriMatcher = new UriMatcher(-1);
        f3567d = uriMatcher;
        uriMatcher.addURI("com.android.contacts", "contacts/lookup/*/#", 1);
        f3567d.addURI("com.android.contacts", "contacts/lookup/*", 1);
        f3567d.addURI("com.android.contacts", "contacts/#/photo", 2);
        f3567d.addURI("com.android.contacts", "contacts/#", 3);
        f3567d.addURI("com.android.contacts", "contacts/#/display_photo", 4);
        f3567d.addURI("com.android.contacts", "phone_lookup/*", 5);
    }
    ...
    */
    public java.io.InputStream d(android.net.Uri r4, android.content.ContentResolver r5) throws java.io.FileNotFoundException {
        /*
            r3 = this;
            android.content.UriMatcher r0 = f.d.a.o.m.n.f3567d
            int r0 = r0.match(r4)
            r1 = 1
            if (r0 == r1) goto L19
            r2 = 3
