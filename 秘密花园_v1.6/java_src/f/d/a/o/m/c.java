...
public final class c extends OutputStream {
    ...
    public void write(@NonNull byte[] bArr, int i2, int i3) throws IOException {
        ...
        do {
            int i5 = i3 - i4;
            int i6 = i2 + i4;
            if (this.f3557d == 0 && i5 >= this.b.length) {
                this.a.write(bArr, i6, i5);
                return;
            }
            int min = Math.min(i5, this.b.length - this.f3557d);
            System.arraycopy(bArr, i6, this.b, this.f3557d, min);
            int i7 = this.f3557d + min;
            this.f3557d = i7;
            i4 += min;
            byte[] bArr2 = this.b;
