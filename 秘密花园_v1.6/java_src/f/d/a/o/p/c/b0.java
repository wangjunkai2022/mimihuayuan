...
public class b0<T> implements f.d.a.o.j<T, Bitmap> {
    ...
    public static final f.d.a.o.g<Long> f3755d = new f.d.a.o.g<>("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", -1L, new a());

    /* renamed from: e  reason: collision with root package name */
    public static final f.d.a.o.g<Integer> f3756e = new f.d.a.o.g<>("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", 2, new b());

    /* renamed from: f  reason: collision with root package name */
    public static final d f3757f = new d();
    public final e<T> a;
    public final f.d.a.o.n.b0.d b;

    /* renamed from: c  reason: collision with root package name */
    public final d f3758c;
    ...
    */
    public static android.graphics.Bitmap c(android.media.MediaMetadataRetriever r9, long r10, int r12, int r13, int r14, f.d.a.o.p.c.m r15) {
        /*
            ...
            if (r13 == r0) goto L59
            if (r14 == r0) goto L59
            f.d.a.o.p.c.m r0 = f.d.a.o.p.c.m.f3761d
            if (r15 == r0) goto L59
            r0 = 18
    ...
    public f.d.a.o.n.w<Bitmap> a(@NonNull T t, int i2, int i3, @NonNull f.d.a.o.h hVar) throws IOException {
        long longValue = ((Long) hVar.c(f3755d)).longValue();
        ...
        Integer num = (Integer) hVar.c(f3756e);
        if (num == null) {
            num = 2;
        }
        m mVar = (m) hVar.c(m.f3763f);
        if (mVar == null) {
            mVar = m.f3762e;
        }
        m mVar2 = mVar;
