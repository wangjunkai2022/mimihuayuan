...
public final class n {
    ...
    public static final f.d.a.o.g<f.d.a.o.b> f3766f = f.d.a.o.g.a("com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeFormat", f.d.a.o.b.f3547c);

    /* renamed from: g  reason: collision with root package name */
    public static final f.d.a.o.g<f.d.a.o.i> f3767g = f.d.a.o.g.a("com.bumptech.glide.load.resource.bitmap.Downsampler.PreferredColorSpace", f.d.a.o.i.SRGB);

    /* renamed from: h  reason: collision with root package name */
    public static final f.d.a.o.g<Boolean> f3768h;

    /* renamed from: i  reason: collision with root package name */
    public static final f.d.a.o.g<Boolean> f3769i;

    /* renamed from: j  reason: collision with root package name */
    public static final Set<String> f3770j;

    /* renamed from: k  reason: collision with root package name */
    public static final b f3771k;

    /* renamed from: l  reason: collision with root package name */
    public static final Set<ImageHeaderParser.ImageType> f3772l;

    /* renamed from: m  reason: collision with root package name */
    public static final Queue<BitmapFactory.Options> f3773m;
    public final f.d.a.o.n.b0.d a;
    public final DisplayMetrics b;

    /* renamed from: c  reason: collision with root package name */
    public final f.d.a.o.n.b0.b f3774c;

    /* renamed from: d  reason: collision with root package name */
    public final List<ImageHeaderParser> f3775d;

    /* renamed from: e  reason: collision with root package name */
    public final s f3776e = s.a();
    ...
    static {
        f.d.a.o.g<m> gVar = m.f3763f;
        f3768h = f.d.a.o.g.a("com.bumptech.glide.load.resource.bitmap.Downsampler.FixBitmapSize", Boolean.FALSE);
        f3769i = f.d.a.o.g.a("com.bumptech.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", Boolean.FALSE);
        f3770j = Collections.unmodifiableSet(new HashSet(Arrays.asList("image/vnd.wap.wbmp", "image/x-ico")));
        f3771k = new a();
        f3772l = Collections.unmodifiableSet(EnumSet.of(ImageHeaderParser.ImageType.JPEG, ImageHeaderParser.ImageType.PNG_A, ImageHeaderParser.ImageType.PNG));
        f3773m = f.d.a.u.i.d(0);
    }
    ...
    public f.d.a.o.n.w<Bitmap> a(InputStream inputStream, int i2, int i3, f.d.a.o.h hVar, b bVar) throws IOException {
        ...
        byte[] bArr = (byte[]) this.f3774c.f(65536, byte[].class);
        ...
        f.d.a.o.b bVar2 = (f.d.a.o.b) hVar.c(f3766f);
        f.d.a.o.i iVar = (f.d.a.o.i) hVar.c(f3767g);
        try {
            e c2 = e.c(b(inputStream, options, (m) hVar.c(m.f3763f), bVar2, iVar, hVar.c(f3769i) != null && ((Boolean) hVar.c(f3769i)).booleanValue(), i2, i3, ((Boolean) hVar.c(f3768h)).booleanValue(), bVar), this.a);
            i(options);
            synchronized (f3773m) {
                f3773m.offer(options);
            }
            this.f3774c.e(bArr);
            return c2;
        } catch (Throwable th) {
