...
public final class a implements ExecutorService {
    ...
    public static volatile int f3623c;
    ...
    public static final class ThreadFactoryC0038a implements ThreadFactory {
        ...
        public class C0039a extends Thread {
            ...
            public void run() {
                ...
                if (ThreadFactoryC0038a.this.f3624c) {
        ...
        public synchronized Thread newThread(@NonNull Runnable runnable) {
            C0039a c0039a;
            c0039a = new C0039a(runnable, "glide-" + this.a + "-thread-" + this.f3625d);
            this.f3625d = this.f3625d + 1;
            return c0039a;
        }
    }
    ...
    public static int a() {
        if (f3623c == 0) {
            f3623c = Math.min(4, Runtime.getRuntime().availableProcessors());
        }
        return f3623c;
    }
