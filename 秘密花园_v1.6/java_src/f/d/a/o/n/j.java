...
public class j<DataType, ResourceType, Transcode> {
    ...
    public final f.d.a.o.p.h.e<ResourceType, Transcode> f3659c;

    /* renamed from: d  reason: collision with root package name */
    public final Pools.Pool<List<Throwable>> f3660d;
        ...
        try {
            ...
            if (iVar != null) {
                ...
                if (aVar2 != f.d.a.o.a.RESOURCE_DISK_CACHE) {
                    ...
                    lVar = f2;
                    wVar = f2.a(iVar.f3644h, b, iVar.f3648l, iVar.f3649m);
                } else {
                    wVar = b;
                    lVar = null;
                }
                ...
                boolean z = false;
                if (iVar.a.f3628c.b.f3467d.a(wVar.b()) != null) {
                    f.d.a.o.k a2 = iVar.a.f3628c.b.f3467d.a(wVar.b());
                    if (a2 != null) {
                        cVar = a2.b(iVar.o);
                        kVar = a2;
                    } else {
                ...
                if (iVar.n.d(!z, aVar2, cVar)) {
                    if (kVar != null) {
                        ...
                        if (ordinal == 0) {
                            eVar2 = new e(iVar.x, iVar.f3645i);
                        } else if (ordinal == 1) {
                            eVar2 = new y(iVar.a.f3628c.a, iVar.x, iVar.f3645i, iVar.f3648l, iVar.f3649m, lVar, cls, iVar.o);
                        } else {
                            throw new IllegalArgumentException("Unknown strategy: " + cVar);
                        }
                        v<Z> a3 = v.a(wVar);
                        i.c<?> cVar2 = iVar.f3642f;
                        cVar2.a = eVar2;
                        cVar2.b = kVar;
                        cVar2.f3650c = a3;
                        wVar2 = a3;
                ...
                return this.f3659c.a(wVar2, hVar);
            }
            throw null;
        } catch (Throwable th) {
            this.f3660d.release(list);
    ...
    public final w<ResourceType> b(f.d.a.o.m.e<DataType> eVar, int i2, int i3, @NonNull f.d.a.o.h hVar, List<Throwable> list) throws r {
        ...
        throw new r(this.f3661e, new ArrayList(list));
    }
