...
public final class a {
    ...
    public final ReferenceQueue<q<?>> f3573c;
    ...
    public synchronized void a(f.d.a.o.f fVar, q<?> qVar) {
        b put = this.b.put(fVar, new b(fVar, qVar, this.f3573c, this.a));
        if (put != null) {
            put.f3575c = null;
            put.clear();
        }
    ...
    public void b(@NonNull b bVar) {
        synchronized (this) {
            ...
            if (bVar.b && bVar.f3575c != null) {
                this.f3574d.a(bVar.a, new q<>(bVar.f3575c, true, false, bVar.a, this.f3574d));
            }
        }
    }
}
