...
public class r {
    ...
    public static final c f3745e = new c();

    /* renamed from: f  reason: collision with root package name */
    public static final n<Object, Object> f3746f = new a();
    public final List<b<?, ?>> a;
    public final c b;

    /* renamed from: c  reason: collision with root package name */
    public final Set<b<?, ?>> f3747c;

    /* renamed from: d  reason: collision with root package name */
    public final Pools.Pool<List<Throwable>> f3748d;
    ...
    public static class b<Model, Data> {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final o<? extends Model, ? extends Data> f3749c;
    ...
    public final <Model, Data> n<Model, Data> b(@NonNull b<?, ?> bVar) {
        n<Model, Data> nVar = (n<Model, Data>) bVar.f3749c.b(this);
    ...
    public synchronized <Model, Data> n<Model, Data> c(@NonNull Class<Model> cls, @NonNull Class<Data> cls2) {
        try {
            ...
            boolean z = false;
            for (b<?, ?> bVar : this.a) {
                if (this.f3747c.contains(bVar)) {
                    z = true;
                } else if (bVar.a(cls, cls2)) {
                    this.f3747c.add(bVar);
                    arrayList.add(b(bVar));
                    this.f3747c.remove(bVar);
                }
            }
            if (arrayList.size() > 1) {
                c cVar = this.b;
                Pools.Pool<List<Throwable>> pool = this.f3748d;
                if (cVar != null) {
    ...
    public synchronized <Model> List<n<Model, ?>> d(@NonNull Class<Model> cls) {
        ...
        try {
            ...
            for (b<?, ?> bVar : this.a) {
                if (!this.f3747c.contains(bVar) && bVar.a.isAssignableFrom(cls)) {
                    this.f3747c.add(bVar);
                    n<? extends Object, ? extends Object> b2 = bVar.f3749c.b(this);
