...
public final class j implements h {
    ...
    public volatile Map<String, String> f3734c;
    ...
    public static final class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public static final Map<String, List<i>> f3735c;
        public Map<String, List<i>> a = f3735c;
        ...
        static {
            ...
            f3735c = Collections.unmodifiableMap(hashMap);
        }
    }
    ...
    public Map<String, String> a() {
        if (this.f3734c == null) {
            synchronized (this) {
                if (this.f3734c == null) {
                    this.f3734c = Collections.unmodifiableMap(b());
                }
            }
        }
        return this.f3734c;
