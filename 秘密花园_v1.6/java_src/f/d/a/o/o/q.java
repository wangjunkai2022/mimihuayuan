...
public class q<Model, Data> implements n<Model, Data> {
    ...
    public static class a<Data> implements f.d.a.o.m.d<Data>, d.a<Data> {
        ...
        public f.d.a.f f3741d;

        /* renamed from: e  reason: collision with root package name */
        public d.a<? super Data> f3742e;
        @Nullable

        /* renamed from: f  reason: collision with root package name */
        public List<Throwable> f3743f;
        ...
        @Override // f.d.a.o.m.d
        public void b() {
            List<Throwable> list = this.f3743f;
            if (list != null) {
                this.b.release(list);
            }
            this.f3743f = null;
        ...
        public void f(@NonNull f.d.a.f fVar, @NonNull d.a<? super Data> aVar) {
            this.f3741d = fVar;
            this.f3742e = aVar;
            this.f3743f = this.b.acquire();
            this.a.get(this.f3740c).f(fVar, this);
            if (this.f3744g) {
                cancel();
            }
        }
        ...
        public final void g() {
            ...
            if (this.f3740c < this.a.size() - 1) {
                this.f3740c++;
                f(this.f3741d, this.f3742e);
                return;
            }
            c.a.a.b.g.h.s(this.f3743f, "Argument must not be null");
            this.f3742e.c(new f.d.a.o.n.r("Fetch failed", new ArrayList(this.f3743f)));
        }
    }
