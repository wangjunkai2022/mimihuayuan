...
public final class g<R> implements b, f.d.a.s.h.g, f {
    ...
    public final f.d.a.e f3844g;
    @Nullable

    /* renamed from: h  reason: collision with root package name */
    public final Object f3845h;

    /* renamed from: i  reason: collision with root package name */
    public final Class<R> f3846i;

    /* renamed from: j  reason: collision with root package name */
    public final f.d.a.s.a<?> f3847j;
    ...
    */
    public void c() {
        /*
            ...
            java.lang.Object r3 = r5.f3845h     // Catch: java.lang.Throwable -> La0
            if (r3 != 0) goto L40
            int r0 = r5.f3848k     // Catch: java.lang.Throwable -> La0
            int r1 = r5.f3849l     // Catch: java.lang.Throwable -> La0
            boolean r0 = f.d.a.u.i.m(r0, r1)     // Catch: java.lang.Throwable -> La0
            if (r0 == 0) goto L2b
            int r0 = r5.f3848k     // Catch: java.lang.Throwable -> La0
            r5.z = r0     // Catch: java.lang.Throwable -> La0
            int r0 = r5.f3849l     // Catch: java.lang.Throwable -> La0
        ...
        L53:
            ...
            int r3 = r5.f3848k     // Catch: java.lang.Throwable -> La0
            int r4 = r5.f3849l     // Catch: java.lang.Throwable -> La0
        ...
        L6c:
            ...
            if (r1 != r0) goto L8d
        L74:
            f.d.a.s.c r0 = r5.f3842e     // Catch: java.lang.Throwable -> La0
            if (r0 == 0) goto L81
    ...
    */
    public void clear() {
        ...
        L13:
            ...
            r3 = r2
        L20:
            f.d.a.s.c r2 = r5.f3842e     // Catch: java.lang.Throwable -> L44
            if (r2 == 0) goto L2d
        ...
        synchronized (obj2) {
            try {
                ...
                if (this.v == a.WAITING_FOR_SIZE) {
                    ...
                    try {
                        try {
                            this.s = this.u.b(this.f3844g, this.f3845h, this.f3847j.f3838l, this.z, this.A, this.f3847j.s, this.f3846i, this.f3850m, this.f3847j.f3829c, this.f3847j.r, this.f3847j.f3839m, this.f3847j.y, this.f3847j.q, this.f3847j.f3835i, this.f3847j.w, this.f3847j.z, this.f3847j.x, this, this.q);
                            if (this.v != aVar) {
                                this.s = null;
                            }
                            if (D) {
    ...
    public final Drawable i() {
        ...
        if (this.x == null) {
            f.d.a.s.a<?> aVar = this.f3847j;
            Drawable drawable = aVar.f3833g;
            this.x = drawable;
            if (drawable == null && (i2 = aVar.f3834h) > 0) {
                this.x = l(i2);
            }
        }
        return this.x;
    ...
    public final Drawable l(@DrawableRes int i2) {
        Resources.Theme theme = this.f3847j.u;
        if (theme == null) {
            theme = this.f3843f.getTheme();
        }
        f.d.a.e eVar = this.f3844g;
    ...
    public final void m(r rVar, int i2) {
        ...
        synchronized (this.f3840c) {
            if (rVar != null) {
                int i3 = this.f3844g.f3461i;
                if (i3 <= i2) {
                    String str = "Load failed for " + this.f3845h + " with size [" + this.z + "x" + this.A + "]";
                    if (i3 <= 4) {
                ...
                if (this.o != null) {
                    z = false;
                    for (d<R> dVar : this.o) {
                        z |= dVar.b(rVar, this.f3845h, this.n, k());
                    }
                } else {
                    z = false;
                }
                if (this.f3841d == null || !this.f3841d.b(rVar, this.f3845h, this.n, k())) {
                    z2 = false;
                }
                if (!(z | z2)) {
                    p();
        ...
        try {
            synchronized (this.f3840c) {
                try {
                    this.s = null;
                    if (wVar == null) {
                        m(new r("Expected to receive a Resource<R> with an object of " + this.f3846i + " inside, but instead got null."), 5);
                        return;
                    }
                    Object obj = wVar.get();
                    try {
                        if (obj != null && this.f3846i.isAssignableFrom(obj.getClass())) {
                            c cVar = this.f3842e;
    ...
    public final void o(w<R> wVar, R r, f.d.a.o.a aVar) {
        ...
        try {
            if (this.o != null) {
                z = false;
                for (d<R> dVar : this.o) {
                    z |= dVar.a(r, this.f3845h, this.n, aVar, k2);
                }
            } else {
                z = false;
            }
            if (this.f3841d == null || !this.f3841d.a(r, this.f3845h, this.n, aVar, k2)) {
                z2 = false;
            }
            if (!(z2 | z)) {
    ...
    public final void p() {
        ...
        if (cVar == null || cVar.c(this)) {
            Drawable h2 = this.f3845h == null ? h() : null;
            if (h2 == null) {
                if (this.w == null) {
                    f.d.a.s.a<?> aVar = this.f3847j;
                    Drawable drawable = aVar.f3831e;
                    this.w = drawable;
                    if (drawable == null && (i2 = aVar.f3832f) > 0) {
                        this.w = l(i2);
                    }
                }
                h2 = this.w;
