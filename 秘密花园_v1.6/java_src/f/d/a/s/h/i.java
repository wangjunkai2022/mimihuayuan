...
public abstract class i<T extends View, Z> extends f.d.a.s.h.a<Z> {
    ...
    public static int f3858c = f.d.a.g.glide_custom_view_target_tag;
    public final T a;
    public final a b;
    ...
    public static final class a {
        ...
        public static Integer f3859d;
        public final View a;
        public final List<g> b = new ArrayList();
        @Nullable

        /* renamed from: c  reason: collision with root package name */
        public ViewTreeObserver$OnPreDrawListenerC0052a f3860c;
        ...
        public void a() {
            ...
            if (viewTreeObserver.isAlive()) {
                viewTreeObserver.removeOnPreDrawListener(this.f3860c);
            }
            this.f3860c = null;
            this.b.clear();
        }
        ...
        public final int b(int i2, int i3, int i4) {
            ...
            if (f3859d == null) {
                ...
                f3859d = Integer.valueOf(Math.max(point.x, point.y));
            }
            return f3859d.intValue();
        }
    ...
    @Nullable
    public f.d.a.s.b f() {
        Object tag = this.a.getTag(f3858c);
        if (tag != null) {
    ...
    public void h(@NonNull g gVar) {
        ...
        if (aVar.f3860c == null) {
            ...
            aVar.f3860c = viewTreeObserver$OnPreDrawListenerC0052a;
