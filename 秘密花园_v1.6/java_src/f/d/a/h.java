...
public class h {
    ...
    public final f.d.a.r.e f3466c;

    /* renamed from: d  reason: collision with root package name */
    public final f.d.a.r.f f3467d;

    /* renamed from: e  reason: collision with root package name */
    public final f.d.a.o.m.f f3468e;

    /* renamed from: f  reason: collision with root package name */
    public final f.d.a.o.p.h.f f3469f;

    /* renamed from: g  reason: collision with root package name */
    public final f.d.a.r.b f3470g;

    /* renamed from: h  reason: collision with root package name */
    public final f.d.a.r.d f3471h = new f.d.a.r.d();

    /* renamed from: i  reason: collision with root package name */
    public final f.d.a.r.c f3472i = new f.d.a.r.c();

    /* renamed from: j  reason: collision with root package name */
    public final Pools.Pool<List<Throwable>> f3473j;
    ...
    public h() {
        ...
        this.f3466c = new f.d.a.r.e();
        this.f3467d = new f.d.a.r.f();
        this.f3468e = new f.d.a.o.m.f();
        this.f3469f = new f.d.a.o.p.h.f();
        this.f3470g = new f.d.a.r.b();
        List asList = Arrays.asList("Gif", "Bitmap", "BitmapDrawable");
        ArrayList arrayList = new ArrayList(asList.size());
        arrayList.addAll(asList);
        arrayList.add(0, "legacy_prepend_all");
        arrayList.add("legacy_append");
        f.d.a.r.e eVar = this.f3466c;
        synchronized (eVar) {
    ...
    public <TResource, Transcode> h h(@NonNull Class<TResource> cls, @NonNull Class<Transcode> cls2, @NonNull f.d.a.o.p.h.e<TResource, Transcode> eVar) {
        f.d.a.o.p.h.f fVar = this.f3469f;
        synchronized (fVar) {
