...
public class l implements Handler.Callback {
    ...
    public static final b f3822f = new a();
    ...
    public final Map<androidx.fragment.app.FragmentManager, SupportRequestManagerFragment> f3823c = new HashMap();
    ...
    public l(@Nullable b bVar) {
        ...
        new ArrayMap();
        new Bundle();
        this.f3825e = bVar == null ? f3822f : bVar;
        this.f3824d = new Handler(Looper.getMainLooper(), this);
    }
    ...
    public f.d.a.j b(@NonNull Context context) {
        if (context != null) {
            if (f.d.a.u.i.l() && !(context instanceof Application)) {
                if (context instanceof FragmentActivity) {
                    ...
                    if (!fragmentActivity.isDestroyed()) {
                        ...
                        if (jVar == null) {
                            f.d.a.j a2 = this.f3825e.a(f.d.a.c.b(fragmentActivity), d2.a, d2.b, fragmentActivity);
                            d2.f100e = a2;
                            return a2;
                        }
                        return jVar;
                    ...
                    if (!activity.isDestroyed()) {
                        ...
                        f.d.a.j jVar2 = c2.f3819d;
                        if (jVar2 == null) {
                            f.d.a.j a3 = this.f3825e.a(f.d.a.c.b(activity), c2.a, c2.b, activity);
                            c2.f3819d = a3;
                            return a3;
                        }
                        return jVar2;
            ...
            if (this.a == null) {
                synchronized (this) {
                    if (this.a == null) {
                        this.a = this.f3825e.a(f.d.a.c.b(context.getApplicationContext()), new f.d.a.p.b(), new g(), context.getApplicationContext());
                    }
                }
            }
            return this.a;
    ...
    public final k c(@NonNull FragmentManager fragmentManager, @Nullable Fragment fragment, boolean z) {
        ...
        if (kVar == null && (kVar = this.b.get(fragmentManager)) == null) {
            ...
            this.f3824d.obtainMessage(1, fragmentManager).sendToTarget();
        }
        return kVar;
    }
    ...
    public final SupportRequestManagerFragment d(@NonNull androidx.fragment.app.FragmentManager fragmentManager, @Nullable androidx.fragment.app.Fragment fragment, boolean z) {
        ...
        if (supportRequestManagerFragment == null && (supportRequestManagerFragment = this.f3823c.get(fragmentManager)) == null) {
            ...
            this.f3823c.put(fragmentManager, supportRequestManagerFragment);
            fragmentManager.beginTransaction().add(supportRequestManagerFragment, "com.bumptech.glide.manager").commitAllowingStateLoss();
            this.f3824d.obtainMessage(2, fragmentManager).sendToTarget();
        }
