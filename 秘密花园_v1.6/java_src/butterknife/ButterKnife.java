...
public final class ButterKnife {
    ...
    public static Unbinder b(@NonNull Object obj, @NonNull View view) {
        ...
        try {
            return c2.newInstance(obj, view);
    ...
    public static Constructor<? extends Unbinder> c(Class<?> cls) {
        Constructor<? extends Unbinder> c2;
        Constructor<? extends Unbinder> constructor = a.get(cls);
        ...
        try {
            ...
            c2 = classLoader.loadClass(name + "_ViewBinding").getConstructor(cls, View.class);
