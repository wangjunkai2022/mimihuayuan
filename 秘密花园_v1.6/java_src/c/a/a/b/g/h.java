...
public class h {
    ...
    */
    ...
    public static void H0(m mVar, f.i.a.a.h1.t0.k.i iVar, f.i.a.a.h1.s0.e eVar, f.i.a.a.h1.t0.k.h hVar) throws IOException, InterruptedException {
        ...
        p c2 = pVar.c(0L);
        try {
            f.i.a.a.b1.d dVar = new f.i.a.a.b1.d(g0Var, c2.f5688d, g0Var.b(c2));
            eVar.b(null, -9223372036854775807L, -9223372036854775807L);
            f.i.a.a.b1.g gVar = eVar.a;
            int i2 = 0;
            while (i2 == 0) {
                i2 = gVar.c(dVar, f.i.a.a.h1.s0.k.f4985l);
            }
            v(i2 != 1);
        } finally {
            h0.k(g0Var);
    ...
    public static void I0(String str, ImageView imageView) {
        ...
        f.d.a.c.d(App.b).o(new f.e.a.j.s.e.c.a(str)).q(R.drawable.default_img_bg).G(imageView);
    }
    ...
    public static void J0(String str, ImageView imageView) {
        ...
        f.d.a.c.d(App.b).o(new f.e.a.j.s.e.c.a(str)).q(R.drawable.default_img_bg).a(f.d.a.s.e.C()).G(imageView);
    }
    ...
    */
    ...
    public static void M0(String str, ImageView imageView) {
        if (TextUtils.isEmpty(str)) {
            return;
        }
    ...
    public static void O0(String str, ImageView imageView, int i2) {
    ...
    public static final <T, R> h.r.c<R> R0(h.r.c<? extends T> cVar, h.o.b.b<? super T, ? extends R> bVar) {
    ...
    public static void S0(MediaFormat mediaFormat, String str, int i2) {
        if (i2 != -1) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> List<T> V0(List<? extends T> list) {
        int size = list.size();
        if (size != 0) {
    ...
    public static f.e.a.h.h.a W0(String str) throws IOException {
        String readLine;
                ...
                if (readLine != null) {
                    if (readLine.startsWith(f.e.a.e.a("FA=="))) {
                        ...
                        if (readLine.startsWith(f.e.a.e.a("FCc7MEYrFHg2Pw=="))) {
                            ...
                            if (replace.contains(f.e.a.e.a("Gw=="))) {
                                ...
                                while (i3 < length) {
                                    ...
                                    if (str2.startsWith(f.e.a.e.a("YjAqWQ=="))) {
                                        ...
                                        if (substring3.startsWith(f.e.a.e.a("XxYXFA=="))) {
                                            aVar.f3885d = substring3;
                                        } else if (substring3.contains(f.e.a.e.a("GA=="))) {
                                            aVar.f3885d = url.substring(0, url.indexOf(f.e.a.e.a("GA=="), 9)) + substring3;
                                        } else {
                                            aVar.f3885d = f.b.a.a.a.f(substring, substring3);
                                        }
                                    }
                                    if (str2.startsWith(f.e.a.e.a("fjRe"))) {
                                        aVar.f3886e = str2.substring(3);
                                    }
                                    i3++;
                                    z = true;
                                    i2 = 5;
                                ...
                                if (substring4.startsWith(f.e.a.e.a("XxYXFA=="))) {
                                    aVar.f3885d = substring4;
                                } else if (substring4.contains(f.e.a.e.a("GA=="))) {
                                    aVar.f3885d = url.substring(0, url.indexOf(f.e.a.e.a("GA=="), 9)) + substring4;
                                } else {
                                    aVar.f3885d = f.b.a.a.a.f(substring, substring4);
                                }
                                aVar.f3886e = "";
                                z = true;
                            }
                        ...
                        if (readLine.contains(f.e.a.e.a("GA=="))) {
                            return W0(url.substring(0, url.indexOf(f.e.a.e.a("GA=="), 9) + 1) + readLine);
                        }
                        return W0(substring + readLine);
                    } else {
                        z = true;
                        z = true;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static f.e.a.h.h.a X0(java.lang.String r17, java.lang.String r18, java.lang.String r19) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 693
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: c.a.a.b.g.h.X0(java.lang.String, java.lang.String, java.lang.String):f.e.a.h.h.a");
    }
    ...
    public static VideoInfo Y0(String str) {
    ...
    public static ArrayList<Video> Z0(String str) {
    ...
    public static int a0(SQLiteDatabase sQLiteDatabase, int i2, String str) throws f.i.a.a.x0.a {
        try {
            if (r1(sQLiteDatabase, "ExoPlayerVersions")) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static java.util.UUID a1(byte[] r9) {
        /*
        ...
        L6d:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: c.a.a.b.g.h.a1(byte[]):java.util.UUID");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static f.i.a.a.b1.y.b b1(f.i.a.a.b1.d r19) throws java.io.IOException, java.lang.InterruptedException {
        /*
            r0 = r19
            r1 = 0
            if (r0 == 0) goto Ld2
        ...
        Ld2:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: c.a.a.b.g.h.b1(f.i.a.a.b1.d):f.i.a.a.b1.y.b");
    }
    ...
    public static long d1(u uVar, int i2, int i3) {
        byte[] bArr;
        uVar.A(i2);
        if (uVar.a() < 5) {
    ...
    public static String e1(StringBuilder sb, int i2, int i3) {
        int i4;
        int i5;
        if (i2 >= i3) {
            return sb.toString();
    ...
    public static Uri g1(String str, String str2) {
        return Uri.parse(f1(str, str2));
    }

    public static ExoUserPlayer h(Activity activity, VideoPlayerView videoPlayerView) {
        k1(activity, videoPlayerView);
    ...
    */
    ...
    public static void i1(MediaFormat mediaFormat, List<byte[]> list) {
    ...
    public static void j1(VideoPlayerView videoPlayerView, String str) {
    ...
    public static void k1(Activity activity, VideoPlayerView videoPlayerView) {
    ...
    public static boolean m0() {
        return f.e.a.e.a("ZAcAFg4HflIBAlEJ").equals(f.e.a.e.a("ZAcbHQMGWw=="));
    }
    ...
    public static void n1(SQLiteDatabase sQLiteDatabase, int i2, String str, int i3) throws f.i.a.a.x0.a {
        try {
    ...
    public static void o1(View view, float f2, long j2) {
        int left = view.getLeft();
        int top = view.getTop();
        int width = view.getWidth();
        int height = view.getHeight();
    ...
    @VisibleForTesting
    public static boolean r1(SQLiteDatabase sQLiteDatabase, String str) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void v1(java.io.File r23, @androidx.annotation.Nullable f.i.a.a.e1.j r24, f.i.a.a.e1.k r25, boolean r26, boolean r27) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 255
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: c.a.a.b.g.h.v1(java.io.File, f.i.a.a.e1.j, f.i.a.a.e1.k, boolean, boolean):void");
    }
    ...
    public static boolean w1(int i2, u uVar, boolean z) throws f.i.a.a.h0 {
        if (uVar.a() < 7) {
            if (z) {
                return false;
            }
