...
public class b extends m {
    ...
    public final void A(k.a.e.l lVar) {
        ...
        if (lVar instanceof k.a.e.h) {
            ...
            if (!hVar.f7102c.f7160h || (jVar = this.o) == null) {
                return;
            }
            jVar.f7114i.add(hVar);
        }
    }
    ...
    public boolean C(k.a.e.h hVar) {
        return k.a.d.a.d(hVar.f7102c.b, D);
    }

    public boolean D(k.a.e.h hVar) {
        return B(this.f7205e, hVar);
    }

    public k.a.e.h E() {
        return this.f7205e.remove(this.f7205e.size() - 1);
    }

    public k.a.e.h F(String str) {
        for (int size = this.f7205e.size() - 1; size >= 0; size--) {
            k.a.e.h hVar = this.f7205e.get(size);
            this.f7205e.remove(size);
    ...
    public void G(k.a.e.h hVar) {
        ...
        while (true) {
            if (size >= 0) {
                ...
                if (hVar.f7102c.b.equals(hVar2.f7102c.b) && hVar.d().equals(hVar2.d())) {
                    i2++;
                }
                if (i2 == 3) {
                    this.q.remove(size);
    ...
    */
    public void H() {
        ...
        L19:
            if (r0 == 0) goto L88
            java.util.ArrayList<k.a.e.h> r2 = r8.f7205e
        ...
        L33:
            ...
            k.a.e.h r0 = (k.a.e.h) r0
            if (r0 == 0) goto L47
            java.util.ArrayList<k.a.e.h> r5 = r8.f7205e
        ...
        L58:
            j.b.s(r0)
            k.a.f.h r3 = r0.f7102c
            java.lang.String r3 = r3.b
            k.a.e.h r6 = new k.a.e.h
            k.a.f.f r7 = r4.f7208h
            k.a.f.h r3 = k.a.f.h.a(r3, r7)
            r6.<init>(r3, r1, r1)
            r4.A(r6)
            java.util.ArrayList<k.a.e.h> r3 = r4.f7205e
            r3.add(r6)
            k.a.e.b r3 = r6.d()
            k.a.e.b r7 = r0.d()
            r3.c(r7)
            ...
            if ("select".equals(str)) {
                ...
                if ("tr".equals(str)) {
                    ...
                    if ("caption".equals(str)) {
                        this.f7124k = c.f7135k;
                        return;
                    } else if ("colgroup".equals(str)) {
                        this.f7124k = c.f7136l;
                        return;
                    } else if ("table".equals(str)) {
                        this.f7124k = c.f7133i;
                        return;
                    } else if ("head".equals(str)) {
                        this.f7124k = c.f7131g;
                        return;
    ...
    public boolean c(i iVar) {
        this.f7207g = iVar;
        return this.f7124k.c(iVar, this);
    }
    ...
    public final void h(String... strArr) {
        ...
        while (true) {
            ...
            k.a.e.h hVar = this.f7205e.get(size);
            if (k.a.d.a.c(hVar.f7102c.b, strArr) || hVar.f7102c.b.equals("html")) {
                return;
            }
            this.f7205e.remove(size);
        }
    ...
    public void k(c cVar) {
        if (this.a.a.b()) {
            this.a.a.add(new d(this.b.t(), "Unexpected token [%s] when in state [%s]", this.f7207g.getClass().getSimpleName(), cVar));
        }
    }

    public void l(String str) {
        while (str != null && !a().f7102c.b.equals(str) && k.a.d.a.d(a().f7102c.b, C)) {
            E();
        }
    }
    ...
    public k.a.e.h n(String str) {
        ...
        do {
            ...
            hVar = this.f7205e.get(size);
        } while (!hVar.f7102c.b.equals(str));
        return hVar;
    }
    ...
    public boolean q(String str) {
        for (int size = this.f7205e.size() - 1; size >= 0; size--) {
            String str2 = this.f7205e.get(size).f7102c.b;
            if (str2.equals(str)) {
                return true;
            }
            if (!k.a.d.a.d(str2, B)) {
    ...
    public final boolean r(String[] strArr, String[] strArr2, String[] strArr3) {
        int size = this.f7205e.size() - 1;
        int i2 = size > 100 ? size - 100 : 0;
        while (size >= i2) {
            String str = this.f7205e.get(size).f7102c.b;
    ...
    public k.a.e.h t(i.h hVar) {
        k.a.e.b bVar = hVar.f7175j;
        if (bVar != null) {
            int i2 = 0;
            if (!(bVar.a == 0)) {
                k.a.e.b bVar2 = hVar.f7175j;
                f fVar = this.f7208h;
                if (!(bVar2.a == 0)) {
                    boolean z2 = fVar.b;
                    int i3 = 0;
        ...
        h a = h.a(hVar.p(), this.f7208h);
        f fVar2 = this.f7208h;
        k.a.e.b bVar3 = hVar.f7175j;
        fVar2.a(bVar3);
        k.a.e.h hVar2 = new k.a.e.h(a, null, bVar3);
        A(hVar2);
        this.f7205e.add(hVar2);
        return hVar2;
    }

    public String toString() {
        StringBuilder o = f.b.a.a.a.o("TreeBuilder{currentToken=");
        o.append(this.f7207g);
        o.append(", state=");
        o.append(this.f7124k);
    ...
    public k.a.e.h w(i.h hVar) {
        ...
        A(hVar2);
        if (hVar.f7174i) {
            if (h.f7151j.containsKey(a.a)) {
                if (!a.f7157e) {
                    this.f7203c.j("Tag cannot be self closing; not a void tag");
                }
            } else {
                a.f7158f = true;
            }
    ...
    */
    public void y(k.a.e.l r10) {
        ...
        L15:
            ...
            goto L22
        L1a:
            java.util.ArrayList<k.a.e.h> r3 = r9.f7205e
