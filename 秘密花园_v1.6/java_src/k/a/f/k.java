...
public final class k {
    ...
    public i.AbstractC0118i f7187i;
    public String o;
    ...
    public String f7184f = null;

    /* renamed from: g  reason: collision with root package name */
    public StringBuilder f7185g = new StringBuilder(1024);

    /* renamed from: h  reason: collision with root package name */
    public StringBuilder f7186h = new StringBuilder(1024);

    /* renamed from: j  reason: collision with root package name */
    public i.h f7188j = new i.h();

    /* renamed from: k  reason: collision with root package name */
    public i.g f7189k = new i.g();

    /* renamed from: l  reason: collision with root package name */
    public i.c f7190l = new i.c();

    /* renamed from: m  reason: collision with root package name */
    public i.e f7191m = new i.e();
    ...
    */
    ...
    public i.AbstractC0118i d(boolean z) {
        ...
        if (z) {
            abstractC0118i = this.f7188j;
            abstractC0118i.s();
        } else {
            abstractC0118i = this.f7189k;
            abstractC0118i.g();
        }
        this.f7187i = abstractC0118i;
    ...
    public void f(String str) {
        ...
        if (this.f7185g.length() == 0) {
            this.f7185g.append(this.f7184f);
        }
        this.f7185g.append(str);
    }
    ...
    public void g(i iVar) {
        ...
        if (jVar == i.j.StartTag) {
            this.o = ((i.h) iVar).b;
        } else if (jVar != i.j.EndTag || ((i.g) iVar).f7175j == null) {
        } else {
    ...
    public void h() {
        i.AbstractC0118i abstractC0118i = this.f7187i;
        if (abstractC0118i.f7169d != null) {
            abstractC0118i.r();
        }
        g(this.f7187i);
    }
    ...
    public boolean l() {
        return this.o != null && this.f7187i.p().equalsIgnoreCase(this.o);
    }
}
