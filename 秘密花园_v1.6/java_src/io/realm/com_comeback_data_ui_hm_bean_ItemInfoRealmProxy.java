...
public class com_comeback_data_ui_hm_bean_ItemInfoRealmProxy extends ItemInfo implements n, u0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6922f = a("type", "type", a);
            this.f6923g = a("id", "id", a);
            this.f6924h = a("image", "image", a);
            this.f6925i = a(NotificationCompatJellybean.KEY_TITLE, NotificationCompatJellybean.KEY_TITLE, a);
            this.f6926j = a("desc", "desc", a);
            this.f6927k = a(NotificationCompat.CarExtender.KEY_AUTHOR, NotificationCompat.CarExtender.KEY_AUTHOR, a);
            this.f6928l = a("update", "update", a);
            this.f6921e = a.a();
        }
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6922f = aVar.f6922f;
            aVar2.f6923g = aVar.f6923g;
            aVar2.f6924h = aVar.f6924h;
            aVar2.f6925i = aVar.f6925i;
            aVar2.f6926j = aVar.f6926j;
            aVar2.f6927k = aVar.f6927k;
            aVar2.f6928l = aVar.f6928l;
            aVar2.f6921e = aVar.f6921e;
        }
    }
    ...
    public static ItemInfo copy(x xVar, a aVar, ItemInfo itemInfo, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6401j.e(ItemInfo.class);
        long j2 = aVar.f6921e;
    ...
    */
    ...
    public static long insert(x xVar, ItemInfo itemInfo, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(ItemInfo.class);
        long j3 = aVar.f6923g;
        String realmGet$id = itemInfo.realmGet$id();
        if (realmGet$id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            Table.nativeSetLong(j2, aVar.f6922f, createRowWithPrimaryKey, itemInfo.realmGet$type(), false);
            String realmGet$image = itemInfo.realmGet$image();
            if (realmGet$image != null) {
                Table.nativeSetString(j2, aVar.f6924h, createRowWithPrimaryKey, realmGet$image, false);
            }
            String realmGet$title = itemInfo.realmGet$title();
            if (realmGet$title != null) {
                Table.nativeSetString(j2, aVar.f6925i, createRowWithPrimaryKey, realmGet$title, false);
            }
            String realmGet$desc = itemInfo.realmGet$desc();
            if (realmGet$desc != null) {
                Table.nativeSetString(j2, aVar.f6926j, createRowWithPrimaryKey, realmGet$desc, false);
            }
            String realmGet$author = itemInfo.realmGet$author();
            if (realmGet$author != null) {
                Table.nativeSetString(j2, aVar.f6927k, createRowWithPrimaryKey, realmGet$author, false);
            }
            String realmGet$update = itemInfo.realmGet$update();
            if (realmGet$update != null) {
                Table.nativeSetString(j2, aVar.f6928l, createRowWithPrimaryKey, realmGet$update, false);
            }
    ...
    public static long insertOrUpdate(x xVar, ItemInfo itemInfo, Map<e0, Long> map) {
        ...
        Table.nativeSetLong(j2, aVar.f6922f, j4, itemInfo.realmGet$type(), false);
        String realmGet$image = itemInfo.realmGet$image();
        if (realmGet$image != null) {
            Table.nativeSetString(j2, aVar.f6924h, j4, realmGet$image, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6924h, j4, false);
        }
        String realmGet$title = itemInfo.realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(j2, aVar.f6925i, j4, realmGet$title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6925i, j4, false);
        }
        String realmGet$desc = itemInfo.realmGet$desc();
        if (realmGet$desc != null) {
            Table.nativeSetString(j2, aVar.f6926j, j4, realmGet$desc, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6926j, j4, false);
        }
        String realmGet$author = itemInfo.realmGet$author();
        if (realmGet$author != null) {
            Table.nativeSetString(j2, aVar.f6927k, j4, realmGet$author, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6927k, j4, false);
        }
        String realmGet$update = itemInfo.realmGet$update();
        if (realmGet$update != null) {
            Table.nativeSetString(j2, aVar.f6928l, j4, realmGet$update, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6928l, j4, false);
        }
        return j4;
    }
    ...
    public static com_comeback_data_ui_hm_bean_ItemInfoRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6370f.a(ItemInfo.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_hm_bean_iteminforealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_hm_bean_iteminforealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_hm_bean_iteminforealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$author() {
        ...
        return this.proxyState.f6389c.q(this.columnInfo.f6927k);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$desc() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6926j);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$id() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6923g);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$image() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6924h);
    }
    ...
    public String realmGet$title() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6925i);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public int realmGet$type() {
        this.proxyState.f6391e.f();
        return (int) this.proxyState.f6389c.p(this.columnInfo.f6922f);
    }

    @Override // com.comeback.data.ui.hm.bean.ItemInfo, g.a.u0
    public String realmGet$update() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6928l);
    }
    ...
    public void realmSet$author(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6927k, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6927k, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6927k);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6927k, str);
        }
    }
    ...
    public void realmSet$desc(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6926j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6926j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6926j);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6926j, str);
        }
    }
    ...
    public void realmSet$image(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6924h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6924h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6924h);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6924h, str);
        }
    }
    ...
    public void realmSet$title(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6925i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6925i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6925i);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6925i, str);
        }
    }
    ...
    public void realmSet$type(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().p(this.columnInfo.f6922f, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.u(this.columnInfo.f6922f, i2);
    }
    ...
    public void realmSet$update(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6928l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6928l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6928l);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6928l, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(itemInfo)) {
                if (itemInfo instanceof n) {
                    n nVar = (n) itemInfo;
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(itemInfo, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$id = itemInfo.realmGet$id();
                if (realmGet$id == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(itemInfo)) {
                ...
                if (realmGet$image != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6924h, createRowWithPrimaryKey, false);
                }
                String realmGet$title = itemInfo.realmGet$title();
                if (realmGet$title != null) {
                    Table.nativeSetString(j2, aVar.f6925i, createRowWithPrimaryKey, realmGet$title, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6925i, createRowWithPrimaryKey, false);
                }
                String realmGet$desc = itemInfo.realmGet$desc();
                if (realmGet$desc != null) {
                    Table.nativeSetString(j2, aVar.f6926j, createRowWithPrimaryKey, realmGet$desc, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6926j, createRowWithPrimaryKey, false);
                }
                String realmGet$author = itemInfo.realmGet$author();
                if (realmGet$author != null) {
                    Table.nativeSetString(j2, aVar.f6927k, createRowWithPrimaryKey, realmGet$author, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6927k, createRowWithPrimaryKey, false);
                }
                String realmGet$update = itemInfo.realmGet$update();
                if (realmGet$update != null) {
                    Table.nativeSetString(j2, aVar.f6928l, createRowWithPrimaryKey, realmGet$update, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6928l, createRowWithPrimaryKey, false);
                }
                j3 = j4;
            }
        }
