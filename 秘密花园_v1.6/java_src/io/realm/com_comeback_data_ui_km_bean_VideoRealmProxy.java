...
public class com_comeback_data_ui_km_bean_VideoRealmProxy extends Video implements n, y0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6945f = a("mu_avatar", "mu_avatar", a);
            this.f6946g = a("mu_id", "mu_id", a);
            this.f6947h = a("mu_name", "mu_name", a);
            this.f6948i = a("mv_comment", "mv_comment", a);
            this.f6949j = a("mv_created", "mv_created", a);
            this.f6950k = a("mv_id", "mv_id", a);
            this.f6951l = a("mv_img_url", "mv_img_url", a);
            this.f6952m = a("mv_like", "mv_like", a);
        ...
        public final void b(c cVar, c cVar2) {
            ...
            aVar2.f6949j = aVar.f6949j;
            aVar2.f6950k = aVar.f6950k;
            aVar2.f6951l = aVar.f6951l;
            aVar2.f6952m = aVar.f6952m;
            aVar2.n = aVar.n;
            aVar2.o = aVar.o;
            aVar2.p = aVar.p;
            aVar2.q = aVar.q;
    ...
    public static Video copy(x xVar, a aVar, Video video, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6401j.e(Video.class), aVar.f6944e, set);
        osObjectBuilder.g(aVar.f6945f, video.realmGet$mu_avatar());
        osObjectBuilder.g(aVar.f6946g, video.realmGet$mu_id());
        osObjectBuilder.g(aVar.f6947h, video.realmGet$mu_name());
        osObjectBuilder.g(aVar.f6948i, video.realmGet$mv_comment());
        osObjectBuilder.g(aVar.f6949j, video.realmGet$mv_created());
        osObjectBuilder.g(aVar.f6950k, video.realmGet$mv_id());
        osObjectBuilder.g(aVar.f6951l, video.realmGet$mv_img_url());
        osObjectBuilder.g(aVar.f6952m, video.realmGet$mv_like());
    ...
    */
    ...
    public static long insert(x xVar, Video video, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6401j.e(Video.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6401j;
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(Video.class);
        long j3 = aVar.f6950k;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$mu_avatar != null) {
                Table.nativeSetString(j2, aVar.f6945f, createRowWithPrimaryKey, realmGet$mu_avatar, false);
            }
            String realmGet$mu_id = video.realmGet$mu_id();
            if (realmGet$mu_id != null) {
                Table.nativeSetString(j2, aVar.f6946g, createRowWithPrimaryKey, realmGet$mu_id, false);
            }
            String realmGet$mu_name = video.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j2, aVar.f6947h, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
            String realmGet$mv_comment = video.realmGet$mv_comment();
            if (realmGet$mv_comment != null) {
                Table.nativeSetString(j2, aVar.f6948i, createRowWithPrimaryKey, realmGet$mv_comment, false);
            }
            String realmGet$mv_created = video.realmGet$mv_created();
            if (realmGet$mv_created != null) {
                Table.nativeSetString(j2, aVar.f6949j, createRowWithPrimaryKey, realmGet$mv_created, false);
            }
            String realmGet$mv_img_url = video.realmGet$mv_img_url();
            if (realmGet$mv_img_url != null) {
                Table.nativeSetString(j2, aVar.f6951l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
            }
            String realmGet$mv_like = video.realmGet$mv_like();
            if (realmGet$mv_like != null) {
                Table.nativeSetString(j2, aVar.f6952m, createRowWithPrimaryKey, realmGet$mv_like, false);
            }
    ...
    public static long insertOrUpdate(x xVar, Video video, Map<e0, Long> map) {
        ...
        String realmGet$mu_avatar = video.realmGet$mu_avatar();
        if (realmGet$mu_avatar != null) {
            Table.nativeSetString(j2, aVar.f6945f, j4, realmGet$mu_avatar, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6945f, j4, false);
        }
        String realmGet$mu_id = video.realmGet$mu_id();
        if (realmGet$mu_id != null) {
            Table.nativeSetString(j2, aVar.f6946g, j4, realmGet$mu_id, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6946g, j4, false);
        }
        String realmGet$mu_name = video.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j2, aVar.f6947h, j4, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6947h, j4, false);
        }
        String realmGet$mv_comment = video.realmGet$mv_comment();
        if (realmGet$mv_comment != null) {
            Table.nativeSetString(j2, aVar.f6948i, j4, realmGet$mv_comment, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6948i, j4, false);
        }
        String realmGet$mv_created = video.realmGet$mv_created();
        if (realmGet$mv_created != null) {
            Table.nativeSetString(j2, aVar.f6949j, j4, realmGet$mv_created, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6949j, j4, false);
        }
        String realmGet$mv_img_url = video.realmGet$mv_img_url();
        if (realmGet$mv_img_url != null) {
            Table.nativeSetString(j2, aVar.f6951l, j4, realmGet$mv_img_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6951l, j4, false);
        }
        String realmGet$mv_like = video.realmGet$mv_like();
        if (realmGet$mv_like != null) {
            Table.nativeSetString(j2, aVar.f6952m, j4, realmGet$mv_like, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6952m, j4, false);
        }
    ...
    public static Video update(x xVar, a aVar, Video video, Video video2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6401j.e(Video.class), aVar.f6944e, set);
        osObjectBuilder.g(aVar.f6945f, video2.realmGet$mu_avatar());
        osObjectBuilder.g(aVar.f6946g, video2.realmGet$mu_id());
        osObjectBuilder.g(aVar.f6947h, video2.realmGet$mu_name());
        osObjectBuilder.g(aVar.f6948i, video2.realmGet$mv_comment());
        osObjectBuilder.g(aVar.f6949j, video2.realmGet$mv_created());
        osObjectBuilder.g(aVar.f6950k, video2.realmGet$mv_id());
        osObjectBuilder.g(aVar.f6951l, video2.realmGet$mv_img_url());
        osObjectBuilder.g(aVar.f6952m, video2.realmGet$mv_like());
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_km_bean_videorealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_km_bean_videorealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_km_bean_videorealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$mu_avatar() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6945f);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mu_id() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6946g);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mu_name() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6947h);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_comment() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6948i);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_created() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6949j);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_id() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6950k);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_img_url() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6951l);
    }

    @Override // com.comeback.data.ui.km.bean.Video, g.a.y0
    public String realmGet$mv_like() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6952m);
    }
    ...
    public void realmSet$mu_avatar(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6945f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6945f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6945f);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6945f, str);
        }
    }
    ...
    public void realmSet$mu_id(String str) {
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6946g);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6946g, str);
        }
    }
    ...
    public void realmSet$mu_name(String str) {
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6947h);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6947h, str);
        }
    }
    ...
    public void realmSet$mv_comment(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6948i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6948i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6948i);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6948i, str);
        }
    }
    ...
    public void realmSet$mv_created(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6949j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6949j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6949j);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6949j, str);
        }
    }
    ...
    public void realmSet$mv_img_url(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6951l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6951l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6951l);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6951l, str);
        }
    }
    ...
    public void realmSet$mv_like(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6952m, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6952m, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6952m);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6952m, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(video)) {
                if (video instanceof n) {
                    n nVar = (n) video;
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(video, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$mv_id = video.realmGet$mv_id();
                if (realmGet$mv_id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$mu_avatar != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6945f, createRowWithPrimaryKey, realmGet$mu_avatar, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$mu_id = video.realmGet$mu_id();
                    if (realmGet$mu_id != null) {
                        Table.nativeSetString(j3, aVar.f6946g, createRowWithPrimaryKey, realmGet$mu_id, false);
                    }
                    String realmGet$mu_name = video.realmGet$mu_name();
                    if (realmGet$mu_name != null) {
                        Table.nativeSetString(j3, aVar.f6947h, createRowWithPrimaryKey, realmGet$mu_name, false);
                    }
                    String realmGet$mv_comment = video.realmGet$mv_comment();
                    if (realmGet$mv_comment != null) {
                        Table.nativeSetString(j3, aVar.f6948i, createRowWithPrimaryKey, realmGet$mv_comment, false);
                    }
                    String realmGet$mv_created = video.realmGet$mv_created();
                    if (realmGet$mv_created != null) {
                        Table.nativeSetString(j3, aVar.f6949j, createRowWithPrimaryKey, realmGet$mv_created, false);
                    }
                    String realmGet$mv_img_url = video.realmGet$mv_img_url();
                    if (realmGet$mv_img_url != null) {
                        Table.nativeSetString(j3, aVar.f6951l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
                    }
                    String realmGet$mv_like = video.realmGet$mv_like();
                    if (realmGet$mv_like != null) {
                        Table.nativeSetString(j3, aVar.f6952m, createRowWithPrimaryKey, realmGet$mv_like, false);
                    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(video)) {
                ...
                if (realmGet$mu_avatar != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6945f, createRowWithPrimaryKey, false);
                }
                String realmGet$mu_id = video.realmGet$mu_id();
                if (realmGet$mu_id != null) {
                    Table.nativeSetString(j3, aVar.f6946g, createRowWithPrimaryKey, realmGet$mu_id, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6946g, createRowWithPrimaryKey, false);
                }
                String realmGet$mu_name = video.realmGet$mu_name();
                if (realmGet$mu_name != null) {
                    Table.nativeSetString(j3, aVar.f6947h, createRowWithPrimaryKey, realmGet$mu_name, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6947h, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_comment = video.realmGet$mv_comment();
                if (realmGet$mv_comment != null) {
                    Table.nativeSetString(j3, aVar.f6948i, createRowWithPrimaryKey, realmGet$mv_comment, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6948i, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_created = video.realmGet$mv_created();
                if (realmGet$mv_created != null) {
                    Table.nativeSetString(j3, aVar.f6949j, createRowWithPrimaryKey, realmGet$mv_created, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6949j, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_img_url = video.realmGet$mv_img_url();
                if (realmGet$mv_img_url != null) {
                    Table.nativeSetString(j3, aVar.f6951l, createRowWithPrimaryKey, realmGet$mv_img_url, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6951l, createRowWithPrimaryKey, false);
                }
                String realmGet$mv_like = video.realmGet$mv_like();
                if (realmGet$mv_like != null) {
                    Table.nativeSetString(j3, aVar.f6952m, createRowWithPrimaryKey, realmGet$mv_like, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6952m, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.n, createRowWithPrimaryKey, video.realmGet$mv_play_height(), false);
                String realmGet$mv_play_url = video.realmGet$mv_play_url();
                if (realmGet$mv_play_url != null) {
