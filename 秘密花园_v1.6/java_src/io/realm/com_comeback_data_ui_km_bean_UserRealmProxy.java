...
public class com_comeback_data_ui_km_bean_UserRealmProxy extends User implements n, x0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6942f = a("mu_name", "mu_name", a);
            this.f6943g = a("mu_id", "mu_id", a);
            this.f6941e = a.a();
        }
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6942f = aVar.f6942f;
            aVar2.f6943g = aVar.f6943g;
            aVar2.f6941e = aVar.f6941e;
        }
    }
    ...
    public static User copy(x xVar, a aVar, User user, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6401j.e(User.class);
        long j2 = aVar.f6941e;
    ...
    */
    ...
    public static long insert(x xVar, User user, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(User.class);
        long j3 = aVar.f6943g;
        String realmGet$mu_id = user.realmGet$mu_id();
        if (realmGet$mu_id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$mu_name = user.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j2, aVar.f6942f, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
    ...
    public static long insertOrUpdate(x xVar, User user, Map<e0, Long> map) {
        ...
        String realmGet$mu_name = user.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j2, aVar.f6942f, j4, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6942f, j4, false);
        }
        return j4;
    }
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_km_bean_userrealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_km_bean_userrealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_km_bean_userrealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$mu_id() {
        ...
        return this.proxyState.f6389c.q(this.columnInfo.f6943g);
    }

    @Override // com.comeback.data.ui.km.bean.User, g.a.x0
    public String realmGet$mu_name() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6942f);
    }
    ...
    public void realmSet$mu_name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6942f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6942f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6942f);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6942f, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(user)) {
                if (user instanceof n) {
                    n nVar = (n) user;
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(user, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$mu_id = user.realmGet$mu_id();
                if (realmGet$mu_id == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(user)) {
                ...
                if (realmGet$mu_name != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6942f, createRowWithPrimaryKey, false);
                }
            }
        }
    }
