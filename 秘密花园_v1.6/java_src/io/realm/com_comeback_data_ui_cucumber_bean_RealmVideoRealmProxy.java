...
public class com_comeback_data_ui_cucumber_bean_RealmVideoRealmProxy extends RealmVideo implements n, q0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6890f = a("cover", "cover", a);
            this.f6891g = a("id", "id", a);
            this.f6892h = a("mins", "mins", a);
            this.f6893i = a("name", "name", a);
            this.f6894j = a("strPlayCnt", "strPlayCnt", a);
            this.f6889e = a.a();
        }
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6890f = aVar.f6890f;
            aVar2.f6891g = aVar.f6891g;
            aVar2.f6892h = aVar.f6892h;
            aVar2.f6893i = aVar.f6893i;
            aVar2.f6894j = aVar.f6894j;
            aVar2.f6889e = aVar.f6889e;
        }
    }
    ...
    public static RealmVideo copy(x xVar, a aVar, RealmVideo realmVideo, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6401j.e(RealmVideo.class);
        long j2 = aVar.f6889e;
    ...
    */
    ...
    public static long insert(x xVar, RealmVideo realmVideo, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(RealmVideo.class);
        long j3 = aVar.f6891g;
        String realmGet$id = realmVideo.realmGet$id();
        if (realmGet$id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$cover = realmVideo.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6890f, createRowWithPrimaryKey, realmGet$cover, false);
            }
            String realmGet$mins = realmVideo.realmGet$mins();
            if (realmGet$mins != null) {
                Table.nativeSetString(j2, aVar.f6892h, createRowWithPrimaryKey, realmGet$mins, false);
            }
            String realmGet$name = realmVideo.realmGet$name();
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6893i, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$strPlayCnt = realmVideo.realmGet$strPlayCnt();
            if (realmGet$strPlayCnt != null) {
                Table.nativeSetString(j2, aVar.f6894j, createRowWithPrimaryKey, realmGet$strPlayCnt, false);
            }
    ...
    public static long insertOrUpdate(x xVar, RealmVideo realmVideo, Map<e0, Long> map) {
        ...
        String realmGet$cover = realmVideo.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6890f, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6890f, j4, false);
        }
        String realmGet$mins = realmVideo.realmGet$mins();
        if (realmGet$mins != null) {
            Table.nativeSetString(j2, aVar.f6892h, j4, realmGet$mins, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6892h, j4, false);
        }
        String realmGet$name = realmVideo.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6893i, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6893i, j4, false);
        }
        String realmGet$strPlayCnt = realmVideo.realmGet$strPlayCnt();
        if (realmGet$strPlayCnt != null) {
            Table.nativeSetString(j2, aVar.f6894j, j4, realmGet$strPlayCnt, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6894j, j4, false);
        }
        return j4;
    }
    ...
    public static com_comeback_data_ui_cucumber_bean_RealmVideoRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6370f.a(RealmVideo.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_cucumber_bean_realmvideorealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_cucumber_bean_realmvideorealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_cucumber_bean_realmvideorealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$cover() {
        ...
        return this.proxyState.f6389c.q(this.columnInfo.f6890f);
    }

    @Override // com.comeback.data.ui.cucumber.bean.RealmVideo, g.a.q0
    public String realmGet$id() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6891g);
    }

    @Override // com.comeback.data.ui.cucumber.bean.RealmVideo, g.a.q0
    public String realmGet$mins() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6892h);
    }

    @Override // com.comeback.data.ui.cucumber.bean.RealmVideo, g.a.q0
    public String realmGet$name() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6893i);
    }
    ...
    public String realmGet$strPlayCnt() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6894j);
    }
    ...
    public void realmSet$cover(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6890f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6890f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6890f);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6890f, str);
        }
    }
    ...
    public void realmSet$mins(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6892h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6892h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6892h);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6892h, str);
        }
    }
    ...
    public void realmSet$name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6893i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6893i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6893i);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6893i, str);
        }
    }
    ...
    public void realmSet$strPlayCnt(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6894j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6894j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6894j);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6894j, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(realmVideo2)) {
                if (realmVideo2 instanceof n) {
                    ...
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(realmVideo2, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$id = realmVideo2.realmGet$id();
                if (realmGet$id == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(realmVideo2)) {
                ...
                if (realmGet$cover != null) {
                    ...
                    realmVideo = realmVideo2;
                    Table.nativeSetNull(j2, aVar.f6890f, createRowWithPrimaryKey, false);
                }
                String realmGet$mins = realmVideo.realmGet$mins();
                if (realmGet$mins != null) {
                    Table.nativeSetString(j2, aVar.f6892h, createRowWithPrimaryKey, realmGet$mins, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6892h, createRowWithPrimaryKey, false);
                }
                String realmGet$name = realmVideo.realmGet$name();
                if (realmGet$name != null) {
                    Table.nativeSetString(j2, aVar.f6893i, createRowWithPrimaryKey, realmGet$name, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6893i, createRowWithPrimaryKey, false);
                }
                String realmGet$strPlayCnt = realmVideo.realmGet$strPlayCnt();
                if (realmGet$strPlayCnt != null) {
                    Table.nativeSetString(j2, aVar.f6894j, createRowWithPrimaryKey, realmGet$strPlayCnt, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6894j, createRowWithPrimaryKey, false);
                }
            }
        }
    }
