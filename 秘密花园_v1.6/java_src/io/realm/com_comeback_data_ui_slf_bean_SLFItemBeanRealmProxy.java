...
public class com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy extends SLFItemBean implements n, e1 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6988f = a("id", "id", a);
            this.f6989g = a("name", "name", a);
            this.f6990h = a("click", "click", a);
            this.f6991i = a("favorite", "favorite", a);
            this.f6992j = a("img", "img", a);
            this.f6993k = a("sale", "sale", a);
            this.f6994l = a("updateTime", "updateTime", a);
            this.f6995m = a("description", "description", a);
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6988f = aVar.f6988f;
            aVar2.f6989g = aVar.f6989g;
            aVar2.f6990h = aVar.f6990h;
            aVar2.f6991i = aVar.f6991i;
            aVar2.f6992j = aVar.f6992j;
            aVar2.f6993k = aVar.f6993k;
            aVar2.f6994l = aVar.f6994l;
            aVar2.f6995m = aVar.f6995m;
            aVar2.n = aVar.n;
            aVar2.o = aVar.o;
            aVar2.p = aVar.p;
            aVar2.q = aVar.q;
    ...
    public static SLFItemBean copy(x xVar, a aVar, SLFItemBean sLFItemBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6401j.e(SLFItemBean.class), aVar.f6987e, set);
        osObjectBuilder.g(aVar.f6988f, sLFItemBean.realmGet$id());
        osObjectBuilder.g(aVar.f6989g, sLFItemBean.realmGet$name());
        osObjectBuilder.g(aVar.f6990h, sLFItemBean.realmGet$click());
        osObjectBuilder.g(aVar.f6991i, sLFItemBean.realmGet$favorite());
        osObjectBuilder.g(aVar.f6992j, sLFItemBean.realmGet$img());
        osObjectBuilder.e(aVar.f6993k, Integer.valueOf(sLFItemBean.realmGet$sale()));
        osObjectBuilder.g(aVar.f6994l, sLFItemBean.realmGet$updateTime());
        osObjectBuilder.g(aVar.f6995m, sLFItemBean.realmGet$description());
    ...
    */
    public static com.comeback.data.ui.slf.bean.SLFItemBean copyOrUpdate(g.a.x r9, io.realm.com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy.a r10, com.comeback.data.ui.slf.bean.SLFItemBean r11, boolean r12, java.util.Map<g.a.e0, g.a.f1.n> r13, java.util.Set<g.a.m> r14) {
        ...
        L6b:
            ...
            io.realm.com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy r1 = new io.realm.com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy     // Catch: java.lang.Throwable -> L89
    ...
    */
    ...
    public static long insert(x xVar, SLFItemBean sLFItemBean, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6401j.e(SLFItemBean.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6401j;
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(SLFItemBean.class);
        long j3 = aVar.f6988f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$name != null) {
                Table.nativeSetString(j2, aVar.f6989g, createRowWithPrimaryKey, realmGet$name, false);
            }
            String realmGet$click = sLFItemBean.realmGet$click();
            if (realmGet$click != null) {
                Table.nativeSetString(j2, aVar.f6990h, createRowWithPrimaryKey, realmGet$click, false);
            }
            String realmGet$favorite = sLFItemBean.realmGet$favorite();
            if (realmGet$favorite != null) {
                Table.nativeSetString(j2, aVar.f6991i, createRowWithPrimaryKey, realmGet$favorite, false);
            }
            String realmGet$img = sLFItemBean.realmGet$img();
            if (realmGet$img != null) {
                Table.nativeSetString(j2, aVar.f6992j, createRowWithPrimaryKey, realmGet$img, false);
            }
            Table.nativeSetLong(j2, aVar.f6993k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
            String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
            if (realmGet$updateTime != null) {
                Table.nativeSetString(j2, aVar.f6994l, createRowWithPrimaryKey, realmGet$updateTime, false);
            }
            String realmGet$description = sLFItemBean.realmGet$description();
            if (realmGet$description != null) {
                Table.nativeSetString(j2, aVar.f6995m, createRowWithPrimaryKey, realmGet$description, false);
            }
            String realmGet$summary = sLFItemBean.realmGet$summary();
            if (realmGet$summary != null) {
                Table.nativeSetString(j2, aVar.n, createRowWithPrimaryKey, realmGet$summary, false);
            }
            Table.nativeSetLong(j2, aVar.o, createRowWithPrimaryKey, sLFItemBean.realmGet$point(), false);
            String realmGet$status = sLFItemBean.realmGet$status();
            if (realmGet$status != null) {
                Table.nativeSetString(j2, aVar.p, createRowWithPrimaryKey, realmGet$status, false);
            }
            Table.nativeSetLong(j2, aVar.q, createRowWithPrimaryKey, sLFItemBean.realmGet$type(), false);
            String realmGet$tagStr = sLFItemBean.realmGet$tagStr();
            if (realmGet$tagStr != null) {
                Table.nativeSetString(j2, aVar.r, createRowWithPrimaryKey, realmGet$tagStr, false);
            }
            String realmGet$author = sLFItemBean.realmGet$author();
            if (realmGet$author != null) {
                Table.nativeSetString(j2, aVar.s, createRowWithPrimaryKey, realmGet$author, false);
            }
            String realmGet$isVideo = sLFItemBean.realmGet$isVideo();
            if (realmGet$isVideo != null) {
                Table.nativeSetString(j2, aVar.t, createRowWithPrimaryKey, realmGet$isVideo, false);
            }
    ...
    public static long insertOrUpdate(x xVar, SLFItemBean sLFItemBean, Map<e0, Long> map) {
        ...
        map.put(sLFItemBean, Long.valueOf(j4));
        String realmGet$name = sLFItemBean.realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(j2, aVar.f6989g, j4, realmGet$name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6989g, j4, false);
        }
        String realmGet$click = sLFItemBean.realmGet$click();
        if (realmGet$click != null) {
            Table.nativeSetString(j2, aVar.f6990h, j4, realmGet$click, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6990h, j4, false);
        }
        String realmGet$favorite = sLFItemBean.realmGet$favorite();
        if (realmGet$favorite != null) {
            Table.nativeSetString(j2, aVar.f6991i, j4, realmGet$favorite, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6991i, j4, false);
        }
        String realmGet$img = sLFItemBean.realmGet$img();
        if (realmGet$img != null) {
            Table.nativeSetString(j2, aVar.f6992j, j4, realmGet$img, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6992j, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6993k, j4, sLFItemBean.realmGet$sale(), false);
        String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
        if (realmGet$updateTime != null) {
            Table.nativeSetString(j2, aVar.f6994l, j4, realmGet$updateTime, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6994l, j4, false);
        }
        String realmGet$description = sLFItemBean.realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(j2, aVar.f6995m, j4, realmGet$description, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6995m, j4, false);
        }
        String realmGet$summary = sLFItemBean.realmGet$summary();
        if (realmGet$summary != null) {
            Table.nativeSetString(j2, aVar.n, j4, realmGet$summary, false);
        } else {
            Table.nativeSetNull(j2, aVar.n, j4, false);
        }
        Table.nativeSetLong(j2, aVar.o, j4, sLFItemBean.realmGet$point(), false);
        String realmGet$status = sLFItemBean.realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(j2, aVar.p, j4, realmGet$status, false);
        } else {
            Table.nativeSetNull(j2, aVar.p, j4, false);
        }
        Table.nativeSetLong(j2, aVar.q, j4, sLFItemBean.realmGet$type(), false);
        String realmGet$tagStr = sLFItemBean.realmGet$tagStr();
        if (realmGet$tagStr != null) {
            Table.nativeSetString(j2, aVar.r, j4, realmGet$tagStr, false);
        } else {
            Table.nativeSetNull(j2, aVar.r, j4, false);
        }
        String realmGet$author = sLFItemBean.realmGet$author();
        if (realmGet$author != null) {
            Table.nativeSetString(j2, aVar.s, j4, realmGet$author, false);
        } else {
            Table.nativeSetNull(j2, aVar.s, j4, false);
        }
        String realmGet$isVideo = sLFItemBean.realmGet$isVideo();
        if (realmGet$isVideo != null) {
            Table.nativeSetString(j2, aVar.t, j4, realmGet$isVideo, false);
        } else {
    ...
    public static com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6370f.a(SLFItemBean.class);
    ...
    public static SLFItemBean update(x xVar, a aVar, SLFItemBean sLFItemBean, SLFItemBean sLFItemBean2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6401j.e(SLFItemBean.class), aVar.f6987e, set);
        osObjectBuilder.g(aVar.f6988f, sLFItemBean2.realmGet$id());
        osObjectBuilder.g(aVar.f6989g, sLFItemBean2.realmGet$name());
        osObjectBuilder.g(aVar.f6990h, sLFItemBean2.realmGet$click());
        osObjectBuilder.g(aVar.f6991i, sLFItemBean2.realmGet$favorite());
        osObjectBuilder.g(aVar.f6992j, sLFItemBean2.realmGet$img());
        osObjectBuilder.e(aVar.f6993k, Integer.valueOf(sLFItemBean2.realmGet$sale()));
        osObjectBuilder.g(aVar.f6994l, sLFItemBean2.realmGet$updateTime());
        osObjectBuilder.g(aVar.f6995m, sLFItemBean2.realmGet$description());
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_slf_bean_slfitembeanrealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_slf_bean_slfitembeanrealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_slf_bean_slfitembeanrealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$click() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6990h);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$description() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6995m);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$favorite() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6991i);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$id() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6988f);
    }

    @Override // com.comeback.data.ui.slf.bean.SLFItemBean, g.a.e1
    public String realmGet$img() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6992j);
    }
    ...
    public String realmGet$name() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6989g);
    }
    ...
    public int realmGet$sale() {
        this.proxyState.f6391e.f();
        return (int) this.proxyState.f6389c.p(this.columnInfo.f6993k);
    }
    ...
    public String realmGet$updateTime() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6994l);
    }
    ...
    public void realmSet$click(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6990h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6990h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6990h);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6990h, str);
        }
    }
    ...
    public void realmSet$description(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6995m, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6995m, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6995m);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6995m, str);
        }
    }
    ...
    public void realmSet$favorite(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6991i, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6991i, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6991i);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6991i, str);
        }
    }
    ...
    public void realmSet$img(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6992j, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6992j, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6992j);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6992j, str);
        }
    }
    ...
    public void realmSet$name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6989g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6989g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6989g);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6989g, str);
        }
    }
    ...
    public void realmSet$sale(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().p(this.columnInfo.f6993k, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.u(this.columnInfo.f6993k, i2);
    }
    ...
    public void realmSet$updateTime(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6994l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6994l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6994l);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6994l, str);
        }
    }
    ...
    public String toString() {
        if (g0.isValid(this)) {
            ...
            f.b.a.a.a.C(q, realmGet$id() != null ? realmGet$id() : "null", "}", ",", "{name:");
            f.b.a.a.a.C(q, realmGet$name() != null ? realmGet$name() : "null", "}", ",", "{click:");
            f.b.a.a.a.C(q, realmGet$click() != null ? realmGet$click() : "null", "}", ",", "{favorite:");
            f.b.a.a.a.C(q, realmGet$favorite() != null ? realmGet$favorite() : "null", "}", ",", "{img:");
            f.b.a.a.a.C(q, realmGet$img() != null ? realmGet$img() : "null", "}", ",", "{sale:");
            q.append(realmGet$sale());
            q.append("}");
            q.append(",");
            q.append("{updateTime:");
            f.b.a.a.a.C(q, realmGet$updateTime() != null ? realmGet$updateTime() : "null", "}", ",", "{description:");
            f.b.a.a.a.C(q, realmGet$description() != null ? realmGet$description() : "null", "}", ",", "{summary:");
            f.b.a.a.a.C(q, realmGet$summary() != null ? realmGet$summary() : "null", "}", ",", "{point:");
            q.append(realmGet$point());
            q.append("}");
            q.append(",");
            q.append("{status:");
            f.b.a.a.a.C(q, realmGet$status() != null ? realmGet$status() : "null", "}", ",", "{type:");
            q.append(realmGet$type());
            q.append("}");
            q.append(",");
            q.append("{tagStr:");
            f.b.a.a.a.C(q, realmGet$tagStr() != null ? realmGet$tagStr() : "null", "}", ",", "{author:");
            f.b.a.a.a.C(q, realmGet$author() != null ? realmGet$author() : "null", "}", ",", "{isVideo:");
            q.append(realmGet$isVideo() != null ? realmGet$isVideo() : "null");
            q.append("}");
            q.append("]");
            return q.toString();
        }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(sLFItemBean)) {
                if (sLFItemBean instanceof n) {
                    n nVar = (n) sLFItemBean;
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(sLFItemBean, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$id = sLFItemBean.realmGet$id();
                if (realmGet$id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$name != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6989g, createRowWithPrimaryKey, realmGet$name, false);
                    } else {
                        j2 = j4;
                    }
                    String realmGet$click = sLFItemBean.realmGet$click();
                    if (realmGet$click != null) {
                        Table.nativeSetString(j3, aVar.f6990h, createRowWithPrimaryKey, realmGet$click, false);
                    }
                    String realmGet$favorite = sLFItemBean.realmGet$favorite();
                    if (realmGet$favorite != null) {
                        Table.nativeSetString(j3, aVar.f6991i, createRowWithPrimaryKey, realmGet$favorite, false);
                    }
                    String realmGet$img = sLFItemBean.realmGet$img();
                    if (realmGet$img != null) {
                        Table.nativeSetString(j3, aVar.f6992j, createRowWithPrimaryKey, realmGet$img, false);
                    }
                    Table.nativeSetLong(j3, aVar.f6993k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
                    String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
                    if (realmGet$updateTime != null) {
                        Table.nativeSetString(j3, aVar.f6994l, createRowWithPrimaryKey, realmGet$updateTime, false);
                    }
                    String realmGet$description = sLFItemBean.realmGet$description();
                    if (realmGet$description != null) {
                        Table.nativeSetString(j3, aVar.f6995m, createRowWithPrimaryKey, realmGet$description, false);
                    }
                    String realmGet$summary = sLFItemBean.realmGet$summary();
                    if (realmGet$summary != null) {
                        Table.nativeSetString(j3, aVar.n, createRowWithPrimaryKey, realmGet$summary, false);
                    }
                    Table.nativeSetLong(j3, aVar.o, createRowWithPrimaryKey, sLFItemBean.realmGet$point(), false);
                    String realmGet$status = sLFItemBean.realmGet$status();
                    if (realmGet$status != null) {
                        Table.nativeSetString(j3, aVar.p, createRowWithPrimaryKey, realmGet$status, false);
                    }
                    Table.nativeSetLong(j3, aVar.q, createRowWithPrimaryKey, sLFItemBean.realmGet$type(), false);
                    String realmGet$tagStr = sLFItemBean.realmGet$tagStr();
                    if (realmGet$tagStr != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(sLFItemBean)) {
                ...
                if (realmGet$name != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6989g, createRowWithPrimaryKey, false);
                }
                String realmGet$click = sLFItemBean.realmGet$click();
                if (realmGet$click != null) {
                    Table.nativeSetString(j3, aVar.f6990h, createRowWithPrimaryKey, realmGet$click, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6990h, createRowWithPrimaryKey, false);
                }
                String realmGet$favorite = sLFItemBean.realmGet$favorite();
                if (realmGet$favorite != null) {
                    Table.nativeSetString(j3, aVar.f6991i, createRowWithPrimaryKey, realmGet$favorite, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6991i, createRowWithPrimaryKey, false);
                }
                String realmGet$img = sLFItemBean.realmGet$img();
                if (realmGet$img != null) {
                    Table.nativeSetString(j3, aVar.f6992j, createRowWithPrimaryKey, realmGet$img, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6992j, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.f6993k, createRowWithPrimaryKey, sLFItemBean.realmGet$sale(), false);
                String realmGet$updateTime = sLFItemBean.realmGet$updateTime();
                if (realmGet$updateTime != null) {
                    ...
                    Table.nativeSetNull(j3, aVar.f6994l, createRowWithPrimaryKey, false);
                }
                String realmGet$description = sLFItemBean.realmGet$description();
                if (realmGet$description != null) {
                    Table.nativeSetString(j3, aVar.f6995m, createRowWithPrimaryKey, realmGet$description, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6995m, createRowWithPrimaryKey, false);
                }
                String realmGet$summary = sLFItemBean.realmGet$summary();
                if (realmGet$summary != null) {
                    Table.nativeSetString(j3, aVar.n, createRowWithPrimaryKey, realmGet$summary, false);
