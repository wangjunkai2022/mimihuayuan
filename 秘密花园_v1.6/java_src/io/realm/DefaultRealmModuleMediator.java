...
public class DefaultRealmModuleMediator extends o {
    ...
    public <E extends e0> E b(x xVar, E e2, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        if (superclass.equals(ActorsBean.class)) {
            k0 k0Var = xVar.f6401j;
            k0Var.a();
            return (E) superclass.cast(com_comeback_data_ui_fulao2_bean_ActorsBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_fulao2_bean_ActorsBeanRealmProxy.a) k0Var.f6370f.a(ActorsBean.class), (ActorsBean) e2, z, map, set));
        } else if (superclass.equals(CollectVideo.class)) {
            k0 k0Var2 = xVar.f6401j;
            k0Var2.a();
            return (E) superclass.cast(com_comeback_data_ui_main_bean_CollectVideoRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_main_bean_CollectVideoRealmProxy.a) k0Var2.f6370f.a(CollectVideo.class), (CollectVideo) e2, z, map, set));
        } else if (superclass.equals(SLFItemBean.class)) {
            k0 k0Var3 = xVar.f6401j;
            k0Var3.a();
            return (E) superclass.cast(com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_slf_bean_SLFItemBeanRealmProxy.a) k0Var3.f6370f.a(SLFItemBean.class), (SLFItemBean) e2, z, map, set));
        } else if (superclass.equals(DsItemBean.class)) {
            k0 k0Var4 = xVar.f6401j;
            k0Var4.a();
            return (E) superclass.cast(com_comeback_data_ui_ds_bean_DsItemBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_ds_bean_DsItemBeanRealmProxy.a) k0Var4.f6370f.a(DsItemBean.class), (DsItemBean) e2, z, map, set));
        } else if (superclass.equals(User.class)) {
            k0 k0Var5 = xVar.f6401j;
            k0Var5.a();
            return (E) superclass.cast(com_comeback_data_ui_km_bean_UserRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_km_bean_UserRealmProxy.a) k0Var5.f6370f.a(User.class), (User) e2, z, map, set));
        } else if (superclass.equals(Video.class)) {
            k0 k0Var6 = xVar.f6401j;
            k0Var6.a();
            return (E) superclass.cast(com_comeback_data_ui_km_bean_VideoRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_km_bean_VideoRealmProxy.a) k0Var6.f6370f.a(Video.class), (Video) e2, z, map, set));
        } else if (superclass.equals(RealmVideo.class)) {
            k0 k0Var7 = xVar.f6401j;
            k0Var7.a();
            return (E) superclass.cast(com_comeback_data_ui_cucumber_bean_RealmVideoRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_cucumber_bean_RealmVideoRealmProxy.a) k0Var7.f6370f.a(RealmVideo.class), (RealmVideo) e2, z, map, set));
        } else if (superclass.equals(BaComicsBean.class)) {
            k0 k0Var8 = xVar.f6401j;
            k0Var8.a();
            return (E) superclass.cast(com_comeback_data_ui_ba_bean_BaComicsBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_ba_bean_BaComicsBeanRealmProxy.a) k0Var8.f6370f.a(BaComicsBean.class), (BaComicsBean) e2, z, map, set));
        } else if (superclass.equals(Km2Video.class)) {
            k0 k0Var9 = xVar.f6401j;
            k0Var9.a();
            return (E) superclass.cast(com_comeback_data_ui_km2_bean_Km2VideoRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_km2_bean_Km2VideoRealmProxy.a) k0Var9.f6370f.a(Km2Video.class), (Km2Video) e2, z, map, set));
        } else if (superclass.equals(Km2User.class)) {
            k0 k0Var10 = xVar.f6401j;
            k0Var10.a();
            return (E) superclass.cast(com_comeback_data_ui_km2_bean_Km2UserRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_km2_bean_Km2UserRealmProxy.a) k0Var10.f6370f.a(Km2User.class), (Km2User) e2, z, map, set));
        } else if (superclass.equals(MimeiComicItem.class)) {
            k0 k0Var11 = xVar.f6401j;
            k0Var11.a();
            return (E) superclass.cast(com_comeback_data_ui_mimei_bean_MimeiComicItemRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_mimei_bean_MimeiComicItemRealmProxy.a) k0Var11.f6370f.a(MimeiComicItem.class), (MimeiComicItem) e2, z, map, set));
        } else if (superclass.equals(LActorsBean.class)) {
            k0 k0Var12 = xVar.f6401j;
            k0Var12.a();
            return (E) superclass.cast(com_comeback_data_ui_lutube_bean_LActorsBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_lutube_bean_LActorsBeanRealmProxy.a) k0Var12.f6370f.a(LActorsBean.class), (LActorsBean) e2, z, map, set));
        } else if (superclass.equals(ItemInfo.class)) {
            k0 k0Var13 = xVar.f6401j;
            k0Var13.a();
            return (E) superclass.cast(com_comeback_data_ui_hm_bean_ItemInfoRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_hm_bean_ItemInfoRealmProxy.a) k0Var13.f6370f.a(ItemInfo.class), (ItemInfo) e2, z, map, set));
        } else if (superclass.equals(LVideosBean.class)) {
            k0 k0Var14 = xVar.f6401j;
            k0Var14.a();
            return (E) superclass.cast(com_comeback_data_ui_lutube_bean_LVideosBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_lutube_bean_LVideosBeanRealmProxy.a) k0Var14.f6370f.a(LVideosBean.class), (LVideosBean) e2, z, map, set));
        } else if (superclass.equals(VideoCacheBean.class)) {
            k0 k0Var15 = xVar.f6401j;
            k0Var15.a();
            return (E) superclass.cast(com_comeback_data_ui_main_bean_VideoCacheBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_main_bean_VideoCacheBeanRealmProxy.a) k0Var15.f6370f.a(VideoCacheBean.class), (VideoCacheBean) e2, z, map, set));
        } else if (superclass.equals(VideosBean.class)) {
            k0 k0Var16 = xVar.f6401j;
            k0Var16.a();
            return (E) superclass.cast(com_comeback_data_ui_fulao2_bean_VideosBeanRealmProxy.copyOrUpdate(xVar, (com_comeback_data_ui_fulao2_bean_VideosBeanRealmProxy.a) k0Var16.f6370f.a(VideosBean.class), (VideosBean) e2, z, map, set));
        } else {
