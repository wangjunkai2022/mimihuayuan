...
public class DynamicRealmObject extends g0 implements n {
        ...
        if (e0Var != null) {
            if (!(e0Var instanceof DynamicRealmObject)) {
                if (g0.isManaged(e0Var)) {
                    if (g0.isValid(e0Var)) {
                        n nVar = (n) e0Var;
                        p pVar = nVar.realmGet$proxyState().f6389c;
                        this.proxyState.f6391e = nVar.realmGet$proxyState().f6391e;
                        v<DynamicRealmObject> vVar = this.proxyState;
                        UncheckedRow uncheckedRow = (UncheckedRow) pVar;
                        if (uncheckedRow != null) {
                            vVar.f6389c = new CheckedRow(uncheckedRow);
    ...
    private void checkFieldType(String str, long j2, RealmFieldType realmFieldType) {
        RealmFieldType B = this.proxyState.f6389c.B(j2);
        if (B != realmFieldType) {
            String str2 = "n";
    ...
    */
    private void checkIsPrimaryKey(java.lang.String r13) {
        /*
            ...
            java.util.Map<java.lang.String, g.a.i0> r3 = r0.f6368d
            java.lang.Object r3 = r3.get(r2)
            g.a.i0 r3 = (g.a.i0) r3
            r4 = 1
            r5 = 0
            if (r3 == 0) goto L3d
            io.realm.internal.Table r6 = r3.f6354c
            long r7 = r6.a
            r9 = 0
        ...
        L3d:
            g.a.a r3 = r0.f6369e
            io.realm.internal.OsSharedRealm r3 = r3.f6275d
            boolean r3 = r3.hasTable(r2)
            if (r3 == 0) goto Laf
            g.a.k r3 = new g.a.k
            g.a.a r1 = r0.f6369e
            io.realm.internal.OsSharedRealm r6 = r1.f6275d
            io.realm.internal.Table r6 = r6.getTable(r2)
            r3.<init>(r1, r0, r6)
            java.util.Map<java.lang.String, g.a.i0> r0 = r0.f6368d
            r0.put(r2, r3)
        L59:
            g.a.a r0 = r3.b
            io.realm.internal.OsSharedRealm r0 = r0.f6275d
    ...
    private void setModelList(String str, c0<DynamicRealmObject> c0Var) {
        boolean z;
        int i2;
        OsList t = this.proxyState.f6389c.t(this.proxyState.f6389c.s(str));
        Table table = t.f7004c;
        String d2 = table.d();
        if (c0Var.b == null && c0Var.a == null) {
            ...
            String str2 = c0Var.b;
            if (str2 == null) {
                str2 = this.proxyState.f6391e.G().e(c0Var.a).d();
            }
            if (!d2.equals(str2)) {
        ...
        while (i3 < size) {
            ...
            if (dynamicRealmObject.realmGet$proxyState().f6391e == this.proxyState.f6391e) {
                if (z) {
                    i2 = size;
                } else {
                    Table d3 = dynamicRealmObject.realmGet$proxyState().f6389c.d();
                    if (d3 != null) {
                        i2 = size;
                        if (!table.nativeHasSameSchema(table.a, d3.a)) {
                            throw new IllegalArgumentException(String.format(Locale.US, "Element at index %d is not the proper type. Was '%s' expected '%s'.", Integer.valueOf(i3), dynamicRealmObject.realmGet$proxyState().f6389c.d().d(), d2));
                        }
                    } else {
                        throw new IllegalArgumentException("The argument cannot be null");
                    }
                }
                jArr[i3] = dynamicRealmObject.realmGet$proxyState().f6389c.l();
                i3++;
                size = i2;
            } else {
    ...
    private <E> void setValueList(String str, c0<E> c0Var, RealmFieldType realmFieldType) {
        ...
        OsList x = this.proxyState.f6389c.x(this.proxyState.f6389c.s(str), realmFieldType);
        ...
        o operator = getOperator(this.proxyState.f6391e, x, realmFieldType, genericDeclaration);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = dynamicRealmObject.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = dynamicRealmObject.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == dynamicRealmObject.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public <E> E get(String str) {
        this.proxyState.f6391e.f();
        long s = this.proxyState.f6389c.s(str);
        RealmFieldType B = this.proxyState.f6389c.B(s);
        switch (B.ordinal()) {
            case 0:
                return (E) Long.valueOf(this.proxyState.f6389c.p(s));
            case 1:
                return (E) Boolean.valueOf(this.proxyState.f6389c.m(s));
            case 2:
                return (E) this.proxyState.f6389c.q(s);
            case 3:
                return (E) this.proxyState.f6389c.g(s);
            case 4:
                return (E) this.proxyState.f6389c.w(s);
            case 5:
                return (E) Float.valueOf(this.proxyState.f6389c.o(s));
            case 6:
                return (E) Double.valueOf(this.proxyState.f6389c.k(s));
            case 7:
    ...
    public byte[] getBlob(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            return this.proxyState.f6389c.g(s);
    ...
    public boolean getBoolean(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            return this.proxyState.f6389c.m(s);
        } catch (IllegalArgumentException e2) {
    ...
    public Date getDate(String str) {
        ...
        if (this.proxyState.f6389c.y(s)) {
            return null;
        }
        return this.proxyState.f6389c.w(s);
    }
    ...
    public double getDouble(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            return this.proxyState.f6389c.k(s);
        } catch (IllegalArgumentException e2) {
    ...
    public i getDynamicRealm() {
        a aVar = realmGet$proxyState().f6391e;
        aVar.f();
        if (isValid()) {
            return (i) aVar;
        }
    ...
    public String[] getFieldNames() {
        this.proxyState.f6391e.f();
        int c2 = (int) this.proxyState.f6389c.c();
        String[] strArr = new String[c2];
        for (int i2 = 0; i2 < c2; i2++) {
            strArr[i2] = this.proxyState.f6389c.z(i2);
        }
        return strArr;
    }
    ...
    public RealmFieldType getFieldType(String str) {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.B(this.proxyState.f6389c.s(str));
    }
    ...
    public float getFloat(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            return this.proxyState.f6389c.o(s);
        } catch (IllegalArgumentException e2) {
    ...
    public c0<DynamicRealmObject> getList(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            OsList t = this.proxyState.f6389c.t(s);
            return new c0<>(t.f7004c.d(), t, this.proxyState.f6391e);
        } catch (IllegalArgumentException e2) {
    ...
    public long getLong(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            return this.proxyState.f6389c.p(s);
        } catch (IllegalArgumentException e2) {
    ...
    public DynamicRealmObject getObject(String str) {
        ...
        if (this.proxyState.f6389c.e(s)) {
            return null;
        }
        long n = this.proxyState.f6389c.n(s);
        Table i2 = this.proxyState.f6389c.d().i(s);
        return new DynamicRealmObject(this.proxyState.f6391e, CheckedRow.G(i2.b, i2, n));
    }
    ...
    public String getString(String str) {
        ...
        long s = this.proxyState.f6389c.s(str);
        try {
            return this.proxyState.f6389c.q(s);
        } catch (IllegalArgumentException e2) {
    ...
    public String getType() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.d().d();
    }
    ...
    public boolean hasField(String str) {
        ...
        return this.proxyState.f6389c.j(str);
    }
    ...
    public boolean isNull(String str) {
        this.proxyState.f6391e.f();
        long s = this.proxyState.f6389c.s(str);
        switch (this.proxyState.f6389c.B(s).ordinal()) {
            case 0:
            case 1:
            case 2:
            case 3:
            ...
            case 5:
            case 6:
                return this.proxyState.f6389c.y(s);
            case 7:
                return this.proxyState.f6389c.e(s);
            default:
                return false;
        }
    }
    ...
    public j0<DynamicRealmObject> linkingObjects(String str, String str2) {
        i iVar = (i) this.proxyState.f6391e;
        iVar.f();
        this.proxyState.f6389c.h();
        i0 b = iVar.f6353j.b(str);
        if (b != null) {
            if (str2 != null) {
                if (!str2.contains(".")) {
                    long f2 = b.f6354c.f(str2);
                    if (f2 != -1) {
                        RealmFieldType h2 = b.f6354c.h(f2);
                        ...
                        return j0.c(iVar, (CheckedRow) this.proxyState.f6389c, b.f6354c, str2);
                    }
    ...
    public void set(String str, Object obj) {
        ...
        RealmFieldType B = this.proxyState.f6389c.B(this.proxyState.f6389c.s(str));
    ...
    public void setBlob(String str, byte[] bArr) {
        this.proxyState.f6391e.f();
        this.proxyState.f6389c.D(this.proxyState.f6389c.s(str), bArr);
    }

    public void setBoolean(String str, boolean z) {
        this.proxyState.f6391e.f();
        this.proxyState.f6389c.i(this.proxyState.f6389c.s(str), z);
    }

    public void setByte(String str, byte b) {
        this.proxyState.f6391e.f();
        checkIsPrimaryKey(str);
        this.proxyState.f6389c.u(this.proxyState.f6389c.s(str), b);
    }
    ...
    public void setDate(String str, Date date) {
        ...
        long s = this.proxyState.f6389c.s(str);
        if (date == null) {
            this.proxyState.f6389c.f(s);
        } else {
            this.proxyState.f6389c.A(s, date);
        }
    }

    public void setDouble(String str, double d2) {
        this.proxyState.f6391e.f();
        this.proxyState.f6389c.C(this.proxyState.f6389c.s(str), d2);
    }

    public void setFloat(String str, float f2) {
        this.proxyState.f6391e.f();
        this.proxyState.f6389c.b(this.proxyState.f6389c.s(str), f2);
    }

    public void setInt(String str, int i2) {
        this.proxyState.f6391e.f();
        checkIsPrimaryKey(str);
        this.proxyState.f6389c.u(this.proxyState.f6389c.s(str), i2);
    }
            ...
            switch (B.ordinal()) {
                case 8:
                    if (!c0Var.isEmpty()) {
                        if (c0Var.i()) {
                            c0Var.f6303d.f();
                            if (!(OsList.nativeSize(c0Var.f6302c.b.a) <= 0)) {
                                e2 = c0Var.get(0);
                        ...
                        List<E> list = c0Var.f6304e;
                        if (list != null && !list.isEmpty()) {
                            e2 = c0Var.f6304e.get(0);
    ...
    public void setLong(String str, long j2) {
        this.proxyState.f6391e.f();
        checkIsPrimaryKey(str);
        this.proxyState.f6389c.u(this.proxyState.f6389c.s(str), j2);
    }

    public void setNull(String str) {
        this.proxyState.f6391e.f();
        long s = this.proxyState.f6389c.s(str);
        if (this.proxyState.f6389c.B(s) == RealmFieldType.OBJECT) {
            this.proxyState.f6389c.E(s);
            return;
        }
        checkIsPrimaryKey(str);
        this.proxyState.f6389c.f(s);
    ...
    public void setObject(String str, DynamicRealmObject dynamicRealmObject) {
        ...
        a aVar = vVar.f6391e;
        if (aVar != null && vVar.f6389c != null) {
            v<DynamicRealmObject> vVar2 = this.proxyState;
            if (vVar2.f6391e == aVar) {
                Table i2 = vVar2.f6389c.d().i(s);
                Table d2 = dynamicRealmObject.proxyState.f6389c.d();
                if (d2 != null) {
                    if (i2.nativeHasSameSchema(i2.a, d2.a)) {
                        this.proxyState.f6389c.r(s, dynamicRealmObject.proxyState.f6389c.l());
                        return;
                    }
    ...
    public void setShort(String str, short s) {
        this.proxyState.f6391e.f();
        checkIsPrimaryKey(str);
        this.proxyState.f6389c.u(this.proxyState.f6389c.s(str), s);
    }

    public void setString(String str, String str2) {
        this.proxyState.f6391e.f();
        checkIsPrimaryKey(str);
        this.proxyState.f6389c.a(this.proxyState.f6389c.s(str), str2);
    }

    public String toString() {
        String[] fieldNames;
        this.proxyState.f6391e.f();
        if (this.proxyState.f6389c.v()) {
            StringBuilder sb = new StringBuilder(f.b.a.a.a.f(this.proxyState.f6389c.d().d(), " = dynamic["));
            for (String str : getFieldNames()) {
                ...
                switch (B.ordinal()) {
                    case 0:
                        Long l2 = str2;
                        if (!this.proxyState.f6389c.y(s)) {
                            l2 = Long.valueOf(this.proxyState.f6389c.p(s));
                        }
                        sb.append(l2);
                        break;
                    case 1:
                        Boolean bool = str2;
                        if (!this.proxyState.f6389c.y(s)) {
                            bool = Boolean.valueOf(this.proxyState.f6389c.m(s));
                        }
                        sb.append(bool);
                        break;
                    case 2:
                        sb.append(this.proxyState.f6389c.q(s));
                        break;
                    case 3:
                        sb.append(Arrays.toString(this.proxyState.f6389c.g(s)));
                        break;
                    case 4:
                        Date date = str2;
                        if (!this.proxyState.f6389c.y(s)) {
                            date = this.proxyState.f6389c.w(s);
                        }
                        sb.append(date);
                        break;
                    case 5:
                        Float f2 = str2;
                        if (!this.proxyState.f6389c.y(s)) {
                            f2 = Float.valueOf(this.proxyState.f6389c.o(s));
                        }
                        sb.append(f2);
                        break;
                    case 6:
                        Double d2 = str2;
                        if (!this.proxyState.f6389c.y(s)) {
                            d2 = Double.valueOf(this.proxyState.f6389c.k(s));
                        }
                        sb.append(d2);
                        break;
                    case 7:
                        String str3 = str2;
                        if (!this.proxyState.f6389c.e(s)) {
                            str3 = this.proxyState.f6389c.d().i(s).d();
                        }
                        sb.append(str3);
                        break;
                    case 8:
                        sb.append(String.format(Locale.US, "RealmList<%s>[%s]", this.proxyState.f6389c.d().i(s).d(), Long.valueOf(this.proxyState.f6389c.t(s).b())));
                        break;
                    case 9:
                    default:
                        sb.append("?");
                        break;
                    case 10:
                        sb.append(String.format(Locale.US, "RealmList<Long>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                    case 11:
                        sb.append(String.format(Locale.US, "RealmList<Boolean>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                    case 12:
                        sb.append(String.format(Locale.US, "RealmList<String>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                    case 13:
                        sb.append(String.format(Locale.US, "RealmList<byte[]>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                    case 14:
                        sb.append(String.format(Locale.US, "RealmList<Date>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                    case 15:
                        sb.append(String.format(Locale.US, "RealmList<Float>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                    case 16:
                        sb.append(String.format(Locale.US, "RealmList<Double>[%s]", Long.valueOf(this.proxyState.f6389c.x(s, B).b())));
                        break;
                }
                sb.append("},");
            }
    ...
    public <E> c0<E> getList(String str, Class<E> cls) {
        ...
        if (cls != null) {
            ...
            try {
                return new c0<>(cls, this.proxyState.f6389c.x(s, classToRealmType), this.proxyState.f6391e);
            } catch (IllegalArgumentException e2) {
