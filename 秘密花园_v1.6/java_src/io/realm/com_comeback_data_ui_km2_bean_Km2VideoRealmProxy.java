...
public class com_comeback_data_ui_km2_bean_Km2VideoRealmProxy extends Km2Video implements n, w0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6933f = a("id", "id", a);
            this.f6934g = a(NotificationCompatJellybean.KEY_TITLE, NotificationCompatJellybean.KEY_TITLE, a);
            this.f6935h = a("praise_num", "praise_num", a);
            this.f6936i = a("width", "width", a);
            this.f6937j = a("height", "height", a);
            this.f6938k = a("cover", "cover", a);
            this.f6939l = a("nickname", "nickname", a);
            this.f6940m = a("type", "type", a);
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6933f = aVar.f6933f;
            aVar2.f6934g = aVar.f6934g;
            aVar2.f6935h = aVar.f6935h;
            aVar2.f6936i = aVar.f6936i;
            aVar2.f6937j = aVar.f6937j;
            aVar2.f6938k = aVar.f6938k;
            aVar2.f6939l = aVar.f6939l;
            aVar2.f6940m = aVar.f6940m;
            aVar2.n = aVar.n;
            aVar2.o = aVar.o;
            aVar2.p = aVar.p;
            aVar2.q = aVar.q;
    ...
    public static Km2Video copy(x xVar, a aVar, Km2Video km2Video, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6401j.e(Km2Video.class), aVar.f6932e, set);
        osObjectBuilder.g(aVar.f6933f, km2Video.realmGet$id());
        osObjectBuilder.g(aVar.f6934g, km2Video.realmGet$title());
        osObjectBuilder.e(aVar.f6935h, Integer.valueOf(km2Video.realmGet$praise_num()));
        osObjectBuilder.e(aVar.f6936i, Integer.valueOf(km2Video.realmGet$width()));
        osObjectBuilder.e(aVar.f6937j, Integer.valueOf(km2Video.realmGet$height()));
        osObjectBuilder.g(aVar.f6938k, km2Video.realmGet$cover());
        osObjectBuilder.g(aVar.f6939l, km2Video.realmGet$nickname());
        osObjectBuilder.e(aVar.f6940m, Integer.valueOf(km2Video.realmGet$type()));
        ...
        if (valueOf == null) {
            ...
            OsObjectBuilder.nativeAddFloat(osObjectBuilder.f7042c, j2, valueOf.floatValue());
        }
    ...
    */
    ...
    public static long insert(x xVar, Km2Video km2Video, Map<e0, Long> map) {
        ...
        Table e2 = xVar.f6401j.e(Km2Video.class);
        long j2 = e2.a;
        k0 k0Var = xVar.f6401j;
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(Km2Video.class);
        long j3 = aVar.f6933f;
        ...
        if (nativeFindFirstString == -1) {
            ...
            if (realmGet$title != null) {
                Table.nativeSetString(j2, aVar.f6934g, createRowWithPrimaryKey, realmGet$title, false);
            }
            Table.nativeSetLong(j2, aVar.f6935h, createRowWithPrimaryKey, km2Video.realmGet$praise_num(), false);
            Table.nativeSetLong(j2, aVar.f6936i, createRowWithPrimaryKey, km2Video.realmGet$width(), false);
            Table.nativeSetLong(j2, aVar.f6937j, createRowWithPrimaryKey, km2Video.realmGet$height(), false);
            String realmGet$cover = km2Video.realmGet$cover();
            if (realmGet$cover != null) {
                Table.nativeSetString(j2, aVar.f6938k, createRowWithPrimaryKey, realmGet$cover, false);
            }
            String realmGet$nickname = km2Video.realmGet$nickname();
            if (realmGet$nickname != null) {
                Table.nativeSetString(j2, aVar.f6939l, createRowWithPrimaryKey, realmGet$nickname, false);
            }
            Table.nativeSetLong(j2, aVar.f6940m, createRowWithPrimaryKey, km2Video.realmGet$type(), false);
    ...
    public static long insertOrUpdate(x xVar, Km2Video km2Video, Map<e0, Long> map) {
        ...
        String realmGet$title = km2Video.realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(j2, aVar.f6934g, j4, realmGet$title, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6934g, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6935h, j4, km2Video.realmGet$praise_num(), false);
        Table.nativeSetLong(j2, aVar.f6936i, j4, km2Video.realmGet$width(), false);
        Table.nativeSetLong(j2, aVar.f6937j, j4, km2Video.realmGet$height(), false);
        String realmGet$cover = km2Video.realmGet$cover();
        if (realmGet$cover != null) {
            Table.nativeSetString(j2, aVar.f6938k, j4, realmGet$cover, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6938k, j4, false);
        }
        String realmGet$nickname = km2Video.realmGet$nickname();
        if (realmGet$nickname != null) {
            Table.nativeSetString(j2, aVar.f6939l, j4, realmGet$nickname, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6939l, j4, false);
        }
        Table.nativeSetLong(j2, aVar.f6940m, j4, km2Video.realmGet$type(), false);
        String realmGet$normal_url = km2Video.realmGet$normal_url();
        if (realmGet$normal_url != null) {
    ...
    public static com_comeback_data_ui_km2_bean_Km2VideoRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6370f.a(Km2Video.class);
    ...
    public static Km2Video update(x xVar, a aVar, Km2Video km2Video, Km2Video km2Video2, Map<e0, n> map, Set<m> set) {
        OsObjectBuilder osObjectBuilder = new OsObjectBuilder(xVar.f6401j.e(Km2Video.class), aVar.f6932e, set);
        osObjectBuilder.g(aVar.f6933f, km2Video2.realmGet$id());
        osObjectBuilder.g(aVar.f6934g, km2Video2.realmGet$title());
        osObjectBuilder.e(aVar.f6935h, Integer.valueOf(km2Video2.realmGet$praise_num()));
        osObjectBuilder.e(aVar.f6936i, Integer.valueOf(km2Video2.realmGet$width()));
        osObjectBuilder.e(aVar.f6937j, Integer.valueOf(km2Video2.realmGet$height()));
        osObjectBuilder.g(aVar.f6938k, km2Video2.realmGet$cover());
        osObjectBuilder.g(aVar.f6939l, km2Video2.realmGet$nickname());
        osObjectBuilder.e(aVar.f6940m, Integer.valueOf(km2Video2.realmGet$type()));
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_km2_bean_km2videorealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_km2_bean_km2videorealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_km2_bean_km2videorealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$cover() {
        ...
        return this.proxyState.f6389c.q(this.columnInfo.f6938k);
    }

    @Override // com.comeback.data.ui.km2.bean.Km2Video, g.a.w0
    public float realmGet$gold() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.o(this.columnInfo.s);
    }

    @Override // com.comeback.data.ui.km2.bean.Km2Video, g.a.w0
    public int realmGet$height() {
        this.proxyState.f6391e.f();
        return (int) this.proxyState.f6389c.p(this.columnInfo.f6937j);
    }

    @Override // com.comeback.data.ui.km2.bean.Km2Video, g.a.w0
    public String realmGet$id() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6933f);
    }
    ...
    public String realmGet$nickname() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6939l);
    }
    ...
    public int realmGet$praise_num() {
        this.proxyState.f6391e.f();
        return (int) this.proxyState.f6389c.p(this.columnInfo.f6935h);
    }
    ...
    public String realmGet$title() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6934g);
    }

    @Override // com.comeback.data.ui.km2.bean.Km2Video, g.a.w0
    public int realmGet$type() {
        this.proxyState.f6391e.f();
        return (int) this.proxyState.f6389c.p(this.columnInfo.f6940m);
    }
    ...
    public int realmGet$width() {
        this.proxyState.f6391e.f();
        return (int) this.proxyState.f6389c.p(this.columnInfo.f6936i);
    }
    ...
    public void realmSet$cover(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6938k, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6938k, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6938k);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6938k, str);
        }
    }
    ...
    public void realmSet$gold(float f2) {
        ...
        vVar.f6391e.f();
        this.proxyState.f6389c.b(this.columnInfo.s, f2);
    }
    ...
    public void realmSet$height(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().p(this.columnInfo.f6937j, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.u(this.columnInfo.f6937j, i2);
    }
    ...
    public void realmSet$nickname(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6939l, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6939l, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6939l);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6939l, str);
        }
    }
    ...
    public void realmSet$praise_num(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().p(this.columnInfo.f6935h, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.u(this.columnInfo.f6935h, i2);
    }
    ...
    public void realmSet$title(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6934g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6934g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6934g);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6934g, str);
        }
    }
    ...
    public void realmSet$type(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().p(this.columnInfo.f6940m, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.u(this.columnInfo.f6940m, i2);
    }
    ...
    public void realmSet$width(int i2) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().p(this.columnInfo.f6936i, pVar.l(), i2, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.u(this.columnInfo.f6936i, i2);
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2Video)) {
                if (km2Video instanceof n) {
                    n nVar = (n) km2Video;
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(km2Video, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$id = km2Video.realmGet$id();
                if (realmGet$id == null) {
                ...
                if (nativeFindFirstString == -1) {
                    ...
                    if (realmGet$title != null) {
                        j2 = j4;
                        Table.nativeSetString(j3, aVar.f6934g, createRowWithPrimaryKey, realmGet$title, false);
                    } else {
                        j2 = j4;
                    }
                    Table.nativeSetLong(j3, aVar.f6935h, createRowWithPrimaryKey, km2Video.realmGet$praise_num(), false);
                    Table.nativeSetLong(j3, aVar.f6936i, createRowWithPrimaryKey, km2Video.realmGet$width(), false);
                    Table.nativeSetLong(j3, aVar.f6937j, createRowWithPrimaryKey, km2Video.realmGet$height(), false);
                    String realmGet$cover = km2Video.realmGet$cover();
                    if (realmGet$cover != null) {
                        Table.nativeSetString(j3, aVar.f6938k, createRowWithPrimaryKey, realmGet$cover, false);
                    }
                    String realmGet$nickname = km2Video.realmGet$nickname();
                    if (realmGet$nickname != null) {
                        Table.nativeSetString(j3, aVar.f6939l, createRowWithPrimaryKey, realmGet$nickname, false);
                    }
                    Table.nativeSetLong(j3, aVar.f6940m, createRowWithPrimaryKey, km2Video.realmGet$type(), false);
                    String realmGet$normal_url = km2Video.realmGet$normal_url();
                    if (realmGet$normal_url != null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2Video)) {
                ...
                if (realmGet$title != null) {
                    ...
                    j2 = j4;
                    Table.nativeSetNull(j3, aVar.f6934g, createRowWithPrimaryKey, false);
                }
                long j5 = createRowWithPrimaryKey;
                Table.nativeSetLong(j3, aVar.f6935h, j5, km2Video.realmGet$praise_num(), false);
                Table.nativeSetLong(j3, aVar.f6936i, j5, km2Video.realmGet$width(), false);
                Table.nativeSetLong(j3, aVar.f6937j, j5, km2Video.realmGet$height(), false);
                String realmGet$cover = km2Video.realmGet$cover();
                if (realmGet$cover != null) {
                    Table.nativeSetString(j3, aVar.f6938k, createRowWithPrimaryKey, realmGet$cover, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6938k, createRowWithPrimaryKey, false);
                }
                String realmGet$nickname = km2Video.realmGet$nickname();
                if (realmGet$nickname != null) {
                    Table.nativeSetString(j3, aVar.f6939l, createRowWithPrimaryKey, realmGet$nickname, false);
                } else {
                    Table.nativeSetNull(j3, aVar.f6939l, createRowWithPrimaryKey, false);
                }
                Table.nativeSetLong(j3, aVar.f6940m, createRowWithPrimaryKey, km2Video.realmGet$type(), false);
                String realmGet$normal_url = km2Video.realmGet$normal_url();
                if (realmGet$normal_url != null) {
