...
public class BaseModuleMediator extends o {
    ...
    public <E extends e0> E b(x xVar, E e2, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        if (superclass.equals(PermissionUser.class)) {
            ...
            k0Var.a();
            return (E) superclass.cast(j1.copyOrUpdate(xVar, (j1$a) k0Var.f6370f.a(PermissionUser.class), (PermissionUser) e2, z, map, set));
        } else if (superclass.equals(RealmPermissions.class)) {
            k0 k0Var2 = xVar.f6401j;
            k0Var2.a();
            return (E) superclass.cast(k1.copyOrUpdate(xVar, (k1$a) k0Var2.f6370f.a(RealmPermissions.class), (RealmPermissions) e2, z, map, set));
        } else if (superclass.equals(ClassPermissions.class)) {
            k0 k0Var3 = xVar.f6401j;
            k0Var3.a();
            return (E) superclass.cast(h1.copyOrUpdate(xVar, (h1$a) k0Var3.f6370f.a(ClassPermissions.class), (ClassPermissions) e2, z, map, set));
        } else if (superclass.equals(Permission.class)) {
            k0 k0Var4 = xVar.f6401j;
            k0Var4.a();
            return (E) superclass.cast(i1.copyOrUpdate(xVar, (i1$a) k0Var4.f6370f.a(Permission.class), (Permission) e2, z, map, set));
        } else if (superclass.equals(Role.class)) {
            k0 k0Var5 = xVar.f6401j;
            k0Var5.a();
            return (E) superclass.cast(l1.copyOrUpdate(xVar, (l1$a) k0Var5.f6370f.a(Role.class), (Role) e2, z, map, set));
        } else if (superclass.equals(Subscription.class)) {
            k0 k0Var6 = xVar.f6401j;
            k0Var6.a();
            return (E) superclass.cast(g1.copyOrUpdate(xVar, (g1$a) k0Var6.f6370f.a(Subscription.class), (Subscription) e2, z, map, set));
        } else {
