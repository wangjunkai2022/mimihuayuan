...
public class com_comeback_data_ui_lutube_bean_LActorsBeanRealmProxy extends LActorsBean implements n, z0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6954f = a("actor_id", "actor_id", a);
            this.f6955g = a("actor_name", "actor_name", a);
            this.f6956h = a("actor_url", "actor_url", a);
            this.f6957i = a("actor_like", "actor_like", a);
            this.f6953e = a.a();
        }
        ...
        public final void b(c cVar, c cVar2) {
            a aVar = (a) cVar;
            a aVar2 = (a) cVar2;
            aVar2.f6954f = aVar.f6954f;
            aVar2.f6955g = aVar.f6955g;
            aVar2.f6956h = aVar.f6956h;
            aVar2.f6957i = aVar.f6957i;
            aVar2.f6953e = aVar.f6953e;
        }
    }
    ...
    public static LActorsBean copy(x xVar, a aVar, LActorsBean lActorsBean, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6401j.e(LActorsBean.class);
        long j2 = aVar.f6953e;
    ...
    */
    public static com.comeback.data.ui.lutube.bean.LActorsBean createOrUpdateUsingJsonObject(g.a.x r8, org.json.JSONObject r9, boolean r10) throws org.json.JSONException {
        ...
        L35:
            ...
            r5.f6278c = r3     // Catch: java.lang.Throwable -> L6c
            r5.f6279d = r4     // Catch: java.lang.Throwable -> L6c
            r5.f6280e = r6     // Catch: java.lang.Throwable -> L6c
    ...
    public static long insert(x xVar, LActorsBean lActorsBean, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(LActorsBean.class);
        long j3 = aVar.f6954f;
        String realmGet$actor_id = lActorsBean.realmGet$actor_id();
        if (realmGet$actor_id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$actor_name = lActorsBean.realmGet$actor_name();
            if (realmGet$actor_name != null) {
                Table.nativeSetString(j2, aVar.f6955g, createRowWithPrimaryKey, realmGet$actor_name, false);
            }
            String realmGet$actor_url = lActorsBean.realmGet$actor_url();
            if (realmGet$actor_url != null) {
                Table.nativeSetString(j2, aVar.f6956h, createRowWithPrimaryKey, realmGet$actor_url, false);
            }
            Table.nativeSetBoolean(j2, aVar.f6957i, createRowWithPrimaryKey, lActorsBean.realmGet$actor_like(), false);
    ...
    public static long insertOrUpdate(x xVar, LActorsBean lActorsBean, Map<e0, Long> map) {
        ...
        String realmGet$actor_name = lActorsBean.realmGet$actor_name();
        if (realmGet$actor_name != null) {
            Table.nativeSetString(j2, aVar.f6955g, j4, realmGet$actor_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6955g, j4, false);
        }
        String realmGet$actor_url = lActorsBean.realmGet$actor_url();
        if (realmGet$actor_url != null) {
            Table.nativeSetString(j2, aVar.f6956h, j4, realmGet$actor_url, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6956h, j4, false);
        }
        Table.nativeSetBoolean(j2, aVar.f6957i, j4, lActorsBean.realmGet$actor_like(), false);
        return j4;
    }
    ...
    public static com_comeback_data_ui_lutube_bean_LActorsBeanRealmProxy newProxyInstance(g.a.a aVar, p pVar) {
        ...
        k0 G = aVar.G();
        G.a();
        c a2 = G.f6370f.a(LActorsBean.class);
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_lutube_bean_lactorsbeanrealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_lutube_bean_lactorsbeanrealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_lutube_bean_lactorsbeanrealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$actor_id() {
        ...
        return this.proxyState.f6389c.q(this.columnInfo.f6954f);
    }

    @Override // com.comeback.data.ui.lutube.bean.LActorsBean, g.a.z0
    public boolean realmGet$actor_like() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.m(this.columnInfo.f6957i);
    }

    @Override // com.comeback.data.ui.lutube.bean.LActorsBean, g.a.z0
    public String realmGet$actor_name() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6955g);
    }

    @Override // com.comeback.data.ui.lutube.bean.LActorsBean, g.a.z0
    public String realmGet$actor_url() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6956h);
    }
    ...
    public void realmSet$actor_like(boolean z) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                pVar.d().o(this.columnInfo.f6957i, pVar.l(), z, true);
                return;
            }
            return;
        }
        vVar.f6391e.f();
        this.proxyState.f6389c.i(this.columnInfo.f6957i, z);
    }
    ...
    public void realmSet$actor_name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6955g, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6955g, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6955g);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6955g, str);
        }
    }
    ...
    public void realmSet$actor_url(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6956h, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6956h, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6956h);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6956h, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lActorsBean2)) {
                if (lActorsBean2 instanceof n) {
                    ...
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(lActorsBean2, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$actor_id = lActorsBean2.realmGet$actor_id();
                if (realmGet$actor_id == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(lActorsBean2)) {
                ...
                if (realmGet$actor_name != null) {
                    ...
                    lActorsBean = lActorsBean2;
                    Table.nativeSetNull(j2, aVar.f6955g, createRowWithPrimaryKey, false);
                }
                String realmGet$actor_url = lActorsBean.realmGet$actor_url();
                if (realmGet$actor_url != null) {
                    Table.nativeSetString(j2, aVar.f6956h, createRowWithPrimaryKey, realmGet$actor_url, false);
                } else {
                    Table.nativeSetNull(j2, aVar.f6956h, createRowWithPrimaryKey, false);
                }
                Table.nativeSetBoolean(j2, aVar.f6957i, createRowWithPrimaryKey, lActorsBean.realmGet$actor_like(), false);
            }
        }
