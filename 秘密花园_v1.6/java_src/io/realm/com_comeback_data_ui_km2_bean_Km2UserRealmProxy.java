...
public class com_comeback_data_ui_km2_bean_Km2UserRealmProxy extends Km2User implements n, v0 {
    ...
    public static final class a extends c {
        ...
        public a(OsSchemaInfo osSchemaInfo) {
            ...
            this.f6930f = a("mu_name", "mu_name", a);
            this.f6931g = a("mu_id", "mu_id", a);
            this.f6929e = a.a();
        }
    ...
    public static Km2User copy(x xVar, a aVar, Km2User km2User, boolean z, Map<e0, n> map, Set<m> set) {
        ...
        Table e2 = xVar.f6401j.e(Km2User.class);
        long j2 = aVar.f6929e;
    ...
    */
    ...
    public static long insert(x xVar, Km2User km2User, Map<e0, Long> map) {
        ...
        k0Var.a();
        a aVar = (a) k0Var.f6370f.a(Km2User.class);
        long j3 = aVar.f6931g;
        String realmGet$mu_id = km2User.realmGet$mu_id();
        if (realmGet$mu_id == null) {
        ...
        if (nativeFindFirstString == -1) {
            ...
            String realmGet$mu_name = km2User.realmGet$mu_name();
            if (realmGet$mu_name != null) {
                Table.nativeSetString(j2, aVar.f6930f, createRowWithPrimaryKey, realmGet$mu_name, false);
            }
    ...
    public static long insertOrUpdate(x xVar, Km2User km2User, Map<e0, Long> map) {
        ...
        String realmGet$mu_name = km2User.realmGet$mu_name();
        if (realmGet$mu_name != null) {
            Table.nativeSetString(j2, aVar.f6930f, j4, realmGet$mu_name, false);
        } else {
            Table.nativeSetNull(j2, aVar.f6930f, j4, false);
        }
        return j4;
    }
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = com_comeback_data_ui_km2_bean_km2userrealmproxy.proxyState.f6391e.b.f6281c;
        if (str == null ? str2 == null : str.equals(str2)) {
            String j2 = this.proxyState.f6389c.d().j();
            String j3 = com_comeback_data_ui_km2_bean_km2userrealmproxy.proxyState.f6389c.d().j();
            if (j2 == null ? j3 == null : j2.equals(j3)) {
                return this.proxyState.f6389c.l() == com_comeback_data_ui_km2_bean_km2userrealmproxy.proxyState.f6389c.l();
            }
            return false;
        }
        return false;
    ...
    public String realmGet$mu_id() {
        ...
        return this.proxyState.f6389c.q(this.columnInfo.f6931g);
    }

    @Override // com.comeback.data.ui.km2.bean.Km2User, g.a.v0
    public String realmGet$mu_name() {
        this.proxyState.f6391e.f();
        return this.proxyState.f6389c.q(this.columnInfo.f6930f);
    }
    ...
    public void realmSet$mu_name(String str) {
        ...
        if (vVar.b) {
            if (vVar.f6392f) {
                p pVar = vVar.f6389c;
                if (str == null) {
                    pVar.d().q(this.columnInfo.f6930f, pVar.l(), true);
                    return;
                } else {
                    pVar.d().r(this.columnInfo.f6930f, pVar.l(), str, true);
                    return;
                }
            }
            return;
        ...
        vVar.f6391e.f();
        if (str == null) {
            this.proxyState.f6389c.f(this.columnInfo.f6930f);
        } else {
            this.proxyState.f6389c.a(this.columnInfo.f6930f, str);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2User)) {
                if (km2User instanceof n) {
                    n nVar = (n) km2User;
                    if (nVar.realmGet$proxyState().f6391e != null && nVar.realmGet$proxyState().f6391e.b.f6281c.equals(xVar.b.f6281c)) {
                        map.put(km2User, Long.valueOf(nVar.realmGet$proxyState().f6389c.l()));
                    }
                }
                String realmGet$mu_id = km2User.realmGet$mu_id();
                if (realmGet$mu_id == null) {
        ...
        while (it.hasNext()) {
            ...
            if (!map.containsKey(km2User)) {
                ...
                if (realmGet$mu_name != null) {
                    ...
                    Table.nativeSetNull(j2, aVar.f6930f, createRowWithPrimaryKey, false);
                }
            }
        }
    }
