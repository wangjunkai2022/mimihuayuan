...
public class UncheckedRow implements i, p {
    ...
    public static final long f7040d = nativeGetFinalizerPtr();
    public final h a;
    ...
    public void A(long j2, Date date) {
        this.b.a();
        nativeSetTimestamp(this.f7041c, j2, date.getTime());
    }

    @Override // g.a.f1.p
    public RealmFieldType B(long j2) {
        return RealmFieldType.fromNativeValue(nativeGetColumnType(this.f7041c, j2));
    }

    @Override // g.a.f1.p
    public void C(long j2, double d2) {
        this.b.a();
        nativeSetDouble(this.f7041c, j2, d2);
    }

    @Override // g.a.f1.p
    public void D(long j2, byte[] bArr) {
        this.b.a();
        nativeSetByteArray(this.f7041c, j2, bArr);
    }

    @Override // g.a.f1.p
    public void E(long j2) {
        this.b.a();
        nativeNullifyLink(this.f7041c, j2);
    }
    ...
    public void a(long j2, String str) {
        this.b.a();
        if (str == null) {
            nativeSetNull(this.f7041c, j2);
        } else {
            nativeSetString(this.f7041c, j2, str);
        }
    }
    ...
    public void b(long j2, float f2) {
        this.b.a();
        nativeSetFloat(this.f7041c, j2, f2);
    }

    @Override // g.a.f1.p
    public long c() {
        return nativeGetColumnCount(this.f7041c);
    }
    ...
    public boolean e(long j2) {
        return nativeIsNullLink(this.f7041c, j2);
    }
    ...
    public byte[] g(long j2) {
        return nativeGetByteArray(this.f7041c, j2);
    }
    ...
    public void i(long j2, boolean z) {
        this.b.a();
        nativeSetBoolean(this.f7041c, j2, z);
    }

    @Override // g.a.f1.p
    public boolean j(String str) {
        return nativeHasColumn(this.f7041c, str);
    }

    @Override // g.a.f1.p
    public double k(long j2) {
        return nativeGetDouble(this.f7041c, j2);
    }

    @Override // g.a.f1.p
    public long l() {
        return nativeGetIndex(this.f7041c);
    }

    @Override // g.a.f1.p
    public boolean m(long j2) {
        return nativeGetBoolean(this.f7041c, j2);
    }

    @Override // g.a.f1.p
    public long n(long j2) {
        return nativeGetLink(this.f7041c, j2);
    }
    ...
    public float o(long j2) {
        return nativeGetFloat(this.f7041c, j2);
    }

    @Override // g.a.f1.p
    public long p(long j2) {
        return nativeGetLong(this.f7041c, j2);
    }

    @Override // g.a.f1.p
    public String q(long j2) {
        return nativeGetString(this.f7041c, j2);
    }

    @Override // g.a.f1.p
    public void r(long j2, long j3) {
        this.b.a();
        nativeSetLink(this.f7041c, j2, j3);
    }

    @Override // g.a.f1.p
    public long s(String str) {
        if (str != null) {
            return nativeGetColumnIndex(this.f7041c, str);
        }
    ...
    public void u(long j2, long j3) {
        this.b.a();
        nativeSetLong(this.f7041c, j2, j3);
    }
    ...
    public Date w(long j2) {
        return new Date(nativeGetTimestamp(this.f7041c, j2));
    }
    ...
    public boolean y(long j2) {
        return nativeIsNull(this.f7041c, j2);
    }

    @Override // g.a.f1.p
    public String z(long j2) {
        return nativeGetColumnName(this.f7041c, j2);
    }

    public UncheckedRow(UncheckedRow uncheckedRow) {
        this.a = uncheckedRow.a;
        this.b = uncheckedRow.b;
        this.f7041c = uncheckedRow.f7041c;
    }
}
