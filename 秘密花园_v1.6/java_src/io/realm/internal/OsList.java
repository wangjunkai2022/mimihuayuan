...
public class OsList implements i, ObservableCollection {
    ...
    public static final long f7003e = nativeGetFinalizerPtr();
    public final long a;
    public final h b;

    /* renamed from: c  reason: collision with root package name */
    public final Table f7004c;

    /* renamed from: d  reason: collision with root package name */
    public final k<ObservableCollection.b> f7005d = new k<>();

    public OsList(UncheckedRow uncheckedRow, long j2) {
        OsSharedRealm osSharedRealm = uncheckedRow.b.f7037c;
        long[] nativeCreate = nativeCreate(osSharedRealm.getNativePtr(), uncheckedRow.f7041c, j2);
        this.a = nativeCreate[0];
        h hVar = osSharedRealm.context;
        this.b = hVar;
        hVar.a(this);
        if (nativeCreate[1] != 0) {
            this.f7004c = new Table(osSharedRealm, nativeCreate[1]);
        } else {
            this.f7004c = null;
        }
    }
    ...
    public void notifyChangeListeners(long j2) {
        ...
        this.f7005d.b(new ObservableCollection.a(osCollectionChangeSet));
    }
}
