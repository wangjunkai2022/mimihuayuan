...
public class OsResults implements i, ObservableCollection {
    ...
    public static final long f7024h = nativeGetFinalizerPtr();
    public final long a;
    public final OsSharedRealm b;

    /* renamed from: c  reason: collision with root package name */
    public final h f7025c;

    /* renamed from: d  reason: collision with root package name */
    public final Table f7026d;
    ...
    public final k<ObservableCollection.b> f7029g;
    ...
    public static abstract class a<T> implements Iterator<T> {
        ...
        public void c() {
            ...
            if (!osResults.f7028f) {
                OsResults osResults2 = new OsResults(osResults.b, osResults.f7026d, OsResults.nativeCreateSnapshot(osResults.a));
                osResults2.f7028f = true;
        ...
        public T next() {
            ...
            if (i2 < this.a.d()) {
                int i3 = this.b;
                OsResults osResults = this.a;
                return b(osResults.f7026d.m(OsResults.nativeGetRow(osResults.a, i3)));
            }
    ...
    public static abstract class b<T> extends a<T> implements ListIterator<T> {
        ...
        public T previous() {
            ...
            try {
                int i2 = this.b;
                OsResults osResults = this.a;
                UncheckedRow m2 = osResults.f7026d.m(OsResults.nativeGetRow(osResults.a, i2));
                u uVar = u.this;
                this.b--;
                return (T) uVar.a.F(uVar.b, uVar.f6384c, m2);
    ...
    public OsResults(OsSharedRealm osSharedRealm, Table table, long j2) {
        ...
        this.f7027e = cVar != cVar2;
    }

    public static OsResults a(OsSharedRealm osSharedRealm, UncheckedRow uncheckedRow, Table table, String str) {
        return new OsResults(osSharedRealm, table, nativeCreateResultsFromBacklinks(osSharedRealm.getNativePtr(), uncheckedRow.f7041c, table.a, table.f(str)));
    }
    ...
    public UncheckedRow c() {
        ...
        if (nativeFirstRow != 0) {
            return this.f7026d.m(nativeFirstRow);
        }
        return null;
    }
    ...
    public void notifyChangeListeners(long j2) {
        ...
        if (j2 == 0) {
            ...
            osCollectionChangeSet = new OsCollectionChangeSet(j2, !this.f7027e, null, this.b.isPartial());
        }
        if (osCollectionChangeSet.e() && this.f7027e) {
            return;
        }
        this.f7027e = true;
        this.f7029g.b(new ObservableCollection.a(osCollectionChangeSet));
    }
}
