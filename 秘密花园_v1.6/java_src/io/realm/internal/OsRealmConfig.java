...
public class OsRealmConfig implements i {
    ...
    public static final long f7009f = nativeGetFinalizerPtr();
    public final b0 a;
    public final URI b;
    ...
    public final h f7011d = new h();

    /* renamed from: e  reason: collision with root package name */
    public final CompactOnLaunchCallback f7012e;
    ...
    public static class b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public OsSharedRealm.MigrationCallback f7013c = null;

        /* renamed from: d  reason: collision with root package name */
        public OsSharedRealm.InitializationCallback f7014d = null;
        ...
        public OsRealmConfig a() {
            return new OsRealmConfig(this.a, this.f7016f, this.f7015e, this.b, this.f7013c, this.f7014d, null);
        }
    }
    ...
    public OsRealmConfig(b0 b0Var, String str, boolean z, OsSchemaInfo osSchemaInfo, OsSharedRealm.MigrationCallback migrationCallback, OsSharedRealm.InitializationCallback initializationCallback, a aVar) {
        ...
        URI uri2;
        this.a = b0Var;
        this.f7010c = nativeCreate(b0Var.f6281c, str, false, true);
        h.f6317c.a(this);
        if (j.b() != null) {
            ...
            byte[] a2 = b0Var.a();
            if (a2 != null) {
                nativeSetEncryptionKey(this.f7010c, a2);
            }
            nativeSetInMemory(this.f7010c, b0Var.f6287i == c.MEM_ONLY);
            nativeEnableChangeNotification(this.f7010c, z);
            d dVar = d.SCHEMA_MODE_MANUAL;
            if (b0Var.o) {
                dVar = d.SCHEMA_MODE_IMMUTABLE;
            } else if (b0Var.f6291m) {
                dVar = d.SCHEMA_MODE_READONLY;
            } else if (str3 != null) {
                dVar = d.SCHEMA_MODE_ADDITIVE;
            } else if (b0Var.f6286h) {
                dVar = d.SCHEMA_MODE_RESET_FILE;
            }
            nativeSetSchemaConfig(this.f7010c, dVar.a, b0Var.f6284f, osSchemaInfo == null ? 0L : osSchemaInfo.a, migrationCallback);
            CompactOnLaunchCallback compactOnLaunchCallback = b0Var.n;
            this.f7012e = compactOnLaunchCallback;
            if (compactOnLaunchCallback != null) {
                nativeSetCompactOnLaunchCallback(this.f7010c, compactOnLaunchCallback);
            }
            if (initializationCallback != null) {
                nativeSetInitializationCallback(this.f7010c, initializationCallback);
            }
            if (str3 != null) {
                String nativeCreateAndSetSyncConfig = nativeCreateAndSetSyncConfig(this.f7010c, str3, str4, str2, str5, equals2, b2.byteValue(), str7, str8, strArr, b3.byteValue());
                try {
                ...
                nativeSetSyncConfigSslSettings(this.f7010c, equals, str6);
                        ...
                        if (proxy.type() != Proxy.Type.DIRECT) {
                            ...
                            if (proxy.type() == Proxy.Type.HTTP) {
                                ...
                                if (address instanceof InetSocketAddress) {
                                    ...
                                    nativeSetSyncConfigProxySettings(this.f7010c, b4, inetSocketAddress.getHostString(), inetSocketAddress.getPort());
                                } else {
