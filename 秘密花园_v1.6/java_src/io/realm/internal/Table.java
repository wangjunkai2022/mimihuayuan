...
public class Table implements i {
    ...
    public static final long f7036e;
    public final long a;
    public final h b;

    /* renamed from: c  reason: collision with root package name */
    public final OsSharedRealm f7037c;

    static {
        String nativeGetTablePrefix = Util.nativeGetTablePrefix();
        f7035d = nativeGetTablePrefix;
        nativeGetTablePrefix.length();
        f7036e = nativeGetFinalizerPtr();
    }

    public Table(OsSharedRealm osSharedRealm, long j2) {
        h hVar = osSharedRealm.context;
        this.b = hVar;
        this.f7037c = osSharedRealm;
        this.a = j2;
        hVar.a(this);
    }
    ...
    public static String e(String str) {
        ...
        return !str.startsWith(f7035d) ? str : str.substring(f7035d.length());
    }
    ...
    public static String k(String str) {
        ...
        return a.l(new StringBuilder(), f7035d, str);
    }
    ...
    public void a() {
        OsSharedRealm osSharedRealm = this.f7037c;
    ...
    public Table i(long j2) {
        return new Table(this.f7037c, nativeGetLinkTarget(this.a, j2));
    }
