...
public class CheckedRow extends UncheckedRow {
    ...
    public boolean e(long j2) {
        RealmFieldType fromNativeValue = RealmFieldType.fromNativeValue(nativeGetColumnType(this.f7041c, j2));
    ...
    public void f(long j2) {
        if (RealmFieldType.fromNativeValue(nativeGetColumnType(this.f7041c, j2)) == RealmFieldType.BINARY) {
            this.b.a();
            nativeSetByteArray(this.f7041c, j2, null);
            return;
        }
        this.b.a();
