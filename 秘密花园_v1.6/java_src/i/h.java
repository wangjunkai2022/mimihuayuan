...
public final class h {
    ...
    public static final class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final j.k f6530d;

        public boolean equals(Object obj) {
            if (this != obj) {
                if (obj instanceof b) {
                    b bVar = (b) obj;
                    return h.o.c.g.a(null, bVar.a) && h.o.c.g.a(null, bVar.b) && h.o.c.g.a(null, bVar.f6529c) && h.o.c.g.a(null, bVar.f6530d);
                }
                return false;
            }
            return true;
        ...
        if (str != null) {
            ...
            for (X509Certificate x509Certificate2 : a2) {
                if (x509Certificate2 != null) {
                    r.append("\n    ");
                    r.append(f6528d.a(x509Certificate2));
                    r.append(": ");
