...
public final class v {
    ...
    public static final /* synthetic */ h.q.e[] f6850e;

    /* renamed from: f  reason: collision with root package name */
    public static final a f6851f;
    public final b a;
    public final l0 b;
    ...
    public final List<Certificate> f6853d;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof v) {
            v vVar = (v) obj;
            if (vVar.b == this.b && h.o.c.g.a(vVar.f6852c, this.f6852c) && h.o.c.g.a(vVar.b(), b()) && h.o.c.g.a(vVar.f6853d, this.f6853d)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int hashCode = this.f6852c.hashCode();
        int hashCode2 = b().hashCode();
        return this.f6853d.hashCode() + ((hashCode2 + ((hashCode + ((this.b.hashCode() + 527) * 31)) * 31)) * 31);
    }
    ...
    public String toString() {
        ...
        List<Certificate> list = this.f6853d;
