...
public final class d0 implements f {
    ...
    public final class a implements Runnable {
        ...
        public final String a() {
            return d0.this.f6502d.b.f6858e;
        }
    ...
    public h0 T() {
        ...
        if (mVar != null) {
            ...
            if (mVar2 != null) {
                mVar2.b();
                try {
                    q qVar = this.f6501c.a;
                    synchronized (qVar) {
                        qVar.f6846f.add(this);
                    }
                    return a();
                } finally {
                    q qVar2 = this.f6501c.a;
                    qVar2.a(qVar2.f6846f, this);
                }
            }
            h.o.c.g.g("transmitter");
            throw null;
    ...
    */
    public void W(i.g r7) {
        /*
            ...
            r2.<init>(r7)
            monitor-enter(r0)
            java.util.ArrayDeque<i.d0$a> r7 = r0.f6844d     // Catch: java.lang.Throwable -> L75
            r7.add(r2)     // Catch: java.lang.Throwable -> L75
            i.d0 r7 = i.d0.this     // Catch: java.lang.Throwable -> L75
            boolean r7 = r7.f6503e     // Catch: java.lang.Throwable -> L75
            if (r7 != 0) goto L70
            java.lang.String r7 = r2.a()     // Catch: java.lang.Throwable -> L75
            java.util.ArrayDeque<i.d0$a> r3 = r0.f6845e     // Catch: java.lang.Throwable -> L75
        ...
        L4b:
            ...
            goto L6a
        L4d:
            java.util.ArrayDeque<i.d0$a> r3 = r0.f6844d     // Catch: java.lang.Throwable -> L75
            java.util.Iterator r3 = r3.iterator()     // Catch: java.lang.Throwable -> L75
        L53:
            boolean r4 = r3.hasNext()     // Catch: java.lang.Throwable -> L75
            if (r4 == 0) goto L6a
    ...
    */
    public final i.h0 a() throws java.io.IOException {
        /*
            ...
            r1.<init>()
            i.b0 r0 = r13.f6501c
            java.util.List<i.y> r0 = r0.f6451c
            c.a.a.b.g.h.d(r1, r0)
            ...
            r1.add(r0)
            boolean r0 = r13.f6503e
            if (r0 != 0) goto L3e
            i.b0 r0 = r13.f6501c
            java.util.List<i.y> r0 = r0.f6452d
            c.a.a.b.g.h.d(r1, r0)
        L3e:
            i.m0.e.b r0 = new i.m0.e.b
            boolean r2 = r13.f6503e
            r0.<init>(r2)
            r1.add(r0)
            ...
            r0 = 0
            i.e0 r1 = r13.f6502d     // Catch: java.lang.Throwable -> L8e java.io.IOException -> L90
    ...
    public final String b() {
        ...
        if (mVar != null) {
            ...
            sb.append(this.f6503e ? "web socket" : NotificationCompat.CATEGORY_CALL);
            sb.append(" to ");
            sb.append(this.f6502d.b.k());
            return sb.toString();
        }
        h.o.c.g.g("transmitter");
        throw null;
