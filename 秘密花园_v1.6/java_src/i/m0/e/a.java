...
public final class a implements y {
    ...
    public h0 a(y.a aVar) throws IOException {
        ...
        if (S != null) {
            ...
            e.b(this.a, S.b, d2.f6535g);
            h0.a aVar3 = new h0.a(d2);
            aVar3.a = S;
            if (z && h.s.d.d("gzip", h0.f(d2, "Content-Encoding", null, 2), true) && e.a(d2) && (i0Var = d2.f6536h) != null) {
                o oVar = new o(i0Var.G());
                w.a d3 = d2.f6535g.d();
                d3.f("Content-Encoding");
                d3.f("Content-Length");
                aVar3.f(d3.d());
                aVar3.f6546g = new h(h0.f(d2, "Content-Type", null, 2), -1L, j.b.h(oVar));
            }
            return aVar3.b();
        }
        throw null;
