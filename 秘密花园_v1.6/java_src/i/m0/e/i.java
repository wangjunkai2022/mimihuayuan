...
public final class i implements y {
    ...
    */
    ...
    public final e0 b(h0 h0Var, String str) {
        String f2;
        x l2;
        if (!this.a.f6456h || (f2 = h0.f(h0Var, "Location", null, 2)) == null || (l2 = h0Var.b.b.l(f2)) == null) {
            return null;
        }
        if (h.o.c.g.a(l2.b, h0Var.b.b.b) || this.a.f6457i) {
            e0 e0Var = h0Var.b;
            if (e0Var != null) {
                ...
                if (f.a(str)) {
                    ...
                    if (!h.o.c.g.a(str, "PROPFIND")) {
                        ...
                        aVar.e(str, a ? h0Var.b.f6518e : null);
                    }
                    if (!a) {
    ...
    */
    public final boolean c(java.io.IOException r3, i.m0.d.m r4, boolean r5, i.e0 r6) {
        ...
        L36:
            ...
            return r1
        L39:
            i.m0.d.d r3 = r4.f6661f
            r5 = 0
            if (r3 == 0) goto L5e
            i.m0.d.i r6 = r3.f6631g
            monitor-enter(r6)
            boolean r3 = r3.f6628d     // Catch: java.lang.Throwable -> L5b
            monitor-exit(r6)
            if (r3 == 0) goto L56
            i.m0.d.d r3 = r4.f6661f
            if (r3 == 0) goto L52
