...
public final class e {
    ...
    public static final String[] f6728d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f6729e = new e();
    public static final j.k a = j.k.f7063e.b("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    public static final String[] f6727c = new String[64];
    ...
    static {
        ...
        for (int i3 = 0; i3 < 1; i3++) {
            int i4 = iArr[i3];
            String[] strArr3 = f6727c;
            strArr3[i4 | 8] = strArr3[i4] + ((Object) "|PADDED");
        }
        String[] strArr4 = f6727c;
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            for (int i7 = 0; i7 < 1; i7++) {
                int i8 = iArr[i7];
                int i9 = i8 | i6;
                f6727c[i9] = f6727c[i8] + "|" + f6727c[i6];
                StringBuilder sb = new StringBuilder();
                sb.append(f6727c[i8]);
                sb.append("|");
                f6727c[i9 | 8] = f.b.a.a.a.l(sb, f6727c[i6], "|PADDED");
            }
        }
        int length = f6727c.length;
        for (int i10 = 0; i10 < length; i10++) {
            String[] strArr5 = f6727c;
            if (strArr5[i10] == null) {
                strArr5[i10] = f6728d[i10];
            }
        }
    }
