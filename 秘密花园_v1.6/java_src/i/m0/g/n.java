...
public final class n implements Closeable {
    ...
    public static final Logger f6799g = Logger.getLogger(e.class.getName());
    public final j.g a;
    public int b;
    ...
    public final d.b f6801d;

    /* renamed from: e  reason: collision with root package name */
    public final j.i f6802e;
    ...
    public n(j.i iVar, boolean z) {
        ...
        this.a = gVar;
        this.b = 16384;
        this.f6801d = new d.b(0, false, gVar, 3);
    }
    ...
    public final void f(int i2, int i3, int i4, int i5) throws IOException {
        if (f6799g.isLoggable(Level.FINE)) {
            f6799g.fine(e.f6729e.a(false, i2, i3, i4, i5));
        }
        if (!(i3 <= this.b)) {
        ...
        if ((((int) 2147483648L) & i2) == 0) {
            i.m0.b.I(this.f6802e, i3);
            this.f6802e.q(i4 & 255);
            this.f6802e.q(i5 & 255);
            this.f6802e.m(i2 & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
            return;
        }
