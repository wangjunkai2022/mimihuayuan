...
public final class h extends f.c implements i.k {
    ...
    */
    ...
    public final void d(int i2, int i3, i.f fVar, t tVar) throws IOException {
        ...
        if (type == null || ((i4 = e.a[type.ordinal()]) != 1 && i4 != 2)) {
            ...
            socket = aVar.f6433e.createSocket();
            if (socket == null) {
                h.o.c.g.e();
                throw null;
            }
        ...
        this.b = socket;
        InetSocketAddress inetSocketAddress = this.q.f6570c;
        if (tVar == null) {
            throw null;
        }
        if (fVar == null) {
            ...
            try {
                ...
                i.m0.i.f.a.g(socket, this.q.f6570c, i2);
                try {
                    this.f6640g = j.b.h(j.b.y(socket));
                    this.f6641h = j.b.g(j.b.w(socket));
    ...
    */
    ...
    public final void f(b bVar, int i2, i.f fVar, t tVar) throws IOException {
        ...
        i.a aVar = this.q.a;
        SSLSocketFactory sSLSocketFactory = aVar.f6434f;
        ...
        String str = null;
        try {
            Socket createSocket = sSLSocketFactory.createSocket(this.b, aVar.a.f6858e, aVar.a.f6859f, true);
            if (createSocket != null) {
                ...
                try {
                    ...
                    if (a.b) {
                        f.a aVar2 = i.m0.i.f.f6825c;
                        i.m0.i.f.a.e(sSLSocket2, aVar.a.f6858e, aVar.b);
                    }
                    ...
                    HostnameVerifier hostnameVerifier = aVar.f6435g;
                    if (hostnameVerifier != null) {
                        if (!hostnameVerifier.verify(aVar.a.f6858e, session)) {
                            ...
                            if (!b.isEmpty()) {
                                ...
                                if (certificate != null) {
                                    ...
                                    sb.append("\n              |Hostname ");
                                    sb.append(aVar.a.f6858e);
                                    sb.append(" not verified:\n              |    certificate: ");
                                    sb.append(i.h.f6528d.a(x509Certificate));
                                    sb.append("\n              |    DN: ");
                            ...
                            throw new SSLPeerUnverifiedException("Hostname " + aVar.a.f6858e + " not verified (no certificates)");
                        }
                        i.h hVar = aVar.f6436h;
                        if (hVar != null) {
                            this.f6637d = new v(a2.b, a2.f6852c, a2.f6853d, new f(hVar, a2, aVar));
                            hVar.a(aVar.a.f6858e, new g(this));
                            if (a.b) {
                                f.a aVar4 = i.m0.i.f.f6825c;
                                str = i.m0.i.f.a.h(sSLSocket2);
                            }
                            this.f6636c = sSLSocket2;
                            this.f6640g = j.b.h(j.b.y(sSLSocket2));
                            this.f6641h = j.b.g(j.b.w(sSLSocket2));
                            if (str != null) {
                                c0Var2 = c0.f6479i.a(str);
                            }
                            this.f6638e = c0Var2;
                            f.a aVar5 = i.m0.i.f.f6825c;
                            i.m0.i.f.a.a(sSLSocket2);
                            if (this.f6638e == c0.HTTP_2) {
                                k(i2);
                                return;
                            }
                            return;
    ...
    public final i.m0.e.d h(b0 b0Var, y.a aVar) throws SocketException {
        ...
        if (socket != null) {
            j.j jVar = this.f6640g;
            if (jVar != null) {
                j.i iVar = this.f6641h;
                if (iVar != null) {
                    i.m0.g.f fVar = this.f6639f;
                    if (fVar != null) {
                ...
                if (iVar != null) {
                    ...
                    if (str == null) {
                        ...
                        synchronized (nVar) {
                            if (!nVar.f6800c) {
                                if (nVar.f6803f) {
                                    if (n.f6799g.isLoggable(Level.FINE)) {
                                        Logger logger = n.f6799g;
                                        logger.fine(i.m0.b.l(">> CONNECTION " + i.m0.g.e.a.c(), new Object[0]));
                                    }
                                    nVar.f6802e.s(i.m0.g.e.a);
                                    nVar.f6802e.flush();
                                }
                            } else {
                        ...
                        synchronized (nVar2) {
                            if (rVar != null) {
                                if (!nVar2.f6800c) {
                                    ...
                                    while (i3 < 10) {
                                        if (((1 << i3) & rVar.a) != 0) {
                                            nVar2.f6802e.l(i3 != 4 ? i3 != 7 ? i3 : 4 : 3);
                                            nVar2.f6802e.m(rVar.b[i3]);
                                        }
                                        i3++;
                                    }
                                    nVar2.f6802e.flush();
    ...
    public final boolean l(x xVar) {
        if (xVar != null) {
            x xVar2 = this.q.a.a;
            if (xVar.f6859f != xVar2.f6859f) {
                return false;
            }
            if (h.o.c.g.a(xVar.f6858e, xVar2.f6858e)) {
                return true;
            }
            v vVar = this.f6637d;
            if (vVar != null) {
                i.m0.k.d dVar = i.m0.k.d.a;
                String str = xVar.f6858e;
                if (vVar == null) {
                    h.o.c.g.e();
                    throw null;
                }
    ...
    public String toString() {
        ...
        o.append(this.q.a.a.f6858e);
        o.append(':');
        o.append(this.q.a.a.f6859f);
        o.append(',');
        o.append(" proxy=");
        o.append(this.q.b);
        ...
        v vVar = this.f6637d;
        o.append((vVar == null || (r1 = vVar.f6852c) == null) ? "none" : "none");
        o.append(" protocol=");
        o.append(this.f6638e);
        o.append('}');
        return o.toString();
    }
}
