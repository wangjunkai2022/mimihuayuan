...
public final class c {
    ...
    public final class a extends j.l {
        ...
        public final <E extends IOException> E d(E e2) {
            ...
            this.b = true;
            return (E) this.f6622f.a(this.f6619c, false, true, e2);
        }
        ...
        public void j(j.g gVar, long j2) throws IOException {
            if (gVar != null) {
                if (!this.f6620d) {
                    long j3 = this.f6621e;
                    if (j3 != -1 && this.f6619c + j2 > j3) {
                        StringBuilder o = f.b.a.a.a.o("expected ");
                        o.append(this.f6621e);
                        o.append(" bytes but received ");
                        o.append(this.f6619c + j2);
    ...
    public final class b extends j.m {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ c f6626f;
            ...
            if (gVar != null) {
                if (!this.f6624d) {
                    try {
                        ...
                        long j3 = this.b + c2;
                        if (this.f6625e != -1 && j3 > this.f6625e) {
                            throw new ProtocolException("expected " + this.f6625e + " bytes but received " + j3);
                        }
                        this.b = j3;
                        if (j3 == this.f6625e) {
                            d(null);
        ...
        public final <E extends IOException> E d(E e2) {
            ...
            this.f6623c = true;
            return (E) this.f6626f.a(this.b, true, false, e2);
        }
    }
    ...
    public final <E extends IOException> E a(long j2, boolean z, boolean z2, E e2) {
        ...
        if (z2) {
            if (e2 != null) {
                this.f6616d.c(this.f6615c, e2);
            } else {
                t tVar = this.f6616d;
                i.f fVar = this.f6615c;
                if (tVar == null) {
                    throw null;
                }
                if (fVar == null) {
        ...
        if (z) {
            if (e2 != null) {
                this.f6616d.d(this.f6615c, e2);
            } else {
                t tVar2 = this.f6616d;
                i.f fVar2 = this.f6615c;
                if (tVar2 == null) {
                    throw null;
                }
                if (fVar2 == null) {
    ...
    public final y c(e0 e0Var, boolean z) throws IOException {
        ...
        if (g0Var != null) {
            ...
            if (tVar != null) {
                if (fVar != null) {
                    return new a(this, this.f6618f.f(e0Var, a2), a2);
                }
                h.o.c.g.f(NotificationCompat.CATEGORY_CALL);
                throw null;
            }
