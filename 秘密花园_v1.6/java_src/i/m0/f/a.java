...
public final class a implements i.m0.e.d {
    ...
    public abstract class AbstractC0109a implements a0 {
        ...
        public long c(g gVar, long j2) {
            if (gVar != null) {
                try {
                    return a.this.f6686f.c(gVar, j2);
                } catch (IOException e2) {
                    h hVar = a.this.f6685e;
                    if (hVar == null) {
                        h.o.c.g.e();
                        throw null;
                    }
    ...
    public final class c extends AbstractC0109a {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final x f6692f;

        /* renamed from: g  reason: collision with root package name */
        public final /* synthetic */ a f6693g;
            ...
            if (j2 >= 0) {
                if (!this.b) {
                    if (this.f6691e) {
                        ...
                        if (j3 == 0 || j3 == -1) {
                            if (this.f6690d != -1) {
                                this.f6693g.f6686f.n();
                            }
                            try {
                                this.f6690d = this.f6693g.f6686f.A();
                                String n = this.f6693g.f6686f.n();
                                if (n != null) {
                                    ...
                                    throw new ProtocolException("expected chunk size and optional extensions but was \"" + this.f6690d + obj + '\"');
                                }
                        ...
                        long c2 = super.c(gVar, Math.min(j2, this.f6690d));
                        if (c2 == -1) {
                            h hVar = this.f6693g.f6685e;
                            if (hVar == null) {
                                h.o.c.g.e();
                                throw null;
                            }
        ...
        public void close() {
            ...
            if (this.f6691e && !i.m0.b.k(this, 100, TimeUnit.MILLISECONDS)) {
                h hVar = this.f6693g.f6685e;
                if (hVar != null) {
                    hVar.i();
                    d();
    ...
    public final class d extends AbstractC0109a {
        ...
        public void close() {
            ...
            if (this.f6694d != 0 && !i.m0.b.k(this, 100, TimeUnit.MILLISECONDS)) {
                h hVar = a.this.f6685e;
                if (hVar != null) {
                    hVar.i();
                    d();
    ...
    public static final void i(a aVar, n nVar) {
        if (aVar != null) {
            j.b0 b0Var = nVar.f7065e;
            nVar.f7065e = j.b0.f7052d;
            b0Var.a();
            b0Var.b();
            return;
        }
        ...
        if (wVar == null) {
            ...
            if (this.a == 0) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    this.f6687g.y(wVar.c(i2)).y(": ").y(wVar.f(i2)).y("\r\n");
                }
                this.f6687g.y("\r\n");
                this.a = 1;
                return;
