...
public final class e implements Closeable, Flushable {
    ...
    /* renamed from: g */
    public final LinkedHashMap<String, b> f6595g = new LinkedHashMap<>(0, 0.75f, true);
    ...
    public final class a {
        ...
        public a(b bVar) {
            e.this = r1;
            this.f6602c = bVar;
            this.a = bVar.f6605d ? null : new boolean[r1.s];
        }

        public final void a() throws IOException {
            synchronized (e.this) {
                if (!this.b) {
                    if (g.a(this.f6602c.f6606e, this)) {
                        e.this.e(this, false);
                    }
                    this.b = true;
                } else {
        ...
        public final void c() {
            if (g.a(this.f6602c.f6606e, this)) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    try {
                        e.this.p.a(this.f6602c.f6604c.get(i3));
                    } catch (IOException unused) {
                    }
                }
                this.f6602c.f6606e = null;
            }
        }
        ...
        public final y d(int i2) {
            synchronized (e.this) {
                if (!this.b) {
                    ...
                    try {
                        return new f(e.this.p.c(this.f6602c.f6604c.get(i2)), new C0107a(i2));
    ...
    public final class b {
        ...
        /* renamed from: c */
        public final List<File> f6604c = new ArrayList();
        ...
        public b(String str) {
            ...
            StringBuilder sb = new StringBuilder(this.f6608g);
            sb.append('.');
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                sb.append(".tmp");
                this.f6604c.add(new File(r8.q, sb.toString()));
                sb.setLength(length);
            }
        }
        ...
        public final c a() {
            ...
            if (!j.a || holdsLock) {
                ...
                try {
                    ...
                    return new c(e.this, this.f6608g, this.f6607f, arrayList, jArr);
                } catch (FileNotFoundException unused) {
    ...
    public static final class d implements Runnable {
        ...
        public final void run() {
            synchronized (e.this) {
                if (!e.this.f6598j || e.this.f6599k) {
                    return;
                }
                try {
                    e.this.N();
    ...
    public e(i.m0.h.b bVar, File file, int i2, int i3, long j2, Executor executor) {
        ...
        this.f6591c = new File(this.q, "journal.tmp");
        this.f6592d = new File(this.q, "journal.bkp");
    }
    ...
    public final synchronized void F() throws IOException {
        ...
        if (this.p.f(this.f6592d)) {
            if (this.p.f(this.b)) {
                this.p.a(this.f6592d);
            } else {
                this.p.g(this.f6592d, this.b);
            }
        }
        if (this.p.f(this.b)) {
            try {
    ...
    public final boolean G() {
        int i2 = this.f6596h;
        return i2 >= 2000 && i2 >= this.f6595g.size();
    }
    ...
    public final void I() throws IOException {
        this.p.a(this.f6591c);
        Iterator<b> it = this.f6595g.values().iterator();
        while (it.hasNext()) {
            b next = it.next();
            g.b(next, "i.next()");
            b bVar = next;
                ...
                if (!(n5.length() > 0)) {
                    while (true) {
                        try {
                            ...
                            this.f6596h = i2 - this.f6595g.size();
                            if (!h2.p()) {
                                L();
                            } else {
                                this.f6594f = H();
    ...
    public final void K(String str) throws IOException {
        ...
        if (i2 != -1) {
            ...
            b bVar = this.f6595g.get(substring);
            if (bVar == null) {
                bVar = new b(substring);
                this.f6595g.put(substring, bVar);
            }
    ...
    public final synchronized void L() throws IOException {
        ...
        i g2 = j.b.g(this.p.c(this.f6591c));
        ...
        if (this.p.f(this.b)) {
            this.p.g(this.b, this.f6592d);
        }
        this.p.g(this.f6591c, this.b);
        this.p.a(this.f6592d);
        this.f6594f = H();
        this.f6597i = false;
        this.f6601m = false;
    ...
    public final boolean M(b bVar) throws IOException {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            long j2 = this.f6593e;
            long[] jArr = bVar.a;
            this.f6593e = j2 - jArr[i3];
            jArr[i3] = 0;
        }
        this.f6596h++;
        i iVar = this.f6594f;
        if (iVar != null) {
            iVar.y(x).q(32).y(bVar.f6608g).q(10);
            this.f6595g.remove(bVar.f6608g);
            if (G()) {
                this.t.execute(this.o);
            }
            return true;
    ...
    public final void N() throws IOException {
        while (this.f6593e > this.a) {
            b next = this.f6595g.values().iterator().next();
    ...
    public synchronized void close() throws IOException {
        b[] bVarArr;
        if (this.f6598j && !this.f6599k) {
            Collection<b> values = this.f6595g.values();
        ...
        if (g.a(bVar.f6606e, aVar)) {
            if (z2 && !bVar.f6605d) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    ...
                    if (zArr != null) {
                        if (zArr[i3]) {
                            if (!this.p.f(bVar.f6604c.get(i3))) {
                                aVar.a();
                                return;
                            }
                        } else {
    ...
    public final synchronized a f(String str, long j2) throws IOException {
        if (str != null) {
            ...
            O(str);
            b bVar = this.f6595g.get(str);
            if (j2 == -1 || (bVar != null && bVar.f6607f == j2)) {
                if ((bVar != null ? bVar.f6606e : null) != null) {
                    return null;
                }
                if (!this.f6600l && !this.f6601m) {
                    i iVar = this.f6594f;
                    if (iVar != null) {
